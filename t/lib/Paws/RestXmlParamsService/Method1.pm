...
package Paws::RestXmlParamsService::Method1;
  use Moose;

  # Test injection fields (not real wire params; consumed by the
  # TestGivenResponse caller in t/lib/TestGivenResponse.pm).
  ...
  class_has _returns     => (isa => 'Str', is => 'ro', default => 'Paws::RestXmlParamsService::Method1Return');
