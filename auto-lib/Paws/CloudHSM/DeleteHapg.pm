...
Paws::CloudHSM::DeleteHapg - Arguments for method DeleteHapg on L<Paws::CloudHSM>
...
=head1 SYNOPSIS
    ...
    my $DeleteHapgResponse = $cloudhsm->DeleteHapg(
      HapgArn => 'MyHapgArn',

    );

    # Results:
    my $Status = $DeleteHapgResponse->Status;

    # Returns a L<Paws::CloudHSM::DeleteHapgResponse> object.
