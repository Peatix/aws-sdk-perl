...
Paws::CloudHSM::DeleteLunaClient - Arguments for method DeleteLunaClient on L<Paws::CloudHSM>
...
=head1 SYNOPSIS
    ...
    my $DeleteLunaClientResponse = $cloudhsm->DeleteLunaClient(
      ClientArn => 'MyClientArn',

    );

    # Results:
    my $Status = $DeleteLunaClientResponse->Status;

    # Returns a L<Paws::CloudHSM::DeleteLunaClientResponse> object.
