...
package Paws::ComprehendMedical::SNOMEDCTEntity;
  use Moose;
  has Attributes => (is => 'ro', isa => 'ArrayRef[Paws::ComprehendMedical::SNOMEDCTAttribute]');
...
Paws::ComprehendMedical::SNOMEDCTEntity
...
As an example, if Att1 is expected to be a Paws::ComprehendMedical::SNOMEDCTEntity object:

  $service_obj->Method(Att1 => { Attributes => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ComprehendMedical::SNOMEDCTEntity object:
...
=head2 Attributes => ArrayRef[L<Paws::ComprehendMedical::SNOMEDCTAttribute>]
