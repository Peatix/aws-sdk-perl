...
package Paws::ComprehendMedical::StartRxNormInferenceJob;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'StartRxNormInferenceJob');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ComprehendMedical::StartRxNormInferenceJobResponse');
...
Paws::ComprehendMedical::StartRxNormInferenceJob - Arguments for method StartRxNormInferenceJob on L<Paws::ComprehendMedical>

=head1 DESCRIPTION

This class represents the parameters used for calling the method StartRxNormInferenceJob on the
L<AWS Comprehend Medical|Paws::ComprehendMedical> service. Use the attributes of this class
as arguments to method StartRxNormInferenceJob.
...
This class forms part of L<Paws>, documenting arguments for method StartRxNormInferenceJob in L<Paws::ComprehendMedical>
