...
package Paws::ComprehendMedical::StartICD10CMInferenceJob;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'StartICD10CMInferenceJob');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ComprehendMedical::StartICD10CMInferenceJobResponse');
...
Paws::ComprehendMedical::StartICD10CMInferenceJob - Arguments for method StartICD10CMInferenceJob on L<Paws::ComprehendMedical>

=head1 DESCRIPTION

This class represents the parameters used for calling the method StartICD10CMInferenceJob on the
L<AWS Comprehend Medical|Paws::ComprehendMedical> service. Use the attributes of this class
as arguments to method StartICD10CMInferenceJob.
...
# Returns a L<Paws::ComprehendMedical::StartICD10CMInferenceJobResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method StartICD10CMInferenceJob in L<Paws::ComprehendMedical>
