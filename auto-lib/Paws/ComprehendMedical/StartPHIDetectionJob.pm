...
package Paws::ComprehendMedical::StartPHIDetectionJob;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'StartPHIDetectionJob');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ComprehendMedical::StartPHIDetectionJobResponse');
...
Paws::ComprehendMedical::StartPHIDetectionJob - Arguments for method StartPHIDetectionJob on L<Paws::ComprehendMedical>

=head1 DESCRIPTION

This class represents the parameters used for calling the method StartPHIDetectionJob on the
L<AWS Comprehend Medical|Paws::ComprehendMedical> service. Use the attributes of this class
as arguments to method StartPHIDetectionJob.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to StartPHIDetectionJob.

=head1 SYNOPSIS

    my $comprehendmedical = Paws->service('ComprehendMedical');
    my $StartPHIDetectionJobResponse = $comprehendmedical->StartPHIDetectionJob(
    ...
    # Results:
    my $JobId = $StartPHIDetectionJobResponse->JobId;

    # Returns a L<Paws::ComprehendMedical::StartPHIDetectionJobResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method StartPHIDetectionJob in L<Paws::ComprehendMedical>
