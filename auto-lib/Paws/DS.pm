package Paws::DS;
  ...
  sub DescribeClientAuthenticationSettings {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::DS::DescribeClientAuthenticationSettings', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeDirectoryDataAccess {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::DS::DescribeDirectoryDataAccess', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeSettings {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::DS::DescribeSettings', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeUpdateDirectory {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::DS::DescribeUpdateDirectory', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DisableDirectoryDataAccess {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::DS::DisableDirectoryDataAccess', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DisableLDAPS {
    my $self = shift;
  ...
  sub EnableDirectoryDataAccess {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::DS::EnableDirectoryDataAccess', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub EnableLDAPS {
    my $self = shift;
  ...
  sub UpdateDirectorySetup {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::DS::UpdateDirectorySetup', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub UpdateSettings {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::DS::UpdateSettings', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub UpdateTrust {
    my $self = shift;
  ...
  sub DescribeAllClientAuthenticationSettings {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->DescribeClientAuthenticationSettings(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->NextToken) {
        $next_result = $self->DescribeClientAuthenticationSettings(@_, NextToken => $next_result->NextToken);
        push @{ $result->ClientAuthenticationSettingsInfo }, @{ $next_result->ClientAuthenticationSettingsInfo };
      }
      return $result;
    } else {
      while ($result->NextToken) {
        $callback->($_ => 'ClientAuthenticationSettingsInfo') foreach (@{ $result->ClientAuthenticationSettingsInfo });
        $result = $self->DescribeClientAuthenticationSettings(@_, NextToken => $result->NextToken);
      }
      $callback->($_ => 'ClientAuthenticationSettingsInfo') foreach (@{ $result->ClientAuthenticationSettingsInfo });
    }
  ...
  sub DescribeAllLDAPSSettings {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->DescribeLDAPSSettings(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->NextToken) {
        $next_result = $self->DescribeLDAPSSettings(@_, NextToken => $next_result->NextToken);
        push @{ $result->LDAPSSettingsInfo }, @{ $next_result->LDAPSSettingsInfo };
      }
      return $result;
    } else {
      while ($result->NextToken) {
        $callback->($_ => 'LDAPSSettingsInfo') foreach (@{ $result->LDAPSSettingsInfo });
        $result = $self->DescribeLDAPSSettings(@_, NextToken => $result->NextToken);
      }
      $callback->($_ => 'LDAPSSettingsInfo') foreach (@{ $result->LDAPSSettingsInfo });
    }
  ...
  sub DescribeAllRegions {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->DescribeRegions(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->NextToken) {
        $next_result = $self->DescribeRegions(@_, NextToken => $next_result->NextToken);
        push @{ $result->RegionsDescription }, @{ $next_result->RegionsDescription };
      }
      return $result;
    } else {
      while ($result->NextToken) {
        $callback->($_ => 'RegionsDescription') foreach (@{ $result->RegionsDescription });
        $result = $self->DescribeRegions(@_, NextToken => $result->NextToken);
      }
      $callback->($_ => 'RegionsDescription') foreach (@{ $result->RegionsDescription });
    }
  ...
  sub DescribeAllUpdateDirectory {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->DescribeUpdateDirectory(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->NextToken) {
        $next_result = $self->DescribeUpdateDirectory(@_, NextToken => $next_result->NextToken);
        push @{ $result->UpdateActivities }, @{ $next_result->UpdateActivities };
      }
      return $result;
    } else {
      while ($result->NextToken) {
        $callback->($_ => 'UpdateActivities') foreach (@{ $result->UpdateActivities });
        $result = $self->DescribeUpdateDirectory(@_, NextToken => $result->NextToken);
      }
      $callback->($_ => 'UpdateActivities') foreach (@{ $result->UpdateActivities });
    }
  ...
  sub ListAllCertificates {
    ...
    if (not defined $callback) {
      while ($next_result->NextToken) {
        ...
        push @{ $result->CertificatesInfo }, @{ $next_result->CertificatesInfo };
      }
      return $result;
    } else {
      while ($result->NextToken) {
        $callback->($_ => 'CertificatesInfo') foreach (@{ $result->CertificatesInfo });
...
information about Directory Services features, see Directory Service
...
Services directory. Conditional forwarders are required in order to set
up a trust relationship with another domain. The conditional forwarder
...
in the I<Directory Service Admin Guide>.
...
more information, see Managed Microsoft AD
...
=head2 DescribeClientAuthenticationSettings
...
Each argument is described in detail in: L<Paws::DS::DescribeClientAuthenticationSettings>

Returns: a L<Paws::DS::DescribeClientAuthenticationSettingsResult> instance
...
for the specified directory is retrieved. Currently, only C<SmartCard>
is supported.
...
=head2 DescribeDirectoryDataAccess
...
Each argument is described in detail in: L<Paws::DS::DescribeDirectoryDataAccess>

Returns: a L<Paws::DS::DescribeDirectoryDataAccessResult> instance
...
Each argument is described in detail in: L<Paws::DS::DescribeSettings>

Returns: a L<Paws::DS::DescribeSettingsResult> instance
...
Each argument is described in detail in: L<Paws::DS::DescribeUpdateDirectory>

Returns: a L<Paws::DS::DescribeUpdateDirectoryResult> instance
...
=head2 DisableDirectoryDataAccess
...
Each argument is described in detail in: L<Paws::DS::DisableDirectoryDataAccess>

Returns: a L<Paws::DS::DisableDirectoryDataAccessResult> instance
...
=head2 EnableDirectoryDataAccess
...
Each argument is described in detail in: L<Paws::DS::EnableDirectoryDataAccess>

Returns: a L<Paws::DS::EnableDirectoryDataAccessResult> instance
...
a user in the B<Amazon Web Services Reserved> OU. For more information
about the OU structure for an Managed Microsoft AD directory, see What
Gets Created
...
Shares a specified directory (C<DirectoryId>) in your Amazon Web
...
Amazon Web Services organization (C<ORGANIZATIONS>). It also determines
whether you can share the directory with any other Amazon Web Services
account either inside or outside of the organization (C<HANDSHAKE>).
...
=item [CreateSnapshotBeforeUpdate => Bool]

=item [OSUpdateSettings => L<Paws::DS::OSUpdateSettings>]


=back

Each argument is described in detail in: L<Paws::DS::UpdateDirectorySetup>

Returns: a L<Paws::DS::UpdateDirectorySetupResult> instance
...
=item Settings => ArrayRef[L<Paws::DS::Setting>]


=back

Each argument is described in detail in: L<Paws::DS::UpdateSettings>

Returns: a L<Paws::DS::UpdateSettingsResult> instance
...
=head2 DescribeAllClientAuthenticationSettings(sub { },DirectoryId => Str, [Limit => Int, NextToken => Str, Type => Str])

=head2 DescribeAllClientAuthenticationSettings(DirectoryId => Str, [Limit => Int, NextToken => Str, Type => Str])


If passed a sub as first parameter, it will call the sub for each element found in :

 - ClientAuthenticationSettingsInfo, passing the object as the first parameter, and the string 'ClientAuthenticationSettingsInfo' as the second parameter 

If not, it will return a a L<Paws::DS::DescribeClientAuthenticationSettingsResult> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
...
=head2 DescribeAllLDAPSSettings(sub { },DirectoryId => Str, [Limit => Int, NextToken => Str, Type => Str])

=head2 DescribeAllLDAPSSettings(DirectoryId => Str, [Limit => Int, NextToken => Str, Type => Str])


If passed a sub as first parameter, it will call the sub for each element found in :

 - LDAPSSettingsInfo, passing the object as the first parameter, and the string 'LDAPSSettingsInfo' as the second parameter 

If not, it will return a a L<Paws::DS::DescribeLDAPSSettingsResult> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.


=head2 DescribeAllRegions(sub { },DirectoryId => Str, [NextToken => Str, RegionName => Str])

=head2 DescribeAllRegions(DirectoryId => Str, [NextToken => Str, RegionName => Str])


If passed a sub as first parameter, it will call the sub for each element found in :

 - RegionsDescription, passing the object as the first parameter, and the string 'RegionsDescription' as the second parameter 

If not, it will return a a L<Paws::DS::DescribeRegionsResult> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
...
=head2 DescribeAllUpdateDirectory(sub { },DirectoryId => Str, UpdateType => Str, [NextToken => Str, RegionName => Str])

=head2 DescribeAllUpdateDirectory(DirectoryId => Str, UpdateType => Str, [NextToken => Str, RegionName => Str])


If passed a sub as first parameter, it will call the sub for each element found in :

 - UpdateActivities, passing the object as the first parameter, and the string 'UpdateActivities' as the second parameter 

If not, it will return a a L<Paws::DS::DescribeUpdateDirectoryResult> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.


=head2 ListAllCertificates(sub { },DirectoryId => Str, [Limit => Int, NextToken => Str])

=head2 ListAllCertificates(DirectoryId => Str, [Limit => Int, NextToken => Str])


If passed a sub as first parameter, it will call the sub for each element found in :

 - CertificatesInfo, passing the object as the first parameter, and the string 'CertificatesInfo' as the second parameter 

If not, it will return a a L<Paws::DS::ListCertificatesResult> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
