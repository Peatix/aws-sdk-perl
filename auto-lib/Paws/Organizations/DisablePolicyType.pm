...
=head1 SYNOPSIS
   ...
   # The following example shows how to disable the service control policy (SCP)
   # policy type in a root. The response shows that the PolicyTypes response
   # element no longer includes SERVICE_CONTROL_POLICY:/n/n
