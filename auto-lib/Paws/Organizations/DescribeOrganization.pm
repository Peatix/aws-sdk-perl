...
package Paws::Organizations::DescribeOrganization;
  use Moose;

  use MooseX::ClassAttribute;

  class_has _api_call => (isa => 'Str', is => 'ro', default => 'DescribeOrganization');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Organizations::DescribeOrganizationResponse');
...
Paws::Organizations::DescribeOrganization - Arguments for method DescribeOrganization on L<Paws::Organizations>
...
=head1 SYNOPSIS
    ...
    # Results:
    my $Organization = $DescribeOrganizationResponse->Organization;

    # Returns a L<Paws::Organizations::DescribeOrganizationResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method DescribeOrganization in L<Paws::Organizations>
