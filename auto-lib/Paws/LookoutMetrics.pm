package Paws::LookoutMetrics;
  ...
  sub DeactivateAnomalyDetector {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::LookoutMetrics::DeactivateAnomalyDetector', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DeleteAlert {
    my $self = shift;
  ...
  sub DetectMetricSetConfig {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::LookoutMetrics::DetectMetricSetConfig', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetAnomalyGroup {
    my $self = shift;
  ...
  sub GetDataQualityMetrics {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::LookoutMetrics::GetDataQualityMetrics', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetFeedback {
    my $self = shift;
  ...
  sub ListAnomalyGroupRelatedMetrics {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::LookoutMetrics::ListAnomalyGroupRelatedMetrics', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub UpdateAlert {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::LookoutMetrics::UpdateAlert', @_);
    return $self->caller->do_call($self, $call_object);
  }
...
=item [AlertFilters => L<Paws::LookoutMetrics::AlertFilters>]
...
=item [DimensionFilterList => ArrayRef[L<Paws::LookoutMetrics::MetricSetDimensionFilter>]]
...
=head2 DeactivateAnomalyDetector
...
Each argument is described in detail in: L<Paws::LookoutMetrics::DeactivateAnomalyDetector>

Returns: a L<Paws::LookoutMetrics::DeactivateAnomalyDetectorResponse> instance
...
=head2 DetectMetricSetConfig

=over

=item AnomalyDetectorArn => Str

=item AutoDetectionMetricSource => L<Paws::LookoutMetrics::AutoDetectionMetricSource>


=back

Each argument is described in detail in: L<Paws::LookoutMetrics::DetectMetricSetConfig>

Returns: a L<Paws::LookoutMetrics::DetectMetricSetConfigResponse> instance
...
Each argument is described in detail in: L<Paws::LookoutMetrics::GetDataQualityMetrics>

Returns: a L<Paws::LookoutMetrics::GetDataQualityMetricsResponse> instance
...
=head2 ListAnomalyGroupRelatedMetrics
...
=item [RelationshipTypeFilter => Str]


=back

Each argument is described in detail in: L<Paws::LookoutMetrics::ListAnomalyGroupRelatedMetrics>

Returns: a L<Paws::LookoutMetrics::ListAnomalyGroupRelatedMetricsResponse> instance
...
Each argument is described in detail in: L<Paws::LookoutMetrics::UpdateAlert>

Returns: a L<Paws::LookoutMetrics::UpdateAlertResponse> instance
