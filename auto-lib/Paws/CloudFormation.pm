package Paws::CloudFormation;
  ...
  sub ActivateOrganizationsAccess {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CloudFormation::ActivateOrganizationsAccess', @_);
  ...
  sub CreateGeneratedTemplate {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CloudFormation::CreateGeneratedTemplate', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub CreateStack {
    my $self = shift;
  ...
  sub CreateStackRefactor {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CloudFormation::CreateStackRefactor', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub CreateStackSet {
    my $self = shift;
  ...
  sub DeactivateOrganizationsAccess {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CloudFormation::DeactivateOrganizationsAccess', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DeactivateType {
    my $self = shift;
  ...
  sub DeleteGeneratedTemplate {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CloudFormation::DeleteGeneratedTemplate', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DeleteStack {
    my $self = shift;
  ...
  sub DescribeChangeSetHooks {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CloudFormation::DescribeChangeSetHooks', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DescribeGeneratedTemplate {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CloudFormation::DescribeGeneratedTemplate', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DescribeOrganizationsAccess {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CloudFormation::DescribeOrganizationsAccess', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeResourceScan {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CloudFormation::DescribeResourceScan', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeStackRefactor {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CloudFormation::DescribeStackRefactor', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ExecuteStackRefactor {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CloudFormation::ExecuteStackRefactor', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetGeneratedTemplate {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CloudFormation::GetGeneratedTemplate', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetStackPolicy {
    my $self = shift;
  ...
  sub ImportStacksToStackSet {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CloudFormation::ImportStacksToStackSet', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ListChangeSets {
    my $self = shift;
  ...
  sub ListGeneratedTemplates {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CloudFormation::ListGeneratedTemplates', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ListHookResults {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CloudFormation::ListHookResults', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ListImports {
    my $self = shift;
  ...
  sub ListResourceScanRelatedResources {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CloudFormation::ListResourceScanRelatedResources', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ListResourceScanResources {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CloudFormation::ListResourceScanResources', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ListResourceScans {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CloudFormation::ListResourceScans', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ListStackInstanceResourceDrifts {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CloudFormation::ListStackInstanceResourceDrifts', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ListStackRefactorActions {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CloudFormation::ListStackRefactorActions', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ListStackRefactors {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CloudFormation::ListStackRefactors', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ListStackSetAutoDeploymentTargets {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CloudFormation::ListStackSetAutoDeploymentTargets', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub RollbackStack {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CloudFormation::RollbackStack', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub SetStackPolicy {
    my $self = shift;
  ...
  sub StartResourceScan {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CloudFormation::StartResourceScan', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub UpdateGeneratedTemplate {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CloudFormation::UpdateGeneratedTemplate', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub UpdateStack {
    my $self = shift;
  ...
  sub ListAllGeneratedTemplates {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->ListGeneratedTemplates(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->NextToken) {
        $next_result = $self->ListGeneratedTemplates(@_, NextToken => $next_result->NextToken);
        push @{ $result->Summaries }, @{ $next_result->Summaries };
      }
      return $result;
    } else {
      while ($result->NextToken) {
        $callback->($_ => 'Summaries') foreach (@{ $result->Summaries });
        $result = $self->ListGeneratedTemplates(@_, NextToken => $result->NextToken);
      }
      $callback->($_ => 'Summaries') foreach (@{ $result->Summaries });
    }
  ...
  sub ListAllResourceScanRelatedResources {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->ListResourceScanRelatedResources(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->NextToken) {
        $next_result = $self->ListResourceScanRelatedResources(@_, NextToken => $next_result->NextToken);
      ...
      while ($result->NextToken) {
        ...
        $result = $self->ListResourceScanRelatedResources(@_, NextToken => $result->NextToken);
      }
      $callback->($_ => 'RelatedResources') foreach (@{ $result->RelatedResources });
    }
  ...
  sub ListAllResourceScanResources {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->ListResourceScanResources(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->NextToken) {
        $next_result = $self->ListResourceScanResources(@_, NextToken => $next_result->NextToken);
      ...
      while ($result->NextToken) {
        ...
        $result = $self->ListResourceScanResources(@_, NextToken => $result->NextToken);
      }
      $callback->($_ => 'Resources') foreach (@{ $result->Resources });
    }
  ...
  sub ListAllResourceScans {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->ListResourceScans(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->NextToken) {
        $next_result = $self->ListResourceScans(@_, NextToken => $next_result->NextToken);
        push @{ $result->ResourceScanSummaries }, @{ $next_result->ResourceScanSummaries };
      }
      return $result;
    } else {
      while ($result->NextToken) {
        $callback->($_ => 'ResourceScanSummaries') foreach (@{ $result->ResourceScanSummaries });
        $result = $self->ListResourceScans(@_, NextToken => $result->NextToken);
      }
      $callback->($_ => 'ResourceScanSummaries') foreach (@{ $result->ResourceScanSummaries });
    }
  ...
  sub ListAllStackRefactorActions {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->ListStackRefactorActions(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->NextToken) {
        $next_result = $self->ListStackRefactorActions(@_, NextToken => $next_result->NextToken);
        push @{ $result->StackRefactorActions }, @{ $next_result->StackRefactorActions };
      }
      return $result;
    } else {
      while ($result->NextToken) {
        $callback->($_ => 'StackRefactorActions') foreach (@{ $result->StackRefactorActions });
        $result = $self->ListStackRefactorActions(@_, NextToken => $result->NextToken);
      }
      $callback->($_ => 'StackRefactorActions') foreach (@{ $result->StackRefactorActions });
    }
  ...
  sub ListAllStackRefactors {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->ListStackRefactors(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->NextToken) {
        $next_result = $self->ListStackRefactors(@_, NextToken => $next_result->NextToken);
        push @{ $result->StackRefactorSummaries }, @{ $next_result->StackRefactorSummaries };
      }
      return $result;
    } else {
      while ($result->NextToken) {
        $callback->($_ => 'StackRefactorSummaries') foreach (@{ $result->StackRefactorSummaries });
        $result = $self->ListStackRefactors(@_, NextToken => $result->NextToken);
      }
      $callback->($_ => 'StackRefactorSummaries') foreach (@{ $result->StackRefactorSummaries });
    }
...
=head2 ActivateOrganizationsAccess
...
Each argument is described in detail in: L<Paws::CloudFormation::ActivateOrganizationsAccess>

Returns: a L<Paws::CloudFormation::ActivateOrganizationsAccessOutput> instance
...
extension in your account and Region, use SetTypeConfiguration
...
information, see Using public extensions
...
You can cancel only stacks that are in the C<UPDATE_IN_PROGRESS> state.
...
For a specified stack that's in the C<UPDATE_ROLLBACK_FAILED> state,
...
A stack goes into the C<UPDATE_ROLLBACK_FAILED> state when
...
C<CreateChangeSet> call successfully completes, CloudFormation starts
...
=head2 CreateGeneratedTemplate

=over

=item GeneratedTemplateName => Str

=item [Resources => ArrayRef[L<Paws::CloudFormation::ResourceDefinition>]]

=item [StackName => Str]

=item [TemplateConfiguration => L<Paws::CloudFormation::TemplateConfiguration>]


=back

Each argument is described in detail in: L<Paws::CloudFormation::CreateGeneratedTemplate>

Returns: a L<Paws::CloudFormation::CreateGeneratedTemplateOutput> instance

Creates a template from existing resources that are not already managed
with CloudFormation. You can check the status of the template
generation using the C<DescribeGeneratedTemplate> API action.
...
=item [RetainExceptOnCreate => Bool]
...
value for either C<Accounts> or C<DeploymentTargets>, and you must
specify at least one value for C<Regions>.


=head2 CreateStackRefactor

=over

=item StackDefinitions => ArrayRef[L<Paws::CloudFormation::StackDefinition>]

=item [Description => Str]

=item [EnableStackCreation => Bool]

=item [ResourceMappings => ArrayRef[L<Paws::CloudFormation::ResourceMapping>]]


=back

Each argument is described in detail in: L<Paws::CloudFormation::CreateStackRefactor>

Returns: a L<Paws::CloudFormation::CreateStackRefactorOutput> instance
...
=item [ManagedExecution => L<Paws::CloudFormation::ManagedExecution>]
...
=head2 DeactivateOrganizationsAccess
...
Each argument is described in detail in: L<Paws::CloudFormation::DeactivateOrganizationsAccess>

Returns: a L<Paws::CloudFormation::DeactivateOrganizationsAccessOutput> instance
...
Each argument is described in detail in: L<Paws::CloudFormation::DeleteGeneratedTemplate>
...
information about account limits, see Understand CloudFormation quotas
...
=item [IncludePropertyValues => Bool]
...
information, see Update CloudFormation stacks using change sets
(https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-changesets.html)
in the I<CloudFormation User Guide>.


=head2 DescribeChangeSetHooks
...
Each argument is described in detail in: L<Paws::CloudFormation::DescribeChangeSetHooks>

Returns: a L<Paws::CloudFormation::DescribeChangeSetHooksOutput> instance
...
=head2 DescribeGeneratedTemplate
...
Each argument is described in detail in: L<Paws::CloudFormation::DescribeGeneratedTemplate>

Returns: a L<Paws::CloudFormation::DescribeGeneratedTemplateOutput> instance
...
C<CreateGeneratedTemplate> API action or the update of a generated
template started with an C<UpdateGeneratedTemplate> API action.


=head2 DescribeOrganizationsAccess
...
Each argument is described in detail in: L<Paws::CloudFormation::DescribeOrganizationsAccess>

Returns: a L<Paws::CloudFormation::DescribeOrganizationsAccessOutput> instance

Retrieves information about the account's C<OrganizationAccess> status.
This API can be called either by the management account or the
delegated administrator by using the C<CallAs> parameter. This API can
also be called without the C<CallAs> parameter by the management
account.
...
=head2 DescribeResourceScan

=over

=item ResourceScanId => Str


=back

Each argument is described in detail in: L<Paws::CloudFormation::DescribeResourceScan>

Returns: a L<Paws::CloudFormation::DescribeResourceScanOutput> instance
...
if one or more of its resources have drifted. For more information
about stack and resource drift, see Detect unmanaged configuration
changes to stacks and resources with drift detection
...
=head2 DescribeStackRefactor

=over

=item StackRefactorId => Str


=back

Each argument is described in detail in: L<Paws::CloudFormation::DescribeStackRefactor>

Returns: a L<Paws::CloudFormation::DescribeStackRefactorOutput> instance
...
deleted stacks. If C<StackName> is specified, all the associated
resources that are part of the stack are returned. If
C<PhysicalResourceId> is specified, the associated resources of the
...
C<LogicalResourceId> and C<PhysicalResourceId>, see the CloudFormation
User Guide
...
If the stack doesn't exist, a C<ValidationError> is returned.
...
I<drifted>, from its expected configuration, as defined in the stack
...
template configurations. For more information, see Detect unmanaged
...
any nested stacks belonging to that stack. Perform C<DetectStackDrift>
...
drift. For more information about stack and resource drift, see Detect
...
set, including detailed information about the last I<completed> drift
operation performed on the stack set. (Information about drift
operations that are in progress isn't included.)

=item *

Use ListStackInstances to return a list of stack instances belonging to
the stack set, including the drift status and last drift time checked
of each instance.
...
Each argument is described in detail in: L<Paws::CloudFormation::ExecuteStackRefactor>
...
Each argument is described in detail in: L<Paws::CloudFormation::GetGeneratedTemplate>

Returns: a L<Paws::CloudFormation::GetGeneratedTemplateOutput> instance

Retrieves a generated template. If the template is in an C<InProgress>
or C<Pending> status then the template returned will be the template
when the template was last in a C<Complete> status. If the template has
not yet been in a C<Complete> status then an empty template will be
returned.
...
For deleted stacks, C<GetTemplate> returns the template for up to 90
days after the stack has been deleted.

If the template doesn't exist, a C<ValidationError> is returned.
...
=item [TemplateSummaryConfig => L<Paws::CloudFormation::TemplateSummaryConfig>]
...
template doesn't exist, a C<ValidationError> is returned.


=head2 ImportStacksToStackSet
...
=item [OrganizationalUnitIds => ArrayRef[Str|Undef]]

=item [StackIds => ArrayRef[Str|Undef]]

=item [StackIdsUrl => Str]


=back

Each argument is described in detail in: L<Paws::CloudFormation::ImportStacksToStackSet>

Returns: a L<Paws::CloudFormation::ImportStacksToStackSetOutput> instance
...
Each argument is described in detail in: L<Paws::CloudFormation::ListGeneratedTemplates>

Returns: a L<Paws::CloudFormation::ListGeneratedTemplatesOutput> instance

Lists your generated templates in this Region.


=head2 ListHookResults
...
Each argument is described in detail in: L<Paws::CloudFormation::ListHookResults>

Returns: a L<Paws::CloudFormation::ListHookResultsOutput> instance
...
=head2 ListResourceScanRelatedResources

=over

=item Resources => ArrayRef[L<Paws::CloudFormation::ScannedResourceIdentifier>]
...
Each argument is described in detail in: L<Paws::CloudFormation::ListResourceScanRelatedResources>

Returns: a L<Paws::CloudFormation::ListResourceScanRelatedResourcesOutput> instance
...
=head2 ListResourceScanResources
...
Each argument is described in detail in: L<Paws::CloudFormation::ListResourceScanResources>

Returns: a L<Paws::CloudFormation::ListResourceScanResourcesOutput> instance
...
=item [ScanTypeFilter => Str]


=back

Each argument is described in detail in: L<Paws::CloudFormation::ListResourceScans>

Returns: a L<Paws::CloudFormation::ListResourceScansOutput> instance

List the resource scans from newest to oldest. By default it will
return up to 10 resource scans.


=head2 ListStackInstanceResourceDrifts
...
=item [StackInstanceResourceDriftStatuses => ArrayRef[Str|Undef]]


=back

Each argument is described in detail in: L<Paws::CloudFormation::ListStackInstanceResourceDrifts>

Returns: a L<Paws::CloudFormation::ListStackInstanceResourceDriftsOutput> instance

Returns drift information for resources in a stack instance.

C<ListStackInstanceResourceDrifts> returns drift information for the
...
=head2 ListStackRefactorActions
...
Each argument is described in detail in: L<Paws::CloudFormation::ListStackRefactorActions>

Returns: a L<Paws::CloudFormation::ListStackRefactorActionsOutput> instance

Lists the stack refactor actions that will be taken after calling the
ExecuteStackRefactor action.


=head2 ListStackRefactors

=over

=item [ExecutionStatusFilter => ArrayRef[Str|Undef]]
...
Each argument is described in detail in: L<Paws::CloudFormation::ListStackRefactors>

Returns: a L<Paws::CloudFormation::ListStackRefactorsOutput> instance
...
specified C<StackStatusFilter>. Summary information for stacks that
have been deleted is kept for 90 days after the stack is deleted. If no
C<StackStatusFilter> is specified, summary information for all stacks
is returned (including existing stacks and stacks that have been
deleted).


=head2 ListStackSetAutoDeploymentTargets
...
Each argument is described in detail in: L<Paws::CloudFormation::ListStackSetAutoDeploymentTargets>

Returns: a L<Paws::CloudFormation::ListStackSetAutoDeploymentTargetsOutput> instance
...
=item [Filters => ArrayRef[L<Paws::CloudFormation::OperationResultFilter>]]
...
C<SELF> while signed in to your Amazon Web Services account,
C<ListStackSets> returns all self-managed stack sets in your Amazon Web
Services account.
...
(https://docs.aws.amazon.com/AWSCloudFormation/latest/APIReference/API_SetTypeConfiguration.html)
to specify configuration properties for the extension. For more
information, see Edit configuration data for extensions in your account
(https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/registry-set-configuration.html)
in the I<CloudFormation User Guide>.
...
Each argument is described in detail in: L<Paws::CloudFormation::RollbackStack>

Returns: a L<Paws::CloudFormation::RollbackStackOutput> instance

When specifying C<RollbackStack>, you preserve the state of previously
...
C<CREATE_FAILED> or C<UPDATE_FAILED> stack statuses.
...
C<*_COMPLETE>. This includes the following stack statuses.
...
C<ConfigurationSchema> element of DescribeType
(https://docs.aws.amazon.com/AWSCloudFormation/latest/APIReference/API_DescribeType.html).
For more information, see Edit configuration data for extensions in
your account
(https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/registry-set-configuration.html)
...
status. You can use the C<SignalResource> operation in conjunction with
...
of signals or the timeout period is exceeded. The C<SignalResource>
...
=item [ScanFilters => ArrayRef[L<Paws::CloudFormation::ScanFilter>]]


=back

Each argument is described in detail in: L<Paws::CloudFormation::StartResourceScan>

Returns: a L<Paws::CloudFormation::StartResourceScanOutput> instance

Starts a scan of the resources in this account in this Region. You can
the status of a scan using the C<ListResourceScans> API action.
...
can pass the returned C<TypeVersionArn> into DescribeType
(https://docs.aws.amazon.com/AWSCloudFormation/latest/APIReference/API_DescribeType.html)
...
=head2 UpdateGeneratedTemplate

=over

=item GeneratedTemplateName => Str

=item [AddResources => ArrayRef[L<Paws::CloudFormation::ResourceDefinition>]]

=item [NewGeneratedTemplateName => Str]

=item [RefreshAllResources => Bool]

=item [RemoveResources => ArrayRef[Str|Undef]]
...
Each argument is described in detail in: L<Paws::CloudFormation::UpdateGeneratedTemplate>

Returns: a L<Paws::CloudFormation::UpdateGeneratedTemplateOutput> instance
...
C<DeletionPolicy> and C<UpdateReplacePolicy> settings. You can check
the status of the update to the generated template using the
C<DescribeGeneratedTemplate> API action.
...
unit with CloudFormation stacks
(https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacks.html)
in the I<CloudFormation User Guide>.
...
see Protect a CloudFormation stack from being deleted
...
=head2 DescribeAllChangeSet(sub { },ChangeSetName => Str, [IncludePropertyValues => Bool, NextToken => Str, StackName => Str])

=head2 DescribeAllChangeSet(ChangeSetName => Str, [IncludePropertyValues => Bool, NextToken => Str, StackName => Str])
...
=head2 ListAllGeneratedTemplates(sub { },[MaxResults => Int, NextToken => Str])

=head2 ListAllGeneratedTemplates([MaxResults => Int, NextToken => Str])
...
If not, it will return a a L<Paws::CloudFormation::ListGeneratedTemplatesOutput> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
...
=head2 ListAllResourceScanRelatedResources(sub { },Resources => ArrayRef[L<Paws::CloudFormation::ScannedResourceIdentifier>], ResourceScanId => Str, [MaxResults => Int, NextToken => Str])

=head2 ListAllResourceScanRelatedResources(Resources => ArrayRef[L<Paws::CloudFormation::ScannedResourceIdentifier>], ResourceScanId => Str, [MaxResults => Int, NextToken => Str])
...
If not, it will return a a L<Paws::CloudFormation::ListResourceScanRelatedResourcesOutput> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.


=head2 ListAllResourceScanResources(sub { },ResourceScanId => Str, [MaxResults => Int, NextToken => Str, ResourceIdentifier => Str, ResourceTypePrefix => Str, TagKey => Str, TagValue => Str])

=head2 ListAllResourceScanResources(ResourceScanId => Str, [MaxResults => Int, NextToken => Str, ResourceIdentifier => Str, ResourceTypePrefix => Str, TagKey => Str, TagValue => Str])
...
If not, it will return a a L<Paws::CloudFormation::ListResourceScanResourcesOutput> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.


=head2 ListAllResourceScans(sub { },[MaxResults => Int, NextToken => Str, ScanTypeFilter => Str])

=head2 ListAllResourceScans([MaxResults => Int, NextToken => Str, ScanTypeFilter => Str])


If passed a sub as first parameter, it will call the sub for each element found in :

 - ResourceScanSummaries, passing the object as the first parameter, and the string 'ResourceScanSummaries' as the second parameter 

If not, it will return a a L<Paws::CloudFormation::ListResourceScansOutput> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
...
=head2 ListAllStackRefactorActions(sub { },StackRefactorId => Str, [MaxResults => Int, NextToken => Str])

=head2 ListAllStackRefactorActions(StackRefactorId => Str, [MaxResults => Int, NextToken => Str])


If passed a sub as first parameter, it will call the sub for each element found in :

 - StackRefactorActions, passing the object as the first parameter, and the string 'StackRefactorActions' as the second parameter 

If not, it will return a a L<Paws::CloudFormation::ListStackRefactorActionsOutput> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.


=head2 ListAllStackRefactors(sub { },[ExecutionStatusFilter => ArrayRef[Str|Undef], MaxResults => Int, NextToken => Str])

=head2 ListAllStackRefactors([ExecutionStatusFilter => ArrayRef[Str|Undef], MaxResults => Int, NextToken => Str])


If passed a sub as first parameter, it will call the sub for each element found in :

 - StackRefactorSummaries, passing the object as the first parameter, and the string 'StackRefactorSummaries' as the second parameter 

If not, it will return a a L<Paws::CloudFormation::ListStackRefactorsOutput> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
...
=head2 ListAllStackSetOperationResults(sub { },OperationId => Str, StackSetName => Str, [CallAs => Str, Filters => ArrayRef[L<Paws::CloudFormation::OperationResultFilter>], MaxResults => Int, NextToken => Str])

=head2 ListAllStackSetOperationResults(OperationId => Str, StackSetName => Str, [CallAs => Str, Filters => ArrayRef[L<Paws::CloudFormation::OperationResultFilter>], MaxResults => Int, NextToken => Str])
