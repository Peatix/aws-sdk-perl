...
package Paws::DataZone::GlueRunConfigurationInput;
  use Moose;
...
Paws::DataZone::GlueRunConfigurationInput
...
As an example, if Att1 is expected to be a Paws::DataZone::GlueRunConfigurationInput object:

  $service_obj->Method(Att1 => { AutoImportDataQualityResult => $value, ..., RelationalFilterConfigurations => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::DataZone::GlueRunConfigurationInput object:

  $result = $service_obj->Method(...);
  $result->Att1->AutoImportDataQualityResult
