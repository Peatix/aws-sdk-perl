...
package Paws::DataZone::SearchListingsOutput;
  use Moose;
  has Items => (is => 'ro', isa => 'ArrayRef[Paws::DataZone::SearchResultItem]', traits => ['NameInRequest'], request_name => 'items');
...
Paws::DataZone::SearchListingsOutput

=head1 ATTRIBUTES


=head2 Items => ArrayRef[L<Paws::DataZone::SearchResultItem>]

The results of the C<SearchListings> action.
