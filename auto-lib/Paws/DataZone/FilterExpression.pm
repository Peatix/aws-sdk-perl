...
package Paws::DataZone::FilterExpression;
  use Moose;
...
Paws::DataZone::FilterExpression
...
As an example, if Att1 is expected to be a Paws::DataZone::FilterExpression object:

  $service_obj->Method(Att1 => { Expression => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::DataZone::FilterExpression object:
