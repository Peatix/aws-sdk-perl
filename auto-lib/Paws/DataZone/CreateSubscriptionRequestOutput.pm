...
package Paws::DataZone::CreateSubscriptionRequestOutput;
  use Moose;
...
Paws::DataZone::CreateSubscriptionRequestOutput
...
The ID of the Amazon DataZone domain in whcih the subscription request
is created.
