...
package Paws::DataZone::ListDomainsOutput;
  use Moose;
  has Items => (is => 'ro', isa => 'ArrayRef[Paws::DataZone::DomainSummary]', traits => ['NameInRequest'], request_name => 'items', required => 1);
...
Paws::DataZone::ListDomainsOutput

=head1 ATTRIBUTES


=head2 B<REQUIRED> Items => ArrayRef[L<Paws::DataZone::DomainSummary>]

The results of the C<ListDomains> action.
