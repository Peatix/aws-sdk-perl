...
package Paws::DataZone::DeleteAsset;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::DataZone::DeleteAssetOutput');
1;
...
Paws::DataZone::DeleteAsset - Arguments for method DeleteAsset on L<Paws::DataZone>
...
=head1 SYNOPSIS
    ...
    my $DeleteAssetOutput = $datazone->DeleteAsset(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/datazone/DeleteAsset>
...
This class forms part of L<Paws>, documenting arguments for method DeleteAsset in L<Paws::DataZone>
