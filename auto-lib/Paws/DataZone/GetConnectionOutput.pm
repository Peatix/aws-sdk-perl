...
package Paws::DataZone::GetConnectionOutput;
  use Moose;
  has ConnectionCredentials => (is => 'ro', isa => 'Paws::DataZone::ConnectionCredentials', traits => ['NameInRequest'], request_name => 'connectionCredentials');
  ...
  has EnvironmentUserRole => (is => 'ro', isa => 'Str', traits => ['NameInRequest'], request_name => 'environmentUserRole');
...
Paws::DataZone::GetConnectionOutput

=head1 ATTRIBUTES


=head2 ConnectionCredentials => L<Paws::DataZone::ConnectionCredentials>
