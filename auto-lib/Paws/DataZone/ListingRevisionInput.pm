...
package Paws::DataZone::ListingRevisionInput;
  use Moose;
...
Paws::DataZone::ListingRevisionInput
...
As an example, if Att1 is expected to be a Paws::DataZone::ListingRevisionInput object:

  $service_obj->Method(Att1 => { Identifier => $value, ..., Revision => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::DataZone::ListingRevisionInput object:
