...
package Paws::DataZone::AddPolicyGrant;
  use Moose;
  has ClientToken => (is => 'ro', isa => 'Str', traits => ['NameInRequest'], request_name => 'clientToken');
  has Detail => (is => 'ro', isa => 'Paws::DataZone::PolicyGrantDetail', traits => ['NameInRequest'], request_name => 'detail', required => 1);
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'AddPolicyGrant');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/v2/domains/{domainIdentifier}/policies/managed/{entityType}/{entityIdentifier}/addGrant');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::DataZone::AddPolicyGrantOutput');
1;
...
Paws::DataZone::AddPolicyGrant - Arguments for method AddPolicyGrant on L<Paws::DataZone>

=head1 DESCRIPTION

This class represents the parameters used for calling the method AddPolicyGrant on the
L<Amazon DataZone|Paws::DataZone> service. Use the attributes of this class
as arguments to method AddPolicyGrant.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to AddPolicyGrant.

=head1 SYNOPSIS

    my $datazone = Paws->service('DataZone');
    my $AddPolicyGrantOutput = $datazone->AddPolicyGrant(
      Detail => {
        ...
        CreateEnvironmentProfile => {
          DomainUnitId => 'MyDomainUnitId',    # min: 1, max: 256; OPTIONAL
        },    # OPTIONAL
        CreateFormType => {
          IncludeChildDomainUnits => 1,    # OPTIONAL
        },    # OPTIONAL
        ...
        CreateProjectFromProjectProfile => {
          IncludeChildDomainUnits => 1,                      # OPTIONAL
          ProjectProfiles         => [ 'MyString', ... ],    # OPTIONAL
        },    # OPTIONAL
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/datazone/AddPolicyGrant>
...
=head2 B<REQUIRED> Detail => L<Paws::DataZone::PolicyGrantDetail>
...
This class forms part of L<Paws>, documenting arguments for method AddPolicyGrant in L<Paws::DataZone>
