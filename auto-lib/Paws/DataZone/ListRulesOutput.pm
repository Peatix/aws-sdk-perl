...
package Paws::DataZone::ListRulesOutput;
  use Moose;
  has Items => (is => 'ro', isa => 'ArrayRef[Paws::DataZone::RuleSummary]', traits => ['NameInRequest'], request_name => 'items', required => 1);
...
Paws::DataZone::ListRulesOutput

=head1 ATTRIBUTES


=head2 B<REQUIRED> Items => ArrayRef[L<Paws::DataZone::RuleSummary>]

The results of the C<ListRules> action.
