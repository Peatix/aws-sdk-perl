...
package Paws::DataZone::ConnectionCredentials;
  use Moose;
  has AccessKeyId => (is => 'ro', isa => 'Str', request_name => 'accessKeyId', traits => ['NameInRequest']);
  has Expiration => (is => 'ro', isa => 'Str', request_name => 'expiration', traits => ['NameInRequest']);
...
Paws::DataZone::ConnectionCredentials
...
As an example, if Att1 is expected to be a Paws::DataZone::ConnectionCredentials object:

  $service_obj->Method(Att1 => { AccessKeyId => $value, ..., SessionToken => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::DataZone::ConnectionCredentials object:
