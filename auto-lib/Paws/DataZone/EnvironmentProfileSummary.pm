...
package Paws::DataZone::EnvironmentProfileSummary;
  use Moose;
...
Paws::DataZone::EnvironmentProfileSummary
...
As an example, if Att1 is expected to be a Paws::DataZone::EnvironmentProfileSummary object:

  $service_obj->Method(Att1 => { AwsAccountId => $value, ..., UpdatedAt => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::DataZone::EnvironmentProfileSummary object:
