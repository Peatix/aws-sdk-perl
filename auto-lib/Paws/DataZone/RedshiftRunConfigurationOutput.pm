...
package Paws::DataZone::RedshiftRunConfigurationOutput;
  use Moose;
  ...
  has RedshiftStorage => (is => 'ro', isa => 'Paws::DataZone::RedshiftStorage', request_name => 'redshiftStorage', traits => ['NameInRequest'], required => 1);
...
Paws::DataZone::RedshiftRunConfigurationOutput
...
As an example, if Att1 is expected to be a Paws::DataZone::RedshiftRunConfigurationOutput object:

  $service_obj->Method(Att1 => { AccountId => $value, ..., RelationalFilterConfigurations => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::DataZone::RedshiftRunConfigurationOutput object:
...
=head2 B<REQUIRED> RedshiftStorage => L<Paws::DataZone::RedshiftStorage>
