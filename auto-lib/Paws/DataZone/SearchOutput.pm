...
package Paws::DataZone::SearchOutput;
  use Moose;
  has Items => (is => 'ro', isa => 'ArrayRef[Paws::DataZone::SearchInventoryResultItem]', traits => ['NameInRequest'], request_name => 'items');
...
Paws::DataZone::SearchOutput

=head1 ATTRIBUTES


=head2 Items => ArrayRef[L<Paws::DataZone::SearchInventoryResultItem>]

The results of the C<Search> action.
