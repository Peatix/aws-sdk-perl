...
package Paws::DataZone::GluePropertiesOutput;
  use Moose;
...
Paws::DataZone::GluePropertiesOutput
...
As an example, if Att1 is expected to be a Paws::DataZone::GluePropertiesOutput object:

  $service_obj->Method(Att1 => { ErrorMessage => $value, ..., Status => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::DataZone::GluePropertiesOutput object:
