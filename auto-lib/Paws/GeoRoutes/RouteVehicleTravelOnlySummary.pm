...
package Paws::GeoRoutes::RouteVehicleTravelOnlySummary;
  use Moose;
...
Paws::GeoRoutes::RouteVehicleTravelOnlySummary
...
As an example, if Att1 is expected to be a Paws::GeoRoutes::RouteVehicleTravelOnlySummary object:

  $service_obj->Method(Att1 => { BestCaseDuration => $value, ..., TypicalDuration => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::GeoRoutes::RouteVehicleTravelOnlySummary object:
