...
package Paws::GeoRoutes::RouteMatrixAvoidanceOptions;
  use Moose;
  has Areas => (is => 'ro', isa => 'ArrayRef[Paws::GeoRoutes::RouteMatrixAvoidanceArea]');
  ...
  has ZoneCategories => (is => 'ro', isa => 'ArrayRef[Paws::GeoRoutes::RouteMatrixAvoidanceZoneCategory]');
...
Paws::GeoRoutes::RouteMatrixAvoidanceOptions
...
As an example, if Att1 is expected to be a Paws::GeoRoutes::RouteMatrixAvoidanceOptions object:

  $service_obj->Method(Att1 => { Areas => $value, ..., ZoneCategories => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::GeoRoutes::RouteMatrixAvoidanceOptions object:
...
=head2 Areas => ArrayRef[L<Paws::GeoRoutes::RouteMatrixAvoidanceArea>]
...
=head2 ZoneCategories => ArrayRef[L<Paws::GeoRoutes::RouteMatrixAvoidanceZoneCategory>]
