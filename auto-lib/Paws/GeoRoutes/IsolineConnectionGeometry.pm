...
package Paws::GeoRoutes::IsolineConnectionGeometry;
  use Moose;
...
Paws::GeoRoutes::IsolineConnectionGeometry
...
As an example, if Att1 is expected to be a Paws::GeoRoutes::IsolineConnectionGeometry object:

  $service_obj->Method(Att1 => { LineString => $value, ..., Polyline => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::GeoRoutes::IsolineConnectionGeometry object:
