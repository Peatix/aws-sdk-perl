...
package Paws::GeoRoutes::RouteTruckOptions;
  use Moose;
  ...
  has Trailer => (is => 'ro', isa => 'Paws::GeoRoutes::RouteTrailerOptions');
...
Paws::GeoRoutes::RouteTruckOptions
...
As an example, if Att1 is expected to be a Paws::GeoRoutes::RouteTruckOptions object:

  $service_obj->Method(Att1 => { AxleCount => $value, ..., Width => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::GeoRoutes::RouteTruckOptions object:
...
=head2 Trailer => L<Paws::GeoRoutes::RouteTrailerOptions>
