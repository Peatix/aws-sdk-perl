...
package Paws::GeoRoutes::IsolineAvoidanceOptions;
  use Moose;
  has Areas => (is => 'ro', isa => 'ArrayRef[Paws::GeoRoutes::IsolineAvoidanceArea]');
  ...
  has ZoneCategories => (is => 'ro', isa => 'ArrayRef[Paws::GeoRoutes::IsolineAvoidanceZoneCategory]');
...
Paws::GeoRoutes::IsolineAvoidanceOptions
...
As an example, if Att1 is expected to be a Paws::GeoRoutes::IsolineAvoidanceOptions object:

  $service_obj->Method(Att1 => { Areas => $value, ..., ZoneCategories => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::GeoRoutes::IsolineAvoidanceOptions object:
...
=head2 Areas => ArrayRef[L<Paws::GeoRoutes::IsolineAvoidanceArea>]
...
=head2 ZoneCategories => ArrayRef[L<Paws::GeoRoutes::IsolineAvoidanceZoneCategory>]
