...
package Paws::GeoRoutes::RouteMatchingOptions;
  use Moose;
...
Paws::GeoRoutes::RouteMatchingOptions
...
As an example, if Att1 is expected to be a Paws::GeoRoutes::RouteMatchingOptions object:

  $service_obj->Method(Att1 => { NameHint => $value, ..., Strategy => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::GeoRoutes::RouteMatchingOptions object:
