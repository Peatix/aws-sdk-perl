...
package Paws::GeoRoutes::RouteResponseNotice;
  use Moose;
...
Paws::GeoRoutes::RouteResponseNotice
...
As an example, if Att1 is expected to be a Paws::GeoRoutes::RouteResponseNotice object:

  $service_obj->Method(Att1 => { Code => $value, ..., Impact => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::GeoRoutes::RouteResponseNotice object:
