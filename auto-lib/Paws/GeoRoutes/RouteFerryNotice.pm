...
package Paws::GeoRoutes::RouteFerryNotice;
  use Moose;
...
Paws::GeoRoutes::RouteFerryNotice
...
As an example, if Att1 is expected to be a Paws::GeoRoutes::RouteFerryNotice object:

  $service_obj->Method(Att1 => { Code => $value, ..., Impact => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::GeoRoutes::RouteFerryNotice object:
