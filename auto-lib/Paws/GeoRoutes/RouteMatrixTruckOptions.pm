...
package Paws::GeoRoutes::RouteMatrixTruckOptions;
  use Moose;
  ...
  has Trailer => (is => 'ro', isa => 'Paws::GeoRoutes::RouteMatrixTrailerOptions');
...
Paws::GeoRoutes::RouteMatrixTruckOptions
...
As an example, if Att1 is expected to be a Paws::GeoRoutes::RouteMatrixTruckOptions object:

  $service_obj->Method(Att1 => { AxleCount => $value, ..., Width => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::GeoRoutes::RouteMatrixTruckOptions object:
...
=head2 Trailer => L<Paws::GeoRoutes::RouteMatrixTrailerOptions>
