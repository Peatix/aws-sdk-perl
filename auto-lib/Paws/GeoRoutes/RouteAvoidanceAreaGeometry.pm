...
package Paws::GeoRoutes::RouteAvoidanceAreaGeometry;
  use Moose;
...
Paws::GeoRoutes::RouteAvoidanceAreaGeometry
...
As an example, if Att1 is expected to be a Paws::GeoRoutes::RouteAvoidanceAreaGeometry object:

  $service_obj->Method(Att1 => { BoundingBox => $value, ..., PolylinePolygon => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::GeoRoutes::RouteAvoidanceAreaGeometry object:
