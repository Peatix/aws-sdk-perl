...
package Paws::AccessAnalyzer::RecommendationError;
  use Moose;
...
Paws::AccessAnalyzer::RecommendationError
...
As an example, if Att1 is expected to be a Paws::AccessAnalyzer::RecommendationError object:

  $service_obj->Method(Att1 => { Code => $value, ..., Message => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::AccessAnalyzer::RecommendationError object:
