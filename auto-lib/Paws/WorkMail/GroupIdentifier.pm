...
package Paws::WorkMail::GroupIdentifier;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::WorkMail::GroupIdentifier object:

  $service_obj->Method(Att1 => { GroupId => $value, ..., GroupName => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::WorkMail::GroupIdentifier object:
