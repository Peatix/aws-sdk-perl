...
package Paws::Inspector2::LambdaVpcConfig;
  use Moose;
...
Paws::Inspector2::LambdaVpcConfig
...
As an example, if Att1 is expected to be a Paws::Inspector2::LambdaVpcConfig object:

  $service_obj->Method(Att1 => { SecurityGroupIds => $value, ..., VpcId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Inspector2::LambdaVpcConfig object:
...
Services Lambda function. For more information, see VPC Settings
