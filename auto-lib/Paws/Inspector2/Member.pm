...
package Paws::Inspector2::Member;
  use Moose;
  has AccountId => (is => 'ro', isa => 'Str', request_name => 'accountId', traits => ['NameInRequest']);
  has DelegatedAdminAccountId => (is => 'ro', isa => 'Str', request_name => 'delegatedAdminAccountId', traits => ['NameInRequest']);
...
As an example, if Att1 is expected to be a Paws::Inspector2::Member object:

  $service_obj->Method(Att1 => { AccountId => $value, ..., UpdatedAt => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Inspector2::Member object:
...
=head2 DelegatedAdminAccountId => Str
