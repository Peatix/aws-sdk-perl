...
package Paws::Inspector2::DelegatedAdmin;
  use Moose;
...
Paws::Inspector2::DelegatedAdmin
...
As an example, if Att1 is expected to be a Paws::Inspector2::DelegatedAdmin object:

  $service_obj->Method(Att1 => { AccountId => $value, ..., RelationshipStatus => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Inspector2::DelegatedAdmin object:
