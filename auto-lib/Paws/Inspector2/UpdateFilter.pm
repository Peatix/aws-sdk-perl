...
package Paws::Inspector2::UpdateFilter;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/filters/update');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Inspector2::UpdateFilterResponse');
1;
...
Paws::Inspector2::UpdateFilter - Arguments for method UpdateFilter on L<Paws::Inspector2>
...
=head1 SYNOPSIS
    ...
    my $UpdateFilterResponse = $inspector2->UpdateFilter(
      FilterArn      => 'MyFilterArn',
    ...
    # Results:
    my $Arn = $UpdateFilterResponse->Arn;

    # Returns a L<Paws::Inspector2::UpdateFilterResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/inspector2/UpdateFilter>
...
This class forms part of L<Paws>, documenting arguments for method UpdateFilter in L<Paws::Inspector2>
