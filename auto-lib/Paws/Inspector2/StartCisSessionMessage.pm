...
package Paws::Inspector2::StartCisSessionMessage;
  use Moose;
...
Paws::Inspector2::StartCisSessionMessage
...
As an example, if Att1 is expected to be a Paws::Inspector2::StartCisSessionMessage object:

  $service_obj->Method(Att1 => { SessionToken => $value, ..., SessionToken => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Inspector2::StartCisSessionMessage object:
