...
package Paws::Inspector2::FindingDetailsError;
  use Moose;
...
Paws::Inspector2::FindingDetailsError
...
As an example, if Att1 is expected to be a Paws::Inspector2::FindingDetailsError object:

  $service_obj->Method(Att1 => { ErrorCode => $value, ..., FindingArn => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Inspector2::FindingDetailsError object:
