...
package Paws::Inspector2::Recommendation;
  use Moose;
...
Paws::Inspector2::Recommendation
...
As an example, if Att1 is expected to be a Paws::Inspector2::Recommendation object:

  $service_obj->Method(Att1 => { Text => $value, ..., Url => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Inspector2::Recommendation object:
