...
package Paws::CleanRooms::GetMembership;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::CleanRooms::GetMembershipOutput');
1;
...
Paws::CleanRooms::GetMembership - Arguments for method GetMembership on L<Paws::CleanRooms>
...
=head1 SYNOPSIS
    ...
    my $GetMembershipOutput = $cleanrooms->GetMembership(
      MembershipIdentifier => 'MyMembershipIdentifier',

    );

    # Results:
    my $Membership = $GetMembershipOutput->Membership;

    # Returns a L<Paws::CleanRooms::GetMembershipOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/cleanrooms/GetMembership>
...
This class forms part of L<Paws>, documenting arguments for method GetMembership in L<Paws::CleanRooms>
