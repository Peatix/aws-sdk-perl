...
package Paws::CleanRooms::CollaborationConfiguredAudienceModelAssociationSummary;
  use Moose;
...
Paws::CleanRooms::CollaborationConfiguredAudienceModelAssociationSummary
...
As an example, if Att1 is expected to be a Paws::CleanRooms::CollaborationConfiguredAudienceModelAssociationSummary object:

  $service_obj->Method(Att1 => { Arn => $value, ..., UpdateTime => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CleanRooms::CollaborationConfiguredAudienceModelAssociationSummary object:
