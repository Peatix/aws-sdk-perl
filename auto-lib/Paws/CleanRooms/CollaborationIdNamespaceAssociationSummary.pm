...
package Paws::CleanRooms::CollaborationIdNamespaceAssociationSummary;
  use Moose;
...
Paws::CleanRooms::CollaborationIdNamespaceAssociationSummary
...
As an example, if Att1 is expected to be a Paws::CleanRooms::CollaborationIdNamespaceAssociationSummary object:

  $service_obj->Method(Att1 => { Arn => $value, ..., UpdateTime => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CleanRooms::CollaborationIdNamespaceAssociationSummary object:
