...
package Paws::CleanRooms::QueryConstraintRequireOverlap;
  use Moose;
...
Paws::CleanRooms::QueryConstraintRequireOverlap
...
As an example, if Att1 is expected to be a Paws::CleanRooms::QueryConstraintRequireOverlap object:

  $service_obj->Method(Att1 => { Columns => $value, ..., Columns => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CleanRooms::QueryConstraintRequireOverlap object:
