...
package Paws::CleanRooms::IdMappingTableSummary;
  use Moose;
...
Paws::CleanRooms::IdMappingTableSummary
...
As an example, if Att1 is expected to be a Paws::CleanRooms::IdMappingTableSummary object:

  $service_obj->Method(Att1 => { Arn => $value, ..., UpdateTime => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CleanRooms::IdMappingTableSummary object:
