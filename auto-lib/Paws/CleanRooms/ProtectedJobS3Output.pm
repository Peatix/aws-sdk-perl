...
package Paws::CleanRooms::ProtectedJobS3Output;
  use Moose;
...
Paws::CleanRooms::ProtectedJobS3Output
...
As an example, if Att1 is expected to be a Paws::CleanRooms::ProtectedJobS3Output object:

  $service_obj->Method(Att1 => { Location => $value, ..., Location => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CleanRooms::ProtectedJobS3Output object:
