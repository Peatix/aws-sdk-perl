...
package Paws::CleanRooms::ListMembers;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/collaborations/{collaborationIdentifier}/members');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::CleanRooms::ListMembersOutput');
1;
...
Paws::CleanRooms::ListMembers - Arguments for method ListMembers on L<Paws::CleanRooms>
...
=head1 SYNOPSIS
    ...
    my $ListMembersOutput = $cleanrooms->ListMembers(
    ...
    # Results:
    my $MemberSummaries = $ListMembersOutput->MemberSummaries;
    my $NextToken       = $ListMembersOutput->NextToken;

    # Returns a L<Paws::CleanRooms::ListMembersOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/cleanrooms/ListMembers>
...
This class forms part of L<Paws>, documenting arguments for method ListMembers in L<Paws::CleanRooms>
