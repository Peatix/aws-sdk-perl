...
package Paws::CleanRooms::CollaborationPrivacyBudgetTemplate;
  use Moose;
...
Paws::CleanRooms::CollaborationPrivacyBudgetTemplate
...
As an example, if Att1 is expected to be a Paws::CleanRooms::CollaborationPrivacyBudgetTemplate object:

  $service_obj->Method(Att1 => { Arn => $value, ..., UpdateTime => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CleanRooms::CollaborationPrivacyBudgetTemplate object:
...
The ARN of the collaboration that includes this collaboration privacy
budget template.
