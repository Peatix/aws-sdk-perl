...
package Paws::CleanRooms::ListSchemas;
  use Moose;
  ...
  has SchemaType => (is => 'ro', isa => 'Str', traits => ['ParamInQuery'], query_name => 'schemaType');

  use MooseX::ClassAttribute;

  class_has _api_call => (isa => 'Str', is => 'ro', default => 'ListSchemas');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/collaborations/{collaborationIdentifier}/schemas');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::CleanRooms::ListSchemasOutput');
1;
...
Paws::CleanRooms::ListSchemas - Arguments for method ListSchemas on L<Paws::CleanRooms>
...
=head1 SYNOPSIS
    ...
    my $ListSchemasOutput = $cleanrooms->ListSchemas(
      CollaborationIdentifier => 'MyCollaborationIdentifier',
      MaxResults              => 1,                             # OPTIONAL
      NextToken               => 'MyPaginationToken',           # OPTIONAL
      SchemaType              => 'TABLE',                       # OPTIONAL
    );

    # Results:
    my $NextToken       = $ListSchemasOutput->NextToken;
    my $SchemaSummaries = $ListSchemasOutput->SchemaSummaries;

    # Returns a L<Paws::CleanRooms::ListSchemasOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/cleanrooms/ListSchemas>
...
=head2 SchemaType => Str

If present, filter schemas by schema type.

Valid values are: C<"TABLE">, C<"ID_MAPPING_TABLE">


=head1 SEE ALSO

This class forms part of L<Paws>, documenting arguments for method ListSchemas in L<Paws::CleanRooms>
