...
package Paws::CleanRooms::ProtectedJobS3OutputConfigurationInput;
  use Moose;
...
Paws::CleanRooms::ProtectedJobS3OutputConfigurationInput
...
As an example, if Att1 is expected to be a Paws::CleanRooms::ProtectedJobS3OutputConfigurationInput object:

  $service_obj->Method(Att1 => { Bucket => $value, ..., KeyPrefix => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CleanRooms::ProtectedJobS3OutputConfigurationInput object:
