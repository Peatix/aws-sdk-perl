...
package Paws::CleanRooms::ProtectedQueryError;
  use Moose;
...
Paws::CleanRooms::ProtectedQueryError
...
As an example, if Att1 is expected to be a Paws::CleanRooms::ProtectedQueryError object:

  $service_obj->Method(Att1 => { Code => $value, ..., Message => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CleanRooms::ProtectedQueryError object:
