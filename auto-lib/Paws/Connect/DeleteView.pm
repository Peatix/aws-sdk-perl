...
package Paws::Connect::DeleteView;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Connect::DeleteViewResponse');
1;
...
Paws::Connect::DeleteView - Arguments for method DeleteView on L<Paws::Connect>
...
=head1 SYNOPSIS
    ...
    my $DeleteViewResponse = $connect->DeleteView(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/connect/DeleteView>
...
This class forms part of L<Paws>, documenting arguments for method DeleteView in L<Paws::Connect>
