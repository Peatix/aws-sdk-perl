...
package Paws::Connect::ThresholdV2;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::Connect::ThresholdV2 object:

  $service_obj->Method(Att1 => { Comparison => $value, ..., ThresholdValue => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Connect::ThresholdV2 object:
