...
package Paws::Connect::ListSecurityProfilePermissionsResponse;
  use Moose;
...
Paws::Connect::ListSecurityProfilePermissionsResponse
...
valid permissions, see List of security profile permissions
