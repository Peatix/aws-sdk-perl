...
package Paws::Connect::CreatePrompt;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/prompts/{InstanceId}');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'PUT');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Connect::CreatePromptResponse');
1;
...
Paws::Connect::CreatePrompt - Arguments for method CreatePrompt on L<Paws::Connect>
...
=head1 SYNOPSIS
    ...
    my $CreatePromptResponse = $connect->CreatePrompt(
    ...
    # Results:
    my $PromptARN = $CreatePromptResponse->PromptARN;
    my $PromptId  = $CreatePromptResponse->PromptId;

    # Returns a L<Paws::Connect::CreatePromptResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/connect/CreatePrompt>
...
This class forms part of L<Paws>, documenting arguments for method CreatePrompt in L<Paws::Connect>
