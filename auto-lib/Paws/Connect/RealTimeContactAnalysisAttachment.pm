...
package Paws::Connect::RealTimeContactAnalysisAttachment;
  use Moose;
...
Paws::Connect::RealTimeContactAnalysisAttachment
...
As an example, if Att1 is expected to be a Paws::Connect::RealTimeContactAnalysisAttachment object:

  $service_obj->Method(Att1 => { AttachmentId => $value, ..., Status => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Connect::RealTimeContactAnalysisAttachment object:
