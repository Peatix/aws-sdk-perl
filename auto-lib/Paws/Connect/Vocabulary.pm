...
package Paws::Connect::Vocabulary;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::Connect::Vocabulary object:

  $service_obj->Method(Att1 => { Arn => $value, ..., Tags => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Connect::Vocabulary object:
...
fields. Separate the fields with TAB characters. For more information,
