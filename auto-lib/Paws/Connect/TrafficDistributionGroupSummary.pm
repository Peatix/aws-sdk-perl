...
package Paws::Connect::TrafficDistributionGroupSummary;
  use Moose;
...
Paws::Connect::TrafficDistributionGroupSummary
...
As an example, if Att1 is expected to be a Paws::Connect::TrafficDistributionGroupSummary object:

  $service_obj->Method(Att1 => { Arn => $value, ..., Status => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Connect::TrafficDistributionGroupSummary object:
...
C<UPDATE_IN_PROGRESS> means the previous UpdateTrafficDistributionGroup
