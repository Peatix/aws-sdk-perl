...
package Paws::Connect::HoursOfOperationConfig;
  ...
  has EndTime => (is => 'ro', isa => 'Paws::Connect::HoursOfOperationTimeSlice', required => 1);
  has StartTime => (is => 'ro', isa => 'Paws::Connect::HoursOfOperationTimeSlice', required => 1);
...
=head2 B<REQUIRED> EndTime => L<Paws::Connect::HoursOfOperationTimeSlice>

The end time that your contact center closes.


=head2 B<REQUIRED> StartTime => L<Paws::Connect::HoursOfOperationTimeSlice>
