...
package Paws::Connect::ContactFlowModule;
  use Moose;
...
Paws::Connect::ContactFlowModule
...
As an example, if Att1 is expected to be a Paws::Connect::ContactFlowModule object:

  $service_obj->Method(Att1 => { Arn => $value, ..., Tags => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Connect::ContactFlowModule object:
