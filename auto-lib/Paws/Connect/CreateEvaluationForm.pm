...
package Paws::Connect::CreateEvaluationForm;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'CreateEvaluationForm');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/evaluation-forms/{InstanceId}');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'PUT');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Connect::CreateEvaluationFormResponse');
1;
...
Paws::Connect::CreateEvaluationForm - Arguments for method CreateEvaluationForm on L<Paws::Connect>

=head1 DESCRIPTION

This class represents the parameters used for calling the method CreateEvaluationForm on the
L<Amazon Connect Service|Paws::Connect> service. Use the attributes of this class
as arguments to method CreateEvaluationForm.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to CreateEvaluationForm.

=head1 SYNOPSIS

    my $connect = Paws->service('Connect');
    my $CreateEvaluationFormResponse = $connect->CreateEvaluationForm(
    ...
    # Results:
    my $EvaluationFormArn = $CreateEvaluationFormResponse->EvaluationFormArn;
    my $EvaluationFormId  = $CreateEvaluationFormResponse->EvaluationFormId;

    # Returns a L<Paws::Connect::CreateEvaluationFormResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/connect/CreateEvaluationForm>
...
This class forms part of L<Paws>, documenting arguments for method CreateEvaluationForm in L<Paws::Connect>
