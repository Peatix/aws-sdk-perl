...
package Paws::Connect::DeleteInstance;
  use Moose;
...
Paws::Connect::DeleteInstance - Arguments for method DeleteInstance on L<Paws::Connect>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/connect/DeleteInstance>
...
This class forms part of L<Paws>, documenting arguments for method DeleteInstance in L<Paws::Connect>
