...
package Paws::Connect::DeleteQueue;
  use Moose;
...
Paws::Connect::DeleteQueue - Arguments for method DeleteQueue on L<Paws::Connect>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/connect/DeleteQueue>
...
This class forms part of L<Paws>, documenting arguments for method DeleteQueue in L<Paws::Connect>
