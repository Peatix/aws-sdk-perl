...
package Paws::Connect::DescribeView;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Connect::DescribeViewResponse');
1;
...
Paws::Connect::DescribeView - Arguments for method DescribeView on L<Paws::Connect>
...
=head1 SYNOPSIS
    ...
    my $DescribeViewResponse = $connect->DescribeView(
    ...
    # Returns a L<Paws::Connect::DescribeViewResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/connect/DescribeView>
...
This class forms part of L<Paws>, documenting arguments for method DescribeView in L<Paws::Connect>
