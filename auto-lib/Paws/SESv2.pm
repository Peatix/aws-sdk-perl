package Paws::SESv2;
  ...
  sub BatchGetMetricData {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::SESv2::BatchGetMetricData', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub CancelExportJob {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::SESv2::CancelExportJob', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub CreateExportJob {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::SESv2::CreateExportJob', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub CreateImportJob {
    my $self = shift;
  ...
  sub CreateMultiRegionEndpoint {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::SESv2::CreateMultiRegionEndpoint', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DeleteMultiRegionEndpoint {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::SESv2::DeleteMultiRegionEndpoint', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub GetDedicatedIpPool {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::SESv2::GetDedicatedIpPool', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetDedicatedIps {
    my $self = shift;
  ...
  sub GetExportJob {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::SESv2::GetExportJob', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetImportJob {
    my $self = shift;
  ...
  sub GetMessageInsights {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::SESv2::GetMessageInsights', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetMultiRegionEndpoint {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::SESv2::GetMultiRegionEndpoint', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ListExportJobs {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::SESv2::ListExportJobs', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ListImportJobs {
    my $self = shift;
  ...
  sub ListMultiRegionEndpoints {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::SESv2::ListMultiRegionEndpoints', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ListRecommendations {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::SESv2::ListRecommendations', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub PutAccountVdmAttributes {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::SESv2::PutAccountVdmAttributes', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub PutConfigurationSetArchivingOptions {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::SESv2::PutConfigurationSetArchivingOptions', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub PutConfigurationSetVdmOptions {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::SESv2::PutConfigurationSetVdmOptions', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub PutDedicatedIpPoolScalingAttributes {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::SESv2::PutDedicatedIpPoolScalingAttributes', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ListAllMultiRegionEndpoints {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->ListMultiRegionEndpoints(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->NextToken) {
        $next_result = $self->ListMultiRegionEndpoints(@_, NextToken => $next_result->NextToken);
        push @{ $result->MultiRegionEndpoints }, @{ $next_result->MultiRegionEndpoints };
      }
      return $result;
    } else {
      while ($result->NextToken) {
        $callback->($_ => 'MultiRegionEndpoints') foreach (@{ $result->MultiRegionEndpoints });
        $result = $self->ListMultiRegionEndpoints(@_, NextToken => $result->NextToken);
      }
      $callback->($_ => 'MultiRegionEndpoints') foreach (@{ $result->MultiRegionEndpoints });
    }
...
Amazon SES (http://aws.amazon.com/ses) is an Amazon Web Services
...
=head2 BatchGetMetricData

=over

=item Queries => ArrayRef[L<Paws::SESv2::BatchGetMetricDataQuery>]


=back

Each argument is described in detail in: L<Paws::SESv2::BatchGetMetricData>

Returns: a L<Paws::SESv2::BatchGetMetricDataResponse> instance
...
Each argument is described in detail in: L<Paws::SESv2::CancelExportJob>

Returns: a L<Paws::SESv2::CancelExportJobResponse> instance
...
=item [ArchivingOptions => L<Paws::SESv2::ArchivingOptions>]
...
=item [VdmOptions => L<Paws::SESv2::VdmOptions>]
...
=item ExportDataSource => L<Paws::SESv2::ExportDataSource>

=item ExportDestination => L<Paws::SESv2::ExportDestination>


=back

Each argument is described in detail in: L<Paws::SESv2::CreateExportJob>

Returns: a L<Paws::SESv2::CreateExportJobResponse> instance
...
=head2 CreateMultiRegionEndpoint

=over

=item Details => L<Paws::SESv2::Details>
...
Each argument is described in detail in: L<Paws::SESv2::CreateMultiRegionEndpoint>

Returns: a L<Paws::SESv2::CreateMultiRegionEndpointResponse> instance
...
=head2 DeleteMultiRegionEndpoint
...
Each argument is described in detail in: L<Paws::SESv2::DeleteMultiRegionEndpoint>

Returns: a L<Paws::SESv2::DeleteMultiRegionEndpointResponse> instance
...
Each argument is described in detail in: L<Paws::SESv2::GetDedicatedIpPool>

Returns: a L<Paws::SESv2::GetDedicatedIpPoolResponse> instance
...
Each argument is described in detail in: L<Paws::SESv2::GetExportJob>

Returns: a L<Paws::SESv2::GetExportJobResponse> instance
...
Each argument is described in detail in: L<Paws::SESv2::GetMessageInsights>

Returns: a L<Paws::SESv2::GetMessageInsightsResponse> instance
...
Each argument is described in detail in: L<Paws::SESv2::GetMultiRegionEndpoint>

Returns: a L<Paws::SESv2::GetMultiRegionEndpointResponse> instance
...
=head2 ListExportJobs

=over

=item [ExportSourceType => Str]
...
Each argument is described in detail in: L<Paws::SESv2::ListExportJobs>

Returns: a L<Paws::SESv2::ListExportJobsResponse> instance
...
=head2 ListMultiRegionEndpoints
...
Each argument is described in detail in: L<Paws::SESv2::ListMultiRegionEndpoints>

Returns: a L<Paws::SESv2::ListMultiRegionEndpointsResponse> instance
...
=item [Filter => L<Paws::SESv2::ListRecommendationsFilter>]
...
Each argument is described in detail in: L<Paws::SESv2::ListRecommendations>

Returns: a L<Paws::SESv2::ListRecommendationsResponse> instance
...
=head2 PutAccountVdmAttributes

=over

=item VdmAttributes => L<Paws::SESv2::VdmAttributes>


=back

Each argument is described in detail in: L<Paws::SESv2::PutAccountVdmAttributes>

Returns: a L<Paws::SESv2::PutAccountVdmAttributesResponse> instance
...
=head2 PutConfigurationSetArchivingOptions
...
Each argument is described in detail in: L<Paws::SESv2::PutConfigurationSetArchivingOptions>

Returns: a L<Paws::SESv2::PutConfigurationSetArchivingOptionsResponse> instance

Associate the configuration set with a MailManager archive. When you
send email using the C<SendEmail> or C<SendBulkEmail> operations the
...
=head2 PutConfigurationSetVdmOptions
...
Each argument is described in detail in: L<Paws::SESv2::PutConfigurationSetVdmOptions>

Returns: a L<Paws::SESv2::PutConfigurationSetVdmOptionsResponse> instance
...
=head2 PutDedicatedIpPoolScalingAttributes
...
Each argument is described in detail in: L<Paws::SESv2::PutDedicatedIpPoolScalingAttributes>

Returns: a L<Paws::SESv2::PutDedicatedIpPoolScalingAttributesResponse> instance

Used to convert a dedicated IP pool to a different scaling mode.

C<MANAGED> pools cannot be converted to C<STANDARD> scaling mode.
...
C<TopicPreferences> object, not just the ones that need updating;
...
=head2 ListAllMultiRegionEndpoints(sub { },[NextToken => Str, PageSize => Int])

=head2 ListAllMultiRegionEndpoints([NextToken => Str, PageSize => Int])


If passed a sub as first parameter, it will call the sub for each element found in :

 - MultiRegionEndpoints, passing the object as the first parameter, and the string 'MultiRegionEndpoints' as the second parameter 

If not, it will return a a L<Paws::SESv2::ListMultiRegionEndpointsResponse> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
