...
package Paws::AutoScaling::MetricStat;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::AutoScaling::MetricStat object:

  $service_obj->Method(Att1 => { Metric => $value, ..., Unit => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::AutoScaling::MetricStat object:
