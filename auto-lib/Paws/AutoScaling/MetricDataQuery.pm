...
package Paws::AutoScaling::MetricDataQuery;
  use Moose;
  has Expression => (is => 'ro', isa => 'Str');
  has Id => (is => 'ro', isa => 'Str', required => 1);
  has Label => (is => 'ro', isa => 'Str');
  has MetricStat => (is => 'ro', isa => 'Paws::AutoScaling::MetricStat');
...
Paws::AutoScaling::MetricDataQuery
...
As an example, if Att1 is expected to be a Paws::AutoScaling::MetricDataQuery object:

  $service_obj->Method(Att1 => { Expression => $value, ..., ReturnData => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::AutoScaling::MetricDataQuery object:
...
policy configurations using custom metrics
...
=head2 MetricStat => L<Paws::AutoScaling::MetricStat>
