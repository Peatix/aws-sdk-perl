...
package Paws::ApplicationInsights::ListWorkloads;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ApplicationInsights::ListWorkloadsResponse');
...
Paws::ApplicationInsights::ListWorkloads - Arguments for method ListWorkloads on L<Paws::ApplicationInsights>
...
=head1 SYNOPSIS
    ...
    my $ListWorkloadsResponse = $applicationinsights->ListWorkloads(
    ...
    # Results:
    my $NextToken    = $ListWorkloadsResponse->NextToken;
    my $WorkloadList = $ListWorkloadsResponse->WorkloadList;

    # Returns a L<Paws::ApplicationInsights::ListWorkloadsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/applicationinsights/ListWorkloads>
...
This class forms part of L<Paws>, documenting arguments for method ListWorkloads in L<Paws::ApplicationInsights>
