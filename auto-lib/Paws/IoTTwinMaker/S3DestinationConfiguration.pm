...
package Paws::IoTTwinMaker::S3DestinationConfiguration;
  use Moose;
...
Paws::IoTTwinMaker::S3DestinationConfiguration
...
As an example, if Att1 is expected to be a Paws::IoTTwinMaker::S3DestinationConfiguration object:

  $service_obj->Method(Att1 => { Location => $value, ..., Location => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IoTTwinMaker::S3DestinationConfiguration object:
