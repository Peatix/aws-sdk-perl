...
package Paws::IoTTwinMaker::CreateComponentType;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'CreateComponentType');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/workspaces/{workspaceId}/component-types/{componentTypeId}');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::IoTTwinMaker::CreateComponentTypeResponse');
1;
...
Paws::IoTTwinMaker::CreateComponentType - Arguments for method CreateComponentType on L<Paws::IoTTwinMaker>

=head1 DESCRIPTION

This class represents the parameters used for calling the method CreateComponentType on the
L<AWS IoT TwinMaker|Paws::IoTTwinMaker> service. Use the attributes of this class
as arguments to method CreateComponentType.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to CreateComponentType.

=head1 SYNOPSIS

    my $iottwinmaker = Paws->service('IoTTwinMaker');
    my $CreateComponentTypeResponse = $iottwinmaker->CreateComponentType(
    ...
    # Results:
    my $Arn              = $CreateComponentTypeResponse->Arn;
    my $CreationDateTime = $CreateComponentTypeResponse->CreationDateTime;
    my $State            = $CreateComponentTypeResponse->State;

    # Returns a L<Paws::IoTTwinMaker::CreateComponentTypeResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/iottwinmaker/CreateComponentType>
...
This class forms part of L<Paws>, documenting arguments for method CreateComponentType in L<Paws::IoTTwinMaker>
