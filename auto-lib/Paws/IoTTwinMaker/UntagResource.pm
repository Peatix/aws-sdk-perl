...
package Paws::IoTTwinMaker::UntagResource;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::IoTTwinMaker::UntagResourceResponse');
1;
...
Paws::IoTTwinMaker::UntagResource - Arguments for method UntagResource on L<Paws::IoTTwinMaker>
...
=head1 SYNOPSIS
    ...
    my $UntagResourceResponse = $iottwinmaker->UntagResource(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/iottwinmaker/UntagResource>
...
This class forms part of L<Paws>, documenting arguments for method UntagResource in L<Paws::IoTTwinMaker>
