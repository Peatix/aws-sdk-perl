...
package Paws::CloudWatchLogs::UntagResource;
  use Moose;
...
Paws::CloudWatchLogs::UntagResource - Arguments for method UntagResource on L<Paws::CloudWatchLogs>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/logs/UntagResource>
...
This class forms part of L<Paws>, documenting arguments for method UntagResource in L<Paws::CloudWatchLogs>
