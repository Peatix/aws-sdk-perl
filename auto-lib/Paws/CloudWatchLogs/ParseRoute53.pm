...
package Paws::CloudWatchLogs::ParseRoute53;
  use Moose;
...
Paws::CloudWatchLogs::ParseRoute53
...
As an example, if Att1 is expected to be a Paws::CloudWatchLogs::ParseRoute53 object:

  $service_obj->Method(Att1 => { Source => $value, ..., Source => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CloudWatchLogs::ParseRoute53 object:
...
the entire log event message. For more information about this processor
including examples, see parseRoute53
