...
package Paws::CloudWatchLogs::LogEvent;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::CloudWatchLogs::LogEvent object:

  $service_obj->Method(Att1 => { Message => $value, ..., Timestamp => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CloudWatchLogs::LogEvent object:
