...
package Paws::CloudWatchLogs::MoveKeyEntry;
  use Moose;
...
Paws::CloudWatchLogs::MoveKeyEntry
...
As an example, if Att1 is expected to be a Paws::CloudWatchLogs::MoveKeyEntry object:

  $service_obj->Method(Att1 => { OverwriteIfExists => $value, ..., Target => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CloudWatchLogs::MoveKeyEntry object:
...
This object defines one key that will be moved with the moveKey
