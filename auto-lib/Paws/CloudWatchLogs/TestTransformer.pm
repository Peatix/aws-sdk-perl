...
package Paws::CloudWatchLogs::TestTransformer;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'TestTransformer');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::CloudWatchLogs::TestTransformerResponse');
...
Paws::CloudWatchLogs::TestTransformer - Arguments for method TestTransformer on L<Paws::CloudWatchLogs>

=head1 DESCRIPTION

This class represents the parameters used for calling the method TestTransformer on the
L<Amazon CloudWatch Logs|Paws::CloudWatchLogs> service. Use the attributes of this class
as arguments to method TestTransformer.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to TestTransformer.

=head1 SYNOPSIS

    my $logs = Paws->service('CloudWatchLogs');
    my $TestTransformerResponse = $logs->TestTransformer(
      LogEventMessages => [
    ...
    # Results:
    my $TransformedLogs = $TestTransformerResponse->TransformedLogs;

    # Returns a L<Paws::CloudWatchLogs::TestTransformerResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/logs/TestTransformer>
...
This class forms part of L<Paws>, documenting arguments for method TestTransformer in L<Paws::CloudWatchLogs>
