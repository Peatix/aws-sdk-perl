...
This class represents the parameters used for calling the method DeleteLogGroup on the
...
This class forms part of L<Paws>, documenting arguments for method DeleteLogGroup in L<Paws::CloudWatchLogs>
