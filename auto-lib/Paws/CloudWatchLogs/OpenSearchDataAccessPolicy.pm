...
package Paws::CloudWatchLogs::OpenSearchDataAccessPolicy;
  use Moose;
...
Paws::CloudWatchLogs::OpenSearchDataAccessPolicy
...
As an example, if Att1 is expected to be a Paws::CloudWatchLogs::OpenSearchDataAccessPolicy object:

  $service_obj->Method(Att1 => { PolicyName => $value, ..., Status => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CloudWatchLogs::OpenSearchDataAccessPolicy object:
