...
As an example, if Att1 is expected to be a Paws::M2::PsAttributes object:

  $service_obj->Method(Att1 => { Encoding => $value, ..., Format => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::M2::PsAttributes object:
