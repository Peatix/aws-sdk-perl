...
package Paws::M2::ListApplicationVersions;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::M2::ListApplicationVersionsResponse');
1;
...
Paws::M2::ListApplicationVersions - Arguments for method ListApplicationVersions on L<Paws::M2>
...
=head1 SYNOPSIS
    ...
    my $ListApplicationVersionsResponse = $m2->ListApplicationVersions(
    ...
    my $ApplicationVersions =
      $ListApplicationVersionsResponse->ApplicationVersions;
    my $NextToken = $ListApplicationVersionsResponse->NextToken;

    # Returns a L<Paws::M2::ListApplicationVersionsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/m2/ListApplicationVersions>
...
This class forms part of L<Paws>, documenting arguments for method ListApplicationVersions in L<Paws::M2>
