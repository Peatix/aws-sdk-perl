...
package Paws::M2::StartApplication;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::M2::StartApplicationResponse');
1;
...
Paws::M2::StartApplication - Arguments for method StartApplication on L<Paws::M2>
...
=head1 SYNOPSIS
    ...
    my $StartApplicationResponse = $m2->StartApplication(
      ApplicationId => 'MyIdentifier',

    );

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/m2/StartApplication>
...
This class forms part of L<Paws>, documenting arguments for method StartApplication in L<Paws::M2>
