...
package Paws::M2::GdgDetailAttributes;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::M2::GdgDetailAttributes object:

  $service_obj->Method(Att1 => { Limit => $value, ..., RollDisposition => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::M2::GdgDetailAttributes object:
