...
package Paws::DevOpsGuru::ServiceCollection;
  use Moose;
...
Paws::DevOpsGuru::ServiceCollection
...
As an example, if Att1 is expected to be a Paws::DevOpsGuru::ServiceCollection object:

  $service_obj->Method(Att1 => { ServiceNames => $value, ..., ServiceNames => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::DevOpsGuru::ServiceCollection object:
