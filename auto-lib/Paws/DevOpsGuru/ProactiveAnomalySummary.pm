...
package Paws::DevOpsGuru::ProactiveAnomalySummary;
  use Moose;
  ...
  has SourceMetadata => (is => 'ro', isa => 'Paws::DevOpsGuru::AnomalySourceMetadata');
...
Paws::DevOpsGuru::ProactiveAnomalySummary
...
As an example, if Att1 is expected to be a Paws::DevOpsGuru::ProactiveAnomalySummary object:

  $service_obj->Method(Att1 => { AnomalyReportedTimeRange => $value, ..., UpdateTime => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::DevOpsGuru::ProactiveAnomalySummary object:
...
=head2 SourceMetadata => L<Paws::DevOpsGuru::AnomalySourceMetadata>
