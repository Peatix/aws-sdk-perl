...
package Paws::DevOpsGuru::DeleteInsight;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::DevOpsGuru::DeleteInsightResponse');
1;
...
Paws::DevOpsGuru::DeleteInsight - Arguments for method DeleteInsight on L<Paws::DevOpsGuru>
...
=head1 SYNOPSIS
    ...
    my $DeleteInsightResponse = $devops -guru->DeleteInsight(
      Id => 'MyInsightId',

    );

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/devops-guru/DeleteInsight>
...
This class forms part of L<Paws>, documenting arguments for method DeleteInsight in L<Paws::DevOpsGuru>
