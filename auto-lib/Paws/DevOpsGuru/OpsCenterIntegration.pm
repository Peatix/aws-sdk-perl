...
package Paws::DevOpsGuru::OpsCenterIntegration;
  use Moose;
...
Paws::DevOpsGuru::OpsCenterIntegration
...
As an example, if Att1 is expected to be a Paws::DevOpsGuru::OpsCenterIntegration object:

  $service_obj->Method(Att1 => { OptInStatus => $value, ..., OptInStatus => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::DevOpsGuru::OpsCenterIntegration object:
