...
package Paws::DevOpsGuru::DescribeOrganizationResourceCollectionHealthResponse;
  use Moose;
  has Account => (is => 'ro', isa => 'ArrayRef[Paws::DevOpsGuru::AccountHealth]');
...
Paws::DevOpsGuru::DescribeOrganizationResourceCollectionHealthResponse

=head1 ATTRIBUTES


=head2 Account => ArrayRef[L<Paws::DevOpsGuru::AccountHealth>]
