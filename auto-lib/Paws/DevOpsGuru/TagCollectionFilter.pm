...
package Paws::DevOpsGuru::TagCollectionFilter;
  use Moose;
...
Paws::DevOpsGuru::TagCollectionFilter
...
As an example, if Att1 is expected to be a Paws::DevOpsGuru::TagCollectionFilter object:

  $service_obj->Method(Att1 => { AppBoundaryKey => $value, ..., TagValues => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::DevOpsGuru::TagCollectionFilter object:
