...
package Paws::DevOpsGuru::ReactiveInsight;
  use Moose;
...
Paws::DevOpsGuru::ReactiveInsight
...
As an example, if Att1 is expected to be a Paws::DevOpsGuru::ReactiveInsight object:

  $service_obj->Method(Att1 => { Description => $value, ..., Status => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::DevOpsGuru::ReactiveInsight object:
