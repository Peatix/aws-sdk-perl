...
package Paws::DevOpsGuru::UpdateTagCollectionFilter;
  use Moose;
...
Paws::DevOpsGuru::UpdateTagCollectionFilter
...
As an example, if Att1 is expected to be a Paws::DevOpsGuru::UpdateTagCollectionFilter object:

  $service_obj->Method(Att1 => { AppBoundaryKey => $value, ..., TagValues => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::DevOpsGuru::UpdateTagCollectionFilter object:
...
an Amazon Web Services tag or tag I<key>/I<value> pair.
