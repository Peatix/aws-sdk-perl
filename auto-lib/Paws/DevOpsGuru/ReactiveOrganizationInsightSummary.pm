...
package Paws::DevOpsGuru::ReactiveOrganizationInsightSummary;
  use Moose;
...
Paws::DevOpsGuru::ReactiveOrganizationInsightSummary
...
As an example, if Att1 is expected to be a Paws::DevOpsGuru::ReactiveOrganizationInsightSummary object:

  $service_obj->Method(Att1 => { AccountId => $value, ..., Status => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::DevOpsGuru::ReactiveOrganizationInsightSummary object:
