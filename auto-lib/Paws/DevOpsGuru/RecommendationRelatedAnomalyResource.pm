...
package Paws::DevOpsGuru::RecommendationRelatedAnomalyResource;
  use Moose;
...
Paws::DevOpsGuru::RecommendationRelatedAnomalyResource
...
As an example, if Att1 is expected to be a Paws::DevOpsGuru::RecommendationRelatedAnomalyResource object:

  $service_obj->Method(Att1 => { Name => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::DevOpsGuru::RecommendationRelatedAnomalyResource object:
