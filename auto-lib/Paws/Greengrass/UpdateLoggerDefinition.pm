...
Paws::Greengrass::UpdateLoggerDefinition - Arguments for method UpdateLoggerDefinition on L<Paws::Greengrass>
...
=head1 SYNOPSIS
    ...
    my $UpdateLoggerDefinitionResponse = $greengrass->UpdateLoggerDefinition(
