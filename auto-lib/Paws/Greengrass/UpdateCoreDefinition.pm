...
Paws::Greengrass::UpdateCoreDefinition - Arguments for method UpdateCoreDefinition on L<Paws::Greengrass>
...
=head1 SYNOPSIS
    ...
    my $UpdateCoreDefinitionResponse = $greengrass->UpdateCoreDefinition(
