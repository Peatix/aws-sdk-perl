...
Paws::Greengrass::ListGroupCertificateAuthorities - Arguments for method ListGroupCertificateAuthorities on L<Paws::Greengrass>
...
=head1 SYNOPSIS
    ...
    my $ListGroupCertificateAuthoritiesResponse =
    ...
    # Results:
    my $GroupCertificateAuthorities =
      $ListGroupCertificateAuthoritiesResponse->GroupCertificateAuthorities;

# Returns a L<Paws::Greengrass::ListGroupCertificateAuthoritiesResponse> object.
