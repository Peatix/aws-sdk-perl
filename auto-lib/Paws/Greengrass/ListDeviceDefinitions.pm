...
Paws::Greengrass::ListDeviceDefinitions - Arguments for method ListDeviceDefinitions on L<Paws::Greengrass>
...
=head1 SYNOPSIS
    ...
    my $ListDeviceDefinitionsResponse = $greengrass->ListDeviceDefinitions(
      MaxResults => 'My__string',    # OPTIONAL
      NextToken  => 'My__string',    # OPTIONAL
    );

    # Results:
    my $Definitions = $ListDeviceDefinitionsResponse->Definitions;
    my $NextToken   = $ListDeviceDefinitionsResponse->NextToken;

    # Returns a L<Paws::Greengrass::ListDeviceDefinitionsResponse> object.
