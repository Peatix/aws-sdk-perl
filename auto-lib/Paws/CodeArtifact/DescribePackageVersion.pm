...
package Paws::CodeArtifact::DescribePackageVersion;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/v1/package/version');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::CodeArtifact::DescribePackageVersionResult');
1;
...
Paws::CodeArtifact::DescribePackageVersion - Arguments for method DescribePackageVersion on L<Paws::CodeArtifact>
...
=head1 SYNOPSIS
    ...
    my $DescribePackageVersionResult = $codeartifact->DescribePackageVersion(
      Domain         => 'MyDomainName',
      Format         => 'npm',
    ...
    # Results:
    my $PackageVersion = $DescribePackageVersionResult->PackageVersion;

    # Returns a L<Paws::CodeArtifact::DescribePackageVersionResult> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/codeartifact/DescribePackageVersion>
...
This class forms part of L<Paws>, documenting arguments for method DescribePackageVersion in L<Paws::CodeArtifact>
