...
package Paws::CodeArtifact::DescribePackage;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::CodeArtifact::DescribePackageResult');
1;
...
Paws::CodeArtifact::DescribePackage - Arguments for method DescribePackage on L<Paws::CodeArtifact>
...
=head1 SYNOPSIS
    ...
    my $DescribePackageResult = $codeartifact->DescribePackage(
      Domain      => 'MyDomainName',
      Format      => 'npm',
    ...
    # Results:
    my $Package = $DescribePackageResult->Package;

    # Returns a L<Paws::CodeArtifact::DescribePackageResult> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/codeartifact/DescribePackage>
...
This class forms part of L<Paws>, documenting arguments for method DescribePackage in L<Paws::CodeArtifact>
