...
package Paws::ConnectCampaignsV2::EncryptionConfig;
  use Moose;
...
Paws::ConnectCampaignsV2::EncryptionConfig
...
As an example, if Att1 is expected to be a Paws::ConnectCampaignsV2::EncryptionConfig object:

  $service_obj->Method(Att1 => { Enabled => $value, ..., KeyArn => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ConnectCampaignsV2::EncryptionConfig object:
