...
package Paws::ConnectCampaignsV2::ResumeCampaign;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/v2/campaigns/{id}/resume');
...
Paws::ConnectCampaignsV2::ResumeCampaign - Arguments for method ResumeCampaign on L<Paws::ConnectCampaignsV2>
...
This class forms part of L<Paws>, documenting arguments for method ResumeCampaign in L<Paws::ConnectCampaignsV2>
