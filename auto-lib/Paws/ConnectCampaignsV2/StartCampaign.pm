...
package Paws::ConnectCampaignsV2::StartCampaign;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/v2/campaigns/{id}/start');
...
Paws::ConnectCampaignsV2::StartCampaign - Arguments for method StartCampaign on L<Paws::ConnectCampaignsV2>
...
This class forms part of L<Paws>, documenting arguments for method StartCampaign in L<Paws::ConnectCampaignsV2>
