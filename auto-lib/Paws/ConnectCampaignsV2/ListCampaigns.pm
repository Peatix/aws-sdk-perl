...
package Paws::ConnectCampaignsV2::ListCampaigns;
  use Moose;
  has Filters => (is => 'ro', isa => 'Paws::ConnectCampaignsV2::CampaignFilters', traits => ['NameInRequest'], request_name => 'filters');
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/v2/campaigns-summary');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ConnectCampaignsV2::ListCampaignsResponse');
1;
...
Paws::ConnectCampaignsV2::ListCampaigns - Arguments for method ListCampaigns on L<Paws::ConnectCampaignsV2>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::ConnectCampaignsV2::ListCampaignsResponse> object.
...
=head2 Filters => L<Paws::ConnectCampaignsV2::CampaignFilters>
...
This class forms part of L<Paws>, documenting arguments for method ListCampaigns in L<Paws::ConnectCampaignsV2>
