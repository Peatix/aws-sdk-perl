...
package Paws::ConnectCampaignsV2::StartInstanceOnboardingJob;
  use Moose;
  has ConnectInstanceId => (is => 'ro', isa => 'Str', traits => ['ParamInURI'], uri_name => 'connectInstanceId', required => 1);
  has EncryptionConfig => (is => 'ro', isa => 'Paws::ConnectCampaignsV2::EncryptionConfig', traits => ['NameInRequest'], request_name => 'encryptionConfig', required => 1);
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ConnectCampaignsV2::StartInstanceOnboardingJobResponse');
1;
...
Paws::ConnectCampaignsV2::StartInstanceOnboardingJob - Arguments for method StartInstanceOnboardingJob on L<Paws::ConnectCampaignsV2>
...
# Returns a L<Paws::ConnectCampaignsV2::StartInstanceOnboardingJobResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method StartInstanceOnboardingJob in L<Paws::ConnectCampaignsV2>
