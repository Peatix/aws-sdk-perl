...
package Paws::ConnectCampaignsV2::GetCampaignStateBatch;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/v2/campaigns-state');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ConnectCampaignsV2::GetCampaignStateBatchResponse');
1;
...
Paws::ConnectCampaignsV2::GetCampaignStateBatch - Arguments for method GetCampaignStateBatch on L<Paws::ConnectCampaignsV2>
...
=head1 SYNOPSIS
  ...
  # Returns a L<Paws::ConnectCampaignsV2::GetCampaignStateBatchResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method GetCampaignStateBatch in L<Paws::ConnectCampaignsV2>
