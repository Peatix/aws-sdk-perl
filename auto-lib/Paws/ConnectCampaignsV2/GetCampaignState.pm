...
package Paws::ConnectCampaignsV2::GetCampaignState;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/v2/campaigns/{id}/state');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ConnectCampaignsV2::GetCampaignStateResponse');
1;
...
Paws::ConnectCampaignsV2::GetCampaignState - Arguments for method GetCampaignState on L<Paws::ConnectCampaignsV2>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::ConnectCampaignsV2::GetCampaignStateResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method GetCampaignState in L<Paws::ConnectCampaignsV2>
