...
package Paws::ConnectCampaignsV2::PauseCampaign;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/v2/campaigns/{id}/pause');
...
Paws::ConnectCampaignsV2::PauseCampaign - Arguments for method PauseCampaign on L<Paws::ConnectCampaignsV2>
...
This class forms part of L<Paws>, documenting arguments for method PauseCampaign in L<Paws::ConnectCampaignsV2>
