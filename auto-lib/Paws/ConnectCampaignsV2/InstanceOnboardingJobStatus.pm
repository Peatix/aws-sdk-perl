...
package Paws::ConnectCampaignsV2::InstanceOnboardingJobStatus;
  use Moose;
...
Paws::ConnectCampaignsV2::InstanceOnboardingJobStatus
...
As an example, if Att1 is expected to be a Paws::ConnectCampaignsV2::InstanceOnboardingJobStatus object:

  $service_obj->Method(Att1 => { ConnectInstanceId => $value, ..., Status => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ConnectCampaignsV2::InstanceOnboardingJobStatus object:
