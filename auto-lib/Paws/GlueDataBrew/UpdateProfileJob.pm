...
package Paws::GlueDataBrew::UpdateProfileJob;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'UpdateProfileJob');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/profileJobs/{name}');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'PUT');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::GlueDataBrew::UpdateProfileJobResponse');
1;
...
Paws::GlueDataBrew::UpdateProfileJob - Arguments for method UpdateProfileJob on L<Paws::GlueDataBrew>

=head1 DESCRIPTION

This class represents the parameters used for calling the method UpdateProfileJob on the
L<AWS Glue DataBrew|Paws::GlueDataBrew> service. Use the attributes of this class
as arguments to method UpdateProfileJob.
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/databrew/UpdateProfileJob>
...
This class forms part of L<Paws>, documenting arguments for method UpdateProfileJob in L<Paws::GlueDataBrew>
