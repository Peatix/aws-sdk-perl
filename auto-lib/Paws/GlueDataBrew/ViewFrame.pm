...
As an example, if Att1 is expected to be a Paws::GlueDataBrew::ViewFrame object:
  ...
  $service_obj->Method(Att1 => { Analytics => $value, ..., StartRowIndex => $value  });
