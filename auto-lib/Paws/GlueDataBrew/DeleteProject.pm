...
package Paws::GlueDataBrew::DeleteProject;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::GlueDataBrew::DeleteProjectResponse');
1;
...
Paws::GlueDataBrew::DeleteProject - Arguments for method DeleteProject on L<Paws::GlueDataBrew>
...
=head1 SYNOPSIS
    ...
    my $DeleteProjectResponse = $databrew->DeleteProject(
      Name => 'MyProjectName',
    ...
    # Returns a L<Paws::GlueDataBrew::DeleteProjectResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method DeleteProject in L<Paws::GlueDataBrew>
