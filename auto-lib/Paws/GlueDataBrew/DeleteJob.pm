...
package Paws::GlueDataBrew::DeleteJob;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::GlueDataBrew::DeleteJobResponse');
1;
...
Paws::GlueDataBrew::DeleteJob - Arguments for method DeleteJob on L<Paws::GlueDataBrew>
...
=head1 SYNOPSIS
    ...
    my $DeleteJobResponse = $databrew->DeleteJob(
      Name => 'MyJobName',

    );

    # Results:
    my $Name = $DeleteJobResponse->Name;

    # Returns a L<Paws::GlueDataBrew::DeleteJobResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method DeleteJob in L<Paws::GlueDataBrew>
