...
package Paws::CloudWatchEvents::ConnectionAuthResponseParameters;
  ...
  has ConnectivityParameters => (is => 'ro', isa => 'Paws::CloudWatchEvents::DescribeConnectionConnectivityParameters');
...
=head2 ConnectivityParameters => L<Paws::CloudWatchEvents::DescribeConnectionConnectivityParameters>

For private OAuth authentication endpoints. The parameters EventBridge
uses to authenticate against the endpoint.
