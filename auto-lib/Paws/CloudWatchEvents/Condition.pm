...
Services organization. The string must contain C<Type>, C<Key>, and
C<Value> fields. The C<Value> field specifies the ID of the Amazon Web
Services organization. Following is an example value for C<Condition>:
