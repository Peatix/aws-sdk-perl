...
package Paws::CloudWatchEvents::Target;
  use Moose;
  has AppSyncParameters => (is => 'ro', isa => 'Paws::CloudWatchEvents::AppSyncParameters');
...
As an example, if Att1 is expected to be a Paws::CloudWatchEvents::Target object:
  ...
  $service_obj->Method(Att1 => { AppSyncParameters => $value, ..., SqsParameters => $value  });
...
=head2 AppSyncParameters => L<Paws::CloudWatchEvents::AppSyncParameters>
...
job name, and other parameters. For more information, see Jobs
(https://docs.aws.amazon.com/batch/latest/userguide/jobs.html) in the
I<Batch User Guide>.
...
If you specify a SageMaker AI Model Building Pipeline as a target, you
