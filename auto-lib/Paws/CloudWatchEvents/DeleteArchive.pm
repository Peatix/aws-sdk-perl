...
package Paws::CloudWatchEvents::DeleteArchive;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::CloudWatchEvents::DeleteArchiveResponse');
...
Paws::CloudWatchEvents::DeleteArchive - Arguments for method DeleteArchive on L<Paws::CloudWatchEvents>
...
=head1 SYNOPSIS
    ...
    my $DeleteArchiveResponse = $events->DeleteArchive(
...
This class forms part of L<Paws>, documenting arguments for method DeleteArchive in L<Paws::CloudWatchEvents>
