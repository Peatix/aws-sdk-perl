...
package Paws::CloudWatchEvents::ConnectionBodyParameter;
  use Moose;
...
Paws::CloudWatchEvents::ConnectionBodyParameter
...
As an example, if Att1 is expected to be a Paws::CloudWatchEvents::ConnectionBodyParameter object:

  $service_obj->Method(Att1 => { IsValueSecret => $value, ..., Value => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CloudWatchEvents::ConnectionBodyParameter object:
