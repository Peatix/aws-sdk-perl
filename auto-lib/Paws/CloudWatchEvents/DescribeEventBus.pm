...
=head1 SYNOPSIS
    ...
    my $CreationTime     = $DescribeEventBusResponse->CreationTime;
    my $DeadLetterConfig = $DescribeEventBusResponse->DeadLetterConfig;
    my $Description      = $DescribeEventBusResponse->Description;
    my $KmsKeyIdentifier = $DescribeEventBusResponse->KmsKeyIdentifier;
    my $LastModifiedTime = $DescribeEventBusResponse->LastModifiedTime;
