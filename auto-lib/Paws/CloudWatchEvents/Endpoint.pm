...
package Paws::CloudWatchEvents::Endpoint;
  use Moose;
...
Paws::CloudWatchEvents::Endpoint
...
As an example, if Att1 is expected to be a Paws::CloudWatchEvents::Endpoint object:

  $service_obj->Method(Att1 => { Arn => $value, ..., StateReason => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CloudWatchEvents::Endpoint object:
