...
Services Organizations, see What Is Amazon Web Services Organizations
(https://docs.aws.amazon.com/organizations/latest/userguide/orgs_introduction.html)
in the I<Amazon Web Services Organizations User Guide>.

If you specify C<Condition> with an Amazon Web Services organization
ID, and specify "*" as the value for C<Principal>, you grant permission
...
Each C<StatementId> must be unique.
