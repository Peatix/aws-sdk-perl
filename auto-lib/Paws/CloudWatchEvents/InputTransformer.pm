...
The C<InputTemplate> can also be valid JSON with varibles in quotes or
...
C<"InputTemplate": '{"myInstance": E<lt>instanceE<gt>,"myStatus":
"E<lt>instanceE<gt> is in state \"E<lt>statusE<gt>\""}'>
