    ...
    my $CreateConnectionResponse = $events->CreateConnection(
      AuthParameters => {
        ApiKeyAuthParameters => {
          ...
          ApiKeyValue => 'MyAuthHeaderParametersSensitive',   # min: 1, max: 512

        },    # OPTIONAL
        BasicAuthParameters => {
          Password => 'MyAuthHeaderParametersSensitive',    # min: 1, max: 512
        ...
        OAuthParameters => {
          ...
          ClientParameters      => {
            ...
            ClientSecret =>
              'MyAuthHeaderParametersSensitive',         # min: 1, max: 512
