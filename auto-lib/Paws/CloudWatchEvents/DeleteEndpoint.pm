...
package Paws::CloudWatchEvents::DeleteEndpoint;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::CloudWatchEvents::DeleteEndpointResponse');
...
Paws::CloudWatchEvents::DeleteEndpoint - Arguments for method DeleteEndpoint on L<Paws::CloudWatchEvents>
...
=head1 SYNOPSIS
    ...
    my $DeleteEndpointResponse = $events->DeleteEndpoint(
      Name => 'MyEndpointName',
...
This class forms part of L<Paws>, documenting arguments for method DeleteEndpoint in L<Paws::CloudWatchEvents>
