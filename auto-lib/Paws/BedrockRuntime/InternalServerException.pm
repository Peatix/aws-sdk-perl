...
package Paws::BedrockRuntime::InternalServerException;
  use Moose;
...
Paws::BedrockRuntime::InternalServerException
...
As an example, if Att1 is expected to be a Paws::BedrockRuntime::InternalServerException object:

  $service_obj->Method(Att1 => { Message => $value, ..., Message => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::BedrockRuntime::InternalServerException object:
