...
package Paws::BedrockRuntime::ConverseStream;
  use Moose;
  ...
  has GuardrailConfig => (is => 'ro', isa => 'Paws::BedrockRuntime::GuardrailStreamConfiguration', traits => ['NameInRequest'], request_name => 'guardrailConfig');
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'ConverseStream');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/model/{modelId}/converse-stream');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::BedrockRuntime::ConverseStreamResponse');
1;
...
Paws::BedrockRuntime::ConverseStream - Arguments for method ConverseStream on L<Paws::BedrockRuntime>

=head1 DESCRIPTION

This class represents the parameters used for calling the method ConverseStream on the
L<Amazon Bedrock Runtime|Paws::BedrockRuntime> service. Use the attributes of this class
as arguments to method ConverseStream.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to ConverseStream.

=head1 SYNOPSIS

    my $bedrock-runtime = Paws->service('BedrockRuntime');
    my $ConverseStreamResponse = $bedrock -runtime->ConverseStream(
      ModelId                      => 'MyConversationalModelId',
      AdditionalModelRequestFields => {

      },    # OPTIONAL
      AdditionalModelResponseFieldPaths => [
'MyConverseStreamRequestAdditionalModelResponseFieldPathsListMemberString',
        ...    # min: 1, max: 256
      ],    # OPTIONAL
      GuardrailConfig => {
        GuardrailIdentifier  => 'MyGuardrailIdentifier',    # max: 2048
        GuardrailVersion     => 'MyGuardrailVersion',
        StreamProcessingMode => 'sync',    # values: sync, async; OPTIONAL
    ...
    # Results:
    my $Stream = $ConverseStreamResponse->Stream;

    # Returns a L<Paws::BedrockRuntime::ConverseStreamResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/bedrock-runtime/ConverseStream>
...
=head2 GuardrailConfig => L<Paws::BedrockRuntime::GuardrailStreamConfiguration>
...
This class forms part of L<Paws>, documenting arguments for method ConverseStream in L<Paws::BedrockRuntime>
