...
package Paws::BedrockRuntime::InvokeModelWithResponseStream;
  use Moose;
  has Accept => (is => 'ro', isa => 'Str', traits => ['ParamInHeader'], header_name => 'X-Amzn-Bedrock-Accept');
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'InvokeModelWithResponseStream');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/model/{modelId}/invoke-with-response-stream');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::BedrockRuntime::InvokeModelWithResponseStreamResponse');
1;
...
Paws::BedrockRuntime::InvokeModelWithResponseStream - Arguments for method InvokeModelWithResponseStream on L<Paws::BedrockRuntime>

=head1 DESCRIPTION

This class represents the parameters used for calling the method InvokeModelWithResponseStream on the
L<Amazon Bedrock Runtime|Paws::BedrockRuntime> service. Use the attributes of this class
as arguments to method InvokeModelWithResponseStream.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to InvokeModelWithResponseStream.

=head1 SYNOPSIS

    my $bedrock-runtime = Paws->service('BedrockRuntime');
    my $InvokeModelWithResponseStreamResponse =
    ...
    # Results:
    my $Body        = $InvokeModelWithResponseStreamResponse->Body;
    my $ContentType = $InvokeModelWithResponseStreamResponse->ContentType;
    my $PerformanceConfigLatency =
      $InvokeModelWithResponseStreamResponse->PerformanceConfigLatency;

# Returns a L<Paws::BedrockRuntime::InvokeModelWithResponseStreamResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/bedrock-runtime/InvokeModelWithResponseStream>
...
This class forms part of L<Paws>, documenting arguments for method InvokeModelWithResponseStream in L<Paws::BedrockRuntime>
