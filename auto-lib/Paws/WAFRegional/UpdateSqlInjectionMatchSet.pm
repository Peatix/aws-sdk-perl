...
Paws::WAFRegional::UpdateSqlInjectionMatchSet - Arguments for method UpdateSqlInjectionMatchSet on L<Paws::WAFRegional>
...
=head1 SYNOPSIS
 ...
 # SQL injection match set with the ID example1ds3t-46da-4fdb-b8d5-abc321j569j5.
    ...
    # Returns a L<Paws::WAFRegional::UpdateSqlInjectionMatchSetResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method UpdateSqlInjectionMatchSet in L<Paws::WAFRegional>
