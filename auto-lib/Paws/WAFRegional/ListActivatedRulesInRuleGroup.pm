...
package Paws::WAFRegional::ListActivatedRulesInRuleGroup;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAFRegional::ListActivatedRulesInRuleGroupResponse');
...
Paws::WAFRegional::ListActivatedRulesInRuleGroup - Arguments for method ListActivatedRulesInRuleGroup on L<Paws::WAFRegional>
...
=head1 SYNOPSIS
 ...
 # Returns a L<Paws::WAFRegional::ListActivatedRulesInRuleGroupResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method ListActivatedRulesInRuleGroup in L<Paws::WAFRegional>
