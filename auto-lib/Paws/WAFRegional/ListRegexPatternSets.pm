...
package Paws::WAFRegional::ListRegexPatternSets;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAFRegional::ListRegexPatternSetsResponse');
...
Paws::WAFRegional::ListRegexPatternSets - Arguments for method ListRegexPatternSets on L<Paws::WAFRegional>
...
=head1 SYNOPSIS
    ...
    my $ListRegexPatternSetsResponse = $waf -regional->ListRegexPatternSets(
      Limit      => 1,                 # OPTIONAL
    ...
    # Returns a L<Paws::WAFRegional::ListRegexPatternSetsResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method ListRegexPatternSets in L<Paws::WAFRegional>
