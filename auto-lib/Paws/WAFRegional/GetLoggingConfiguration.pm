...
package Paws::WAFRegional::GetLoggingConfiguration;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAFRegional::GetLoggingConfigurationResponse');
...
Paws::WAFRegional::GetLoggingConfiguration - Arguments for method GetLoggingConfiguration on L<Paws::WAFRegional>
...
=head1 SYNOPSIS
    ...
    my $GetLoggingConfigurationResponse =
    ...
    # Returns a L<Paws::WAFRegional::GetLoggingConfigurationResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method GetLoggingConfiguration in L<Paws::WAFRegional>
