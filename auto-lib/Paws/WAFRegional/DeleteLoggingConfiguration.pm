...
package Paws::WAFRegional::DeleteLoggingConfiguration;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAFRegional::DeleteLoggingConfigurationResponse');
...
Paws::WAFRegional::DeleteLoggingConfiguration - Arguments for method DeleteLoggingConfiguration on L<Paws::WAFRegional>
...
=head1 SYNOPSIS
    ...
    my $DeleteLoggingConfigurationResponse =
...
This class forms part of L<Paws>, documenting arguments for method DeleteLoggingConfiguration in L<Paws::WAFRegional>
