...
package Paws::WAFRegional::ListRateBasedRules;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAFRegional::ListRateBasedRulesResponse');
...
Paws::WAFRegional::ListRateBasedRules - Arguments for method ListRateBasedRules on L<Paws::WAFRegional>
...
=head1 SYNOPSIS
    ...
    my $ListRateBasedRulesResponse = $waf -regional->ListRateBasedRules(
      Limit      => 1,                 # OPTIONAL
    ...
    # Returns a L<Paws::WAFRegional::ListRateBasedRulesResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method ListRateBasedRules in L<Paws::WAFRegional>
