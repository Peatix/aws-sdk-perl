...
package Paws::WAFRegional::DeletePermissionPolicy;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAFRegional::DeletePermissionPolicyResponse');
...
Paws::WAFRegional::DeletePermissionPolicy - Arguments for method DeletePermissionPolicy on L<Paws::WAFRegional>
...
=head1 SYNOPSIS
    ...
    my $DeletePermissionPolicyResponse = $waf -regional->DeletePermissionPolicy(
...
This class forms part of L<Paws>, documenting arguments for method DeletePermissionPolicy in L<Paws::WAFRegional>
