...
package Paws::WAFRegional::ListByteMatchSets;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAFRegional::ListByteMatchSetsResponse');
...
Paws::WAFRegional::ListByteMatchSets - Arguments for method ListByteMatchSets on L<Paws::WAFRegional>
...
=head1 SYNOPSIS
    ...
    my $ListByteMatchSetsResponse = $waf -regional->ListByteMatchSets(
      Limit      => 1,                 # OPTIONAL
    ...
    # Returns a L<Paws::WAFRegional::ListByteMatchSetsResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method ListByteMatchSets in L<Paws::WAFRegional>
