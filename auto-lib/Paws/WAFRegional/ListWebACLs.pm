...
package Paws::WAFRegional::ListWebACLs;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAFRegional::ListWebACLsResponse');
...
Paws::WAFRegional::ListWebACLs - Arguments for method ListWebACLs on L<Paws::WAFRegional>
...
=head1 SYNOPSIS
    ...
    my $ListWebACLsResponse = $waf -regional->ListWebACLs( 'Limit' => 100 );

    # Results:
    my $WebACLs = $ListWebACLsResponse->WebACLs;

    # Returns a L<Paws::WAFRegional::ListWebACLsResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method ListWebACLs in L<Paws::WAFRegional>
