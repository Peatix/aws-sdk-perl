...
package Paws::WAFRegional::GetChangeToken;
  use Moose;

  use MooseX::ClassAttribute;

  class_has _api_call => (isa => 'Str', is => 'ro', default => 'GetChangeToken');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAFRegional::GetChangeTokenResponse');
...
Paws::WAFRegional::GetChangeToken - Arguments for method GetChangeToken on L<Paws::WAFRegional>
...
=head1 SYNOPSIS
   ...
   # delete operation.
    my $GetChangeTokenResponse = $waf -regional->GetChangeToken();

    # Results:
    my $ChangeToken = $GetChangeTokenResponse->ChangeToken;

    # Returns a L<Paws::WAFRegional::GetChangeTokenResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method GetChangeToken in L<Paws::WAFRegional>
