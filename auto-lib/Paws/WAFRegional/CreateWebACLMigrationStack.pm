...
package Paws::WAFRegional::CreateWebACLMigrationStack;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAFRegional::CreateWebACLMigrationStackResponse');
...
Paws::WAFRegional::CreateWebACLMigrationStack - Arguments for method CreateWebACLMigrationStack on L<Paws::WAFRegional>
...
This class forms part of L<Paws>, documenting arguments for method CreateWebACLMigrationStack in L<Paws::WAFRegional>
