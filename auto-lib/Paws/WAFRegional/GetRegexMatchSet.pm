...
package Paws::WAFRegional::GetRegexMatchSet;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAFRegional::GetRegexMatchSetResponse');
...
Paws::WAFRegional::GetRegexMatchSet - Arguments for method GetRegexMatchSet on L<Paws::WAFRegional>
...
=head1 SYNOPSIS
    ...
    my $GetRegexMatchSetResponse = $waf -regional->GetRegexMatchSet(
    ...
    # Returns a L<Paws::WAFRegional::GetRegexMatchSetResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method GetRegexMatchSet in L<Paws::WAFRegional>
