...
package Paws::WAFRegional::ListXssMatchSets;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAFRegional::ListXssMatchSetsResponse');
...
Paws::WAFRegional::ListXssMatchSets - Arguments for method ListXssMatchSets on L<Paws::WAFRegional>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::WAFRegional::ListXssMatchSetsResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method ListXssMatchSets in L<Paws::WAFRegional>
