...
package Paws::WAFRegional::DeleteGeoMatchSet;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAFRegional::DeleteGeoMatchSetResponse');
...
Paws::WAFRegional::DeleteGeoMatchSet - Arguments for method DeleteGeoMatchSet on L<Paws::WAFRegional>
...
=head1 SYNOPSIS
    ...
    my $DeleteGeoMatchSetResponse = $waf -regional->DeleteGeoMatchSet(
    ...
    # Returns a L<Paws::WAFRegional::DeleteGeoMatchSetResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method DeleteGeoMatchSet in L<Paws::WAFRegional>
