...
package Paws::WAFRegional::ListRuleGroups;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAFRegional::ListRuleGroupsResponse');
...
Paws::WAFRegional::ListRuleGroups - Arguments for method ListRuleGroups on L<Paws::WAFRegional>
...
=head1 SYNOPSIS
    ...
    my $ListRuleGroupsResponse = $waf -regional->ListRuleGroups(
      Limit      => 1,                 # OPTIONAL
...
This class forms part of L<Paws>, documenting arguments for method ListRuleGroups in L<Paws::WAFRegional>
