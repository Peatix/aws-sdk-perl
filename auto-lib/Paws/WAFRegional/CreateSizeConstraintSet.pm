...
package Paws::WAFRegional::CreateSizeConstraintSet;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAFRegional::CreateSizeConstraintSetResponse');
...
Paws::WAFRegional::CreateSizeConstraintSet - Arguments for method CreateSizeConstraintSet on L<Paws::WAFRegional>
...
This class forms part of L<Paws>, documenting arguments for method CreateSizeConstraintSet in L<Paws::WAFRegional>
