...
package Paws::WAFRegional::CreateByteMatchSet;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAFRegional::CreateByteMatchSetResponse');
...
Paws::WAFRegional::CreateByteMatchSet - Arguments for method CreateByteMatchSet on L<Paws::WAFRegional>
...
This class forms part of L<Paws>, documenting arguments for method CreateByteMatchSet in L<Paws::WAFRegional>
