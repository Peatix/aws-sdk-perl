...
package Paws::WAFRegional::CreateSqlInjectionMatchSet;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAFRegional::CreateSqlInjectionMatchSetResponse');
...
Paws::WAFRegional::CreateSqlInjectionMatchSet - Arguments for method CreateSqlInjectionMatchSet on L<Paws::WAFRegional>
...
=head1 SYNOPSIS
    ...
    my $CreateSqlInjectionMatchSetResponse =
    ...
    # Returns a L<Paws::WAFRegional::CreateSqlInjectionMatchSetResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method CreateSqlInjectionMatchSet in L<Paws::WAFRegional>
