...
package Paws::WAFRegional::GetChangeTokenStatus;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAFRegional::GetChangeTokenStatusResponse');
...
Paws::WAFRegional::GetChangeTokenStatus - Arguments for method GetChangeTokenStatus on L<Paws::WAFRegional>
...
This class forms part of L<Paws>, documenting arguments for method GetChangeTokenStatus in L<Paws::WAFRegional>
