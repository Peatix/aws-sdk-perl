...
commit. We recommend that you run each MySQL DDL statement in a
separate C<ExecuteStatement> call with C<continueAfterTimeout> enabled.
...
deprecated. Use the C<BatchExecuteStatement> or C<ExecuteStatement>
operation.
