...
is applied to all Cost Categories. That is, it filters on resources
that aren't mapped to any Cost Categories.

If C<Values> is provided and C<Key> isn't specified, the C<ABSENT>
