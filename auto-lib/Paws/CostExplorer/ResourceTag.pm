...
package Paws::CostExplorer::ResourceTag;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::CostExplorer::ResourceTag object:

  $service_obj->Method(Att1 => { Key => $value, ..., Value => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CostExplorer::ResourceTag object:
