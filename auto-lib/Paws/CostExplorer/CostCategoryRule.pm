...
C<LINKED_ACCOUNT>, C<SERVICE_CODE>, C<RECORD_TYPE>,
C<LINKED_ACCOUNT_NAME>, C<REGION>, and C<USAGE_TYPE>.
...
category value. This value is from the dimension value that's defined
by C<CostCategoryInheritedValueDimension>. For example, suppose that
you want to costs to be dynamically grouped based on the value of a
