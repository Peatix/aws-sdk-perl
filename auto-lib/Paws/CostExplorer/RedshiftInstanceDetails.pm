...
package Paws::CostExplorer::RedshiftInstanceDetails;
  use Moose;
...
Paws::CostExplorer::RedshiftInstanceDetails
...
As an example, if Att1 is expected to be a Paws::CostExplorer::RedshiftInstanceDetails object:

  $service_obj->Method(Att1 => { CurrentGeneration => $value, ..., SizeFlexEligible => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CostExplorer::RedshiftInstanceDetails object:
