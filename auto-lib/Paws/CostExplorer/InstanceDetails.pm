...
package Paws::CostExplorer::InstanceDetails;
  ...
  has MemoryDBInstanceDetails => (is => 'ro', isa => 'Paws::CostExplorer::MemoryDBInstanceDetails');
...
The ElastiCache reservations that Amazon Web Services recommends that
you purchase.
...
=head2 MemoryDBInstanceDetails => L<Paws::CostExplorer::MemoryDBInstanceDetails>
