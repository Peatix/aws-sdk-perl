...
package Paws::SecurityLake::UntagResource;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::SecurityLake::UntagResourceResponse');
1;
...
Paws::SecurityLake::UntagResource - Arguments for method UntagResource on L<Paws::SecurityLake>
...
=head1 SYNOPSIS
    ...
    my $UntagResourceResponse = $securitylake->UntagResource(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/securitylake/UntagResource>
...
This class forms part of L<Paws>, documenting arguments for method UntagResource in L<Paws::SecurityLake>
