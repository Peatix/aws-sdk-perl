...
package Paws::Transfer::DeleteConnector;
  use Moose;
...
Paws::Transfer::DeleteConnector - Arguments for method DeleteConnector on L<Paws::Transfer>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/transfer/DeleteConnector>
...
This class forms part of L<Paws>, documenting arguments for method DeleteConnector in L<Paws::Transfer>
