...
package Paws::Transfer::EfsFileLocation;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::Transfer::EfsFileLocation object:

  $service_obj->Method(Att1 => { FileSystemId => $value, ..., Path => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Transfer::EfsFileLocation object:
