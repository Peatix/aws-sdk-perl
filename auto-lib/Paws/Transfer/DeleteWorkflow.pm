...
package Paws::Transfer::DeleteWorkflow;
  use Moose;
...
Paws::Transfer::DeleteWorkflow - Arguments for method DeleteWorkflow on L<Paws::Transfer>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/transfer/DeleteWorkflow>
...
This class forms part of L<Paws>, documenting arguments for method DeleteWorkflow in L<Paws::Transfer>
