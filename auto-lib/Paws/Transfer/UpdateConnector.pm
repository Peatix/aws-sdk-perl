...
package Paws::Transfer::UpdateConnector;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Transfer::UpdateConnectorResponse');
...
Paws::Transfer::UpdateConnector - Arguments for method UpdateConnector on L<Paws::Transfer>
...
=head1 SYNOPSIS
    ...
    my $UpdateConnectorResponse = $transfer->UpdateConnector(
    ...
    # Results:
    my $ConnectorId = $UpdateConnectorResponse->ConnectorId;

    # Returns a L<Paws::Transfer::UpdateConnectorResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/transfer/UpdateConnector>
...
This class forms part of L<Paws>, documenting arguments for method UpdateConnector in L<Paws::Transfer>
