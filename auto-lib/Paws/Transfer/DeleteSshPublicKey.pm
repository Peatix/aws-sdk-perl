...
Paws::Transfer::DeleteSshPublicKey - Arguments for method DeleteSshPublicKey on L<Paws::Transfer>
...
=head1 SYNOPSIS
    ...
    $transfer->DeleteSshPublicKey(
      ServerId       => 'MyServerId',
      SshPublicKeyId => 'MySshPublicKeyId',
      UserName       => 'MyUserName',
...
This class forms part of L<Paws>, documenting arguments for method DeleteSshPublicKey in L<Paws::Transfer>
