...
package Paws::Transfer::UpdateAccess;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'UpdateAccess');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Transfer::UpdateAccessResponse');
...
Paws::Transfer::UpdateAccess - Arguments for method UpdateAccess on L<Paws::Transfer>

=head1 DESCRIPTION

This class represents the parameters used for calling the method UpdateAccess on the
L<AWS Transfer Family|Paws::Transfer> service. Use the attributes of this class
as arguments to method UpdateAccess.
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/transfer/UpdateAccess>
...
in the I<Amazon Web ServicesSecurity Token Service API Reference>.
...
This class forms part of L<Paws>, documenting arguments for method UpdateAccess in L<Paws::Transfer>
