...
Paws::ManagedBlockchain::DeleteMember - Arguments for method DeleteMember on L<Paws::ManagedBlockchain>
...
=head1 SYNOPSIS
    ...
    my $DeleteMemberOutput = $managedblockchain->DeleteMember(
...
This class forms part of L<Paws>, documenting arguments for method DeleteMember in L<Paws::ManagedBlockchain>
