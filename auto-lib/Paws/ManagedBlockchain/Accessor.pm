...
package Paws::ManagedBlockchain::Accessor;
  use Moose;
...
Paws::ManagedBlockchain::Accessor
...
As an example, if Att1 is expected to be a Paws::ManagedBlockchain::Accessor object:

  $service_obj->Method(Att1 => { Arn => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ManagedBlockchain::Accessor object:
