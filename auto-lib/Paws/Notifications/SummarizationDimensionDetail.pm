...
package Paws::Notifications::SummarizationDimensionDetail;
  use Moose;
...
Paws::Notifications::SummarizationDimensionDetail
...
As an example, if Att1 is expected to be a Paws::Notifications::SummarizationDimensionDetail object:

  $service_obj->Method(Att1 => { Name => $value, ..., Value => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Notifications::SummarizationDimensionDetail object:
