...
package Paws::SSOAdmin::ListApplicationsResponse;
  use Moose;
  has Applications => (is => 'ro', isa => 'ArrayRef[Paws::SSOAdmin::Application]');
...
Paws::SSOAdmin::ListApplicationsResponse

=head1 ATTRIBUTES


=head2 Applications => ArrayRef[L<Paws::SSOAdmin::Application>]
