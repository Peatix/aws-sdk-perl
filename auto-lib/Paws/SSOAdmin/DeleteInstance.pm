...
package Paws::SSOAdmin::DeleteInstance;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::SSOAdmin::DeleteInstanceResponse');
...
Paws::SSOAdmin::DeleteInstance - Arguments for method DeleteInstance on L<Paws::SSOAdmin>
...
=head1 SYNOPSIS
    ...
    my $DeleteInstanceResponse = $sso->DeleteInstance(
      InstanceArn => 'MyInstanceArn',

    );

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/sso/DeleteInstance>
...
This class forms part of L<Paws>, documenting arguments for method DeleteInstance in L<Paws::SSOAdmin>
