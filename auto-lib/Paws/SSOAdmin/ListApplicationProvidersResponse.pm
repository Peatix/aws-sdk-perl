...
package Paws::SSOAdmin::ListApplicationProvidersResponse;
  use Moose;
  has ApplicationProviders => (is => 'ro', isa => 'ArrayRef[Paws::SSOAdmin::ApplicationProvider]');
...
Paws::SSOAdmin::ListApplicationProvidersResponse

=head1 ATTRIBUTES


=head2 ApplicationProviders => ArrayRef[L<Paws::SSOAdmin::ApplicationProvider>]
