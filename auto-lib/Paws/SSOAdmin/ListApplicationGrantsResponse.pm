...
package Paws::SSOAdmin::ListApplicationGrantsResponse;
  use Moose;
  has Grants => (is => 'ro', isa => 'ArrayRef[Paws::SSOAdmin::GrantItem]', required => 1);
...
Paws::SSOAdmin::ListApplicationGrantsResponse

=head1 ATTRIBUTES


=head2 B<REQUIRED> Grants => ArrayRef[L<Paws::SSOAdmin::GrantItem>]
