...
package Paws::SSOAdmin::DeleteApplication;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::SSOAdmin::DeleteApplicationResponse');
...
Paws::SSOAdmin::DeleteApplication - Arguments for method DeleteApplication on L<Paws::SSOAdmin>
...
=head1 SYNOPSIS
    ...
    my $DeleteApplicationResponse = $sso->DeleteApplication(
      ApplicationArn => 'MyApplicationArn',

    );

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/sso/DeleteApplication>
...
This class forms part of L<Paws>, documenting arguments for method DeleteApplication in L<Paws::SSOAdmin>
