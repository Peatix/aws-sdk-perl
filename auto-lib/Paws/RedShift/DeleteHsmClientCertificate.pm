...
Paws::RedShift::DeleteHsmClientCertificate - Arguments for method DeleteHsmClientCertificate on L<Paws::RedShift>

=head1 DESCRIPTION

This class represents the parameters used for calling the method DeleteHsmClientCertificate on the
