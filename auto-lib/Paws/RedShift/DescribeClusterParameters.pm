...
Paws::RedShift::DescribeClusterParameters - Arguments for method DescribeClusterParameters on L<Paws::RedShift>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/redshift/DescribeClusterParameters>
