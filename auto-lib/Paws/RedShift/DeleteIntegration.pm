...
package Paws::RedShift::DeleteIntegration;
  use Moose;
...
Paws::RedShift::DeleteIntegration - Arguments for method DeleteIntegration on L<Paws::RedShift>
...
=head1 SYNOPSIS
    ...
    my $Integration = $redshift->DeleteIntegration(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/redshift/DeleteIntegration>
...
This class forms part of L<Paws>, documenting arguments for method DeleteIntegration in L<Paws::RedShift>
