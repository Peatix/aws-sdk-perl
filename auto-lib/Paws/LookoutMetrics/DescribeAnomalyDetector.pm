...
package Paws::LookoutMetrics::DescribeAnomalyDetector;
  use Moose;
...
=head1 SYNOPSIS
    ...
    my $FailureType   = $DescribeAnomalyDetectorResponse->FailureType;
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/lookoutmetrics/DescribeAnomalyDetector>
