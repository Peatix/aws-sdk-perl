...
package Paws::LookoutMetrics::CloudWatchConfig;
  use Moose;
...
Paws::LookoutMetrics::CloudWatchConfig
...
As an example, if Att1 is expected to be a Paws::LookoutMetrics::CloudWatchConfig object:

  $service_obj->Method(Att1 => { BackTestConfiguration => $value, ..., RoleArn => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::LookoutMetrics::CloudWatchConfig object:
