...
package Paws::Account::GetContactInformation;
  use Moose;
  has AccountId => (is => 'ro', isa => 'Str');

  use MooseX::ClassAttribute;

  class_has _api_call => (isa => 'Str', is => 'ro', default => 'GetContactInformation');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/getContactInformation');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Account::GetContactInformationResponse');
1;
...
Paws::Account::GetContactInformation - Arguments for method GetContactInformation on L<Paws::Account>

=head1 DESCRIPTION

This class represents the parameters used for calling the method GetContactInformation on the
L<AWS Account|Paws::Account> service. Use the attributes of this class
as arguments to method GetContactInformation.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to GetContactInformation.

=head1 SYNOPSIS

    my $account = Paws->service('Account');
    my $GetContactInformationResponse = $account->GetContactInformation(
      AccountId => 'MyAccountId',    # OPTIONAL
    );

    # Results:
    my $ContactInformation = $GetContactInformationResponse->ContactInformation;

    # Returns a L<Paws::Account::GetContactInformationResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/account/GetContactInformation>
...
This class forms part of L<Paws>, documenting arguments for method GetContactInformation in L<Paws::Account>
