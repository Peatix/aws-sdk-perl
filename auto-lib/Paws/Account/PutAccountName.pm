...
package Paws::Account::PutAccountName;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'PutAccountName');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/putAccountName');
...
Paws::Account::PutAccountName - Arguments for method PutAccountName on L<Paws::Account>

=head1 DESCRIPTION

This class represents the parameters used for calling the method PutAccountName on the
L<AWS Account|Paws::Account> service. Use the attributes of this class
as arguments to method PutAccountName.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to PutAccountName.
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/account/PutAccountName>
...
This class forms part of L<Paws>, documenting arguments for method PutAccountName in L<Paws::Account>
