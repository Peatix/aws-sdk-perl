...
package Paws::Account::DeleteAlternateContact;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'DeleteAlternateContact');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/deleteAlternateContact');
...
Paws::Account::DeleteAlternateContact - Arguments for method DeleteAlternateContact on L<Paws::Account>

=head1 DESCRIPTION

This class represents the parameters used for calling the method DeleteAlternateContact on the
L<AWS Account|Paws::Account> service. Use the attributes of this class
as arguments to method DeleteAlternateContact.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to DeleteAlternateContact.
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/account/DeleteAlternateContact>
...
This class forms part of L<Paws>, documenting arguments for method DeleteAlternateContact in L<Paws::Account>
