...
package Paws::Account::GetAlternateContact;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'GetAlternateContact');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/getAlternateContact');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Account::GetAlternateContactResponse');
1;
...
Paws::Account::GetAlternateContact - Arguments for method GetAlternateContact on L<Paws::Account>

=head1 DESCRIPTION

This class represents the parameters used for calling the method GetAlternateContact on the
L<AWS Account|Paws::Account> service. Use the attributes of this class
as arguments to method GetAlternateContact.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to GetAlternateContact.

=head1 SYNOPSIS

    my $account = Paws->service('Account');
    my $GetAlternateContactResponse = $account->GetAlternateContact(
      AlternateContactType => 'BILLING',
      AccountId            => 'MyAccountId',    # OPTIONAL
    );

    # Results:
    my $AlternateContact = $GetAlternateContactResponse->AlternateContact;

    # Returns a L<Paws::Account::GetAlternateContactResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/account/GetAlternateContact>
...
This class forms part of L<Paws>, documenting arguments for method GetAlternateContact in L<Paws::Account>
