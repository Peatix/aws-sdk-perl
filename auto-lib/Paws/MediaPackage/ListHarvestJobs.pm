...
package Paws::MediaPackage::ListHarvestJobs;
  use Moose;
  has IncludeChannelId => (is => 'ro', isa => 'Str', traits => ['ParamInQuery'], query_name => 'includeChannelId');
  has IncludeStatus => (is => 'ro', isa => 'Str', traits => ['ParamInQuery'], query_name => 'includeStatus');
