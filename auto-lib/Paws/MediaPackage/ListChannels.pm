...
package Paws::MediaPackage::ListChannels;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::MediaPackage::ListChannelsResponse');
1;
...
Paws::MediaPackage::ListChannels - Arguments for method ListChannels on L<Paws::MediaPackage>
...
This class forms part of L<Paws>, documenting arguments for method ListChannels in L<Paws::MediaPackage>
