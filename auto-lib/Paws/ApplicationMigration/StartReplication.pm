...
package Paws::ApplicationMigration::StartReplication;
  use Moose;
...
Paws::ApplicationMigration::StartReplication - Arguments for method StartReplication on L<Paws::ApplicationMigration>
...
=head1 SYNOPSIS
    ...
    my $SourceServer = $mgn->StartReplication(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/mgn/StartReplication>
...
This class forms part of L<Paws>, documenting arguments for method StartReplication in L<Paws::ApplicationMigration>
