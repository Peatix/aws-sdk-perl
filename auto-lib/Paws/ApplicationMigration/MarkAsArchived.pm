...
package Paws::ApplicationMigration::MarkAsArchived;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'MarkAsArchived');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/MarkAsArchived');
...
Paws::ApplicationMigration::MarkAsArchived - Arguments for method MarkAsArchived on L<Paws::ApplicationMigration>

=head1 DESCRIPTION

This class represents the parameters used for calling the method MarkAsArchived on the
L<Application Migration Service|Paws::ApplicationMigration> service. Use the attributes of this class
as arguments to method MarkAsArchived.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to MarkAsArchived.
...
This class forms part of L<Paws>, documenting arguments for method MarkAsArchived in L<Paws::ApplicationMigration>
