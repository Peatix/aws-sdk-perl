...
package Paws::ApplicationMigration::DescribeReplicationConfigurationTemplates;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ApplicationMigration::DescribeReplicationConfigurationTemplatesResponse');
1;
...
Paws::ApplicationMigration::DescribeReplicationConfigurationTemplates - Arguments for method DescribeReplicationConfigurationTemplates on L<Paws::ApplicationMigration>
...
# Returns a L<Paws::ApplicationMigration::DescribeReplicationConfigurationTemplatesResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/mgn/DescribeReplicationConfigurationTemplates>
...
This class forms part of L<Paws>, documenting arguments for method DescribeReplicationConfigurationTemplates in L<Paws::ApplicationMigration>
