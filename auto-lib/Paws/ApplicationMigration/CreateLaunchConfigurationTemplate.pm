...
package Paws::ApplicationMigration::CreateLaunchConfigurationTemplate;
  use Moose;
...
Paws::ApplicationMigration::CreateLaunchConfigurationTemplate - Arguments for method CreateLaunchConfigurationTemplate on L<Paws::ApplicationMigration>
...
=head1 SYNOPSIS
    ...
    my $LaunchConfigurationTemplate = $mgn->CreateLaunchConfigurationTemplate(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/mgn/CreateLaunchConfigurationTemplate>
...
This class forms part of L<Paws>, documenting arguments for method CreateLaunchConfigurationTemplate in L<Paws::ApplicationMigration>
