...
package Paws::ApplicationMigration::DeleteJob;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ApplicationMigration::DeleteJobResponse');
1;
...
Paws::ApplicationMigration::DeleteJob - Arguments for method DeleteJob on L<Paws::ApplicationMigration>
...
This class forms part of L<Paws>, documenting arguments for method DeleteJob in L<Paws::ApplicationMigration>
