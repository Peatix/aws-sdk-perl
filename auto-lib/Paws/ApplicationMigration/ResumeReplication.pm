...
package Paws::ApplicationMigration::ResumeReplication;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'ResumeReplication');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/ResumeReplication');
...
Paws::ApplicationMigration::ResumeReplication - Arguments for method ResumeReplication on L<Paws::ApplicationMigration>

=head1 DESCRIPTION

This class represents the parameters used for calling the method ResumeReplication on the
L<Application Migration Service|Paws::ApplicationMigration> service. Use the attributes of this class
as arguments to method ResumeReplication.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to ResumeReplication.

=head1 SYNOPSIS

    my $mgn = Paws->service('ApplicationMigration');
    my $SourceServer = $mgn->ResumeReplication(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/mgn/ResumeReplication>
...
This class forms part of L<Paws>, documenting arguments for method ResumeReplication in L<Paws::ApplicationMigration>
