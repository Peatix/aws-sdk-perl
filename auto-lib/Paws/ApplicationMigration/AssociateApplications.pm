...
package Paws::ApplicationMigration::AssociateApplications;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/AssociateApplications');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ApplicationMigration::AssociateApplicationsResponse');
1;
...
Paws::ApplicationMigration::AssociateApplications - Arguments for method AssociateApplications on L<Paws::ApplicationMigration>
...
=head1 SYNOPSIS
    ...
    my $AssociateApplicationsResponse = $mgn->AssociateApplications(
      ApplicationIDs => [
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/mgn/AssociateApplications>
...
This class forms part of L<Paws>, documenting arguments for method AssociateApplications in L<Paws::ApplicationMigration>
