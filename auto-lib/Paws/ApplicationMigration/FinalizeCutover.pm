...
package Paws::ApplicationMigration::FinalizeCutover;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'FinalizeCutover');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/FinalizeCutover');
...
Paws::ApplicationMigration::FinalizeCutover - Arguments for method FinalizeCutover on L<Paws::ApplicationMigration>

=head1 DESCRIPTION

This class represents the parameters used for calling the method FinalizeCutover on the
L<Application Migration Service|Paws::ApplicationMigration> service. Use the attributes of this class
as arguments to method FinalizeCutover.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to FinalizeCutover.

=head1 SYNOPSIS

    my $mgn = Paws->service('ApplicationMigration');
    my $SourceServer = $mgn->FinalizeCutover(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/mgn/FinalizeCutover>
...
This class forms part of L<Paws>, documenting arguments for method FinalizeCutover in L<Paws::ApplicationMigration>
