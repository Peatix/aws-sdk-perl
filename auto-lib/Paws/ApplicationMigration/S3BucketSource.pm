...
package Paws::ApplicationMigration::S3BucketSource;
  use Moose;
...
Paws::ApplicationMigration::S3BucketSource
...
As an example, if Att1 is expected to be a Paws::ApplicationMigration::S3BucketSource object:

  $service_obj->Method(Att1 => { S3Bucket => $value, ..., S3Key => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ApplicationMigration::S3BucketSource object:
