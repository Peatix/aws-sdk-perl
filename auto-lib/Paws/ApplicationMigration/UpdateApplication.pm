...
package Paws::ApplicationMigration::UpdateApplication;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/UpdateApplication');
...
Paws::ApplicationMigration::UpdateApplication - Arguments for method UpdateApplication on L<Paws::ApplicationMigration>
...
=head1 SYNOPSIS
    ...
    my $Application = $mgn->UpdateApplication(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/mgn/UpdateApplication>
...
This class forms part of L<Paws>, documenting arguments for method UpdateApplication in L<Paws::ApplicationMigration>
