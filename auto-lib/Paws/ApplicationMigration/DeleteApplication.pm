...
package Paws::ApplicationMigration::DeleteApplication;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/DeleteApplication');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ApplicationMigration::DeleteApplicationResponse');
1;
...
Paws::ApplicationMigration::DeleteApplication - Arguments for method DeleteApplication on L<Paws::ApplicationMigration>
...
=head1 SYNOPSIS
    ...
    my $DeleteApplicationResponse = $mgn->DeleteApplication(
      ApplicationID => 'MyApplicationID',
      AccountID     => 'MyAccountID',       # OPTIONAL
    );

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/mgn/DeleteApplication>
...
This class forms part of L<Paws>, documenting arguments for method DeleteApplication in L<Paws::ApplicationMigration>
