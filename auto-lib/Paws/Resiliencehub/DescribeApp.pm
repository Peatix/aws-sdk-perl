...
package Paws::Resiliencehub::DescribeApp;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/describe-app');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Resiliencehub::DescribeAppResponse');
1;
...
Paws::Resiliencehub::DescribeApp - Arguments for method DescribeApp on L<Paws::Resiliencehub>
...
=head1 SYNOPSIS
    ...
    my $DescribeAppResponse = $resiliencehub->DescribeApp(
      AppArn => 'MyArn',

    );

    # Results:
    my $App = $DescribeAppResponse->App;

    # Returns a L<Paws::Resiliencehub::DescribeAppResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/resiliencehub/DescribeApp>
...
This class forms part of L<Paws>, documenting arguments for method DescribeApp in L<Paws::Resiliencehub>
