...
package Paws::Resiliencehub::ErrorDetail;
  use Moose;
...
Paws::Resiliencehub::ErrorDetail
...
As an example, if Att1 is expected to be a Paws::Resiliencehub::ErrorDetail object:

  $service_obj->Method(Att1 => { ErrorMessage => $value, ..., ErrorMessage => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Resiliencehub::ErrorDetail object:
