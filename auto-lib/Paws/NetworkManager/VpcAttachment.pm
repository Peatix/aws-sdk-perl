...
package Paws::NetworkManager::VpcAttachment;
  use Moose;
...
Paws::NetworkManager::VpcAttachment
...
As an example, if Att1 is expected to be a Paws::NetworkManager::VpcAttachment object:

  $service_obj->Method(Att1 => { Attachment => $value, ..., SubnetArns => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::NetworkManager::VpcAttachment object:
