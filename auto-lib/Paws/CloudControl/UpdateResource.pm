...
package Paws::CloudControl::UpdateResource;
  use Moose;
  has ClientToken => (is => 'ro', isa => 'Str');
  has Identifier => (is => 'ro', isa => 'Str', required => 1);
  has PatchDocument => (is => 'ro', isa => 'Str', required => 1);
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::CloudControl::UpdateResourceOutput');
...
Paws::CloudControl::UpdateResource - Arguments for method UpdateResource on L<Paws::CloudControl>
...
=head1 SYNOPSIS
    ...
    my $UpdateResourceOutput = $cloudcontrolapi->UpdateResource(
      Identifier    => 'MyIdentifier',
      PatchDocument => 'MyPatchDocument',
      TypeName      => 'MyTypeName',
    ...
    # Results:
    my $ProgressEvent = $UpdateResourceOutput->ProgressEvent;

    # Returns a L<Paws::CloudControl::UpdateResourceOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/cloudcontrolapi/UpdateResource>
...
=head2 B<REQUIRED> PatchDocument => Str
...
properties. For details, see Composing the patch document
...
This class forms part of L<Paws>, documenting arguments for method UpdateResource in L<Paws::CloudControl>
