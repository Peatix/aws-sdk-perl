...
package Paws::CloudControl::GetResource;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::CloudControl::GetResourceOutput');
...
Paws::CloudControl::GetResource - Arguments for method GetResource on L<Paws::CloudControl>
...
=head1 SYNOPSIS
    ...
    my $GetResourceOutput = $cloudcontrolapi->GetResource(
    ...
    # Results:
    my $ResourceDescription = $GetResourceOutput->ResourceDescription;
    my $TypeName            = $GetResourceOutput->TypeName;

    # Returns a L<Paws::CloudControl::GetResourceOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/cloudcontrolapi/GetResource>
...
This class forms part of L<Paws>, documenting arguments for method GetResource in L<Paws::CloudControl>
