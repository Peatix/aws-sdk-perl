...
package Paws::PaymentCryptographyData::TranslatePinDataOutput;
  use Moose;
  has KeyArn => (is => 'ro', isa => 'Str', required => 1);
  has KeyCheckValue => (is => 'ro', isa => 'Str', required => 1);
  has PinBlock => (is => 'ro', isa => 'Str', required => 1);
...
Paws::PaymentCryptographyData::TranslatePinDataOutput
