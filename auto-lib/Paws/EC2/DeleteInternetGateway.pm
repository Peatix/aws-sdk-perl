...
package Paws::EC2::DeleteInternetGateway;
  use Moose;
...
Paws::EC2::DeleteInternetGateway - Arguments for method DeleteInternetGateway on L<Paws::EC2>

=head1 DESCRIPTION

This class represents the parameters used for calling the method DeleteInternetGateway on the
...
This class forms part of L<Paws>, documenting arguments for method DeleteInternetGateway in L<Paws::EC2>
