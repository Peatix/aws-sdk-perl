...
C<description> - The description of the authorization rule.

=item *

C<destination-cidr> - The CIDR of the network to which the
authorization rule applies.

=item *

C<group-id> - The ID of the Active Directory group to which the
