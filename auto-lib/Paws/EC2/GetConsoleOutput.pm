...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/ec2/GetConsoleOutput>
...
This class forms part of L<Paws>, documenting arguments for method GetConsoleOutput in L<Paws::EC2>
