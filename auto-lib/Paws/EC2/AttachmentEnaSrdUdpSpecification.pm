package Paws::EC2::AttachmentEnaSrdUdpSpecification;
  use Moose;
...
Paws::EC2::AttachmentEnaSrdUdpSpecification
...
As an example, if Att1 is expected to be a Paws::EC2::AttachmentEnaSrdUdpSpecification object:

  $service_obj->Method(Att1 => { EnaSrdUdpEnabled => $value, ..., EnaSrdUdpEnabled => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EC2::AttachmentEnaSrdUdpSpecification object:
