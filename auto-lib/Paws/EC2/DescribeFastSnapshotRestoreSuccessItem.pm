package Paws::EC2::DescribeFastSnapshotRestoreSuccessItem;
  use Moose;
...
Paws::EC2::DescribeFastSnapshotRestoreSuccessItem
...
As an example, if Att1 is expected to be a Paws::EC2::DescribeFastSnapshotRestoreSuccessItem object:

  $service_obj->Method(Att1 => { AvailabilityZone => $value, ..., StateTransitionReason => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EC2::DescribeFastSnapshotRestoreSuccessItem object:
