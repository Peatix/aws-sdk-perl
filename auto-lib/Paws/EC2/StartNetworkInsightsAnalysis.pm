...
package Paws::EC2::StartNetworkInsightsAnalysis;
  use Moose;
  has AdditionalAccounts => (is => 'ro', isa => 'ArrayRef[Str|Undef]', traits => ['NameInRequest'], request_name => 'AdditionalAccount' );
  has ClientToken => (is => 'ro', isa => 'Str', required => 1);
  has DryRun => (is => 'ro', isa => 'Bool');
  has FilterInArns => (is => 'ro', isa => 'ArrayRef[Str|Undef]', traits => ['NameInRequest'], request_name => 'FilterInArn' );
  has FilterOutArns => (is => 'ro', isa => 'ArrayRef[Str|Undef]', traits => ['NameInRequest'], request_name => 'FilterOutArn' );
...
=head1 SYNOPSIS
    ...
    my $StartNetworkInsightsAnalysisResult = $ec2->StartNetworkInsightsAnalysis(
      ...
      AdditionalAccounts    => [ 'MyString', ... ],         # OPTIONAL
      DryRun                => 1,                           # OPTIONAL
      FilterInArns          => [
