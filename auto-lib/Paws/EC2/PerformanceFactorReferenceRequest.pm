package Paws::EC2::PerformanceFactorReferenceRequest;
  use Moose;
...
Paws::EC2::PerformanceFactorReferenceRequest
...
As an example, if Att1 is expected to be a Paws::EC2::PerformanceFactorReferenceRequest object:

  $service_obj->Method(Att1 => { InstanceFamily => $value, ..., InstanceFamily => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EC2::PerformanceFactorReferenceRequest object:
