package Paws::EC2::DescribeFleetsInstances;
  use Moose;
...
Paws::EC2::DescribeFleetsInstances
...
As an example, if Att1 is expected to be a Paws::EC2::DescribeFleetsInstances object:

  $service_obj->Method(Att1 => { InstanceIds => $value, ..., Platform => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EC2::DescribeFleetsInstances object:
