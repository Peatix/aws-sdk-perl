...
Paws::EC2::CancelReservedInstancesListing - Arguments for method CancelReservedInstancesListing on L<Paws::EC2>
...
=head1 SYNOPSIS
    ...
    my $CancelReservedInstancesListingResult =
      $ec2->CancelReservedInstancesListing(
      ReservedInstancesListingId => 'MyReservedInstancesListingId',

      );

    # Results:
    my $ReservedInstancesListings =
      $CancelReservedInstancesListingResult->ReservedInstancesListings;

    # Returns a L<Paws::EC2::CancelReservedInstancesListingResult> object.
