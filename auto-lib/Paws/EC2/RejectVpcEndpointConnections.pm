...
Paws::EC2::RejectVpcEndpointConnections - Arguments for method RejectVpcEndpointConnections on L<Paws::EC2>

=head1 DESCRIPTION

This class represents the parameters used for calling the method RejectVpcEndpointConnections on the
L<Amazon Elastic Compute Cloud|Paws::EC2> service. Use the attributes of this class
as arguments to method RejectVpcEndpointConnections.
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/ec2/RejectVpcEndpointConnections>
...
This class forms part of L<Paws>, documenting arguments for method RejectVpcEndpointConnections in L<Paws::EC2>
