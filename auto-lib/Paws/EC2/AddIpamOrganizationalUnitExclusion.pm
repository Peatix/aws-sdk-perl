package Paws::EC2::AddIpamOrganizationalUnitExclusion;
  use Moose;
...
Paws::EC2::AddIpamOrganizationalUnitExclusion
...
As an example, if Att1 is expected to be a Paws::EC2::AddIpamOrganizationalUnitExclusion object:

  $service_obj->Method(Att1 => { OrganizationsEntityPath => $value, ..., OrganizationsEntityPath => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EC2::AddIpamOrganizationalUnitExclusion object:
