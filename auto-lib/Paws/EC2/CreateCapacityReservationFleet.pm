...
package Paws::EC2::CreateCapacityReservationFleet;
  use Moose;
  ...
  has InstanceTypeSpecifications => (is => 'ro', isa => 'ArrayRef[Paws::EC2::ReservationFleetInstanceSpecification]', traits => ['NameInRequest'], request_name => 'InstanceTypeSpecification' , required => 1);
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'CreateCapacityReservationFleet');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::EC2::CreateCapacityReservationFleetResult');
...
Paws::EC2::CreateCapacityReservationFleet - Arguments for method CreateCapacityReservationFleet on L<Paws::EC2>

=head1 DESCRIPTION

This class represents the parameters used for calling the method CreateCapacityReservationFleet on the
L<Amazon Elastic Compute Cloud|Paws::EC2> service. Use the attributes of this class
as arguments to method CreateCapacityReservationFleet.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to CreateCapacityReservationFleet.

=head1 SYNOPSIS

    my $ec2 = Paws->service('EC2');
    my $CreateCapacityReservationFleetResult =
    ...
    # Results:
    my $AllocationStrategy =
      $CreateCapacityReservationFleetResult->AllocationStrategy;
    my $CapacityReservationFleetId =
      $CreateCapacityReservationFleetResult->CapacityReservationFleetId;
    my $CreateTime = $CreateCapacityReservationFleetResult->CreateTime;
    my $EndDate    = $CreateCapacityReservationFleetResult->EndDate;
    my $FleetCapacityReservations =
      $CreateCapacityReservationFleetResult->FleetCapacityReservations;
    my $InstanceMatchCriteria =
      $CreateCapacityReservationFleetResult->InstanceMatchCriteria;
    my $State   = $CreateCapacityReservationFleetResult->State;
    my $Tags    = $CreateCapacityReservationFleetResult->Tags;
    my $Tenancy = $CreateCapacityReservationFleetResult->Tenancy;
    my $TotalFulfilledCapacity =
      $CreateCapacityReservationFleetResult->TotalFulfilledCapacity;
    my $TotalTargetCapacity =
      $CreateCapacityReservationFleetResult->TotalTargetCapacity;

    # Returns a L<Paws::EC2::CreateCapacityReservationFleetResult> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/ec2/CreateCapacityReservationFleet>
...
=head2 B<REQUIRED> InstanceTypeSpecifications => ArrayRef[L<Paws::EC2::ReservationFleetInstanceSpecification>]
...
C<dedicated> - The Capacity Reservations are created on single-tenant
...
This class forms part of L<Paws>, documenting arguments for method CreateCapacityReservationFleet in L<Paws::EC2>
