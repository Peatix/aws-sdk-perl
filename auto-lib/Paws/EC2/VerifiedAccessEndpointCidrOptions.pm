package Paws::EC2::VerifiedAccessEndpointCidrOptions;
  use Moose;
...
Paws::EC2::VerifiedAccessEndpointCidrOptions
...
As an example, if Att1 is expected to be a Paws::EC2::VerifiedAccessEndpointCidrOptions object:

  $service_obj->Method(Att1 => { Cidr => $value, ..., SubnetIds => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EC2::VerifiedAccessEndpointCidrOptions object:
