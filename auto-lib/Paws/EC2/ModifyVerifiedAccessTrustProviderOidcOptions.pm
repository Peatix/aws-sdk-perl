package Paws::EC2::ModifyVerifiedAccessTrustProviderOidcOptions;
  use Moose;
...
Paws::EC2::ModifyVerifiedAccessTrustProviderOidcOptions
...
As an example, if Att1 is expected to be a Paws::EC2::ModifyVerifiedAccessTrustProviderOidcOptions object:

  $service_obj->Method(Att1 => { AuthorizationEndpoint => $value, ..., UserInfoEndpoint => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EC2::ModifyVerifiedAccessTrustProviderOidcOptions object:
