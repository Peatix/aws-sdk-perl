package Paws::EC2::VerifiedAccessEndpointEniOptions;
  use Moose;
...
Paws::EC2::VerifiedAccessEndpointEniOptions
...
As an example, if Att1 is expected to be a Paws::EC2::VerifiedAccessEndpointEniOptions object:

  $service_obj->Method(Att1 => { NetworkInterfaceId => $value, ..., Protocol => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EC2::VerifiedAccessEndpointEniOptions object:
