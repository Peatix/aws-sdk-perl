package Paws::EC2::InstanceRequirementsRequest;
  use Moose;
  has AcceleratorCount => (is => 'ro', isa => 'Paws::EC2::AcceleratorCountRequest');
  has AcceleratorManufacturers => (is => 'ro', isa => 'ArrayRef[Str|Undef]', request_name => 'AcceleratorManufacturer', traits => ['NameInRequest']);
  has AcceleratorNames => (is => 'ro', isa => 'ArrayRef[Str|Undef]', request_name => 'AcceleratorName', traits => ['NameInRequest']);
  has AcceleratorTotalMemoryMiB => (is => 'ro', isa => 'Paws::EC2::AcceleratorTotalMemoryMiBRequest');
  has AcceleratorTypes => (is => 'ro', isa => 'ArrayRef[Str|Undef]', request_name => 'AcceleratorType', traits => ['NameInRequest']);
  has AllowedInstanceTypes => (is => 'ro', isa => 'ArrayRef[Str|Undef]', request_name => 'AllowedInstanceType', traits => ['NameInRequest']);
  has BareMetal => (is => 'ro', isa => 'Str');
  has BaselineEbsBandwidthMbps => (is => 'ro', isa => 'Paws::EC2::BaselineEbsBandwidthMbpsRequest');
  has BaselinePerformanceFactors => (is => 'ro', isa => 'Paws::EC2::BaselinePerformanceFactorsRequest');
  has BurstablePerformance => (is => 'ro', isa => 'Str');
  has CpuManufacturers => (is => 'ro', isa => 'ArrayRef[Str|Undef]', request_name => 'CpuManufacturer', traits => ['NameInRequest']);
  has ExcludedInstanceTypes => (is => 'ro', isa => 'ArrayRef[Str|Undef]', request_name => 'ExcludedInstanceType', traits => ['NameInRequest']);
  has InstanceGenerations => (is => 'ro', isa => 'ArrayRef[Str|Undef]', request_name => 'InstanceGeneration', traits => ['NameInRequest']);
  has LocalStorage => (is => 'ro', isa => 'Str');
  has LocalStorageTypes => (is => 'ro', isa => 'ArrayRef[Str|Undef]', request_name => 'LocalStorageType', traits => ['NameInRequest']);
  has MaxSpotPriceAsPercentageOfOptimalOnDemandPrice => (is => 'ro', isa => 'Int');
  has MemoryGiBPerVCpu => (is => 'ro', isa => 'Paws::EC2::MemoryGiBPerVCpuRequest');
  has MemoryMiB => (is => 'ro', isa => 'Paws::EC2::MemoryMiBRequest', required => 1);
  has NetworkBandwidthGbps => (is => 'ro', isa => 'Paws::EC2::NetworkBandwidthGbpsRequest');
  has NetworkInterfaceCount => (is => 'ro', isa => 'Paws::EC2::NetworkInterfaceCountRequest');
  ...
  has TotalLocalStorageGB => (is => 'ro', isa => 'Paws::EC2::TotalLocalStorageGBRequest');
  has VCpuCount => (is => 'ro', isa => 'Paws::EC2::VCpuCountRangeRequest', required => 1);
1;
...
Paws::EC2::InstanceRequirementsRequest
...
As an example, if Att1 is expected to be a Paws::EC2::InstanceRequirementsRequest object:

  $service_obj->Method(Att1 => { AcceleratorCount => $value, ..., VCpuCount => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EC2::InstanceRequirementsRequest object:
...
=head2 AcceleratorCount => L<Paws::EC2::AcceleratorCountRequest>
...
=head2 AcceleratorTotalMemoryMiB => L<Paws::EC2::AcceleratorTotalMemoryMiBRequest>
...
=head2 BaselineEbsBandwidthMbps => L<Paws::EC2::BaselineEbsBandwidthMbpsRequest>
...
=head2 BaselinePerformanceFactors => L<Paws::EC2::BaselinePerformanceFactorsRequest>
...
You can use strings with one or more wild cards, represented by an
asterisk (C<*>), to exclude an instance family, type, size, or
generation. The following are examples: C<m5.8xlarge>, C<c5*.*>,
C<m5a.*>, C<r*>, C<*3*>.
...
=head2 MemoryGiBPerVCpu => L<Paws::EC2::MemoryGiBPerVCpuRequest>
...
=head2 B<REQUIRED> MemoryMiB => L<Paws::EC2::MemoryMiBRequest>

The minimum and maximum amount of memory, in MiB.


=head2 NetworkBandwidthGbps => L<Paws::EC2::NetworkBandwidthGbpsRequest>
...
=head2 NetworkInterfaceCount => L<Paws::EC2::NetworkInterfaceCountRequest>
...
To indicate no price protection threshold, specify a high value, such
as C<999999>.
...
=head2 TotalLocalStorageGB => L<Paws::EC2::TotalLocalStorageGBRequest>
...
=head2 B<REQUIRED> VCpuCount => L<Paws::EC2::VCpuCountRangeRequest>
