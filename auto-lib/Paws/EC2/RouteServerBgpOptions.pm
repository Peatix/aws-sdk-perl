package Paws::EC2::RouteServerBgpOptions;
  use Moose;
  has PeerAsn => (is => 'ro', isa => 'Int', request_name => 'peerAsn', traits => ['NameInRequest']);
  has PeerLivenessDetection => (is => 'ro', isa => 'Str', request_name => 'peerLivenessDetection', traits => ['NameInRequest']);
1;
...
Paws::EC2::RouteServerBgpOptions
...
As an example, if Att1 is expected to be a Paws::EC2::RouteServerBgpOptions object:

  $service_obj->Method(Att1 => { PeerAsn => $value, ..., PeerLivenessDetection => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EC2::RouteServerBgpOptions object:
