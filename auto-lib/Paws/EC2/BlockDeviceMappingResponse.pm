package Paws::EC2::BlockDeviceMappingResponse;
  use Moose;
  has DeviceName => (is => 'ro', isa => 'Str', request_name => 'deviceName', traits => ['NameInRequest']);
  has Ebs => (is => 'ro', isa => 'Paws::EC2::EbsBlockDeviceResponse', request_name => 'ebs', traits => ['NameInRequest']);
...
Paws::EC2::BlockDeviceMappingResponse
...
As an example, if Att1 is expected to be a Paws::EC2::BlockDeviceMappingResponse object:

  $service_obj->Method(Att1 => { DeviceName => $value, ..., VirtualName => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EC2::BlockDeviceMappingResponse object:
...
=head2 Ebs => L<Paws::EC2::EbsBlockDeviceResponse>
