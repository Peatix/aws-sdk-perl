package Paws::EC2::LaunchTemplateNetworkPerformanceOptionsRequest;
  use Moose;
...
Paws::EC2::LaunchTemplateNetworkPerformanceOptionsRequest
...
As an example, if Att1 is expected to be a Paws::EC2::LaunchTemplateNetworkPerformanceOptionsRequest object:

  $service_obj->Method(Att1 => { BandwidthWeighting => $value, ..., BandwidthWeighting => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EC2::LaunchTemplateNetworkPerformanceOptionsRequest object:
