...
C<auto-recovery-supported> - Indicates whether Amazon CloudWatch action
based recovery is supported (C<true> | C<false>).
...
C<burstable-performance-supported> - Indicates whether the instance
type is a burstable performance T instance type (C<true> | C<false>).
...
C<dedicated-hosts-supported> - Indicates whether the instance type
supports Dedicated Hosts. (C<true> | C<false>)
...
C<instance-storage-info.encryption-support> - Indicates whether data is
encrypted at rest (C<required> | C<supported> | C<unsupported>).
...
C<network-info.bandwidth-weightings> - For instances that support
bandwidth weighting to boost performance (C<default>, C<vpc-1>,
C<ebs-1>).
...
C<network-info.flexible-ena-queues-support> - Indicates whether an
instance supports flexible ENA queues (C<supported> | C<unsupported>).

=item *

C<network-info.encryption-in-transit-supported> - Indicates whether the
instance type automatically encrypts in-transit traffic between
instances (C<true> | C<false>).
...
C<network-info.maximum-network-cards> - The maximum number of network
cards per instance.
...
C<nitro-enclaves-support> - Indicates whether Nitro Enclaves is
supported (C<supported> | C<unsupported>).

=item *

C<nitro-tpm-support> - Indicates whether NitroTPM is supported
(C<supported> | C<unsupported>).

=item *

C<nitro-tpm-info.supported-versions> - The supported NitroTPM version
(C<2.0>).
...
C<processor-info.supported-features> - The supported CPU features
(C<amd-sev-snp>).
