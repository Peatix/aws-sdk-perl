package Paws::EC2::CreateVerifiedAccessEndpointLoadBalancerOptions;
  use Moose;
...
Paws::EC2::CreateVerifiedAccessEndpointLoadBalancerOptions
...
As an example, if Att1 is expected to be a Paws::EC2::CreateVerifiedAccessEndpointLoadBalancerOptions object:

  $service_obj->Method(Att1 => { LoadBalancerArn => $value, ..., SubnetIds => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EC2::CreateVerifiedAccessEndpointLoadBalancerOptions object:
