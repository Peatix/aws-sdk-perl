...
Paws::EC2::LaunchTemplateCpuOptions
...
As an example, if Att1 is expected to be a Paws::EC2::LaunchTemplateCpuOptions object:

  $service_obj->Method(Att1 => { AmdSevSnp => $value, ..., ThreadsPerCore => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EC2::LaunchTemplateCpuOptions object:
