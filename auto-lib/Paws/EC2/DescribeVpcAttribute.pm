...
package Paws::EC2::DescribeVpcAttribute;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::EC2::DescribeVpcAttributeResult');
...
Paws::EC2::DescribeVpcAttribute - Arguments for method DescribeVpcAttribute on L<Paws::EC2>
...
This class forms part of L<Paws>, documenting arguments for method DescribeVpcAttribute in L<Paws::EC2>
