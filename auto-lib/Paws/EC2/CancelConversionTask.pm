...
Paws::EC2::CancelConversionTask - Arguments for method CancelConversionTask on L<Paws::EC2>

=head1 DESCRIPTION

This class represents the parameters used for calling the method CancelConversionTask on the
...
=head1 SYNOPSIS
    ...
    $ec2->CancelConversionTask(
      ConversionTaskId => 'MyConversionTaskId',
      DryRun           => 1,                      # OPTIONAL
      ReasonMessage    => 'MyString',             # OPTIONAL
    );
...
This class forms part of L<Paws>, documenting arguments for method CancelConversionTask in L<Paws::EC2>
