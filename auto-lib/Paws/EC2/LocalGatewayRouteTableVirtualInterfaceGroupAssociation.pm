...
Paws::EC2::LocalGatewayRouteTableVirtualInterfaceGroupAssociation
...
Use accessors for each attribute. If Att1 is expected to be an Paws::EC2::LocalGatewayRouteTableVirtualInterfaceGroupAssociation object:
