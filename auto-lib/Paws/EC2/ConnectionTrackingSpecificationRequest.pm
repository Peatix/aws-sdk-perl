package Paws::EC2::ConnectionTrackingSpecificationRequest;
  use Moose;
  has TcpEstablishedTimeout => (is => 'ro', isa => 'Int');
  has UdpStreamTimeout => (is => 'ro', isa => 'Int');
  has UdpTimeout => (is => 'ro', isa => 'Int');
1;
...
Paws::EC2::ConnectionTrackingSpecificationRequest
...
As an example, if Att1 is expected to be a Paws::EC2::ConnectionTrackingSpecificationRequest object:

  $service_obj->Method(Att1 => { TcpEstablishedTimeout => $value, ..., UdpTimeout => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EC2::ConnectionTrackingSpecificationRequest object:
