...
package Paws::EC2::DescribeFpgaImageAttribute;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'DescribeFpgaImageAttribute');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::EC2::DescribeFpgaImageAttributeResult');
...
Paws::EC2::DescribeFpgaImageAttribute - Arguments for method DescribeFpgaImageAttribute on L<Paws::EC2>

=head1 DESCRIPTION

This class represents the parameters used for calling the method DescribeFpgaImageAttribute on the
L<Amazon Elastic Compute Cloud|Paws::EC2> service. Use the attributes of this class
as arguments to method DescribeFpgaImageAttribute.
...
This class forms part of L<Paws>, documenting arguments for method DescribeFpgaImageAttribute in L<Paws::EC2>
