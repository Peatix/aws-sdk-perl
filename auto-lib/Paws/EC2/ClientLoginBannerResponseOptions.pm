package Paws::EC2::ClientLoginBannerResponseOptions;
  use Moose;
  has BannerText => (is => 'ro', isa => 'Str', request_name => 'bannerText', traits => ['NameInRequest']);
...
Paws::EC2::ClientLoginBannerResponseOptions
...
As an example, if Att1 is expected to be a Paws::EC2::ClientLoginBannerResponseOptions object:

  $service_obj->Method(Att1 => { BannerText => $value, ..., Enabled => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EC2::ClientLoginBannerResponseOptions object:
