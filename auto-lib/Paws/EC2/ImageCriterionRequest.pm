package Paws::EC2::ImageCriterionRequest;
  use Moose;
  has ImageProviders => (is => 'ro', isa => 'ArrayRef[Str|Undef]', request_name => 'ImageProvider', traits => ['NameInRequest']);
1;
...
Paws::EC2::ImageCriterionRequest
...
As an example, if Att1 is expected to be a Paws::EC2::ImageCriterionRequest object:

  $service_obj->Method(Att1 => { ImageProviders => $value, ..., ImageProviders => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EC2::ImageCriterionRequest object:
...
C<none>: Allow AMIs created by your own account only. When C<none> is
