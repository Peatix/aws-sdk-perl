...
Paws::EC2::AttachVpnGateway - Arguments for method AttachVpnGateway on L<Paws::EC2>
...
You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to AttachVpnGateway.
...
=head1 SYNOPSIS
    ...
    # Results:
    my $VpcAttachment = $AttachVpnGatewayResult->VpcAttachment;

    # Returns a L<Paws::EC2::AttachVpnGatewayResult> object.
