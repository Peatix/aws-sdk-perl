package Paws::EC2::ConnectionTrackingConfiguration;
  use Moose;
...
Paws::EC2::ConnectionTrackingConfiguration
...
As an example, if Att1 is expected to be a Paws::EC2::ConnectionTrackingConfiguration object:

  $service_obj->Method(Att1 => { TcpEstablishedTimeout => $value, ..., UdpTimeout => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EC2::ConnectionTrackingConfiguration object:
