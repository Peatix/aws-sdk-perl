...
Paws::EC2::TransitGatewayMulticastDomainAssociation
...
As an example, if Att1 is expected to be a Paws::EC2::TransitGatewayMulticastDomainAssociation object:

  $service_obj->Method(Att1 => { ResourceId => $value, ..., TransitGatewayAttachmentId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EC2::TransitGatewayMulticastDomainAssociation object:
...
=head2 Subnet => L<Paws::EC2::SubnetAssociation>
