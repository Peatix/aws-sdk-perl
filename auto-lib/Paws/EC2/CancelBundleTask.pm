...
package Paws::EC2::CancelBundleTask;
  use Moose;
...
Paws::EC2::CancelBundleTask - Arguments for method CancelBundleTask on L<Paws::EC2>
...
This class forms part of L<Paws>, documenting arguments for method CancelBundleTask in L<Paws::EC2>
