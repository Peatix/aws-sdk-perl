package Paws::EC2::FleetLaunchTemplateOverrides;
  ...
  has BlockDeviceMappings => (is => 'ro', isa => 'ArrayRef[Paws::EC2::BlockDeviceMappingResponse]', request_name => 'blockDeviceMappingSet', traits => ['NameInRequest']);
...
=head2 BlockDeviceMappings => ArrayRef[L<Paws::EC2::BlockDeviceMappingResponse>]
