...
package Paws::EC2::CreatePublicIpv4Pool;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'CreatePublicIpv4Pool');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::EC2::CreatePublicIpv4PoolResult');
...
Paws::EC2::CreatePublicIpv4Pool - Arguments for method CreatePublicIpv4Pool on L<Paws::EC2>

=head1 DESCRIPTION

This class represents the parameters used for calling the method CreatePublicIpv4Pool on the
L<Amazon Elastic Compute Cloud|Paws::EC2> service. Use the attributes of this class
as arguments to method CreatePublicIpv4Pool.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to CreatePublicIpv4Pool.

=head1 SYNOPSIS

    my $ec2 = Paws->service('EC2');
    my $CreatePublicIpv4PoolResult = $ec2->CreatePublicIpv4Pool(
      DryRun             => 1,             # OPTIONAL
    ...
    # Results:
    my $PoolId = $CreatePublicIpv4PoolResult->PoolId;

    # Returns a L<Paws::EC2::CreatePublicIpv4PoolResult> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/ec2/CreatePublicIpv4Pool>
...
This class forms part of L<Paws>, documenting arguments for method CreatePublicIpv4Pool in L<Paws::EC2>
