...
package Paws::EC2::DeregisterImage;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::EC2::DeregisterImageResult');
...
Paws::EC2::DeregisterImage - Arguments for method DeregisterImage on L<Paws::EC2>
...
=head1 SYNOPSIS
    ...
    my $DeregisterImageResult = $ec2->DeregisterImage(
      ImageId => 'MyImageId',
      DryRun  => 1,             # OPTIONAL
    );
...
This class forms part of L<Paws>, documenting arguments for method DeregisterImage in L<Paws::EC2>
