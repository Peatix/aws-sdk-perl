package Paws::EC2::LaunchTemplateEnaSrdUdpSpecification;
  use Moose;
...
Paws::EC2::LaunchTemplateEnaSrdUdpSpecification
...
As an example, if Att1 is expected to be a Paws::EC2::LaunchTemplateEnaSrdUdpSpecification object:

  $service_obj->Method(Att1 => { EnaSrdUdpEnabled => $value, ..., EnaSrdUdpEnabled => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EC2::LaunchTemplateEnaSrdUdpSpecification object:
