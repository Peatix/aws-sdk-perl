...
package Paws::EC2::DescribeTrafficMirrorSessions;
  ...
  has TrafficMirrorSessionIds => (is => 'ro', isa => 'ArrayRef[Str|Undef]', traits => ['NameInRequest'], request_name => 'TrafficMirrorSessionId' );
...
=head1 SYNOPSIS
    ...
    my $DescribeTrafficMirrorSessionsResult =
      ...
      TrafficMirrorSessionIds => [ 'MyTrafficMirrorSessionId', ... ], # OPTIONAL
      );
