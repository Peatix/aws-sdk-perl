...
package Paws::EC2::CreateVerifiedAccessGroup;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'CreateVerifiedAccessGroup');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::EC2::CreateVerifiedAccessGroupResult');
...
Paws::EC2::CreateVerifiedAccessGroup - Arguments for method CreateVerifiedAccessGroup on L<Paws::EC2>

=head1 DESCRIPTION

This class represents the parameters used for calling the method CreateVerifiedAccessGroup on the
L<Amazon Elastic Compute Cloud|Paws::EC2> service. Use the attributes of this class
as arguments to method CreateVerifiedAccessGroup.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to CreateVerifiedAccessGroup.

=head1 SYNOPSIS

    my $ec2 = Paws->service('EC2');
    my $CreateVerifiedAccessGroupResult = $ec2->CreateVerifiedAccessGroup(
    ...
    # Returns a L<Paws::EC2::CreateVerifiedAccessGroupResult> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/ec2/CreateVerifiedAccessGroup>
...
This class forms part of L<Paws>, documenting arguments for method CreateVerifiedAccessGroup in L<Paws::EC2>
