package Paws::EC2::LaunchTemplateInstanceMaintenanceOptionsRequest;
  use Moose;
...
Paws::EC2::LaunchTemplateInstanceMaintenanceOptionsRequest
...
As an example, if Att1 is expected to be a Paws::EC2::LaunchTemplateInstanceMaintenanceOptionsRequest object:

  $service_obj->Method(Att1 => { AutoRecovery => $value, ..., AutoRecovery => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EC2::LaunchTemplateInstanceMaintenanceOptionsRequest object:
