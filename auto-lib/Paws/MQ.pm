package Paws::MQ;
  ...
  sub DeleteConfiguration {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::MQ::DeleteConfiguration', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DeleteTags {
    my $self = shift;
  ...
  sub Promote {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::MQ::Promote', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub RebootBroker {
    my $self = shift;
  ...
  sub operations { qw/CreateBroker CreateConfiguration CreateTags CreateUser DeleteBroker DeleteConfiguration DeleteTags DeleteUser DescribeBroker DescribeBrokerEngineTypes DescribeBrokerInstanceOptions DescribeConfiguration DescribeConfigurationRevision DescribeUser ListBrokers ListConfigurationRevisions ListConfigurations ListTags ListUsers Promote RebootBroker UpdateBroker UpdateConfiguration UpdateUser / }
...
=item [DataReplicationMode => Str]

=item [DataReplicationPrimaryBrokerArn => Str]
...
in the I<Amazon MQ Developer Guide>.
...
Each argument is described in detail in: L<Paws::MQ::DeleteConfiguration>

Returns: a L<Paws::MQ::DeleteConfigurationResponse> instance
...
Each argument is described in detail in: L<Paws::MQ::Promote>

Returns: a L<Paws::MQ::PromoteResponse> instance
