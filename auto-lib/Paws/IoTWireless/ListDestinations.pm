...
package Paws::IoTWireless::ListDestinations;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::IoTWireless::ListDestinationsResponse');
1;
...
Paws::IoTWireless::ListDestinations - Arguments for method ListDestinations on L<Paws::IoTWireless>
...
This class forms part of L<Paws>, documenting arguments for method ListDestinations in L<Paws::IoTWireless>
