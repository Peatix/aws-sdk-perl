...
package Paws::IoTWireless::FuotaTaskEventLogOption;
  use Moose;
...
Paws::IoTWireless::FuotaTaskEventLogOption
...
As an example, if Att1 is expected to be a Paws::IoTWireless::FuotaTaskEventLogOption object:

  $service_obj->Method(Att1 => { Event => $value, ..., LogLevel => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IoTWireless::FuotaTaskEventLogOption object:
