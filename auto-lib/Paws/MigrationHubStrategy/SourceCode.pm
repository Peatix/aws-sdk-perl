...
package Paws::MigrationHubStrategy::SourceCode;
  use Moose;
  ...
  has VersionControl => (is => 'ro', isa => 'Str', request_name => 'versionControl', traits => ['NameInRequest']);
...
Paws::MigrationHubStrategy::SourceCode
...
As an example, if Att1 is expected to be a Paws::MigrationHubStrategy::SourceCode object:

  $service_obj->Method(Att1 => { Location => $value, ..., VersionControl => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MigrationHubStrategy::SourceCode object:
