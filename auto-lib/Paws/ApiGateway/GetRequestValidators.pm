...
=head1 SYNOPSIS
    ...
    my $RequestValidators = $apigateway->GetRequestValidators(
      RestApiId => 'MyString',
      Limit     => 1,             # OPTIONAL
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/apigateway/GetRequestValidators>
