...
Paws::ApiGateway::DeleteMethod - Arguments for method DeleteMethod on L<Paws::ApiGateway>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/apigateway/DeleteMethod>
