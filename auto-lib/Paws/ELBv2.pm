package Paws::ELBv2;
  ...
  sub AddTrustStoreRevocations {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ELBv2::AddTrustStoreRevocations', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub CreateListener {
    my $self = shift;
  ...
  sub CreateTrustStore {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ELBv2::CreateTrustStore', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DeleteListener {
    my $self = shift;
  ...
  sub DeleteSharedTrustStoreAssociation {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ELBv2::DeleteSharedTrustStoreAssociation', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DeleteTrustStore {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ELBv2::DeleteTrustStore', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeCapacityReservation {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ELBv2::DescribeCapacityReservation', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DescribeListenerAttributes {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ELBv2::DescribeListenerAttributes', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeTrustStoreAssociations {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ELBv2::DescribeTrustStoreAssociations', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DescribeTrustStoreRevocations {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ELBv2::DescribeTrustStoreRevocations', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DescribeTrustStores {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ELBv2::DescribeTrustStores', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetResourcePolicy {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ELBv2::GetResourcePolicy', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetTrustStoreCaCertificatesBundle {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ELBv2::GetTrustStoreCaCertificatesBundle', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetTrustStoreRevocationContent {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ELBv2::GetTrustStoreRevocationContent', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ModifyCapacityReservation {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ELBv2::ModifyCapacityReservation', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ModifyIpPools {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ELBv2::ModifyIpPools', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ModifyListener {
    my $self = shift;
  ...
  sub ModifyListenerAttributes {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ELBv2::ModifyListenerAttributes', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ModifyTrustStore {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ELBv2::ModifyTrustStore', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub RegisterTargets {
    my $self = shift;
  ...
  sub RemoveTrustStoreRevocations {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ELBv2::RemoveTrustStoreRevocations', @_);
    return $self->caller->do_call($self, $call_object);
  }
...
=head2 AddTrustStoreRevocations

=over

=item TrustStoreArn => Str

=item [RevocationContents => ArrayRef[L<Paws::ELBv2::RevocationContent>]]


=back

Each argument is described in detail in: L<Paws::ELBv2::AddTrustStoreRevocations>

Returns: a L<Paws::ELBv2::AddTrustStoreRevocationsOutput> instance
...
=item [MutualAuthentication => L<Paws::ELBv2::MutualAuthenticationAttributes>]
...
=item [EnablePrefixForIpv6SourceNat => Str]

=item [IpAddressType => Str]

=item [IpamPools => L<Paws::ELBv2::IpamPools>]
...
=item CaCertificatesBundleS3Bucket => Str

=item CaCertificatesBundleS3Key => Str

=item Name => Str

=item [CaCertificatesBundleS3ObjectVersion => Str]
...
Each argument is described in detail in: L<Paws::ELBv2::CreateTrustStore>

Returns: a L<Paws::ELBv2::CreateTrustStoreOutput> instance
...
=head2 DeleteSharedTrustStoreAssociation
...
Each argument is described in detail in: L<Paws::ELBv2::DeleteSharedTrustStoreAssociation>

Returns: a L<Paws::ELBv2::DeleteSharedTrustStoreAssociationOutput> instance
...
Each argument is described in detail in: L<Paws::ELBv2::DeleteTrustStore>

Returns: a L<Paws::ELBv2::DeleteTrustStoreOutput> instance
...
=head2 DescribeCapacityReservation
...
Each argument is described in detail in: L<Paws::ELBv2::DescribeCapacityReservation>

Returns: a L<Paws::ELBv2::DescribeCapacityReservationOutput> instance

Describes the capacity reservation status for the specified load
balancer.


=head2 DescribeListenerAttributes
...
Each argument is described in detail in: L<Paws::ELBv2::DescribeListenerAttributes>

Returns: a L<Paws::ELBv2::DescribeListenerAttributesOutput> instance
...
=head2 DescribeTrustStoreAssociations
...
Each argument is described in detail in: L<Paws::ELBv2::DescribeTrustStoreAssociations>

Returns: a L<Paws::ELBv2::DescribeTrustStoreAssociationsOutput> instance

Describes all resources associated with the specified trust store.


=head2 DescribeTrustStoreRevocations
...
=item [RevocationIds => ArrayRef[Int]]


=back

Each argument is described in detail in: L<Paws::ELBv2::DescribeTrustStoreRevocations>

Returns: a L<Paws::ELBv2::DescribeTrustStoreRevocationsOutput> instance

Describes the revocation files in use by the specified trust store or
revocation files.


=head2 DescribeTrustStores
...
=item [TrustStoreArns => ArrayRef[Str|Undef]]


=back

Each argument is described in detail in: L<Paws::ELBv2::DescribeTrustStores>

Returns: a L<Paws::ELBv2::DescribeTrustStoresOutput> instance
...
Each argument is described in detail in: L<Paws::ELBv2::GetResourcePolicy>

Returns: a L<Paws::ELBv2::GetResourcePolicyOutput> instance

Retrieves the resource policy for a specified resource.


=head2 GetTrustStoreCaCertificatesBundle
...
Each argument is described in detail in: L<Paws::ELBv2::GetTrustStoreCaCertificatesBundle>

Returns: a L<Paws::ELBv2::GetTrustStoreCaCertificatesBundleOutput> instance
...
=head2 GetTrustStoreRevocationContent

=over

=item RevocationId => Int
...
Each argument is described in detail in: L<Paws::ELBv2::GetTrustStoreRevocationContent>

Returns: a L<Paws::ELBv2::GetTrustStoreRevocationContentOutput> instance
...
=item [MinimumLoadBalancerCapacity => L<Paws::ELBv2::MinimumLoadBalancerCapacity>]

=item [ResetCapacityReservation => Bool]


=back

Each argument is described in detail in: L<Paws::ELBv2::ModifyCapacityReservation>

Returns: a L<Paws::ELBv2::ModifyCapacityReservationOutput> instance

Modifies the capacity reservation of the specified load balancer.

When modifying capacity reservation, you must include at least one
C<MinimumLoadBalancerCapacity> or C<ResetCapacityReservation>.
...
=item [RemoveIpamPools => ArrayRef[Str|Undef]]


=back

Each argument is described in detail in: L<Paws::ELBv2::ModifyIpPools>

Returns: a L<Paws::ELBv2::ModifyIpPoolsOutput> instance
...
=head2 ModifyListenerAttributes

=over

=item Attributes => ArrayRef[L<Paws::ELBv2::ListenerAttribute>]
...
Each argument is described in detail in: L<Paws::ELBv2::ModifyListenerAttributes>

Returns: a L<Paws::ELBv2::ModifyListenerAttributesOutput> instance
...
Each argument is described in detail in: L<Paws::ELBv2::ModifyTrustStore>

Returns: a L<Paws::ELBv2::ModifyTrustStoreOutput> instance
...
=head2 RemoveTrustStoreRevocations
...
Each argument is described in detail in: L<Paws::ELBv2::RemoveTrustStoreRevocations>

Returns: a L<Paws::ELBv2::RemoveTrustStoreRevocationsOutput> instance
...
=item [EnforceSecurityGroupInboundRulesOnPrivateLinkTraffic => Str]
...
=head2 DescribeAllSSLPolicies(sub { },[LoadBalancerType => Str, Marker => Str, Names => ArrayRef[Str|Undef], PageSize => Int])

=head2 DescribeAllSSLPolicies([LoadBalancerType => Str, Marker => Str, Names => ArrayRef[Str|Undef], PageSize => Int])
