...
package Paws::OpsWorks::DetachElasticLoadBalancer;
  use Moose;
...
Paws::OpsWorks::DetachElasticLoadBalancer - Arguments for method DetachElasticLoadBalancer on L<Paws::OpsWorks>
