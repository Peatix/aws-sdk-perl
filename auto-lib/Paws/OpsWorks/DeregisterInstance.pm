...
package Paws::OpsWorks::DeregisterInstance;
  use Moose;
...
Paws::OpsWorks::DeregisterInstance - Arguments for method DeregisterInstance on L<Paws::OpsWorks>
...
This class forms part of L<Paws>, documenting arguments for method DeregisterInstance in L<Paws::OpsWorks>
