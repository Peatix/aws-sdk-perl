...
package Paws::FSX::DeleteFileSystemOpenZFSResponse;
  use Moose;
...
Paws::FSX::DeleteFileSystemOpenZFSResponse
...
As an example, if Att1 is expected to be a Paws::FSX::DeleteFileSystemOpenZFSResponse object:

  $service_obj->Method(Att1 => { FinalBackupId => $value, ..., FinalBackupTags => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::FSX::DeleteFileSystemOpenZFSResponse object:
