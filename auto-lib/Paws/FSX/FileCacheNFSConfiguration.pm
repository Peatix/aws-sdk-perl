...
package Paws::FSX::FileCacheNFSConfiguration;
  use Moose;
...
Paws::FSX::FileCacheNFSConfiguration
...
As an example, if Att1 is expected to be a Paws::FSX::FileCacheNFSConfiguration object:

  $service_obj->Method(Att1 => { DnsIps => $value, ..., Version => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::FSX::FileCacheNFSConfiguration object:
...
repository. The only supported value is C<NFS3>, which indicates that
