...
package Paws::VerifiedPermissions::CreatePolicyOutput;
  use Moose;
...
Paws::VerifiedPermissions::CreatePolicyOutput
...
element isn't present when C<principal> isn't specified in the policy
content.
...
isn't present when the C<resource> isn't specified in the policy
content.
