...
package Paws::VerifiedPermissions::IdentitySourceItemDetails;
  use Moose;
...
Paws::VerifiedPermissions::IdentitySourceItemDetails
...
As an example, if Att1 is expected to be a Paws::VerifiedPermissions::IdentitySourceItemDetails object:

  $service_obj->Method(Att1 => { ClientIds => $value, ..., UserPoolArn => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::VerifiedPermissions::IdentitySourceItemDetails object:
