...
package Paws::VerifiedPermissions::BatchIsAuthorizedWithTokenOutputItem;
  use Moose;
  ...
  has Request => (is => 'ro', isa => 'Paws::VerifiedPermissions::BatchIsAuthorizedWithTokenInputItem', request_name => 'request', traits => ['NameInRequest'], required => 1);
...
Paws::VerifiedPermissions::BatchIsAuthorizedWithTokenOutputItem
...
As an example, if Att1 is expected to be a Paws::VerifiedPermissions::BatchIsAuthorizedWithTokenOutputItem object:

  $service_obj->Method(Att1 => { Decision => $value, ..., Request => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::VerifiedPermissions::BatchIsAuthorizedWithTokenOutputItem object:
...
authorization request in a C<BatchIsAuthorizedWithToken> API request.
...
=head2 B<REQUIRED> Request => L<Paws::VerifiedPermissions::BatchIsAuthorizedWithTokenInputItem>
