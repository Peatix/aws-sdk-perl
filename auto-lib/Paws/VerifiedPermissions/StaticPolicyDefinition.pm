...
package Paws::VerifiedPermissions::StaticPolicyDefinition;
  use Moose;
...
Paws::VerifiedPermissions::StaticPolicyDefinition
...
As an example, if Att1 is expected to be a Paws::VerifiedPermissions::StaticPolicyDefinition object:

  $service_obj->Method(Att1 => { Description => $value, ..., Statement => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::VerifiedPermissions::StaticPolicyDefinition object:
