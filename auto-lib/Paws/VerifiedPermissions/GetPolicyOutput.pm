...
package Paws::VerifiedPermissions::GetPolicyOutput;
  use Moose;
  ...
  has Definition => (is => 'ro', isa => 'Paws::VerifiedPermissions::PolicyDefinitionDetail', traits => ['NameInRequest'], request_name => 'definition' , required => 1);
...
Paws::VerifiedPermissions::GetPolicyOutput
