...
package Paws::VerifiedPermissions::CognitoUserPoolConfigurationDetail;
  use Moose;
  has ClientIds => (is => 'ro', isa => 'ArrayRef[Str|Undef]', request_name => 'clientIds', traits => ['NameInRequest'], required => 1);
  has GroupConfiguration => (is => 'ro', isa => 'Paws::VerifiedPermissions::CognitoGroupConfigurationDetail', request_name => 'groupConfiguration', traits => ['NameInRequest']);
...
Paws::VerifiedPermissions::CognitoUserPoolConfigurationDetail
...
As an example, if Att1 is expected to be a Paws::VerifiedPermissions::CognitoUserPoolConfigurationDetail object:

  $service_obj->Method(Att1 => { ClientIds => $value, ..., UserPoolArn => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::VerifiedPermissions::CognitoUserPoolConfigurationDetail object:
...
=head2 GroupConfiguration => L<Paws::VerifiedPermissions::CognitoGroupConfigurationDetail>
