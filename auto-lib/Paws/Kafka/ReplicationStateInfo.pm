...
package Paws::Kafka::ReplicationStateInfo;
  use Moose;
...
Paws::Kafka::ReplicationStateInfo
...
As an example, if Att1 is expected to be a Paws::Kafka::ReplicationStateInfo object:

  $service_obj->Method(Att1 => { Code => $value, ..., Message => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Kafka::ReplicationStateInfo object:
