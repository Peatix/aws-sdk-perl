...
package Paws::Kafka::VpcConnectivityIam;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::Kafka::VpcConnectivityIam object:

  $service_obj->Method(Att1 => { Enabled => $value, ..., Enabled => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Kafka::VpcConnectivityIam object:
