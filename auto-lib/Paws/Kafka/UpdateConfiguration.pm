...
package Paws::Kafka::UpdateConfiguration;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Kafka::UpdateConfigurationResponse');
1;
...
Paws::Kafka::UpdateConfiguration - Arguments for method UpdateConfiguration on L<Paws::Kafka>
...
This class forms part of L<Paws>, documenting arguments for method UpdateConfiguration in L<Paws::Kafka>
