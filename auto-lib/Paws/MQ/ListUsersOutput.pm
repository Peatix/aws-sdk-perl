...
package Paws::MQ::ListUsersOutput;
  ...
  has Users => (is => 'ro', isa => 'ArrayRef[Paws::MQ::UserSummary]', request_name => 'users', traits => ['NameInRequest'], required => 1);
...
=head2 B<REQUIRED> Users => ArrayRef[L<Paws::MQ::UserSummary>]
