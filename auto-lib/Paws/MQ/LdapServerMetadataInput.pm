...
package Paws::MQ::LdapServerMetadataInput;
  use Moose;
  ...
  has ServiceAccountPassword => (is => 'ro', isa => 'Str', request_name => 'serviceAccountPassword', traits => ['NameInRequest'], required => 1);
...
Paws::MQ::LdapServerMetadataInput
...
As an example, if Att1 is expected to be a Paws::MQ::LdapServerMetadataInput object:

  $service_obj->Method(Att1 => { Hosts => $value, ..., UserSearchSubtree => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MQ::LdapServerMetadataInput object:
...
=head2 B<REQUIRED> ServiceAccountPassword => Str
