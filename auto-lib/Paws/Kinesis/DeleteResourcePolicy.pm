...
package Paws::Kinesis::DeleteResourcePolicy;
  use Moose;
...
Paws::Kinesis::DeleteResourcePolicy - Arguments for method DeleteResourcePolicy on L<Paws::Kinesis>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/kinesis/DeleteResourcePolicy>
...
This class forms part of L<Paws>, documenting arguments for method DeleteResourcePolicy in L<Paws::Kinesis>
