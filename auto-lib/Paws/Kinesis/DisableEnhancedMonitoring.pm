...
Paws::Kinesis::DisableEnhancedMonitoring - Arguments for method DisableEnhancedMonitoring on L<Paws::Kinesis>
...
=head1 SYNOPSIS
    ...
    my $EnhancedMonitoringOutput = $kinesis->DisableEnhancedMonitoring(
      ShardLevelMetrics => [
        'IncomingBytes',
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/kinesis/DisableEnhancedMonitoring>
