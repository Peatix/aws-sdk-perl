...
As an example, if Att1 is expected to be a Paws::CodePipeline::OutputArtifact object:
  ...
  $service_obj->Method(Att1 => { Files => $value, ..., Name => $value  });
...
The files that you want to associate with the output artifact that will
be exported from the compute action.
