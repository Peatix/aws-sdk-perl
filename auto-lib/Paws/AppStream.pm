package Paws::AppStream;
  ...
  sub AssociateAppBlockBuilderAppBlock {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::AssociateAppBlockBuilderAppBlock', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub AssociateApplicationFleet {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::AssociateApplicationFleet', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub AssociateApplicationToEntitlement {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::AssociateApplicationToEntitlement', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub AssociateFleet {
    my $self = shift;
  ...
  sub CreateAppBlock {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::CreateAppBlock', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub CreateAppBlockBuilder {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::CreateAppBlockBuilder', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub CreateAppBlockBuilderStreamingURL {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::CreateAppBlockBuilderStreamingURL', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub CreateApplication {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::CreateApplication', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub CreateEntitlement {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::CreateEntitlement', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub CreateFleet {
    my $self = shift;
  ...
  sub CreateThemeForStack {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::CreateThemeForStack', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DeleteAppBlock {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::DeleteAppBlock', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DeleteAppBlockBuilder {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::DeleteAppBlockBuilder', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DeleteApplication {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::DeleteApplication', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DeleteEntitlement {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::DeleteEntitlement', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DeleteFleet {
    my $self = shift;
  ...
  sub DeleteThemeForStack {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::DeleteThemeForStack', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeAppBlockBuilderAppBlockAssociations {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::DescribeAppBlockBuilderAppBlockAssociations', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DescribeAppBlockBuilders {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::DescribeAppBlockBuilders', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DescribeAppBlocks {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::DescribeAppBlocks', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DescribeApplicationFleetAssociations {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::DescribeApplicationFleetAssociations', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DescribeApplications {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::DescribeApplications', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeEntitlements {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::DescribeEntitlements', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DescribeFleets {
    my $self = shift;
  ...
  sub DescribeThemeForStack {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::DescribeThemeForStack', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DisassociateAppBlockBuilderAppBlock {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::DisassociateAppBlockBuilderAppBlock', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DisassociateApplicationFleet {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::DisassociateApplicationFleet', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DisassociateApplicationFromEntitlement {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::DisassociateApplicationFromEntitlement', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ListEntitledApplications {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::ListEntitledApplications', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub StartAppBlockBuilder {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::StartAppBlockBuilder', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub StartFleet {
    my $self = shift;
  ...
  sub StopAppBlockBuilder {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::StopAppBlockBuilder', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub StopFleet {
    my $self = shift;
  ...
  sub UpdateAppBlockBuilder {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::UpdateAppBlockBuilder', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub UpdateApplication {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::UpdateApplication', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub UpdateEntitlement {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::UpdateEntitlement', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub UpdateFleet {
    my $self = shift;
  ...
  sub UpdateThemeForStack {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AppStream::UpdateThemeForStack', @_);
    return $self->caller->do_call($self, $call_object);
  }
...
=head2 AssociateAppBlockBuilderAppBlock

=over

=item AppBlockArn => Str

=item AppBlockBuilderName => Str


=back

Each argument is described in detail in: L<Paws::AppStream::AssociateAppBlockBuilderAppBlock>

Returns: a L<Paws::AppStream::AssociateAppBlockBuilderAppBlockResult> instance

Associates the specified app block builder with the specified app
block.


=head2 AssociateApplicationFleet
...
Each argument is described in detail in: L<Paws::AppStream::AssociateApplicationFleet>

Returns: a L<Paws::AppStream::AssociateApplicationFleetResult> instance

Associates the specified application with the specified fleet. This is
only supported for Elastic fleets.


=head2 AssociateApplicationToEntitlement

=over

=item ApplicationIdentifier => Str

=item EntitlementName => Str
...
Each argument is described in detail in: L<Paws::AppStream::AssociateApplicationToEntitlement>

Returns: a L<Paws::AppStream::AssociateApplicationToEntitlementResult> instance
...
=head2 CreateAppBlock

=over

=item Name => Str

=item SourceS3Location => L<Paws::AppStream::S3Location>

=item [Description => Str]

=item [DisplayName => Str]

=item [PackagingType => Str]

=item [PostSetupScriptDetails => L<Paws::AppStream::ScriptDetails>]

=item [SetupScriptDetails => L<Paws::AppStream::ScriptDetails>]
...
Each argument is described in detail in: L<Paws::AppStream::CreateAppBlock>

Returns: a L<Paws::AppStream::CreateAppBlockResult> instance
...
Each argument is described in detail in: L<Paws::AppStream::CreateAppBlockBuilder>

Returns: a L<Paws::AppStream::CreateAppBlockBuilderResult> instance

Creates an app block builder.


=head2 CreateAppBlockBuilderStreamingURL
...
Each argument is described in detail in: L<Paws::AppStream::CreateAppBlockBuilderStreamingURL>

Returns: a L<Paws::AppStream::CreateAppBlockBuilderStreamingURLResult> instance
...
=item IconS3Location => L<Paws::AppStream::S3Location>

=item InstanceFamilies => ArrayRef[Str|Undef]
...
Each argument is described in detail in: L<Paws::AppStream::CreateApplication>

Returns: a L<Paws::AppStream::CreateApplicationResult> instance
...
=item [CertificateBasedAuthProperties => L<Paws::AppStream::CertificateBasedAuthProperties>]
...
=head2 CreateEntitlement

=over

=item AppVisibility => Str

=item Attributes => ArrayRef[L<Paws::AppStream::EntitlementAttribute>]
...
Each argument is described in detail in: L<Paws::AppStream::CreateEntitlement>

Returns: a L<Paws::AppStream::CreateEntitlementResult> instance
...
=item [MaxSessionsPerInstance => Int]

=item [MaxUserDurationInSeconds => Int]

=item [Platform => Str]

=item [SessionScriptS3Location => L<Paws::AppStream::S3Location>]

=item [StreamView => Str]

=item [Tags => L<Paws::AppStream::Tags>]

=item [UsbDeviceFilterStrings => ArrayRef[Str|Undef]]
...
=item [StreamingExperienceSettings => L<Paws::AppStream::StreamingExperienceSettings>]
...
=head2 CreateThemeForStack

=over

=item FaviconS3Location => L<Paws::AppStream::S3Location>

=item OrganizationLogoS3Location => L<Paws::AppStream::S3Location>

=item StackName => Str

=item ThemeStyling => Str

=item TitleText => Str

=item [FooterLinks => ArrayRef[L<Paws::AppStream::ThemeFooterLink>]]


=back

Each argument is described in detail in: L<Paws::AppStream::CreateThemeForStack>

Returns: a L<Paws::AppStream::CreateThemeForStackResult> instance
...
Each argument is described in detail in: L<Paws::AppStream::DeleteAppBlock>

Returns: a L<Paws::AppStream::DeleteAppBlockResult> instance

Deletes an app block.


=head2 DeleteAppBlockBuilder
...
Each argument is described in detail in: L<Paws::AppStream::DeleteAppBlockBuilder>

Returns: a L<Paws::AppStream::DeleteAppBlockBuilderResult> instance
...
Each argument is described in detail in: L<Paws::AppStream::DeleteApplication>

Returns: a L<Paws::AppStream::DeleteApplicationResult> instance
...
Each argument is described in detail in: L<Paws::AppStream::DeleteEntitlement>

Returns: a L<Paws::AppStream::DeleteEntitlementResult> instance
...
Each argument is described in detail in: L<Paws::AppStream::DeleteThemeForStack>

Returns: a L<Paws::AppStream::DeleteThemeForStackResult> instance
...
=head2 DescribeAppBlockBuilderAppBlockAssociations
...
Each argument is described in detail in: L<Paws::AppStream::DescribeAppBlockBuilderAppBlockAssociations>

Returns: a L<Paws::AppStream::DescribeAppBlockBuilderAppBlockAssociationsResult> instance

Retrieves a list that describes one or more app block builder
associations.


=head2 DescribeAppBlockBuilders
...
Each argument is described in detail in: L<Paws::AppStream::DescribeAppBlockBuilders>

Returns: a L<Paws::AppStream::DescribeAppBlockBuildersResult> instance

Retrieves a list that describes one or more app block builders.


=head2 DescribeAppBlocks
...
Each argument is described in detail in: L<Paws::AppStream::DescribeAppBlocks>

Returns: a L<Paws::AppStream::DescribeAppBlocksResult> instance

Retrieves a list that describes one or more app blocks.


=head2 DescribeApplicationFleetAssociations
...
Each argument is described in detail in: L<Paws::AppStream::DescribeApplicationFleetAssociations>

Returns: a L<Paws::AppStream::DescribeApplicationFleetAssociationsResult> instance
...
Each argument is described in detail in: L<Paws::AppStream::DescribeApplications>

Returns: a L<Paws::AppStream::DescribeApplicationsResult> instance
...
Each argument is described in detail in: L<Paws::AppStream::DescribeEntitlements>

Returns: a L<Paws::AppStream::DescribeEntitlementsResult> instance
...
Each argument is described in detail in: L<Paws::AppStream::DescribeThemeForStack>

Returns: a L<Paws::AppStream::DescribeThemeForStackResult> instance
...
=head2 DisassociateAppBlockBuilderAppBlock
...
Each argument is described in detail in: L<Paws::AppStream::DisassociateAppBlockBuilderAppBlock>

Returns: a L<Paws::AppStream::DisassociateAppBlockBuilderAppBlockResult> instance

Disassociates a specified app block builder from a specified app block.


=head2 DisassociateApplicationFleet
...
Each argument is described in detail in: L<Paws::AppStream::DisassociateApplicationFleet>

Returns: a L<Paws::AppStream::DisassociateApplicationFleetResult> instance

Disassociates the specified application from the fleet.


=head2 DisassociateApplicationFromEntitlement
...
Each argument is described in detail in: L<Paws::AppStream::DisassociateApplicationFromEntitlement>

Returns: a L<Paws::AppStream::DisassociateApplicationFromEntitlementResult> instance
...
=head2 ListEntitledApplications
...
Each argument is described in detail in: L<Paws::AppStream::ListEntitledApplications>

Returns: a L<Paws::AppStream::ListEntitledApplicationsResult> instance
...
Each argument is described in detail in: L<Paws::AppStream::StartAppBlockBuilder>

Returns: a L<Paws::AppStream::StartAppBlockBuilderResult> instance
...
Each argument is described in detail in: L<Paws::AppStream::StopAppBlockBuilder>

Returns: a L<Paws::AppStream::StopAppBlockBuilderResult> instance
...
Each argument is described in detail in: L<Paws::AppStream::UpdateAppBlockBuilder>

Returns: a L<Paws::AppStream::UpdateAppBlockBuilderResult> instance

Updates an app block builder.

If the app block builder is in the C<STARTING> or C<STOPPING> state,
you can't update it. If the app block builder is in the C<RUNNING>
state, you can only update the DisplayName and Description. If the app
block builder is in the C<STOPPED> state, you can update any attribute
except the Name.
...
Each argument is described in detail in: L<Paws::AppStream::UpdateApplication>

Returns: a L<Paws::AppStream::UpdateApplicationResult> instance
...
Each argument is described in detail in: L<Paws::AppStream::UpdateEntitlement>

Returns: a L<Paws::AppStream::UpdateEntitlementResult> instance
...
If the fleet is in the C<RUNNING> state, you can update the following
...
You can update the C<DisplayName>, C<ComputeCapacity>, C<ImageARN>,
C<ImageName>, C<IdleDisconnectTimeoutInSeconds>, and
C<DisconnectTimeoutInSeconds> attributes.

=item *

Elastic fleet type

You can update the C<DisplayName>, C<IdleDisconnectTimeoutInSeconds>,
C<DisconnectTimeoutInSeconds>, C<MaxConcurrentSessions>,
C<SessionScriptS3Location> and C<UsbDeviceFilterStrings> attributes.

=back

If the fleet is in the C<STARTING> or C<STOPPED> state, you can't
update it.
...
Each argument is described in detail in: L<Paws::AppStream::UpdateThemeForStack>

Returns: a L<Paws::AppStream::UpdateThemeForStackResult> instance
...
=head2 DescribeAllSessions(sub { },FleetName => Str, StackName => Str, [AuthenticationType => Str, InstanceId => Str, Limit => Int, NextToken => Str, UserId => Str])

=head2 DescribeAllSessions(FleetName => Str, StackName => Str, [AuthenticationType => Str, InstanceId => Str, Limit => Int, NextToken => Str, UserId => Str])
