...
package Paws::DocDBElastic::GetCluster;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::DocDBElastic::GetClusterOutput');
1;
...
Paws::DocDBElastic::GetCluster - Arguments for method GetCluster on L<Paws::DocDBElastic>
...
=head1 SYNOPSIS
    ...
    my $GetClusterOutput = $docdb -elastic->GetCluster(
      ClusterArn => 'MyString',

    );

    # Results:
    my $Cluster = $GetClusterOutput->Cluster;

    # Returns a L<Paws::DocDBElastic::GetClusterOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/docdb-elastic/GetCluster>
...
This class forms part of L<Paws>, documenting arguments for method GetCluster in L<Paws::DocDBElastic>
