...
package Paws::Neptune::DescribeDBClusterEndpoints;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Neptune::DBClusterEndpointMessage');
...
Paws::Neptune::DescribeDBClusterEndpoints - Arguments for method DescribeDBClusterEndpoints on L<Paws::Neptune>
...
This class forms part of L<Paws>, documenting arguments for method DescribeDBClusterEndpoints in L<Paws::Neptune>
