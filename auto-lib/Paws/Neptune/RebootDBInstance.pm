...
package Paws::Neptune::RebootDBInstance;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Neptune::RebootDBInstanceResult');
...
Paws::Neptune::RebootDBInstance - Arguments for method RebootDBInstance on L<Paws::Neptune>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::Neptune::RebootDBInstanceResult> object.
...
This class forms part of L<Paws>, documenting arguments for method RebootDBInstance in L<Paws::Neptune>
