...
package Paws::Neptune::DeleteDBCluster;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Neptune::DeleteDBClusterResult');
...
Paws::Neptune::DeleteDBCluster - Arguments for method DeleteDBCluster on L<Paws::Neptune>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::Neptune::DeleteDBClusterResult> object.
...
This class forms part of L<Paws>, documenting arguments for method DeleteDBCluster in L<Paws::Neptune>
