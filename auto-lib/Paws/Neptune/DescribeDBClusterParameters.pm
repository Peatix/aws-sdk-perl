...
package Paws::Neptune::DescribeDBClusterParameters;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Neptune::DBClusterParameterGroupDetails');
...
Paws::Neptune::DescribeDBClusterParameters - Arguments for method DescribeDBClusterParameters on L<Paws::Neptune>
...
This class forms part of L<Paws>, documenting arguments for method DescribeDBClusterParameters in L<Paws::Neptune>
