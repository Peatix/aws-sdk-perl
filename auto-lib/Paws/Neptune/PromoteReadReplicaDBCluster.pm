...
package Paws::Neptune::PromoteReadReplicaDBCluster;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Neptune::PromoteReadReplicaDBClusterResult');
...
Paws::Neptune::PromoteReadReplicaDBCluster - Arguments for method PromoteReadReplicaDBCluster on L<Paws::Neptune>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::Neptune::PromoteReadReplicaDBClusterResult> object.
...
This class forms part of L<Paws>, documenting arguments for method PromoteReadReplicaDBCluster in L<Paws::Neptune>
