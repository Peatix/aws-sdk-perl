...
package Paws::Neptune::SwitchoverGlobalCluster;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Neptune::SwitchoverGlobalClusterResult');
...
Paws::Neptune::SwitchoverGlobalCluster - Arguments for method SwitchoverGlobalCluster on L<Paws::Neptune>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::Neptune::SwitchoverGlobalClusterResult> object.
...
This class forms part of L<Paws>, documenting arguments for method SwitchoverGlobalCluster in L<Paws::Neptune>
