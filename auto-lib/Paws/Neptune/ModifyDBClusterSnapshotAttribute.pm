...
package Paws::Neptune::ModifyDBClusterSnapshotAttribute;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Neptune::ModifyDBClusterSnapshotAttributeResult');
...
Paws::Neptune::ModifyDBClusterSnapshotAttribute - Arguments for method ModifyDBClusterSnapshotAttribute on L<Paws::Neptune>
...
This class forms part of L<Paws>, documenting arguments for method ModifyDBClusterSnapshotAttribute in L<Paws::Neptune>
