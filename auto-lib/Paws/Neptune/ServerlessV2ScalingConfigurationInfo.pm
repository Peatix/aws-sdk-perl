...
package Paws::Neptune::ServerlessV2ScalingConfigurationInfo;
  use Moose;
...
Paws::Neptune::ServerlessV2ScalingConfigurationInfo
...
As an example, if Att1 is expected to be a Paws::Neptune::ServerlessV2ScalingConfigurationInfo object:

  $service_obj->Method(Att1 => { MaxCapacity => $value, ..., MinCapacity => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Neptune::ServerlessV2ScalingConfigurationInfo object:
