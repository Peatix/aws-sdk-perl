...
package Paws::Neptune::ModifyEventSubscription;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Neptune::ModifyEventSubscriptionResult');
...
Paws::Neptune::ModifyEventSubscription - Arguments for method ModifyEventSubscription on L<Paws::Neptune>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::Neptune::ModifyEventSubscriptionResult> object.
...
This class forms part of L<Paws>, documenting arguments for method ModifyEventSubscription in L<Paws::Neptune>
