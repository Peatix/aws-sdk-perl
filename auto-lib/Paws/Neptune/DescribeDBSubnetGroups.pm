...
package Paws::Neptune::DescribeDBSubnetGroups;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Neptune::DBSubnetGroupMessage');
...
Paws::Neptune::DescribeDBSubnetGroups - Arguments for method DescribeDBSubnetGroups on L<Paws::Neptune>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::Neptune::DBSubnetGroupMessage> object.
...
This class forms part of L<Paws>, documenting arguments for method DescribeDBSubnetGroups in L<Paws::Neptune>
