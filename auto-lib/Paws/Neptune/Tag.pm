...
As an example, if Att1 is expected to be a Paws::Neptune::Tag object:

  $service_obj->Method(Att1 => { Key => $value, ..., Value => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Neptune::Tag object:
...
or C<rds:>. The string can only contain the set of Unicode letters,
...
C<aws:> or C<rds:>. The string can only contain the set of Unicode
