...
package Paws::Neptune::DescribeEngineDefaultClusterParameters;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Neptune::DescribeEngineDefaultClusterParametersResult');
...
Paws::Neptune::DescribeEngineDefaultClusterParameters - Arguments for method DescribeEngineDefaultClusterParameters on L<Paws::Neptune>
...
# Returns a L<Paws::Neptune::DescribeEngineDefaultClusterParametersResult> object.
...
This class forms part of L<Paws>, documenting arguments for method DescribeEngineDefaultClusterParameters in L<Paws::Neptune>
