...
package Paws::Neptune::DeleteDBClusterSnapshot;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Neptune::DeleteDBClusterSnapshotResult');
...
Paws::Neptune::DeleteDBClusterSnapshot - Arguments for method DeleteDBClusterSnapshot on L<Paws::Neptune>
...
=head1 SYNOPSIS
    ...
    # Results:
    my $DBClusterSnapshot = $DeleteDBClusterSnapshotResult->DBClusterSnapshot;

    # Returns a L<Paws::Neptune::DeleteDBClusterSnapshotResult> object.
...
This class forms part of L<Paws>, documenting arguments for method DeleteDBClusterSnapshot in L<Paws::Neptune>
