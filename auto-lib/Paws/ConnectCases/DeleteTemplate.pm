...
package Paws::ConnectCases::DeleteTemplate;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ConnectCases::DeleteTemplateResponse');
1;
...
Paws::ConnectCases::DeleteTemplate - Arguments for method DeleteTemplate on L<Paws::ConnectCases>
...
=head1 SYNOPSIS
    ...
    my $DeleteTemplateResponse = $cases->DeleteTemplate(
      DomainId   => 'MyDomainId',
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/cases/DeleteTemplate>
...
This class forms part of L<Paws>, documenting arguments for method DeleteTemplate in L<Paws::ConnectCases>
