...
package Paws::ConnectCases::ListTemplates;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/domains/{domainId}/templates-list');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ConnectCases::ListTemplatesResponse');
1;
...
Paws::ConnectCases::ListTemplates - Arguments for method ListTemplates on L<Paws::ConnectCases>
...
=head1 SYNOPSIS
    ...
    my $ListTemplatesResponse = $cases->ListTemplates(
      DomainId   => 'MyDomainId',
      MaxResults => 1,                # OPTIONAL
      NextToken  => 'MyNextToken',    # OPTIONAL
      Status     => [
        'Active', ...                 # values: Active, Inactive
      ],    # OPTIONAL
    );
    ...
    # Returns a L<Paws::ConnectCases::ListTemplatesResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/cases/ListTemplates>
...
This class forms part of L<Paws>, documenting arguments for method ListTemplates in L<Paws::ConnectCases>
