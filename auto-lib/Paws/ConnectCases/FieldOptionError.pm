...
package Paws::ConnectCases::FieldOptionError;
  use Moose;
...
Paws::ConnectCases::FieldOptionError
...
As an example, if Att1 is expected to be a Paws::ConnectCases::FieldOptionError object:

  $service_obj->Method(Att1 => { ErrorCode => $value, ..., Value => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ConnectCases::FieldOptionError object:
