...
package Paws::ConnectCases::UpdateTemplate;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ConnectCases::UpdateTemplateResponse');
1;
...
Paws::ConnectCases::UpdateTemplate - Arguments for method UpdateTemplate on L<Paws::ConnectCases>
...
=head1 SYNOPSIS
    ...
    my $UpdateTemplateResponse = $cases->UpdateTemplate(
      DomainId            => 'MyDomainId',
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/cases/UpdateTemplate>
...
This class forms part of L<Paws>, documenting arguments for method UpdateTemplate in L<Paws::ConnectCases>
