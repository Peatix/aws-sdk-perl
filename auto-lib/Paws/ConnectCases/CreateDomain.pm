...
package Paws::ConnectCases::CreateDomain;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ConnectCases::CreateDomainResponse');
1;
...
Paws::ConnectCases::CreateDomain - Arguments for method CreateDomain on L<Paws::ConnectCases>
...
=head1 SYNOPSIS
    ...
    my $CreateDomainResponse = $cases->CreateDomain(
      Name => 'MyDomainName',
    ...
    my $DomainId     = $CreateDomainResponse->DomainId;
    my $DomainStatus = $CreateDomainResponse->DomainStatus;

    # Returns a L<Paws::ConnectCases::CreateDomainResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/cases/CreateDomain>
...
This class forms part of L<Paws>, documenting arguments for method CreateDomain in L<Paws::ConnectCases>
