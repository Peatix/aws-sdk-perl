...
package Paws::AmplifyBackend::GetBackendAPI;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'GetBackendAPI');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/backend/{appId}/api/{backendEnvironmentName}/details');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::AmplifyBackend::GetBackendAPIResponse');
1;
...
Paws::AmplifyBackend::GetBackendAPI - Arguments for method GetBackendAPI on L<Paws::AmplifyBackend>

=head1 DESCRIPTION

This class represents the parameters used for calling the method GetBackendAPI on the
L<AmplifyBackend|Paws::AmplifyBackend> service. Use the attributes of this class
as arguments to method GetBackendAPI.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to GetBackendAPI.

=head1 SYNOPSIS

    my $amplifybackend = Paws->service('AmplifyBackend');
    my $GetBackendAPIResponse = $amplifybackend->GetBackendAPI(
      AppId                  => 'My__string',
    ...
    # Results:
    my $AppId                  = $GetBackendAPIResponse->AppId;
    my $BackendEnvironmentName = $GetBackendAPIResponse->BackendEnvironmentName;
    my $Error                  = $GetBackendAPIResponse->Error;
    my $ResourceConfig         = $GetBackendAPIResponse->ResourceConfig;
    my $ResourceName           = $GetBackendAPIResponse->ResourceName;

    # Returns a L<Paws::AmplifyBackend::GetBackendAPIResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method GetBackendAPI in L<Paws::AmplifyBackend>
