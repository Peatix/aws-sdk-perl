...
package Paws::AmplifyBackend::CreateBackendAuthMFAConfig;
  use Moose;
  has MFAMode => (is => 'ro', isa => 'Str', required => 1);
...
Paws::AmplifyBackend::CreateBackendAuthMFAConfig
...
As an example, if Att1 is expected to be a Paws::AmplifyBackend::CreateBackendAuthMFAConfig object:

  $service_obj->Method(Att1 => { MFAMode => $value, ..., Settings => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::AmplifyBackend::CreateBackendAuthMFAConfig object:
