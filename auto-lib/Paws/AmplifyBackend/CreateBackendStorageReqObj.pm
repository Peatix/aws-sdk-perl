...
package Paws::AmplifyBackend::CreateBackendStorageReqObj;
  use Moose;
  has BackendEnvironmentName => (is => 'ro', isa => 'Str', request_name => 'backendEnvironmentName', traits => ['NameInRequest'], required => 1);
  has ResourceConfig => (is => 'ro', isa => 'Paws::AmplifyBackend::CreateBackendStorageResourceConfig', request_name => 'resourceConfig', traits => ['NameInRequest'], required => 1);
...
Paws::AmplifyBackend::CreateBackendStorageReqObj
...
As an example, if Att1 is expected to be a Paws::AmplifyBackend::CreateBackendStorageReqObj object:

  $service_obj->Method(Att1 => { BackendEnvironmentName => $value, ..., ResourceName => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::AmplifyBackend::CreateBackendStorageReqObj object:
