...
package Paws::AmplifyBackend::GetBackendStorageRespObj;
  use Moose;
  ...
  has ResourceConfig => (is => 'ro', isa => 'Paws::AmplifyBackend::GetBackendStorageResourceConfig', request_name => 'resourceConfig', traits => ['NameInRequest']);
...
Paws::AmplifyBackend::GetBackendStorageRespObj
...
As an example, if Att1 is expected to be a Paws::AmplifyBackend::GetBackendStorageRespObj object:

  $service_obj->Method(Att1 => { AppId => $value, ..., ResourceName => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::AmplifyBackend::GetBackendStorageRespObj object:
