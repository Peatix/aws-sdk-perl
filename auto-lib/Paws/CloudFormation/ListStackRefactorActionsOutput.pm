...
package Paws::CloudFormation::ListStackRefactorActionsOutput;
  use Moose;
  has NextToken => (is => 'ro', isa => 'Str');
  has StackRefactorActions => (is => 'ro', isa => 'ArrayRef[Paws::CloudFormation::StackRefactorAction]', required => 1);
...
Paws::CloudFormation::ListStackRefactorActionsOutput
...
=head2 B<REQUIRED> StackRefactorActions => ArrayRef[L<Paws::CloudFormation::StackRefactorAction>]
