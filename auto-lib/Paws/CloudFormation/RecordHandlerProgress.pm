...
Valid values are: C<"NotUpdatable">, C<"InvalidRequest">, C<"AccessDenied">, C<"InvalidCredentials">, C<"AlreadyExists">, C<"NotFound">, C<"ResourceConflict">, C<"Throttling">, C<"ServiceLimitExceeded">, C<"NotStabilized">, C<"GeneralServiceException">, C<"ServiceInternalError">, C<"NetworkFailure">, C<"InternalFailure">, C<"InvalidTypeConfiguration">, C<"HandlerInternalFailure">, C<"NonCompliant">, C<"Unknown">, C<"UnsupportedTarget">
