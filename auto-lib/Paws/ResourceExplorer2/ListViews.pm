...
package Paws::ResourceExplorer2::ListViews;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/ListViews');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ResourceExplorer2::ListViewsOutput');
1;
...
Paws::ResourceExplorer2::ListViews - Arguments for method ListViews on L<Paws::ResourceExplorer2>
...
=head1 SYNOPSIS
    ...
    my $ListViewsOutput = $resource -explorer- 2->ListViews(
      MaxResults => 1,             # OPTIONAL
      NextToken  => 'MyString',    # OPTIONAL
    );

    # Results:
    my $NextToken = $ListViewsOutput->NextToken;
    my $Views     = $ListViewsOutput->Views;

    # Returns a L<Paws::ResourceExplorer2::ListViewsOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/resource-explorer-2/ListViews>
...
This class forms part of L<Paws>, documenting arguments for method ListViews in L<Paws::ResourceExplorer2>
