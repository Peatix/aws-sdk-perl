...
package Paws::ResourceExplorer2::BatchGetViewError;
  use Moose;
...
Paws::ResourceExplorer2::BatchGetViewError
...
As an example, if Att1 is expected to be a Paws::ResourceExplorer2::BatchGetViewError object:

  $service_obj->Method(Att1 => { ErrorMessage => $value, ..., ViewArn => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ResourceExplorer2::BatchGetViewError object:
