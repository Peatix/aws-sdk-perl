...
package Paws::Wisdom::AssistantData;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::Wisdom::AssistantData object:

  $service_obj->Method(Att1 => { AssistantArn => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Wisdom::AssistantData object:
