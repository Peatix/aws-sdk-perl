...
package Paws::Wisdom::GetImportJob;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Wisdom::GetImportJobResponse');
1;
...
Paws::Wisdom::GetImportJob - Arguments for method GetImportJob on L<Paws::Wisdom>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::Wisdom::GetImportJobResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method GetImportJob in L<Paws::Wisdom>
