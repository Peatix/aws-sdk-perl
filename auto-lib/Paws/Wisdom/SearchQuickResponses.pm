...
package Paws::Wisdom::SearchQuickResponses;
  use Moose;
  has Attributes => (is => 'ro', isa => 'Paws::Wisdom::ContactAttributes', traits => ['NameInRequest'], request_name => 'attributes');
  has KnowledgeBaseId => (is => 'ro', isa => 'Str', traits => ['ParamInURI'], uri_name => 'knowledgeBaseId', required => 1);
  has MaxResults => (is => 'ro', isa => 'Int', traits => ['ParamInQuery'], query_name => 'maxResults');
  has NextToken => (is => 'ro', isa => 'Str', traits => ['ParamInQuery'], query_name => 'nextToken');
  has SearchExpression => (is => 'ro', isa => 'Paws::Wisdom::QuickResponseSearchExpression', traits => ['NameInRequest'], request_name => 'searchExpression', required => 1);
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Wisdom::SearchQuickResponsesResponse');
1;
...
Paws::Wisdom::SearchQuickResponses - Arguments for method SearchQuickResponses on L<Paws::Wisdom>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::Wisdom::SearchQuickResponsesResponse> object.
...
=head2 Attributes => L<Paws::Wisdom::ContactAttributes>
...
=head2 B<REQUIRED> SearchExpression => L<Paws::Wisdom::QuickResponseSearchExpression>
...
This class forms part of L<Paws>, documenting arguments for method SearchQuickResponses in L<Paws::Wisdom>
