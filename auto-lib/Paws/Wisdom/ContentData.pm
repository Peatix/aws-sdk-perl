...
package Paws::Wisdom::ContentData;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::Wisdom::ContentData object:

  $service_obj->Method(Att1 => { ContentArn => $value, ..., UrlExpiry => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Wisdom::ContentData object:
