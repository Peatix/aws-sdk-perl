...
package Paws::Wisdom::KnowledgeBaseSummary;
  use Moose;
...
Paws::Wisdom::KnowledgeBaseSummary
...
As an example, if Att1 is expected to be a Paws::Wisdom::KnowledgeBaseSummary object:

  $service_obj->Method(Att1 => { Description => $value, ..., Tags => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Wisdom::KnowledgeBaseSummary object:
...
C<kms:DescribeKey>, C<kms:Decrypt/kms:GenerateDataKey> permissions to
