...
package Paws::Wisdom::UpdateQuickResponse;
  use Moose;
  has Channels => (is => 'ro', isa => 'ArrayRef[Str|Undef]', traits => ['NameInRequest'], request_name => 'channels');
  has Content => (is => 'ro', isa => 'Paws::Wisdom::QuickResponseDataProvider', traits => ['NameInRequest'], request_name => 'content');
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Wisdom::UpdateQuickResponseResponse');
1;
...
Paws::Wisdom::UpdateQuickResponse - Arguments for method UpdateQuickResponse on L<Paws::Wisdom>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::Wisdom::UpdateQuickResponseResponse> object.
...
=head2 Content => L<Paws::Wisdom::QuickResponseDataProvider>
...
This class forms part of L<Paws>, documenting arguments for method UpdateQuickResponse in L<Paws::Wisdom>
