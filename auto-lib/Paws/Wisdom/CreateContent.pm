...
package Paws::Wisdom::CreateContent;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Wisdom::CreateContentResponse');
1;
...
Paws::Wisdom::CreateContent - Arguments for method CreateContent on L<Paws::Wisdom>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::Wisdom::CreateContentResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method CreateContent in L<Paws::Wisdom>
