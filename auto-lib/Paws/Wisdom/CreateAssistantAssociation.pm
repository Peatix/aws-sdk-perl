...
package Paws::Wisdom::CreateAssistantAssociation;
  use Moose;
  has AssistantId => (is => 'ro', isa => 'Str', traits => ['ParamInURI'], uri_name => 'assistantId', required => 1);
  has Association => (is => 'ro', isa => 'Paws::Wisdom::AssistantAssociationInputData', traits => ['NameInRequest'], request_name => 'association', required => 1);
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Wisdom::CreateAssistantAssociationResponse');
1;
...
Paws::Wisdom::CreateAssistantAssociation - Arguments for method CreateAssistantAssociation on L<Paws::Wisdom>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::Wisdom::CreateAssistantAssociationResponse> object.
...
=head2 B<REQUIRED> Association => L<Paws::Wisdom::AssistantAssociationInputData>
...
This class forms part of L<Paws>, documenting arguments for method CreateAssistantAssociation in L<Paws::Wisdom>
