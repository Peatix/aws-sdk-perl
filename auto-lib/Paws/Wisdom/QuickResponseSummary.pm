...
package Paws::Wisdom::QuickResponseSummary;
  use Moose;
...
Paws::Wisdom::QuickResponseSummary
...
As an example, if Att1 is expected to be a Paws::Wisdom::QuickResponseSummary object:

  $service_obj->Method(Att1 => { Channels => $value, ..., Tags => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Wisdom::QuickResponseSummary object:
