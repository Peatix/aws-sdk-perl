...
package Paws::Wisdom::DeleteContent;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Wisdom::DeleteContentResponse');
1;
...
Paws::Wisdom::DeleteContent - Arguments for method DeleteContent on L<Paws::Wisdom>
...
This class forms part of L<Paws>, documenting arguments for method DeleteContent in L<Paws::Wisdom>
