...
package Paws::Wisdom::ListImportJobs;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Wisdom::ListImportJobsResponse');
1;
...
Paws::Wisdom::ListImportJobs - Arguments for method ListImportJobs on L<Paws::Wisdom>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::Wisdom::ListImportJobsResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method ListImportJobs in L<Paws::Wisdom>
