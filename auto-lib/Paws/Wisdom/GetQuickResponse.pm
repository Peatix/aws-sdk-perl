...
package Paws::Wisdom::GetQuickResponse;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Wisdom::GetQuickResponseResponse');
1;
...
Paws::Wisdom::GetQuickResponse - Arguments for method GetQuickResponse on L<Paws::Wisdom>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::Wisdom::GetQuickResponseResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method GetQuickResponse in L<Paws::Wisdom>
