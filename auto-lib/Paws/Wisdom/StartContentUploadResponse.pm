...
package Paws::Wisdom::StartContentUploadResponse;
  use Moose;
  has HeadersToInclude => (is => 'ro', isa => 'Paws::Wisdom::Headers', traits => ['NameInRequest'], request_name => 'headersToInclude', required => 1);
...
Paws::Wisdom::StartContentUploadResponse

=head1 ATTRIBUTES


=head2 B<REQUIRED> HeadersToInclude => L<Paws::Wisdom::Headers>
