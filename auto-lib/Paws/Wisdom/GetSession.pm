...
package Paws::Wisdom::GetSession;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Wisdom::GetSessionResponse');
1;
...
Paws::Wisdom::GetSession - Arguments for method GetSession on L<Paws::Wisdom>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::Wisdom::GetSessionResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method GetSession in L<Paws::Wisdom>
