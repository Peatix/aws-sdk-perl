...
package Paws::Wisdom::StartImportJob;
  use Moose;
  has ClientToken => (is => 'ro', isa => 'Str', traits => ['NameInRequest'], request_name => 'clientToken');
  has ExternalSourceConfiguration => (is => 'ro', isa => 'Paws::Wisdom::ExternalSourceConfiguration', traits => ['NameInRequest'], request_name => 'externalSourceConfiguration');
  ...
  has Metadata => (is => 'ro', isa => 'Paws::Wisdom::ContentMetadata', traits => ['NameInRequest'], request_name => 'metadata');
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Wisdom::StartImportJobResponse');
1;
...
Paws::Wisdom::StartImportJob - Arguments for method StartImportJob on L<Paws::Wisdom>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::Wisdom::StartImportJobResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method StartImportJob in L<Paws::Wisdom>
