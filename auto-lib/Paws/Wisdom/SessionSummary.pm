...
package Paws::Wisdom::SessionSummary;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::Wisdom::SessionSummary object:

  $service_obj->Method(Att1 => { AssistantArn => $value, ..., SessionId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Wisdom::SessionSummary object:
