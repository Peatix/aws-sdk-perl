...
package Paws::Wisdom::SearchContent;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Wisdom::SearchContentResponse');
1;
...
Paws::Wisdom::SearchContent - Arguments for method SearchContent on L<Paws::Wisdom>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::Wisdom::SearchContentResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method SearchContent in L<Paws::Wisdom>
