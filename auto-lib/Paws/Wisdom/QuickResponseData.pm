...
package Paws::Wisdom::QuickResponseData;
  use Moose;
  has Channels => (is => 'ro', isa => 'ArrayRef[Str|Undef]', request_name => 'channels', traits => ['NameInRequest']);
  has Contents => (is => 'ro', isa => 'Paws::Wisdom::QuickResponseContents', request_name => 'contents', traits => ['NameInRequest']);
...
As an example, if Att1 is expected to be a Paws::Wisdom::QuickResponseData object:

  $service_obj->Method(Att1 => { Channels => $value, ..., Tags => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Wisdom::QuickResponseData object:
...
=head2 Contents => L<Paws::Wisdom::QuickResponseContents>
