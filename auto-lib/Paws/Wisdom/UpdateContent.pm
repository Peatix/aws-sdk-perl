...
package Paws::Wisdom::UpdateContent;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Wisdom::UpdateContentResponse');
1;
...
Paws::Wisdom::UpdateContent - Arguments for method UpdateContent on L<Paws::Wisdom>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::Wisdom::UpdateContentResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method UpdateContent in L<Paws::Wisdom>
