...
package Paws::B2bi::UpdateTransformer;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'UpdateTransformer');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::B2bi::UpdateTransformerResponse');
...
Paws::B2bi::UpdateTransformer - Arguments for method UpdateTransformer on L<Paws::B2bi>

=head1 DESCRIPTION

This class represents the parameters used for calling the method UpdateTransformer on the
L<AWS B2B Data Interchange|Paws::B2bi> service. Use the attributes of this class
as arguments to method UpdateTransformer.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to UpdateTransformer.

=head1 SYNOPSIS

    my $b2bi = Paws->service('B2bi');
    my $UpdateTransformerResponse = $b2bi->UpdateTransformer(
      ...
      Name             => 'MyTransformerName',    # OPTIONAL
      OutputConversion => {
    ...
    # Results:
    my $CreatedAt        = $UpdateTransformerResponse->CreatedAt;
    my $EdiType          = $UpdateTransformerResponse->EdiType;
    my $FileFormat       = $UpdateTransformerResponse->FileFormat;
    my $InputConversion  = $UpdateTransformerResponse->InputConversion;
    my $Mapping          = $UpdateTransformerResponse->Mapping;
    my $MappingTemplate  = $UpdateTransformerResponse->MappingTemplate;
    my $ModifiedAt       = $UpdateTransformerResponse->ModifiedAt;
    my $Name             = $UpdateTransformerResponse->Name;
    my $OutputConversion = $UpdateTransformerResponse->OutputConversion;
    my $SampleDocument   = $UpdateTransformerResponse->SampleDocument;
    my $SampleDocuments  = $UpdateTransformerResponse->SampleDocuments;
    my $Status           = $UpdateTransformerResponse->Status;
    my $TransformerArn   = $UpdateTransformerResponse->TransformerArn;
    my $TransformerId    = $UpdateTransformerResponse->TransformerId;

    # Returns a L<Paws::B2bi::UpdateTransformerResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/b2bi/UpdateTransformer>
...
To update, specify the C<InputConversion> object, which contains the
...
To update, specify the C<OutputConversion> object, which contains the
...
transformer from C<inactive> to C<active>.
...
This class forms part of L<Paws>, documenting arguments for method UpdateTransformer in L<Paws::B2bi>
