...
package Paws::B2bi::TestParsing;
  use Moose;
  has EdiType => (is => 'ro', isa => 'Paws::B2bi::EdiType', traits => ['NameInRequest'], request_name => 'ediType' , required => 1);
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'TestParsing');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::B2bi::TestParsingResponse');
...
Paws::B2bi::TestParsing - Arguments for method TestParsing on L<Paws::B2bi>

=head1 DESCRIPTION

This class represents the parameters used for calling the method TestParsing on the
L<AWS B2B Data Interchange|Paws::B2bi> service. Use the attributes of this class
as arguments to method TestParsing.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to TestParsing.

=head1 SYNOPSIS

    my $b2bi = Paws->service('B2bi');
    my $TestParsingResponse = $b2bi->TestParsing(
      EdiType => {
        X12Details => {
    ...
    # Results:
    my $ParsedFileContent = $TestParsingResponse->ParsedFileContent;

    # Returns a L<Paws::B2bi::TestParsingResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/b2bi/TestParsing>

=head1 ATTRIBUTES


=head2 B<REQUIRED> EdiType => L<Paws::B2bi::EdiType>
...
Specifies an C<S3Location> object, which contains the Amazon S3 bucket
...
This class forms part of L<Paws>, documenting arguments for method TestParsing in L<Paws::B2bi>
