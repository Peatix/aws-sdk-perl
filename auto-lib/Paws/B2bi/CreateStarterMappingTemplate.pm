...
package Paws::B2bi::CreateStarterMappingTemplate;
  use Moose;
  has MappingType => (is => 'ro', isa => 'Str', traits => ['NameInRequest'], request_name => 'mappingType' , required => 1);
  has OutputSampleLocation => (is => 'ro', isa => 'Paws::B2bi::S3Location', traits => ['NameInRequest'], request_name => 'outputSampleLocation' );
  has TemplateDetails => (is => 'ro', isa => 'Paws::B2bi::TemplateDetails', traits => ['NameInRequest'], request_name => 'templateDetails' , required => 1);

  use MooseX::ClassAttribute;

  class_has _api_call => (isa => 'Str', is => 'ro', default => 'CreateStarterMappingTemplate');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::B2bi::CreateStarterMappingTemplateResponse');
...
Paws::B2bi::CreateStarterMappingTemplate - Arguments for method CreateStarterMappingTemplate on L<Paws::B2bi>

=head1 DESCRIPTION

This class represents the parameters used for calling the method CreateStarterMappingTemplate on the
L<AWS B2B Data Interchange|Paws::B2bi> service. Use the attributes of this class
as arguments to method CreateStarterMappingTemplate.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to CreateStarterMappingTemplate.

=head1 SYNOPSIS

    my $b2bi = Paws->service('B2bi');
    my $CreateStarterMappingTemplateResponse =
    ...
    # Results:
    my $MappingTemplate =
      $CreateStarterMappingTemplateResponse->MappingTemplate;

    # Returns a L<Paws::B2bi::CreateStarterMappingTemplateResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/b2bi/CreateStarterMappingTemplate>
...
=head2 OutputSampleLocation => L<Paws::B2bi::S3Location>
...
=head2 B<REQUIRED> TemplateDetails => L<Paws::B2bi::TemplateDetails>
...
This class forms part of L<Paws>, documenting arguments for method CreateStarterMappingTemplate in L<Paws::B2bi>
