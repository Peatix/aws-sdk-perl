...
package Paws::B2bi::DeleteProfile;
  use Moose;
...
Paws::B2bi::DeleteProfile - Arguments for method DeleteProfile on L<Paws::B2bi>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/b2bi/DeleteProfile>
...
This class forms part of L<Paws>, documenting arguments for method DeleteProfile in L<Paws::B2bi>
