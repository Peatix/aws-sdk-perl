...
package Paws::B2bi::UpdateCapability;
  use Moose;
  has CapabilityId => (is => 'ro', isa => 'Str', traits => ['NameInRequest'], request_name => 'capabilityId' , required => 1);
  has Configuration => (is => 'ro', isa => 'Paws::B2bi::CapabilityConfiguration', traits => ['NameInRequest'], request_name => 'configuration' );
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'UpdateCapability');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::B2bi::UpdateCapabilityResponse');
...
Paws::B2bi::UpdateCapability - Arguments for method UpdateCapability on L<Paws::B2bi>

=head1 DESCRIPTION

This class represents the parameters used for calling the method UpdateCapability on the
L<AWS B2B Data Interchange|Paws::B2bi> service. Use the attributes of this class
as arguments to method UpdateCapability.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to UpdateCapability.

=head1 SYNOPSIS

    my $b2bi = Paws->service('B2bi');
    my $UpdateCapabilityResponse = $b2bi->UpdateCapability(
      ...
      Configuration => {
        Edi => {
          ...
          TransformerId => 'MyTransformerId',    # min: 1, max: 64
          Type          => {
            X12Details => {
      ...
      Name => 'MyCapabilityName',    # OPTIONAL
    );

    # Results:
    my $CapabilityArn = $UpdateCapabilityResponse->CapabilityArn;
    my $CapabilityId  = $UpdateCapabilityResponse->CapabilityId;
    my $Configuration = $UpdateCapabilityResponse->Configuration;
    my $CreatedAt     = $UpdateCapabilityResponse->CreatedAt;
    my $InstructionsDocuments =
      $UpdateCapabilityResponse->InstructionsDocuments;
    my $ModifiedAt = $UpdateCapabilityResponse->ModifiedAt;
    my $Name       = $UpdateCapabilityResponse->Name;
    my $Type       = $UpdateCapabilityResponse->Type;

    # Returns a L<Paws::B2bi::UpdateCapabilityResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/b2bi/UpdateCapability>
...
=head2 Configuration => L<Paws::B2bi::CapabilityConfiguration>
...
This class forms part of L<Paws>, documenting arguments for method UpdateCapability in L<Paws::B2bi>
