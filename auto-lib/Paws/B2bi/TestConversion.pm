...
package Paws::B2bi::TestConversion;
  use Moose;
  has Source => (is => 'ro', isa => 'Paws::B2bi::ConversionSource', traits => ['NameInRequest'], request_name => 'source' , required => 1);
  has Target => (is => 'ro', isa => 'Paws::B2bi::ConversionTarget', traits => ['NameInRequest'], request_name => 'target' , required => 1);

  use MooseX::ClassAttribute;

  class_has _api_call => (isa => 'Str', is => 'ro', default => 'TestConversion');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::B2bi::TestConversionResponse');
...
Paws::B2bi::TestConversion - Arguments for method TestConversion on L<Paws::B2bi>

=head1 DESCRIPTION

This class represents the parameters used for calling the method TestConversion on the
L<AWS B2B Data Interchange|Paws::B2bi> service. Use the attributes of this class
as arguments to method TestConversion.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to TestConversion.

=head1 SYNOPSIS

    my $b2bi = Paws->service('B2bi');
    my $TestConversionResponse = $b2bi->TestConversion(
      Source => {
        FileFormat => 'JSON',    # values: JSON, XML
        InputFile  => {
          FileContent => 'MyInputFileSourceFileContentString'
          ,                      # min: 1, max: 5000000; OPTIONAL
        },

      },
      Target => {
        FileFormat    => 'X12',    # values: X12
        FormatDetails => {
          X12 => {
    ...
    # Results:
    my $ConvertedFileContent = $TestConversionResponse->ConvertedFileContent;
    my $ValidationMessages   = $TestConversionResponse->ValidationMessages;

    # Returns a L<Paws::B2bi::TestConversionResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/b2bi/TestConversion>

=head1 ATTRIBUTES


=head2 B<REQUIRED> Source => L<Paws::B2bi::ConversionSource>

Specify the source file for an outbound EDI request.



=head2 B<REQUIRED> Target => L<Paws::B2bi::ConversionTarget>
...
This class forms part of L<Paws>, documenting arguments for method TestConversion in L<Paws::B2bi>
