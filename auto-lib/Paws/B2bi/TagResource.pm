...
package Paws::B2bi::TagResource;
  use Moose;
  has ResourceARN => (is => 'ro', isa => 'Str', required => 1);
  has Tags => (is => 'ro', isa => 'ArrayRef[Paws::B2bi::Tag]', required => 1);
...
Paws::B2bi::TagResource - Arguments for method TagResource on L<Paws::B2bi>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/b2bi/TagResource>
...
=head2 B<REQUIRED> Tags => ArrayRef[L<Paws::B2bi::Tag>]
...
This class forms part of L<Paws>, documenting arguments for method TagResource in L<Paws::B2bi>
