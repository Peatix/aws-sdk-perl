...
package Paws::PinpointSMSVoice::DeleteConfigurationSet;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/v1/sms-voice/configuration-sets/{ConfigurationSetName}');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'DELETE');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::PinpointSMSVoice::DeleteConfigurationSetResponse');
1;
...
Paws::PinpointSMSVoice::DeleteConfigurationSet - Arguments for method DeleteConfigurationSet on L<Paws::PinpointSMSVoice>
...
=head1 SYNOPSIS
    ...
    my $DeleteConfigurationSetResponse =
      $sms -voice . pinpoint->DeleteConfigurationSet(
...
This class forms part of L<Paws>, documenting arguments for method DeleteConfigurationSet in L<Paws::PinpointSMSVoice>
