...
package Paws::RolesAnywhere::DeleteProfile;
  use Moose;
...
Paws::RolesAnywhere::DeleteProfile - Arguments for method DeleteProfile on L<Paws::RolesAnywhere>
...
=head1 SYNOPSIS
    ...
    my $ProfileDetailResponse = $rolesanywhere->DeleteProfile(
      ProfileId => 'MyUuid',
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/rolesanywhere/DeleteProfile>
...
This class forms part of L<Paws>, documenting arguments for method DeleteProfile in L<Paws::RolesAnywhere>
