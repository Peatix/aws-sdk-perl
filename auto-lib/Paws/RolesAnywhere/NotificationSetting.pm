...
package Paws::RolesAnywhere::NotificationSetting;
  use Moose;
...
Paws::RolesAnywhere::NotificationSetting
...
As an example, if Att1 is expected to be a Paws::RolesAnywhere::NotificationSetting object:

  $service_obj->Method(Att1 => { Channel => $value, ..., Threshold => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::RolesAnywhere::NotificationSetting object:
