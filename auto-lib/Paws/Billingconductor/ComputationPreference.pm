...
package Paws::Billingconductor::ComputationPreference;
  use Moose;
...
Paws::Billingconductor::ComputationPreference
...
As an example, if Att1 is expected to be a Paws::Billingconductor::ComputationPreference object:

  $service_obj->Method(Att1 => { PricingPlanArn => $value, ..., PricingPlanArn => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Billingconductor::ComputationPreference object:

  $result = $service_obj->Method(...);
  $result->Att1->PricingPlanArn
