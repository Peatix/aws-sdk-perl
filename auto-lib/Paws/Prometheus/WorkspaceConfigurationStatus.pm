...
package Paws::Prometheus::WorkspaceConfigurationStatus;
  use Moose;
...
Paws::Prometheus::WorkspaceConfigurationStatus
...
As an example, if Att1 is expected to be a Paws::Prometheus::WorkspaceConfigurationStatus object:

  $service_obj->Method(Att1 => { StatusCode => $value, ..., StatusReason => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Prometheus::WorkspaceConfigurationStatus object:
