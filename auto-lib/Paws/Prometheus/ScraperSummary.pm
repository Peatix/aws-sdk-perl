...
package Paws::Prometheus::ScraperSummary;
  use Moose;
...
Paws::Prometheus::ScraperSummary
...
As an example, if Att1 is expected to be a Paws::Prometheus::ScraperSummary object:

  $service_obj->Method(Att1 => { Alias => $value, ..., Tags => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Prometheus::ScraperSummary object:
...
The C<ScraperSummary> structure contains a summary of the details about
