...
package Paws::Prometheus::DeleteWorkspace;
  use Moose;
...
Paws::Prometheus::DeleteWorkspace - Arguments for method DeleteWorkspace on L<Paws::Prometheus>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/aps/DeleteWorkspace>
...
This class forms part of L<Paws>, documenting arguments for method DeleteWorkspace in L<Paws::Prometheus>
