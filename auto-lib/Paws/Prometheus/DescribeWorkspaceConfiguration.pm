...
package Paws::Prometheus::DescribeWorkspaceConfiguration;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Prometheus::DescribeWorkspaceConfigurationResponse');
1;
...
Paws::Prometheus::DescribeWorkspaceConfiguration - Arguments for method DescribeWorkspaceConfiguration on L<Paws::Prometheus>
...
=head1 SYNOPSIS
    ...
    # Results:
    my $WorkspaceConfiguration =
      $DescribeWorkspaceConfigurationResponse->WorkspaceConfiguration;

 # Returns a L<Paws::Prometheus::DescribeWorkspaceConfigurationResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/aps/DescribeWorkspaceConfiguration>
...
find the IDs of your workspaces, use the ListWorkspaces
...
This class forms part of L<Paws>, documenting arguments for method DescribeWorkspaceConfiguration in L<Paws::Prometheus>
