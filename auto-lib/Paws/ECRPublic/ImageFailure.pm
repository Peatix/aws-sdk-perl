...
package Paws::ECRPublic::ImageFailure;
  use Moose;
  ...
  has ImageId => (is => 'ro', isa => 'Paws::ECRPublic::ImageIdentifier', request_name => 'imageId', traits => ['NameInRequest']);
...
As an example, if Att1 is expected to be a Paws::ECRPublic::ImageFailure object:

  $service_obj->Method(Att1 => { FailureCode => $value, ..., ImageId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ECRPublic::ImageFailure object:
