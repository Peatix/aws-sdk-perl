...
package Paws::ECRPublic::ImageIdentifier;
  use Moose;
...
Paws::ECRPublic::ImageIdentifier
...
As an example, if Att1 is expected to be a Paws::ECRPublic::ImageIdentifier object:

  $service_obj->Method(Att1 => { ImageDigest => $value, ..., ImageTag => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ECRPublic::ImageIdentifier object:
