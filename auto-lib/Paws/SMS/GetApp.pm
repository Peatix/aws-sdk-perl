...
package Paws::SMS::GetApp;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::SMS::GetAppResponse');
...
Paws::SMS::GetApp - Arguments for method GetApp on L<Paws::SMS>
...
=head1 SYNOPSIS
    ...
    my $GetAppResponse = $sms->GetApp(
      AppId => 'MyAppId',    # OPTIONAL
    );

    # Results:
    my $AppSummary   = $GetAppResponse->AppSummary;
    my $ServerGroups = $GetAppResponse->ServerGroups;
    my $Tags         = $GetAppResponse->Tags;

    # Returns a L<Paws::SMS::GetAppResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method GetApp in L<Paws::SMS>
