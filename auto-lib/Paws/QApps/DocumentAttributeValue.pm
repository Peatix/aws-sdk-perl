...
package Paws::QApps::DocumentAttributeValue;
  use Moose;
...
Paws::QApps::DocumentAttributeValue
...
As an example, if Att1 is expected to be a Paws::QApps::DocumentAttributeValue object:

  $service_obj->Method(Att1 => { DateValue => $value, ..., StringValue => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::QApps::DocumentAttributeValue object:
