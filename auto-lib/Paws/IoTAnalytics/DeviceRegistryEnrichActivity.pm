...
Paws::IoTAnalytics::DeviceRegistryEnrichActivity
...
As an example, if Att1 is expected to be a Paws::IoTAnalytics::DeviceRegistryEnrichActivity object:

  $service_obj->Method(Att1 => { Attribute => $value, ..., ThingName => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IoTAnalytics::DeviceRegistryEnrichActivity object:
