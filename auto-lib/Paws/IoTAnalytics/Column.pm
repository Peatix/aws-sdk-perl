...
package Paws::IoTAnalytics::Column;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::IoTAnalytics::Column object:

  $service_obj->Method(Att1 => { Name => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IoTAnalytics::Column object:
