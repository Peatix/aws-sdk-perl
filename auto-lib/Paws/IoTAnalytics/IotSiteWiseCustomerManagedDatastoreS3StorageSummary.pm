...
package Paws::IoTAnalytics::IotSiteWiseCustomerManagedDatastoreS3StorageSummary;
  use Moose;
...
Paws::IoTAnalytics::IotSiteWiseCustomerManagedDatastoreS3StorageSummary
...
As an example, if Att1 is expected to be a Paws::IoTAnalytics::IotSiteWiseCustomerManagedDatastoreS3StorageSummary object:

  $service_obj->Method(Att1 => { Bucket => $value, ..., KeyPrefix => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IoTAnalytics::IotSiteWiseCustomerManagedDatastoreS3StorageSummary object:
