...
package Paws::PinpointEmail::DeleteConfigurationSetEventDestination;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::PinpointEmail::DeleteConfigurationSetEventDestinationResponse');
1;
...
Paws::PinpointEmail::DeleteConfigurationSetEventDestination - Arguments for method DeleteConfigurationSetEventDestination on L<Paws::PinpointEmail>
...
This class forms part of L<Paws>, documenting arguments for method DeleteConfigurationSetEventDestination in L<Paws::PinpointEmail>
