...
package Paws::PinpointEmail::GetBlacklistReports;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/v1/email/deliverability-dashboard/blacklist-report');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::PinpointEmail::GetBlacklistReportsResponse');
1;
...
Paws::PinpointEmail::GetBlacklistReports - Arguments for method GetBlacklistReports on L<Paws::PinpointEmail>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::PinpointEmail::GetBlacklistReportsResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method GetBlacklistReports in L<Paws::PinpointEmail>
