...
package Paws::MediaConvert::MinTopRenditionSize;
  use Moose;
...
Paws::MediaConvert::MinTopRenditionSize
...
As an example, if Att1 is expected to be a Paws::MediaConvert::MinTopRenditionSize object:

  $service_obj->Method(Att1 => { Height => $value, ..., Width => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MediaConvert::MinTopRenditionSize object:
