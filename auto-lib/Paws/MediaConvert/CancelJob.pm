...
package Paws::MediaConvert::CancelJob;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::MediaConvert::CancelJobResponse');
1;
...
Paws::MediaConvert::CancelJob - Arguments for method CancelJob on L<Paws::MediaConvert>
...
=head1 SYNOPSIS
    ...
    my $CancelJobResponse = $mediaconvert->CancelJob(
      Id => 'My__string',
...
This class forms part of L<Paws>, documenting arguments for method CancelJob in L<Paws::MediaConvert>
