...
package Paws::MediaConvert::DashIsoGroupSettings;
  ...
  has ImageBasedTrickPlaySettings => (is => 'ro', isa => 'Paws::MediaConvert::DashIsoImageBasedTrickPlaySettings', request_name => 'imageBasedTrickPlaySettings', traits => ['NameInRequest']);
...
configuration, to have MediaConvert write this:
...
MediaConvert adds an entry in the .mpd manifest for each set of images
that you generate. A common application for these images is Roku trick
...
=head2 ImageBasedTrickPlaySettings => L<Paws::MediaConvert::DashIsoImageBasedTrickPlaySettings>
