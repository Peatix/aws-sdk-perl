...
package Paws::MediaConvert::HlsImageBasedTrickPlaySettings;
  use Moose;
...
Paws::MediaConvert::HlsImageBasedTrickPlaySettings
...
As an example, if Att1 is expected to be a Paws::MediaConvert::HlsImageBasedTrickPlaySettings object:

  $service_obj->Method(Att1 => { IntervalCadence => $value, ..., TileWidth => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MediaConvert::HlsImageBasedTrickPlaySettings object:
