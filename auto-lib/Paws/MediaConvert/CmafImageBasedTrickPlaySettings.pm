...
package Paws::MediaConvert::CmafImageBasedTrickPlaySettings;
  use Moose;
...
Paws::MediaConvert::CmafImageBasedTrickPlaySettings
...
As an example, if Att1 is expected to be a Paws::MediaConvert::CmafImageBasedTrickPlaySettings object:

  $service_obj->Method(Att1 => { IntervalCadence => $value, ..., TileWidth => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MediaConvert::CmafImageBasedTrickPlaySettings object:
