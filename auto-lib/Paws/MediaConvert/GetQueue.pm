...
package Paws::MediaConvert::GetQueue;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::MediaConvert::GetQueueResponse');
1;
...
Paws::MediaConvert::GetQueue - Arguments for method GetQueue on L<Paws::MediaConvert>
...
=head1 SYNOPSIS
    ...
    my $GetQueueResponse = $mediaconvert->GetQueue(
      Name => 'My__string',
    ...
    # Returns a L<Paws::MediaConvert::GetQueueResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method GetQueue in L<Paws::MediaConvert>
