...
package Paws::MediaConvert::Input;
  ...
  has VideoGenerator => (is => 'ro', isa => 'Paws::MediaConvert::InputVideoGenerator', request_name => 'videoGenerator', traits => ['NameInRequest']);
...
incomplete IMP, make sure to use *Supplemental IMPs* to specify any
...
=head2 VideoGenerator => L<Paws::MediaConvert::InputVideoGenerator>
