...
package Paws::MediaConvert::FlacSettings;
  use Moose;
...
Paws::MediaConvert::FlacSettings
...
As an example, if Att1 is expected to be a Paws::MediaConvert::FlacSettings object:

  $service_obj->Method(Att1 => { BitDepth => $value, ..., SampleRate => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MediaConvert::FlacSettings object:
...
you 2. In the API, valid values are between 1 and 8.
