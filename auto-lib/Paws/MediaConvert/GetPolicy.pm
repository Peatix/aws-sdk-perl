...
package Paws::MediaConvert::GetPolicy;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::MediaConvert::GetPolicyResponse');
1;
...
Paws::MediaConvert::GetPolicy - Arguments for method GetPolicy on L<Paws::MediaConvert>
...
=head1 SYNOPSIS
    ...
    my $GetPolicyResponse = $mediaconvert->GetPolicy();

    # Results:
    my $Policy = $GetPolicyResponse->Policy;

    # Returns a L<Paws::MediaConvert::GetPolicyResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/mediaconvert/GetPolicy>
...
This class forms part of L<Paws>, documenting arguments for method GetPolicy in L<Paws::MediaConvert>
