...
Paws::MediaConvert::H265QvbrSettings
...
As an example, if Att1 is expected to be a Paws::MediaConvert::H265QvbrSettings object:

  $service_obj->Method(Att1 => { MaxAverageBitrate => $value, ..., QvbrQualityLevelFineTune => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MediaConvert::H265QvbrSettings object:
