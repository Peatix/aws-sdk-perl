...
package Paws::MediaConvert::CreateJob;
  ...
  has JobEngineVersion => (is => 'ro', isa => 'Str', traits => ['NameInRequest'], request_name => 'jobEngineVersion');
...
'My__stringMin9Max19PatternAZ26EastWestCentralNorthSouthEastWest1912'
            ...
            FileInput =>
              'My__stringMax2048PatternS3Https',    # max: 2048; OPTIONAL
...
'My__stringMin14PatternS3BmpBMPPngPNGTgaTGAHttpsBmpBMPPngPNGTgaTGA'
            ...
            VideoGenerator => {
              Channels             => 1,    # min: 1, max: 32; OPTIONAL
              Duration             => 1,    # min: 50, max: 86400000; OPTIONAL
              FramerateDenominator => 1,    # min: 1, max: 1001; OPTIONAL
              FramerateNumerator   => 1,    # min: 1, max: 60000; OPTIONAL
...
'My__stringMin14PatternS3BmpBMPPngPNGTgaTGAHttpsBmpBMPPngPNGTgaTGA'
      ...
      JobEngineVersion      => 'My__string',                         # OPTIONAL
...
=head2 JobEngineVersion => Str

Use Job engine versions to run jobs for your production workflow on one
version, while you test and validate the latest version. To specify a
Job engine version: Enter a date in a YYYY-MM-DD format. For a list of
valid Job engine versions, submit a ListVersions request. To not
specify a Job engine version: Leave blank.
