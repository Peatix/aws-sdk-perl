...
package Paws::BedrockDataAutomation::UpdateDataAutomationProject;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'UpdateDataAutomationProject');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/data-automation-projects/{projectArn}/');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'PUT');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::BedrockDataAutomation::UpdateDataAutomationProjectResponse');
1;
...
Paws::BedrockDataAutomation::UpdateDataAutomationProject - Arguments for method UpdateDataAutomationProject on L<Paws::BedrockDataAutomation>

=head1 DESCRIPTION

This class represents the parameters used for calling the method UpdateDataAutomationProject on the
L<Data Automation for Amazon Bedrock|Paws::BedrockDataAutomation> service. Use the attributes of this class
as arguments to method UpdateDataAutomationProject.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to UpdateDataAutomationProject.

=head1 SYNOPSIS

    my $bedrock-data-automation = Paws->service('BedrockDataAutomation');
    my $UpdateDataAutomationProjectResponse =
      $bedrock -data-automation->UpdateDataAutomationProject(
    ...
    # Results:
    my $ProjectArn   = $UpdateDataAutomationProjectResponse->ProjectArn;
    my $ProjectStage = $UpdateDataAutomationProjectResponse->ProjectStage;
    my $Status       = $UpdateDataAutomationProjectResponse->Status;

# Returns a L<Paws::BedrockDataAutomation::UpdateDataAutomationProjectResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/bedrock-data-automation/UpdateDataAutomationProject>
...
This class forms part of L<Paws>, documenting arguments for method UpdateDataAutomationProject in L<Paws::BedrockDataAutomation>
