...
package Paws::PartnerCentralSelling::StartEngagementByAcceptingInvitationTaskResponse;
  use Moose;
...
Paws::PartnerCentralSelling::StartEngagementByAcceptingInvitationTaskResponse
...
Returns the identifier of the engagement invitation that was accepted
and used to create the opportunity.
...
Returns the original opportunity identifier passed in the request. This
is the unique identifier for the opportunity.
