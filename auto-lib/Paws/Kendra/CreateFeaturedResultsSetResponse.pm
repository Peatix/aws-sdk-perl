...
package Paws::Kendra::CreateFeaturedResultsSetResponse;
  use Moose;
...
Paws::Kendra::CreateFeaturedResultsSetResponse
...
set is active or inactive, when the featured results set was created,
and more.
