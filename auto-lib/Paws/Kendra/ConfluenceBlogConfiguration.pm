...
package Paws::Kendra::ConfluenceBlogConfiguration;
  use Moose;
  has BlogFieldMappings => (is => 'ro', isa => 'ArrayRef[Paws::Kendra::ConfluenceBlogToIndexFieldMapping]');
...
Paws::Kendra::ConfluenceBlogConfiguration
...
As an example, if Att1 is expected to be a Paws::Kendra::ConfluenceBlogConfiguration object:

  $service_obj->Method(Att1 => { BlogFieldMappings => $value, ..., BlogFieldMappings => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Kendra::ConfluenceBlogConfiguration object:
