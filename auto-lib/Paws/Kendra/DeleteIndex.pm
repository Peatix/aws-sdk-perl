...
package Paws::Kendra::DeleteIndex;
  use Moose;
...
Paws::Kendra::DeleteIndex - Arguments for method DeleteIndex on L<Paws::Kendra>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/kendra/DeleteIndex>
...
This class forms part of L<Paws>, documenting arguments for method DeleteIndex in L<Paws::Kendra>
