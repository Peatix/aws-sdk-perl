...
package Paws::RUM::BatchCreateRumMetricDefinitionsError;
  use Moose;
...
Paws::RUM::BatchCreateRumMetricDefinitionsError
...
As an example, if Att1 is expected to be a Paws::RUM::BatchCreateRumMetricDefinitionsError object:

  $service_obj->Method(Att1 => { ErrorCode => $value, ..., MetricDefinition => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::RUM::BatchCreateRumMetricDefinitionsError object:
