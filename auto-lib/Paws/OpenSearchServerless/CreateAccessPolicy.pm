...
package Paws::OpenSearchServerless::CreateAccessPolicy;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::OpenSearchServerless::CreateAccessPolicyResponse');
...
Paws::OpenSearchServerless::CreateAccessPolicy - Arguments for method CreateAccessPolicy on L<Paws::OpenSearchServerless>
...
=head1 SYNOPSIS
    ...
    my $CreateAccessPolicyResponse = $aoss->CreateAccessPolicy(
      Name        => 'MyPolicyName',
    ...
    # Results:
    my $AccessPolicyDetail = $CreateAccessPolicyResponse->AccessPolicyDetail;

   # Returns a L<Paws::OpenSearchServerless::CreateAccessPolicyResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/aoss/CreateAccessPolicy>
...
This class forms part of L<Paws>, documenting arguments for method CreateAccessPolicy in L<Paws::OpenSearchServerless>
