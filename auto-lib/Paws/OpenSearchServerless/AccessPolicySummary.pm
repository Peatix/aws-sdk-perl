...
package Paws::OpenSearchServerless::AccessPolicySummary;
  use Moose;
...
Paws::OpenSearchServerless::AccessPolicySummary
...
As an example, if Att1 is expected to be a Paws::OpenSearchServerless::AccessPolicySummary object:

  $service_obj->Method(Att1 => { CreatedDate => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::OpenSearchServerless::AccessPolicySummary object:
