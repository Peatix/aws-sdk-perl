...
package Paws::OpenSearchServerless::CreateCollectionDetail;
  use Moose;
...
Paws::OpenSearchServerless::CreateCollectionDetail
...
As an example, if Att1 is expected to be a Paws::OpenSearchServerless::CreateCollectionDetail object:

  $service_obj->Method(Att1 => { Arn => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::OpenSearchServerless::CreateCollectionDetail object:
