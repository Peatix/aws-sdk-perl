...
package Paws::FinspaceData::S3Location;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::FinspaceData::S3Location object:

  $service_obj->Method(Att1 => { Bucket => $value, ..., Key => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::FinspaceData::S3Location object:
