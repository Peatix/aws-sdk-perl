...
package Paws::EntityResolution::CreateSchemaMapping;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'CreateSchemaMapping');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/schemas');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::EntityResolution::CreateSchemaMappingOutput');
1;
...
Paws::EntityResolution::CreateSchemaMapping - Arguments for method CreateSchemaMapping on L<Paws::EntityResolution>

=head1 DESCRIPTION

This class represents the parameters used for calling the method CreateSchemaMapping on the
L<AWS EntityResolution|Paws::EntityResolution> service. Use the attributes of this class
as arguments to method CreateSchemaMapping.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to CreateSchemaMapping.

=head1 SYNOPSIS

    my $entityresolution = Paws->service('EntityResolution');
    my $CreateSchemaMappingOutput = $entityresolution->CreateSchemaMapping(
      MappedInputFields => [
        {
    ...
    # Results:
    my $Description       = $CreateSchemaMappingOutput->Description;
    my $MappedInputFields = $CreateSchemaMappingOutput->MappedInputFields;
    my $SchemaArn         = $CreateSchemaMappingOutput->SchemaArn;
    my $SchemaName        = $CreateSchemaMappingOutput->SchemaName;

    # Returns a L<Paws::EntityResolution::CreateSchemaMappingOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/entityresolution/CreateSchemaMapping>
...
This class forms part of L<Paws>, documenting arguments for method CreateSchemaMapping in L<Paws::EntityResolution>
