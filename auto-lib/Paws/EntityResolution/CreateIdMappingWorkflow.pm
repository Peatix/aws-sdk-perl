...
package Paws::EntityResolution::CreateIdMappingWorkflow;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'CreateIdMappingWorkflow');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/idmappingworkflows');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::EntityResolution::CreateIdMappingWorkflowOutput');
1;
...
Paws::EntityResolution::CreateIdMappingWorkflow - Arguments for method CreateIdMappingWorkflow on L<Paws::EntityResolution>

=head1 DESCRIPTION

This class represents the parameters used for calling the method CreateIdMappingWorkflow on the
L<AWS EntityResolution|Paws::EntityResolution> service. Use the attributes of this class
as arguments to method CreateIdMappingWorkflow.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to CreateIdMappingWorkflow.

=head1 SYNOPSIS

    my $entityresolution = Paws->service('EntityResolution');
    my $CreateIdMappingWorkflowOutput =
    ...
    # Results:
    my $Description = $CreateIdMappingWorkflowOutput->Description;
    my $IdMappingTechniques =
      $CreateIdMappingWorkflowOutput->IdMappingTechniques;
    my $InputSourceConfig  = $CreateIdMappingWorkflowOutput->InputSourceConfig;
    my $OutputSourceConfig = $CreateIdMappingWorkflowOutput->OutputSourceConfig;
    my $RoleArn            = $CreateIdMappingWorkflowOutput->RoleArn;
    my $WorkflowArn        = $CreateIdMappingWorkflowOutput->WorkflowArn;
    my $WorkflowName       = $CreateIdMappingWorkflowOutput->WorkflowName;

    # Returns a L<Paws::EntityResolution::CreateIdMappingWorkflowOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/entityresolution/CreateIdMappingWorkflow>
...
A list of C<IdMappingWorkflowOutputSource> objects, each of which
contains fields C<OutputS3Path> and C<Output>.
...
The name of the workflow. There can't be multiple C<IdMappingWorkflows>
with the same name.
...
This class forms part of L<Paws>, documenting arguments for method CreateIdMappingWorkflow in L<Paws::EntityResolution>
