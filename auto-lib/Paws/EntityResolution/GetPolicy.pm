...
package Paws::EntityResolution::GetPolicy;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::EntityResolution::GetPolicyOutput');
1;
...
Paws::EntityResolution::GetPolicy - Arguments for method GetPolicy on L<Paws::EntityResolution>
...
=head1 SYNOPSIS
    ...
    my $GetPolicyOutput = $entityresolution->GetPolicy(
      Arn => 'MyVeniceGlobalArn',

    );

    # Results:
    my $Arn    = $GetPolicyOutput->Arn;
    my $Policy = $GetPolicyOutput->Policy;
    my $Token  = $GetPolicyOutput->Token;

    # Returns a L<Paws::EntityResolution::GetPolicyOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/entityresolution/GetPolicy>
...
This class forms part of L<Paws>, documenting arguments for method GetPolicy in L<Paws::EntityResolution>
