...
package Paws::EntityResolution::CreateIdNamespaceOutput;
  use Moose;
...
Paws::EntityResolution::CreateIdNamespaceOutput
...
C<inputSourceConfig> on your behalf as part of the workflow run.
