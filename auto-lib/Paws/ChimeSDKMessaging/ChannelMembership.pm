...
package Paws::ChimeSDKMessaging::ChannelMembership;
  use Moose;
...
Paws::ChimeSDKMessaging::ChannelMembership
...
As an example, if Att1 is expected to be a Paws::ChimeSDKMessaging::ChannelMembership object:

  $service_obj->Method(Att1 => { ChannelArn => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ChimeSDKMessaging::ChannelMembership object:
