...
package Paws::ChimeSDKMessaging::ListChannelBans;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ChimeSDKMessaging::ListChannelBansResponse');
1;
...
Paws::ChimeSDKMessaging::ListChannelBans - Arguments for method ListChannelBans on L<Paws::ChimeSDKMessaging>
...
=head1 SYNOPSIS
    ...
    my $ListChannelBansResponse = $messaging -chime->ListChannelBans(
    ...
    # Returns a L<Paws::ChimeSDKMessaging::ListChannelBansResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/messaging-chime/ListChannelBans>
...
This class forms part of L<Paws>, documenting arguments for method ListChannelBans in L<Paws::ChimeSDKMessaging>
