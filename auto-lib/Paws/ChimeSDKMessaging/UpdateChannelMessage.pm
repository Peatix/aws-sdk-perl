...
package Paws::ChimeSDKMessaging::UpdateChannelMessage;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ChimeSDKMessaging::UpdateChannelMessageResponse');
1;
...
Paws::ChimeSDKMessaging::UpdateChannelMessage - Arguments for method UpdateChannelMessage on L<Paws::ChimeSDKMessaging>
...
=head1 SYNOPSIS
    ...
    my $UpdateChannelMessageResponse = $messaging -chime->UpdateChannelMessage(
    ...
    my $Status       = $UpdateChannelMessageResponse->Status;
    my $SubChannelId = $UpdateChannelMessageResponse->SubChannelId;

    # Returns a L<Paws::ChimeSDKMessaging::UpdateChannelMessageResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/messaging-chime/UpdateChannelMessage>
...
This class forms part of L<Paws>, documenting arguments for method UpdateChannelMessage in L<Paws::ChimeSDKMessaging>
