...
package Paws::ChimeSDKMessaging::CreateChannelMembership;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ChimeSDKMessaging::CreateChannelMembershipResponse');
1;
...
Paws::ChimeSDKMessaging::CreateChannelMembership - Arguments for method CreateChannelMembership on L<Paws::ChimeSDKMessaging>
...
=head1 SYNOPSIS
    ...
    my $CreateChannelMembershipResponse =
      $messaging -chime->CreateChannelMembership(
    ...
    my $SubChannelId = $CreateChannelMembershipResponse->SubChannelId;

 # Returns a L<Paws::ChimeSDKMessaging::CreateChannelMembershipResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/messaging-chime/CreateChannelMembership>
...
The C<AppInstanceUserArn> of the member you want to add to the channel.
...
This class forms part of L<Paws>, documenting arguments for method CreateChannelMembership in L<Paws::ChimeSDKMessaging>
