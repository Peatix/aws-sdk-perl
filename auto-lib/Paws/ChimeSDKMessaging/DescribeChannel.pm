...
package Paws::ChimeSDKMessaging::DescribeChannel;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ChimeSDKMessaging::DescribeChannelResponse');
1;
...
Paws::ChimeSDKMessaging::DescribeChannel - Arguments for method DescribeChannel on L<Paws::ChimeSDKMessaging>
...
=head1 SYNOPSIS
    ...
    my $DescribeChannelResponse = $messaging -chime->DescribeChannel(
    ...
    # Returns a L<Paws::ChimeSDKMessaging::DescribeChannelResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/messaging-chime/DescribeChannel>
...
This class forms part of L<Paws>, documenting arguments for method DescribeChannel in L<Paws::ChimeSDKMessaging>
