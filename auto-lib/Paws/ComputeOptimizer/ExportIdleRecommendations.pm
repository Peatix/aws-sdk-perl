...
package Paws::ComputeOptimizer::ExportIdleRecommendations;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'ExportIdleRecommendations');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ComputeOptimizer::ExportIdleRecommendationsResponse');
...
Paws::ComputeOptimizer::ExportIdleRecommendations - Arguments for method ExportIdleRecommendations on L<Paws::ComputeOptimizer>

=head1 DESCRIPTION

This class represents the parameters used for calling the method ExportIdleRecommendations on the
L<AWS Compute Optimizer|Paws::ComputeOptimizer> service. Use the attributes of this class
as arguments to method ExportIdleRecommendations.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to ExportIdleRecommendations.

=head1 SYNOPSIS

    my $compute-optimizer = Paws->service('ComputeOptimizer');
    my $ExportIdleRecommendationsResponse =
    ...
    # Results:
    my $JobId         = $ExportIdleRecommendationsResponse->JobId;
    my $S3Destination = $ExportIdleRecommendationsResponse->S3Destination;

# Returns a L<Paws::ComputeOptimizer::ExportIdleRecommendationsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/compute-optimizer/ExportIdleRecommendations>
...
This class forms part of L<Paws>, documenting arguments for method ExportIdleRecommendations in L<Paws::ComputeOptimizer>
