...
package Paws::ComputeOptimizer::ExportEC2InstanceRecommendations;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'ExportEC2InstanceRecommendations');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ComputeOptimizer::ExportEC2InstanceRecommendationsResponse');
...
Paws::ComputeOptimizer::ExportEC2InstanceRecommendations - Arguments for method ExportEC2InstanceRecommendations on L<Paws::ComputeOptimizer>

=head1 DESCRIPTION

This class represents the parameters used for calling the method ExportEC2InstanceRecommendations on the
L<AWS Compute Optimizer|Paws::ComputeOptimizer> service. Use the attributes of this class
as arguments to method ExportEC2InstanceRecommendations.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to ExportEC2InstanceRecommendations.

=head1 SYNOPSIS

    my $compute-optimizer = Paws->service('ComputeOptimizer');
    my $ExportEC2InstanceRecommendationsResponse =
    ...
    # Results:
    my $JobId = $ExportEC2InstanceRecommendationsResponse->JobId;
    my $S3Destination =
      $ExportEC2InstanceRecommendationsResponse->S3Destination;

# Returns a L<Paws::ComputeOptimizer::ExportEC2InstanceRecommendationsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/compute-optimizer/ExportEC2InstanceRecommendations>
...
This class forms part of L<Paws>, documenting arguments for method ExportEC2InstanceRecommendations in L<Paws::ComputeOptimizer>
