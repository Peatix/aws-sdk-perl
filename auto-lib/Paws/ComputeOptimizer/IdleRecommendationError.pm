...
package Paws::ComputeOptimizer::IdleRecommendationError;
  use Moose;
...
Paws::ComputeOptimizer::IdleRecommendationError
...
As an example, if Att1 is expected to be a Paws::ComputeOptimizer::IdleRecommendationError object:

  $service_obj->Method(Att1 => { Code => $value, ..., ResourceType => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ComputeOptimizer::IdleRecommendationError object:
