...
package Paws::ComputeOptimizer::ECSServiceUtilizationMetric;
  use Moose;
...
Paws::ComputeOptimizer::ECSServiceUtilizationMetric
...
As an example, if Att1 is expected to be a Paws::ComputeOptimizer::ECSServiceUtilizationMetric object:

  $service_obj->Method(Att1 => { Name => $value, ..., Value => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ComputeOptimizer::ECSServiceUtilizationMetric object:
...
C<Cpu> E<mdash> The amount of CPU capacity that's used in the service.

=item *

C<Memory> E<mdash> The amount of memory that's used in the service.
