...
package Paws::Finspace::GetEnvironment;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Finspace::GetEnvironmentResponse');
1;
...
Paws::Finspace::GetEnvironment - Arguments for method GetEnvironment on L<Paws::Finspace>
...
This class forms part of L<Paws>, documenting arguments for method GetEnvironment in L<Paws::Finspace>
