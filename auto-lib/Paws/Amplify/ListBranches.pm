...
package Paws::Amplify::ListBranches;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Amplify::ListBranchesResult');
1;
...
Paws::Amplify::ListBranches - Arguments for method ListBranches on L<Paws::Amplify>
...
This class forms part of L<Paws>, documenting arguments for method ListBranches in L<Paws::Amplify>
