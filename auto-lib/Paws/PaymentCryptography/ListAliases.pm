...
package Paws::PaymentCryptography::ListAliases;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::PaymentCryptography::ListAliasesOutput');
...
Paws::PaymentCryptography::ListAliases - Arguments for method ListAliases on L<Paws::PaymentCryptography>
...
=head1 SYNOPSIS
    ...
    my $ListAliasesOutput = $controlplane . payment-cryptography->ListAliases(
    ...
    # Returns a L<Paws::PaymentCryptography::ListAliasesOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/controlplane.payment-cryptography/ListAliases>
...
The C<keyARN> for which you want to list all aliases.
...
This class forms part of L<Paws>, documenting arguments for method ListAliases in L<Paws::PaymentCryptography>
