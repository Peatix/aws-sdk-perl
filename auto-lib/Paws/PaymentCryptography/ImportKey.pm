...
package Paws::PaymentCryptography::ImportKey;
  use Moose;
  has Enabled => (is => 'ro', isa => 'Bool');
  has KeyCheckValueAlgorithm => (is => 'ro', isa => 'Str');
  has KeyMaterial => (is => 'ro', isa => 'Paws::PaymentCryptography::ImportKeyMaterial', required => 1);
  has Tags => (is => 'ro', isa => 'ArrayRef[Paws::PaymentCryptography::Tag]');

  use MooseX::ClassAttribute;

  class_has _api_call => (isa => 'Str', is => 'ro', default => 'ImportKey');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::PaymentCryptography::ImportKeyOutput');
...
Paws::PaymentCryptography::ImportKey - Arguments for method ImportKey on L<Paws::PaymentCryptography>

=head1 DESCRIPTION

This class represents the parameters used for calling the method ImportKey on the
L<Payment Cryptography Control Plane|Paws::PaymentCryptography> service. Use the attributes of this class
as arguments to method ImportKey.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to ImportKey.

=head1 SYNOPSIS

    my $controlplane.payment-cryptography = Paws->service('PaymentCryptography');
    my $ImportKeyOutput = $controlplane . payment-cryptography->ImportKey(
      KeyMaterial => {
        DiffieHellmanTr31KeyBlock => {
          ...
          WrappedKeyBlock      => 'MyTr31WrappedKeyBlock',  # min: 56, max: 9984

        },    # OPTIONAL
        KeyCryptogram => {
          Exportable    => 1,
          ImportToken   => 'MyImportTokenId',
          KeyAttributes => {
          ...
          WrappedKeyCryptogram => 'MyWrappedKeyCryptogram', # min: 16, max: 4096
        ...
        Tr34KeyBlock => {
          ...
          SigningKeyCertificate => 'MyCertificateType',   # min: 1, max: 32768
          WrappedKeyBlock       => 'MyTr34WrappedKeyBlock',  # min: 2, max: 4096
          RandomNonce           =>
    ...
    # Results:
    my $Key = $ImportKeyOutput->Key;

    # Returns a L<Paws::PaymentCryptography::ImportKeyOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/controlplane.payment-cryptography/ImportKey>
...
=head2 B<REQUIRED> KeyMaterial => L<Paws::PaymentCryptography::ImportKeyMaterial>
...
This class forms part of L<Paws>, documenting arguments for method ImportKey in L<Paws::PaymentCryptography>
