...
package Paws::PaymentCryptography::ExportDiffieHellmanTr31KeyBlock;
  use Moose;
...
Paws::PaymentCryptography::ExportDiffieHellmanTr31KeyBlock
...
As an example, if Att1 is expected to be a Paws::PaymentCryptography::ExportDiffieHellmanTr31KeyBlock object:

  $service_obj->Method(Att1 => { CertificateAuthorityPublicKeyIdentifier => $value, ..., PublicKeyCertificate => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::PaymentCryptography::ExportDiffieHellmanTr31KeyBlock object:
