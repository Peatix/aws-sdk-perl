...
package Paws::Athena::ListEngineVersions;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Athena::ListEngineVersionsOutput');
...
Paws::Athena::ListEngineVersions - Arguments for method ListEngineVersions on L<Paws::Athena>
...
=head1 SYNOPSIS
    ...
    my $ListEngineVersionsOutput = $athena->ListEngineVersions(
      MaxResults => 1,            # OPTIONAL
      NextToken  => 'MyToken',    # OPTIONAL
    );

    # Results:
    my $EngineVersions = $ListEngineVersionsOutput->EngineVersions;
    my $NextToken      = $ListEngineVersionsOutput->NextToken;

    # Returns a L<Paws::Athena::ListEngineVersionsOutput> object.
...
This class forms part of L<Paws>, documenting arguments for method ListEngineVersions in L<Paws::Athena>
