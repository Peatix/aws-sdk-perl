package Paws::RDS;
  ...
  sub CreateBlueGreenDeployment {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::CreateBlueGreenDeployment', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub CreateCustomDBEngineVersion {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::CreateCustomDBEngineVersion', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub CreateDBCluster {
    my $self = shift;
  ...
  sub CreateDBShardGroup {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::CreateDBShardGroup', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub CreateIntegration {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::CreateIntegration', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub CreateTenantDatabase {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::CreateTenantDatabase', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DeleteBlueGreenDeployment {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::DeleteBlueGreenDeployment', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DeleteCustomDBEngineVersion {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::DeleteCustomDBEngineVersion', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DeleteDBCluster {
    my $self = shift;
  ...
  sub DeleteDBClusterAutomatedBackup {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::DeleteDBClusterAutomatedBackup', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DeleteDBShardGroup {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::DeleteDBShardGroup', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DeleteIntegration {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::DeleteIntegration', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DeleteTenantDatabase {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::DeleteTenantDatabase', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeBlueGreenDeployments {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::DescribeBlueGreenDeployments', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeDBClusterAutomatedBackups {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::DescribeDBClusterAutomatedBackups', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeDBRecommendations {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::DescribeDBRecommendations', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeDBShardGroups {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::DescribeDBShardGroups', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeDBSnapshotTenantDatabases {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::DescribeDBSnapshotTenantDatabases', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeIntegrations {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::DescribeIntegrations', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeTenantDatabases {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::DescribeTenantDatabases', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DisableHttpEndpoint {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::DisableHttpEndpoint', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub EnableHttpEndpoint {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::EnableHttpEndpoint', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ModifyActivityStream {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::ModifyActivityStream', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ModifyCustomDBEngineVersion {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::ModifyCustomDBEngineVersion', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ModifyDBCluster {
    my $self = shift;
  ...
  sub ModifyDBRecommendation {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::ModifyDBRecommendation', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ModifyDBShardGroup {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::ModifyDBShardGroup', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ModifyIntegration {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::ModifyIntegration', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ModifyTenantDatabase {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::ModifyTenantDatabase', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub RebootDBCluster {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::RebootDBCluster', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub RebootDBShardGroup {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::RebootDBShardGroup', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub SwitchoverBlueGreenDeployment {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::SwitchoverBlueGreenDeployment', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub SwitchoverGlobalCluster {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::SwitchoverGlobalCluster', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub SwitchoverReadReplica {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RDS::SwitchoverReadReplica', @_);
    return $self->caller->do_call($self, $call_object);
  }
  
  sub DescribeAllBlueGreenDeployments {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->DescribeBlueGreenDeployments(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->Marker) {
        $next_result = $self->DescribeBlueGreenDeployments(@_, Marker => $next_result->Marker);
        push @{ $result->BlueGreenDeployments }, @{ $next_result->BlueGreenDeployments };
      }
      return $result;
    } else {
      while ($result->Marker) {
        $callback->($_ => 'BlueGreenDeployments') foreach (@{ $result->BlueGreenDeployments });
        $result = $self->DescribeBlueGreenDeployments(@_, Marker => $result->Marker);
      }
      $callback->($_ => 'BlueGreenDeployments') foreach (@{ $result->BlueGreenDeployments });
    }
  ...
  sub DescribeAllDBClusterAutomatedBackups {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->DescribeDBClusterAutomatedBackups(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->Marker) {
        $next_result = $self->DescribeDBClusterAutomatedBackups(@_, Marker => $next_result->Marker);
        push @{ $result->DBClusterAutomatedBackups }, @{ $next_result->DBClusterAutomatedBackups };
      }
      return $result;
    } else {
      while ($result->Marker) {
        $callback->($_ => 'DBClusterAutomatedBackups') foreach (@{ $result->DBClusterAutomatedBackups });
        $result = $self->DescribeDBClusterAutomatedBackups(@_, Marker => $result->Marker);
      }
      $callback->($_ => 'DBClusterAutomatedBackups') foreach (@{ $result->DBClusterAutomatedBackups });
    }
  ...
  sub DescribeAllDBRecommendations {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->DescribeDBRecommendations(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->Marker) {
        $next_result = $self->DescribeDBRecommendations(@_, Marker => $next_result->Marker);
        push @{ $result->DBRecommendations }, @{ $next_result->DBRecommendations };
      }
      return $result;
    } else {
      while ($result->Marker) {
        $callback->($_ => 'DBRecommendations') foreach (@{ $result->DBRecommendations });
        $result = $self->DescribeDBRecommendations(@_, Marker => $result->Marker);
      }
      $callback->($_ => 'DBRecommendations') foreach (@{ $result->DBRecommendations });
    }
  ...
  sub DescribeAllDBSnapshotTenantDatabases {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->DescribeDBSnapshotTenantDatabases(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->Marker) {
        $next_result = $self->DescribeDBSnapshotTenantDatabases(@_, Marker => $next_result->Marker);
        push @{ $result->DBSnapshotTenantDatabases }, @{ $next_result->DBSnapshotTenantDatabases };
      }
      return $result;
    } else {
      while ($result->Marker) {
        $callback->($_ => 'DBSnapshotTenantDatabases') foreach (@{ $result->DBSnapshotTenantDatabases });
        $result = $self->DescribeDBSnapshotTenantDatabases(@_, Marker => $result->Marker);
      }
      $callback->($_ => 'DBSnapshotTenantDatabases') foreach (@{ $result->DBSnapshotTenantDatabases });
    }
  ...
  sub DescribeAllIntegrations {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->DescribeIntegrations(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->Marker) {
        $next_result = $self->DescribeIntegrations(@_, Marker => $next_result->Marker);
        push @{ $result->Integrations }, @{ $next_result->Integrations };
      }
      return $result;
    } else {
      while ($result->Marker) {
        $callback->($_ => 'Integrations') foreach (@{ $result->Integrations });
        $result = $self->DescribeIntegrations(@_, Marker => $result->Marker);
      }
      $callback->($_ => 'Integrations') foreach (@{ $result->Integrations });
    }
  ...
  sub DescribeAllTenantDatabases {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->DescribeTenantDatabases(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->Marker) {
        $next_result = $self->DescribeTenantDatabases(@_, Marker => $next_result->Marker);
        push @{ $result->TenantDatabases }, @{ $next_result->TenantDatabases };
      }
      return $result;
    } else {
      while ($result->Marker) {
        $callback->($_ => 'TenantDatabases') foreach (@{ $result->TenantDatabases });
        $result = $self->DescribeTenantDatabases(@_, Marker => $result->Marker);
      }
      $callback->($_ => 'TenantDatabases') foreach (@{ $result->TenantDatabases });
    }
...
PostgreSQL, Microsoft SQL Server, Oracle, Db2, or Amazon Aurora
database server. These capabilities mean that the code, applications,
and tools you already use today with your existing databases work with
Amazon RDS without modification. Amazon RDS automatically backs up your
...
in the I<Amazon EC2 User Guide>, the blog EC2-Classic Networking is
...
call the C<CopyDBClusterSnapshot> operation is the destination Amazon
...
C<KmsKeyId> - The Amazon Web Services Key Management System (Amazon Web
Services KMS) key identifier for the key to use to encrypt the copy of
...
C<SourceDBClusterSnapshotIdentifier> in the presigned URL.
...
C<CopyDBSnapshot> operation is the destination Amazon Web Services
...
=head2 CreateBlueGreenDeployment

=over

=item BlueGreenDeploymentName => Str

=item Source => Str

=item [Tags => ArrayRef[L<Paws::RDS::Tag>]]

=item [TargetAllocatedStorage => Int]

=item [TargetDBClusterParameterGroupName => Str]

=item [TargetDBInstanceClass => Str]

=item [TargetDBParameterGroupName => Str]

=item [TargetEngineVersion => Str]

=item [TargetIops => Int]

=item [TargetStorageThroughput => Int]

=item [TargetStorageType => Str]

=item [UpgradeTargetStorageConfig => Bool]


=back

Each argument is described in detail in: L<Paws::RDS::CreateBlueGreenDeployment>

Returns: a L<Paws::RDS::CreateBlueGreenDeploymentResponse> instance
...
=head2 CreateCustomDBEngineVersion
...
=item [DatabaseInstallationFilesS3BucketName => Str]

=item [DatabaseInstallationFilesS3Prefix => Str]
...
=item [SourceCustomDbEngineVersionIdentifier => Str]

=item [Tags => ArrayRef[L<Paws::RDS::Tag>]]

=item [UseAwsProvidedLatestImage => Bool]


=back

Each argument is described in detail in: L<Paws::RDS::CreateCustomDBEngineVersion>

Returns: a L<Paws::RDS::DBEngineVersion> instance
...
=item [ClusterScalabilityType => Str]

=item [CopyTagsToSnapshot => Bool]

=item [DatabaseInsightsMode => Str]

=item [DatabaseName => Str]

=item [DBClusterInstanceClass => Str]
...
=item [EnableLimitlessDatabase => Bool]

=item [EnableLocalWriteForwarding => Bool]

=item [EnablePerformanceInsights => Bool]

=item [EngineLifecycleSupport => Str]
...
=item [ManageMasterUserPassword => Bool]

=item [MasterUsername => Str]

=item [MasterUserPassword => Str]

=item [MasterUserSecretKmsKeyId => Str]
...
=item [RdsCustomClusterConfiguration => L<Paws::RDS::RdsCustomClusterConfiguration>]

=item [ReplicationSourceIdentifier => Str]

=item [ScalingConfiguration => L<Paws::RDS::ScalingConfiguration>]

=item [ServerlessV2ScalingConfiguration => L<Paws::RDS::ServerlessV2ScalingConfiguration>]
...
cluster using the CreateDBInstance
...
You can use the C<ReplicationSourceIdentifier> parameter to create an
...
about Amazon Aurora, see What is Amazon Aurora?
(https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/CHAP_AuroraOverview.html)
in the I<Amazon Aurora User Guide>.

You can also use the C<ReplicationSourceIdentifier> parameter to create
...
clusters, see Multi-AZ DB cluster deployments
(https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/multi-az-db-clusters-concepts.html)
in the I<Amazon RDS User Guide>.
...
with your DB cluster using C<ModifyDBCluster>.
...
C<DescribeDBClusterParameters> operation to verify that your DB cluster
...
=item [CustomIamInstanceProfile => Str]
...
=item [DedicatedLogVolume => Bool]

=item [DeletionProtection => Bool]

=item [Domain => Str]

=item [DomainAuthSecretArn => Str]

=item [DomainDnsIps => ArrayRef[Str|Undef]]
...
cluster, see Creating an Amazon Aurora DB cluster
...
=item [UpgradeStorageConfig => Bool]
...
PostgreSQL, or SQL Server. You can create a read replica for a Multi-AZ
DB cluster running MySQL or PostgreSQL. For more information, see
...
for an Aurora DB cluster, use the C<CreateDBInstance> operation.
...
creating it using C<ModifyDBParameterGroup>. Once you've created a DB
parameter group, you need to associate it with your DB instance using
C<ModifyDBInstance>. When you associate a new DB parameter group with a
...
=head2 CreateDBShardGroup

=over

=item DBClusterIdentifier => Str

=item DBShardGroupIdentifier => Str

=item MaxACU => Num

=item [ComputeRedundancy => Int]
...
Each argument is described in detail in: L<Paws::RDS::CreateDBShardGroup>

Returns: a L<Paws::RDS::DBShardGroup> instance
...
C<SourceType> = C<db-instance> and C<SourceIds> = C<myDBInstance1>, you
are notified of all the C<db-instance> events for the specified source.
If you specify a C<SourceType> but do not specify C<SourceIds>, you
...
C<SourceIds>, you are notified of events generated from all RDS sources
...
engines, see Subscribing to Amazon RDS event notification
...
=item [AdditionalEncryptionContext => L<Paws::RDS::EncryptionContextMap>]
...
Each argument is described in detail in: L<Paws::RDS::CreateIntegration>

Returns: a L<Paws::RDS::Integration> instance
...
Each argument is described in detail in: L<Paws::RDS::CreateTenantDatabase>

Returns: a L<Paws::RDS::CreateTenantDatabaseResult> instance
...
=head2 DeleteBlueGreenDeployment

=over

=item BlueGreenDeploymentIdentifier => Str

=item [DeleteTarget => Bool]


=back

Each argument is described in detail in: L<Paws::RDS::DeleteBlueGreenDeployment>

Returns: a L<Paws::RDS::DeleteBlueGreenDeploymentResponse> instance
...
=head2 DeleteCustomDBEngineVersion
...
Each argument is described in detail in: L<Paws::RDS::DeleteCustomDBEngineVersion>
...
CEVs isn't integrated with Amazon Web Services CloudTrail. If you turn
on data logging for Amazon RDS in CloudTrail, calls to the
C<DeleteCustomDbEngineVersion> event aren't logged. However, you might
...
C<DeleteCustomDbEngineVersion> event.
...
=head2 DeleteDBClusterAutomatedBackup

=over

=item DbClusterResourceId => Str


=back

Each argument is described in detail in: L<Paws::RDS::DeleteDBClusterAutomatedBackup>

Returns: a L<Paws::RDS::DeleteDBClusterAutomatedBackupResult> instance

Deletes automated backups using the C<DbClusterResourceId> value of the
...
instance is C<deleting> until the DB snapshot is created. This
operation can't be canceled or reverted after it begins. To monitor the
status of this operation, use C<DescribeDBInstance>.
...
C<PromoteReadReplicaDBCluster> operation to promote the DB cluster so
that it's no longer a read replica. After the promotion completes, use
the C<DeleteDBInstance> operation to delete the final instance in the
DB cluster.
...
Each argument is described in detail in: L<Paws::RDS::DeleteDBShardGroup>
...
Each argument is described in detail in: L<Paws::RDS::DeleteIntegration>
...
Each argument is described in detail in: L<Paws::RDS::DeleteTenantDatabase>

Returns: a L<Paws::RDS::DeleteTenantDatabaseResult> instance
...
=head2 DescribeBlueGreenDeployments
...
Each argument is described in detail in: L<Paws::RDS::DescribeBlueGreenDeployments>

Returns: a L<Paws::RDS::DescribeBlueGreenDeploymentsResponse> instance
...
=head2 DescribeDBClusterAutomatedBackups
...
Each argument is described in detail in: L<Paws::RDS::DescribeDBClusterAutomatedBackups>

Returns: a L<Paws::RDS::DBClusterAutomatedBackupMessage> instance
...
C<DescribeDBClusterAutomatedBackups> and C<DescribeDBClusters>
operations.
...
authorized to copy or restore the manual DB cluster snapshot. If C<all>
is included in the list of values for the C<restore> attribute, then
...
snapshot public or private, use the C<ModifyDBClusterSnapshotAttribute>
API action.
...
=head2 DescribeDBRecommendations

=over

=item [Filters => ArrayRef[L<Paws::RDS::Filter>]]

=item [LastUpdatedAfter => Str]

=item [LastUpdatedBefore => Str]
...
Each argument is described in detail in: L<Paws::RDS::DescribeDBRecommendations>

Returns: a L<Paws::RDS::DBRecommendationsMessage> instance
...
Each argument is described in detail in: L<Paws::RDS::DescribeDBShardGroups>

Returns: a L<Paws::RDS::DescribeDBShardGroupsResponse> instance
...
copy or restore the manual DB snapshot. If C<all> is included in the
list of values for the C<restore> attribute, then the manual DB
...
or private, use the C<ModifyDBSnapshotAttribute> API action.
...
=head2 DescribeDBSnapshotTenantDatabases
...
Each argument is described in detail in: L<Paws::RDS::DescribeDBSnapshotTenantDatabases>

Returns: a L<Paws::RDS::DBSnapshotTenantDatabasesMessage> instance

Describes the tenant databases that exist in a DB snapshot. This
command only applies to RDS for Oracle DB instances in the multi-tenant
configuration.
...
in the I<Amazon RDS User Guide> and Monitoring Amazon Aurora events
...
Each argument is described in detail in: L<Paws::RDS::DescribeIntegrations>

Returns: a L<Paws::RDS::DescribeIntegrationsResponse> instance
...
result of the C<DescribePendingMaintenanceActions> command might not be
immediately visible to all subsequent RDS commands. Keep this in mind
when you use C<DescribePendingMaintenanceActions> immediately after
using a previous API command such as C<ApplyPendingMaintenanceActions>.
...
account, or all Regions, use the EC2 operation C<DescribeRegions>. For
more information, see DescribeRegions
(https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeRegions.html)
in the I<Amazon EC2 API Reference>.


=head2 DescribeTenantDatabases
...
Each argument is described in detail in: L<Paws::RDS::DescribeTenantDatabases>

Returns: a L<Paws::RDS::TenantDatabasesMessage> instance
...
Each argument is described in detail in: L<Paws::RDS::DisableHttpEndpoint>

Returns: a L<Paws::RDS::DisableHttpEndpointResponse> instance
...
clusters, use the C<EnableHttpEndpoint> parameter of the
C<ModifyDBCluster> operation.
...
Each argument is described in detail in: L<Paws::RDS::EnableHttpEndpoint>

Returns: a L<Paws::RDS::EnableHttpEndpointResponse> instance
...
=item [AllowDataLoss => Bool]

=item [Switchover => Bool]
...
global database. Switchover operations were previously called "managed
planned failovers."
...
Failing over - Specify the C<AllowDataLoss> parameter and don't specify
the C<Switchover> parameter.

=item *

Switching over - Specify the C<Switchover> parameter or omit it, but
don't specify the C<AllowDataLoss> parameter.
...
I<Failing over> - Use this operation to respond to an unplanned event,
...
cluster to be the primary writer DB instance guarantees that the data
is in a transactionally consistent state.

For more information about failing over an Amazon Aurora global
database, see Performing managed failovers for Aurora global databases
...
I<Switching over> - Use this operation on a healthy global database
...
=head2 ModifyActivityStream

=over

=item [AuditPolicyState => Str]
...
Each argument is described in detail in: L<Paws::RDS::ModifyActivityStream>

Returns: a L<Paws::RDS::ModifyActivityStreamResponse> instance
...
For more information, see Modifying a database activity stream
...
Amazon Web Services Region, but you are still in the process of
...
C<TimeoutAction>, connections that prevent Aurora Serverless v1 from
...
=head2 ModifyCustomDBEngineVersion
...
Each argument is described in detail in: L<Paws::RDS::ModifyCustomDBEngineVersion>

Returns: a L<Paws::RDS::DBEngineVersion> instance

Modifies the status of a custom engine version (CEV). You can find CEVs
to modify by calling C<DescribeDBEngineVersions>.

The MediaImport service that imports files from Amazon S3 to create
CEVs isn't integrated with Amazon Web Services CloudTrail. If you turn
on data logging for Amazon RDS in CloudTrail, calls to the
C<ModifyCustomDbEngineVersion> event aren't logged. However, you might
see calls from the API gateway that accesses your Amazon S3 bucket.
These calls originate from the MediaImport service for the
C<ModifyCustomDbEngineVersion> event.
...
=item [AllowEngineModeChange => Bool]
...
accounts, specify C<restore> as the C<AttributeName> and use the
C<ValuesToAdd> parameter to add a list of IDs of the Amazon Web
Services accounts that are authorized to restore the manual DB cluster
snapshot. Use the value C<all> to make the manual DB cluster snapshot
...
for the C<ValuesToAdd> parameter. You can't use C<all> as a value for
...
returned as values for the C<restore> attribute.
...
=item [ResumeFullAutomationModeMinutes => Int]
...
defined by the C<character_set_database> parameter. You can use the
I<Parameter Groups> option of the Amazon RDS console
...
=item [RecommendedActionUpdates => ArrayRef[L<Paws::RDS::RecommendedActionUpdate>]]
...
Each argument is described in detail in: L<Paws::RDS::ModifyDBRecommendation>

Returns: a L<Paws::RDS::DBRecommendationMessage> instance

Updates the recommendation status and recommended action status for the
specified recommendation.


=head2 ModifyDBShardGroup
...
Each argument is described in detail in: L<Paws::RDS::ModifyDBShardGroup>
...
are authorized to restore the manual DB snapshot. Uses the value C<all>
...
Each argument is described in detail in: L<Paws::RDS::ModifyIntegration>
...
Each argument is described in detail in: L<Paws::RDS::ModifyTenantDatabase>

Returns: a L<Paws::RDS::ModifyTenantDatabaseResult> instance
...
Each argument is described in detail in: L<Paws::RDS::RebootDBCluster>

Returns: a L<Paws::RDS::RebootDBClusterResult> instance
...
a DB cluster results in a momentary outage, during which the DB cluster
...
the DB cluster with the C<RebootDBCluster> operation.


=head2 RebootDBShardGroup
...
Each argument is described in detail in: L<Paws::RDS::RebootDBShardGroup>
...
that DB cluster. You must invoke the C<CreateDBInstance> operation to
create DB instances for the restored DB cluster, specifying the
identifier of the restored DB cluster in C<DBClusterIdentifier>. You
can create DB instances only after the C<RestoreDBClusterFromS3>
...
create DB instances for the restored DB cluster, specifying the
identifier of the restored DB cluster in C<DBClusterIdentifier>. You
can create DB instances only after the C<RestoreDBClusterFromSnapshot>
operation has completed and the DB cluster is available.
...
=item [SourceDbClusterResourceId => Str]
...
security group. Unless the C<RestoreType> is set to C<copy-on-write>,
...
instances for that DB cluster. You must invoke the C<CreateDBInstance>
operation to create DB instances for the restored DB cluster,
specifying the identifier of the restored DB cluster in
C<DBClusterIdentifier>. You can create DB instances only after the
C<RestoreDBClusterToPointInTime> operation has completed and the DB
...
C<RestoreDBInstanceFromDBSnapshot> operation. RDS doesn't allow two DB
...
name of the DB instance as the C<DBInstanceIdentifier> in the call to
the C<RestoreDBInstanceFromDBSnapshot> operation. The result is that
...
see Upgrading a MySQL DB snapshot engine version
...
C<LatestRestorableTime> property. You can restore to a point up to the
number of days specified by the C<BackupRetentionPeriod> property.
...
=item [EngineNativeAuditFieldsIncluded => Bool]
...
in the I<Amazon Aurora User Guide> or Monitoring Amazon RDS with
...
PostgreSQL. For Aurora DB clusters, use C<StartDBCluster> instead.
...
in the I<Amazon RDS User Guide> or Exporting DB cluster snapshot data
to Amazon S3
...
Services console, the C<start-activity-stream> CLI command, or the
C<StartActivityStream> operation.
...
This command doesn't apply to RDS Custom, Aurora MySQL, and Aurora
PostgreSQL. For Aurora clusters, use C<StopDBCluster> instead.
...
=head2 SwitchoverBlueGreenDeployment

=over

=item BlueGreenDeploymentIdentifier => Str

=item [SwitchoverTimeout => Int]


=back

Each argument is described in detail in: L<Paws::RDS::SwitchoverBlueGreenDeployment>

Returns: a L<Paws::RDS::SwitchoverBlueGreenDeploymentResponse> instance
...
Each argument is described in detail in: L<Paws::RDS::SwitchoverGlobalCluster>

Returns: a L<Paws::RDS::SwitchoverGlobalClusterResult> instance
...
switchovers for Amazon Aurora global databases
(https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-global-database-disaster-recovery.html#aurora-global-database-disaster-recovery.managed-failover)
in the I<Amazon Aurora User Guide>.
...
Each argument is described in detail in: L<Paws::RDS::SwitchoverReadReplica>

Returns: a L<Paws::RDS::SwitchoverReadReplicaResult> instance
...
=head2 DescribeAllBlueGreenDeployments(sub { },[BlueGreenDeploymentIdentifier => Str, Filters => ArrayRef[L<Paws::RDS::Filter>], Marker => Str, MaxRecords => Int])

=head2 DescribeAllBlueGreenDeployments([BlueGreenDeploymentIdentifier => Str, Filters => ArrayRef[L<Paws::RDS::Filter>], Marker => Str, MaxRecords => Int])


If passed a sub as first parameter, it will call the sub for each element found in :

 - BlueGreenDeployments, passing the object as the first parameter, and the string 'BlueGreenDeployments' as the second parameter 

If not, it will return a a L<Paws::RDS::DescribeBlueGreenDeploymentsResponse> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
...
=head2 DescribeAllDBClusterAutomatedBackups(sub { },[DBClusterIdentifier => Str, DbClusterResourceId => Str, Filters => ArrayRef[L<Paws::RDS::Filter>], Marker => Str, MaxRecords => Int])

=head2 DescribeAllDBClusterAutomatedBackups([DBClusterIdentifier => Str, DbClusterResourceId => Str, Filters => ArrayRef[L<Paws::RDS::Filter>], Marker => Str, MaxRecords => Int])


If passed a sub as first parameter, it will call the sub for each element found in :

 - DBClusterAutomatedBackups, passing the object as the first parameter, and the string 'DBClusterAutomatedBackups' as the second parameter 

If not, it will return a a L<Paws::RDS::DBClusterAutomatedBackupMessage> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
...
=head2 DescribeAllDBClusterSnapshots(sub { },[DBClusterIdentifier => Str, DbClusterResourceId => Str, DBClusterSnapshotIdentifier => Str, Filters => ArrayRef[L<Paws::RDS::Filter>], IncludePublic => Bool, IncludeShared => Bool, Marker => Str, MaxRecords => Int, SnapshotType => Str])

=head2 DescribeAllDBClusterSnapshots([DBClusterIdentifier => Str, DbClusterResourceId => Str, DBClusterSnapshotIdentifier => Str, Filters => ArrayRef[L<Paws::RDS::Filter>], IncludePublic => Bool, IncludeShared => Bool, Marker => Str, MaxRecords => Int, SnapshotType => Str])
...
=head2 DescribeAllDBRecommendations(sub { },[Filters => ArrayRef[L<Paws::RDS::Filter>], LastUpdatedAfter => Str, LastUpdatedBefore => Str, Locale => Str, Marker => Str, MaxRecords => Int])

=head2 DescribeAllDBRecommendations([Filters => ArrayRef[L<Paws::RDS::Filter>], LastUpdatedAfter => Str, LastUpdatedBefore => Str, Locale => Str, Marker => Str, MaxRecords => Int])


If passed a sub as first parameter, it will call the sub for each element found in :

 - DBRecommendations, passing the object as the first parameter, and the string 'DBRecommendations' as the second parameter 

If not, it will return a a L<Paws::RDS::DBRecommendationsMessage> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
...
=head2 DescribeAllDBSnapshotTenantDatabases(sub { },[DBInstanceIdentifier => Str, DbiResourceId => Str, DBSnapshotIdentifier => Str, Filters => ArrayRef[L<Paws::RDS::Filter>], Marker => Str, MaxRecords => Int, SnapshotType => Str])

=head2 DescribeAllDBSnapshotTenantDatabases([DBInstanceIdentifier => Str, DbiResourceId => Str, DBSnapshotIdentifier => Str, Filters => ArrayRef[L<Paws::RDS::Filter>], Marker => Str, MaxRecords => Int, SnapshotType => Str])


If passed a sub as first parameter, it will call the sub for each element found in :

 - DBSnapshotTenantDatabases, passing the object as the first parameter, and the string 'DBSnapshotTenantDatabases' as the second parameter 

If not, it will return a a L<Paws::RDS::DBSnapshotTenantDatabasesMessage> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
...
=head2 DescribeAllExportTasks(sub { },[ExportTaskIdentifier => Str, Filters => ArrayRef[L<Paws::RDS::Filter>], Marker => Str, MaxRecords => Int, SourceArn => Str, SourceType => Str])

=head2 DescribeAllExportTasks([ExportTaskIdentifier => Str, Filters => ArrayRef[L<Paws::RDS::Filter>], Marker => Str, MaxRecords => Int, SourceArn => Str, SourceType => Str])
...
=head2 DescribeAllIntegrations(sub { },[Filters => ArrayRef[L<Paws::RDS::Filter>], IntegrationIdentifier => Str, Marker => Str, MaxRecords => Int])

=head2 DescribeAllIntegrations([Filters => ArrayRef[L<Paws::RDS::Filter>], IntegrationIdentifier => Str, Marker => Str, MaxRecords => Int])


If passed a sub as first parameter, it will call the sub for each element found in :

 - Integrations, passing the object as the first parameter, and the string 'Integrations' as the second parameter 

If not, it will return a a L<Paws::RDS::DescribeIntegrationsResponse> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
...
=head2 DescribeAllTenantDatabases(sub { },[DBInstanceIdentifier => Str, Filters => ArrayRef[L<Paws::RDS::Filter>], Marker => Str, MaxRecords => Int, TenantDBName => Str])

=head2 DescribeAllTenantDatabases([DBInstanceIdentifier => Str, Filters => ArrayRef[L<Paws::RDS::Filter>], Marker => Str, MaxRecords => Int, TenantDBName => Str])


If passed a sub as first parameter, it will call the sub for each element found in :

 - TenantDatabases, passing the object as the first parameter, and the string 'TenantDatabases' as the second parameter 

If not, it will return a a L<Paws::RDS::TenantDatabasesMessage> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
