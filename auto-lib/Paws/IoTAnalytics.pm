...
store by applying a C<queryAction> (a SQL query) or a
C<containerAction> (executing a containerized application). This
operation creates the skeleton of a dataset. The dataset can be
populated manually by calling C<CreateDatasetContent> or automatically
...
Creates the content of a dataset by applying a C<queryAction> (a SQL
