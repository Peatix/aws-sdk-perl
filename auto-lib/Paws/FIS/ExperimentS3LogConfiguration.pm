...
package Paws::FIS::ExperimentS3LogConfiguration;
  use Moose;
...
Paws::FIS::ExperimentS3LogConfiguration
...
As an example, if Att1 is expected to be a Paws::FIS::ExperimentS3LogConfiguration object:

  $service_obj->Method(Att1 => { BucketName => $value, ..., Prefix => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::FIS::ExperimentS3LogConfiguration object:
