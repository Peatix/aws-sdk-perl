...
package Paws::FIS::ExperimentTarget;
  ...
  has Parameters => (is => 'ro', isa => 'Paws::FIS::ExperimentTargetParameterMap', request_name => 'parameters', traits => ['NameInRequest']);
...
=head2 Parameters => L<Paws::FIS::ExperimentTargetParameterMap>
