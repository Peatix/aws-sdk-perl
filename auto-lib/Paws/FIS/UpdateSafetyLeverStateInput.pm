...
package Paws::FIS::UpdateSafetyLeverStateInput;
  use Moose;
...
Paws::FIS::UpdateSafetyLeverStateInput
...
As an example, if Att1 is expected to be a Paws::FIS::UpdateSafetyLeverStateInput object:

  $service_obj->Method(Att1 => { Reason => $value, ..., Status => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::FIS::UpdateSafetyLeverStateInput object:
