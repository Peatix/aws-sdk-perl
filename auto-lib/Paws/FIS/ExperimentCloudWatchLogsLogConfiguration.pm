...
package Paws::FIS::ExperimentCloudWatchLogsLogConfiguration;
  use Moose;
...
Paws::FIS::ExperimentCloudWatchLogsLogConfiguration
...
As an example, if Att1 is expected to be a Paws::FIS::ExperimentCloudWatchLogsLogConfiguration object:

  $service_obj->Method(Att1 => { LogGroupArn => $value, ..., LogGroupArn => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::FIS::ExperimentCloudWatchLogsLogConfiguration object:
