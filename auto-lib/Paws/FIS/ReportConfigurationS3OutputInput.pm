...
package Paws::FIS::ReportConfigurationS3OutputInput;
  use Moose;
...
Paws::FIS::ReportConfigurationS3OutputInput
...
As an example, if Att1 is expected to be a Paws::FIS::ReportConfigurationS3OutputInput object:

  $service_obj->Method(Att1 => { BucketName => $value, ..., Prefix => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::FIS::ReportConfigurationS3OutputInput object:
