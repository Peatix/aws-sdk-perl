...
package Paws::FIS::ActionSummary;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::FIS::ActionSummary object:

  $service_obj->Method(Att1 => { Arn => $value, ..., Targets => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::FIS::ActionSummary object:
