...
package Paws::FIS::ExperimentTemplateS3LogConfigurationInput;
  use Moose;
...
Paws::FIS::ExperimentTemplateS3LogConfigurationInput
...
As an example, if Att1 is expected to be a Paws::FIS::ExperimentTemplateS3LogConfigurationInput object:

  $service_obj->Method(Att1 => { BucketName => $value, ..., Prefix => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::FIS::ExperimentTemplateS3LogConfigurationInput object:
