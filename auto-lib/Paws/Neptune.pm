package Paws::Neptune;
  ...
  sub CreateGlobalCluster {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Neptune::CreateGlobalCluster', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DeleteDBCluster {
    my $self = shift;
  ...
  sub DeleteGlobalCluster {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Neptune::DeleteGlobalCluster', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeGlobalClusters {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Neptune::DescribeGlobalClusters', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub FailoverGlobalCluster {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Neptune::FailoverGlobalCluster', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ModifyGlobalCluster {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Neptune::ModifyGlobalCluster', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub RemoveFromGlobalCluster {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Neptune::RemoveFromGlobalCluster', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub SwitchoverGlobalCluster {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Neptune::SwitchoverGlobalCluster', @_);
    return $self->caller->do_call($self, $call_object);
  }
...
=item [ServerlessV2ScalingConfiguration => L<Paws::Neptune::ServerlessV2ScalingConfiguration>]
...
Each argument is described in detail in: L<Paws::Neptune::CreateGlobalCluster>

Returns: a L<Paws::Neptune::CreateGlobalClusterResult> instance
...
Each argument is described in detail in: L<Paws::Neptune::DeleteGlobalCluster>

Returns: a L<Paws::Neptune::DeleteGlobalClusterResult> instance
...
Each argument is described in detail in: L<Paws::Neptune::DescribeGlobalClusters>

Returns: a L<Paws::Neptune::GlobalClustersMessage> instance
...
Each argument is described in detail in: L<Paws::Neptune::FailoverGlobalCluster>

Returns: a L<Paws::Neptune::FailoverGlobalClusterResult> instance
...
This action applies B<only> to Neptune global databases. This action is
...
Each argument is described in detail in: L<Paws::Neptune::ModifyGlobalCluster>

Returns: a L<Paws::Neptune::ModifyGlobalClusterResult> instance
...
Each argument is described in detail in: L<Paws::Neptune::RemoveFromGlobalCluster>

Returns: a L<Paws::Neptune::RemoveFromGlobalClusterResult> instance
...
Each argument is described in detail in: L<Paws::Neptune::SwitchoverGlobalCluster>

Returns: a L<Paws::Neptune::SwitchoverGlobalClusterResult> instance
...
secondary clusters are synchronized with the primary at the beginning
of the process so the new primary continues operations for the global
...
=head2 DescribeAllGlobalClusters(sub { },[GlobalClusterIdentifier => Str, Marker => Str, MaxRecords => Int])

=head2 DescribeAllGlobalClusters([GlobalClusterIdentifier => Str, Marker => Str, MaxRecords => Int])
...
If not, it will return a a L<Paws::Neptune::GlobalClustersMessage> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
