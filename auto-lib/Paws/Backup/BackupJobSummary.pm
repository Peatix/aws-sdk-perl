...
package Paws::Backup::BackupJobSummary;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::Backup::BackupJobSummary object:

  $service_obj->Method(Att1 => { AccountId => $value, ..., State => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Backup::BackupJobSummary object:
