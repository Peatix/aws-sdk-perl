...
Paws::Backup::ListBackupSelections - Arguments for method ListBackupSelections on L<Paws::Backup>

=head1 DESCRIPTION

This class represents the parameters used for calling the method ListBackupSelections on the
L<AWS Backup|Paws::Backup> service. Use the attributes of this class
as arguments to method ListBackupSelections.
...
=head1 SYNOPSIS
    ...
    my $BackupSelectionsList =
      $ListBackupSelectionsOutput->BackupSelectionsList;
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/backup/ListBackupSelections>
...
This class forms part of L<Paws>, documenting arguments for method ListBackupSelections in L<Paws::Backup>
