...
The status of the flag C<isCrossAccountBackupEnabled>.


=head2 LastUpdateTime => Str

The date and time that the flag C<isCrossAccountBackupEnabled> was last
updated. This update is in Unix format and Coordinated Universal Time
(UTC). The value of C<LastUpdateTime> is accurate to milliseconds. For
