...
package Paws::Backup::ListRestoreJobsByProtectedResourceOutput;
  use Moose;
...
Paws::Backup::ListRestoreJobsByProtectedResourceOutput
...
C<NextToken> allows youto return more items in your list starting at
