...
package Paws::GameLift::GameServerContainerDefinitionInput;
  use Moose;
  ...
  has PortConfiguration => (is => 'ro', isa => 'Paws::GameLift::ContainerPortConfiguration', required => 1);
  has ServerSdkVersion => (is => 'ro', isa => 'Str', required => 1);
...
Paws::GameLift::GameServerContainerDefinitionInput
...
As an example, if Att1 is expected to be a Paws::GameLift::GameServerContainerDefinitionInput object:

  $service_obj->Method(Att1 => { ContainerName => $value, ..., ServerSdkVersion => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::GameLift::GameServerContainerDefinitionInput object:
...
deployed container, see GameServerContainerDefinition
(https://docs.aws.amazon.com/gamelift/latest/apireference/API_GameServerContainerDefinition.html).
A game server container is automatically considered essential; if an
...
=head2 B<REQUIRED> PortConfiguration => L<Paws::GameLift::ContainerPortConfiguration>
...
Container ports aren't directly accessed by inbound traffic. Instead,
Amazon GameLift maps container ports to externally accessible
connection ports (see the container fleet property
C<ConnectionPortRange>).


=head2 B<REQUIRED> ServerSdkVersion => Str
