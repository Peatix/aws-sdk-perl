...
package Paws::TimestreamWrite::ReportS3Configuration;
  use Moose;
...
Paws::TimestreamWrite::ReportS3Configuration
...
As an example, if Att1 is expected to be a Paws::TimestreamWrite::ReportS3Configuration object:

  $service_obj->Method(Att1 => { BucketName => $value, ..., ObjectKeyPrefix => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::TimestreamWrite::ReportS3Configuration object:
