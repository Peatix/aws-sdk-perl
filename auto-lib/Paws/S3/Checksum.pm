...
As an example, if Att1 is expected to be a Paws::S3::Checksum object:

  $service_obj->Method(Att1 => { ChecksumCRC32 => $value, ..., ChecksumType => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::S3::Checksum object:
...
checksum is present if the object was uploaded with the C<CRC64NVME>
checksum algorithm, or if the object was uploaded without a checksum
(and Amazon S3 added the default checksum, C<CRC64NVME>, to the
uploaded object). For more information, see Checking object integrity
