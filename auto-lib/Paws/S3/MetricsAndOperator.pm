...
package Paws::S3::MetricsAndOperator;
  ...
  has Tags => (is => 'ro', isa => 'ArrayRef[Paws::S3::Tag]', request_name => 'Tag', traits => ['NameInRequest']);
...
As an example, if Att1 is expected to be a Paws::S3::MetricsAndOperator object:
  ...
  $service_obj->Method(Att1 => { AccessPointArn => $value, ..., Tags => $value  });
...
The access point ARN used when evaluating an C<AND> predicate.
