...
package Paws::S3::GetObjectAttributes;
  use Moose;
  has Bucket => (is => 'ro', isa => 'Str', uri_name => 'Bucket', traits => ['ParamInURI'], required => 1);
  has ExpectedBucketOwner => (is => 'ro', isa => 'Str', header_name => 'x-amz-expected-bucket-owner', traits => ['ParamInHeader']);
  has Key => (is => 'ro', isa => 'Str', uri_name => 'Key', traits => ['ParamInURI'], required => 1);
  has MaxParts => (is => 'ro', isa => 'Int', header_name => 'x-amz-max-parts', traits => ['ParamInHeader']);
  has ObjectAttributes => (is => 'ro', isa => 'ArrayRef[Str|Undef]', request_name => 'x-amz-object-attributes', traits => ['NameInRequest'], required => 1);
  has PartNumberMarker => (is => 'ro', isa => 'Int', header_name => 'x-amz-part-number-marker', traits => ['ParamInHeader']);
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::S3::GetObjectAttributesOutput');
...
Paws::S3::GetObjectAttributes - Arguments for method GetObjectAttributes on L<Paws::S3>
...
=head1 SYNOPSIS
    ...
    my $GetObjectAttributesOutput = $s3->GetObjectAttributes(
      Bucket           => 'MyBucketName',
      Key              => 'MyObjectKey',
      ObjectAttributes => [
        'ETag',
        ...    # values: ETag, Checksum, ObjectParts, StorageClass, ObjectSize
      ],
    ...
    # Results:
    my $Checksum       = $GetObjectAttributesOutput->Checksum;
    my $DeleteMarker   = $GetObjectAttributesOutput->DeleteMarker;
    my $ETag           = $GetObjectAttributesOutput->ETag;
    my $LastModified   = $GetObjectAttributesOutput->LastModified;
    my $ObjectParts    = $GetObjectAttributesOutput->ObjectParts;
    my $ObjectSize     = $GetObjectAttributesOutput->ObjectSize;
    my $RequestCharged = $GetObjectAttributesOutput->RequestCharged;
    my $StorageClass   = $GetObjectAttributesOutput->StorageClass;
    my $VersionId      = $GetObjectAttributesOutput->VersionId;

    # Returns a L<Paws::S3::GetObjectAttributesOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/s3/GetObjectAttributes>
...
=head2 B<REQUIRED> ObjectAttributes => ArrayRef[Str|Undef]
...
this API operation, only the C<null> value of the version ID is
supported by directory buckets. You can only specify C<null> to the
C<versionId> query parameter in the request.
...
This class forms part of L<Paws>, documenting arguments for method GetObjectAttributes in L<Paws::S3>
