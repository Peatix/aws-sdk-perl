...
package Paws::S3::DeleteBucketCors;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'DeleteBucketCors');
...
Paws::S3::DeleteBucketCors - Arguments for method DeleteBucketCors on L<Paws::S3>
...
=head1 SYNOPSIS
    ...
    $s3->DeleteBucketCors( 'Bucket' => 'examplebucket' );


Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/s3/DeleteBucketCors>
...
Specifies the bucket whose C<cors> configuration is being deleted.
