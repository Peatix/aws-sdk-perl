...
package Paws::S3::DeletePublicAccessBlock;
  use Moose;
...
Paws::S3::DeletePublicAccessBlock - Arguments for method DeletePublicAccessBlock on L<Paws::S3>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/s3/DeletePublicAccessBlock>
...
The Amazon S3 bucket whose C<PublicAccessBlock> configuration you want
to delete.
...
This class forms part of L<Paws>, documenting arguments for method DeletePublicAccessBlock in L<Paws::S3>
