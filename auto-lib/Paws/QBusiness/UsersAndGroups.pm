...
package Paws::QBusiness::UsersAndGroups;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::QBusiness::UsersAndGroups object:

  $service_obj->Method(Att1 => { UserGroups => $value, ..., UserIds => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::QBusiness::UsersAndGroups object:
