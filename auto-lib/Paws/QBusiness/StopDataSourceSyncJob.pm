...
package Paws::QBusiness::StopDataSourceSyncJob;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/applications/{applicationId}/indices/{indexId}/datasources/{dataSourceId}/stopsync');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::QBusiness::StopDataSourceSyncJobResponse');
1;
...
Paws::QBusiness::StopDataSourceSyncJob - Arguments for method StopDataSourceSyncJob on L<Paws::QBusiness>
...
=head1 SYNOPSIS
    ...
    my $StopDataSourceSyncJobResponse = $qbusiness->StopDataSourceSyncJob(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/qbusiness/StopDataSourceSyncJob>
...
This class forms part of L<Paws>, documenting arguments for method StopDataSourceSyncJob in L<Paws::QBusiness>
