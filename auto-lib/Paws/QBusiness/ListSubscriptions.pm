...
package Paws::QBusiness::ListSubscriptions;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::QBusiness::ListSubscriptionsResponse');
1;
...
Paws::QBusiness::ListSubscriptions - Arguments for method ListSubscriptions on L<Paws::QBusiness>
...
=head1 SYNOPSIS
    ...
    my $ListSubscriptionsResponse = $qbusiness->ListSubscriptions(
    ...
    # Returns a L<Paws::QBusiness::ListSubscriptionsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/qbusiness/ListSubscriptions>
...
This class forms part of L<Paws>, documenting arguments for method ListSubscriptions in L<Paws::QBusiness>
