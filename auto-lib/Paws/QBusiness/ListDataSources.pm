...
package Paws::QBusiness::ListDataSources;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::QBusiness::ListDataSourcesResponse');
1;
...
Paws::QBusiness::ListDataSources - Arguments for method ListDataSources on L<Paws::QBusiness>
...
=head1 SYNOPSIS
    ...
    my $ListDataSourcesResponse = $qbusiness->ListDataSources(
    ...
    # Returns a L<Paws::QBusiness::ListDataSourcesResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/qbusiness/ListDataSources>
...
This class forms part of L<Paws>, documenting arguments for method ListDataSources in L<Paws::QBusiness>
