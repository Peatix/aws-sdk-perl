...
package Paws::QBusiness::ListAttachments;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/applications/{applicationId}/attachments');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::QBusiness::ListAttachmentsResponse');
1;
...
Paws::QBusiness::ListAttachments - Arguments for method ListAttachments on L<Paws::QBusiness>
...
=head1 SYNOPSIS
    ...
    my $ListAttachmentsResponse = $qbusiness->ListAttachments(
    ...
    # Returns a L<Paws::QBusiness::ListAttachmentsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/qbusiness/ListAttachments>
...
If the number of attachments returned exceeds C<maxResults>, Amazon Q
...
This class forms part of L<Paws>, documenting arguments for method ListAttachments in L<Paws::QBusiness>
