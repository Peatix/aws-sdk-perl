...
package Paws::QBusiness::GroupSummary;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::QBusiness::GroupSummary object:

  $service_obj->Method(Att1 => { GroupName => $value, ..., GroupName => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::QBusiness::GroupSummary object:
