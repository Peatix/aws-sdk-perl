...
package Paws::QBusiness::ListPlugins;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::QBusiness::ListPluginsResponse');
1;
...
Paws::QBusiness::ListPlugins - Arguments for method ListPlugins on L<Paws::QBusiness>
...
=head1 SYNOPSIS
    ...
    my $ListPluginsResponse = $qbusiness->ListPlugins(
    ...
    # Returns a L<Paws::QBusiness::ListPluginsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/qbusiness/ListPlugins>
...
This class forms part of L<Paws>, documenting arguments for method ListPlugins in L<Paws::QBusiness>
