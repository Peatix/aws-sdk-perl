...
package Paws::QBusiness::DocumentAclGroup;
  use Moose;
...
Paws::QBusiness::DocumentAclGroup
...
As an example, if Att1 is expected to be a Paws::QBusiness::DocumentAclGroup object:

  $service_obj->Method(Att1 => { Name => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::QBusiness::DocumentAclGroup object:
...
The name of the group in the document's ACL. This is used to identify
