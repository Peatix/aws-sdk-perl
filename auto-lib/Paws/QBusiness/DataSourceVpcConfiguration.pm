...
package Paws::QBusiness::DataSourceVpcConfiguration;
  use Moose;
...
Paws::QBusiness::DataSourceVpcConfiguration
...
As an example, if Att1 is expected to be a Paws::QBusiness::DataSourceVpcConfiguration object:

  $service_obj->Method(Att1 => { SecurityGroupIds => $value, ..., SubnetIds => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::QBusiness::DataSourceVpcConfiguration object:
