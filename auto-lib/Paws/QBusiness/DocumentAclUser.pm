...
package Paws::QBusiness::DocumentAclUser;
  use Moose;
...
Paws::QBusiness::DocumentAclUser
...
As an example, if Att1 is expected to be a Paws::QBusiness::DocumentAclUser object:

  $service_obj->Method(Att1 => { Id => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::QBusiness::DocumentAclUser object:
...
The unique identifier of the user in the document's ACL. This is used
