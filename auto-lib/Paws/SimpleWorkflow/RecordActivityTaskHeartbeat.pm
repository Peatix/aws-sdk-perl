...
Paws::SimpleWorkflow::RecordActivityTaskHeartbeat - Arguments for method RecordActivityTaskHeartbeat on L<Paws::SimpleWorkflow>
...
=head1 SYNOPSIS
    ...
    my $ActivityTaskStatus = $swf->RecordActivityTaskHeartbeat(
      TaskToken => 'MyTaskToken',
      Details   => 'MyLimitedData',    # OPTIONAL
    );
