...
A single C<GetMetricData> call can include up to 500 C<MetricDataQuery>
structures.
...
If you are performing a C<GetMetricData> operation in a monitoring
account, use this to specify which account to retrieve this metric
from.

If you are performing a C<PutMetricAlarm> operation, use this to
...
information about Metrics Insights queries, see Metrics Insights query
