package Paws::RedShift;
  ...
  sub AssociateDataShareConsumer {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::AssociateDataShareConsumer', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub AuthorizeDataShare {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::AuthorizeDataShare', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub CreateAuthenticationProfile {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::CreateAuthenticationProfile', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub CreateCluster {
    my $self = shift;
  ...
  sub CreateCustomDomainAssociation {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::CreateCustomDomainAssociation', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub CreateIntegration {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::CreateIntegration', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub CreateRedshiftIdcApplication {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::CreateRedshiftIdcApplication', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DeauthorizeDataShare {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::DeauthorizeDataShare', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DeleteAuthenticationProfile {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::DeleteAuthenticationProfile', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DeleteCluster {
    my $self = shift;
  ...
  sub DeleteCustomDomainAssociation {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::DeleteCustomDomainAssociation', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DeleteIntegration {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::DeleteIntegration', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DeletePartner {
    my $self = shift;
  ...
  sub DeleteRedshiftIdcApplication {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::DeleteRedshiftIdcApplication', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DeleteResourcePolicy {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::DeleteResourcePolicy', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DeregisterNamespace {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::DeregisterNamespace', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeAuthenticationProfiles {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::DescribeAuthenticationProfiles', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeCustomDomainAssociations {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::DescribeCustomDomainAssociations', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DescribeDataShares {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::DescribeDataShares', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DescribeDataSharesForConsumer {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::DescribeDataSharesForConsumer', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DescribeDataSharesForProducer {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::DescribeDataSharesForProducer', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeInboundIntegrations {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::DescribeInboundIntegrations', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DescribeIntegrations {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::DescribeIntegrations', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeRedshiftIdcApplications {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::DescribeRedshiftIdcApplications', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DescribeReservedNodeExchangeStatus {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::DescribeReservedNodeExchangeStatus', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DisassociateDataShareConsumer {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::DisassociateDataShareConsumer', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub EnableLogging {
    my $self = shift;
  ...
  sub FailoverPrimaryCompute {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::FailoverPrimaryCompute', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub GetClusterCredentialsWithIAM {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::GetClusterCredentialsWithIAM', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetReservedNodeExchangeConfigurationOptions {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::GetReservedNodeExchangeConfigurationOptions', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub GetResourcePolicy {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::GetResourcePolicy', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ListRecommendations {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::ListRecommendations', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ModifyAuthenticationProfile {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::ModifyAuthenticationProfile', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ModifyCluster {
    my $self = shift;
  ...
  sub ModifyCustomDomainAssociation {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::ModifyCustomDomainAssociation', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ModifyIntegration {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::ModifyIntegration', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ModifyRedshiftIdcApplication {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::ModifyRedshiftIdcApplication', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub PutResourcePolicy {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::PutResourcePolicy', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub RebootCluster {
    my $self = shift;
  ...
  sub RegisterNamespace {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::RegisterNamespace', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub RejectDataShare {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::RedShift::RejectDataShare', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeAllCustomDomainAssociations {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->DescribeCustomDomainAssociations(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->Marker) {
        $next_result = $self->DescribeCustomDomainAssociations(@_, Marker => $next_result->Marker);
      ...
      while ($result->Marker) {
        ...
        $result = $self->DescribeCustomDomainAssociations(@_, Marker => $result->Marker);
      }
      $callback->($_ => 'Associations') foreach (@{ $result->Associations });
    }
  ...
  sub DescribeAllDataShares {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->DescribeDataShares(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->Marker) {
        $next_result = $self->DescribeDataShares(@_, Marker => $next_result->Marker);
        push @{ $result->DataShares }, @{ $next_result->DataShares };
      }
      return $result;
    } else {
      while ($result->Marker) {
        $callback->($_ => 'DataShares') foreach (@{ $result->DataShares });
        $result = $self->DescribeDataShares(@_, Marker => $result->Marker);
      }
      $callback->($_ => 'DataShares') foreach (@{ $result->DataShares });
    }
  ...
  sub DescribeAllDataSharesForConsumer {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->DescribeDataSharesForConsumer(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->Marker) {
        $next_result = $self->DescribeDataSharesForConsumer(@_, Marker => $next_result->Marker);
        push @{ $result->DataShares }, @{ $next_result->DataShares };
      }
      return $result;
    } else {
      while ($result->Marker) {
        $callback->($_ => 'DataShares') foreach (@{ $result->DataShares });
        $result = $self->DescribeDataSharesForConsumer(@_, Marker => $result->Marker);
      }
      $callback->($_ => 'DataShares') foreach (@{ $result->DataShares });
    }
  ...
  sub DescribeAllDataSharesForProducer {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->DescribeDataSharesForProducer(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->Marker) {
        $next_result = $self->DescribeDataSharesForProducer(@_, Marker => $next_result->Marker);
        push @{ $result->DataShares }, @{ $next_result->DataShares };
      }
      return $result;
    } else {
      while ($result->Marker) {
        $callback->($_ => 'DataShares') foreach (@{ $result->DataShares });
        $result = $self->DescribeDataSharesForProducer(@_, Marker => $result->Marker);
      }
      $callback->($_ => 'DataShares') foreach (@{ $result->DataShares });
    }
  ...
  sub DescribeAllInboundIntegrations {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->DescribeInboundIntegrations(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->Marker) {
        $next_result = $self->DescribeInboundIntegrations(@_, Marker => $next_result->Marker);
        push @{ $result->InboundIntegrations }, @{ $next_result->InboundIntegrations };
      }
      return $result;
    } else {
      while ($result->Marker) {
        $callback->($_ => 'InboundIntegrations') foreach (@{ $result->InboundIntegrations });
        $result = $self->DescribeInboundIntegrations(@_, Marker => $result->Marker);
      }
      $callback->($_ => 'InboundIntegrations') foreach (@{ $result->InboundIntegrations });
    }
  ...
  sub DescribeAllRedshiftIdcApplications {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->DescribeRedshiftIdcApplications(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->Marker) {
        $next_result = $self->DescribeRedshiftIdcApplications(@_, Marker => $next_result->Marker);
        push @{ $result->RedshiftIdcApplications }, @{ $next_result->RedshiftIdcApplications };
      }
      return $result;
    } else {
      while ($result->Marker) {
        $callback->($_ => 'RedshiftIdcApplications') foreach (@{ $result->RedshiftIdcApplications });
        $result = $self->DescribeRedshiftIdcApplications(@_, Marker => $result->Marker);
      }
      $callback->($_ => 'RedshiftIdcApplications') foreach (@{ $result->RedshiftIdcApplications });
    }
  ...
  sub DescribeAllReservedNodeExchangeStatus {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->DescribeReservedNodeExchangeStatus(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->Marker) {
        $next_result = $self->DescribeReservedNodeExchangeStatus(@_, Marker => $next_result->Marker);
        push @{ $result->ReservedNodeExchangeStatusDetails }, @{ $next_result->ReservedNodeExchangeStatusDetails };
      }
      return $result;
    } else {
      while ($result->Marker) {
        $callback->($_ => 'ReservedNodeExchangeStatusDetails') foreach (@{ $result->ReservedNodeExchangeStatusDetails });
        $result = $self->DescribeReservedNodeExchangeStatus(@_, Marker => $result->Marker);
      }
      $callback->($_ => 'ReservedNodeExchangeStatusDetails') foreach (@{ $result->ReservedNodeExchangeStatusDetails });
    }
  ...
  sub GetAllReservedNodeExchangeConfigurationOptions {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->GetReservedNodeExchangeConfigurationOptions(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->Marker) {
        $next_result = $self->GetReservedNodeExchangeConfigurationOptions(@_, Marker => $next_result->Marker);
        push @{ $result->ReservedNodeConfigurationOptionList }, @{ $next_result->ReservedNodeConfigurationOptionList };
      }
      return $result;
    } else {
      while ($result->Marker) {
        $callback->($_ => 'ReservedNodeConfigurationOptionList') foreach (@{ $result->ReservedNodeConfigurationOptionList });
        $result = $self->GetReservedNodeExchangeConfigurationOptions(@_, Marker => $result->Marker);
      }
      $callback->($_ => 'ReservedNodeConfigurationOptionList') foreach (@{ $result->ReservedNodeConfigurationOptionList });
    }
  ...
  sub ListAllRecommendations {
    ...
    if (not defined $callback) {
      while ($next_result->Marker) {
        $next_result = $self->ListRecommendations(@_, Marker => $next_result->Marker);
      ...
      while ($result->Marker) {
        ...
        $result = $self->ListRecommendations(@_, Marker => $result->Marker);
      }
      $callback->($_ => 'Recommendations') foreach (@{ $result->Recommendations });
    }
...
=head2 AssociateDataShareConsumer

=over

=item DataShareArn => Str

=item [AllowWrites => Bool]

=item [AssociateEntireAccount => Bool]

=item [ConsumerArn => Str]

=item [ConsumerRegion => Str]


=back

Each argument is described in detail in: L<Paws::RedShift::AssociateDataShareConsumer>

Returns: a L<Paws::RedShift::DataShare> instance
...
=head2 AuthorizeDataShare

=over

=item ConsumerIdentifier => Str
...
Each argument is described in detail in: L<Paws::RedShift::AuthorizeDataShare>
...
=head2 CreateAuthenticationProfile

=over

=item AuthenticationProfileContent => Str

=item AuthenticationProfileName => Str


=back

Each argument is described in detail in: L<Paws::RedShift::CreateAuthenticationProfile>

Returns: a L<Paws::RedShift::CreateAuthenticationProfileResult> instance
...
=item [LoadSampleData => Str]

=item [MaintenanceTrackName => Str]

=item [ManageMasterPassword => Bool]

=item [ManualSnapshotRetentionPeriod => Int]

=item [MasterPasswordSecretKmsKeyId => Str]
...
Adding a subnet with VPC BPA turned on to the subnet group when there's
at least one public cluster within the group
...
Each argument is described in detail in: L<Paws::RedShift::CreateCustomDomainAssociation>

Returns: a L<Paws::RedShift::CreateCustomDomainAssociationResult> instance
...
=item [AdditionalEncryptionContext => L<Paws::RedShift::EncryptionContextMap>]

=item [Description => Str]

=item [KMSKeyId => Str]

=item [TagList => ArrayRef[L<Paws::RedShift::Tag>]]


=back

Each argument is described in detail in: L<Paws::RedShift::CreateIntegration>

Returns: a L<Paws::RedShift::Integration> instance

Creates a zero-ETL integration or S3 event integration with Amazon
Redshift.


=head2 CreateRedshiftIdcApplication

=over

=item IamRoleArn => Str

=item IdcDisplayName => Str

=item IdcInstanceArn => Str

=item RedshiftIdcApplicationName => Str

=item [AuthorizedTokenIssuerList => ArrayRef[L<Paws::RedShift::AuthorizedTokenIssuer>]]

=item [IdentityNamespace => Str]

=item [ServiceIntegrations => ArrayRef[L<Paws::RedShift::ServiceIntegrationsUnion>]]


=back

Each argument is described in detail in: L<Paws::RedShift::CreateRedshiftIdcApplication>

Returns: a L<Paws::RedShift::CreateRedshiftIdcApplicationResult> instance
...
Each argument is described in detail in: L<Paws::RedShift::DeauthorizeDataShare>
...
=head2 DeleteAuthenticationProfile
...
Each argument is described in detail in: L<Paws::RedShift::DeleteAuthenticationProfile>

Returns: a L<Paws::RedShift::DeleteAuthenticationProfileResult> instance
...
Each argument is described in detail in: L<Paws::RedShift::DeleteCustomDomainAssociation>
...
Each argument is described in detail in: L<Paws::RedShift::DeleteIntegration>
...
=head2 DeleteRedshiftIdcApplication
...
Each argument is described in detail in: L<Paws::RedShift::DeleteRedshiftIdcApplication>
...
Each argument is described in detail in: L<Paws::RedShift::DeleteResourcePolicy>
...
=item ConsumerIdentifiers => ArrayRef[Str|Undef]

=item NamespaceIdentifier => L<Paws::RedShift::NamespaceIdentifierUnion>


=back

Each argument is described in detail in: L<Paws::RedShift::DeregisterNamespace>

Returns: a L<Paws::RedShift::DeregisterNamespaceOutputMessage> instance
...
=head2 DescribeAuthenticationProfiles
...
Each argument is described in detail in: L<Paws::RedShift::DescribeAuthenticationProfiles>

Returns: a L<Paws::RedShift::DescribeAuthenticationProfilesResult> instance
...
all snapshots of all clusters that are owned by your Amazon Web
...
=head2 DescribeCustomDomainAssociations
...
Each argument is described in detail in: L<Paws::RedShift::DescribeCustomDomainAssociations>

Returns: a L<Paws::RedShift::CustomDomainAssociationsMessage> instance

Contains information about custom domain associations for a cluster.


=head2 DescribeDataShares
...
Each argument is described in detail in: L<Paws::RedShift::DescribeDataShares>

Returns: a L<Paws::RedShift::DescribeDataSharesResult> instance

Shows the status of any inbound or outbound datashares available in the
specified account.


=head2 DescribeDataSharesForConsumer
...
Each argument is described in detail in: L<Paws::RedShift::DescribeDataSharesForConsumer>

Returns: a L<Paws::RedShift::DescribeDataSharesForConsumerResult> instance

Returns a list of datashares where the account identifier being called
is a consumer account identifier.


=head2 DescribeDataSharesForProducer
...
Each argument is described in detail in: L<Paws::RedShift::DescribeDataSharesForProducer>

Returns: a L<Paws::RedShift::DescribeDataSharesForProducerResult> instance
...
Each argument is described in detail in: L<Paws::RedShift::DescribeInboundIntegrations>

Returns: a L<Paws::RedShift::InboundIntegrationsMessage> instance
...
=item [Filters => ArrayRef[L<Paws::RedShift::DescribeIntegrationsFilter>]]
...
Each argument is described in detail in: L<Paws::RedShift::DescribeIntegrations>

Returns: a L<Paws::RedShift::IntegrationsMessage> instance
...
cluster options in the specific region and specify values when creating
a cluster. For more information about managing clusters, go to Amazon
Redshift Clusters
(https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-clusters.html)
in the I<Amazon Redshift Cluster Management Guide>.
...
=head2 DescribeRedshiftIdcApplications
...
Each argument is described in detail in: L<Paws::RedShift::DescribeRedshiftIdcApplications>

Returns: a L<Paws::RedShift::DescribeRedshiftIdcApplicationsResult> instance

Lists the Amazon Redshift IAM Identity Center applications.


=head2 DescribeReservedNodeExchangeStatus
...
=item [ReservedNodeExchangeRequestId => Str]
...
Each argument is described in detail in: L<Paws::RedShift::DescribeReservedNodeExchangeStatus>

Returns: a L<Paws::RedShift::DescribeReservedNodeExchangeStatusOutputMessage> instance
...
=head2 DisassociateDataShareConsumer
...
=item [DisassociateEntireAccount => Bool]


=back

Each argument is described in detail in: L<Paws::RedShift::DisassociateDataShareConsumer>
...
Each argument is described in detail in: L<Paws::RedShift::FailoverPrimaryCompute>

Returns: a L<Paws::RedShift::FailoverPrimaryComputeResult> instance
...
policy must include the C<redshift:CreateClusterUser> permission.
...
=head2 GetClusterCredentialsWithIAM
...
Each argument is described in detail in: L<Paws::RedShift::GetClusterCredentialsWithIAM>

Returns: a L<Paws::RedShift::ClusterExtendedCredentials> instance
...
permissions, see Using identity-based policies (IAM policies)
(https://docs.aws.amazon.com/redshift/latest/mgmt/redshift-iam-access-control-identity-based.html)
in the Amazon Redshift Cluster Management Guide.


=head2 GetReservedNodeExchangeConfigurationOptions
...
Each argument is described in detail in: L<Paws::RedShift::GetReservedNodeExchangeConfigurationOptions>

Returns: a L<Paws::RedShift::GetReservedNodeExchangeConfigurationOptionsOutputMessage> instance
...
Each argument is described in detail in: L<Paws::RedShift::GetResourcePolicy>

Returns: a L<Paws::RedShift::GetResourcePolicyResult> instance
...
Each argument is described in detail in: L<Paws::RedShift::ListRecommendations>

Returns: a L<Paws::RedShift::ListRecommendationsResult> instance
...
=head2 ModifyAuthenticationProfile
...
Each argument is described in detail in: L<Paws::RedShift::ModifyAuthenticationProfile>

Returns: a L<Paws::RedShift::ModifyAuthenticationProfileResult> instance
...
=head2 ModifyCustomDomainAssociation
...
Each argument is described in detail in: L<Paws::RedShift::ModifyCustomDomainAssociation>

Returns: a L<Paws::RedShift::ModifyCustomDomainAssociationResult> instance
...
Each argument is described in detail in: L<Paws::RedShift::ModifyIntegration>
...
=head2 ModifyRedshiftIdcApplication
...
Each argument is described in detail in: L<Paws::RedShift::ModifyRedshiftIdcApplication>

Returns: a L<Paws::RedShift::ModifyRedshiftIdcApplicationResult> instance
...
Each argument is described in detail in: L<Paws::RedShift::PutResourcePolicy>

Returns: a L<Paws::RedShift::PutResourcePolicyResult> instance
...
Each argument is described in detail in: L<Paws::RedShift::RegisterNamespace>

Returns: a L<Paws::RedShift::RegisterNamespaceOutputMessage> instance

Registers a cluster or serverless namespace to the Amazon Web Services
Glue Data Catalog.


=head2 RejectDataShare
...
Each argument is described in detail in: L<Paws::RedShift::RejectDataShare>
...
=head2 DescribeAllClusterSnapshots(sub { },[ClusterExists => Bool, ClusterIdentifier => Str, EndTime => Str, Marker => Str, MaxRecords => Int, OwnerAccount => Str, SnapshotArn => Str, SnapshotIdentifier => Str, SnapshotType => Str, SortingEntities => ArrayRef[L<Paws::RedShift::SnapshotSortingEntity>], StartTime => Str, TagKeys => ArrayRef[Str|Undef], TagValues => ArrayRef[Str|Undef]])

=head2 DescribeAllClusterSnapshots([ClusterExists => Bool, ClusterIdentifier => Str, EndTime => Str, Marker => Str, MaxRecords => Int, OwnerAccount => Str, SnapshotArn => Str, SnapshotIdentifier => Str, SnapshotType => Str, SortingEntities => ArrayRef[L<Paws::RedShift::SnapshotSortingEntity>], StartTime => Str, TagKeys => ArrayRef[Str|Undef], TagValues => ArrayRef[Str|Undef]])
...
=head2 DescribeAllCustomDomainAssociations(sub { },[CustomDomainCertificateArn => Str, CustomDomainName => Str, Marker => Str, MaxRecords => Int])

=head2 DescribeAllCustomDomainAssociations([CustomDomainCertificateArn => Str, CustomDomainName => Str, Marker => Str, MaxRecords => Int])
...
If not, it will return a a L<Paws::RedShift::CustomDomainAssociationsMessage> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.


=head2 DescribeAllDataShares(sub { },[DataShareArn => Str, Marker => Str, MaxRecords => Int])

=head2 DescribeAllDataShares([DataShareArn => Str, Marker => Str, MaxRecords => Int])


If passed a sub as first parameter, it will call the sub for each element found in :

 - DataShares, passing the object as the first parameter, and the string 'DataShares' as the second parameter 

If not, it will return a a L<Paws::RedShift::DescribeDataSharesResult> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.


=head2 DescribeAllDataSharesForConsumer(sub { },[ConsumerArn => Str, Marker => Str, MaxRecords => Int, Status => Str])

=head2 DescribeAllDataSharesForConsumer([ConsumerArn => Str, Marker => Str, MaxRecords => Int, Status => Str])
...
If not, it will return a a L<Paws::RedShift::DescribeDataSharesForConsumerResult> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.


=head2 DescribeAllDataSharesForProducer(sub { },[Marker => Str, MaxRecords => Int, ProducerArn => Str, Status => Str])

=head2 DescribeAllDataSharesForProducer([Marker => Str, MaxRecords => Int, ProducerArn => Str, Status => Str])
...
If not, it will return a a L<Paws::RedShift::DescribeDataSharesForProducerResult> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
...
=head2 DescribeAllInboundIntegrations(sub { },[IntegrationArn => Str, Marker => Str, MaxRecords => Int, TargetArn => Str])

=head2 DescribeAllInboundIntegrations([IntegrationArn => Str, Marker => Str, MaxRecords => Int, TargetArn => Str])


If passed a sub as first parameter, it will call the sub for each element found in :

 - InboundIntegrations, passing the object as the first parameter, and the string 'InboundIntegrations' as the second parameter 

If not, it will return a a L<Paws::RedShift::InboundIntegrationsMessage> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.


=head2 DescribeAllIntegrations(sub { },[Filters => ArrayRef[L<Paws::RedShift::DescribeIntegrationsFilter>], IntegrationArn => Str, Marker => Str, MaxRecords => Int])

=head2 DescribeAllIntegrations([Filters => ArrayRef[L<Paws::RedShift::DescribeIntegrationsFilter>], IntegrationArn => Str, Marker => Str, MaxRecords => Int])
...
If not, it will return a a L<Paws::RedShift::IntegrationsMessage> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.


=head2 DescribeAllNodeConfigurationOptions(sub { },ActionType => Str, [ClusterIdentifier => Str, Filters => ArrayRef[L<Paws::RedShift::NodeConfigurationOptionsFilter>], Marker => Str, MaxRecords => Int, OwnerAccount => Str, SnapshotArn => Str, SnapshotIdentifier => Str])

=head2 DescribeAllNodeConfigurationOptions(ActionType => Str, [ClusterIdentifier => Str, Filters => ArrayRef[L<Paws::RedShift::NodeConfigurationOptionsFilter>], Marker => Str, MaxRecords => Int, OwnerAccount => Str, SnapshotArn => Str, SnapshotIdentifier => Str])
...
=head2 DescribeAllRedshiftIdcApplications(sub { },[Marker => Str, MaxRecords => Int, RedshiftIdcApplicationArn => Str])

=head2 DescribeAllRedshiftIdcApplications([Marker => Str, MaxRecords => Int, RedshiftIdcApplicationArn => Str])


If passed a sub as first parameter, it will call the sub for each element found in :

 - RedshiftIdcApplications, passing the object as the first parameter, and the string 'RedshiftIdcApplications' as the second parameter 

If not, it will return a a L<Paws::RedShift::DescribeRedshiftIdcApplicationsResult> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.


=head2 DescribeAllReservedNodeExchangeStatus(sub { },[Marker => Str, MaxRecords => Int, ReservedNodeExchangeRequestId => Str, ReservedNodeId => Str])

=head2 DescribeAllReservedNodeExchangeStatus([Marker => Str, MaxRecords => Int, ReservedNodeExchangeRequestId => Str, ReservedNodeId => Str])


If passed a sub as first parameter, it will call the sub for each element found in :

 - ReservedNodeExchangeStatusDetails, passing the object as the first parameter, and the string 'ReservedNodeExchangeStatusDetails' as the second parameter 

If not, it will return a a L<Paws::RedShift::DescribeReservedNodeExchangeStatusOutputMessage> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
...
=head2 GetAllReservedNodeExchangeConfigurationOptions(sub { },ActionType => Str, [ClusterIdentifier => Str, Marker => Str, MaxRecords => Int, SnapshotIdentifier => Str])

=head2 GetAllReservedNodeExchangeConfigurationOptions(ActionType => Str, [ClusterIdentifier => Str, Marker => Str, MaxRecords => Int, SnapshotIdentifier => Str])


If passed a sub as first parameter, it will call the sub for each element found in :

 - ReservedNodeConfigurationOptionList, passing the object as the first parameter, and the string 'ReservedNodeConfigurationOptionList' as the second parameter 

If not, it will return a a L<Paws::RedShift::GetReservedNodeExchangeConfigurationOptionsOutputMessage> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
...
=head2 ListAllRecommendations(sub { },[ClusterIdentifier => Str, Marker => Str, MaxRecords => Int, NamespaceArn => Str])

=head2 ListAllRecommendations([ClusterIdentifier => Str, Marker => Str, MaxRecords => Int, NamespaceArn => Str])
...
If not, it will return a a L<Paws::RedShift::ListRecommendationsResult> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
