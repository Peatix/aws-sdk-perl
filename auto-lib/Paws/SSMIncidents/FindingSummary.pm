...
package Paws::SSMIncidents::FindingSummary;
  use Moose;
...
Paws::SSMIncidents::FindingSummary
...
As an example, if Att1 is expected to be a Paws::SSMIncidents::FindingSummary object:

  $service_obj->Method(Att1 => { Id => $value, ..., LastModifiedTime => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::SSMIncidents::FindingSummary object:
