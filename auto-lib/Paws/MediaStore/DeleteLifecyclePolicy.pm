...
package Paws::MediaStore::DeleteLifecyclePolicy;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::MediaStore::DeleteLifecyclePolicyOutput');
...
Paws::MediaStore::DeleteLifecyclePolicy - Arguments for method DeleteLifecyclePolicy on L<Paws::MediaStore>
...
=head1 SYNOPSIS
    ...
    my $DeleteLifecyclePolicyOutput = $mediastore->DeleteLifecyclePolicy(
...
This class forms part of L<Paws>, documenting arguments for method DeleteLifecyclePolicy in L<Paws::MediaStore>
