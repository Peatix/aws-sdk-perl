...
package Paws::MediaStore::PutLifecyclePolicy;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::MediaStore::PutLifecyclePolicyOutput');
...
Paws::MediaStore::PutLifecyclePolicy - Arguments for method PutLifecyclePolicy on L<Paws::MediaStore>
...
This class forms part of L<Paws>, documenting arguments for method PutLifecyclePolicy in L<Paws::MediaStore>
