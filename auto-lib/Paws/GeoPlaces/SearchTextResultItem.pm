...
package Paws::GeoPlaces::SearchTextResultItem;
  use Moose;
...
Paws::GeoPlaces::SearchTextResultItem
...
As an example, if Att1 is expected to be a Paws::GeoPlaces::SearchTextResultItem object:

  $service_obj->Method(Att1 => { AccessPoints => $value, ..., Title => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::GeoPlaces::SearchTextResultItem object:
