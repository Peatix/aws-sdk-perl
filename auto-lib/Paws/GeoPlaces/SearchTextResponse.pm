...
package Paws::GeoPlaces::SearchTextResponse;
  use Moose;
  has NextToken => (is => 'ro', isa => 'Str');
  has PricingBucket => (is => 'ro', isa => 'Str', traits => ['ParamInHeader'], header_name => 'x-amz-geo-pricing-bucket', required => 1);
  has ResultItems => (is => 'ro', isa => 'ArrayRef[Paws::GeoPlaces::SearchTextResultItem]');
...
Paws::GeoPlaces::SearchTextResponse
...
=head2 ResultItems => ArrayRef[L<Paws::GeoPlaces::SearchTextResultItem>]
