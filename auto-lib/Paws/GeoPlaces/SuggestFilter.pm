...
package Paws::GeoPlaces::SuggestFilter;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::GeoPlaces::SuggestFilter object:

  $service_obj->Method(Att1 => { BoundingBox => $value, ..., IncludeCountries => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::GeoPlaces::SuggestFilter object:
