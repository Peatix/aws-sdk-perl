...
package Paws::GeoPlaces::AutocompleteFilter;
  use Moose;
...
Paws::GeoPlaces::AutocompleteFilter
...
As an example, if Att1 is expected to be a Paws::GeoPlaces::AutocompleteFilter object:

  $service_obj->Method(Att1 => { BoundingBox => $value, ..., IncludePlaceTypes => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::GeoPlaces::AutocompleteFilter object:
