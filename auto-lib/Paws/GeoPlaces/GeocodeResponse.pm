...
package Paws::GeoPlaces::GeocodeResponse;
  use Moose;
  has PricingBucket => (is => 'ro', isa => 'Str', traits => ['ParamInHeader'], header_name => 'x-amz-geo-pricing-bucket', required => 1);
  has ResultItems => (is => 'ro', isa => 'ArrayRef[Paws::GeoPlaces::GeocodeResultItem]');
...
Paws::GeoPlaces::GeocodeResponse
...
=head2 ResultItems => ArrayRef[L<Paws::GeoPlaces::GeocodeResultItem>]
