...
package Paws::Scheduler::AwsVpcConfiguration;
  use Moose;
...
Paws::Scheduler::AwsVpcConfiguration
...
As an example, if Att1 is expected to be a Paws::Scheduler::AwsVpcConfiguration object:

  $service_obj->Method(Att1 => { AssignPublicIp => $value, ..., Subnets => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Scheduler::AwsVpcConfiguration object:
