...
package Paws::Scheduler::UpdateSchedule;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Scheduler::UpdateScheduleOutput');
1;
...
Paws::Scheduler::UpdateSchedule - Arguments for method UpdateSchedule on L<Paws::Scheduler>
...
=head1 SYNOPSIS
    ...
    my $UpdateScheduleOutput = $scheduler->UpdateSchedule(
      FlexibleTimeWindow => {
    ...
    # Results:
    my $ScheduleArn = $UpdateScheduleOutput->ScheduleArn;

    # Returns a L<Paws::Scheduler::UpdateScheduleOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/scheduler/UpdateSchedule>
...
This class forms part of L<Paws>, documenting arguments for method UpdateSchedule in L<Paws::Scheduler>
