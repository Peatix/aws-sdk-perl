...
package Paws::Scheduler::PlacementConstraint;
  use Moose;
...
Paws::Scheduler::PlacementConstraint
...
As an example, if Att1 is expected to be a Paws::Scheduler::PlacementConstraint object:

  $service_obj->Method(Att1 => { Expression => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Scheduler::PlacementConstraint object:
