...
package Paws::SSMContacts::Plan;
  use Moose;
  has RotationIds => (is => 'ro', isa => 'ArrayRef[Str|Undef]');
  has Stages => (is => 'ro', isa => 'ArrayRef[Paws::SSMContacts::Stage]');
...
As an example, if Att1 is expected to be a Paws::SSMContacts::Plan object:
  ...
  $service_obj->Method(Att1 => { RotationIds => $value, ..., Stages => $value  });
...
=head2 RotationIds => ArrayRef[Str|Undef]

The Amazon Resource Names (ARNs) of the on-call rotations associated
with the plan.


=head2 Stages => ArrayRef[L<Paws::SSMContacts::Stage>]
