...
=head1 SYNOPSIS
   ...
   # To delete a contact
   # The following delete-contact example deletes a contact. The contact will no
   # longer be reachable from any escalation plan that refers to them.
    my $DeleteContactResult =
      $ssm -
