...
package Paws::SSMContacts::UntagResource;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::SSMContacts::UntagResourceResult');
...
Paws::SSMContacts::UntagResource - Arguments for method UntagResource on L<Paws::SSMContacts>
...
This class forms part of L<Paws>, documenting arguments for method UntagResource in L<Paws::SSMContacts>
