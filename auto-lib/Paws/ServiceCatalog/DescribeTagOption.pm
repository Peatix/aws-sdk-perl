...
=head1 SYNOPSIS
    ...
    my $DescribeTagOptionOutput = $servicecatalog->DescribeTagOption(
      Id => 'MyTagOptionId',

    );

    # Results:
    my $TagOptionDetail = $DescribeTagOptionOutput->TagOptionDetail;

    # Returns a L<Paws::ServiceCatalog::DescribeTagOptionOutput> object.
