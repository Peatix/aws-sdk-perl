...
package Paws::ServiceCatalog::DescribePortfolio;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'DescribePortfolio');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ServiceCatalog::DescribePortfolioOutput');
...
This class forms part of L<Paws>, documenting arguments for method DescribePortfolio in L<Paws::ServiceCatalog>
