...
package Paws::ElastiCache::BatchApplyUpdateAction;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'BatchApplyUpdateAction');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ElastiCache::UpdateActionResultsMessage');
  class_has _result_key => (isa => 'Str', is => 'ro', default => 'BatchApplyUpdateActionResult');
1;
...
Paws::ElastiCache::BatchApplyUpdateAction - Arguments for method BatchApplyUpdateAction on L<Paws::ElastiCache>

=head1 DESCRIPTION

This class represents the parameters used for calling the method BatchApplyUpdateAction on the
L<Amazon ElastiCache|Paws::ElastiCache> service. Use the attributes of this class
as arguments to method BatchApplyUpdateAction.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to BatchApplyUpdateAction.
...
This class forms part of L<Paws>, documenting arguments for method BatchApplyUpdateAction in L<Paws::ElastiCache>
