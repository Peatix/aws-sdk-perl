...
package Paws::ElastiCache::ExportServerlessCacheSnapshotResponse;
  use Moose;
...
Paws::ElastiCache::ExportServerlessCacheSnapshotResponse
...
millisecond. Available for Valkey, Redis OSS and Serverless Memcached
only.
