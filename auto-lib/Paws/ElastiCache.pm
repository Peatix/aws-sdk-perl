package Paws::ElastiCache;
  ...
  sub CopyServerlessCacheSnapshot {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ElastiCache::CopyServerlessCacheSnapshot', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub CopySnapshot {
    my $self = shift;
  ...
  sub CreateServerlessCache {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ElastiCache::CreateServerlessCache', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub CreateServerlessCacheSnapshot {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ElastiCache::CreateServerlessCacheSnapshot', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub CreateSnapshot {
    my $self = shift;
  ...
  sub DeleteServerlessCache {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ElastiCache::DeleteServerlessCache', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DeleteServerlessCacheSnapshot {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ElastiCache::DeleteServerlessCacheSnapshot', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DeleteSnapshot {
    my $self = shift;
  ...
  sub DescribeServerlessCaches {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ElastiCache::DescribeServerlessCaches', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DescribeServerlessCacheSnapshots {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ElastiCache::DescribeServerlessCacheSnapshots', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ExportServerlessCacheSnapshot {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ElastiCache::ExportServerlessCacheSnapshot', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ModifyServerlessCache {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ElastiCache::ModifyServerlessCache', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ModifyUser {
    my $self = shift;
  ...
  sub TestMigration {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ElastiCache::TestMigration', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeAllServerlessCaches {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->DescribeServerlessCaches(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->NextToken) {
        $next_result = $self->DescribeServerlessCaches(@_, NextToken => $next_result->NextToken);
        push @{ $result->ServerlessCaches }, @{ $next_result->ServerlessCaches };
      }
      return $result;
    } else {
      while ($result->NextToken) {
        $callback->($_ => 'ServerlessCaches') foreach (@{ $result->ServerlessCaches });
        $result = $self->DescribeServerlessCaches(@_, NextToken => $result->NextToken);
      }
      $callback->($_ => 'ServerlessCaches') foreach (@{ $result->ServerlessCaches });
    }
  ...
  sub DescribeAllServerlessCacheSnapshots {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->DescribeServerlessCacheSnapshots(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->NextToken) {
        $next_result = $self->DescribeServerlessCacheSnapshots(@_, NextToken => $next_result->NextToken);
        push @{ $result->ServerlessCacheSnapshots }, @{ $next_result->ServerlessCacheSnapshots };
      }
      return $result;
    } else {
      while ($result->NextToken) {
        $callback->($_ => 'ServerlessCacheSnapshots') foreach (@{ $result->ServerlessCacheSnapshots });
        $result = $self->DescribeServerlessCacheSnapshots(@_, NextToken => $result->NextToken);
      }
      $callback->($_ => 'ServerlessCacheSnapshots') foreach (@{ $result->ServerlessCacheSnapshots });
    }
...
ElastiCache
(https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/Tagging.html)
...
=head2 CopyServerlessCacheSnapshot

=over

=item SourceServerlessCacheSnapshotName => Str

=item TargetServerlessCacheSnapshotName => Str
...
Each argument is described in detail in: L<Paws::ElastiCache::CopyServerlessCacheSnapshot>

Returns: a L<Paws::ElastiCache::CopyServerlessCacheSnapshotResponse> instance

Creates a copy of an existing serverless cacheE<rsquo>s snapshot.
...
(https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/IAM.html).
...
=item [ClusterMode => Str]

=item [DataTieringEnabled => Bool]
...
=item [ServerlessCacheSnapshotName => Str]
...
=item [TransitEncryptionMode => Str]
...
1 to 90 shards (API/CLI: node groups). Each shard has a primary node
and up to 5 read-only replica nodes. The configuration can range from
90 shards and 0 replicas to 15 shards and 5 replicas, which is the
...
For example, you can choose to configure a 500 node cluster that ranges
...
it, up to a total of 5 read replicas. If you need to increase or
decrease the number of node groups (console: shards), you can use
scaling. For more information, see Scaling self-designed clusters
...
=head2 CreateServerlessCache

=over

=item Engine => Str

=item ServerlessCacheName => Str

=item [CacheUsageLimits => L<Paws::ElastiCache::CacheUsageLimits>]

=item [DailySnapshotTime => Str]
...
=item [SnapshotArnsToRestore => ArrayRef[Str|Undef]]
...
Each argument is described in detail in: L<Paws::ElastiCache::CreateServerlessCache>

Returns: a L<Paws::ElastiCache::CreateServerlessCacheResponse> instance

Creates a serverless cache.


=head2 CreateServerlessCacheSnapshot
...
Each argument is described in detail in: L<Paws::ElastiCache::CreateServerlessCacheSnapshot>

Returns: a L<Paws::ElastiCache::CreateServerlessCacheSnapshotResponse> instance
...
=item [AuthenticationMode => L<Paws::ElastiCache::AuthenticationMode>]
...
Each argument is described in detail in: L<Paws::ElastiCache::DeleteServerlessCache>

Returns: a L<Paws::ElastiCache::DeleteServerlessCacheResponse> instance

Deletes a specified existing serverless cache.

C<CreateServerlessCacheSnapshot> permission is required to create a
final snapshot. Without this permission, the API call will fail with an
C<Access Denied> exception.


=head2 DeleteServerlessCacheSnapshot
...
Each argument is described in detail in: L<Paws::ElastiCache::DeleteServerlessCacheSnapshot>

Returns: a L<Paws::ElastiCache::DeleteServerlessCacheSnapshotResponse> instance
...
=head2 DescribeServerlessCaches
...
Each argument is described in detail in: L<Paws::ElastiCache::DescribeServerlessCaches>

Returns: a L<Paws::ElastiCache::DescribeServerlessCachesResponse> instance
...
=head2 DescribeServerlessCacheSnapshots
...
Each argument is described in detail in: L<Paws::ElastiCache::DescribeServerlessCacheSnapshots>

Returns: a L<Paws::ElastiCache::DescribeServerlessCacheSnapshotsResponse> instance

Returns information about serverless cache snapshots. By default, this
API lists all of the customerE<rsquo>s serverless cache snapshots. It
...
=head2 ExportServerlessCacheSnapshot
...
Each argument is described in detail in: L<Paws::ElastiCache::ExportServerlessCacheSnapshot>

Returns: a L<Paws::ElastiCache::ExportServerlessCacheSnapshotResponse> instance
...
=item [ScaleConfig => L<Paws::ElastiCache::ScaleConfig>]
...
Each argument is described in detail in: L<Paws::ElastiCache::ModifyServerlessCache>

Returns: a L<Paws::ElastiCache::ModifyServerlessCacheResponse> instance
...
Represents the input of a C<TestFailover> operation which tests
...
same Valkey or Redis OSS (cluster mode enabled) replication group, the
first node replacement must complete before a subsequent call can be
made.
...
Each argument is described in detail in: L<Paws::ElastiCache::TestMigration>

Returns: a L<Paws::ElastiCache::TestMigrationResponse> instance
...
=head2 DescribeAllServerlessCaches(sub { },[MaxResults => Int, NextToken => Str, ServerlessCacheName => Str])

=head2 DescribeAllServerlessCaches([MaxResults => Int, NextToken => Str, ServerlessCacheName => Str])


If passed a sub as first parameter, it will call the sub for each element found in :

 - ServerlessCaches, passing the object as the first parameter, and the string 'ServerlessCaches' as the second parameter 

If not, it will return a a L<Paws::ElastiCache::DescribeServerlessCachesResponse> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.


=head2 DescribeAllServerlessCacheSnapshots(sub { },[MaxResults => Int, NextToken => Str, ServerlessCacheName => Str, ServerlessCacheSnapshotName => Str, SnapshotType => Str])

=head2 DescribeAllServerlessCacheSnapshots([MaxResults => Int, NextToken => Str, ServerlessCacheName => Str, ServerlessCacheSnapshotName => Str, SnapshotType => Str])


If passed a sub as first parameter, it will call the sub for each element found in :

 - ServerlessCacheSnapshots, passing the object as the first parameter, and the string 'ServerlessCacheSnapshots' as the second parameter 

If not, it will return a a L<Paws::ElastiCache::DescribeServerlessCacheSnapshotsResponse> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
