...
package Paws::IVSRealTime::PublicKeySummary;
  use Moose;
...
Paws::IVSRealTime::PublicKeySummary
...
As an example, if Att1 is expected to be a Paws::IVSRealTime::PublicKeySummary object:

  $service_obj->Method(Att1 => { Arn => $value, ..., Tags => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IVSRealTime::PublicKeySummary object:
