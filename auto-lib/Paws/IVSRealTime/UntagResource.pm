...
package Paws::IVSRealTime::UntagResource;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::IVSRealTime::UntagResourceResponse');
1;
...
Paws::IVSRealTime::UntagResource - Arguments for method UntagResource on L<Paws::IVSRealTime>
...
=head1 SYNOPSIS
    ...
    my $UntagResourceResponse = $ivsrealtime->UntagResource(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/ivsrealtime/UntagResource>
...
This class forms part of L<Paws>, documenting arguments for method UntagResource in L<Paws::IVSRealTime>
