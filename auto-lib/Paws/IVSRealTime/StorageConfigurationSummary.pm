...
package Paws::IVSRealTime::StorageConfigurationSummary;
  use Moose;
  has Arn => (is => 'ro', isa => 'Str', request_name => 'arn', traits => ['NameInRequest'], required => 1);
  has Name => (is => 'ro', isa => 'Str', request_name => 'name', traits => ['NameInRequest']);
  has S3 => (is => 'ro', isa => 'Paws::IVSRealTime::S3StorageConfiguration', request_name => 's3', traits => ['NameInRequest']);
...
Paws::IVSRealTime::StorageConfigurationSummary
...
As an example, if Att1 is expected to be a Paws::IVSRealTime::StorageConfigurationSummary object:

  $service_obj->Method(Att1 => { Arn => $value, ..., Tags => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IVSRealTime::StorageConfigurationSummary object:
...
=head2 S3 => L<Paws::IVSRealTime::S3StorageConfiguration>
