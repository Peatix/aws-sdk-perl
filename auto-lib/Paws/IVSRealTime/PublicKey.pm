...
package Paws::IVSRealTime::PublicKey;
  use Moose;
  has Arn => (is => 'ro', isa => 'Str', request_name => 'arn', traits => ['NameInRequest']);
  has Fingerprint => (is => 'ro', isa => 'Str', request_name => 'fingerprint', traits => ['NameInRequest']);
  has Name => (is => 'ro', isa => 'Str', request_name => 'name', traits => ['NameInRequest']);
  has PublicKeyMaterial => (is => 'ro', isa => 'Str', request_name => 'publicKeyMaterial', traits => ['NameInRequest']);
...
As an example, if Att1 is expected to be a Paws::IVSRealTime::PublicKey object:

  $service_obj->Method(Att1 => { Arn => $value, ..., Tags => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IVSRealTime::PublicKey object:
...
The public key fingerprint, a short string used to identify or verify
the full public key.
