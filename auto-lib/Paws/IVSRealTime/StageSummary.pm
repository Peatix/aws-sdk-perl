...
package Paws::IVSRealTime::StageSummary;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::IVSRealTime::StageSummary object:

  $service_obj->Method(Att1 => { ActiveSessionId => $value, ..., Tags => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IVSRealTime::StageSummary object:
