...
Paws::DAX::UntagResource - Arguments for method UntagResource on L<Paws::DAX>
...
=head1 SYNOPSIS
    ...
    my $UntagResourceResponse = $dax->UntagResource(
    ...
    # Results:
    my $Tags = $UntagResourceResponse->Tags;

    # Returns a L<Paws::DAX::UntagResourceResponse> object.
