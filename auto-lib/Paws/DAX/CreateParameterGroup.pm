...
Paws::DAX::CreateParameterGroup - Arguments for method CreateParameterGroup on L<Paws::DAX>
...
=head1 SYNOPSIS
    ...
    my $CreateParameterGroupResponse = $dax->CreateParameterGroup(
    ...
    # Returns a L<Paws::DAX::CreateParameterGroupResponse> object.
