...
package Paws::Route53RecoveryReadiness::ListRules;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Route53RecoveryReadiness::ListRulesResponse');
1;
...
Paws::Route53RecoveryReadiness::ListRules - Arguments for method ListRules on L<Paws::Route53RecoveryReadiness>
...
=head1 SYNOPSIS
    ...
    my $ListRulesResponse = $route53 -recovery-readiness->ListRules(
    ...
    # Returns a L<Paws::Route53RecoveryReadiness::ListRulesResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/route53-recovery-readiness/ListRules>
...
This class forms part of L<Paws>, documenting arguments for method ListRules in L<Paws::Route53RecoveryReadiness>
