...
package Paws::Route53RecoveryReadiness::ListResourceSets;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Route53RecoveryReadiness::ListResourceSetsResponse');
1;
...
Paws::Route53RecoveryReadiness::ListResourceSets - Arguments for method ListResourceSets on L<Paws::Route53RecoveryReadiness>
...
=head1 SYNOPSIS
 ...
 # Returns a L<Paws::Route53RecoveryReadiness::ListResourceSetsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/route53-recovery-readiness/ListResourceSets>
...
This class forms part of L<Paws>, documenting arguments for method ListResourceSets in L<Paws::Route53RecoveryReadiness>
