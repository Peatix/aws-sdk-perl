...
package Paws::Billing::GetResourcePolicy;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Billing::GetResourcePolicyResponse');
...
Paws::Billing::GetResourcePolicy - Arguments for method GetResourcePolicy on L<Paws::Billing>
...
=head1 SYNOPSIS
    ...
    my $GetResourcePolicyResponse = $billing->GetResourcePolicy(
    ...
    # Returns a L<Paws::Billing::GetResourcePolicyResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/billing/GetResourcePolicy>
...
This class forms part of L<Paws>, documenting arguments for method GetResourcePolicy in L<Paws::Billing>
