package Paws::Lightsail;
  ...
  sub CreateBucket {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Lightsail::CreateBucket', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub CreateBucketAccessKey {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Lightsail::CreateBucketAccessKey', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub CreateGUISessionAccessDetails {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Lightsail::CreateGUISessionAccessDetails', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub CreateInstances {
    my $self = shift;
  ...
  sub DeleteBucket {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Lightsail::DeleteBucket', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DeleteBucketAccessKey {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Lightsail::DeleteBucketAccessKey', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub GetBucketAccessKeys {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Lightsail::GetBucketAccessKeys', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetBucketBundles {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Lightsail::GetBucketBundles', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetBucketMetricData {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Lightsail::GetBucketMetricData', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetBuckets {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Lightsail::GetBuckets', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetBundles {
    my $self = shift;
  ...
  sub GetCostEstimate {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Lightsail::GetCostEstimate', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetDisk {
    my $self = shift;
  ...
  sub GetLoadBalancerTlsPolicies {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Lightsail::GetLoadBalancerTlsPolicies', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetOperation {
    my $self = shift;
  ...
  sub GetSetupHistory {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Lightsail::GetSetupHistory', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetStaticIp {
    my $self = shift;
  ...
  sub SetResourceAccessForBucket {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Lightsail::SetResourceAccessForBucket', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub SetupInstanceHttps {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Lightsail::SetupInstanceHttps', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub StartGUISession {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Lightsail::StartGUISession', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub StartInstance {
    my $self = shift;
  ...
  sub StopGUISession {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Lightsail::StopGUISession', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub StopInstance {
    my $self = shift;
  ...
  sub UpdateBucket {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Lightsail::UpdateBucket', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub UpdateBucketBundle {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Lightsail::UpdateBucketBundle', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub UpdateInstanceMetadataOptions {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Lightsail::UpdateInstanceMetadataOptions', @_);
    return $self->caller->do_call($self, $call_object);
  }
...
Services (Amazon Web Services) for developers who need to build
websites or web applications. It includes everything you need to launch
your project quickly - instances (virtual private servers), container
...
Only certificates created in the C<us-east-1> Amazon Web Services
...
However, all distributions are located in the C<us-east-1> Region.
...
C<load balancer name>. For more information, see the Lightsail
Developer Guide
(https://docs.aws.amazon.com/lightsail/latest/userguide/amazon-lightsail-controlling-access-using-tags).
...
access control via resource tags applied to the resource identified by
C<load balancer name>. For more information, see the Amazon Lightsail
Developer Guide
(https://docs.aws.amazon.com/lightsail/latest/userguide/amazon-lightsail-controlling-access-using-tags).
...
C<instanceName>. For more information, see the Amazon Lightsail
Developer Guide
(https://docs.aws.amazon.com/lightsail/latest/userguide/amazon-lightsail-controlling-access-using-tags).
...
=item [EnableObjectVersioning => Bool]
...
Each argument is described in detail in: L<Paws::Lightsail::CreateBucket>

Returns: a L<Paws::Lightsail::CreateBucketResult> instance
...
Each argument is described in detail in: L<Paws::Lightsail::CreateBucketAccessKey>

Returns: a L<Paws::Lightsail::CreateBucketAccessKeyResult> instance
...
more information about access keys, see Creating access keys for a
...
=item [PrivateRegistryAccess => L<Paws::Lightsail::PrivateRegistryAccessRequest>]
...
Lightsail instance in the same Availability Zone (C<us-east-2a>).
...
instance in the same Availability Zone (C<us-east-2a>).
...
=item [ViewerMinimumTlsProtocolVersion => Str]
...
=head2 CreateGUISessionAccessDetails
...
Each argument is described in detail in: L<Paws::Lightsail::CreateGUISessionAccessDetails>

Returns: a L<Paws::Lightsail::CreateGUISessionAccessDetailsResult> instance

Creates two URLs that are used to access a virtual computerE<rsquo>s
graphical user interface (GUI) session. The primary URL initiates a
web-based Amazon DCV session to the virtual computer's application. The
secondary URL initiates a web-based Amazon DCV session to the virtual
computer's operating session.

Use C<StartGUISession> to open the session.
...
Each argument is described in detail in: L<Paws::Lightsail::DeleteBucket>

Returns: a L<Paws::Lightsail::DeleteBucketResult> instance
...
Each argument is described in detail in: L<Paws::Lightsail::DeleteBucketAccessKey>

Returns: a L<Paws::Lightsail::DeleteBucketAccessKeyResult> instance
...
control via resource tags applied to the resource identified by
C<instance snapshot name>. For more information, see the Amazon
Lightsail Developer Guide
(https://docs.aws.amazon.com/lightsail/latest/userguide/amazon-lightsail-controlling-access-using-tags).
...
specifying a custom key pair, or you call the DownloadDefaultKeyPair
(https://docs.aws.amazon.com/lightsail/2016-11-28/api-reference/API_DownloadDefaultKeyPair.html)
API.
...
Each argument is described in detail in: L<Paws::Lightsail::GetBucketAccessKeys>

Returns: a L<Paws::Lightsail::GetBucketAccessKeysResult> instance
...
response of the CreateBucketAccessKey
...
Each argument is described in detail in: L<Paws::Lightsail::GetBucketBundles>

Returns: a L<Paws::Lightsail::GetBucketBundlesResult> instance
...
Each argument is described in detail in: L<Paws::Lightsail::GetBucketMetricData>

Returns: a L<Paws::Lightsail::GetBucketMetricDataResult> instance
...
=item [IncludeConnectedResources => Bool]
...
Each argument is described in detail in: L<Paws::Lightsail::GetBuckets>

Returns: a L<Paws::Lightsail::GetBucketsResult> instance
...
To get a summary of a certificate, omit C<includeCertificateDetails>
...
Each argument is described in detail in: L<Paws::Lightsail::GetCostEstimate>

Returns: a L<Paws::Lightsail::GetCostEstimateResult> instance
...
Returns all export snapshot records created as a result of the C<export
snapshot> operation.
...
control via resource tags applied to the resource identified by
C<instance name>. For more information, see the Amazon Lightsail
Developer Guide
(https://docs.aws.amazon.com/lightsail/latest/userguide/amazon-lightsail-controlling-access-using-tags).
...
=item [IncludeDefaultKeyPair => Bool]
...
=head2 GetLoadBalancerTlsPolicies
...
Each argument is described in detail in: L<Paws::Lightsail::GetLoadBalancerTlsPolicies>

Returns: a L<Paws::Lightsail::GetLoadBalancerTlsPoliciesResult> instance
...
Each argument is described in detail in: L<Paws::Lightsail::GetSetupHistory>

Returns: a L<Paws::Lightsail::GetSetupHistoryResult> instance

Returns detailed information for five of the most recent
C<SetupInstanceHttps> requests that were ran on the target instance.
...
=head2 SetResourceAccessForBucket
...
Each argument is described in detail in: L<Paws::Lightsail::SetResourceAccessForBucket>

Returns: a L<Paws::Lightsail::SetResourceAccessForBucketResult> instance
...
=head2 SetupInstanceHttps

=over

=item CertificateProvider => Str
...
Each argument is described in detail in: L<Paws::Lightsail::SetupInstanceHttps>

Returns: a L<Paws::Lightsail::SetupInstanceHttpsResult> instance
...
Each argument is described in detail in: L<Paws::Lightsail::StartGUISession>

Returns: a L<Paws::Lightsail::StartGUISessionResult> instance

Initiates a graphical user interface (GUI) session thatE<rsquo>s used
to access a virtual computerE<rsquo>s operating system and application.
...
Each argument is described in detail in: L<Paws::Lightsail::StopGUISession>

Returns: a L<Paws::Lightsail::StopGUISessionResult> instance

Terminates a web-based Amazon DCV session thatE<rsquo>s used to access
a virtual computerE<rsquo>s operating system or application. The
session will close and any unsaved data will be lost.
...
C<resource name>. For more information, see the Amazon Lightsail
Developer Guide
(https://docs.aws.amazon.com/lightsail/latest/userguide/amazon-lightsail-controlling-access-using-tags).
...
=item [AccessLogConfig => L<Paws::Lightsail::BucketAccessLogConfig>]

=item [AccessRules => L<Paws::Lightsail::AccessRules>]

=item [ReadonlyAccessAccounts => ArrayRef[Str|Undef]]
...
Each argument is described in detail in: L<Paws::Lightsail::UpdateBucket>

Returns: a L<Paws::Lightsail::UpdateBucketResult> instance
...
Each argument is described in detail in: L<Paws::Lightsail::UpdateBucketBundle>

Returns: a L<Paws::Lightsail::UpdateBucketBundleResult> instance
...
time within a monthly Amazon Web Services billing cycle. To determine
if you can update a bucket's bundle, use the GetBuckets
(https://docs.aws.amazon.com/lightsail/2016-11-28/api-reference/API_GetBuckets.html)
action. The C<ableToUpdateBundle> parameter in the response will
...
=item [UseDefaultCertificate => Bool]
...
update your distribution's bundle, use the C<GetDistributions> action.
The C<ableToUpdateBundle> parameter in the result will indicate whether
...
=head2 UpdateInstanceMetadataOptions
...
Each argument is described in detail in: L<Paws::Lightsail::UpdateInstanceMetadataOptions>

Returns: a L<Paws::Lightsail::UpdateInstanceMetadataOptionsResult> instance
...
instance, the C<GetInstance> or C<GetInstances> API operation initially
responds with a state of C<pending>. After the parameter modifications
are successfully applied, the state changes to C<applied> in subsequent
C<GetInstance> or C<GetInstances> API calls. For more information, see
Use IMDSv2 with an Amazon Lightsail instance
...
=head2 GetAllBlueprints(sub { },[AppCategory => Str, IncludeInactive => Bool, PageToken => Str])

=head2 GetAllBlueprints([AppCategory => Str, IncludeInactive => Bool, PageToken => Str])
...
=head2 GetAllBundles(sub { },[AppCategory => Str, IncludeInactive => Bool, PageToken => Str])

=head2 GetAllBundles([AppCategory => Str, IncludeInactive => Bool, PageToken => Str])
...
=head2 GetAllKeyPairs(sub { },[IncludeDefaultKeyPair => Bool, PageToken => Str])

=head2 GetAllKeyPairs([IncludeDefaultKeyPair => Bool, PageToken => Str])
...
=head2 GetAllRelationalDatabaseBundles(sub { },[IncludeInactive => Bool, PageToken => Str])

=head2 GetAllRelationalDatabaseBundles([IncludeInactive => Bool, PageToken => Str])
