...
package Paws::PCS::ClusterSummary;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::PCS::ClusterSummary object:

  $service_obj->Method(Att1 => { Arn => $value, ..., Status => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::PCS::ClusterSummary object:
...
The object returned by the C<ListClusters> API action.
