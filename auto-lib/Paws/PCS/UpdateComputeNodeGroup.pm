...
package Paws::PCS::UpdateComputeNodeGroup;
  use Moose;
  ...
  has CustomLaunchTemplate => (is => 'ro', isa => 'Paws::PCS::CustomLaunchTemplate', traits => ['NameInRequest'], request_name => 'customLaunchTemplate' );
  has IamInstanceProfileArn => (is => 'ro', isa => 'Str', traits => ['NameInRequest'], request_name => 'iamInstanceProfileArn' );
  has PurchaseOption => (is => 'ro', isa => 'Str', traits => ['NameInRequest'], request_name => 'purchaseOption' );
  has ScalingConfiguration => (is => 'ro', isa => 'Paws::PCS::ScalingConfigurationRequest', traits => ['NameInRequest'], request_name => 'scalingConfiguration' );
  has SlurmConfiguration => (is => 'ro', isa => 'Paws::PCS::UpdateComputeNodeGroupSlurmConfigurationRequest', traits => ['NameInRequest'], request_name => 'slurmConfiguration' );
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'UpdateComputeNodeGroup');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::PCS::UpdateComputeNodeGroupResponse');
...
Paws::PCS::UpdateComputeNodeGroup - Arguments for method UpdateComputeNodeGroup on L<Paws::PCS>

=head1 DESCRIPTION

This class represents the parameters used for calling the method UpdateComputeNodeGroup on the
L<AWS Parallel Computing Service|Paws::PCS> service. Use the attributes of this class
as arguments to method UpdateComputeNodeGroup.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to UpdateComputeNodeGroup.

=head1 SYNOPSIS

    my $pcs = Paws->service('PCS');
    my $UpdateComputeNodeGroupResponse = $pcs->UpdateComputeNodeGroup(
      ...
      IamInstanceProfileArn => 'MyInstanceProfileArn',                # OPTIONAL
    ...
    # Results:
    my $ComputeNodeGroup = $UpdateComputeNodeGroupResponse->ComputeNodeGroup;

    # Returns a L<Paws::PCS::UpdateComputeNodeGroupResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/pcs/UpdateComputeNodeGroup>
...
=head2 CustomLaunchTemplate => L<Paws::PCS::CustomLaunchTemplate>
...
=head2 ScalingConfiguration => L<Paws::PCS::ScalingConfigurationRequest>

Specifies the boundaries of the compute node group auto scaling.



=head2 SlurmConfiguration => L<Paws::PCS::UpdateComputeNodeGroupSlurmConfigurationRequest>
...
This class forms part of L<Paws>, documenting arguments for method UpdateComputeNodeGroup in L<Paws::PCS>
