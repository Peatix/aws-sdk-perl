...
package Paws::PCS::ListQueues;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::PCS::ListQueuesResponse');
...
Paws::PCS::ListQueues - Arguments for method ListQueues on L<Paws::PCS>
...
=head1 SYNOPSIS
    ...
    my $ListQueuesResponse = $pcs->ListQueues(
    ...
    # Returns a L<Paws::PCS::ListQueuesResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/pcs/ListQueues>
...
This class forms part of L<Paws>, documenting arguments for method ListQueues in L<Paws::PCS>
