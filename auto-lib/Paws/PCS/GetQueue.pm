...
package Paws::PCS::GetQueue;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::PCS::GetQueueResponse');
...
Paws::PCS::GetQueue - Arguments for method GetQueue on L<Paws::PCS>
...
=head1 SYNOPSIS
    ...
    my $GetQueueResponse = $pcs->GetQueue(
    ...
    # Results:
    my $Queue = $GetQueueResponse->Queue;

    # Returns a L<Paws::PCS::GetQueueResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/pcs/GetQueue>
...
This class forms part of L<Paws>, documenting arguments for method GetQueue in L<Paws::PCS>
