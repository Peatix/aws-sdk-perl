package Paws::GlueDataBrew;
  ...
  sub CreateRuleset {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::GlueDataBrew::CreateRuleset', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub CreateSchedule {
    my $self = shift;
  ...
  sub DeleteRuleset {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::GlueDataBrew::DeleteRuleset', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DeleteSchedule {
    my $self = shift;
  ...
  sub DescribeRuleset {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::GlueDataBrew::DescribeRuleset', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ListRulesets {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::GlueDataBrew::ListRulesets', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ListSchedules {
    my $self = shift;
  ...
  sub UpdateRuleset {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::GlueDataBrew::UpdateRuleset', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub UpdateSchedule {
    my $self = shift;
...
=item [Configuration => L<Paws::GlueDataBrew::ProfileConfiguration>]
...
=item [ValidationConfigurations => ArrayRef[L<Paws::GlueDataBrew::ValidationConfiguration>]]
...
=item [DatabaseOutputs => ArrayRef[L<Paws::GlueDataBrew::DatabaseOutput>]]
...
=item Rules => ArrayRef[L<Paws::GlueDataBrew::Rule>]
...
Each argument is described in detail in: L<Paws::GlueDataBrew::CreateRuleset>

Returns: a L<Paws::GlueDataBrew::CreateRulesetResponse> instance
...
Each argument is described in detail in: L<Paws::GlueDataBrew::DeleteRuleset>

Returns: a L<Paws::GlueDataBrew::DeleteRulesetResponse> instance
...
Each argument is described in detail in: L<Paws::GlueDataBrew::DescribeRuleset>

Returns: a L<Paws::GlueDataBrew::DescribeRulesetResponse> instance
...
Each argument is described in detail in: L<Paws::GlueDataBrew::ListRulesets>

Returns: a L<Paws::GlueDataBrew::ListRulesetsResponse> instance
...
Each argument is described in detail in: L<Paws::GlueDataBrew::UpdateRuleset>

Returns: a L<Paws::GlueDataBrew::UpdateRulesetResponse> instance
...
=head2 ListAllRulesets(sub { },[MaxResults => Int, NextToken => Str, TargetArn => Str])

=head2 ListAllRulesets([MaxResults => Int, NextToken => Str, TargetArn => Str])
...
If not, it will return a a L<Paws::GlueDataBrew::ListRulesetsResponse> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
