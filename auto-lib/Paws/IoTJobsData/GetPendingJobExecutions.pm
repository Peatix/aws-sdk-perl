...
package Paws::IoTJobsData::GetPendingJobExecutions;
  use Moose;
  has ThingName => (is => 'ro', isa => 'Str', traits => ['ParamInURI'], uri_name => 'thingName', required => 1);

  use MooseX::ClassAttribute;

  class_has _api_call => (isa => 'Str', is => 'ro', default => 'GetPendingJobExecutions');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/things/{thingName}/jobs');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::IoTJobsData::GetPendingJobExecutionsResponse');
1;
...
Paws::IoTJobsData::GetPendingJobExecutions - Arguments for method GetPendingJobExecutions on L<Paws::IoTJobsData>
...
This class forms part of L<Paws>, documenting arguments for method GetPendingJobExecutions in L<Paws::IoTJobsData>
