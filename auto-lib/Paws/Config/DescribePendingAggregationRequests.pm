...
=head1 SYNOPSIS
    ...
    my $DescribePendingAggregationRequestsResponse =
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/config/DescribePendingAggregationRequests>
