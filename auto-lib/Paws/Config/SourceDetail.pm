...
parameter values for C<SourceDetail> only for custom rules.
...
each valid value. For example, if you choose C<Three_Hours>, Config
runs evaluations once every three hours. In this case, C<Three_Hours>
