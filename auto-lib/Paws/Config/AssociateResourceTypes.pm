...
package Paws::Config::AssociateResourceTypes;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'AssociateResourceTypes');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Config::AssociateResourceTypesResponse');
...
Paws::Config::AssociateResourceTypes - Arguments for method AssociateResourceTypes on L<Paws::Config>

=head1 DESCRIPTION

This class represents the parameters used for calling the method AssociateResourceTypes on the
L<AWS Config|Paws::Config> service. Use the attributes of this class
as arguments to method AssociateResourceTypes.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to AssociateResourceTypes.

=head1 SYNOPSIS

    my $config = Paws->service('Config');
    my $AssociateResourceTypesResponse = $config->AssociateResourceTypes(
    ...
    my $ConfigurationRecorder =
      $AssociateResourceTypesResponse->ConfigurationRecorder;

    # Returns a L<Paws::Config::AssociateResourceTypesResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/config/AssociateResourceTypes>
...
This class forms part of L<Paws>, documenting arguments for method AssociateResourceTypes in L<Paws::Config>
