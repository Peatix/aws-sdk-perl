...
package Paws::Config::DisassociateResourceTypes;
  use Moose;
  has ConfigurationRecorderArn => (is => 'ro', isa => 'Str', required => 1);
  has ResourceTypes => (is => 'ro', isa => 'ArrayRef[Str|Undef]', required => 1);

  use MooseX::ClassAttribute;

  class_has _api_call => (isa => 'Str', is => 'ro', default => 'DisassociateResourceTypes');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Config::DisassociateResourceTypesResponse');
...
Paws::Config::DisassociateResourceTypes - Arguments for method DisassociateResourceTypes on L<Paws::Config>

=head1 DESCRIPTION

This class represents the parameters used for calling the method DisassociateResourceTypes on the
L<AWS Config|Paws::Config> service. Use the attributes of this class
as arguments to method DisassociateResourceTypes.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to DisassociateResourceTypes.

=head1 SYNOPSIS

    my $config = Paws->service('Config');
    my $DisassociateResourceTypesResponse = $config->DisassociateResourceTypes(
      ConfigurationRecorderArn => 'MyAmazonResourceName',
      ResourceTypes            => [
    ...
    # Results:
    my $ConfigurationRecorder =
      $DisassociateResourceTypesResponse->ConfigurationRecorder;

    # Returns a L<Paws::Config::DisassociateResourceTypesResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/config/DisassociateResourceTypes>

=head1 ATTRIBUTES


=head2 B<REQUIRED> ConfigurationRecorderArn => Str
...
The list of resource types you want to remove from the recording group
...
This class forms part of L<Paws>, documenting arguments for method DisassociateResourceTypes in L<Paws::Config>
