...
package Paws::Datasync::FsxUpdateProtocolSmb;
  use Moose;
...
Paws::Datasync::FsxUpdateProtocolSmb
...
As an example, if Att1 is expected to be a Paws::Datasync::FsxUpdateProtocolSmb object:

  $service_obj->Method(Att1 => { Domain => $value, ..., User => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Datasync::FsxUpdateProtocolSmb object:
