...
package Paws::Datasync::UpdateLocationAzureBlob;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'UpdateLocationAzureBlob');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Datasync::UpdateLocationAzureBlobResponse');
...
Paws::Datasync::UpdateLocationAzureBlob - Arguments for method UpdateLocationAzureBlob on L<Paws::Datasync>

=head1 DESCRIPTION

This class represents the parameters used for calling the method UpdateLocationAzureBlob on the
L<AWS DataSync|Paws::Datasync> service. Use the attributes of this class
as arguments to method UpdateLocationAzureBlob.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to UpdateLocationAzureBlob.

=head1 SYNOPSIS

    my $datasync = Paws->service('Datasync');
    my $UpdateLocationAzureBlobResponse = $datasync->UpdateLocationAzureBlob(
      LocationArn => 'MyLocationArn',
      AccessTier  => 'HOT',             # OPTIONAL
      AgentArns   => [
        'MyAgentArn', ...               # max: 128
      ],    # OPTIONAL
      AuthenticationType => 'SAS',      # OPTIONAL
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/datasync/UpdateLocationAzureBlob>
...
This class forms part of L<Paws>, documenting arguments for method UpdateLocationAzureBlob in L<Paws::Datasync>
