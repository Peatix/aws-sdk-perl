...
Paws::CognitoSync::ListIdentityPoolUsage - Arguments for method ListIdentityPoolUsage on L<Paws::CognitoSync>
...
=head1 SYNOPSIS
    ...
    my $ListIdentityPoolUsageResponse = $cognito -sync->ListIdentityPoolUsage(
