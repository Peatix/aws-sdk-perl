...
package Paws::Chatbot::DeleteSlackChannelConfiguration;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/delete-slack-channel-configuration');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Chatbot::DeleteSlackChannelConfigurationResult');
1;
...
Paws::Chatbot::DeleteSlackChannelConfiguration - Arguments for method DeleteSlackChannelConfiguration on L<Paws::Chatbot>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/chatbot/DeleteSlackChannelConfiguration>
...
This class forms part of L<Paws>, documenting arguments for method DeleteSlackChannelConfiguration in L<Paws::Chatbot>
