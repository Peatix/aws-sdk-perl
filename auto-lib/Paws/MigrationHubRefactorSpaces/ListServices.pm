...
package Paws::MigrationHubRefactorSpaces::ListServices;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::MigrationHubRefactorSpaces::ListServicesResponse');
1;
...
Paws::MigrationHubRefactorSpaces::ListServices - Arguments for method ListServices on L<Paws::MigrationHubRefactorSpaces>
...
=head1 SYNOPSIS
    ...
    my $ListServicesResponse = $refactor -spaces->ListServices(
   ...
   # Returns a L<Paws::MigrationHubRefactorSpaces::ListServicesResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/refactor-spaces/ListServices>
...
This class forms part of L<Paws>, documenting arguments for method ListServices in L<Paws::MigrationHubRefactorSpaces>
