...
package Paws::MigrationHubRefactorSpaces::ListApplications;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::MigrationHubRefactorSpaces::ListApplicationsResponse');
1;
...
Paws::MigrationHubRefactorSpaces::ListApplications - Arguments for method ListApplications on L<Paws::MigrationHubRefactorSpaces>
...
=head1 SYNOPSIS
    ...
    my $ListApplicationsResponse = $refactor -spaces->ListApplications(
    ...
    # Results:
    my $ApplicationSummaryList =
      $ListApplicationsResponse->ApplicationSummaryList;
    my $NextToken = $ListApplicationsResponse->NextToken;

# Returns a L<Paws::MigrationHubRefactorSpaces::ListApplicationsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/refactor-spaces/ListApplications>
...
This class forms part of L<Paws>, documenting arguments for method ListApplications in L<Paws::MigrationHubRefactorSpaces>
