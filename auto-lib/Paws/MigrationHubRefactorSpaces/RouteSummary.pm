...
package Paws::MigrationHubRefactorSpaces::RouteSummary;
  use Moose;
...
Paws::MigrationHubRefactorSpaces::RouteSummary
...
As an example, if Att1 is expected to be a Paws::MigrationHubRefactorSpaces::RouteSummary object:

  $service_obj->Method(Att1 => { AppendSourcePath => $value, ..., Tags => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MigrationHubRefactorSpaces::RouteSummary object:

  $result = $service_obj->Method(...);
  $result->Att1->AppendSourcePath

=head1 DESCRIPTION

The summary information for the routes as a response to C<ListRoutes>.
