...
package Paws::MigrationHubRefactorSpaces::DeleteRoute;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::MigrationHubRefactorSpaces::DeleteRouteResponse');
1;
...
Paws::MigrationHubRefactorSpaces::DeleteRoute - Arguments for method DeleteRoute on L<Paws::MigrationHubRefactorSpaces>
...
=head1 SYNOPSIS
    ...
    my $DeleteRouteResponse = $refactor -spaces->DeleteRoute(
    ...
    # Results:
    my $ApplicationId   = $DeleteRouteResponse->ApplicationId;
    my $Arn             = $DeleteRouteResponse->Arn;
    my $LastUpdatedTime = $DeleteRouteResponse->LastUpdatedTime;
    my $RouteId         = $DeleteRouteResponse->RouteId;
    my $ServiceId       = $DeleteRouteResponse->ServiceId;
    my $State           = $DeleteRouteResponse->State;

    # Returns a L<Paws::MigrationHubRefactorSpaces::DeleteRouteResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/refactor-spaces/DeleteRoute>
...
This class forms part of L<Paws>, documenting arguments for method DeleteRoute in L<Paws::MigrationHubRefactorSpaces>
