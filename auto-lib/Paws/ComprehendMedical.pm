package Paws::ComprehendMedical;
  ...
  sub DescribeSNOMEDCTInferenceJob {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ComprehendMedical::DescribeSNOMEDCTInferenceJob', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DetectEntities {
    my $self = shift;
  ...
  sub InferSNOMEDCT {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ComprehendMedical::InferSNOMEDCT', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ListSNOMEDCTInferenceJobs {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ComprehendMedical::ListSNOMEDCTInferenceJobs', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub StartSNOMEDCTInferenceJob {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ComprehendMedical::StartSNOMEDCTInferenceJob', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub StopSNOMEDCTInferenceJob {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ComprehendMedical::StopSNOMEDCTInferenceJob', @_);
    return $self->caller->do_call($self, $call_object);
  }
  


  sub operations { qw/DescribeEntitiesDetectionV2Job DescribeICD10CMInferenceJob DescribePHIDetectionJob DescribeRxNormInferenceJob DescribeSNOMEDCTInferenceJob DetectEntities DetectEntitiesV2 DetectPHI InferICD10CM InferRxNorm InferSNOMEDCT ListEntitiesDetectionV2Jobs ListICD10CMInferenceJobs ListPHIDetectionJobs ListRxNormInferenceJobs ListSNOMEDCTInferenceJobs StartEntitiesDetectionV2Job StartICD10CMInferenceJob StartPHIDetectionJob StartRxNormInferenceJob StartSNOMEDCTInferenceJob StopEntitiesDetectionV2Job StopICD10CMInferenceJob StopPHIDetectionJob StopRxNormInferenceJob StopSNOMEDCTInferenceJob / }
...
in the I<Amazon Comprehend Medical Developer Guide>.
...
=head2 DescribeSNOMEDCTInferenceJob
...
Each argument is described in detail in: L<Paws::ComprehendMedical::DescribeSNOMEDCTInferenceJob>

Returns: a L<Paws::ComprehendMedical::DescribeSNOMEDCTInferenceJobResponse> instance
...
Each argument is described in detail in: L<Paws::ComprehendMedical::InferSNOMEDCT>

Returns: a L<Paws::ComprehendMedical::InferSNOMEDCTResponse> instance
...
=head2 ListSNOMEDCTInferenceJobs
...
Each argument is described in detail in: L<Paws::ComprehendMedical::ListSNOMEDCTInferenceJobs>

Returns: a L<Paws::ComprehendMedical::ListSNOMEDCTInferenceJobsResponse> instance
...
=head2 StartSNOMEDCTInferenceJob
...
Each argument is described in detail in: L<Paws::ComprehendMedical::StartSNOMEDCTInferenceJob>

Returns: a L<Paws::ComprehendMedical::StartSNOMEDCTInferenceJobResponse> instance
...
=head2 StopSNOMEDCTInferenceJob
...
Each argument is described in detail in: L<Paws::ComprehendMedical::StopSNOMEDCTInferenceJob>

Returns: a L<Paws::ComprehendMedical::StopSNOMEDCTInferenceJobResponse> instance
