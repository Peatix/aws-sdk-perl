...
Welcome to the I<OpsWorks Stacks API Reference>. This guide provides
descriptions, syntax, and usage examples for OpsWorks Stacks actions
...
For information about OpsWorks, see the OpsWorks
(http://aws.amazon.com/opsworks/) information page.

B<SDKs and CLI>

Use the OpsWorks Stacks API by using the Command Line Interface (CLI)
or by using one of the Amazon Web Services SDKs to implement
...
B<Required Permissions>: To use this action, an Identity and Access
...
information, see the Elastic Load Balancing Developer Guide
...
should instead use the CLI C<register> command, which performs the
...
Stacks. For more information about how tagging works, see Tags
