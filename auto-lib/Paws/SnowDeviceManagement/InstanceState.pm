...
package Paws::SnowDeviceManagement::InstanceState;
  use Moose;
...
Paws::SnowDeviceManagement::InstanceState
...
As an example, if Att1 is expected to be a Paws::SnowDeviceManagement::InstanceState object:

  $service_obj->Method(Att1 => { Code => $value, ..., Name => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::SnowDeviceManagement::InstanceState object:
