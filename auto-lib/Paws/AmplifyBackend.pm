package Paws::AmplifyBackend;
  ...
  sub CreateBackendStorage {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AmplifyBackend::CreateBackendStorage', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub CreateToken {
    my $self = shift;
  ...
  sub DeleteBackendStorage {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AmplifyBackend::DeleteBackendStorage', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DeleteToken {
    my $self = shift;
  ...
  sub GetBackendStorage {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AmplifyBackend::GetBackendStorage', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetToken {
    my $self = shift;
  ...
  sub ImportBackendStorage {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AmplifyBackend::ImportBackendStorage', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ListBackendJobs {
    my $self = shift;
  ...
  sub ListS3Buckets {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AmplifyBackend::ListS3Buckets', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub UpdateBackendStorage {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::AmplifyBackend::UpdateBackendStorage', @_);
    return $self->caller->do_call($self, $call_object);
  }
...
=item ResourceConfig => L<Paws::AmplifyBackend::CreateBackendStorageResourceConfig>
...
Each argument is described in detail in: L<Paws::AmplifyBackend::CreateBackendStorage>

Returns: a L<Paws::AmplifyBackend::CreateBackendStorageResponse> instance
...
Each argument is described in detail in: L<Paws::AmplifyBackend::DeleteBackendStorage>

Returns: a L<Paws::AmplifyBackend::DeleteBackendStorageResponse> instance
...
Each argument is described in detail in: L<Paws::AmplifyBackend::GetBackendStorage>

Returns: a L<Paws::AmplifyBackend::GetBackendStorageResponse> instance
...
Each argument is described in detail in: L<Paws::AmplifyBackend::ImportBackendStorage>

Returns: a L<Paws::AmplifyBackend::ImportBackendStorageResponse> instance
...
Each argument is described in detail in: L<Paws::AmplifyBackend::ListS3Buckets>

Returns: a L<Paws::AmplifyBackend::ListS3BucketsResponse> instance
...
=item ResourceConfig => L<Paws::AmplifyBackend::UpdateBackendStorageResourceConfig>
...
Each argument is described in detail in: L<Paws::AmplifyBackend::UpdateBackendStorage>

Returns: a L<Paws::AmplifyBackend::UpdateBackendStorageResponse> instance
