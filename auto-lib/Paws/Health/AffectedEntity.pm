...
package Paws::Health::AffectedEntity;
  ...
  has EntityMetadata => (is => 'ro', isa => 'Paws::Health::EntityMetadata', request_name => 'entityMetadata', traits => ['NameInRequest']);
...
=head2 EntityMetadata => L<Paws::Health::EntityMetadata>
