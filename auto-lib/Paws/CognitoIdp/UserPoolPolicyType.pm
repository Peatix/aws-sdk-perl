...
package Paws::CognitoIdp::UserPoolPolicyType;
  ...
  has SignInPolicy => (is => 'ro', isa => 'Paws::CognitoIdp::SignInPolicyType');
...
As an example, if Att1 is expected to be a Paws::CognitoIdp::UserPoolPolicyType object:
  ...
  $service_obj->Method(Att1 => { PasswordPolicy => $value, ..., SignInPolicy => $value  });
...
=head2 SignInPolicy => L<Paws::CognitoIdp::SignInPolicyType>
