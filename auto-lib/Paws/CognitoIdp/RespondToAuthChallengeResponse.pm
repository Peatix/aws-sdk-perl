...
requests and challenge responses. If an C<InitiateAuth> or
C<RespondToAuthChallenge> API request results in a determination that
...
unmodified, to the next C<RespondToAuthChallenge> request.
