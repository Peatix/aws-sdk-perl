...
Cognito updates its value, this request doesnE<rsquo>t immediately
update the value of that attribute. After your user receives and
responds to a verification message to verify the new value, Amazon
