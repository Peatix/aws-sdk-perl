...
package Paws::CognitoIdp::DeleteUserAttributes;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'DeleteUserAttributes');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::CognitoIdp::DeleteUserAttributesResponse');
...
This class represents the parameters used for calling the method DeleteUserAttributes on the
L<Amazon Cognito Identity Provider|Paws::CognitoIdp> service. Use the attributes of this class
as arguments to method DeleteUserAttributes.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to DeleteUserAttributes.

=head1 SYNOPSIS

    my $cognito-idp = Paws->service('CognitoIdp');
    my $DeleteUserAttributesResponse = $cognito -idp->DeleteUserAttributes(
...
This class forms part of L<Paws>, documenting arguments for method DeleteUserAttributes in L<Paws::CognitoIdp>
