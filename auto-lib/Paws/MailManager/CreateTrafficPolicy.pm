...
package Paws::MailManager::CreateTrafficPolicy;
  use Moose;
  has ClientToken => (is => 'ro', isa => 'Str');
  has DefaultAction => (is => 'ro', isa => 'Str', required => 1);
  has MaxMessageSizeBytes => (is => 'ro', isa => 'Int');
  has PolicyStatements => (is => 'ro', isa => 'ArrayRef[Paws::MailManager::PolicyStatement]', required => 1);
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::MailManager::CreateTrafficPolicyResponse');
...
Paws::MailManager::CreateTrafficPolicy - Arguments for method CreateTrafficPolicy on L<Paws::MailManager>
...
=head1 SYNOPSIS
    ...
    my $CreateTrafficPolicyResponse = $mail -manager->CreateTrafficPolicy(
      DefaultAction    => 'ALLOW',
      PolicyStatements => [
        {
      ...
      TrafficPolicyName   => 'MyTrafficPolicyName',
    ...
    # Results:
    my $TrafficPolicyId = $CreateTrafficPolicyResponse->TrafficPolicyId;

    # Returns a L<Paws::MailManager::CreateTrafficPolicyResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/mail-manager/CreateTrafficPolicy>
...
=head2 B<REQUIRED> PolicyStatements => ArrayRef[L<Paws::MailManager::PolicyStatement>]
...
This class forms part of L<Paws>, documenting arguments for method CreateTrafficPolicy in L<Paws::MailManager>
