...
package Paws::MailManager::IngressIpv6ToEvaluate;
  use Moose;
...
Paws::MailManager::IngressIpv6ToEvaluate
...
As an example, if Att1 is expected to be a Paws::MailManager::IngressIpv6ToEvaluate object:

  $service_obj->Method(Att1 => { Attribute => $value, ..., Attribute => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MailManager::IngressIpv6ToEvaluate object:
