...
Paws::Route53Domains::EnableDomainTransferLock - Arguments for method EnableDomainTransferLock on L<Paws::Route53Domains>
...
=head1 SYNOPSIS
    ...
    my $EnableDomainTransferLockResponse =
    ...
    # Results:
    my $OperationId = $EnableDomainTransferLockResponse->OperationId;

   # Returns a L<Paws::Route53Domains::EnableDomainTransferLockResponse> object.
