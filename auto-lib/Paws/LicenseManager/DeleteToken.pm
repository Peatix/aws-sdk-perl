...
package Paws::LicenseManager::DeleteToken;
  use Moose;
  has TokenId => (is => 'ro', isa => 'Str', required => 1);

  use MooseX::ClassAttribute;

  class_has _api_call => (isa => 'Str', is => 'ro', default => 'DeleteToken');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::LicenseManager::DeleteTokenResponse');
...
Paws::LicenseManager::DeleteToken - Arguments for method DeleteToken on L<Paws::LicenseManager>
...
=head1 SYNOPSIS
    ...
    my $DeleteTokenResponse = $license -manager->DeleteToken(
      TokenId => 'MyString',
...
This class forms part of L<Paws>, documenting arguments for method DeleteToken in L<Paws::LicenseManager>
