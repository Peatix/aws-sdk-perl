...
package Paws::Pipes::PipeSourceKinesisStreamParameters;
  use Moose;
...
Paws::Pipes::PipeSourceKinesisStreamParameters
...
As an example, if Att1 is expected to be a Paws::Pipes::PipeSourceKinesisStreamParameters object:

  $service_obj->Method(Att1 => { BatchSize => $value, ..., StartingPositionTimestamp => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Pipes::PipeSourceKinesisStreamParameters object:
