...
package Paws::Pipes::PipeTargetHttpParameters;
  use Moose;
...
Paws::Pipes::PipeTargetHttpParameters
...
As an example, if Att1 is expected to be a Paws::Pipes::PipeTargetHttpParameters object:

  $service_obj->Method(Att1 => { HeaderParameters => $value, ..., QueryStringParameters => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Pipes::PipeTargetHttpParameters object:
