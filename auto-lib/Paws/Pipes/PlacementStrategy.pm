...
package Paws::Pipes::PlacementStrategy;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::Pipes::PlacementStrategy object:

  $service_obj->Method(Att1 => { Field => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Pipes::PlacementStrategy object:
