...
package Paws::Pipes::PipeEnrichmentHttpParameters;
  use Moose;
  has HeaderParameters => (is => 'ro', isa => 'Paws::Pipes::HeaderParametersMap');
  has PathParameterValues => (is => 'ro', isa => 'ArrayRef[Str|Undef]');
  has QueryStringParameters => (is => 'ro', isa => 'Paws::Pipes::QueryStringParametersMap');
...
Paws::Pipes::PipeEnrichmentHttpParameters
...
As an example, if Att1 is expected to be a Paws::Pipes::PipeEnrichmentHttpParameters object:

  $service_obj->Method(Att1 => { HeaderParameters => $value, ..., QueryStringParameters => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Pipes::PipeEnrichmentHttpParameters object:
...
=head2 HeaderParameters => L<Paws::Pipes::HeaderParametersMap>
...
=head2 QueryStringParameters => L<Paws::Pipes::QueryStringParametersMap>
