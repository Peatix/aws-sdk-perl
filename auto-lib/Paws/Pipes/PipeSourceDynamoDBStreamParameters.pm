...
package Paws::Pipes::PipeSourceDynamoDBStreamParameters;
  use Moose;
...
Paws::Pipes::PipeSourceDynamoDBStreamParameters
...
As an example, if Att1 is expected to be a Paws::Pipes::PipeSourceDynamoDBStreamParameters object:

  $service_obj->Method(Att1 => { BatchSize => $value, ..., StartingPosition => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Pipes::PipeSourceDynamoDBStreamParameters object:
