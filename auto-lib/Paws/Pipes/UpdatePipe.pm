...
package Paws::Pipes::UpdatePipe;
  ...
  has SourceParameters => (is => 'ro', isa => 'Paws::Pipes::UpdatePipeSourceParameters');
  has Target => (is => 'ro', isa => 'Str');
  has TargetParameters => (is => 'ro', isa => 'Paws::Pipes::PipeTargetParameters');

  use MooseX::ClassAttribute;

  class_has _api_call => (isa => 'Str', is => 'ro', default => 'UpdatePipe');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/v1/pipes/{Name}');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'PUT');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Pipes::UpdatePipeResponse');
1;
...
Paws::Pipes::UpdatePipe - Arguments for method UpdatePipe on L<Paws::Pipes>

=head1 DESCRIPTION

This class represents the parameters used for calling the method UpdatePipe on the
L<Amazon EventBridge Pipes|Paws::Pipes> service. Use the attributes of this class
as arguments to method UpdatePipe.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to UpdatePipe.

=head1 SYNOPSIS

    my $pipes = Paws->service('Pipes');
    my $UpdatePipeResponse = $pipes->UpdatePipe(
      Name                 => 'MyPipeName',
      RoleArn              => 'MyRoleArn',
      ...
      SourceParameters => {
        ...
        DynamoDBStreamParameters => {
          BatchSize        => 1,    # min: 1, max: 10000; OPTIONAL
          DeadLetterConfig => {
            Arn => 'MyArn',         # min: 1, max: 1600; OPTIONAL
          },    # OPTIONAL
          MaximumBatchingWindowInSeconds => 1,  # max: 300; OPTIONAL
    ...
    # Results:
    my $Arn              = $UpdatePipeResponse->Arn;
    my $CreationTime     = $UpdatePipeResponse->CreationTime;
    my $CurrentState     = $UpdatePipeResponse->CurrentState;
    my $DesiredState     = $UpdatePipeResponse->DesiredState;
    my $LastModifiedTime = $UpdatePipeResponse->LastModifiedTime;
    my $Name             = $UpdatePipeResponse->Name;

    # Returns a L<Paws::Pipes::UpdatePipeResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/pipes/UpdatePipe>
...
=head2 SourceParameters => L<Paws::Pipes::UpdatePipeSourceParameters>
...
This class forms part of L<Paws>, documenting arguments for method UpdatePipe in L<Paws::Pipes>
