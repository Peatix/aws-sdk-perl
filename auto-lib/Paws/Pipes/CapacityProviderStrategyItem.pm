...
package Paws::Pipes::CapacityProviderStrategyItem;
  use Moose;
...
Paws::Pipes::CapacityProviderStrategyItem
...
As an example, if Att1 is expected to be a Paws::Pipes::CapacityProviderStrategyItem object:

  $service_obj->Method(Att1 => { Base => $value, ..., Weight => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Pipes::CapacityProviderStrategyItem object:
