...
package Paws::Pipes::PlacementConstraint;
  use Moose;
...
Paws::Pipes::PlacementConstraint
...
As an example, if Att1 is expected to be a Paws::Pipes::PlacementConstraint object:

  $service_obj->Method(Att1 => { Expression => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Pipes::PlacementConstraint object:
