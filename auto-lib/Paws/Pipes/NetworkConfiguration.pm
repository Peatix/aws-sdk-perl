...
package Paws::Pipes::NetworkConfiguration;
  use Moose;
  has AwsvpcConfiguration => (is => 'ro', isa => 'Paws::Pipes::AwsVpcConfiguration', request_name => 'awsvpcConfiguration', traits => ['NameInRequest']);
...
Paws::Pipes::NetworkConfiguration
...
As an example, if Att1 is expected to be a Paws::Pipes::NetworkConfiguration object:

  $service_obj->Method(Att1 => { AwsvpcConfiguration => $value, ..., AwsvpcConfiguration => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Pipes::NetworkConfiguration object:
...
=head2 AwsvpcConfiguration => L<Paws::Pipes::AwsVpcConfiguration>
