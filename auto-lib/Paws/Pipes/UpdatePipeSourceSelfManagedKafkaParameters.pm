...
package Paws::Pipes::UpdatePipeSourceSelfManagedKafkaParameters;
  use Moose;
...
Paws::Pipes::UpdatePipeSourceSelfManagedKafkaParameters
...
As an example, if Att1 is expected to be a Paws::Pipes::UpdatePipeSourceSelfManagedKafkaParameters object:

  $service_obj->Method(Att1 => { BatchSize => $value, ..., Vpc => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Pipes::UpdatePipeSourceSelfManagedKafkaParameters object:
