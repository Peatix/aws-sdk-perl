...
package Paws::Pipes::EcsInferenceAcceleratorOverride;
  use Moose;
...
Paws::Pipes::EcsInferenceAcceleratorOverride
...
As an example, if Att1 is expected to be a Paws::Pipes::EcsInferenceAcceleratorOverride object:

  $service_obj->Method(Att1 => { DeviceName => $value, ..., DeviceType => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Pipes::EcsInferenceAcceleratorOverride object:
...
(https://docs.aws.amazon.com/AmazonECS/latest/userguide/ecs-inference.html)
