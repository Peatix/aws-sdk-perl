...
package Paws::Pipes::SageMakerPipelineParameter;
  use Moose;
...
Paws::Pipes::SageMakerPipelineParameter
...
As an example, if Att1 is expected to be a Paws::Pipes::SageMakerPipelineParameter object:

  $service_obj->Method(Att1 => { Name => $value, ..., Value => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Pipes::SageMakerPipelineParameter object:
