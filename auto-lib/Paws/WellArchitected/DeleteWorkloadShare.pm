...
package Paws::WellArchitected::DeleteWorkloadShare;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'DeleteWorkloadShare');
...
Paws::WellArchitected::DeleteWorkloadShare - Arguments for method DeleteWorkloadShare on L<Paws::WellArchitected>

=head1 DESCRIPTION

This class represents the parameters used for calling the method DeleteWorkloadShare on the
L<AWS Well-Architected Tool|Paws::WellArchitected> service. Use the attributes of this class
as arguments to method DeleteWorkloadShare.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to DeleteWorkloadShare.
...
This class forms part of L<Paws>, documenting arguments for method DeleteWorkloadShare in L<Paws::WellArchitected>
