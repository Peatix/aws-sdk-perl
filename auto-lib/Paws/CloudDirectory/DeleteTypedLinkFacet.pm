...
Paws::CloudDirectory::DeleteTypedLinkFacet - Arguments for method DeleteTypedLinkFacet on L<Paws::CloudDirectory>
...
=head1 SYNOPSIS
    ...
    my $DeleteTypedLinkFacetResponse = $clouddirectory->DeleteTypedLinkFacet(
