...
Paws::CloudDirectory::GetFacet - Arguments for method GetFacet on L<Paws::CloudDirectory>
...
=head1 SYNOPSIS
    ...
    my $GetFacetResponse = $clouddirectory->GetFacet(
      Name      => 'MyFacetName',
      SchemaArn => 'MyArn',
    ...
    # Results:
    my $Facet = $GetFacetResponse->Facet;

    # Returns a L<Paws::CloudDirectory::GetFacetResponse> object.
