...
Paws::CloudDirectory::DeleteSchema - Arguments for method DeleteSchema on L<Paws::CloudDirectory>
...
=head1 SYNOPSIS
    ...
    my $DeleteSchemaResponse = $clouddirectory->DeleteSchema(
      SchemaArn => 'MyArn',
    ...
    # Returns a L<Paws::CloudDirectory::DeleteSchemaResponse> object.
