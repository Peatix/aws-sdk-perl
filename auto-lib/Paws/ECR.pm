package Paws::ECR;
  ...
  sub BatchGetRepositoryScanningConfiguration {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ECR::BatchGetRepositoryScanningConfiguration', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub CreatePullThroughCacheRule {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ECR::CreatePullThroughCacheRule', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub CreateRepositoryCreationTemplate {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ECR::CreateRepositoryCreationTemplate', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DeletePullThroughCacheRule {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ECR::DeletePullThroughCacheRule', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DeleteRepositoryCreationTemplate {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ECR::DeleteRepositoryCreationTemplate', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeImageReplicationStatus {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ECR::DescribeImageReplicationStatus', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DescribeImages {
    my $self = shift;
  ...
  sub DescribePullThroughCacheRules {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ECR::DescribePullThroughCacheRules', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeRepositoryCreationTemplates {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ECR::DescribeRepositoryCreationTemplates', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetAccountSetting {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ECR::GetAccountSetting', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub GetRegistryScanningConfiguration {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ECR::GetRegistryScanningConfiguration', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub PutAccountSetting {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ECR::PutAccountSetting', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub PutImage {
    my $self = shift;
  ...
  sub PutRegistryScanningConfiguration {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ECR::PutRegistryScanningConfiguration', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub UpdatePullThroughCacheRule {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ECR::UpdatePullThroughCacheRule', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub UpdateRepositoryCreationTemplate {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ECR::UpdateRepositoryCreationTemplate', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub UploadLayerPart {
    my $self = shift;
  ...
  sub ValidatePullThroughCacheRule {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ECR::ValidatePullThroughCacheRule', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeAllImageScanFindings {
    ...
    if (not defined $callback) {
      while ($next_result->nextToken) {
        ...
        push @{ $result->imageScanFindings->enhancedFindings }, @{ $next_result->imageScanFindings->enhancedFindings };
      }
      return $result;
    } else {
      while ($result->nextToken) {
        $callback->($_ => 'imageScanFindings.findings') foreach (@{ $result->imageScanFindings->findings });
        $callback->($_ => 'imageScanFindings.enhancedFindings') foreach (@{ $result->imageScanFindings->enhancedFindings });
  ...
  sub DescribeAllPullThroughCacheRules {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->DescribePullThroughCacheRules(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->nextToken) {
        $next_result = $self->DescribePullThroughCacheRules(@_, nextToken => $next_result->nextToken);
        push @{ $result->pullThroughCacheRules }, @{ $next_result->pullThroughCacheRules };
      }
      return $result;
    } else {
      while ($result->nextToken) {
        $callback->($_ => 'pullThroughCacheRules') foreach (@{ $result->pullThroughCacheRules });
        $result = $self->DescribePullThroughCacheRules(@_, nextToken => $result->nextToken);
      }
      $callback->($_ => 'pullThroughCacheRules') foreach (@{ $result->pullThroughCacheRules });
    }
  ...
  sub DescribeAllRepositoryCreationTemplates {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->DescribeRepositoryCreationTemplates(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->nextToken) {
        $next_result = $self->DescribeRepositoryCreationTemplates(@_, nextToken => $next_result->nextToken);
        push @{ $result->repositoryCreationTemplates }, @{ $next_result->repositoryCreationTemplates };
      }
      return $result;
    } else {
      while ($result->nextToken) {
        $callback->($_ => 'repositoryCreationTemplates') foreach (@{ $result->repositoryCreationTemplates });
        $result = $self->DescribeRepositoryCreationTemplates(@_, nextToken => $result->nextToken);
      }
      $callback->($_ => 'repositoryCreationTemplates') foreach (@{ $result->repositoryCreationTemplates });
    }
  ...
  sub operations { qw/BatchCheckLayerAvailability BatchDeleteImage BatchGetImage BatchGetRepositoryScanningConfiguration CompleteLayerUpload CreatePullThroughCacheRule CreateRepository CreateRepositoryCreationTemplate DeleteLifecyclePolicy DeletePullThroughCacheRule DeleteRegistryPolicy DeleteRepository DeleteRepositoryCreationTemplate DeleteRepositoryPolicy DescribeImageReplicationStatus DescribeImages DescribeImageScanFindings DescribePullThroughCacheRules DescribeRegistry DescribeRepositories DescribeRepositoryCreationTemplates GetAccountSetting GetAuthorizationToken GetDownloadUrlForLayer GetLifecyclePolicy GetLifecyclePolicyPreview GetRegistryPolicy GetRegistryScanningConfiguration GetRepositoryPolicy InitiateLayerUpload ListImages ListTagsForResource PutAccountSetting PutImage PutImageScanningConfiguration PutImageTagMutability PutLifecyclePolicy PutRegistryPolicy PutRegistryScanningConfiguration PutReplicationConfiguration SetRepositoryPolicy StartImageScan StartLifecyclePolicyPreview TagResource UntagResource UpdatePullThroughCacheRule UpdateRepositoryCreationTemplate UploadLayerPart ValidatePullThroughCacheRule / }
...
Paws::ECR - Perl Interface to AWS Amazon Elastic Container Registry
...
=head2 BatchGetRepositoryScanningConfiguration
...
Each argument is described in detail in: L<Paws::ECR::BatchGetRepositoryScanningConfiguration>

Returns: a L<Paws::ECR::BatchGetRepositoryScanningConfigurationResponse> instance
...
=head2 CreatePullThroughCacheRule

=over

=item EcrRepositoryPrefix => Str

=item UpstreamRegistryUrl => Str

=item [CredentialArn => Str]

=item [CustomRoleArn => Str]

=item [RegistryId => Str]

=item [UpstreamRegistry => Str]

=item [UpstreamRepositoryPrefix => Str]


=back

Each argument is described in detail in: L<Paws::ECR::CreatePullThroughCacheRule>

Returns: a L<Paws::ECR::CreatePullThroughCacheRuleResponse> instance
...
=head2 CreateRepositoryCreationTemplate

=over

=item AppliedFor => ArrayRef[Str|Undef]
...
=item [EncryptionConfiguration => L<Paws::ECR::EncryptionConfigurationForRepositoryCreationTemplate>]

=item [ImageTagMutability => Str]

=item [LifecyclePolicy => Str]

=item [RepositoryPolicy => Str]

=item [ResourceTags => ArrayRef[L<Paws::ECR::Tag>]]


=back

Each argument is described in detail in: L<Paws::ECR::CreateRepositoryCreationTemplate>

Returns: a L<Paws::ECR::CreateRepositoryCreationTemplateResponse> instance
...
more information, see Private repository creation templates
...
=head2 DeletePullThroughCacheRule
...
Each argument is described in detail in: L<Paws::ECR::DeletePullThroughCacheRule>

Returns: a L<Paws::ECR::DeletePullThroughCacheRuleResponse> instance
...
delete the contents of the repository or use the C<force> option to
delete the repository and have Amazon ECR delete all of its contents on
your behalf.


=head2 DeleteRepositoryCreationTemplate
...
Each argument is described in detail in: L<Paws::ECR::DeleteRepositoryCreationTemplate>

Returns: a L<Paws::ECR::DeleteRepositoryCreationTemplateResponse> instance
...
=head2 DescribeImageReplicationStatus
...
Each argument is described in detail in: L<Paws::ECR::DescribeImageReplicationStatus>

Returns: a L<Paws::ECR::DescribeImageReplicationStatusResponse> instance
...
=head2 DescribePullThroughCacheRules

=over

=item [EcrRepositoryPrefixes => ArrayRef[Str|Undef]]
...
Each argument is described in detail in: L<Paws::ECR::DescribePullThroughCacheRules>

Returns: a L<Paws::ECR::DescribePullThroughCacheRulesResponse> instance
...
=head2 DescribeRepositoryCreationTemplates
...
=item [Prefixes => ArrayRef[Str|Undef]]


=back

Each argument is described in detail in: L<Paws::ECR::DescribeRepositoryCreationTemplates>

Returns: a L<Paws::ECR::DescribeRepositoryCreationTemplatesResponse> instance

Returns details about the repository creation templates in a registry.
The C<prefixes> request parameter can be used to return the details for
a specific repository creation template.


=head2 GetAccountSetting
...
Each argument is described in detail in: L<Paws::ECR::GetAccountSetting>

Returns: a L<Paws::ECR::GetAccountSettingResponse> instance
...
registry. The CLI offers an C<get-login-password> command that
...
=head2 GetRegistryScanningConfiguration
...
Each argument is described in detail in: L<Paws::ECR::GetRegistryScanningConfiguration>

Returns: a L<Paws::ECR::GetRegistryScanningConfigurationResponse> instance
...
Each argument is described in detail in: L<Paws::ECR::PutAccountSetting>

Returns: a L<Paws::ECR::PutAccountSettingResponse> instance
...
The C<PutImageScanningConfiguration> API is being deprecated, in favor
...
Services account and is used when configuring cross-account
replication. For more information, see Registry permissions
(https://docs.aws.amazon.com/AmazonECR/latest/userguide/registry-permissions.html)
in the I<Amazon Elastic Container Registry User Guide>.


=head2 PutRegistryScanningConfiguration

=over

=item [Rules => ArrayRef[L<Paws::ECR::RegistryScanningRule>]]
...
Each argument is described in detail in: L<Paws::ECR::PutRegistryScanningConfiguration>

Returns: a L<Paws::ECR::PutRegistryScanningConfigurationResponse> instance
...
in the I<Amazon Elastic Container Registry User Guide>. For more
...
the StartImageScan API. For more information, see Basic scanning
...
=head2 UpdatePullThroughCacheRule
...
Each argument is described in detail in: L<Paws::ECR::UpdatePullThroughCacheRule>

Returns: a L<Paws::ECR::UpdatePullThroughCacheRuleResponse> instance

Updates an existing pull through cache rule.


=head2 UpdateRepositoryCreationTemplate
...
Each argument is described in detail in: L<Paws::ECR::UpdateRepositoryCreationTemplate>

Returns: a L<Paws::ECR::UpdateRepositoryCreationTemplateResponse> instance
...
=head2 ValidatePullThroughCacheRule
...
Each argument is described in detail in: L<Paws::ECR::ValidatePullThroughCacheRule>

Returns: a L<Paws::ECR::ValidatePullThroughCacheRuleResponse> instance
...
If passed a sub as first parameter, it will call the sub for each element found in :
 ...
 - imageScanFindings.enhancedFindings, passing the object as the first parameter, and the string 'imageScanFindings.enhancedFindings' as the second parameter 

If not, it will return a a L<Paws::ECR::DescribeImageScanFindingsResponse> instance with all the C<param>s; andC<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.


=head2 DescribeAllPullThroughCacheRules(sub { },[EcrRepositoryPrefixes => ArrayRef[Str|Undef], MaxResults => Int, NextToken => Str, RegistryId => Str])

=head2 DescribeAllPullThroughCacheRules([EcrRepositoryPrefixes => ArrayRef[Str|Undef], MaxResults => Int, NextToken => Str, RegistryId => Str])


If passed a sub as first parameter, it will call the sub for each element found in :

 - pullThroughCacheRules, passing the object as the first parameter, and the string 'pullThroughCacheRules' as the second parameter 

If not, it will return a a L<Paws::ECR::DescribePullThroughCacheRulesResponse> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
...
=head2 DescribeAllRepositoryCreationTemplates(sub { },[MaxResults => Int, NextToken => Str, Prefixes => ArrayRef[Str|Undef]])

=head2 DescribeAllRepositoryCreationTemplates([MaxResults => Int, NextToken => Str, Prefixes => ArrayRef[Str|Undef]])


If passed a sub as first parameter, it will call the sub for each element found in :

 - repositoryCreationTemplates, passing the object as the first parameter, and the string 'repositoryCreationTemplates' as the second parameter 

If not, it will return a a L<Paws::ECR::DescribeRepositoryCreationTemplatesResponse> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
