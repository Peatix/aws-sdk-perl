...
recommend that you specify a I<different> Amazon S3 bucket or use a
I<separate path> in the same bucket (for example, use a log prefix or
...
C<Enabled> but you specify values for C<Bucket> and C<prefix>, the
