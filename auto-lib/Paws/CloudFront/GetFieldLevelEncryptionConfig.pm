...
package Paws::CloudFront::GetFieldLevelEncryptionConfig;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/2020-05-31/field-level-encryption/{Id}/config');
...
This class represents the parameters used for calling the method GetFieldLevelEncryptionConfig2020_05_31 on the
L<Amazon CloudFront|Paws::CloudFront> service. Use the attributes of this class
as arguments to method GetFieldLevelEncryptionConfig2020_05_31.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to GetFieldLevelEncryptionConfig2020_05_31.
...
This class forms part of L<Paws>, documenting arguments for method GetFieldLevelEncryptionConfig2020_05_31 in L<Paws::CloudFront>
