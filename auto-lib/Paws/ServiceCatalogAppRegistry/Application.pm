...
package Paws::ServiceCatalogAppRegistry::Application;
  use Moose;
  has ApplicationTag => (is => 'ro', isa => 'Paws::ServiceCatalogAppRegistry::ApplicationTagDefinition', request_name => 'applicationTag', traits => ['NameInRequest']);
  ...
  has Tags => (is => 'ro', isa => 'Paws::ServiceCatalogAppRegistry::Tags', request_name => 'tags', traits => ['NameInRequest']);
...
Paws::ServiceCatalogAppRegistry::Application
...
As an example, if Att1 is expected to be a Paws::ServiceCatalogAppRegistry::Application object:

  $service_obj->Method(Att1 => { ApplicationTag => $value, ..., Tags => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ServiceCatalogAppRegistry::Application object:
