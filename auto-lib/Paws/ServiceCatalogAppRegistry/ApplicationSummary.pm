...
package Paws::ServiceCatalogAppRegistry::ApplicationSummary;
  use Moose;
...
Paws::ServiceCatalogAppRegistry::ApplicationSummary
...
As an example, if Att1 is expected to be a Paws::ServiceCatalogAppRegistry::ApplicationSummary object:

  $service_obj->Method(Att1 => { Arn => $value, ..., Name => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ServiceCatalogAppRegistry::ApplicationSummary object:
