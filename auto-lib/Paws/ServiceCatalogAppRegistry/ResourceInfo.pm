...
package Paws::ServiceCatalogAppRegistry::ResourceInfo;
  use Moose;
...
Paws::ServiceCatalogAppRegistry::ResourceInfo
...
Use accessors for each attribute. If Att1 is expected to be an Paws::ServiceCatalogAppRegistry::ResourceInfo object:
