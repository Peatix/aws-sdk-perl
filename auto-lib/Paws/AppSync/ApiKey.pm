...
package Paws::AppSync::ApiKey;
  use Moose;
  has Deletes => (is => 'ro', isa => 'Int', request_name => 'deletes', traits => ['NameInRequest']);
...
C<ListApiKeys> returns the expiration time and deletion time in
seconds.

=item *

C<CreateApiKey> returns the expiration time and deletion time in
