...
Paws::AppSync::CognitoUserPoolConfig
...
As an example, if Att1 is expected to be a Paws::AppSync::CognitoUserPoolConfig object:

  $service_obj->Method(Att1 => { AppIdClientRegex => $value, ..., UserPoolId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::AppSync::CognitoUserPoolConfig object:
