...
package Paws::AppSync::UpdateChannelNamespace;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'UpdateChannelNamespace');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/v2/apis/{apiId}/channelNamespaces/{name}');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::AppSync::UpdateChannelNamespaceResponse');
1;
...
Paws::AppSync::UpdateChannelNamespace - Arguments for method UpdateChannelNamespace on L<Paws::AppSync>

=head1 DESCRIPTION

This class represents the parameters used for calling the method UpdateChannelNamespace on the
L<AWS AppSync|Paws::AppSync> service. Use the attributes of this class
as arguments to method UpdateChannelNamespace.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to UpdateChannelNamespace.

=head1 SYNOPSIS

    my $appsync = Paws->service('AppSync');
    my $UpdateChannelNamespaceResponse = $appsync->UpdateChannelNamespace(
      ApiId          => 'MyString',
      Name           => 'MyNamespace',
    ...
    # Results:
    my $ChannelNamespace = $UpdateChannelNamespaceResponse->ChannelNamespace;

    # Returns a L<Paws::AppSync::UpdateChannelNamespaceResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/appsync/UpdateChannelNamespace>
...
This class forms part of L<Paws>, documenting arguments for method UpdateChannelNamespace in L<Paws::AppSync>
