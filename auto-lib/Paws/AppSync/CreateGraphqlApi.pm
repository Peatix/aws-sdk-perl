...
package Paws::AppSync::CreateGraphqlApi;
  ...
  has ApiType => (is => 'ro', isa => 'Str', traits => ['NameInRequest'], request_name => 'apiType');
  ...
  has Visibility => (is => 'ro', isa => 'Str', traits => ['NameInRequest'], request_name => 'visibility');
...
Valid values are: C<"GLOBAL">, C<"PRIVATE">
