...
package Paws::AppSync::CognitoConfig;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::AppSync::CognitoConfig object:

  $service_obj->Method(Att1 => { AppIdClientRegex => $value, ..., UserPoolId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::AppSync::CognitoConfig object:
