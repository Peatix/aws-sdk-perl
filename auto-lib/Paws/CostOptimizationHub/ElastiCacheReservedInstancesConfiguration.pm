...
package Paws::CostOptimizationHub::ElastiCacheReservedInstancesConfiguration;
  use Moose;
...
Paws::CostOptimizationHub::ElastiCacheReservedInstancesConfiguration
...
As an example, if Att1 is expected to be a Paws::CostOptimizationHub::ElastiCacheReservedInstancesConfiguration object:

  $service_obj->Method(Att1 => { AccountScope => $value, ..., UpfrontCost => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CostOptimizationHub::ElastiCacheReservedInstancesConfiguration object:
