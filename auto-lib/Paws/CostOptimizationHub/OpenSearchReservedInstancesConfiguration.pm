...
package Paws::CostOptimizationHub::OpenSearchReservedInstancesConfiguration;
  use Moose;
...
Paws::CostOptimizationHub::OpenSearchReservedInstancesConfiguration
...
As an example, if Att1 is expected to be a Paws::CostOptimizationHub::OpenSearchReservedInstancesConfiguration object:

  $service_obj->Method(Att1 => { AccountScope => $value, ..., UpfrontCost => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CostOptimizationHub::OpenSearchReservedInstancesConfiguration object:
