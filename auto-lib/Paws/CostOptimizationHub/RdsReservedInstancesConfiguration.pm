...
package Paws::CostOptimizationHub::RdsReservedInstancesConfiguration;
  use Moose;
  ...
  has DatabaseEdition => (is => 'ro', isa => 'Str', request_name => 'databaseEdition', traits => ['NameInRequest']);
  has DatabaseEngine => (is => 'ro', isa => 'Str', request_name => 'databaseEngine', traits => ['NameInRequest']);
...
Paws::CostOptimizationHub::RdsReservedInstancesConfiguration
...
As an example, if Att1 is expected to be a Paws::CostOptimizationHub::RdsReservedInstancesConfiguration object:

  $service_obj->Method(Att1 => { AccountScope => $value, ..., UpfrontCost => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CostOptimizationHub::RdsReservedInstancesConfiguration object:
