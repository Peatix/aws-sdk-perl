...
package Paws::RedshiftServerless::RestoreTableFromSnapshot;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'RestoreTableFromSnapshot');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::RedshiftServerless::RestoreTableFromSnapshotResponse');
...
Paws::RedshiftServerless::RestoreTableFromSnapshot - Arguments for method RestoreTableFromSnapshot on L<Paws::RedshiftServerless>

=head1 DESCRIPTION

This class represents the parameters used for calling the method RestoreTableFromSnapshot on the
L<Redshift Serverless|Paws::RedshiftServerless> service. Use the attributes of this class
as arguments to method RestoreTableFromSnapshot.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to RestoreTableFromSnapshot.

=head1 SYNOPSIS

    my $redshift-serverless = Paws->service('RedshiftServerless');
    my $RestoreTableFromSnapshotResponse =
...
# Returns a L<Paws::RedshiftServerless::RestoreTableFromSnapshotResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/redshift-serverless/RestoreTableFromSnapshot>
...
This class forms part of L<Paws>, documenting arguments for method RestoreTableFromSnapshot in L<Paws::RedshiftServerless>
