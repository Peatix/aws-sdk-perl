...
package Paws::RedshiftServerless::UpdateWorkgroup;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::RedshiftServerless::UpdateWorkgroupResponse');
...
Paws::RedshiftServerless::UpdateWorkgroup - Arguments for method UpdateWorkgroup on L<Paws::RedshiftServerless>
...
=head1 SYNOPSIS
    ...
    my $UpdateWorkgroupResponse = $redshift -serverless->UpdateWorkgroup(
    ...
    # Results:
    my $Workgroup = $UpdateWorkgroupResponse->Workgroup;

    # Returns a L<Paws::RedshiftServerless::UpdateWorkgroupResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/redshift-serverless/UpdateWorkgroup>
...
This class forms part of L<Paws>, documenting arguments for method UpdateWorkgroup in L<Paws::RedshiftServerless>
