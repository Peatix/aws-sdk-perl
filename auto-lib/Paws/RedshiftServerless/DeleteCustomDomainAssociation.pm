...
package Paws::RedshiftServerless::DeleteCustomDomainAssociation;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::RedshiftServerless::DeleteCustomDomainAssociationResponse');
...
Paws::RedshiftServerless::DeleteCustomDomainAssociation - Arguments for method DeleteCustomDomainAssociation on L<Paws::RedshiftServerless>
...
=head1 SYNOPSIS
    ...
    my $DeleteCustomDomainAssociationResponse =
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/redshift-serverless/DeleteCustomDomainAssociation>
...
This class forms part of L<Paws>, documenting arguments for method DeleteCustomDomainAssociation in L<Paws::RedshiftServerless>
