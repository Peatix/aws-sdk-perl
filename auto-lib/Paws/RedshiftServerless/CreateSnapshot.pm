...
package Paws::RedshiftServerless::CreateSnapshot;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::RedshiftServerless::CreateSnapshotResponse');
...
Paws::RedshiftServerless::CreateSnapshot - Arguments for method CreateSnapshot on L<Paws::RedshiftServerless>
...
=head1 SYNOPSIS
    ...
    my $CreateSnapshotResponse = $redshift -serverless->CreateSnapshot(
    ...
    # Returns a L<Paws::RedshiftServerless::CreateSnapshotResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/redshift-serverless/CreateSnapshot>
...
This class forms part of L<Paws>, documenting arguments for method CreateSnapshot in L<Paws::RedshiftServerless>
