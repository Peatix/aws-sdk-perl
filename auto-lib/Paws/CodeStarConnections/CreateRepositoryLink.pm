...
package Paws::CodeStarConnections::CreateRepositoryLink;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::CodeStarConnections::CreateRepositoryLinkOutput');
...
Paws::CodeStarConnections::CreateRepositoryLink - Arguments for method CreateRepositoryLink on L<Paws::CodeStarConnections>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::CodeStarConnections::CreateRepositoryLinkOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/codestar-connections/CreateRepositoryLink>
...
This class forms part of L<Paws>, documenting arguments for method CreateRepositoryLink in L<Paws::CodeStarConnections>
