...
package Paws::CodeStarConnections::RepositorySyncEvent;
  use Moose;
...
Paws::CodeStarConnections::RepositorySyncEvent
...
As an example, if Att1 is expected to be a Paws::CodeStarConnections::RepositorySyncEvent object:

  $service_obj->Method(Att1 => { Event => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CodeStarConnections::RepositorySyncEvent object:
