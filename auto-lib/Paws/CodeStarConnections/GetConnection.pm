...
package Paws::CodeStarConnections::GetConnection;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::CodeStarConnections::GetConnectionOutput');
...
Paws::CodeStarConnections::GetConnection - Arguments for method GetConnection on L<Paws::CodeStarConnections>
...
=head1 SYNOPSIS
    ...
    my $GetConnectionOutput = $codestar -connections->GetConnection(
    ...
    # Returns a L<Paws::CodeStarConnections::GetConnectionOutput> object.
...
This class forms part of L<Paws>, documenting arguments for method GetConnection in L<Paws::CodeStarConnections>
