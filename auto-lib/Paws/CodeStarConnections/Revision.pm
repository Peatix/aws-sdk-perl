...
package Paws::CodeStarConnections::Revision;
  use Moose;
...
Paws::CodeStarConnections::Revision
...
As an example, if Att1 is expected to be a Paws::CodeStarConnections::Revision object:

  $service_obj->Method(Att1 => { Branch => $value, ..., Sha => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CodeStarConnections::Revision object:
