...
package Paws::CodeStarConnections::RepositorySyncAttempt;
  use Moose;
  has Events => (is => 'ro', isa => 'ArrayRef[Paws::CodeStarConnections::RepositorySyncEvent]', required => 1);
...
Paws::CodeStarConnections::RepositorySyncAttempt
...
As an example, if Att1 is expected to be a Paws::CodeStarConnections::RepositorySyncAttempt object:

  $service_obj->Method(Att1 => { Events => $value, ..., Status => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CodeStarConnections::RepositorySyncAttempt object:
...
=head2 B<REQUIRED> Events => ArrayRef[L<Paws::CodeStarConnections::RepositorySyncEvent>]
