...
package Paws::CodeStarConnections::DeleteSyncConfiguration;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::CodeStarConnections::DeleteSyncConfigurationOutput');
...
Paws::CodeStarConnections::DeleteSyncConfiguration - Arguments for method DeleteSyncConfiguration on L<Paws::CodeStarConnections>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/codestar-connections/DeleteSyncConfiguration>
...
This class forms part of L<Paws>, documenting arguments for method DeleteSyncConfiguration in L<Paws::CodeStarConnections>
