...
package Paws::CodeStarConnections::DeleteRepositoryLink;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::CodeStarConnections::DeleteRepositoryLinkOutput');
...
Paws::CodeStarConnections::DeleteRepositoryLink - Arguments for method DeleteRepositoryLink on L<Paws::CodeStarConnections>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/codestar-connections/DeleteRepositoryLink>
...
This class forms part of L<Paws>, documenting arguments for method DeleteRepositoryLink in L<Paws::CodeStarConnections>
