...
package Paws::CodeStarConnections::SyncConfiguration;
  use Moose;
...
Paws::CodeStarConnections::SyncConfiguration
...
As an example, if Att1 is expected to be a Paws::CodeStarConnections::SyncConfiguration object:

  $service_obj->Method(Att1 => { Branch => $value, ..., TriggerResourceUpdateOn => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CodeStarConnections::SyncConfiguration object:
