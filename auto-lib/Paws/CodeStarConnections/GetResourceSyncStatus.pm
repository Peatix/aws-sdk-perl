...
package Paws::CodeStarConnections::GetResourceSyncStatus;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::CodeStarConnections::GetResourceSyncStatusOutput');
...
Paws::CodeStarConnections::GetResourceSyncStatus - Arguments for method GetResourceSyncStatus on L<Paws::CodeStarConnections>
...
=head1 SYNOPSIS
    ...
    my $GetResourceSyncStatusOutput =
   ...
   # Returns a L<Paws::CodeStarConnections::GetResourceSyncStatusOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/codestar-connections/GetResourceSyncStatus>
...
This class forms part of L<Paws>, documenting arguments for method GetResourceSyncStatus in L<Paws::CodeStarConnections>
