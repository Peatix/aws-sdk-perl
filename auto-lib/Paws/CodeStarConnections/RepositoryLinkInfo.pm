...
package Paws::CodeStarConnections::RepositoryLinkInfo;
  use Moose;
...
Paws::CodeStarConnections::RepositoryLinkInfo
...
As an example, if Att1 is expected to be a Paws::CodeStarConnections::RepositoryLinkInfo object:

  $service_obj->Method(Att1 => { ConnectionArn => $value, ..., RepositoryName => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CodeStarConnections::RepositoryLinkInfo object:
