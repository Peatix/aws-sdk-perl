...
=head1 SYNOPSIS
    ...
    my $PurchaseOfferingResponse = $mediaconnect->PurchaseOffering(
      OfferingArn     => 'MyString',
      ReservationName => 'MyString',
      Start           => 'MyString',
...
C<YYYY-MM-DDTHH:mm:SSZ>, where C<T> and C<Z> are literal characters.
For example, to specify 11:30pm on March 5, 2020, enter
C<2020-03-05T23:30:00Z>.
