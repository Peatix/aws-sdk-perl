...
package Paws::MediaConnect::BridgeNetworkOutput;
  use Moose;
...
Paws::MediaConnect::BridgeNetworkOutput
...
As an example, if Att1 is expected to be a Paws::MediaConnect::BridgeNetworkOutput object:

  $service_obj->Method(Att1 => { IpAddress => $value, ..., Ttl => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MediaConnect::BridgeNetworkOutput object:
