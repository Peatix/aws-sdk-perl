...
package Paws::MediaConnect::ListGateways;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::MediaConnect::ListGatewaysResponse');
1;
...
Paws::MediaConnect::ListGateways - Arguments for method ListGateways on L<Paws::MediaConnect>
...
=head1 SYNOPSIS
    ...
    my $ListGatewaysResponse = $mediaconnect->ListGateways(
    ...
    # Returns a L<Paws::MediaConnect::ListGatewaysResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/mediaconnect/ListGateways>
...
more than the first 5 items. (The service also returns a C<NextToken>
...
This class forms part of L<Paws>, documenting arguments for method ListGateways in L<Paws::MediaConnect>
