...
package Paws::MediaConnect::SetGatewayBridgeSourceRequest;
  use Moose;
...
Paws::MediaConnect::SetGatewayBridgeSourceRequest
...
As an example, if Att1 is expected to be a Paws::MediaConnect::SetGatewayBridgeSourceRequest object:

  $service_obj->Method(Att1 => { BridgeArn => $value, ..., VpcInterfaceAttachment => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MediaConnect::SetGatewayBridgeSourceRequest object:
