...
For example, you submit a C<ListEntitlements> request with set at 5.
...
For example, you submit a C<ListEntitlements> request with
...
you can submit the C<ListEntitlements> request a second time and
