...
package Paws::MediaConnect::MessageDetail;
  use Moose;
...
Paws::MediaConnect::MessageDetail
...
As an example, if Att1 is expected to be a Paws::MediaConnect::MessageDetail object:

  $service_obj->Method(Att1 => { Code => $value, ..., ResourceName => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MediaConnect::MessageDetail object:
