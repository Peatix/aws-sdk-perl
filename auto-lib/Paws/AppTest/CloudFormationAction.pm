...
package Paws::AppTest::CloudFormationAction;
  use Moose;
...
Paws::AppTest::CloudFormationAction
...
As an example, if Att1 is expected to be a Paws::AppTest::CloudFormationAction object:

  $service_obj->Method(Att1 => { ActionType => $value, ..., Resource => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::AppTest::CloudFormationAction object:
