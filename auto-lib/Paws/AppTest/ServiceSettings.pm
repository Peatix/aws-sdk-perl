...
package Paws::AppTest::ServiceSettings;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::AppTest::ServiceSettings object:

  $service_obj->Method(Att1 => { KmsKeyId => $value, ..., KmsKeyId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::AppTest::ServiceSettings object:
