...
package Paws::AppTest::TestConfigurationLatestVersion;
  use Moose;
...
Paws::AppTest::TestConfigurationLatestVersion
...
As an example, if Att1 is expected to be a Paws::AppTest::TestConfigurationLatestVersion object:

  $service_obj->Method(Att1 => { Status => $value, ..., Version => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::AppTest::TestConfigurationLatestVersion object:
