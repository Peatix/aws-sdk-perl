...
package Paws::Neptunedata::QueryLanguageVersion;
  use Moose;
...
Paws::Neptunedata::QueryLanguageVersion
...
As an example, if Att1 is expected to be a Paws::Neptunedata::QueryLanguageVersion object:

  $service_obj->Method(Att1 => { Version => $value, ..., Version => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Neptunedata::QueryLanguageVersion object:
