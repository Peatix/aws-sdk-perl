...
package Paws::Neptunedata::GetSparqlStream;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'GetSparqlStream');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/sparql/stream');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Neptunedata::GetSparqlStreamOutput');
1;
...
Paws::Neptunedata::GetSparqlStream - Arguments for method GetSparqlStream on L<Paws::Neptunedata>

=head1 DESCRIPTION

This class represents the parameters used for calling the method GetSparqlStream on the
L<Amazon NeptuneData|Paws::Neptunedata> service. Use the attributes of this class
as arguments to method GetSparqlStream.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to GetSparqlStream.

=head1 SYNOPSIS

    my $neptune-db = Paws->service('Neptunedata');
    my $GetSparqlStreamOutput = $neptune -db->GetSparqlStream(
    ...
    # Results:
    my $Format      = $GetSparqlStreamOutput->Format;
    my $LastEventId = $GetSparqlStreamOutput->LastEventId;
    my $LastTrxTimestampInMillis =
      $GetSparqlStreamOutput->LastTrxTimestampInMillis;
    my $Records      = $GetSparqlStreamOutput->Records;
    my $TotalRecords = $GetSparqlStreamOutput->TotalRecords;

    # Returns a L<Paws::Neptunedata::GetSparqlStreamOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/neptune-db/GetSparqlStream>
...
This class forms part of L<Paws>, documenting arguments for method GetSparqlStream in L<Paws::Neptunedata>
