...
package Paws::Neptunedata::GetSparqlStreamOutput;
  use Moose;
  ...
  has Records => (is => 'ro', isa => 'ArrayRef[Paws::Neptunedata::SparqlRecord]', traits => ['NameInRequest'], request_name => 'records', required => 1);
...
Paws::Neptunedata::GetSparqlStreamOutput
...
the only supported value is C<NQUADS>.
...
=head2 B<REQUIRED> Records => ArrayRef[L<Paws::Neptunedata::SparqlRecord>]
