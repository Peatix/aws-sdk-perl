...
package Paws::Ivschat::DeleteRoom;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/DeleteRoom');
...
Paws::Ivschat::DeleteRoom - Arguments for method DeleteRoom on L<Paws::Ivschat>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/ivschat/DeleteRoom>
...
This class forms part of L<Paws>, documenting arguments for method DeleteRoom in L<Paws::Ivschat>
