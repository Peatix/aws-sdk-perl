...
package Paws::Ivschat::RoomSummary;
  use Moose;
  has Arn => (is => 'ro', isa => 'Str', request_name => 'arn', traits => ['NameInRequest']);
  has CreateTime => (is => 'ro', isa => 'Str', request_name => 'createTime', traits => ['NameInRequest']);
  has Id => (is => 'ro', isa => 'Str', request_name => 'id', traits => ['NameInRequest']);
  has LoggingConfigurationIdentifiers => (is => 'ro', isa => 'ArrayRef[Str|Undef]', request_name => 'loggingConfigurationIdentifiers', traits => ['NameInRequest']);
  has MessageReviewHandler => (is => 'ro', isa => 'Paws::Ivschat::MessageReviewHandler', request_name => 'messageReviewHandler', traits => ['NameInRequest']);
...
As an example, if Att1 is expected to be a Paws::Ivschat::RoomSummary object:

  $service_obj->Method(Att1 => { Arn => $value, ..., UpdateTime => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Ivschat::RoomSummary object:
