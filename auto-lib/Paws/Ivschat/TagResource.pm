...
package Paws::Ivschat::TagResource;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Ivschat::TagResourceResponse');
1;
...
Paws::Ivschat::TagResource - Arguments for method TagResource on L<Paws::Ivschat>
...
=head1 SYNOPSIS
    ...
    my $TagResourceResponse = $ivschat->TagResource(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/ivschat/TagResource>
...
This class forms part of L<Paws>, documenting arguments for method TagResource in L<Paws::Ivschat>
