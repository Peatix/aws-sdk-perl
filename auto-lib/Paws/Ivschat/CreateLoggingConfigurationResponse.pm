...
package Paws::Ivschat::CreateLoggingConfigurationResponse;
  use Moose;
...
Paws::Ivschat::CreateLoggingConfigurationResponse
...
Tags attached to the resource, from the request (if specified). Array
of maps, each of the form C<string:string (key:value)>.
