...
=head1 SYNOPSIS
    ...
    my $DeleteBatchPredictionOutput = $machinelearning->DeleteBatchPrediction(
      BatchPredictionId => 'MyEntityId',

    );

    # Results:
    my $BatchPredictionId = $DeleteBatchPredictionOutput->BatchPredictionId;

    # Returns a L<Paws::MachineLearning::DeleteBatchPredictionOutput> object.
