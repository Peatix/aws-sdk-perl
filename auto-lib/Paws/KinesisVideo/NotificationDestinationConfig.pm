...
package Paws::KinesisVideo::NotificationDestinationConfig;
  use Moose;
...
Paws::KinesisVideo::NotificationDestinationConfig
...
As an example, if Att1 is expected to be a Paws::KinesisVideo::NotificationDestinationConfig object:

  $service_obj->Method(Att1 => { Uri => $value, ..., Uri => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::KinesisVideo::NotificationDestinationConfig object:
