...
package Paws::EMRServerless::AutoStartConfig;
  use Moose;
...
Paws::EMRServerless::AutoStartConfig
...
As an example, if Att1 is expected to be a Paws::EMRServerless::AutoStartConfig object:

  $service_obj->Method(Att1 => { Enabled => $value, ..., Enabled => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EMRServerless::AutoStartConfig object:
