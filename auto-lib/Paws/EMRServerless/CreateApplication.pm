...
package Paws::EMRServerless::CreateApplication;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::EMRServerless::CreateApplicationResponse');
1;
...
Paws::EMRServerless::CreateApplication - Arguments for method CreateApplication on L<Paws::EMRServerless>
...
=head1 SYNOPSIS
    ...
    my $CreateApplicationResponse = $emr -serverless->CreateApplication(
    ...
    # Returns a L<Paws::EMRServerless::CreateApplicationResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/emr-serverless/CreateApplication>
...
parameter or C<imageConfiguration> for each worker type in
C<workerTypeSpecifications>.
...
This class forms part of L<Paws>, documenting arguments for method CreateApplication in L<Paws::EMRServerless>
