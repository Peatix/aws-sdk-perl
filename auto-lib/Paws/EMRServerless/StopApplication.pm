...
package Paws::EMRServerless::StopApplication;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::EMRServerless::StopApplicationResponse');
1;
...
Paws::EMRServerless::StopApplication - Arguments for method StopApplication on L<Paws::EMRServerless>
...
=head1 SYNOPSIS
    ...
    my $StopApplicationResponse = $emr -serverless->StopApplication(
      ApplicationId => 'MyApplicationId',

    );

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/emr-serverless/StopApplication>
...
This class forms part of L<Paws>, documenting arguments for method StopApplication in L<Paws::EMRServerless>
