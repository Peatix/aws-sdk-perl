...
package Paws::EMRServerless::AutoStopConfig;
  use Moose;
  has Enabled => (is => 'ro', isa => 'Bool', request_name => 'enabled', traits => ['NameInRequest']);
  has IdleTimeoutMinutes => (is => 'ro', isa => 'Int', request_name => 'idleTimeoutMinutes', traits => ['NameInRequest']);
...
Paws::EMRServerless::AutoStopConfig
...
As an example, if Att1 is expected to be a Paws::EMRServerless::AutoStopConfig object:

  $service_obj->Method(Att1 => { Enabled => $value, ..., IdleTimeoutMinutes => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EMRServerless::AutoStopConfig object:
