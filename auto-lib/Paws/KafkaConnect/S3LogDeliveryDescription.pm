...
package Paws::KafkaConnect::S3LogDeliveryDescription;
  use Moose;
...
Paws::KafkaConnect::S3LogDeliveryDescription
...
As an example, if Att1 is expected to be a Paws::KafkaConnect::S3LogDeliveryDescription object:

  $service_obj->Method(Att1 => { Bucket => $value, ..., Prefix => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::KafkaConnect::S3LogDeliveryDescription object:
