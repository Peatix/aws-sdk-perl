...
package Paws::KafkaConnect::FirehoseLogDelivery;
  use Moose;
...
Paws::KafkaConnect::FirehoseLogDelivery
...
As an example, if Att1 is expected to be a Paws::KafkaConnect::FirehoseLogDelivery object:

  $service_obj->Method(Att1 => { DeliveryStream => $value, ..., Enabled => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::KafkaConnect::FirehoseLogDelivery object:
