...
package Paws::KafkaConnect::ProvisionedCapacityUpdate;
  use Moose;
...
Paws::KafkaConnect::ProvisionedCapacityUpdate
...
As an example, if Att1 is expected to be a Paws::KafkaConnect::ProvisionedCapacityUpdate object:

  $service_obj->Method(Att1 => { McuCount => $value, ..., WorkerCount => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::KafkaConnect::ProvisionedCapacityUpdate object:
