...
package Paws::Tnb::ListSolFunctionPackageMetadata;
  use Moose;
...
Paws::Tnb::ListSolFunctionPackageMetadata
...
As an example, if Att1 is expected to be a Paws::Tnb::ListSolFunctionPackageMetadata object:

  $service_obj->Method(Att1 => { CreatedAt => $value, ..., LastModified => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Tnb::ListSolFunctionPackageMetadata object:
