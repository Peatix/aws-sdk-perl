...
package Paws::Tnb::PutSolNetworkPackageContentOutput;
  use Moose;
  has Arn => (is => 'ro', isa => 'Str', traits => ['NameInRequest'], request_name => 'arn', required => 1);
  has Id => (is => 'ro', isa => 'Str', traits => ['NameInRequest'], request_name => 'id', required => 1);
  has Metadata => (is => 'ro', isa => 'Paws::Tnb::PutSolNetworkPackageContentMetadata', traits => ['NameInRequest'], request_name => 'metadata', required => 1);
...
Paws::Tnb::PutSolNetworkPackageContentOutput
...
=head2 B<REQUIRED> Metadata => L<Paws::Tnb::PutSolNetworkPackageContentMetadata>
