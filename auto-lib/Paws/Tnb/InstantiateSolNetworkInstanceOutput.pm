...
package Paws::Tnb::InstantiateSolNetworkInstanceOutput;
  use Moose;
  has NsLcmOpOccId => (is => 'ro', isa => 'Str', traits => ['NameInRequest'], request_name => 'nsLcmOpOccId', required => 1);
...
Paws::Tnb::InstantiateSolNetworkInstanceOutput
