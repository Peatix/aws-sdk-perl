...
package Paws::Tnb::UpdateNsMetadata;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::Tnb::UpdateNsMetadata object:

  $service_obj->Method(Att1 => { AdditionalParamsForNs => $value, ..., NsdInfoId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Tnb::UpdateNsMetadata object:
