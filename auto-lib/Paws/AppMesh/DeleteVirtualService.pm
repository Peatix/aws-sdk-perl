...
package Paws::AppMesh::DeleteVirtualService;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'DeleteVirtualService');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/v20190125/meshes/{meshName}/virtualServices/{virtualServiceName}');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'DELETE');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::AppMesh::DeleteVirtualServiceOutput');
1;
...
Paws::AppMesh::DeleteVirtualService - Arguments for method DeleteVirtualService on L<Paws::AppMesh>

=head1 DESCRIPTION

This class represents the parameters used for calling the method DeleteVirtualService on the
L<AWS App Mesh|Paws::AppMesh> service. Use the attributes of this class
as arguments to method DeleteVirtualService.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to DeleteVirtualService.
...
=head1 SYNOPSIS
    ...
    # Results:
    my $VirtualService = $DeleteVirtualServiceOutput->VirtualService;

    # Returns a L<Paws::AppMesh::DeleteVirtualServiceOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/appmesh/DeleteVirtualService>
...
This class forms part of L<Paws>, documenting arguments for method DeleteVirtualService in L<Paws::AppMesh>
