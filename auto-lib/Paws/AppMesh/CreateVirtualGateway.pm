...
package Paws::AppMesh::CreateVirtualGateway;
  use Moose;
  ...
  has VirtualGatewayName => (is => 'ro', isa => 'Str', traits => ['NameInRequest'], request_name => 'virtualGatewayName', required => 1);

  use MooseX::ClassAttribute;

  class_has _api_call => (isa => 'Str', is => 'ro', default => 'CreateVirtualGateway');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/v20190125/meshes/{meshName}/virtualGateways');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'PUT');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::AppMesh::CreateVirtualGatewayOutput');
1;
...
Paws::AppMesh::CreateVirtualGateway - Arguments for method CreateVirtualGateway on L<Paws::AppMesh>

=head1 DESCRIPTION

This class represents the parameters used for calling the method CreateVirtualGateway on the
L<AWS App Mesh|Paws::AppMesh> service. Use the attributes of this class
as arguments to method CreateVirtualGateway.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to CreateVirtualGateway.

=head1 SYNOPSIS

    my $appmesh = Paws->service('AppMesh');
    my $CreateVirtualGatewayOutput = $appmesh->CreateVirtualGateway(
    ...
    # Results:
    my $VirtualGateway = $CreateVirtualGatewayOutput->VirtualGateway;

    # Returns a L<Paws::AppMesh::CreateVirtualGatewayOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/appmesh/CreateVirtualGateway>
...
This class forms part of L<Paws>, documenting arguments for method CreateVirtualGateway in L<Paws::AppMesh>
