...
package Paws::AppMesh::HttpGatewayRouteHeader;
  use Moose;
...
Paws::AppMesh::HttpGatewayRouteHeader
...
As an example, if Att1 is expected to be a Paws::AppMesh::HttpGatewayRouteHeader object:

  $service_obj->Method(Att1 => { Invert => $value, ..., Name => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::AppMesh::HttpGatewayRouteHeader object:
