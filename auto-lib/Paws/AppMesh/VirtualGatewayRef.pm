...
package Paws::AppMesh::VirtualGatewayRef;
  use Moose;
...
Paws::AppMesh::VirtualGatewayRef
...
As an example, if Att1 is expected to be a Paws::AppMesh::VirtualGatewayRef object:

  $service_obj->Method(Att1 => { Arn => $value, ..., VirtualGatewayName => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::AppMesh::VirtualGatewayRef object:
...
another account that the mesh is shared with. For more information
