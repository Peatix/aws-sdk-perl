...
package Paws::ChimeSDKMeetings::ListAttendees;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ChimeSDKMeetings::ListAttendeesResponse');
1;
...
Paws::ChimeSDKMeetings::ListAttendees - Arguments for method ListAttendees on L<Paws::ChimeSDKMeetings>
...
=head1 SYNOPSIS
    ...
    my $ListAttendeesResponse = $meetings -chime->ListAttendees(
    ...
    # Returns a L<Paws::ChimeSDKMeetings::ListAttendeesResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/meetings-chime/ListAttendees>
...
This class forms part of L<Paws>, documenting arguments for method ListAttendees in L<Paws::ChimeSDKMeetings>
