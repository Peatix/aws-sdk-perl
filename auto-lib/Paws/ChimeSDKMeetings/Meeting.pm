...
package Paws::ChimeSDKMeetings::Meeting;
  use Moose;
  has ExternalMeetingId => (is => 'ro', isa => 'Str');
  has MediaPlacement => (is => 'ro', isa => 'Paws::ChimeSDKMeetings::MediaPlacement');
  has MediaRegion => (is => 'ro', isa => 'Str');
  has MeetingArn => (is => 'ro', isa => 'Str');
...
As an example, if Att1 is expected to be a Paws::ChimeSDKMeetings::Meeting object:

  $service_obj->Method(Att1 => { ExternalMeetingId => $value, ..., TenantIds => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ChimeSDKMeetings::Meeting object:
...
=head2 MediaPlacement => L<Paws::ChimeSDKMeetings::MediaPlacement>
