...
package Paws::ChimeSDKMeetings::CreateAttendeeError;
  use Moose;
...
Paws::ChimeSDKMeetings::CreateAttendeeError
...
As an example, if Att1 is expected to be a Paws::ChimeSDKMeetings::CreateAttendeeError object:

  $service_obj->Method(Att1 => { ErrorCode => $value, ..., ExternalUserId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ChimeSDKMeetings::CreateAttendeeError object:
