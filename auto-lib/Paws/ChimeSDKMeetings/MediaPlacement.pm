...
package Paws::ChimeSDKMeetings::MediaPlacement;
  use Moose;
...
Paws::ChimeSDKMeetings::MediaPlacement
...
As an example, if Att1 is expected to be a Paws::ChimeSDKMeetings::MediaPlacement object:

  $service_obj->Method(Att1 => { AudioFallbackUrl => $value, ..., TurnControlUrl => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ChimeSDKMeetings::MediaPlacement object:
