...
package Paws::CodeConnections::ListRepositorySyncDefinitions;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::CodeConnections::ListRepositorySyncDefinitionsOutput');
...
Paws::CodeConnections::ListRepositorySyncDefinitions - Arguments for method ListRepositorySyncDefinitions on L<Paws::CodeConnections>
...
# Returns a L<Paws::CodeConnections::ListRepositorySyncDefinitionsOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/codeconnections/ListRepositorySyncDefinitions>
...
This class forms part of L<Paws>, documenting arguments for method ListRepositorySyncDefinitions in L<Paws::CodeConnections>
