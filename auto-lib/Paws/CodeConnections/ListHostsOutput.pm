...
package Paws::CodeConnections::ListHostsOutput;
  use Moose;
  has Hosts => (is => 'ro', isa => 'ArrayRef[Paws::CodeConnections::Host]');
...
Paws::CodeConnections::ListHostsOutput

=head1 ATTRIBUTES


=head2 Hosts => ArrayRef[L<Paws::CodeConnections::Host>]
