...
package Paws::CodeConnections::UpdateHost;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::CodeConnections::UpdateHostOutput');
...
Paws::CodeConnections::UpdateHost - Arguments for method UpdateHost on L<Paws::CodeConnections>
...
=head1 SYNOPSIS
    ...
    my $UpdateHostOutput = $codeconnections->UpdateHost(
      HostArn          => 'MyHostArn',
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/codeconnections/UpdateHost>
...
This class forms part of L<Paws>, documenting arguments for method UpdateHost in L<Paws::CodeConnections>
