...
package Paws::CodeConnections::DeleteHost;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::CodeConnections::DeleteHostOutput');
...
Paws::CodeConnections::DeleteHost - Arguments for method DeleteHost on L<Paws::CodeConnections>
...
=head1 SYNOPSIS
    ...
    my $DeleteHostOutput = $codeconnections->DeleteHost(
      HostArn => 'MyHostArn',

    );

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/codeconnections/DeleteHost>
...
This class forms part of L<Paws>, documenting arguments for method DeleteHost in L<Paws::CodeConnections>
