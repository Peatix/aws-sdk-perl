...
package Paws::CodeConnections::GetSyncBlockerSummary;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::CodeConnections::GetSyncBlockerSummaryOutput');
...
Paws::CodeConnections::GetSyncBlockerSummary - Arguments for method GetSyncBlockerSummary on L<Paws::CodeConnections>
...
=head1 SYNOPSIS
    ...
    my $GetSyncBlockerSummaryOutput = $codeconnections->GetSyncBlockerSummary(
    ...
    # Returns a L<Paws::CodeConnections::GetSyncBlockerSummaryOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/codeconnections/GetSyncBlockerSummary>
...
This class forms part of L<Paws>, documenting arguments for method GetSyncBlockerSummary in L<Paws::CodeConnections>
