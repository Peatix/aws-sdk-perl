...
package Paws::CodeConnections::ResourceSyncEvent;
  use Moose;
...
Paws::CodeConnections::ResourceSyncEvent
...
As an example, if Att1 is expected to be a Paws::CodeConnections::ResourceSyncEvent object:

  $service_obj->Method(Att1 => { Event => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CodeConnections::ResourceSyncEvent object:
