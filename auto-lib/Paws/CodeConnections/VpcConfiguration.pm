...
package Paws::CodeConnections::VpcConfiguration;
  use Moose;
  has SecurityGroupIds => (is => 'ro', isa => 'ArrayRef[Str|Undef]', required => 1);
  has SubnetIds => (is => 'ro', isa => 'ArrayRef[Str|Undef]', required => 1);
  has TlsCertificate => (is => 'ro', isa => 'Str');
...
Paws::CodeConnections::VpcConfiguration
...
As an example, if Att1 is expected to be a Paws::CodeConnections::VpcConfiguration object:

  $service_obj->Method(Att1 => { SecurityGroupIds => $value, ..., VpcId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CodeConnections::VpcConfiguration object:
