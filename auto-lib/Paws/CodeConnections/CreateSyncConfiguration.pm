...
package Paws::CodeConnections::CreateSyncConfiguration;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::CodeConnections::CreateSyncConfigurationOutput');
...
Paws::CodeConnections::CreateSyncConfiguration - Arguments for method CreateSyncConfiguration on L<Paws::CodeConnections>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::CodeConnections::CreateSyncConfigurationOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/codeconnections/CreateSyncConfiguration>
...
This class forms part of L<Paws>, documenting arguments for method CreateSyncConfiguration in L<Paws::CodeConnections>
