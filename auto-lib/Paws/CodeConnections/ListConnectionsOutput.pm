...
package Paws::CodeConnections::ListConnectionsOutput;
  use Moose;
  has Connections => (is => 'ro', isa => 'ArrayRef[Paws::CodeConnections::Connection]');
...
Paws::CodeConnections::ListConnectionsOutput

=head1 ATTRIBUTES


=head2 Connections => ArrayRef[L<Paws::CodeConnections::Connection>]
