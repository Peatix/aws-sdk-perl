...
=head1 SYNOPSIS
    ...
    my $IntegrationSubtype   = $CreateIntegrationResult->IntegrationSubtype;
    ...
    my $ResponseParameters   = $CreateIntegrationResult->ResponseParameters;
    ...
    my $TlsConfig       = $CreateIntegrationResult->TlsConfig;
