...
package Paws::TrustedAdvisor::ListRecommendations;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/v1/recommendations');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::TrustedAdvisor::ListRecommendationsResponse');
1;
...
Paws::TrustedAdvisor::ListRecommendations - Arguments for method ListRecommendations on L<Paws::TrustedAdvisor>
...
=head1 SYNOPSIS
    ...
    my $ListRecommendationsResponse = $trustedadvisor->ListRecommendations(
      ...
      NextToken => 'MyListRecommendationsRequestNextTokenString',    # OPTIONAL
    ...
    # Returns a L<Paws::TrustedAdvisor::ListRecommendationsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/trustedadvisor/ListRecommendations>
...
This class forms part of L<Paws>, documenting arguments for method ListRecommendations in L<Paws::TrustedAdvisor>
