...
package Paws::TrustedAdvisor::UpdateRecommendationLifecycle;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'UpdateRecommendationLifecycle');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/v1/recommendations/{recommendationIdentifier}/lifecycle');
...
Paws::TrustedAdvisor::UpdateRecommendationLifecycle - Arguments for method UpdateRecommendationLifecycle on L<Paws::TrustedAdvisor>

=head1 DESCRIPTION

This class represents the parameters used for calling the method UpdateRecommendationLifecycle on the
L<TrustedAdvisor Public API|Paws::TrustedAdvisor> service. Use the attributes of this class
as arguments to method UpdateRecommendationLifecycle.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to UpdateRecommendationLifecycle.
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/trustedadvisor/UpdateRecommendationLifecycle>
...
This class forms part of L<Paws>, documenting arguments for method UpdateRecommendationLifecycle in L<Paws::TrustedAdvisor>
