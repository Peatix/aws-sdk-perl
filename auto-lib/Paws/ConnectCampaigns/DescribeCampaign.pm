...
package Paws::ConnectCampaigns::DescribeCampaign;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ConnectCampaigns::DescribeCampaignResponse');
1;
...
Paws::ConnectCampaigns::DescribeCampaign - Arguments for method DescribeCampaign on L<Paws::ConnectCampaigns>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::ConnectCampaigns::DescribeCampaignResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method DescribeCampaign in L<Paws::ConnectCampaigns>
