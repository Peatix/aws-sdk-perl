...
package Paws::ConnectCampaigns::GetInstanceOnboardingJobStatus;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ConnectCampaigns::GetInstanceOnboardingJobStatusResponse');
1;
...
Paws::ConnectCampaigns::GetInstanceOnboardingJobStatus - Arguments for method GetInstanceOnboardingJobStatus on L<Paws::ConnectCampaigns>
...
# Returns a L<Paws::ConnectCampaigns::GetInstanceOnboardingJobStatusResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method GetInstanceOnboardingJobStatus in L<Paws::ConnectCampaigns>
