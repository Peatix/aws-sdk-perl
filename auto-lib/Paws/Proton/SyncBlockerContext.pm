...
package Paws::Proton::SyncBlockerContext;
  use Moose;
...
Paws::Proton::SyncBlockerContext
...
As an example, if Att1 is expected to be a Paws::Proton::SyncBlockerContext object:

  $service_obj->Method(Att1 => { Key => $value, ..., Value => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Proton::SyncBlockerContext object:
