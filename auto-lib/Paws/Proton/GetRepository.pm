...
package Paws::Proton::GetRepository;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Proton::GetRepositoryOutput');
...
Paws::Proton::GetRepository - Arguments for method GetRepository on L<Paws::Proton>
...
=head1 SYNOPSIS
    ...
    my $GetRepositoryOutput = $proton->GetRepository(
    ...
    # Results:
    my $Repository = $GetRepositoryOutput->Repository;

    # Returns a L<Paws::Proton::GetRepositoryOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/proton/GetRepository>
...
This class forms part of L<Paws>, documenting arguments for method GetRepository in L<Paws::Proton>
