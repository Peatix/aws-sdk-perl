...
package Paws::Proton::EnvironmentState;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::Proton::EnvironmentState object:

  $service_obj->Method(Att1 => { Spec => $value, ..., TemplateName => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Proton::EnvironmentState object:
...
The major version of the environment template that was used to create
the environment.


=head2 B<REQUIRED> TemplateMinorVersion => Str

The minor version of the environment template that was used to create
the environment.
