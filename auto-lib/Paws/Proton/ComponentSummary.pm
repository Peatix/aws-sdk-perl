...
package Paws::Proton::ComponentSummary;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::Proton::ComponentSummary object:

  $service_obj->Method(Att1 => { Arn => $value, ..., ServiceName => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Proton::ComponentSummary object:
