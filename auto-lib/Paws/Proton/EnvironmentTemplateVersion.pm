...
package Paws::Proton::EnvironmentTemplateVersion;
  use Moose;
...
Paws::Proton::EnvironmentTemplateVersion
...
As an example, if Att1 is expected to be a Paws::Proton::EnvironmentTemplateVersion object:

  $service_obj->Method(Att1 => { Arn => $value, ..., TemplateName => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Proton::EnvironmentTemplateVersion object:
