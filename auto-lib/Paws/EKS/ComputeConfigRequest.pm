...
package Paws::EKS::ComputeConfigRequest;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::EKS::ComputeConfigRequest object:

  $service_obj->Method(Att1 => { Enabled => $value, ..., NodeRoleArn => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EKS::ComputeConfigRequest object:
...
information, see EKS Auto Mode compute capability in the I<Amazon EKS
User Guide>.
...
Node Pools in the I<Amazon EKS User Guide>.
...
see the IAM Reference in the I<Amazon EKS User Guide>.
