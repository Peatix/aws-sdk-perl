...
package Paws::EKS::ControlPlanePlacementResponse;
  use Moose;
...
Paws::EKS::ControlPlanePlacementResponse
...
As an example, if Att1 is expected to be a Paws::EKS::ControlPlanePlacementResponse object:

  $service_obj->Method(Att1 => { GroupName => $value, ..., GroupName => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EKS::ControlPlanePlacementResponse object:
