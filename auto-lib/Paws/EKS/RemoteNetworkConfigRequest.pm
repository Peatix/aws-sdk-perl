...
package Paws::EKS::RemoteNetworkConfigRequest;
  use Moose;
...
Paws::EKS::RemoteNetworkConfigRequest
...
As an example, if Att1 is expected to be a Paws::EKS::RemoteNetworkConfigRequest object:

  $service_obj->Method(Att1 => { RemoteNodeNetworks => $value, ..., RemotePodNetworks => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::EKS::RemoteNetworkConfigRequest object:
