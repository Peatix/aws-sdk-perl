...
package Paws::EKS::DescribeAddon;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'DescribeAddon');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/clusters/{name}/addons/{addonName}');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::EKS::DescribeAddonResponse');
1;
...
Paws::EKS::DescribeAddon - Arguments for method DescribeAddon on L<Paws::EKS>

=head1 DESCRIPTION

This class represents the parameters used for calling the method DescribeAddon on the
L<Amazon Elastic Kubernetes Service|Paws::EKS> service. Use the attributes of this class
as arguments to method DescribeAddon.
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/eks/DescribeAddon>
...
This class forms part of L<Paws>, documenting arguments for method DescribeAddon in L<Paws::EKS>
