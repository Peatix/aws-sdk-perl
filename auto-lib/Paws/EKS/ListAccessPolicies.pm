...
package Paws::EKS::ListAccessPolicies;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::EKS::ListAccessPoliciesResponse');
1;
...
Paws::EKS::ListAccessPolicies - Arguments for method ListAccessPolicies on L<Paws::EKS>
...
=head1 SYNOPSIS
    ...
    my $ListAccessPoliciesResponse = $eks->ListAccessPolicies(
      MaxResults => 1,             # OPTIONAL
      NextToken  => 'MyString',    # OPTIONAL
    );

    # Results:
    my $AccessPolicies = $ListAccessPoliciesResponse->AccessPolicies;
    my $NextToken      = $ListAccessPoliciesResponse->NextToken;

    # Returns a L<Paws::EKS::ListAccessPoliciesResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/eks/ListAccessPolicies>
...
This class forms part of L<Paws>, documenting arguments for method ListAccessPolicies in L<Paws::EKS>
