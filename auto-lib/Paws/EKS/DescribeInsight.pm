...
package Paws::EKS::DescribeInsight;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/clusters/{name}/insights/{id}');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::EKS::DescribeInsightResponse');
1;
...
Paws::EKS::DescribeInsight - Arguments for method DescribeInsight on L<Paws::EKS>
...
=head1 SYNOPSIS
    ...
    my $DescribeInsightResponse = $eks->DescribeInsight(
    ...
    # Results:
    my $Insight = $DescribeInsightResponse->Insight;

    # Returns a L<Paws::EKS::DescribeInsightResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/eks/DescribeInsight>
...
This class forms part of L<Paws>, documenting arguments for method DescribeInsight in L<Paws::EKS>
