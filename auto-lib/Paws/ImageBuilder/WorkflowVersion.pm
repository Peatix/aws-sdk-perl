...
package Paws::ImageBuilder::WorkflowVersion;
  use Moose;
...
Paws::ImageBuilder::WorkflowVersion
...
As an example, if Att1 is expected to be a Paws::ImageBuilder::WorkflowVersion object:

  $service_obj->Method(Att1 => { Arn => $value, ..., Version => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ImageBuilder::WorkflowVersion object:
...
three nodes: E<lt>majorE<gt>.E<lt>minorE<gt>.E<lt>patchE<gt>.
