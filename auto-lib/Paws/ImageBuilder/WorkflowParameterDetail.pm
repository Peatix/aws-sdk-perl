...
package Paws::ImageBuilder::WorkflowParameterDetail;
  use Moose;
...
Paws::ImageBuilder::WorkflowParameterDetail
...
As an example, if Att1 is expected to be a Paws::ImageBuilder::WorkflowParameterDetail object:

  $service_obj->Method(Att1 => { DefaultValue => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ImageBuilder::WorkflowParameterDetail object:
