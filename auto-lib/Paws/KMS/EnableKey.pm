...
package Paws::KMS::EnableKey;
  use Moose;
  has KeyId => (is => 'ro', isa => 'Str', required => 1);

  use MooseX::ClassAttribute;

  class_has _api_call => (isa => 'Str', is => 'ro', default => 'EnableKey');
...
This class forms part of L<Paws>, documenting arguments for method EnableKey in L<Paws::KMS>
