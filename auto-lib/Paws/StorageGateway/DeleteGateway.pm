...
Paws::StorageGateway::DeleteGateway - Arguments for method DeleteGateway on L<Paws::StorageGateway>
...
=head1 SYNOPSIS
    ...
    # computer.
    my $DeleteGatewayOutput = $storagegateway->DeleteGateway( 'GatewayARN' =>
...
This class forms part of L<Paws>, documenting arguments for method DeleteGateway in L<Paws::StorageGateway>
