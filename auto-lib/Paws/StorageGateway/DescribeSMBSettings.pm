...
=head1 SYNOPSIS
    ...
    my $SMBLocalGroups      = $DescribeSMBSettingsOutput->SMBLocalGroups;
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/storagegateway/DescribeSMBSettings>
