...
package Paws::IoT::PrincipalThingObject;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::IoT::PrincipalThingObject object:

  $service_obj->Method(Att1 => { ThingName => $value, ..., ThingPrincipalType => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IoT::PrincipalThingObject object:
