...
package Paws::IoT::OpenSearchAction;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::IoT::OpenSearchAction object:

  $service_obj->Method(Att1 => { Endpoint => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IoT::OpenSearchAction object:
