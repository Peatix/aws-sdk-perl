...
Paws::IoT::DescribeCACertificate - Arguments for method DescribeCACertificate on L<Paws::IoT>

=head1 DESCRIPTION

This class represents the parameters used for calling the method DescribeCACertificate on the
L<AWS IoT|Paws::IoT> service. Use the attributes of this class
as arguments to method DescribeCACertificate.
...
This class forms part of L<Paws>, documenting arguments for method DescribeCACertificate in L<Paws::IoT>
