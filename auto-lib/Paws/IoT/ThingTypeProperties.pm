...
package Paws::IoT::ThingTypeProperties;
  use Moose;
  has Mqtt5Configuration => (is => 'ro', isa => 'Paws::IoT::Mqtt5Configuration', request_name => 'mqtt5Configuration', traits => ['NameInRequest']);
...
As an example, if Att1 is expected to be a Paws::IoT::ThingTypeProperties object:
  ...
  $service_obj->Method(Att1 => { Mqtt5Configuration => $value, ..., ThingTypeDescription => $value  });
...
Use accessors for each attribute. If Att1 is expected to be an Paws::IoT::ThingTypeProperties object:
  ...
  $result->Att1->Mqtt5Configuration
...
=head2 Mqtt5Configuration => L<Paws::IoT::Mqtt5Configuration>
