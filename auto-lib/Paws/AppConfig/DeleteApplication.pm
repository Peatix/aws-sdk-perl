...
package Paws::AppConfig::DeleteApplication;
  use Moose;
...
Paws::AppConfig::DeleteApplication - Arguments for method DeleteApplication on L<Paws::AppConfig>
...
=head1 SYNOPSIS
   ...
   # The following delete-application example deletes the specified application.
    ...
    $appconfig->DeleteApplication( 'ApplicationId' => '339ohji' );


Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/appconfig/DeleteApplication>
...
This class forms part of L<Paws>, documenting arguments for method DeleteApplication in L<Paws::AppConfig>
