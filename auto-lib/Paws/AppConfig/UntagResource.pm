...
package Paws::AppConfig::UntagResource;
  use Moose;
...
Paws::AppConfig::UntagResource - Arguments for method UntagResource on L<Paws::AppConfig>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/appconfig/UntagResource>
...
This class forms part of L<Paws>, documenting arguments for method UntagResource in L<Paws::AppConfig>
