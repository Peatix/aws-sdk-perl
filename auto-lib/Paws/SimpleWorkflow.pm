package Paws::SimpleWorkflow;
  ...
  sub DeleteActivityType {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::SimpleWorkflow::DeleteActivityType', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DeleteWorkflowType {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::SimpleWorkflow::DeleteWorkflowType', @_);
    return $self->caller->do_call($self, $call_object);
  }
...
Each argument is described in detail in: L<Paws::SimpleWorkflow::DeleteActivityType>
...
Each argument is described in detail in: L<Paws::SimpleWorkflow::DeleteWorkflowType>
...
=item [StartAtPreviousStartedEvent => Bool]
...
=item [TaskListScheduleToStartTimeout => Str]
...
=head2 PollForAllDecisionTasks(sub { },Domain => Str, TaskList => L<Paws::SimpleWorkflow::TaskList>, [Identity => Str, MaximumPageSize => Int, NextPageToken => Str, ReverseOrder => Bool, StartAtPreviousStartedEvent => Bool])

=head2 PollForAllDecisionTasks(Domain => Str, TaskList => L<Paws::SimpleWorkflow::TaskList>, [Identity => Str, MaximumPageSize => Int, NextPageToken => Str, ReverseOrder => Bool, StartAtPreviousStartedEvent => Bool])
