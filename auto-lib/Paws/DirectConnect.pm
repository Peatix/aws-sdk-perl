package Paws::DirectConnect;
  ...
  sub ConfirmCustomerAgreement {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::DirectConnect::ConfirmCustomerAgreement', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeCustomerMetadata {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::DirectConnect::DescribeCustomerMetadata', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeRouterConfiguration {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::DirectConnect::DescribeRouterConfiguration', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DescribeTags {
    my $self = shift;
  ...
  sub UpdateDirectConnectGateway {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::DirectConnect::UpdateDirectConnectGateway', @_);
    return $self->caller->do_call($self, $call_object);
  }
...
providers in your network path. A connection provides access to all
Amazon Web Services Regions except the China (Beijing) and (China)
...
connection or LAG has an associated virtual interface with a
conflicting VLAN number or a conflicting IP address, the operation
fails.
...
=head2 ConfirmCustomerAgreement

=over

=item [AgreementName => Str]


=back

Each argument is described in detail in: L<Paws::DirectConnect::ConfirmCustomerAgreement>

Returns: a L<Paws::DirectConnect::ConfirmCustomerAgreementResponse> instance
...
the partner's network to an Direct Connect location over a standard
...
Connect gateway enables the possibility for connecting to multiple
VPCs, including VPCs in different Amazon Web Services Regions.
...
supports sending traffic to public services of Amazon Web Services such
as Amazon S3.
...
=head2 DescribeCustomerMetadata
...
Each argument is described in detail in: L<Paws::DirectConnect::DescribeCustomerMetadata>

Returns: a L<Paws::DirectConnect::DescribeCustomerMetadataResponse> instance
...
=head2 DescribeRouterConfiguration

=over

=item VirtualInterfaceId => Str

=item [RouterTypeIdentifier => Str]


=back

Each argument is described in detail in: L<Paws::DirectConnect::DescribeRouterConfiguration>

Returns: a L<Paws::DirectConnect::DescribeRouterConfigurationResponse> instance
...
Deprecated. Use C<DescribeVpnGateways> instead. See DescribeVPNGateways
...
=head2 UpdateDirectConnectGateway

=over

=item DirectConnectGatewayId => Str

=item NewDirectConnectGatewayName => Str


=back

Each argument is described in detail in: L<Paws::DirectConnect::UpdateDirectConnectGateway>

Returns: a L<Paws::DirectConnect::UpdateDirectConnectGatewayResponse> instance
...
Amazon Web Services assigns this value to each connection which is part
of the LAG.
...
=item [EnableSiteLink => Bool]

=item [Mtu => Int]

=item [VirtualInterfaceName => Str]
