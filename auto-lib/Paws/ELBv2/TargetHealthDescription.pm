...
package Paws::ELBv2::TargetHealthDescription;
  use Moose;
  has AdministrativeOverride => (is => 'ro', isa => 'Paws::ELBv2::AdministrativeOverride');
  has AnomalyDetection => (is => 'ro', isa => 'Paws::ELBv2::AnomalyDetection');
...
As an example, if Att1 is expected to be a Paws::ELBv2::TargetHealthDescription object:
  ...
  $service_obj->Method(Att1 => { AdministrativeOverride => $value, ..., TargetHealth => $value  });
...
Use accessors for each attribute. If Att1 is expected to be an Paws::ELBv2::TargetHealthDescription object:
  ...
  $result->Att1->AdministrativeOverride
...
=head2 AdministrativeOverride => L<Paws::ELBv2::AdministrativeOverride>

The administrative override information for the target.


=head2 AnomalyDetection => L<Paws::ELBv2::AnomalyDetection>

The anomaly detection result for the target.

If no anomalies were detected, the result is C<normal>.

If anomalies were detected, the result is C<anomalous>.
