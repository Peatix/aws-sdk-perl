...
package Paws::Robomaker::DeleteFleet;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/deleteFleet');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Robomaker::DeleteFleetResponse');
1;
...
Paws::Robomaker::DeleteFleet - Arguments for method DeleteFleet on L<Paws::Robomaker>
...
=head1 SYNOPSIS
    ...
    my $DeleteFleetResponse = $robomaker->DeleteFleet(
      Fleet => 'MyArn',
...
This class forms part of L<Paws>, documenting arguments for method DeleteFleet in L<Paws::Robomaker>
