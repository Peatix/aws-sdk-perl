...
package Paws::Robomaker::TemplateSummary;
  use Moose;
...
Paws::Robomaker::TemplateSummary
...
Use accessors for each attribute. If Att1 is expected to be an Paws::Robomaker::TemplateSummary object:
