...
package Paws::IoTFleetWise::StorageMinimumTimeToLive;
  use Moose;
...
Paws::IoTFleetWise::StorageMinimumTimeToLive
...
As an example, if Att1 is expected to be a Paws::IoTFleetWise::StorageMinimumTimeToLive object:

  $service_obj->Method(Att1 => { Unit => $value, ..., Value => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IoTFleetWise::StorageMinimumTimeToLive object:
