...
package Paws::IoTFleetWise::UpdateDecoderManifest;
  use Moose;
  ...
  has NetworkInterfacesToAdd => (is => 'ro', isa => 'ArrayRef[Paws::IoTFleetWise::NetworkInterface]', traits => ['NameInRequest'], request_name => 'networkInterfacesToAdd' );
  has NetworkInterfacesToRemove => (is => 'ro', isa => 'ArrayRef[Str|Undef]', traits => ['NameInRequest'], request_name => 'networkInterfacesToRemove' );
  has NetworkInterfacesToUpdate => (is => 'ro', isa => 'ArrayRef[Paws::IoTFleetWise::NetworkInterface]', traits => ['NameInRequest'], request_name => 'networkInterfacesToUpdate' );
  has SignalDecodersToAdd => (is => 'ro', isa => 'ArrayRef[Paws::IoTFleetWise::SignalDecoder]', traits => ['NameInRequest'], request_name => 'signalDecodersToAdd' );
  has SignalDecodersToRemove => (is => 'ro', isa => 'ArrayRef[Str|Undef]', traits => ['NameInRequest'], request_name => 'signalDecodersToRemove' );
  has SignalDecodersToUpdate => (is => 'ro', isa => 'ArrayRef[Paws::IoTFleetWise::SignalDecoder]', traits => ['NameInRequest'], request_name => 'signalDecodersToUpdate' );
  has Status => (is => 'ro', isa => 'Str', traits => ['NameInRequest'], request_name => 'status' );

  use MooseX::ClassAttribute;

  class_has _api_call => (isa => 'Str', is => 'ro', default => 'UpdateDecoderManifest');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::IoTFleetWise::UpdateDecoderManifestResponse');
...
Paws::IoTFleetWise::UpdateDecoderManifest - Arguments for method UpdateDecoderManifest on L<Paws::IoTFleetWise>

=head1 DESCRIPTION

This class represents the parameters used for calling the method UpdateDecoderManifest on the
L<AWS IoT FleetWise|Paws::IoTFleetWise> service. Use the attributes of this class
as arguments to method UpdateDecoderManifest.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to UpdateDecoderManifest.

=head1 SYNOPSIS

    my $iotfleetwise = Paws->service('IoTFleetWise');
    my $UpdateDecoderManifestResponse = $iotfleetwise->UpdateDecoderManifest(
      Name                      => 'MyresourceName',
      ...
      SignalDecodersToRemove => [
        'MyFullyQualifiedName', ...    # min: 1, max: 150
      ],    # OPTIONAL
    ...
    # Results:
    my $Arn  = $UpdateDecoderManifestResponse->Arn;
    my $Name = $UpdateDecoderManifestResponse->Name;

    # Returns a L<Paws::IoTFleetWise::UpdateDecoderManifestResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/iotfleetwise/UpdateDecoderManifest>
...
=head2 NetworkInterfacesToAdd => ArrayRef[L<Paws::IoTFleetWise::NetworkInterface>]
...
=head2 NetworkInterfacesToRemove => ArrayRef[Str|Undef]

A list of network interfaces to remove from the decoder manifest.



=head2 NetworkInterfacesToUpdate => ArrayRef[L<Paws::IoTFleetWise::NetworkInterface>]
...
=head2 SignalDecodersToAdd => ArrayRef[L<Paws::IoTFleetWise::SignalDecoder>]
...
=head2 SignalDecodersToRemove => ArrayRef[Str|Undef]

A list of signal decoders to remove from the decoder manifest.



=head2 SignalDecodersToUpdate => ArrayRef[L<Paws::IoTFleetWise::SignalDecoder>]
...
decoder manifest can't be edited. If the status is C<DRAFT>, you can
...
This class forms part of L<Paws>, documenting arguments for method UpdateDecoderManifest in L<Paws::IoTFleetWise>
