...
package Paws::IoTFleetWise::Branch;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::IoTFleetWise::Branch object:

  $service_obj->Method(Att1 => { Comment => $value, ..., FullyQualifiedName => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IoTFleetWise::Branch object:
...
qualified name of a branch might be C<Vehicle.Body.Engine>.
