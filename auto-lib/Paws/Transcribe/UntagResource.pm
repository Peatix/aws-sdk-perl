...
package Paws::Transcribe::UntagResource;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Transcribe::UntagResourceResponse');
...
Paws::Transcribe::UntagResource - Arguments for method UntagResource on L<Paws::Transcribe>
...
=head1 SYNOPSIS
    ...
    my $UntagResourceResponse = $transcribe->UntagResource(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/transcribe/UntagResource>
...
This class forms part of L<Paws>, documenting arguments for method UntagResource in L<Paws::Transcribe>
