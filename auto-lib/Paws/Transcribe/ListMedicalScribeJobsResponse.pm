...
package Paws::Transcribe::ListMedicalScribeJobsResponse;
  use Moose;
  has MedicalScribeJobSummaries => (is => 'ro', isa => 'ArrayRef[Paws::Transcribe::MedicalScribeJobSummary]');
...
Paws::Transcribe::ListMedicalScribeJobsResponse

=head1 ATTRIBUTES


=head2 MedicalScribeJobSummaries => ArrayRef[L<Paws::Transcribe::MedicalScribeJobSummary>]
