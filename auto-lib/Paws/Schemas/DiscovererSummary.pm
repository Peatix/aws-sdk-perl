...
package Paws::Schemas::DiscovererSummary;
  use Moose;
...
Paws::Schemas::DiscovererSummary
...
As an example, if Att1 is expected to be a Paws::Schemas::DiscovererSummary object:

  $service_obj->Method(Att1 => { CrossAccount => $value, ..., Tags => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Schemas::DiscovererSummary object:
