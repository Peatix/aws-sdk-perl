...
package Paws::Schemas::DeleteSchema;
  use Moose;
...
Paws::Schemas::DeleteSchema - Arguments for method DeleteSchema on L<Paws::Schemas>
...
This class forms part of L<Paws>, documenting arguments for method DeleteSchema in L<Paws::Schemas>
