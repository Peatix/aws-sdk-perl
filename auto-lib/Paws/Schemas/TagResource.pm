...
package Paws::Schemas::TagResource;
  use Moose;
  has ResourceArn => (is => 'ro', isa => 'Str', traits => ['ParamInURI'], uri_name => 'resource-arn', required => 1);
  has Tags => (is => 'ro', isa => 'Paws::Schemas::Tags', traits => ['NameInRequest'], request_name => 'tags', required => 1);
...
Paws::Schemas::TagResource - Arguments for method TagResource on L<Paws::Schemas>
...
This class forms part of L<Paws>, documenting arguments for method TagResource in L<Paws::Schemas>
