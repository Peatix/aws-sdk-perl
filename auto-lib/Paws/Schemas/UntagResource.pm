...
package Paws::Schemas::UntagResource;
  use Moose;
...
Paws::Schemas::UntagResource - Arguments for method UntagResource on L<Paws::Schemas>
...
This class forms part of L<Paws>, documenting arguments for method UntagResource in L<Paws::Schemas>
