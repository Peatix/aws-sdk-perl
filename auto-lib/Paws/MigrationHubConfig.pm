package Paws::MigrationHubConfig;
  ...
  sub DeleteHomeRegionControl {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::MigrationHubConfig::DeleteHomeRegionControl', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub operations { qw/CreateHomeRegionControl DeleteHomeRegionControl DescribeHomeRegionControls GetHomeRegion / }
...
Each argument is described in detail in: L<Paws::MigrationHubConfig::DeleteHomeRegionControl>

Returns: a L<Paws::MigrationHubConfig::DeleteHomeRegionControlResult> instance
