...
package Paws::ChimeSDKIdentity::DescribeAppInstanceUser;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ChimeSDKIdentity::DescribeAppInstanceUserResponse');
1;
...
Paws::ChimeSDKIdentity::DescribeAppInstanceUser - Arguments for method DescribeAppInstanceUser on L<Paws::ChimeSDKIdentity>
...
=head1 SYNOPSIS
    ...
    my $DescribeAppInstanceUserResponse =
      $identity -chime->DescribeAppInstanceUser(
  ...
  # Returns a L<Paws::ChimeSDKIdentity::DescribeAppInstanceUserResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/identity-chime/DescribeAppInstanceUser>
...
This class forms part of L<Paws>, documenting arguments for method DescribeAppInstanceUser in L<Paws::ChimeSDKIdentity>
