...
package Paws::ChimeSDKIdentity::AppInstanceSummary;
  use Moose;
...
Paws::ChimeSDKIdentity::AppInstanceSummary
...
As an example, if Att1 is expected to be a Paws::ChimeSDKIdentity::AppInstanceSummary object:

  $service_obj->Method(Att1 => { AppInstanceArn => $value, ..., Name => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ChimeSDKIdentity::AppInstanceSummary object:
