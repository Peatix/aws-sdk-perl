...
package Paws::ChimeSDKIdentity::DeleteAppInstance;
  use Moose;
...
Paws::ChimeSDKIdentity::DeleteAppInstance - Arguments for method DeleteAppInstance on L<Paws::ChimeSDKIdentity>
...
=head1 SYNOPSIS
    ...
    $identity -chime->DeleteAppInstance(
      AppInstanceArn => 'MyChimeArn',

    );

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/identity-chime/DeleteAppInstance>
...
This class forms part of L<Paws>, documenting arguments for method DeleteAppInstance in L<Paws::ChimeSDKIdentity>
