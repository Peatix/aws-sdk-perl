...
package Paws::ChimeSDKIdentity::ListAppInstanceAdmins;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ChimeSDKIdentity::ListAppInstanceAdminsResponse');
1;
...
Paws::ChimeSDKIdentity::ListAppInstanceAdmins - Arguments for method ListAppInstanceAdmins on L<Paws::ChimeSDKIdentity>
...
=head1 SYNOPSIS
    ...
    my $ListAppInstanceAdminsResponse = $identity -chime->ListAppInstanceAdmins(
    ...
    # Returns a L<Paws::ChimeSDKIdentity::ListAppInstanceAdminsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/identity-chime/ListAppInstanceAdmins>
...
This class forms part of L<Paws>, documenting arguments for method ListAppInstanceAdmins in L<Paws::ChimeSDKIdentity>
