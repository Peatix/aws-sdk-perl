...
package Paws::ChimeSDKIdentity::ListAppInstances;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ChimeSDKIdentity::ListAppInstancesResponse');
1;
...
Paws::ChimeSDKIdentity::ListAppInstances - Arguments for method ListAppInstances on L<Paws::ChimeSDKIdentity>
...
=head1 SYNOPSIS
    ...
    my $ListAppInstancesResponse = $identity -chime->ListAppInstances(
    ...
    # Returns a L<Paws::ChimeSDKIdentity::ListAppInstancesResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/identity-chime/ListAppInstances>
...
This class forms part of L<Paws>, documenting arguments for method ListAppInstances in L<Paws::ChimeSDKIdentity>
