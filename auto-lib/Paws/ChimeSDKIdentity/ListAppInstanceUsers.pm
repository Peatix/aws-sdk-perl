...
package Paws::ChimeSDKIdentity::ListAppInstanceUsers;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ChimeSDKIdentity::ListAppInstanceUsersResponse');
1;
...
Paws::ChimeSDKIdentity::ListAppInstanceUsers - Arguments for method ListAppInstanceUsers on L<Paws::ChimeSDKIdentity>
...
=head1 SYNOPSIS
    ...
    my $ListAppInstanceUsersResponse = $identity -chime->ListAppInstanceUsers(
    ...
    # Returns a L<Paws::ChimeSDKIdentity::ListAppInstanceUsersResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/identity-chime/ListAppInstanceUsers>
...
This class forms part of L<Paws>, documenting arguments for method ListAppInstanceUsers in L<Paws::ChimeSDKIdentity>
