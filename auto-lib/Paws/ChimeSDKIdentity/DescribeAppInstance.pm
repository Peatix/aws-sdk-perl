...
package Paws::ChimeSDKIdentity::DescribeAppInstance;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ChimeSDKIdentity::DescribeAppInstanceResponse');
1;
...
Paws::ChimeSDKIdentity::DescribeAppInstance - Arguments for method DescribeAppInstance on L<Paws::ChimeSDKIdentity>
...
=head1 SYNOPSIS
    ...
    my $DescribeAppInstanceResponse = $identity -chime->DescribeAppInstance(
    ...
    # Returns a L<Paws::ChimeSDKIdentity::DescribeAppInstanceResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/identity-chime/DescribeAppInstance>
...
This class forms part of L<Paws>, documenting arguments for method DescribeAppInstance in L<Paws::ChimeSDKIdentity>
