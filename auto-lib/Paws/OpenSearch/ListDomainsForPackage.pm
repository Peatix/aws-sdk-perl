...
package Paws::OpenSearch::ListDomainsForPackage;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/2021-01-01/packages/{PackageID}/domains');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::OpenSearch::ListDomainsForPackageResponse');
1;
...
Paws::OpenSearch::ListDomainsForPackage - Arguments for method ListDomainsForPackage on L<Paws::OpenSearch>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::OpenSearch::ListDomainsForPackageResponse> object.
...
If your initial C<ListDomainsForPackage> operation returns a
C<nextToken>, you can include the returned C<nextToken> in subsequent
C<ListDomainsForPackage> operations, which returns results in the next
page.
...
This class forms part of L<Paws>, documenting arguments for method ListDomainsForPackage in L<Paws::OpenSearch>
