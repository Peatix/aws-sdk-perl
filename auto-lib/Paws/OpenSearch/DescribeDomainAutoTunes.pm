...
package Paws::OpenSearch::DescribeDomainAutoTunes;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/2021-01-01/opensearch/domain/{DomainName}/autoTunes');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::OpenSearch::DescribeDomainAutoTunesResponse');
1;
...
Paws::OpenSearch::DescribeDomainAutoTunes - Arguments for method DescribeDomainAutoTunes on L<Paws::OpenSearch>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::OpenSearch::DescribeDomainAutoTunesResponse> object.
...
If your initial C<DescribeDomainAutoTunes> operation returns a
C<nextToken>, you can include the returned C<nextToken> in subsequent
C<DescribeDomainAutoTunes> operations, which returns results in the
next page.
...
This class forms part of L<Paws>, documenting arguments for method DescribeDomainAutoTunes in L<Paws::OpenSearch>
