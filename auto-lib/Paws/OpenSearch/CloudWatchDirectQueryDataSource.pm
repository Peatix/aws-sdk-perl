...
package Paws::OpenSearch::CloudWatchDirectQueryDataSource;
  use Moose;
...
Paws::OpenSearch::CloudWatchDirectQueryDataSource
...
As an example, if Att1 is expected to be a Paws::OpenSearch::CloudWatchDirectQueryDataSource object:

  $service_obj->Method(Att1 => { RoleArn => $value, ..., RoleArn => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::OpenSearch::CloudWatchDirectQueryDataSource object:
