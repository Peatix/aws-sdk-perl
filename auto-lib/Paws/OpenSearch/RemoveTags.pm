...
package Paws::OpenSearch::RemoveTags;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/2021-01-01/tags-removal');
...
Paws::OpenSearch::RemoveTags - Arguments for method RemoveTags on L<Paws::OpenSearch>
...
This class forms part of L<Paws>, documenting arguments for method RemoveTags in L<Paws::OpenSearch>
