...
package Paws::OpenSearch::UpdateVpcEndpoint;
  use Moose;
  has VpcEndpointId => (is => 'ro', isa => 'Str', required => 1);
  has VpcOptions => (is => 'ro', isa => 'Paws::OpenSearch::VPCOptions', required => 1);

  use MooseX::ClassAttribute;

  class_has _api_call => (isa => 'Str', is => 'ro', default => 'UpdateVpcEndpoint');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/2021-01-01/opensearch/vpcEndpoints/update');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::OpenSearch::UpdateVpcEndpointResponse');
1;
...
Paws::OpenSearch::UpdateVpcEndpoint - Arguments for method UpdateVpcEndpoint on L<Paws::OpenSearch>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::OpenSearch::UpdateVpcEndpointResponse> object.
...
=head2 B<REQUIRED> VpcOptions => L<Paws::OpenSearch::VPCOptions>
...
This class forms part of L<Paws>, documenting arguments for method UpdateVpcEndpoint in L<Paws::OpenSearch>
