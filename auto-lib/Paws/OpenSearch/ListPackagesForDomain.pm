...
package Paws::OpenSearch::ListPackagesForDomain;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/2021-01-01/domain/{DomainName}/packages');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::OpenSearch::ListPackagesForDomainResponse');
1;
...
Paws::OpenSearch::ListPackagesForDomain - Arguments for method ListPackagesForDomain on L<Paws::OpenSearch>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::OpenSearch::ListPackagesForDomainResponse> object.
...
If your initial C<ListPackagesForDomain> operation returns a
C<nextToken>, you can include the returned C<nextToken> in subsequent
C<ListPackagesForDomain> operations, which returns results in the next
page.
...
This class forms part of L<Paws>, documenting arguments for method ListPackagesForDomain in L<Paws::OpenSearch>
