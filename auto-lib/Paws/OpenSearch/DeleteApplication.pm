...
package Paws::OpenSearch::DeleteApplication;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::OpenSearch::DeleteApplicationResponse');
1;
...
Paws::OpenSearch::DeleteApplication - Arguments for method DeleteApplication on L<Paws::OpenSearch>
...
=head1 SYNOPSIS
    ...
    my $DeleteApplicationResponse = $es->DeleteApplication(
      Id => 'MyId',
...
This class forms part of L<Paws>, documenting arguments for method DeleteApplication in L<Paws::OpenSearch>
