...
package Paws::OpenSearch::CreateVpcEndpoint;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::OpenSearch::CreateVpcEndpointResponse');
1;
...
Paws::OpenSearch::CreateVpcEndpoint - Arguments for method CreateVpcEndpoint on L<Paws::OpenSearch>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::OpenSearch::CreateVpcEndpointResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method CreateVpcEndpoint in L<Paws::OpenSearch>
