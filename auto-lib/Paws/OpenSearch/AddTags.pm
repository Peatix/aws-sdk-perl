...
package Paws::OpenSearch::AddTags;
  use Moose;
  has ARN => (is => 'ro', isa => 'Str', required => 1);
  has TagList => (is => 'ro', isa => 'ArrayRef[Paws::OpenSearch::Tag]', required => 1);
...
Paws::OpenSearch::AddTags - Arguments for method AddTags on L<Paws::OpenSearch>
...
=head2 B<REQUIRED> TagList => ArrayRef[L<Paws::OpenSearch::Tag>]
...
This class forms part of L<Paws>, documenting arguments for method AddTags in L<Paws::OpenSearch>
