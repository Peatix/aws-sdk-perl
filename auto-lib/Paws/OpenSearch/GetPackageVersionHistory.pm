...
package Paws::OpenSearch::GetPackageVersionHistory;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/2021-01-01/packages/{PackageID}/history');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::OpenSearch::GetPackageVersionHistoryResponse');
1;
...
Paws::OpenSearch::GetPackageVersionHistory - Arguments for method GetPackageVersionHistory on L<Paws::OpenSearch>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::OpenSearch::GetPackageVersionHistoryResponse> object.
...
If your initial C<GetPackageVersionHistory> operation returns a
C<nextToken>, you can include the returned C<nextToken> in subsequent
C<GetPackageVersionHistory> operations, which returns results in the
next page.
...
This class forms part of L<Paws>, documenting arguments for method GetPackageVersionHistory in L<Paws::OpenSearch>
