...
package Paws::OpenSearch::DissociatePackage;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/2021-01-01/packages/dissociate/{PackageID}/{DomainName}');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::OpenSearch::DissociatePackageResponse');
1;
...
Paws::OpenSearch::DissociatePackage - Arguments for method DissociatePackage on L<Paws::OpenSearch>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::OpenSearch::DissociatePackageResponse> object.
...
C<ListPackagesForDomain> to find this value.
...
This class forms part of L<Paws>, documenting arguments for method DissociatePackage in L<Paws::OpenSearch>
