...
package Paws::OpenSearch::GetUpgradeStatus;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/2021-01-01/opensearch/upgradeDomain/{DomainName}/status');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::OpenSearch::GetUpgradeStatusResponse');
1;
...
Paws::OpenSearch::GetUpgradeStatus - Arguments for method GetUpgradeStatus on L<Paws::OpenSearch>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::OpenSearch::GetUpgradeStatusResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method GetUpgradeStatus in L<Paws::OpenSearch>
