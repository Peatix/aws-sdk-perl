...
package Paws::OpenSearch::UpgradeStepItem;
  use Moose;
...
Paws::OpenSearch::UpgradeStepItem
...
As an example, if Att1 is expected to be a Paws::OpenSearch::UpgradeStepItem object:

  $service_obj->Method(Att1 => { Issues => $value, ..., UpgradeStepStatus => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::OpenSearch::UpgradeStepItem object:
