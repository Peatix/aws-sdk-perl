...
package Paws::OpenSearch::ListTags;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/2021-01-01/tags/');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::OpenSearch::ListTagsResponse');
1;
...
Paws::OpenSearch::ListTags - Arguments for method ListTags on L<Paws::OpenSearch>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::OpenSearch::ListTagsResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method ListTags in L<Paws::OpenSearch>
