...
package Paws::OpenSearch::DescribeDomainChangeProgress;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/2021-01-01/opensearch/domain/{DomainName}/progress');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::OpenSearch::DescribeDomainChangeProgressResponse');
1;
...
Paws::OpenSearch::DescribeDomainChangeProgress - Arguments for method DescribeDomainChangeProgress on L<Paws::OpenSearch>
...
=head1 SYNOPSIS
   ...
   # Returns a L<Paws::OpenSearch::DescribeDomainChangeProgressResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method DescribeDomainChangeProgress in L<Paws::OpenSearch>
