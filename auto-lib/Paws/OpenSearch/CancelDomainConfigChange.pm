...
package Paws::OpenSearch::CancelDomainConfigChange;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/2021-01-01/opensearch/domain/{DomainName}/config/cancel');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::OpenSearch::CancelDomainConfigChangeResponse');
1;
...
Paws::OpenSearch::CancelDomainConfigChange - Arguments for method CancelDomainConfigChange on L<Paws::OpenSearch>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::OpenSearch::CancelDomainConfigChangeResponse> object.
...
When set to C<True>, returns the list of change IDs and properties that
...
This class forms part of L<Paws>, documenting arguments for method CancelDomainConfigChange in L<Paws::OpenSearch>
