...
package Paws::OpenSearch::OptionStatus;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::OpenSearch::OptionStatus object:

  $service_obj->Method(Att1 => { CreationDate => $value, ..., UpdateVersion => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::OpenSearch::OptionStatus object:
