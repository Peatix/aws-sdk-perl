...
package Paws::OpenSearch::GetUpgradeHistory;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/2021-01-01/opensearch/upgradeDomain/{DomainName}/history');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::OpenSearch::GetUpgradeHistoryResponse');
1;
...
Paws::OpenSearch::GetUpgradeHistory - Arguments for method GetUpgradeHistory on L<Paws::OpenSearch>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::OpenSearch::GetUpgradeHistoryResponse> object.
...
If your initial C<GetUpgradeHistory> operation returns a C<nextToken>,
you can include the returned C<nextToken> in subsequent
C<GetUpgradeHistory> operations, which returns results in the next
page.
...
This class forms part of L<Paws>, documenting arguments for method GetUpgradeHistory in L<Paws::OpenSearch>
