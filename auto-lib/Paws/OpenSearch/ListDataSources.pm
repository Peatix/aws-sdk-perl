...
package Paws::OpenSearch::ListDataSources;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::OpenSearch::ListDataSourcesResponse');
1;
...
Paws::OpenSearch::ListDataSources - Arguments for method ListDataSources on L<Paws::OpenSearch>
...
=head1 SYNOPSIS
    ...
    my $ListDataSourcesResponse = $es->ListDataSources(
    ...
    # Returns a L<Paws::OpenSearch::ListDataSourcesResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method ListDataSources in L<Paws::OpenSearch>
