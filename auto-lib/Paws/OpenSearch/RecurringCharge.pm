...
package Paws::OpenSearch::RecurringCharge;
  use Moose;
...
Paws::OpenSearch::RecurringCharge
...
As an example, if Att1 is expected to be a Paws::OpenSearch::RecurringCharge object:

  $service_obj->Method(Att1 => { RecurringChargeAmount => $value, ..., RecurringChargeFrequency => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::OpenSearch::RecurringCharge object:
