...
package Paws::CodeDeploy::DeploymentTarget;
  use Moose;
  has CloudFormationTarget => (is => 'ro', isa => 'Paws::CodeDeploy::CloudFormationTarget', request_name => 'cloudFormationTarget', traits => ['NameInRequest']);
...
As an example, if Att1 is expected to be a Paws::CodeDeploy::DeploymentTarget object:
  ...
  $service_obj->Method(Att1 => { CloudFormationTarget => $value, ..., LambdaTarget => $value  });
...
Use accessors for each attribute. If Att1 is expected to be an Paws::CodeDeploy::DeploymentTarget object:
  ...
  $result->Att1->CloudFormationTarget
...
=head2 CloudFormationTarget => L<Paws::CodeDeploy::CloudFormationTarget>
