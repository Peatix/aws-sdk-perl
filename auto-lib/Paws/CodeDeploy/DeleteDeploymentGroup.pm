...
=head1 SYNOPSIS
    ...
    my $DeleteDeploymentGroupOutput = $codedeploy->DeleteDeploymentGroup(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/codedeploy/DeleteDeploymentGroup>
