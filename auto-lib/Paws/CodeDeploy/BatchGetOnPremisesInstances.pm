...
=head1 SYNOPSIS
    ...
    my $BatchGetOnPremisesInstancesOutput =
    ...
    # Results:
    my $InstanceInfos = $BatchGetOnPremisesInstancesOutput->InstanceInfos;

    # Returns a L<Paws::CodeDeploy::BatchGetOnPremisesInstancesOutput> object.
