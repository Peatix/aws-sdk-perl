package Paws::ServiceQuotas;
  ...
  sub CreateSupportCase {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ServiceQuotas::CreateSupportCase', @_);
    return $self->caller->do_call($self, $call_object);
  }
...
manage resource-level quotas such as C<Instances per domain> for Amazon
OpenSearch Service.
...
Each argument is described in detail in: L<Paws::ServiceQuotas::CreateSupportCase>

Returns: a L<Paws::ServiceQuotas::CreateSupportCaseResponse> instance

Creates a Support case for an existing quota increase request. This
call only creates a Support case if the request has a C<Pending>
status.
...
=item [QuotaRequestedAtLevel => Str]
...
=head2 ListAllRequestedServiceQuotaChangeHistory(sub { },[MaxResults => Int, NextToken => Str, QuotaRequestedAtLevel => Str, ServiceCode => Str, Status => Str])

=head2 ListAllRequestedServiceQuotaChangeHistory([MaxResults => Int, NextToken => Str, QuotaRequestedAtLevel => Str, ServiceCode => Str, Status => Str])
...
=head2 ListAllRequestedServiceQuotaChangeHistoryByQuota(sub { },QuotaCode => Str, ServiceCode => Str, [MaxResults => Int, NextToken => Str, QuotaRequestedAtLevel => Str, Status => Str])

=head2 ListAllRequestedServiceQuotaChangeHistoryByQuota(QuotaCode => Str, ServiceCode => Str, [MaxResults => Int, NextToken => Str, QuotaRequestedAtLevel => Str, Status => Str])
...
=head2 ListAllServiceQuotas(sub { },ServiceCode => Str, [MaxResults => Int, NextToken => Str, QuotaAppliedAtLevel => Str, QuotaCode => Str])

=head2 ListAllServiceQuotas(ServiceCode => Str, [MaxResults => Int, NextToken => Str, QuotaAppliedAtLevel => Str, QuotaCode => Str])
