    ...
    my $ModifyReportDefinitionResponse = $cur->ModifyReportDefinition(
      ReportDefinition => {
        AdditionalSchemaElements => [
          'RESOURCES',
          ... # values: RESOURCES, SPLIT_COST_ALLOCATION_DATA, MANUAL_DISCOUNT_COMPATIBILITY
        ],
        ...
        S3Region    => 'af-south-1'
        , # values: af-south-1, ap-east-1, ap-south-1, ap-south-2, ap-southeast-1, ap-southeast-2, ap-southeast-3, ap-northeast-1, ap-northeast-2, ap-northeast-3, ca-central-1, eu-central-1, eu-central-2, eu-west-1, eu-west-2, eu-west-3, eu-north-1, eu-south-1, eu-south-2, me-central-1, me-south-1, sa-east-1, us-east-1, us-east-2, us-west-1, us-west-2, cn-north-1, cn-northwest-1
        ...
        ReportStatus         => {
          LastDelivery => 'MyLastDelivery',    # min: 16, max: 20; OPTIONAL
          LastStatus   => 'SUCCESS'
          ,    # values: SUCCESS, ERROR_PERMISSIONS, ERROR_NO_BUCKET; OPTIONAL
        },    # OPTIONAL
