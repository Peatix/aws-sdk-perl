...
package Paws::SimSpaceWeaver::CreateSnapshot;
  use Moose;
  has Destination => (is => 'ro', isa => 'Paws::SimSpaceWeaver::S3Destination', required => 1);
  has Simulation => (is => 'ro', isa => 'Str', required => 1);

  use MooseX::ClassAttribute;

  class_has _api_call => (isa => 'Str', is => 'ro', default => 'CreateSnapshot');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/createsnapshot');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::SimSpaceWeaver::CreateSnapshotOutput');
1;
...
Paws::SimSpaceWeaver::CreateSnapshot - Arguments for method CreateSnapshot on L<Paws::SimSpaceWeaver>
...
=head1 SYNOPSIS
    ...
    my $CreateSnapshotOutput = $simspaceweaver->CreateSnapshot(
      Destination => {
        BucketName      => 'MyBucketName',         # min: 3, max: 63
        ObjectKeyPrefix => 'MyObjectKeyPrefix',    # max: 1024; OPTIONAL
      },
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/simspaceweaver/CreateSnapshot>

=head1 ATTRIBUTES


=head2 B<REQUIRED> Destination => L<Paws::SimSpaceWeaver::S3Destination>
...
This class forms part of L<Paws>, documenting arguments for method CreateSnapshot in L<Paws::SimSpaceWeaver>
