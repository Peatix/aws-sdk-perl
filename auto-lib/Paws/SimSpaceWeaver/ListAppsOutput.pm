...
package Paws::SimSpaceWeaver::ListAppsOutput;
  use Moose;
  has Apps => (is => 'ro', isa => 'ArrayRef[Paws::SimSpaceWeaver::SimulationAppMetadata]');
...
Paws::SimSpaceWeaver::ListAppsOutput

=head1 ATTRIBUTES


=head2 Apps => ArrayRef[L<Paws::SimSpaceWeaver::SimulationAppMetadata>]
