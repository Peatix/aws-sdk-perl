...
package Paws::CodeCatalyst::DevEnvironmentRepositorySummary;
  use Moose;
...
Paws::CodeCatalyst::DevEnvironmentRepositorySummary
...
As an example, if Att1 is expected to be a Paws::CodeCatalyst::DevEnvironmentRepositorySummary object:

  $service_obj->Method(Att1 => { BranchName => $value, ..., RepositoryName => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CodeCatalyst::DevEnvironmentRepositorySummary object:
