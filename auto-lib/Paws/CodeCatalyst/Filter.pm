...
package Paws::CodeCatalyst::Filter;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::CodeCatalyst::Filter object:

  $service_obj->Method(Att1 => { ComparisonOperator => $value, ..., Values => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CodeCatalyst::Filter object:
