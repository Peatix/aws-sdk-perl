...
package Paws::CodeCatalyst::EventPayload;
  use Moose;
...
Paws::CodeCatalyst::EventPayload
...
As an example, if Att1 is expected to be a Paws::CodeCatalyst::EventPayload object:

  $service_obj->Method(Att1 => { ContentType => $value, ..., Data => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CodeCatalyst::EventPayload object:
