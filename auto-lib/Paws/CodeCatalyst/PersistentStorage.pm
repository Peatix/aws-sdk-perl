...
package Paws::CodeCatalyst::PersistentStorage;
  use Moose;
...
Paws::CodeCatalyst::PersistentStorage
...
As an example, if Att1 is expected to be a Paws::CodeCatalyst::PersistentStorage object:

  $service_obj->Method(Att1 => { SizeInGiB => $value, ..., SizeInGiB => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CodeCatalyst::PersistentStorage object:
