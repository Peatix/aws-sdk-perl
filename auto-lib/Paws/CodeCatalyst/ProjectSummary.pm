...
package Paws::CodeCatalyst::ProjectSummary;
  use Moose;
...
Paws::CodeCatalyst::ProjectSummary
...
As an example, if Att1 is expected to be a Paws::CodeCatalyst::ProjectSummary object:

  $service_obj->Method(Att1 => { Description => $value, ..., Name => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CodeCatalyst::ProjectSummary object:
