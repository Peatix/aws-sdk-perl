...
package Paws::MediaPackageVod::SpekeKeyProvider;
  use Moose;
  has EncryptionContractConfiguration => (is => 'ro', isa => 'Paws::MediaPackageVod::EncryptionContractConfiguration', request_name => 'encryptionContractConfiguration', traits => ['NameInRequest']);
...
As an example, if Att1 is expected to be a Paws::MediaPackageVod::SpekeKeyProvider object:
  ...
  $service_obj->Method(Att1 => { EncryptionContractConfiguration => $value, ..., Url => $value  });
...
Use accessors for each attribute. If Att1 is expected to be an Paws::MediaPackageVod::SpekeKeyProvider object:
  ...
  $result->Att1->EncryptionContractConfiguration
...
=head2 EncryptionContractConfiguration => L<Paws::MediaPackageVod::EncryptionContractConfiguration>
