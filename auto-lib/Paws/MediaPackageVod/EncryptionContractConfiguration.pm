...
package Paws::MediaPackageVod::EncryptionContractConfiguration;
  use Moose;
...
Paws::MediaPackageVod::EncryptionContractConfiguration
...
As an example, if Att1 is expected to be a Paws::MediaPackageVod::EncryptionContractConfiguration object:

  $service_obj->Method(Att1 => { PresetSpeke20Audio => $value, ..., PresetSpeke20Video => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MediaPackageVod::EncryptionContractConfiguration object:
