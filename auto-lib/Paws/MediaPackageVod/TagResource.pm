...
package Paws::MediaPackageVod::TagResource;
  use Moose;
  has ResourceArn => (is => 'ro', isa => 'Str', traits => ['ParamInURI'], uri_name => 'resource-arn', required => 1);
  has Tags => (is => 'ro', isa => 'Paws::MediaPackageVod::__mapOf__string', traits => ['NameInRequest'], request_name => 'tags', required => 1);
...
Paws::MediaPackageVod::TagResource - Arguments for method TagResource on L<Paws::MediaPackageVod>
...
=head2 B<REQUIRED> Tags => L<Paws::MediaPackageVod::__mapOf__string>
...
This class forms part of L<Paws>, documenting arguments for method TagResource in L<Paws::MediaPackageVod>
