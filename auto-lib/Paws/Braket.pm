package Paws::Braket;
  ...
  sub CancelJob {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Braket::CancelJob', @_);
  ...
  sub CreateJob {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Braket::CreateJob', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub GetJob {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Braket::GetJob', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetQuantumTask {
    my $self = shift;
  ...
  sub SearchJobs {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Braket::SearchJobs', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub operations { qw/CancelJob CancelQuantumTask CreateJob CreateQuantumTask GetDevice GetJob GetQuantumTask ListTagsForResource SearchDevices SearchJobs SearchQuantumTasks TagResource UntagResource / }
...
Each argument is described in detail in: L<Paws::Braket::CancelJob>

Returns: a L<Paws::Braket::CancelJobResponse> instance
...
=item AlgorithmSpecification => L<Paws::Braket::AlgorithmSpecification>

=item ClientToken => Str

=item DeviceConfig => L<Paws::Braket::DeviceConfig>

=item InstanceConfig => L<Paws::Braket::InstanceConfig>

=item JobName => Str

=item OutputDataConfig => L<Paws::Braket::JobOutputDataConfig>

=item RoleArn => Str

=item [Associations => ArrayRef[L<Paws::Braket::Association>]]

=item [CheckpointConfig => L<Paws::Braket::JobCheckpointConfig>]

=item [HyperParameters => L<Paws::Braket::HyperParameters>]

=item [InputDataConfig => ArrayRef[L<Paws::Braket::InputFileConfig>]]

=item [StoppingCondition => L<Paws::Braket::JobStoppingCondition>]
...
Each argument is described in detail in: L<Paws::Braket::CreateJob>

Returns: a L<Paws::Braket::CreateJobResponse> instance
...
=item [AdditionalAttributeNames => ArrayRef[Str|Undef]]


=back

Each argument is described in detail in: L<Paws::Braket::GetJob>

Returns: a L<Paws::Braket::GetJobResponse> instance
...
=item Filters => ArrayRef[L<Paws::Braket::SearchJobsFilter>]
...
Each argument is described in detail in: L<Paws::Braket::SearchJobs>

Returns: a L<Paws::Braket::SearchJobsResponse> instance
...
=head2 SearchAllJobs(sub { },Filters => ArrayRef[L<Paws::Braket::SearchJobsFilter>], [MaxResults => Int, NextToken => Str])

=head2 SearchAllJobs(Filters => ArrayRef[L<Paws::Braket::SearchJobsFilter>], [MaxResults => Int, NextToken => Str])
...
If not, it will return a a L<Paws::Braket::SearchJobsResponse> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
