package Paws::ServiceDiscovery;
  ...
  sub DeleteServiceAttributes {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ServiceDiscovery::DeleteServiceAttributes', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DiscoverInstancesRevision {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ServiceDiscovery::DiscoverInstancesRevision', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetInstance {
    my $self = shift;
  ...
  sub GetServiceAttributes {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ServiceDiscovery::GetServiceAttributes', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ListInstances {
    my $self = shift;
  ...
  sub UpdateServiceAttributes {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ServiceDiscovery::UpdateServiceAttributes', @_);
    return $self->caller->do_call($self, $call_object);
  }
...
The C<CreatePublicDnsNamespace> API operation is not supported in the
...
Each argument is described in detail in: L<Paws::ServiceDiscovery::DeleteServiceAttributes>

Returns: a L<Paws::ServiceDiscovery::DeleteServiceAttributesResponse> instance
...
namespace. C<DiscoverInstances> returns a randomized list of instances
...
=head2 DiscoverInstancesRevision
...
Each argument is described in detail in: L<Paws::ServiceDiscovery::DiscoverInstancesRevision>

Returns: a L<Paws::ServiceDiscovery::DiscoverInstancesRevisionResponse> instance
...
the response, such as a C<CreateHttpNamespace> request.
...
Each argument is described in detail in: L<Paws::ServiceDiscovery::GetServiceAttributes>

Returns: a L<Paws::ServiceDiscovery::GetServiceAttributesResponse> instance
...
=head2 UpdateServiceAttributes

=over

=item Attributes => L<Paws::ServiceDiscovery::ServiceAttributesMap>
...
Each argument is described in detail in: L<Paws::ServiceDiscovery::UpdateServiceAttributes>

Returns: a L<Paws::ServiceDiscovery::UpdateServiceAttributesResponse> instance
