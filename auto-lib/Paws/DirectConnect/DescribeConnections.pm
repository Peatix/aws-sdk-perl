...
Paws::DirectConnect::DescribeConnections - Arguments for method DescribeConnections on L<Paws::DirectConnect>
...
=head1 SYNOPSIS
    ...
    my $Connections = $directconnect->DescribeConnections(
...
This class forms part of L<Paws>, documenting arguments for method DescribeConnections in L<Paws::DirectConnect>
