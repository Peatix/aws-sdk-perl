...
package Paws::InternetMonitor::GetMonitor;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::InternetMonitor::GetMonitorOutput');
1;
...
Paws::InternetMonitor::GetMonitor - Arguments for method GetMonitor on L<Paws::InternetMonitor>
...
=head1 SYNOPSIS
    ...
    my $GetMonitorOutput = $internetmonitor->GetMonitor(
    ...
    my $HealthEventsConfig = $GetMonitorOutput->HealthEventsConfig;
    my $InternetMeasurementsLogDelivery =
      $GetMonitorOutput->InternetMeasurementsLogDelivery;
    my $MaxCityNetworksToMonitor = $GetMonitorOutput->MaxCityNetworksToMonitor;
    ...
    my $ProcessingStatus         = $GetMonitorOutput->ProcessingStatus;
    my $ProcessingStatusInfo     = $GetMonitorOutput->ProcessingStatusInfo;
    my $Resources                = $GetMonitorOutput->Resources;
    my $Status                   = $GetMonitorOutput->Status;
    my $Tags                     = $GetMonitorOutput->Tags;
    my $TrafficPercentageToMonitor =
      $GetMonitorOutput->TrafficPercentageToMonitor;

    # Returns a L<Paws::InternetMonitor::GetMonitorOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/internetmonitor/GetMonitor>
...
This class forms part of L<Paws>, documenting arguments for method GetMonitor in L<Paws::InternetMonitor>
