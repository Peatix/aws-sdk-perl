...
package Paws::InternetMonitor::DeleteMonitor;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::InternetMonitor::DeleteMonitorOutput');
1;
...
Paws::InternetMonitor::DeleteMonitor - Arguments for method DeleteMonitor on L<Paws::InternetMonitor>
...
=head1 SYNOPSIS
    ...
    my $DeleteMonitorOutput = $internetmonitor->DeleteMonitor(
      MonitorName => 'MyResourceName',

    );

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/internetmonitor/DeleteMonitor>
...
This class forms part of L<Paws>, documenting arguments for method DeleteMonitor in L<Paws::InternetMonitor>
