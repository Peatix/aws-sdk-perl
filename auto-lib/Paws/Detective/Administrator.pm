...
package Paws::Detective::Administrator;
  use Moose;
  has AccountId => (is => 'ro', isa => 'Str');
  has DelegationTime => (is => 'ro', isa => 'Str');
...
As an example, if Att1 is expected to be a Paws::Detective::Administrator object:

  $service_obj->Method(Att1 => { AccountId => $value, ..., GraphArn => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Detective::Administrator object:
