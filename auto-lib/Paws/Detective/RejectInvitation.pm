...
package Paws::Detective::RejectInvitation;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/invitation/removal');
...
Paws::Detective::RejectInvitation - Arguments for method RejectInvitation on L<Paws::Detective>
...
This class forms part of L<Paws>, documenting arguments for method RejectInvitation in L<Paws::Detective>
