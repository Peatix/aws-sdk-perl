...
package Paws::Detective::DescribeOrganizationConfiguration;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/orgs/describeOrganizationConfiguration');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Detective::DescribeOrganizationConfigurationResponse');
1;
...
Paws::Detective::DescribeOrganizationConfiguration - Arguments for method DescribeOrganizationConfiguration on L<Paws::Detective>
...
# Returns a L<Paws::Detective::DescribeOrganizationConfigurationResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/api.detective/DescribeOrganizationConfiguration>
...
This class forms part of L<Paws>, documenting arguments for method DescribeOrganizationConfiguration in L<Paws::Detective>
