...
package Paws::Detective::AcceptInvitation;
  use Moose;
...
Paws::Detective::AcceptInvitation - Arguments for method AcceptInvitation on L<Paws::Detective>
...
The member account status in the behavior graph must be C<INVITED>.
...
This class forms part of L<Paws>, documenting arguments for method AcceptInvitation in L<Paws::Detective>
