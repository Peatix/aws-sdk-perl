...
package Paws::Detective::DisableOrganizationAdminAccount;
  use Moose;

  use MooseX::ClassAttribute;

  class_has _api_call => (isa => 'Str', is => 'ro', default => 'DisableOrganizationAdminAccount');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/orgs/disableAdminAccount');
...
Paws::Detective::DisableOrganizationAdminAccount - Arguments for method DisableOrganizationAdminAccount on L<Paws::Detective>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/api.detective/DisableOrganizationAdminAccount>
...
This class forms part of L<Paws>, documenting arguments for method DisableOrganizationAdminAccount in L<Paws::Detective>
