package Paws::SavingsPlans;
  ...
  sub ReturnSavingsPlan {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::SavingsPlans::ReturnSavingsPlan', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub TagResource {
    my $self = shift;
  ...
  sub operations { qw/CreateSavingsPlan DeleteQueuedSavingsPlan DescribeSavingsPlanRates DescribeSavingsPlans DescribeSavingsPlansOfferingRates DescribeSavingsPlansOfferings ListTagsForResource ReturnSavingsPlan TagResource UntagResource / }
...
Each argument is described in detail in: L<Paws::SavingsPlans::ReturnSavingsPlan>

Returns: a L<Paws::SavingsPlans::ReturnSavingsPlanResponse> instance
