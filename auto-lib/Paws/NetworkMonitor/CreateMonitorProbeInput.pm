...
package Paws::NetworkMonitor::CreateMonitorProbeInput;
  use Moose;
  ...
  has ProbeTags => (is => 'ro', isa => 'Paws::NetworkMonitor::TagMap', request_name => 'probeTags', traits => ['NameInRequest']);
...
Paws::NetworkMonitor::CreateMonitorProbeInput
...
As an example, if Att1 is expected to be a Paws::NetworkMonitor::CreateMonitorProbeInput object:

  $service_obj->Method(Att1 => { Destination => $value, ..., SourceArn => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::NetworkMonitor::CreateMonitorProbeInput object:
...
=head2 ProbeTags => L<Paws::NetworkMonitor::TagMap>
