...
package Paws::NetworkMonitor::DeleteMonitor;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::NetworkMonitor::DeleteMonitorOutput');
1;
...
Paws::NetworkMonitor::DeleteMonitor - Arguments for method DeleteMonitor on L<Paws::NetworkMonitor>
...
=head1 SYNOPSIS
    ...
    my $DeleteMonitorOutput = $networkmonitor->DeleteMonitor(
      MonitorName => 'MyResourceName',

    );

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/networkmonitor/DeleteMonitor>
...
This class forms part of L<Paws>, documenting arguments for method DeleteMonitor in L<Paws::NetworkMonitor>
