...
package Paws::NetworkMonitor::GetMonitor;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::NetworkMonitor::GetMonitorOutput');
1;
...
Paws::NetworkMonitor::GetMonitor - Arguments for method GetMonitor on L<Paws::NetworkMonitor>
...
=head1 SYNOPSIS
    ...
    my $GetMonitorOutput = $networkmonitor->GetMonitor(
      MonitorName => 'MyResourceName',

    );

    # Results:
    my $AggregationPeriod = $GetMonitorOutput->AggregationPeriod;
    ...
    my $Probes            = $GetMonitorOutput->Probes;
    my $State             = $GetMonitorOutput->State;
    my $Tags              = $GetMonitorOutput->Tags;

    # Returns a L<Paws::NetworkMonitor::GetMonitorOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/networkmonitor/GetMonitor>
...
This class forms part of L<Paws>, documenting arguments for method GetMonitor in L<Paws::NetworkMonitor>
