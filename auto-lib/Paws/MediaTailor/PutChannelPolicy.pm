...
Paws::MediaTailor::PutChannelPolicy - Arguments for method PutChannelPolicy on L<Paws::MediaTailor>
...
=head1 SYNOPSIS
    ...
    my $PutChannelPolicyResponse = $api . mediatailor->PutChannelPolicy(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/api.mediatailor/PutChannelPolicy>
...
This class forms part of L<Paws>, documenting arguments for method PutChannelPolicy in L<Paws::MediaTailor>
