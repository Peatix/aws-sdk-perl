...
package Paws::MediaTailor::DeleteChannelPolicy;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::MediaTailor::DeleteChannelPolicyResponse');
1;
...
Paws::MediaTailor::DeleteChannelPolicy - Arguments for method DeleteChannelPolicy on L<Paws::MediaTailor>
...
=head1 SYNOPSIS
    ...
    my $DeleteChannelPolicyResponse = $api . mediatailor->DeleteChannelPolicy(
      ChannelName => 'My__string',

    );

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/api.mediatailor/DeleteChannelPolicy>
...
This class forms part of L<Paws>, documenting arguments for method DeleteChannelPolicy in L<Paws::MediaTailor>
