...
package Paws::ApplicationSignals::ListServiceOperationsOutput;
  use Moose;
  has EndTime => (is => 'ro', isa => 'Str', required => 1);
  has NextToken => (is => 'ro', isa => 'Str');
  has ServiceOperations => (is => 'ro', isa => 'ArrayRef[Paws::ApplicationSignals::ServiceOperation]', required => 1);
...
Paws::ApplicationSignals::ListServiceOperationsOutput
...
=head2 B<REQUIRED> ServiceOperations => ArrayRef[L<Paws::ApplicationSignals::ServiceOperation>]
