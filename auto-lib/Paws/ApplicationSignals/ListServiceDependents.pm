...
package Paws::ApplicationSignals::ListServiceDependents;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'ListServiceDependents');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/service-dependents');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ApplicationSignals::ListServiceDependentsOutput');
1;
...
Paws::ApplicationSignals::ListServiceDependents - Arguments for method ListServiceDependents on L<Paws::ApplicationSignals>

=head1 DESCRIPTION

This class represents the parameters used for calling the method ListServiceDependents on the
L<Amazon CloudWatch Application Signals|Paws::ApplicationSignals> service. Use the attributes of this class
as arguments to method ListServiceDependents.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to ListServiceDependents.

=head1 SYNOPSIS

    my $application-signals = Paws->service('ApplicationSignals');
    my $ListServiceDependentsOutput =
    ...
    # Results:
    my $EndTime           = $ListServiceDependentsOutput->EndTime;
    my $NextToken         = $ListServiceDependentsOutput->NextToken;
    my $ServiceDependents = $ListServiceDependentsOutput->ServiceDependents;
    my $StartTime         = $ListServiceDependentsOutput->StartTime;

    # Returns a L<Paws::ApplicationSignals::ListServiceDependentsOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/application-signals/ListServiceDependents>
...
This class forms part of L<Paws>, documenting arguments for method ListServiceDependents in L<Paws::ApplicationSignals>
