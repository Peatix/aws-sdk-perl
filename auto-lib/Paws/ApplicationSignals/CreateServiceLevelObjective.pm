...
package Paws::ApplicationSignals::CreateServiceLevelObjective;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'CreateServiceLevelObjective');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/slo');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ApplicationSignals::CreateServiceLevelObjectiveOutput');
1;
...
Paws::ApplicationSignals::CreateServiceLevelObjective - Arguments for method CreateServiceLevelObjective on L<Paws::ApplicationSignals>

=head1 DESCRIPTION

This class represents the parameters used for calling the method CreateServiceLevelObjective on the
L<Amazon CloudWatch Application Signals|Paws::ApplicationSignals> service. Use the attributes of this class
as arguments to method CreateServiceLevelObjective.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to CreateServiceLevelObjective.

=head1 SYNOPSIS

    my $application-signals = Paws->service('ApplicationSignals');
    my $CreateServiceLevelObjectiveOutput =
      $application -signals->CreateServiceLevelObjective(
      Name                   => 'MyServiceLevelObjectiveName',
    ...
    # Results:
    my $Slo = $CreateServiceLevelObjectiveOutput->Slo;

# Returns a L<Paws::ApplicationSignals::CreateServiceLevelObjectiveOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/application-signals/CreateServiceLevelObjective>
...
You can't specify both C<RequestBasedSliConfig> and C<SliConfig> in the
same operation.
...
This class forms part of L<Paws>, documenting arguments for method CreateServiceLevelObjective in L<Paws::ApplicationSignals>
