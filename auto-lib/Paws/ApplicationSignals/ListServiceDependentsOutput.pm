...
package Paws::ApplicationSignals::ListServiceDependentsOutput;
  use Moose;
  has EndTime => (is => 'ro', isa => 'Str', required => 1);
  has NextToken => (is => 'ro', isa => 'Str');
  has ServiceDependents => (is => 'ro', isa => 'ArrayRef[Paws::ApplicationSignals::ServiceDependent]', required => 1);
...
Paws::ApplicationSignals::ListServiceDependentsOutput
...
=head2 B<REQUIRED> ServiceDependents => ArrayRef[L<Paws::ApplicationSignals::ServiceDependent>]

An array, where each object in the array contains information about one
of the dependents of this service.
