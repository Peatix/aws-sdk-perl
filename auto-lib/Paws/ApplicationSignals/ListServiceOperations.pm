...
package Paws::ApplicationSignals::ListServiceOperations;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'ListServiceOperations');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/service-operations');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ApplicationSignals::ListServiceOperationsOutput');
1;
...
Paws::ApplicationSignals::ListServiceOperations - Arguments for method ListServiceOperations on L<Paws::ApplicationSignals>

=head1 DESCRIPTION

This class represents the parameters used for calling the method ListServiceOperations on the
L<Amazon CloudWatch Application Signals|Paws::ApplicationSignals> service. Use the attributes of this class
as arguments to method ListServiceOperations.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to ListServiceOperations.

=head1 SYNOPSIS

    my $application-signals = Paws->service('ApplicationSignals');
    my $ListServiceOperationsOutput =
    ...
    # Results:
    my $EndTime           = $ListServiceOperationsOutput->EndTime;
    my $NextToken         = $ListServiceOperationsOutput->NextToken;
    my $ServiceOperations = $ListServiceOperationsOutput->ServiceOperations;
    my $StartTime         = $ListServiceOperationsOutput->StartTime;

    # Returns a L<Paws::ApplicationSignals::ListServiceOperationsOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/application-signals/ListServiceOperations>
...
This class forms part of L<Paws>, documenting arguments for method ListServiceOperations in L<Paws::ApplicationSignals>
