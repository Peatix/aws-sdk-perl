...
package Paws::AppIntegrations::ListApplications;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::AppIntegrations::ListApplicationsResponse');
1;
...
Paws::AppIntegrations::ListApplications - Arguments for method ListApplications on L<Paws::AppIntegrations>
...
=head1 SYNOPSIS
    ...
    my $ListApplicationsResponse = $app -integrations->ListApplications(
    ...
    # Returns a L<Paws::AppIntegrations::ListApplicationsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/app-integrations/ListApplications>
...
This class forms part of L<Paws>, documenting arguments for method ListApplications in L<Paws::AppIntegrations>
