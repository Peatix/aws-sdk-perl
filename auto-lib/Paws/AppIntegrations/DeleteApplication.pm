...
package Paws::AppIntegrations::DeleteApplication;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::AppIntegrations::DeleteApplicationResponse');
1;
...
Paws::AppIntegrations::DeleteApplication - Arguments for method DeleteApplication on L<Paws::AppIntegrations>
...
=head1 SYNOPSIS
    ...
    my $DeleteApplicationResponse = $app -integrations->DeleteApplication(
      Arn => 'MyArnOrUUID',

    );

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/app-integrations/DeleteApplication>
...
This class forms part of L<Paws>, documenting arguments for method DeleteApplication in L<Paws::AppIntegrations>
