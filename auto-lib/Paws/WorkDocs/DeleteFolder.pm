...
package Paws::WorkDocs::DeleteFolder;
  use Moose;
...
Paws::WorkDocs::DeleteFolder - Arguments for method DeleteFolder on L<Paws::WorkDocs>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/workdocs/DeleteFolder>
...
This class forms part of L<Paws>, documenting arguments for method DeleteFolder in L<Paws::WorkDocs>
