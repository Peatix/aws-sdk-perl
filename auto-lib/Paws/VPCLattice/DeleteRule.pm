...
package Paws::VPCLattice::DeleteRule;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::VPCLattice::DeleteRuleResponse');
1;
...
Paws::VPCLattice::DeleteRule - Arguments for method DeleteRule on L<Paws::VPCLattice>
...
=head1 SYNOPSIS
    ...
    my $DeleteRuleResponse = $vpc -lattice->DeleteRule(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/vpc-lattice/DeleteRule>
...
This class forms part of L<Paws>, documenting arguments for method DeleteRule in L<Paws::VPCLattice>
