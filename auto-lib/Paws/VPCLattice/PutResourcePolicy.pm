...
package Paws::VPCLattice::PutResourcePolicy;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::VPCLattice::PutResourcePolicyResponse');
1;
...
Paws::VPCLattice::PutResourcePolicy - Arguments for method PutResourcePolicy on L<Paws::VPCLattice>
...
=head1 SYNOPSIS
    ...
    my $PutResourcePolicyResponse = $vpc -lattice->PutResourcePolicy(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/vpc-lattice/PutResourcePolicy>
...
This class forms part of L<Paws>, documenting arguments for method PutResourcePolicy in L<Paws::VPCLattice>
