...
package Paws::VPCLattice::DeleteListener;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::VPCLattice::DeleteListenerResponse');
1;
...
Paws::VPCLattice::DeleteListener - Arguments for method DeleteListener on L<Paws::VPCLattice>
...
=head1 SYNOPSIS
    ...
    my $DeleteListenerResponse = $vpc -lattice->DeleteListener(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/vpc-lattice/DeleteListener>
...
This class forms part of L<Paws>, documenting arguments for method DeleteListener in L<Paws::VPCLattice>
