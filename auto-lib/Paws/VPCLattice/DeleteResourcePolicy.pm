...
package Paws::VPCLattice::DeleteResourcePolicy;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::VPCLattice::DeleteResourcePolicyResponse');
1;
...
Paws::VPCLattice::DeleteResourcePolicy - Arguments for method DeleteResourcePolicy on L<Paws::VPCLattice>
...
=head1 SYNOPSIS
    ...
    my $DeleteResourcePolicyResponse = $vpc -lattice->DeleteResourcePolicy(
      ResourceArn => 'MyResourceArn',

    );

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/vpc-lattice/DeleteResourcePolicy>
...
This class forms part of L<Paws>, documenting arguments for method DeleteResourcePolicy in L<Paws::VPCLattice>
