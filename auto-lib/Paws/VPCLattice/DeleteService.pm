...
package Paws::VPCLattice::DeleteService;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::VPCLattice::DeleteServiceResponse');
1;
...
Paws::VPCLattice::DeleteService - Arguments for method DeleteService on L<Paws::VPCLattice>
...
=head1 SYNOPSIS
    ...
    my $DeleteServiceResponse = $vpc -lattice->DeleteService(
    ...
    my $Id     = $DeleteServiceResponse->Id;
    my $Name   = $DeleteServiceResponse->Name;
    my $Status = $DeleteServiceResponse->Status;

    # Returns a L<Paws::VPCLattice::DeleteServiceResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/vpc-lattice/DeleteService>
...
This class forms part of L<Paws>, documenting arguments for method DeleteService in L<Paws::VPCLattice>
