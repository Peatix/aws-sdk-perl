...
package Paws::VPCLattice::DeregisterTargets;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/targetgroups/{targetGroupIdentifier}/deregistertargets');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::VPCLattice::DeregisterTargetsResponse');
1;
...
Paws::VPCLattice::DeregisterTargets - Arguments for method DeregisterTargets on L<Paws::VPCLattice>
...
=head1 SYNOPSIS
    ...
    my $DeregisterTargetsResponse = $vpc -lattice->DeregisterTargets(
    ...
    # Results:
    my $Successful   = $DeregisterTargetsResponse->Successful;
    my $Unsuccessful = $DeregisterTargetsResponse->Unsuccessful;

    # Returns a L<Paws::VPCLattice::DeregisterTargetsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/vpc-lattice/DeregisterTargets>
...
This class forms part of L<Paws>, documenting arguments for method DeregisterTargets in L<Paws::VPCLattice>
