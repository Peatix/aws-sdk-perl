...
package Paws::VPCLattice::ServiceNetworkVpcAssociationSummary;
  use Moose;
...
Paws::VPCLattice::ServiceNetworkVpcAssociationSummary
...
As an example, if Att1 is expected to be a Paws::VPCLattice::ServiceNetworkVpcAssociationSummary object:

  $service_obj->Method(Att1 => { Arn => $value, ..., VpcId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::VPCLattice::ServiceNetworkVpcAssociationSummary object:
