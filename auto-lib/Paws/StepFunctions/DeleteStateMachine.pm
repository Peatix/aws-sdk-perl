...
package Paws::StepFunctions::DeleteStateMachine;
  use Moose;
  has StateMachineArn => (is => 'ro', isa => 'Str', traits => ['NameInRequest'], request_name => 'stateMachineArn' , required => 1);

  use MooseX::ClassAttribute;

  class_has _api_call => (isa => 'Str', is => 'ro', default => 'DeleteStateMachine');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::StepFunctions::DeleteStateMachineOutput');
...
Paws::StepFunctions::DeleteStateMachine - Arguments for method DeleteStateMachine on L<Paws::StepFunctions>
...
=head1 SYNOPSIS
    ...
    my $DeleteStateMachineOutput = $states->DeleteStateMachine(
...
This class forms part of L<Paws>, documenting arguments for method DeleteStateMachine in L<Paws::StepFunctions>
