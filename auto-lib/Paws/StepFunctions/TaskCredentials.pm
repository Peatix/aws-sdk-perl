...
package Paws::StepFunctions::TaskCredentials;
  use Moose;
...
Paws::StepFunctions::TaskCredentials
...
As an example, if Att1 is expected to be a Paws::StepFunctions::TaskCredentials object:

  $service_obj->Method(Att1 => { RoleArn => $value, ..., RoleArn => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::StepFunctions::TaskCredentials object:
