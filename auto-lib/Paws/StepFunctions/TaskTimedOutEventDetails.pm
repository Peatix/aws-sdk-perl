...
Paws::StepFunctions::TaskTimedOutEventDetails
...
As an example, if Att1 is expected to be a Paws::StepFunctions::TaskTimedOutEventDetails object:

  $service_obj->Method(Att1 => { Cause => $value, ..., ResourceType => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::StepFunctions::TaskTimedOutEventDetails object:
