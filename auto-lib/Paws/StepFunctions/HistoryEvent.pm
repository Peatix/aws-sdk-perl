...
package Paws::StepFunctions::HistoryEvent;
  ...
  has EvaluationFailedEventDetails => (is => 'ro', isa => 'Paws::StepFunctions::EvaluationFailedEventDetails', request_name => 'evaluationFailedEventDetails', traits => ['NameInRequest']);
  ...
  has ExecutionRedrivenEventDetails => (is => 'ro', isa => 'Paws::StepFunctions::ExecutionRedrivenEventDetails', request_name => 'executionRedrivenEventDetails', traits => ['NameInRequest']);
  ...
  has MapRunFailedEventDetails => (is => 'ro', isa => 'Paws::StepFunctions::MapRunFailedEventDetails', request_name => 'mapRunFailedEventDetails', traits => ['NameInRequest']);
  has MapRunRedrivenEventDetails => (is => 'ro', isa => 'Paws::StepFunctions::MapRunRedrivenEventDetails', request_name => 'mapRunRedrivenEventDetails', traits => ['NameInRequest']);
  has MapRunStartedEventDetails => (is => 'ro', isa => 'Paws::StepFunctions::MapRunStartedEventDetails', request_name => 'mapRunStartedEventDetails', traits => ['NameInRequest']);
...
=head2 EvaluationFailedEventDetails => L<Paws::StepFunctions::EvaluationFailedEventDetails>
...
=head2 ExecutionRedrivenEventDetails => L<Paws::StepFunctions::ExecutionRedrivenEventDetails>
...
=head2 MapRunFailedEventDetails => L<Paws::StepFunctions::MapRunFailedEventDetails>

Contains error and cause details about a Map Run that failed.


=head2 MapRunRedrivenEventDetails => L<Paws::StepFunctions::MapRunRedrivenEventDetails>

Contains details about the redrive attempt of a Map Run.


=head2 MapRunStartedEventDetails => L<Paws::StepFunctions::MapRunStartedEventDetails>

Contains details, such as C<mapRunArn>, and the start date and time of
a Map Run. C<mapRunArn> is the Amazon Resource Name (ARN) of the Map
