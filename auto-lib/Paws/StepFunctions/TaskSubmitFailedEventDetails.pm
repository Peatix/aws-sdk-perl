...
package Paws::StepFunctions::TaskSubmitFailedEventDetails;
  use Moose;
...
Paws::StepFunctions::TaskSubmitFailedEventDetails
...
As an example, if Att1 is expected to be a Paws::StepFunctions::TaskSubmitFailedEventDetails object:

  $service_obj->Method(Att1 => { Cause => $value, ..., ResourceType => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::StepFunctions::TaskSubmitFailedEventDetails object:
