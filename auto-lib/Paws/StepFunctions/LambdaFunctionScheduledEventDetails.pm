...
package Paws::StepFunctions::LambdaFunctionScheduledEventDetails;
  ...
  has TaskCredentials => (is => 'ro', isa => 'Paws::StepFunctions::TaskCredentials', request_name => 'taskCredentials', traits => ['NameInRequest']);
...
=head2 TaskCredentials => L<Paws::StepFunctions::TaskCredentials>
