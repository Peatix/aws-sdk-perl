...
package Paws::StepFunctions::MapRunFailedEventDetails;
  use Moose;
...
Paws::StepFunctions::MapRunFailedEventDetails
...
As an example, if Att1 is expected to be a Paws::StepFunctions::MapRunFailedEventDetails object:

  $service_obj->Method(Att1 => { Cause => $value, ..., Error => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::StepFunctions::MapRunFailedEventDetails object:
