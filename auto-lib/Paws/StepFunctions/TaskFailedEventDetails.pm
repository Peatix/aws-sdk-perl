...
package Paws::StepFunctions::TaskFailedEventDetails;
  use Moose;
...
Paws::StepFunctions::TaskFailedEventDetails
...
As an example, if Att1 is expected to be a Paws::StepFunctions::TaskFailedEventDetails object:

  $service_obj->Method(Att1 => { Cause => $value, ..., ResourceType => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::StepFunctions::TaskFailedEventDetails object:
