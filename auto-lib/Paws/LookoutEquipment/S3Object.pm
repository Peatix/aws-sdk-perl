...
package Paws::LookoutEquipment::S3Object;
  use Moose;
...
Paws::LookoutEquipment::S3Object
...
As an example, if Att1 is expected to be a Paws::LookoutEquipment::S3Object object:

  $service_obj->Method(Att1 => { Bucket => $value, ..., Key => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::LookoutEquipment::S3Object object:
