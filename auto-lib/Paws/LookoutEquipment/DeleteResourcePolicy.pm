...
package Paws::LookoutEquipment::DeleteResourcePolicy;
  use Moose;
...
Paws::LookoutEquipment::DeleteResourcePolicy - Arguments for method DeleteResourcePolicy on L<Paws::LookoutEquipment>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/lookoutequipment/DeleteResourcePolicy>
...
This class forms part of L<Paws>, documenting arguments for method DeleteResourcePolicy in L<Paws::LookoutEquipment>
