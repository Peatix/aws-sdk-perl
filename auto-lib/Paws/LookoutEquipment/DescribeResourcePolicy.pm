...
package Paws::LookoutEquipment::DescribeResourcePolicy;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::LookoutEquipment::DescribeResourcePolicyResponse');
...
Paws::LookoutEquipment::DescribeResourcePolicy - Arguments for method DescribeResourcePolicy on L<Paws::LookoutEquipment>
...
=head1 SYNOPSIS
   ...
   # Returns a L<Paws::LookoutEquipment::DescribeResourcePolicyResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/lookoutequipment/DescribeResourcePolicy>
...
This class forms part of L<Paws>, documenting arguments for method DescribeResourcePolicy in L<Paws::LookoutEquipment>
