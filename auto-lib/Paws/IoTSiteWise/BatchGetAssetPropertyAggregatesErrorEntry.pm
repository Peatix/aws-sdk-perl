...
package Paws::IoTSiteWise::BatchGetAssetPropertyAggregatesErrorEntry;
  use Moose;
...
Paws::IoTSiteWise::BatchGetAssetPropertyAggregatesErrorEntry
...
As an example, if Att1 is expected to be a Paws::IoTSiteWise::BatchGetAssetPropertyAggregatesErrorEntry object:

  $service_obj->Method(Att1 => { EntryId => $value, ..., ErrorMessage => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IoTSiteWise::BatchGetAssetPropertyAggregatesErrorEntry object:
...
is associated with the BatchGetAssetPropertyAggregates
