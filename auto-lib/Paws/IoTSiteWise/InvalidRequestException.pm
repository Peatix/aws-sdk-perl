...
package Paws::IoTSiteWise::InvalidRequestException;
  use Moose;
...
Paws::IoTSiteWise::InvalidRequestException
...
As an example, if Att1 is expected to be a Paws::IoTSiteWise::InvalidRequestException object:

  $service_obj->Method(Att1 => { Message => $value, ..., Message => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IoTSiteWise::InvalidRequestException object:
