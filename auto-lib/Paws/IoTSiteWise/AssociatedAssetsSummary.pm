...
package Paws::IoTSiteWise::AssociatedAssetsSummary;
  use Moose;
  ...
  has Status => (is => 'ro', isa => 'Paws::IoTSiteWise::AssetStatus', request_name => 'status', traits => ['NameInRequest'], required => 1);
...
Paws::IoTSiteWise::AssociatedAssetsSummary
...
As an example, if Att1 is expected to be a Paws::IoTSiteWise::AssociatedAssetsSummary object:

  $service_obj->Method(Att1 => { Arn => $value, ..., Status => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IoTSiteWise::AssociatedAssetsSummary object:
...
=head2 B<REQUIRED> Status => L<Paws::IoTSiteWise::AssetStatus>
