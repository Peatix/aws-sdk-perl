...
package Paws::IoTSiteWise::AssetSummary;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::IoTSiteWise::AssetSummary object:

  $service_obj->Method(Att1 => { Arn => $value, ..., Status => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IoTSiteWise::AssetSummary object:
