...
package Paws::IoTSiteWise::AssetModelCompositeModelSummary;
  use Moose;
  has Description => (is => 'ro', isa => 'Str', request_name => 'description', traits => ['NameInRequest']);
  has ExternalId => (is => 'ro', isa => 'Str', request_name => 'externalId', traits => ['NameInRequest']);
  has Id => (is => 'ro', isa => 'Str', request_name => 'id', traits => ['NameInRequest'], required => 1);
  has Name => (is => 'ro', isa => 'Str', request_name => 'name', traits => ['NameInRequest'], required => 1);
  has Path => (is => 'ro', isa => 'ArrayRef[Paws::IoTSiteWise::AssetModelCompositeModelPathSegment]', request_name => 'path', traits => ['NameInRequest']);
...
Paws::IoTSiteWise::AssetModelCompositeModelSummary
...
As an example, if Att1 is expected to be a Paws::IoTSiteWise::AssetModelCompositeModelSummary object:

  $service_obj->Method(Att1 => { Description => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IoTSiteWise::AssetModelCompositeModelSummary object:
...
=head2 Path => ArrayRef[L<Paws::IoTSiteWise::AssetModelCompositeModelPathSegment>]
