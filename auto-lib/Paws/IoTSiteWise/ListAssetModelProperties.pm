...
package Paws::IoTSiteWise::ListAssetModelProperties;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'ListAssetModelProperties');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/asset-models/{assetModelId}/properties');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::IoTSiteWise::ListAssetModelPropertiesResponse');
1;
...
Paws::IoTSiteWise::ListAssetModelProperties - Arguments for method ListAssetModelProperties on L<Paws::IoTSiteWise>

=head1 DESCRIPTION

This class represents the parameters used for calling the method ListAssetModelProperties on the
L<AWS IoT SiteWise|Paws::IoTSiteWise> service. Use the attributes of this class
as arguments to method ListAssetModelProperties.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to ListAssetModelProperties.

=head1 SYNOPSIS

    my $iotsitewise = Paws->service('IoTSiteWise');
    my $ListAssetModelPropertiesResponse =
    ...
    # Results:
    my $AssetModelPropertySummaries =
      $ListAssetModelPropertiesResponse->AssetModelPropertySummaries;
    my $NextToken = $ListAssetModelPropertiesResponse->NextToken;

    # Returns a L<Paws::IoTSiteWise::ListAssetModelPropertiesResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/iotsitewise/ListAssetModelProperties>
...
C<ALL> E<ndash> The list includes all asset model properties for a
given asset model ID.

=item *

C<BASE> E<ndash> The list includes only base asset model properties for
...
This class forms part of L<Paws>, documenting arguments for method ListAssetModelProperties in L<Paws::IoTSiteWise>
