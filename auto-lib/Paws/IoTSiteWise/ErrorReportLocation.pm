...
package Paws::IoTSiteWise::ErrorReportLocation;
  use Moose;
...
Paws::IoTSiteWise::ErrorReportLocation
...
As an example, if Att1 is expected to be a Paws::IoTSiteWise::ErrorReportLocation object:

  $service_obj->Method(Att1 => { Bucket => $value, ..., Prefix => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IoTSiteWise::ErrorReportLocation object:
...
bucket. Each Amazon S3 object has a key that is its unique identifier
