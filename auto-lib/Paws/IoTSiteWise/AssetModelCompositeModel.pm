...
package Paws::IoTSiteWise::AssetModelCompositeModel;
  use Moose;
  has Description => (is => 'ro', isa => 'Str', request_name => 'description', traits => ['NameInRequest']);
  has ExternalId => (is => 'ro', isa => 'Str', request_name => 'externalId', traits => ['NameInRequest']);
  has Id => (is => 'ro', isa => 'Str', request_name => 'id', traits => ['NameInRequest']);
  has Name => (is => 'ro', isa => 'Str', request_name => 'name', traits => ['NameInRequest'], required => 1);
  has Properties => (is => 'ro', isa => 'ArrayRef[Paws::IoTSiteWise::AssetModelProperty]', request_name => 'properties', traits => ['NameInRequest']);
...
Paws::IoTSiteWise::AssetModelCompositeModel
...
As an example, if Att1 is expected to be a Paws::IoTSiteWise::AssetModelCompositeModel object:

  $service_obj->Method(Att1 => { Description => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IoTSiteWise::AssetModelCompositeModel object:
...
=head2 Properties => ArrayRef[L<Paws::IoTSiteWise::AssetModelProperty>]
