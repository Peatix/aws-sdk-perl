...
package Paws::IoTSiteWise::BatchGetAssetPropertyValueHistoryErrorEntry;
  use Moose;
...
Paws::IoTSiteWise::BatchGetAssetPropertyValueHistoryErrorEntry
...
As an example, if Att1 is expected to be a Paws::IoTSiteWise::BatchGetAssetPropertyValueHistoryErrorEntry object:

  $service_obj->Method(Att1 => { EntryId => $value, ..., ErrorMessage => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IoTSiteWise::BatchGetAssetPropertyValueHistoryErrorEntry object:
