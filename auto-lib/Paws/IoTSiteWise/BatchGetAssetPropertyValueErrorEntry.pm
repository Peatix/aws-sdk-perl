...
package Paws::IoTSiteWise::BatchGetAssetPropertyValueErrorEntry;
  use Moose;
...
Paws::IoTSiteWise::BatchGetAssetPropertyValueErrorEntry
...
As an example, if Att1 is expected to be a Paws::IoTSiteWise::BatchGetAssetPropertyValueErrorEntry object:

  $service_obj->Method(Att1 => { EntryId => $value, ..., ErrorMessage => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IoTSiteWise::BatchGetAssetPropertyValueErrorEntry object:
