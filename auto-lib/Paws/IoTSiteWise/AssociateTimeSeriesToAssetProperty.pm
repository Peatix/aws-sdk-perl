...
package Paws::IoTSiteWise::AssociateTimeSeriesToAssetProperty;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'AssociateTimeSeriesToAssetProperty');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/timeseries/associate/');
...
Paws::IoTSiteWise::AssociateTimeSeriesToAssetProperty - Arguments for method AssociateTimeSeriesToAssetProperty on L<Paws::IoTSiteWise>

=head1 DESCRIPTION

This class represents the parameters used for calling the method AssociateTimeSeriesToAssetProperty on the
L<AWS IoT SiteWise|Paws::IoTSiteWise> service. Use the attributes of this class
as arguments to method AssociateTimeSeriesToAssetProperty.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to AssociateTimeSeriesToAssetProperty.
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/iotsitewise/AssociateTimeSeriesToAssetProperty>
...
This class forms part of L<Paws>, documenting arguments for method AssociateTimeSeriesToAssetProperty in L<Paws::IoTSiteWise>
