...
package Paws::LakeFormation::CommitTransaction;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::LakeFormation::CommitTransactionResponse');
1;
...
Paws::LakeFormation::CommitTransaction - Arguments for method CommitTransaction on L<Paws::LakeFormation>
...
=head1 SYNOPSIS
    ...
    my $CommitTransactionResponse = $lakeformation->CommitTransaction(
    ...
    # Returns a L<Paws::LakeFormation::CommitTransactionResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/lakeformation/CommitTransaction>
...
This class forms part of L<Paws>, documenting arguments for method CommitTransaction in L<Paws::LakeFormation>
