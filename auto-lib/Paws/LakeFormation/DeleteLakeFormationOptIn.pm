...
package Paws::LakeFormation::DeleteLakeFormationOptIn;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'DeleteLakeFormationOptIn');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/DeleteLakeFormationOptIn');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::LakeFormation::DeleteLakeFormationOptInResponse');
1;
...
Paws::LakeFormation::DeleteLakeFormationOptIn - Arguments for method DeleteLakeFormationOptIn on L<Paws::LakeFormation>

=head1 DESCRIPTION

This class represents the parameters used for calling the method DeleteLakeFormationOptIn on the
L<AWS Lake Formation|Paws::LakeFormation> service. Use the attributes of this class
as arguments to method DeleteLakeFormationOptIn.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to DeleteLakeFormationOptIn.

=head1 SYNOPSIS

    my $lakeformation = Paws->service('LakeFormation');
    my $DeleteLakeFormationOptInResponse =
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/lakeformation/DeleteLakeFormationOptIn>
...
This class forms part of L<Paws>, documenting arguments for method DeleteLakeFormationOptIn in L<Paws::LakeFormation>
