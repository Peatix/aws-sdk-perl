...
Paws::DS::GetDirectoryLimits - Arguments for method GetDirectoryLimits on L<Paws::DS>
...
=head1 SYNOPSIS
    ...
    my $GetDirectoryLimitsResult = $ds->GetDirectoryLimits();

    # Results:
    my $DirectoryLimits = $GetDirectoryLimitsResult->DirectoryLimits;

    # Returns a L<Paws::DS::GetDirectoryLimitsResult> object.
