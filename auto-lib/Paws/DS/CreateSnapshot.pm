...
Paws::DS::CreateSnapshot - Arguments for method CreateSnapshot on L<Paws::DS>
...
This class forms part of L<Paws>, documenting arguments for method CreateSnapshot in L<Paws::DS>
