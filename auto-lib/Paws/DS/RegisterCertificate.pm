...
package Paws::DS::RegisterCertificate;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::DS::RegisterCertificateResult');
...
Paws::DS::RegisterCertificate - Arguments for method RegisterCertificate on L<Paws::DS>
...
=head2 B<REQUIRED> CertificateData => Str
...
This class forms part of L<Paws>, documenting arguments for method RegisterCertificate in L<Paws::DS>
