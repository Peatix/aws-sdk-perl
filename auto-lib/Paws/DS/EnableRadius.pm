...
Paws::DS::EnableRadius - Arguments for method EnableRadius on L<Paws::DS>
...
=head1 SYNOPSIS
    ...
    my $EnableRadiusResult = $ds->EnableRadius(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/ds/EnableRadius>
