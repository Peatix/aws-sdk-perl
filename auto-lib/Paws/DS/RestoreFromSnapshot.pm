...
package Paws::DS::RestoreFromSnapshot;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::DS::RestoreFromSnapshotResult');
...
Paws::DS::RestoreFromSnapshot - Arguments for method RestoreFromSnapshot on L<Paws::DS>
...
=head1 SYNOPSIS
    ...
    my $RestoreFromSnapshotResult = $ds->RestoreFromSnapshot(
...
This class forms part of L<Paws>, documenting arguments for method RestoreFromSnapshot in L<Paws::DS>
