...
package Paws::Glue::SelectFromCollection;
  use Moose;
...
Paws::Glue::SelectFromCollection
...
As an example, if Att1 is expected to be a Paws::Glue::SelectFromCollection object:

  $service_obj->Method(Att1 => { Index => $value, ..., Name => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Glue::SelectFromCollection object:
