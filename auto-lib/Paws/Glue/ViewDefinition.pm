...
package Paws::Glue::ViewDefinition;
  use Moose;
  has Definer => (is => 'ro', isa => 'Str');
  has IsProtected => (is => 'ro', isa => 'Bool');
  has Representations => (is => 'ro', isa => 'ArrayRef[Paws::Glue::ViewRepresentation]');
...
As an example, if Att1 is expected to be a Paws::Glue::ViewDefinition object:

  $service_obj->Method(Att1 => { Definer => $value, ..., SubObjects => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Glue::ViewDefinition object:
...
=head2 Representations => ArrayRef[L<Paws::Glue::ViewRepresentation>]
