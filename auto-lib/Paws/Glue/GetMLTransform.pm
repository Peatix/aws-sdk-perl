...
Paws::Glue::GetMLTransform - Arguments for method GetMLTransform on L<Paws::Glue>

=head1 DESCRIPTION

This class represents the parameters used for calling the method GetMLTransform on the
L<AWS Glue|Paws::Glue> service. Use the attributes of this class
as arguments to method GetMLTransform.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to GetMLTransform.

=head1 SYNOPSIS

    my $glue = Paws->service('Glue');
    my $GetMLTransformResponse = $glue->GetMLTransform(
...
This class forms part of L<Paws>, documenting arguments for method GetMLTransform in L<Paws::Glue>
