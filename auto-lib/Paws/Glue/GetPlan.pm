...
package Paws::Glue::GetPlan;
  use Moose;
  has AdditionalPlanOptionsMap => (is => 'ro', isa => 'Paws::Glue::AdditionalPlanOptionsMap');
...
=head2 AdditionalPlanOptionsMap => L<Paws::Glue::AdditionalPlanOptionsMap>
...
C<inferSchema> E<mdash> Specifies whether to set C<inferSchema> to true
or false for the default script generated by an Glue job. For example,
to set C<inferSchema> to true, pass the following key value pair:

C<--additional-plan-options-map '{"inferSchema":"true"}'>
