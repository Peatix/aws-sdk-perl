...
package Paws::Glue::CreateBlueprint;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Glue::CreateBlueprintResponse');
...
Paws::Glue::CreateBlueprint - Arguments for method CreateBlueprint on L<Paws::Glue>
...
=head1 SYNOPSIS
    ...
    my $CreateBlueprintResponse = $glue->CreateBlueprint(
    ...
    # Results:
    my $Name = $CreateBlueprintResponse->Name;

    # Returns a L<Paws::Glue::CreateBlueprintResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/glue/CreateBlueprint>
...
This class forms part of L<Paws>, documenting arguments for method CreateBlueprint in L<Paws::Glue>
