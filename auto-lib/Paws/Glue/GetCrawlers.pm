...
Paws::Glue::GetCrawlers - Arguments for method GetCrawlers on L<Paws::Glue>
...
=head1 SYNOPSIS
    ...
    my $GetCrawlersResponse = $glue->GetCrawlers(
      MaxResults => 1,            # OPTIONAL
      NextToken  => 'MyToken',    # OPTIONAL
    );

    # Results:
    my $Crawlers  = $GetCrawlersResponse->Crawlers;
    my $NextToken = $GetCrawlersResponse->NextToken;

    # Returns a L<Paws::Glue::GetCrawlersResponse> object.
