...
package Paws::Glue::WorkflowRunStatistics;
  use Moose;
  has ErroredActions => (is => 'ro', isa => 'Int');
  ...
  has WaitingActions => (is => 'ro', isa => 'Int');
...
As an example, if Att1 is expected to be a Paws::Glue::WorkflowRunStatistics object:
  ...
  $service_obj->Method(Att1 => { ErroredActions => $value, ..., WaitingActions => $value  });
