...
package Paws::Glue::S3JsonSource;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::Glue::S3JsonSource object:

  $service_obj->Method(Att1 => { AdditionalOptions => $value, ..., Recurse => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Glue::S3JsonSource object:
