...
package Paws::Glue::DeleteResourcePolicy;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Glue::DeleteResourcePolicyResponse');
...
Paws::Glue::DeleteResourcePolicy - Arguments for method DeleteResourcePolicy on L<Paws::Glue>
...
This class forms part of L<Paws>, documenting arguments for method DeleteResourcePolicy in L<Paws::Glue>
