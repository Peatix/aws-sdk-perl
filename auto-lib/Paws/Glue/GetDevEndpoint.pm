...
Paws::Glue::GetDevEndpoint - Arguments for method GetDevEndpoint on L<Paws::Glue>
...
=head1 SYNOPSIS
    ...
    my $GetDevEndpointResponse = $glue->GetDevEndpoint(
      EndpointName => 'MyGenericString',

    );

    # Results:
    my $DevEndpoint = $GetDevEndpointResponse->DevEndpoint;

    # Returns a L<Paws::Glue::GetDevEndpointResponse> object.
