...
package Paws::PcaConnectorScep::ListConnectorsResponse;
  use Moose;
  has Connectors => (is => 'ro', isa => 'ArrayRef[Paws::PcaConnectorScep::ConnectorSummary]');
...
Paws::PcaConnectorScep::ListConnectorsResponse

=head1 ATTRIBUTES


=head2 Connectors => ArrayRef[L<Paws::PcaConnectorScep::ConnectorSummary>]
