...
package Paws::GroundStation::SatelliteListItem;
  use Moose;
  has CurrentEphemeris => (is => 'ro', isa => 'Paws::GroundStation::EphemerisMetaData', request_name => 'currentEphemeris', traits => ['NameInRequest']);
...
As an example, if Att1 is expected to be a Paws::GroundStation::SatelliteListItem object:
  ...
  $service_obj->Method(Att1 => { CurrentEphemeris => $value, ..., SatelliteId => $value  });
