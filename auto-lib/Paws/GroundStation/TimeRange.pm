...
package Paws::GroundStation::TimeRange;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::GroundStation::TimeRange object:

  $service_obj->Method(Att1 => { EndTime => $value, ..., StartTime => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::GroundStation::TimeRange object:
