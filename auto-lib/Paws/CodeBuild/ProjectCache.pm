...
package Paws::CodeBuild::ProjectCache;
  use Moose;
  has CacheNamespace => (is => 'ro', isa => 'Str', request_name => 'cacheNamespace', traits => ['NameInRequest']);
...
As an example, if Att1 is expected to be a Paws::CodeBuild::ProjectCache object:
  ...
  $service_obj->Method(Att1 => { CacheNamespace => $value, ..., Type => $value  });
...
Defines the scope of the cache. You can use this namespace to share a
cache across multiple projects. For more information, see Cache sharing
between projects
