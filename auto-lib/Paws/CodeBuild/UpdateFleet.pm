...
package Paws::CodeBuild::UpdateFleet;
  use Moose;
  ...
  has ComputeType => (is => 'ro', isa => 'Str', traits => ['NameInRequest'], request_name => 'computeType' );
  has EnvironmentType => (is => 'ro', isa => 'Str', traits => ['NameInRequest'], request_name => 'environmentType' );
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::CodeBuild::UpdateFleetOutput');
...
Paws::CodeBuild::UpdateFleet - Arguments for method UpdateFleet on L<Paws::CodeBuild>
...
=head1 SYNOPSIS
    ...
    my $UpdateFleetOutput = $codebuild->UpdateFleet(
      ...
      ComputeType        => 'BUILD_GENERAL1_SMALL',    # OPTIONAL
      EnvironmentType    => 'WINDOWS_CONTAINER',       # OPTIONAL
    ...
    # Results:
    my $Fleet = $UpdateFleetOutput->Fleet;

    # Returns a L<Paws::CodeBuild::UpdateFleetOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/codebuild/UpdateFleet>
...
This class forms part of L<Paws>, documenting arguments for method UpdateFleet in L<Paws::CodeBuild>
