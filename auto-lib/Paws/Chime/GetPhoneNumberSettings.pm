...
package Paws::Chime::GetPhoneNumberSettings;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Chime::GetPhoneNumberSettingsResponse');
1;
...
Paws::Chime::GetPhoneNumberSettings - Arguments for method GetPhoneNumberSettings on L<Paws::Chime>
...
=head1 SYNOPSIS
    ...
    my $GetPhoneNumberSettingsResponse = $chime->GetPhoneNumberSettings();
    ...
    # Returns a L<Paws::Chime::GetPhoneNumberSettingsResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method GetPhoneNumberSettings in L<Paws::Chime>
