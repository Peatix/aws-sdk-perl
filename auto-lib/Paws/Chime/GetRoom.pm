...
Paws::Chime::GetRoom - Arguments for method GetRoom on L<Paws::Chime>
...
=head1 SYNOPSIS
    ...
    my $GetRoomResponse = $chime->GetRoom(
    ...
    # Returns a L<Paws::Chime::GetRoomResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method GetRoom in L<Paws::Chime>
