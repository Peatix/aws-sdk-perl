...
package Paws::GameLiftStreams::DisassociateApplications;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/streamgroups/{Identifier}/disassociations');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::GameLiftStreams::DisassociateApplicationsOutput');
1;
...
Paws::GameLiftStreams::DisassociateApplications - Arguments for method DisassociateApplications on L<Paws::GameLiftStreams>
...
=head1 SYNOPSIS
    ...
    my $DisassociateApplicationsOutput =
    ...
    # Results:
    my $ApplicationArns = $DisassociateApplicationsOutput->ApplicationArns;
    my $Arn             = $DisassociateApplicationsOutput->Arn;

    # Returns a L<Paws::GameLiftStreams::DisassociateApplicationsOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/gameliftstreams/DisassociateApplications>
...
This class forms part of L<Paws>, documenting arguments for method DisassociateApplications in L<Paws::GameLiftStreams>
