...
package Paws::GameLiftStreams::ListApplications;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::GameLiftStreams::ListApplicationsOutput');
1;
...
Paws::GameLiftStreams::ListApplications - Arguments for method ListApplications on L<Paws::GameLiftStreams>
...
=head1 SYNOPSIS
    ...
    my $ListApplicationsOutput = $gameliftstreams->ListApplications(
      MaxResults => 1,                # OPTIONAL
      NextToken  => 'MyNextToken',    # OPTIONAL
    );

    # Results:
    my $Items     = $ListApplicationsOutput->Items;
    my $NextToken = $ListApplicationsOutput->NextToken;

    # Returns a L<Paws::GameLiftStreams::ListApplicationsOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/gameliftstreams/ListApplications>
...
This class forms part of L<Paws>, documenting arguments for method ListApplications in L<Paws::GameLiftStreams>
