...
package Paws::MediaPackageV2::DeleteOriginEndpoint;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::MediaPackageV2::DeleteOriginEndpointResponse');
1;
...
Paws::MediaPackageV2::DeleteOriginEndpoint - Arguments for method DeleteOriginEndpoint on L<Paws::MediaPackageV2>
...
=head1 SYNOPSIS
    ...
    my $DeleteOriginEndpointResponse = $mediapackagev2->DeleteOriginEndpoint(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/mediapackagev2/DeleteOriginEndpoint>
...
This class forms part of L<Paws>, documenting arguments for method DeleteOriginEndpoint in L<Paws::MediaPackageV2>
