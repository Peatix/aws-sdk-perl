...
package Paws::MediaPackageV2::ListChannels;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::MediaPackageV2::ListChannelsResponse');
1;
...
Paws::MediaPackageV2::ListChannels - Arguments for method ListChannels on L<Paws::MediaPackageV2>
...
=head1 SYNOPSIS
    ...
    my $ListChannelsResponse = $mediapackagev2->ListChannels(
    ...
    # Returns a L<Paws::MediaPackageV2::ListChannelsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/mediapackagev2/ListChannels>
...
This class forms part of L<Paws>, documenting arguments for method ListChannels in L<Paws::MediaPackageV2>
