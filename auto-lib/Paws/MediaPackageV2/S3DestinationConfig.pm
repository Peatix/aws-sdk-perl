...
package Paws::MediaPackageV2::S3DestinationConfig;
  use Moose;
  has BucketName => (is => 'ro', isa => 'Str', required => 1);
  has DestinationPath => (is => 'ro', isa => 'Str', required => 1);
...
Paws::MediaPackageV2::S3DestinationConfig
...
As an example, if Att1 is expected to be a Paws::MediaPackageV2::S3DestinationConfig object:

  $service_obj->Method(Att1 => { BucketName => $value, ..., DestinationPath => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MediaPackageV2::S3DestinationConfig object:
