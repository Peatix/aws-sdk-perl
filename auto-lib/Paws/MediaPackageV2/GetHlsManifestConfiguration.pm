...
package Paws::MediaPackageV2::GetHlsManifestConfiguration;
  use Moose;
...
Paws::MediaPackageV2::GetHlsManifestConfiguration
...
As an example, if Att1 is expected to be a Paws::MediaPackageV2::GetHlsManifestConfiguration object:

  $service_obj->Method(Att1 => { ChildManifestName => $value, ..., UrlEncodeChildManifest => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MediaPackageV2::GetHlsManifestConfiguration object:
