...
package Paws::MediaPackageV2::PutOriginEndpointPolicy;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'PutOriginEndpointPolicy');
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::MediaPackageV2::PutOriginEndpointPolicyResponse');
1;
...
Paws::MediaPackageV2::PutOriginEndpointPolicy - Arguments for method PutOriginEndpointPolicy on L<Paws::MediaPackageV2>

=head1 DESCRIPTION

This class represents the parameters used for calling the method PutOriginEndpointPolicy on the
L<AWS Elemental MediaPackage v2|Paws::MediaPackageV2> service. Use the attributes of this class
as arguments to method PutOriginEndpointPolicy.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to PutOriginEndpointPolicy.

=head1 SYNOPSIS

    my $mediapackagev2 = Paws->service('MediaPackageV2');
    my $PutOriginEndpointPolicyResponse =
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/mediapackagev2/PutOriginEndpointPolicy>
...
This class forms part of L<Paws>, documenting arguments for method PutOriginEndpointPolicy in L<Paws::MediaPackageV2>
