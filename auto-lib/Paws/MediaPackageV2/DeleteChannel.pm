...
package Paws::MediaPackageV2::DeleteChannel;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::MediaPackageV2::DeleteChannelResponse');
1;
...
Paws::MediaPackageV2::DeleteChannel - Arguments for method DeleteChannel on L<Paws::MediaPackageV2>
...
=head1 SYNOPSIS
    ...
    my $DeleteChannelResponse = $mediapackagev2->DeleteChannel(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/mediapackagev2/DeleteChannel>
...
This class forms part of L<Paws>, documenting arguments for method DeleteChannel in L<Paws::MediaPackageV2>
