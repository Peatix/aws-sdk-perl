...
package Paws::MediaPackageV2::GetChannelPolicy;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::MediaPackageV2::GetChannelPolicyResponse');
1;
...
Paws::MediaPackageV2::GetChannelPolicy - Arguments for method GetChannelPolicy on L<Paws::MediaPackageV2>
...
=head1 SYNOPSIS
    ...
    my $GetChannelPolicyResponse = $mediapackagev2->GetChannelPolicy(
    ...
    # Results:
    my $ChannelGroupName = $GetChannelPolicyResponse->ChannelGroupName;
    my $ChannelName      = $GetChannelPolicyResponse->ChannelName;
    my $Policy           = $GetChannelPolicyResponse->Policy;

    # Returns a L<Paws::MediaPackageV2::GetChannelPolicyResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/mediapackagev2/GetChannelPolicy>
...
This class forms part of L<Paws>, documenting arguments for method GetChannelPolicy in L<Paws::MediaPackageV2>
