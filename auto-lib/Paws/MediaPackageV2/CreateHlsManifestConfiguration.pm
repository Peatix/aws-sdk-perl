...
package Paws::MediaPackageV2::CreateHlsManifestConfiguration;
  use Moose;
...
Paws::MediaPackageV2::CreateHlsManifestConfiguration
...
As an example, if Att1 is expected to be a Paws::MediaPackageV2::CreateHlsManifestConfiguration object:

  $service_obj->Method(Att1 => { ChildManifestName => $value, ..., UrlEncodeChildManifest => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MediaPackageV2::CreateHlsManifestConfiguration object:
