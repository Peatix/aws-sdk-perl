...
package Paws::MediaPackageV2::ListLowLatencyHlsManifestConfiguration;
  use Moose;
...
Paws::MediaPackageV2::ListLowLatencyHlsManifestConfiguration
...
As an example, if Att1 is expected to be a Paws::MediaPackageV2::ListLowLatencyHlsManifestConfiguration object:

  $service_obj->Method(Att1 => { ChildManifestName => $value, ..., Url => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MediaPackageV2::ListLowLatencyHlsManifestConfiguration object:
