...
package Paws::DMS::DocDbDataProviderSettings;
  use Moose;
...
Paws::DMS::DocDbDataProviderSettings
...
As an example, if Att1 is expected to be a Paws::DMS::DocDbDataProviderSettings object:

  $service_obj->Method(Att1 => { CertificateArn => $value, ..., SslMode => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::DMS::DocDbDataProviderSettings object:
