...
package Paws::DMS::DescribePendingMaintenanceActions;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::DMS::DescribePendingMaintenanceActionsResponse');
...
Paws::DMS::DescribePendingMaintenanceActions - Arguments for method DescribePendingMaintenanceActions on L<Paws::DMS>
...
=head1 SYNOPSIS
    ...
    my $DescribePendingMaintenanceActionsResponse =
    ...
    # Results:
    my $Marker = $DescribePendingMaintenanceActionsResponse->Marker;
    my $PendingMaintenanceActions =
      $DescribePendingMaintenanceActionsResponse->PendingMaintenanceActions;

    # Returns a L<Paws::DMS::DescribePendingMaintenanceActionsResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method DescribePendingMaintenanceActions in L<Paws::DMS>
