...
package Paws::DMS::DescribeEndpoints;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::DMS::DescribeEndpointsResponse');
...
Paws::DMS::DescribeEndpoints - Arguments for method DescribeEndpoints on L<Paws::DMS>
...
=head1 SYNOPSIS
    ...
    my $Marker    = $DescribeEndpointsResponse->Marker;

    # Returns a L<Paws::DMS::DescribeEndpointsResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method DescribeEndpoints in L<Paws::DMS>
