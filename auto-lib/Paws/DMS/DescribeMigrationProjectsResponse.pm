...
package Paws::DMS::DescribeMigrationProjectsResponse;
  use Moose;
  has Marker => (is => 'ro', isa => 'Str');
  has MigrationProjects => (is => 'ro', isa => 'ArrayRef[Paws::DMS::MigrationProject]');
...
Paws::DMS::DescribeMigrationProjectsResponse
...
=head2 MigrationProjects => ArrayRef[L<Paws::DMS::MigrationProject>]
