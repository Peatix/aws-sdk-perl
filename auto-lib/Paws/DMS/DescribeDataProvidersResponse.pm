...
package Paws::DMS::DescribeDataProvidersResponse;
  use Moose;
  has DataProviders => (is => 'ro', isa => 'ArrayRef[Paws::DMS::DataProvider]');
...
Paws::DMS::DescribeDataProvidersResponse

=head1 ATTRIBUTES


=head2 DataProviders => ArrayRef[L<Paws::DMS::DataProvider>]
