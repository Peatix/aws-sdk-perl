...
to. For more information, see Working with Events and Notifications
...
set this parameter to C<replication-instance>. If this value isn't
specified, all events are returned.

Valid values: C<replication-instance> | C<replication-task>
