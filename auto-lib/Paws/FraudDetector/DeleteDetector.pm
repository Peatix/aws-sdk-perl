...
package Paws::FraudDetector::DeleteDetector;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::FraudDetector::DeleteDetectorResult');
...
Paws::FraudDetector::DeleteDetector - Arguments for method DeleteDetector on L<Paws::FraudDetector>
...
=head1 SYNOPSIS
    ...
    my $DeleteDetectorResult = $frauddetector->DeleteDetector(
...
This class forms part of L<Paws>, documenting arguments for method DeleteDetector in L<Paws::FraudDetector>
