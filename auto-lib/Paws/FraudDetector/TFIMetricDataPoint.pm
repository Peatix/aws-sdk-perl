...
package Paws::FraudDetector::TFIMetricDataPoint;
  use Moose;
...
Paws::FraudDetector::TFIMetricDataPoint
...
As an example, if Att1 is expected to be a Paws::FraudDetector::TFIMetricDataPoint object:

  $service_obj->Method(Att1 => { Fpr => $value, ..., Tpr => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::FraudDetector::TFIMetricDataPoint object:
