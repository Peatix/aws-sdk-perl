...
package Paws::FraudDetector::PredictionTimeRange;
  use Moose;
...
Paws::FraudDetector::PredictionTimeRange
...
As an example, if Att1 is expected to be a Paws::FraudDetector::PredictionTimeRange object:

  $service_obj->Method(Att1 => { EndTime => $value, ..., StartTime => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::FraudDetector::PredictionTimeRange object:
