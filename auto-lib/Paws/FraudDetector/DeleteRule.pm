...
package Paws::FraudDetector::DeleteRule;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::FraudDetector::DeleteRuleResult');
...
Paws::FraudDetector::DeleteRule - Arguments for method DeleteRule on L<Paws::FraudDetector>
...
=head1 SYNOPSIS
    ...
    my $DeleteRuleResult = $frauddetector->DeleteRule(
      Rule => {
...
This class forms part of L<Paws>, documenting arguments for method DeleteRule in L<Paws::FraudDetector>
