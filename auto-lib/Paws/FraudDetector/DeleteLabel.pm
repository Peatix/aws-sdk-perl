...
package Paws::FraudDetector::DeleteLabel;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::FraudDetector::DeleteLabelResult');
...
Paws::FraudDetector::DeleteLabel - Arguments for method DeleteLabel on L<Paws::FraudDetector>
...
=head1 SYNOPSIS
    ...
    my $DeleteLabelResult = $frauddetector->DeleteLabel(
      Name => 'Myidentifier',
...
This class forms part of L<Paws>, documenting arguments for method DeleteLabel in L<Paws::FraudDetector>
