...
package Paws::FraudDetector::DeleteModel;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::FraudDetector::DeleteModelResult');
...
Paws::FraudDetector::DeleteModel - Arguments for method DeleteModel on L<Paws::FraudDetector>
...
=head1 SYNOPSIS
    ...
    my $DeleteModelResult = $frauddetector->DeleteModel(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/frauddetector/DeleteModel>
...
This class forms part of L<Paws>, documenting arguments for method DeleteModel in L<Paws::FraudDetector>
