...
package Paws::Lambda::FilterCriteriaError;
  use Moose;
...
Paws::Lambda::FilterCriteriaError
...
As an example, if Att1 is expected to be a Paws::Lambda::FilterCriteriaError object:

  $service_obj->Method(Att1 => { ErrorCode => $value, ..., Message => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Lambda::FilterCriteriaError object:
