...
package Paws::Lambda::CreateFunctionUrlConfig;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'CreateFunctionUrlConfig');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/2021-10-31/functions/{FunctionName}/url');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Lambda::CreateFunctionUrlConfigResponse');
1;
...
Paws::Lambda::CreateFunctionUrlConfig - Arguments for method CreateFunctionUrlConfig on L<Paws::Lambda>

=head1 DESCRIPTION

This class represents the parameters used for calling the method CreateFunctionUrlConfig on the
L<AWS Lambda|Paws::Lambda> service. Use the attributes of this class
as arguments to method CreateFunctionUrlConfig.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to CreateFunctionUrlConfig.

=head1 SYNOPSIS

    my $lambda = Paws->service('Lambda');
    my $CreateFunctionUrlConfigResponse = $lambda->CreateFunctionUrlConfig(
      AuthType     => 'NONE',
    ...
    # Results:
    my $AuthType     = $CreateFunctionUrlConfigResponse->AuthType;
    my $Cors         = $CreateFunctionUrlConfigResponse->Cors;
    my $CreationTime = $CreateFunctionUrlConfigResponse->CreationTime;
    my $FunctionArn  = $CreateFunctionUrlConfigResponse->FunctionArn;
    my $FunctionUrl  = $CreateFunctionUrlConfigResponse->FunctionUrl;
    my $InvokeMode   = $CreateFunctionUrlConfigResponse->InvokeMode;

    # Returns a L<Paws::Lambda::CreateFunctionUrlConfigResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/lambda/CreateFunctionUrlConfig>
...
This class forms part of L<Paws>, documenting arguments for method CreateFunctionUrlConfig in L<Paws::Lambda>
