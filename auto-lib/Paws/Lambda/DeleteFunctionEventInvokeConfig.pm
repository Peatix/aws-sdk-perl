...
package Paws::Lambda::DeleteFunctionEventInvokeConfig;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'DeleteFunctionEventInvokeConfig');
...
Paws::Lambda::DeleteFunctionEventInvokeConfig - Arguments for method DeleteFunctionEventInvokeConfig on L<Paws::Lambda>

=head1 DESCRIPTION

This class represents the parameters used for calling the method DeleteFunctionEventInvokeConfig on the
L<AWS Lambda|Paws::Lambda> service. Use the attributes of this class
as arguments to method DeleteFunctionEventInvokeConfig.
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/lambda/DeleteFunctionEventInvokeConfig>
...
This class forms part of L<Paws>, documenting arguments for method DeleteFunctionEventInvokeConfig in L<Paws::Lambda>
