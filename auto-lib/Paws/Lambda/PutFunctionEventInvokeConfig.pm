...
package Paws::Lambda::PutFunctionEventInvokeConfig;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'PutFunctionEventInvokeConfig');
...
Paws::Lambda::PutFunctionEventInvokeConfig - Arguments for method PutFunctionEventInvokeConfig on L<Paws::Lambda>

=head1 DESCRIPTION

This class represents the parameters used for calling the method PutFunctionEventInvokeConfig on the
L<AWS Lambda|Paws::Lambda> service. Use the attributes of this class
as arguments to method PutFunctionEventInvokeConfig.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to PutFunctionEventInvokeConfig.
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/lambda/PutFunctionEventInvokeConfig>
...
This class forms part of L<Paws>, documenting arguments for method PutFunctionEventInvokeConfig in L<Paws::Lambda>
