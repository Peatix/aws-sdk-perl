...
Paws::Lambda::ListAliases - Arguments for method ListAliases on L<Paws::Lambda>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/lambda/ListAliases>
