...
package Paws::Keyspaces::DeleteType;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Keyspaces::DeleteTypeResponse');
...
Paws::Keyspaces::DeleteType - Arguments for method DeleteType on L<Paws::Keyspaces>
...
=head1 SYNOPSIS
    ...
    my $DeleteTypeResponse = $cassandra->DeleteType(
    ...
    # Results:
    my $KeyspaceArn = $DeleteTypeResponse->KeyspaceArn;
    my $TypeName    = $DeleteTypeResponse->TypeName;

    # Returns a L<Paws::Keyspaces::DeleteTypeResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/cassandra/DeleteType>
...
This class forms part of L<Paws>, documenting arguments for method DeleteType in L<Paws::Keyspaces>
