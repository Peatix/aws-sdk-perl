...
package Paws::GlobalAccelerator::CidrAuthorizationContext;
  use Moose;
...
Paws::GlobalAccelerator::CidrAuthorizationContext
...
As an example, if Att1 is expected to be a Paws::GlobalAccelerator::CidrAuthorizationContext object:

  $service_obj->Method(Att1 => { Message => $value, ..., Signature => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::GlobalAccelerator::CidrAuthorizationContext object:
