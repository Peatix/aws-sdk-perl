...
=head1 SYNOPSIS
    ...
    my $GetHealthCheckCountResponse = $route53->GetHealthCheckCount();

    # Results:
    my $HealthCheckCount = $GetHealthCheckCountResponse->HealthCheckCount;

    # Returns a L<Paws::Route53::GetHealthCheckCountResponse> object.
