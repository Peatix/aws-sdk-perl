...
package Paws::Route53::CidrCollection;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::Route53::CidrCollection object:

  $service_obj->Method(Att1 => { Arn => $value, ..., Version => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Route53::CidrCollection object:
