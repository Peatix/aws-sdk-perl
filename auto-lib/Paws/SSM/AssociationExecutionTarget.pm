...
Paws::SSM::AssociationExecutionTarget
...
As an example, if Att1 is expected to be a Paws::SSM::AssociationExecutionTarget object:

  $service_obj->Method(Att1 => { AssociationId => $value, ..., Status => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::SSM::AssociationExecutionTarget object:
