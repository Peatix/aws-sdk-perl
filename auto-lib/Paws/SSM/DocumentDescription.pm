...
package Paws::SSM::DocumentDescription;
  ...
  has PendingReviewVersion => (is => 'ro', isa => 'Str');
  has PlatformTypes => (is => 'ro', isa => 'ArrayRef[Str|Undef]');
  has Requires => (is => 'ro', isa => 'ArrayRef[Paws::SSM::DocumentRequires]');
  has ReviewInformation => (is => 'ro', isa => 'ArrayRef[Paws::SSM::ReviewInformation]');
...
=head2 PendingReviewVersion => Str
...
=head2 ReviewInformation => ArrayRef[L<Paws::SSM::ReviewInformation>]
