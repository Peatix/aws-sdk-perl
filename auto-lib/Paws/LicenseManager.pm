package Paws::LicenseManager;
  ...
  sub CreateLicenseConversionTaskForResource {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::LicenseManager::CreateLicenseConversionTaskForResource', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub GetLicenseConversionTask {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::LicenseManager::GetLicenseConversionTask', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ListLicenseConversionTasks {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::LicenseManager::ListLicenseConversionTasks', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ListReceivedGrantsForOrganization {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::LicenseManager::ListReceivedGrantsForOrganization', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ListReceivedLicensesForOrganization {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::LicenseManager::ListReceivedLicensesForOrganization', @_);
    return $self->caller->do_call($self, $call_object);
  }
...
=item [Options => L<Paws::LicenseManager::Options>]
...
=head2 CreateLicenseConversionTaskForResource

=over

=item DestinationLicenseContext => L<Paws::LicenseManager::LicenseConversionContext>

=item ResourceArn => Str

=item SourceLicenseContext => L<Paws::LicenseManager::LicenseConversionContext>


=back

Each argument is described in detail in: L<Paws::LicenseManager::CreateLicenseConversionTaskForResource>

Returns: a L<Paws::LicenseManager::CreateLicenseConversionTaskForResourceResponse> instance
...
=head2 GetLicenseConversionTask

=over

=item LicenseConversionTaskId => Str


=back

Each argument is described in detail in: L<Paws::LicenseManager::GetLicenseConversionTask>

Returns: a L<Paws::LicenseManager::GetLicenseConversionTaskResponse> instance
...
=head2 ListLicenseConversionTasks
...
Each argument is described in detail in: L<Paws::LicenseManager::ListLicenseConversionTasks>

Returns: a L<Paws::LicenseManager::ListLicenseConversionTasksResponse> instance
...
=head2 ListReceivedGrantsForOrganization
...
Each argument is described in detail in: L<Paws::LicenseManager::ListReceivedGrantsForOrganization>

Returns: a L<Paws::LicenseManager::ListReceivedGrantsForOrganizationResponse> instance
...
=head2 ListReceivedLicensesForOrganization
...
Each argument is described in detail in: L<Paws::LicenseManager::ListReceivedLicensesForOrganization>

Returns: a L<Paws::LicenseManager::ListReceivedLicensesForOrganizationResponse> instance
