...
package Paws::CleanRoomsML::CollaborationTrainedModelExportJobSummary;
  use Moose;
  ...
  has OutputConfiguration => (is => 'ro', isa => 'Paws::CleanRoomsML::TrainedModelExportOutputConfiguration', request_name => 'outputConfiguration', traits => ['NameInRequest'], required => 1);
...
Paws::CleanRoomsML::CollaborationTrainedModelExportJobSummary
...
As an example, if Att1 is expected to be a Paws::CleanRoomsML::CollaborationTrainedModelExportJobSummary object:

  $service_obj->Method(Att1 => { CollaborationIdentifier => $value, ..., UpdateTime => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CleanRoomsML::CollaborationTrainedModelExportJobSummary object:
...
The membership ID of the member that created the trained model export
job.
