...
package Paws::CleanRoomsML::CollaborationMLInputChannelSummary;
  use Moose;
...
Paws::CleanRoomsML::CollaborationMLInputChannelSummary
...
As an example, if Att1 is expected to be a Paws::CleanRoomsML::CollaborationMLInputChannelSummary object:

  $service_obj->Method(Att1 => { CollaborationIdentifier => $value, ..., UpdateTime => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CleanRoomsML::CollaborationMLInputChannelSummary object:
