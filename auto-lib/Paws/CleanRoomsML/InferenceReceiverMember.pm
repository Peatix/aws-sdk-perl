...
package Paws::CleanRoomsML::InferenceReceiverMember;
  use Moose;
...
Paws::CleanRoomsML::InferenceReceiverMember
...
As an example, if Att1 is expected to be a Paws::CleanRoomsML::InferenceReceiverMember object:

  $service_obj->Method(Att1 => { AccountId => $value, ..., AccountId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CleanRoomsML::InferenceReceiverMember object:
