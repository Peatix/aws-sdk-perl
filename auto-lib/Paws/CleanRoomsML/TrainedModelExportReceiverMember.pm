...
package Paws::CleanRoomsML::TrainedModelExportReceiverMember;
  use Moose;
...
Paws::CleanRoomsML::TrainedModelExportReceiverMember
...
As an example, if Att1 is expected to be a Paws::CleanRoomsML::TrainedModelExportReceiverMember object:

  $service_obj->Method(Att1 => { AccountId => $value, ..., AccountId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CleanRoomsML::TrainedModelExportReceiverMember object:
