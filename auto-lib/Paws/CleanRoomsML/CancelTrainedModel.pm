...
package Paws::CleanRoomsML::CancelTrainedModel;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'CancelTrainedModel');
...
Paws::CleanRoomsML::CancelTrainedModel - Arguments for method CancelTrainedModel on L<Paws::CleanRoomsML>

=head1 DESCRIPTION

This class represents the parameters used for calling the method CancelTrainedModel on the
L<AWS Clean Rooms ML|Paws::CleanRoomsML> service. Use the attributes of this class
as arguments to method CancelTrainedModel.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to CancelTrainedModel.
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/cleanrooms-ml/CancelTrainedModel>
...
This class forms part of L<Paws>, documenting arguments for method CancelTrainedModel in L<Paws::CleanRoomsML>
