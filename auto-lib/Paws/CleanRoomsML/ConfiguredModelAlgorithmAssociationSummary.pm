...
package Paws::CleanRoomsML::ConfiguredModelAlgorithmAssociationSummary;
  use Moose;
...
Paws::CleanRoomsML::ConfiguredModelAlgorithmAssociationSummary
...
As an example, if Att1 is expected to be a Paws::CleanRoomsML::ConfiguredModelAlgorithmAssociationSummary object:

  $service_obj->Method(Att1 => { CollaborationIdentifier => $value, ..., UpdateTime => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CleanRoomsML::ConfiguredModelAlgorithmAssociationSummary object:
