...
package Paws::CleanRoomsML::TrainedModelExportsMaxSize;
  use Moose;
...
Paws::CleanRoomsML::TrainedModelExportsMaxSize
...
As an example, if Att1 is expected to be a Paws::CleanRoomsML::TrainedModelExportsMaxSize object:

  $service_obj->Method(Att1 => { Unit => $value, ..., Value => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CleanRoomsML::TrainedModelExportsMaxSize object:
