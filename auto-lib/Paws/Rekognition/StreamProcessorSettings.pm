...
package Paws::Rekognition::StreamProcessorSettings;
  use Moose;
  has ConnectedHome => (is => 'ro', isa => 'Paws::Rekognition::ConnectedHomeSettings');
...
As an example, if Att1 is expected to be a Paws::Rekognition::StreamProcessorSettings object:
  ...
  $service_obj->Method(Att1 => { ConnectedHome => $value, ..., FaceSearch => $value  });
...
Use accessors for each attribute. If Att1 is expected to be an Paws::Rekognition::StreamProcessorSettings object:
  ...
  $result->Att1->ConnectedHome

=head1 DESCRIPTION

Input parameters used in a streaming video analyzed by a Amazon
Rekognition stream processor. You can use C<FaceSearch> to recognize
faces in a streaming video, or you can use C<ConnectedHome> to detect
labels.

=head1 ATTRIBUTES


=head2 ConnectedHome => L<Paws::Rekognition::ConnectedHomeSettings>
