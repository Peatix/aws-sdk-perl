...
package Paws::Rekognition::UnsuccessfulFaceAssociation;
  use Moose;
...
Paws::Rekognition::UnsuccessfulFaceAssociation
...
As an example, if Att1 is expected to be a Paws::Rekognition::UnsuccessfulFaceAssociation object:

  $service_obj->Method(Att1 => { Confidence => $value, ..., UserId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Rekognition::UnsuccessfulFaceAssociation object:
