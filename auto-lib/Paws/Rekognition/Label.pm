...
package Paws::Rekognition::Label;
  use Moose;
  has Aliases => (is => 'ro', isa => 'ArrayRef[Paws::Rekognition::LabelAlias]');
  has Categories => (is => 'ro', isa => 'ArrayRef[Paws::Rekognition::LabelCategory]');
...
As an example, if Att1 is expected to be a Paws::Rekognition::Label object:
  ...
  $service_obj->Method(Att1 => { Aliases => $value, ..., Parents => $value  });
...
=head2 Aliases => ArrayRef[L<Paws::Rekognition::LabelAlias>]

A list of potential aliases for a given label.


=head2 Categories => ArrayRef[L<Paws::Rekognition::LabelCategory>]
