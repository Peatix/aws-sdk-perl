...
package Paws::SsmSap::ListDatabases;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/list-databases');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::SsmSap::ListDatabasesOutput');
1;
...
Paws::SsmSap::ListDatabases - Arguments for method ListDatabases on L<Paws::SsmSap>
...
=head1 SYNOPSIS
    ...
    my $ListDatabasesOutput = $ssm -sap->ListDatabases(
    ...
    # Results:
    my $Databases = $ListDatabasesOutput->Databases;
    my $NextToken = $ListDatabasesOutput->NextToken;

    # Returns a L<Paws::SsmSap::ListDatabasesOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/ssm-sap/ListDatabases>
...
This class forms part of L<Paws>, documenting arguments for method ListDatabases in L<Paws::SsmSap>
