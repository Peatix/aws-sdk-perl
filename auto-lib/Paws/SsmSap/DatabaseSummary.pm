...
package Paws::SsmSap::DatabaseSummary;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::SsmSap::DatabaseSummary object:

  $service_obj->Method(Att1 => { ApplicationId => $value, ..., Tags => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::SsmSap::DatabaseSummary object:
