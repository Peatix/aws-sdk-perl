...
package Paws::Omics::ImportReadSetJobItem;
  use Moose;
...
Paws::Omics::ImportReadSetJobItem
...
As an example, if Att1 is expected to be a Paws::Omics::ImportReadSetJobItem object:

  $service_obj->Method(Att1 => { CompletionTime => $value, ..., Status => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Omics::ImportReadSetJobItem object:
