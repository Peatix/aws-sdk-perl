...
package Paws::Omics::GetReadSetImportJobResponse;
  use Moose;
  ...
  has Sources => (is => 'ro', isa => 'ArrayRef[Paws::Omics::ImportReadSetSourceItem]', traits => ['NameInRequest'], request_name => 'sources', required => 1);
...
Paws::Omics::GetReadSetImportJobResponse
...
=head2 B<REQUIRED> Sources => ArrayRef[L<Paws::Omics::ImportReadSetSourceItem>]
