...
package Paws::Synthetics::DisassociateResource;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/group/{groupIdentifier}/disassociate');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'PATCH');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Synthetics::DisassociateResourceResponse');
1;
...
Paws::Synthetics::DisassociateResource - Arguments for method DisassociateResource on L<Paws::Synthetics>
...
=head1 SYNOPSIS
    ...
    my $DisassociateResourceResponse = $synthetics->DisassociateResource(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/synthetics/DisassociateResource>
...
This class forms part of L<Paws>, documenting arguments for method DisassociateResource in L<Paws::Synthetics>
