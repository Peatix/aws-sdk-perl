...
package Paws::Synthetics::GetGroup;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Synthetics::GetGroupResponse');
1;
...
Paws::Synthetics::GetGroup - Arguments for method GetGroup on L<Paws::Synthetics>
...
=head1 SYNOPSIS
    ...
    my $GetGroupResponse = $synthetics->GetGroup(
    ...
    # Returns a L<Paws::Synthetics::GetGroupResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/synthetics/GetGroup>
...
This class forms part of L<Paws>, documenting arguments for method GetGroup in L<Paws::Synthetics>
