package Paws::CodeBuild;
  ...
  sub BatchGetCommandExecutions {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeBuild::BatchGetCommandExecutions', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub BatchGetFleets {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeBuild::BatchGetFleets', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub BatchGetSandboxes {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeBuild::BatchGetSandboxes', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub CreateFleet {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeBuild::CreateFleet', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub CreateProject {
    my $self = shift;
  ...
  sub DeleteFleet {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeBuild::DeleteFleet', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DeleteProject {
    my $self = shift;
  ...
  sub ListCommandExecutionsForSandbox {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeBuild::ListCommandExecutionsForSandbox', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ListFleets {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeBuild::ListFleets', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ListProjects {
    my $self = shift;
  ...
  sub ListSandboxes {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeBuild::ListSandboxes', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ListSandboxesForProject {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeBuild::ListSandboxesForProject', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub StartCommandExecution {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeBuild::StartCommandExecution', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub StartSandbox {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeBuild::StartSandbox', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub StartSandboxConnection {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeBuild::StartSandboxConnection', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub StopBuild {
    my $self = shift;
  ...
  sub StopSandbox {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeBuild::StopSandbox', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub UpdateFleet {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeBuild::UpdateFleet', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub UpdateProject {
    my $self = shift;
  ...
  sub UpdateProjectVisibility {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeBuild::UpdateProjectVisibility', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ListAllCommandExecutionsForSandbox {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->ListCommandExecutionsForSandbox(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->nextToken) {
        $next_result = $self->ListCommandExecutionsForSandbox(@_, nextToken => $next_result->nextToken);
      ...
      while ($result->nextToken) {
        ...
        $result = $self->ListCommandExecutionsForSandbox(@_, nextToken => $result->nextToken);
      }
      $callback->($_ => 'commandExecutions') foreach (@{ $result->commandExecutions });
    }
  ...
  sub ListAllSandboxes {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->ListSandboxes(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->nextToken) {
        $next_result = $self->ListSandboxes(@_, nextToken => $next_result->nextToken);
        push @{ $result->ids }, @{ $next_result->ids };
      }
      return $result;
    } else {
      while ($result->nextToken) {
        $callback->($_ => 'ids') foreach (@{ $result->ids });
        $result = $self->ListSandboxes(@_, nextToken => $result->nextToken);
      }
      $callback->($_ => 'ids') foreach (@{ $result->ids });
    }
  ...
  sub ListAllSandboxesForProject {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->ListSandboxesForProject(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->nextToken) {
        $next_result = $self->ListSandboxesForProject(@_, nextToken => $next_result->nextToken);
        push @{ $result->ids }, @{ $next_result->ids };
      }
      return $result;
    } else {
      while ($result->nextToken) {
        $callback->($_ => 'ids') foreach (@{ $result->ids });
        $result = $self->ListSandboxesForProject(@_, nextToken => $result->nextToken);
      }
      $callback->($_ => 'ids') foreach (@{ $result->ids });
    }
...
=head2 BatchGetCommandExecutions

=over

=item CommandExecutionIds => ArrayRef[Str|Undef]
...
Each argument is described in detail in: L<Paws::CodeBuild::BatchGetCommandExecutions>

Returns: a L<Paws::CodeBuild::BatchGetCommandExecutionsOutput> instance

Gets information about the command executions.


=head2 BatchGetFleets
...
Each argument is described in detail in: L<Paws::CodeBuild::BatchGetFleets>

Returns: a L<Paws::CodeBuild::BatchGetFleetsOutput> instance
...
Each argument is described in detail in: L<Paws::CodeBuild::BatchGetSandboxes>

Returns: a L<Paws::CodeBuild::BatchGetSandboxesOutput> instance
...
=item EnvironmentType => Str

=item Name => Str

=item [ComputeConfiguration => L<Paws::CodeBuild::ComputeConfiguration>]

=item [FleetServiceRole => Str]

=item [ImageId => Str]

=item [OverflowBehavior => Str]

=item [ProxyConfiguration => L<Paws::CodeBuild::ProxyConfiguration>]

=item [ScalingConfiguration => L<Paws::CodeBuild::ScalingConfigurationInput>]
...
Each argument is described in detail in: L<Paws::CodeBuild::CreateFleet>

Returns: a L<Paws::CodeBuild::CreateFleetOutput> instance
...
=item [ManualCreation => Bool]

=item [ScopeConfiguration => L<Paws::CodeBuild::ScopeConfiguration>]
...
Each argument is described in detail in: L<Paws::CodeBuild::DeleteFleet>

Returns: a L<Paws::CodeBuild::DeleteFleetOutput> instance
...
=head2 ListCommandExecutionsForSandbox
...
Each argument is described in detail in: L<Paws::CodeBuild::ListCommandExecutionsForSandbox>

Returns: a L<Paws::CodeBuild::ListCommandExecutionsForSandboxOutput> instance
...
Each argument is described in detail in: L<Paws::CodeBuild::ListFleets>

Returns: a L<Paws::CodeBuild::ListFleetsOutput> instance
...
Each argument is described in detail in: L<Paws::CodeBuild::ListSandboxes>

Returns: a L<Paws::CodeBuild::ListSandboxesOutput> instance

Gets a list of sandboxes.


=head2 ListSandboxesForProject
...
Each argument is described in detail in: L<Paws::CodeBuild::ListSandboxesForProject>

Returns: a L<Paws::CodeBuild::ListSandboxesForProjectOutput> instance
...
=item [AutoRetryLimitOverride => Int]
...
=item [FleetOverride => L<Paws::CodeBuild::ProjectFleet>]
...
Each argument is described in detail in: L<Paws::CodeBuild::StartCommandExecution>

Returns: a L<Paws::CodeBuild::StartCommandExecutionOutput> instance
...
Each argument is described in detail in: L<Paws::CodeBuild::StartSandbox>

Returns: a L<Paws::CodeBuild::StartSandboxOutput> instance

Starts a sandbox.


=head2 StartSandboxConnection
...
Each argument is described in detail in: L<Paws::CodeBuild::StartSandboxConnection>

Returns: a L<Paws::CodeBuild::StartSandboxConnectionOutput> instance
...
Each argument is described in detail in: L<Paws::CodeBuild::StopSandbox>

Returns: a L<Paws::CodeBuild::StopSandboxOutput> instance
...
Each argument is described in detail in: L<Paws::CodeBuild::UpdateFleet>

Returns: a L<Paws::CodeBuild::UpdateFleetOutput> instance
...
=head2 UpdateProjectVisibility

=over

=item ProjectArn => Str

=item ProjectVisibility => Str

=item [ResourceAccessRole => Str]


=back

Each argument is described in detail in: L<Paws::CodeBuild::UpdateProjectVisibility>

Returns: a L<Paws::CodeBuild::UpdateProjectVisibilityOutput> instance
...
more information, see Public build projects
...
that were run when the project was private, are available to the
general public.
...
that you use an Amazon EC2 Systems Manager Parameter Store or Secrets
...
in the I<CodeBuild User Guide> to limit which entities can trigger a
...
=head2 ListAllCommandExecutionsForSandbox(sub { },SandboxId => Str, [MaxResults => Int, NextToken => Str, SortOrder => Str])

=head2 ListAllCommandExecutionsForSandbox(SandboxId => Str, [MaxResults => Int, NextToken => Str, SortOrder => Str])
...
If not, it will return a a L<Paws::CodeBuild::ListCommandExecutionsForSandboxOutput> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
...
=head2 ListAllSandboxes(sub { },[MaxResults => Int, NextToken => Str, SortOrder => Str])

=head2 ListAllSandboxes([MaxResults => Int, NextToken => Str, SortOrder => Str])
...
If not, it will return a a L<Paws::CodeBuild::ListSandboxesOutput> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.


=head2 ListAllSandboxesForProject(sub { },ProjectName => Str, [MaxResults => Int, NextToken => Str, SortOrder => Str])

=head2 ListAllSandboxesForProject(ProjectName => Str, [MaxResults => Int, NextToken => Str, SortOrder => Str])
...
If not, it will return a a L<Paws::CodeBuild::ListSandboxesForProjectOutput> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
