package Paws::ForecastQuery;
  ...
  sub QueryWhatIfForecast {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ForecastQuery::QueryWhatIfForecast', @_);
    return $self->caller->do_call($self, $call_object);
  }
  


  sub operations { qw/QueryForecast QueryWhatIfForecast / }
...
Each argument is described in detail in: L<Paws::ForecastQuery::QueryWhatIfForecast>

Returns: a L<Paws::ForecastQuery::QueryWhatIfForecastResponse> instance
