package Paws::CodeStarConnections;
  ...
  sub CreateRepositoryLink {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeStarConnections::CreateRepositoryLink', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub CreateSyncConfiguration {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeStarConnections::CreateSyncConfiguration', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DeleteRepositoryLink {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeStarConnections::DeleteRepositoryLink', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DeleteSyncConfiguration {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeStarConnections::DeleteSyncConfiguration', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetConnection {
    my $self = shift;
  ...
  sub GetRepositoryLink {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeStarConnections::GetRepositoryLink', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetRepositorySyncStatus {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeStarConnections::GetRepositorySyncStatus', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetResourceSyncStatus {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeStarConnections::GetResourceSyncStatus', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetSyncBlockerSummary {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeStarConnections::GetSyncBlockerSummary', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetSyncConfiguration {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeStarConnections::GetSyncConfiguration', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ListConnections {
    my $self = shift;
  ...
  sub ListRepositoryLinks {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeStarConnections::ListRepositoryLinks', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ListRepositorySyncDefinitions {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeStarConnections::ListRepositorySyncDefinitions', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ListSyncConfigurations {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeStarConnections::ListSyncConfigurations', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub UpdateRepositoryLink {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeStarConnections::UpdateRepositoryLink', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub UpdateSyncBlocker {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeStarConnections::UpdateSyncBlocker', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub UpdateSyncConfiguration {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeStarConnections::UpdateSyncConfiguration', @_);
    return $self->caller->do_call($self, $call_object);
  }
...
the Amazon Web Services CodeStar Connections API. You can use the
...
Each argument is described in detail in: L<Paws::CodeStarConnections::CreateRepositoryLink>

Returns: a L<Paws::CodeStarConnections::CreateRepositoryLinkOutput> instance
...
Each argument is described in detail in: L<Paws::CodeStarConnections::CreateSyncConfiguration>

Returns: a L<Paws::CodeStarConnections::CreateSyncConfigurationOutput> instance
...
Each argument is described in detail in: L<Paws::CodeStarConnections::DeleteRepositoryLink>

Returns: a L<Paws::CodeStarConnections::DeleteRepositoryLinkOutput> instance
...
Each argument is described in detail in: L<Paws::CodeStarConnections::DeleteSyncConfiguration>

Returns: a L<Paws::CodeStarConnections::DeleteSyncConfigurationOutput> instance
...
Each argument is described in detail in: L<Paws::CodeStarConnections::GetRepositoryLink>

Returns: a L<Paws::CodeStarConnections::GetRepositoryLinkOutput> instance
...
Each argument is described in detail in: L<Paws::CodeStarConnections::GetRepositorySyncStatus>

Returns: a L<Paws::CodeStarConnections::GetRepositorySyncStatusOutput> instance
...
Each argument is described in detail in: L<Paws::CodeStarConnections::GetResourceSyncStatus>

Returns: a L<Paws::CodeStarConnections::GetResourceSyncStatusOutput> instance
...
Each argument is described in detail in: L<Paws::CodeStarConnections::GetSyncBlockerSummary>

Returns: a L<Paws::CodeStarConnections::GetSyncBlockerSummaryOutput> instance
...
Each argument is described in detail in: L<Paws::CodeStarConnections::GetSyncConfiguration>

Returns: a L<Paws::CodeStarConnections::GetSyncConfigurationOutput> instance
...
Each argument is described in detail in: L<Paws::CodeStarConnections::ListRepositoryLinks>

Returns: a L<Paws::CodeStarConnections::ListRepositoryLinksOutput> instance
...
Each argument is described in detail in: L<Paws::CodeStarConnections::ListRepositorySyncDefinitions>

Returns: a L<Paws::CodeStarConnections::ListRepositorySyncDefinitionsOutput> instance
...
Each argument is described in detail in: L<Paws::CodeStarConnections::ListSyncConfigurations>

Returns: a L<Paws::CodeStarConnections::ListSyncConfigurationsOutput> instance
...
Each argument is described in detail in: L<Paws::CodeStarConnections::UpdateRepositoryLink>

Returns: a L<Paws::CodeStarConnections::UpdateRepositoryLinkOutput> instance
...
Each argument is described in detail in: L<Paws::CodeStarConnections::UpdateSyncBlocker>

Returns: a L<Paws::CodeStarConnections::UpdateSyncBlockerOutput> instance
...
Each argument is described in detail in: L<Paws::CodeStarConnections::UpdateSyncConfiguration>

Returns: a L<Paws::CodeStarConnections::UpdateSyncConfigurationOutput> instance
