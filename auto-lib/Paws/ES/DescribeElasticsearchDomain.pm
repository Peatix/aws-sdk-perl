...
Paws::ES::DescribeElasticsearchDomain - Arguments for method DescribeElasticsearchDomain on L<Paws::ES>
...
=head1 SYNOPSIS
    ...
    my $DescribeElasticsearchDomainResponse = $es->DescribeElasticsearchDomain(
      DomainName => 'MyDomainName',

    );

    # Results:
    my $DomainStatus = $DescribeElasticsearchDomainResponse->DomainStatus;

    # Returns a L<Paws::ES::DescribeElasticsearchDomainResponse> object.
