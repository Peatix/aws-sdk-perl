...
package Paws::ES::ListVpcEndpointsForDomain;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/2015-01-01/es/domain/{DomainName}/vpcEndpoints');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ES::ListVpcEndpointsForDomainResponse');
1;
...
Paws::ES::ListVpcEndpointsForDomain - Arguments for method ListVpcEndpointsForDomain on L<Paws::ES>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::ES::ListVpcEndpointsForDomainResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method ListVpcEndpointsForDomain in L<Paws::ES>
