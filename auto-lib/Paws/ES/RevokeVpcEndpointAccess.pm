...
package Paws::ES::RevokeVpcEndpointAccess;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/2015-01-01/es/domain/{DomainName}/revokeVpcEndpointAccess');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ES::RevokeVpcEndpointAccessResponse');
1;
...
Paws::ES::RevokeVpcEndpointAccess - Arguments for method RevokeVpcEndpointAccess on L<Paws::ES>
...
This class forms part of L<Paws>, documenting arguments for method RevokeVpcEndpointAccess in L<Paws::ES>
