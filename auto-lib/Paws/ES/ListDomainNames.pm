...
package Paws::ES::ListDomainNames;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/2015-01-01/domain');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ES::ListDomainNamesResponse');
1;
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::ES::ListDomainNamesResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method ListDomainNames in L<Paws::ES>
