...
Paws::ES::DescribeElasticsearchDomainConfig - Arguments for method DescribeElasticsearchDomainConfig on L<Paws::ES>
...
=head1 SYNOPSIS
    ...
    my $DescribeElasticsearchDomainConfigResponse =
    ...
    # Results:
    my $DomainConfig = $DescribeElasticsearchDomainConfigResponse->DomainConfig;

    # Returns a L<Paws::ES::DescribeElasticsearchDomainConfigResponse> object.
