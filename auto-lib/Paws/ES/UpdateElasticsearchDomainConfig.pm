...
=head1 SYNOPSIS
    ...
    my $DryRunResults = $UpdateElasticsearchDomainConfigResponse->DryRunResults;
...
C<UpdateElasticsearchDomain> request should return the results of
validation checks without actually applying the change. This flag, when
set to True, specifies the deployment mechanism through which the
