...
=item * B<Policy-Min-TLS-1-0-2019-07: > TLS security policy that
supports TLS version 1.0 to TLS version 1.2

=item * B<Policy-Min-TLS-1-2-2019-07: > TLS security policy that
supports only TLS version 1.2

=item * B<Policy-Min-TLS-1-2-PFS-2023-10: > TLS security policy that
