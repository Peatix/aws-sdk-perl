...
package Paws::Batch::TaskContainerDetails;
  use Moose;
...
Paws::Batch::TaskContainerDetails
...
As an example, if Att1 is expected to be a Paws::Batch::TaskContainerDetails object:

  $service_obj->Method(Att1 => { Command => $value, ..., User => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Batch::TaskContainerDetails object:
