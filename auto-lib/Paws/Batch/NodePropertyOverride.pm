...
package Paws::Batch::NodePropertyOverride;
  use Moose;
  has ConsumableResourcePropertiesOverride => (is => 'ro', isa => 'Paws::Batch::ConsumableResourceProperties', request_name => 'consumableResourcePropertiesOverride', traits => ['NameInRequest']);
  has ContainerOverrides => (is => 'ro', isa => 'Paws::Batch::ContainerOverrides', request_name => 'containerOverrides', traits => ['NameInRequest']);
  has EcsPropertiesOverride => (is => 'ro', isa => 'Paws::Batch::EcsPropertiesOverride', request_name => 'ecsPropertiesOverride', traits => ['NameInRequest']);
  has EksPropertiesOverride => (is => 'ro', isa => 'Paws::Batch::EksPropertiesOverride', request_name => 'eksPropertiesOverride', traits => ['NameInRequest']);
...
As an example, if Att1 is expected to be a Paws::Batch::NodePropertyOverride object:
  ...
  $service_obj->Method(Att1 => { ConsumableResourcePropertiesOverride => $value, ..., TargetNodes => $value  });
...
Use accessors for each attribute. If Att1 is expected to be an Paws::Batch::NodePropertyOverride object:
  ...
  $result->Att1->ConsumableResourcePropertiesOverride

=head1 DESCRIPTION

The object that represents any node overrides to a job definition
that's used in a SubmitJob
...
An object that contains the instance types that you want to replace for
the existing resources of a job.
