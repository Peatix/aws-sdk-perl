...
package Paws::Batch::FirelensConfiguration;
  use Moose;
  has Options => (is => 'ro', isa => 'Paws::Batch::FirelensConfigurationOptionsMap', request_name => 'options', traits => ['NameInRequest']);
...
Paws::Batch::FirelensConfiguration
...
As an example, if Att1 is expected to be a Paws::Batch::FirelensConfiguration object:

  $service_obj->Method(Att1 => { Options => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Batch::FirelensConfiguration object:
...
=head2 Options => L<Paws::Batch::FirelensConfigurationOptionsMap>
