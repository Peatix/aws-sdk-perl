...
package Paws::Batch::RepositoryCredentials;
  use Moose;
...
Paws::Batch::RepositoryCredentials
...
As an example, if Att1 is expected to be a Paws::Batch::RepositoryCredentials object:

  $service_obj->Method(Att1 => { CredentialsParameter => $value, ..., CredentialsParameter => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Batch::RepositoryCredentials object:
