...
=head1 SYNOPSIS
    ...
    my $GetEncryptionConfigResult = $xray->GetEncryptionConfig();

    # Results:
    my $EncryptionConfig = $GetEncryptionConfigResult->EncryptionConfig;

    # Returns a L<Paws::XRay::GetEncryptionConfigResult> object.
