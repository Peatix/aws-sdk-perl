...
package Paws::XRay::ErrorStatistics;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::XRay::ErrorStatistics object:

  $service_obj->Method(Att1 => { OtherCount => $value, ..., TotalCount => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::XRay::ErrorStatistics object:
