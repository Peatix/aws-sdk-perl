...
Paws::XRay::GetGroup - Arguments for method GetGroup on L<Paws::XRay>
...
=head1 SYNOPSIS
    ...
    my $GetGroupResult = $xray->GetGroup(
      GroupARN  => 'MyGroupARN',     # OPTIONAL
      GroupName => 'MyGroupName',    # OPTIONAL
    );

    # Results:
    my $Group = $GetGroupResult->Group;

    # Returns a L<Paws::XRay::GetGroupResult> object.
...
This class forms part of L<Paws>, documenting arguments for method GetGroup in L<Paws::XRay>
