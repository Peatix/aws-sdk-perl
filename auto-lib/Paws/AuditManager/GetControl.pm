...
package Paws::AuditManager::GetControl;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::AuditManager::GetControlResponse');
1;
...
Paws::AuditManager::GetControl - Arguments for method GetControl on L<Paws::AuditManager>
...
=head1 SYNOPSIS
    ...
    my $GetControlResponse = $auditmanager->GetControl(
      ControlId => 'MyUUID',

    );

    # Results:
    my $Control = $GetControlResponse->Control;

    # Returns a L<Paws::AuditManager::GetControlResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/auditmanager/GetControl>
...
This class forms part of L<Paws>, documenting arguments for method GetControl in L<Paws::AuditManager>
