...
package Paws::AuditManager::DefaultExportDestination;
  use Moose;
...
Paws::AuditManager::DefaultExportDestination
...
As an example, if Att1 is expected to be a Paws::AuditManager::DefaultExportDestination object:

  $service_obj->Method(Att1 => { Destination => $value, ..., DestinationType => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::AuditManager::DefaultExportDestination object:
