...
package Paws::AuditManager::ListControlDomainInsightsResponse;
  use Moose;
...
Paws::AuditManager::ListControlDomainInsightsResponse
...
The control domain analytics data that the C<ListControlDomainInsights>
API returned.
