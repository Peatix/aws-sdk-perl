...
package Paws::AuditManager::DeleteAssessment;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::AuditManager::DeleteAssessmentResponse');
1;
...
Paws::AuditManager::DeleteAssessment - Arguments for method DeleteAssessment on L<Paws::AuditManager>
...
=head1 SYNOPSIS
    ...
    my $DeleteAssessmentResponse = $auditmanager->DeleteAssessment(
      AssessmentId => 'MyUUID',

    );

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/auditmanager/DeleteAssessment>
...
This class forms part of L<Paws>, documenting arguments for method DeleteAssessment in L<Paws::AuditManager>
