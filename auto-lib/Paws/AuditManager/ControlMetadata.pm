...
package Paws::AuditManager::ControlMetadata;
  use Moose;
...
Paws::AuditManager::ControlMetadata
...
As an example, if Att1 is expected to be a Paws::AuditManager::ControlMetadata object:

  $service_obj->Method(Att1 => { Arn => $value, ..., Name => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::AuditManager::ControlMetadata object:
