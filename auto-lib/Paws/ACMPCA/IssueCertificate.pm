          ...
          CustomExtensions => [
            {
              ...
              Value            => 'MyBase64String1To4096',   # min: 1, max: 4096
              Critical         => 1,                         # OPTIONAL
            },
            ...
...
B<IssueCertificate> time out after five minutes. Therefore, if you call
B<IssueCertificate> multiple times with the same idempotency token
within five minutes, Amazon Web Services Private CA recognizes that you
are requesting only one certificate and will issue only one. If you
change the idempotency token for each call, Amazon Web Services Private
...
Valid values are: C<"SHA256WITHECDSA">, C<"SHA384WITHECDSA">, C<"SHA512WITHECDSA">, C<"SHA256WITHRSA">, C<"SHA384WITHRSA">, C<"SHA512WITHRSA">, C<"SM3WITHSM2">

=head2 TemplateArn => Str

Specifies a custom configuration template to use when issuing a
certificate. If this parameter is not provided, Amazon Web Services
Private CA defaults to the C<EndEntityCertificate/V1> template. For CA
certificates, you should choose the shortest path length that meets
your needs. The path length is indicated by the PathLenI<N> portion of
the ARN, where I<N> is the CA depth
...
For a list of C<TemplateArn> values supported by Amazon Web Services
...
(https://datatracker.ietf.org/doc/html/rfc5280#section-4.1.2.5) in RFC
5280.
