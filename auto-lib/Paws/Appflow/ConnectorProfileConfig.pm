...
package Paws::Appflow::ConnectorProfileConfig;
  use Moose;
  has ConnectorProfileCredentials => (is => 'ro', isa => 'Paws::Appflow::ConnectorProfileCredentials', request_name => 'connectorProfileCredentials', traits => ['NameInRequest']);
...
=head2 ConnectorProfileCredentials => L<Paws::Appflow::ConnectorProfileCredentials>
