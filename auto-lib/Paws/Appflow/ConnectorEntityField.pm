...
package Paws::Appflow::ConnectorEntityField;
  ...
  has IsDeprecated => (is => 'ro', isa => 'Bool', request_name => 'isDeprecated', traits => ['NameInRequest']);
  has IsPrimaryKey => (is => 'ro', isa => 'Bool', request_name => 'isPrimaryKey', traits => ['NameInRequest']);
...
As an example, if Att1 is expected to be a Paws::Appflow::ConnectorEntityField object:
  ...
  $service_obj->Method(Att1 => { CustomProperties => $value, ..., SupportedFieldTypeDetails => $value  });
