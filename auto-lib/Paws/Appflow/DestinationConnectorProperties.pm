...
package Paws::Appflow::DestinationConnectorProperties;
  use Moose;
  has CustomConnector => (is => 'ro', isa => 'Paws::Appflow::CustomConnectorDestinationProperties');
  ...
  has Marketo => (is => 'ro', isa => 'Paws::Appflow::MarketoDestinationProperties');
  ...
  has SAPOData => (is => 'ro', isa => 'Paws::Appflow::SAPODataDestinationProperties');
...
As an example, if Att1 is expected to be a Paws::Appflow::DestinationConnectorProperties object:
  ...
  $service_obj->Method(Att1 => { CustomConnector => $value, ..., Zendesk => $value  });
...
=head2 CustomConnector => L<Paws::Appflow::CustomConnectorDestinationProperties>
...
=head2 Marketo => L<Paws::Appflow::MarketoDestinationProperties>
...
=head2 SAPOData => L<Paws::Appflow::SAPODataDestinationProperties>
