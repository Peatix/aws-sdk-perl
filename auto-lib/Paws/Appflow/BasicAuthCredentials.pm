...
package Paws::Appflow::BasicAuthCredentials;
  use Moose;
...
Paws::Appflow::BasicAuthCredentials
...
As an example, if Att1 is expected to be a Paws::Appflow::BasicAuthCredentials object:

  $service_obj->Method(Att1 => { Password => $value, ..., Username => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Appflow::BasicAuthCredentials object:
