...
package Paws::Evidently::DeleteProject;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Evidently::DeleteProjectResponse');
1;
...
Paws::Evidently::DeleteProject - Arguments for method DeleteProject on L<Paws::Evidently>
...
=head1 SYNOPSIS
    ...
    my $DeleteProjectResponse = $evidently->DeleteProject(
      Project => 'MyProjectRef',

    );

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/evidently/DeleteProject>
...
This class forms part of L<Paws>, documenting arguments for method DeleteProject in L<Paws::Evidently>
