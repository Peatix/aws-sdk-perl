...
package Paws::Evidently::GetSegment;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Evidently::GetSegmentResponse');
1;
...
Paws::Evidently::GetSegment - Arguments for method GetSegment on L<Paws::Evidently>
...
=head1 SYNOPSIS
    ...
    my $GetSegmentResponse = $evidently->GetSegment(
      Segment => 'MySegmentRef',

    );

    # Results:
    my $Segment = $GetSegmentResponse->Segment;

    # Returns a L<Paws::Evidently::GetSegmentResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/evidently/GetSegment>
...
This class forms part of L<Paws>, documenting arguments for method GetSegment in L<Paws::Evidently>
