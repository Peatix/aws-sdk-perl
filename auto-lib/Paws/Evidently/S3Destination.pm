...
package Paws::Evidently::S3Destination;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::Evidently::S3Destination object:

  $service_obj->Method(Att1 => { Bucket => $value, ..., Prefix => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Evidently::S3Destination object:
