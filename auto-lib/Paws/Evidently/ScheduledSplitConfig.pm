...
package Paws::Evidently::ScheduledSplitConfig;
  use Moose;
  has GroupWeights => (is => 'ro', isa => 'Paws::Evidently::GroupToWeightMap', request_name => 'groupWeights', traits => ['NameInRequest'], required => 1);
...
Paws::Evidently::ScheduledSplitConfig
...
As an example, if Att1 is expected to be a Paws::Evidently::ScheduledSplitConfig object:

  $service_obj->Method(Att1 => { GroupWeights => $value, ..., StartTime => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Evidently::ScheduledSplitConfig object:
...
=head2 B<REQUIRED> GroupWeights => L<Paws::Evidently::GroupToWeightMap>
