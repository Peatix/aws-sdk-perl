...
package Paws::SES::DeleteConfigurationSetEventDestination;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::SES::DeleteConfigurationSetEventDestinationResponse');
  class_has _result_key => (isa => 'Str', is => 'ro', default => 'DeleteConfigurationSetEventDestinationResult');
1;
...
Paws::SES::DeleteConfigurationSetEventDestination - Arguments for method DeleteConfigurationSetEventDestination on L<Paws::SES>
...
This class forms part of L<Paws>, documenting arguments for method DeleteConfigurationSetEventDestination in L<Paws::SES>
