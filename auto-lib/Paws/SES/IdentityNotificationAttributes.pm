...
notifications as email. C<true> indicates that Amazon SES forwards
...
specifies that Amazon SES includes headers in bounce notifications, and
a value of C<false> specifies that Amazon SES does not include headers
...
specifies that Amazon SES includes headers in complaint notifications,
...
specifies that Amazon SES includes headers in delivery notifications,
and a value of C<false> specifies that Amazon SES does not include
