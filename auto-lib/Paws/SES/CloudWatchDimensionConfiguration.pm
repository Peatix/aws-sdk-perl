...
send an email. The default value must meet the following requirements:
...
C<X-SES-MESSAGE-TAGS> header or a parameter to the
C<SendEmail>/C<SendRawEmail> API, specify C<messageTag>. To use your
own email headers, specify C<emailHeader>. To put a custom tag on any
link included in your email, specify C<linkTag>.
