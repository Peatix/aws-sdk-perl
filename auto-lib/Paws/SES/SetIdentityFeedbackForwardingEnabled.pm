...
email. C<true> specifies that Amazon SES forwards bounce and complaint
notifications as email, in addition to any Amazon SNS topic publishing
otherwise specified. C<false> specifies that Amazon SES publishes
bounce and complaint notifications only through Amazon SNS. This value
can only be set to C<false> when Amazon SNS topics are set for both
C<Bounce> and C<Complaint> notification types.
