...
Paws::SES::UpdateConfigurationSetTrackingOptions - Arguments for method UpdateConfigurationSetTrackingOptions on L<Paws::SES>

=head1 DESCRIPTION

This class represents the parameters used for calling the method UpdateConfigurationSetTrackingOptions on the
L<Amazon Simple Email Service|Paws::SES> service. Use the attributes of this class
as arguments to method UpdateConfigurationSetTrackingOptions.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to UpdateConfigurationSetTrackingOptions.

=head1 SYNOPSIS

    my $email = Paws->service('SES');
    my $UpdateConfigurationSetTrackingOptionsResponse =
...
This class forms part of L<Paws>, documenting arguments for method UpdateConfigurationSetTrackingOptions in L<Paws::SES>
