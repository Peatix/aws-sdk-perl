...
C<send> - The call was successful and Amazon SES is attempting to
deliver the email.

=item *

C<reject> - Amazon SES determined that the email contained a virus and
rejected it.

=item *

C<bounce> - The recipient's mail server permanently rejected the email.
This corresponds to a hard bounce.

=item *

C<complaint> - The recipient marked the email as spam.

=item *

C<delivery> - Amazon SES successfully delivered the email to the
recipient's mail server.

=item *

C<open> - The recipient received the email and opened it in their email
client.
...
C<renderingFailure> - Amazon SES did not send the email because of a
