...
package Paws::SES::ReceiptAction;
  ...
  has ConnectAction => (is => 'ro', isa => 'Paws::SES::ConnectAction');
...
=head2 ConnectAction => L<Paws::SES::ConnectAction>
...
Calls an Amazon Web Services Lambda function, and optionally, publishes
