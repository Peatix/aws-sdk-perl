...
package Paws::QConnect::RemoveKnowledgeBaseTemplateUri;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::QConnect::RemoveKnowledgeBaseTemplateUriResponse');
1;
...
Paws::QConnect::RemoveKnowledgeBaseTemplateUri - Arguments for method RemoveKnowledgeBaseTemplateUri on L<Paws::QConnect>
...
This class forms part of L<Paws>, documenting arguments for method RemoveKnowledgeBaseTemplateUri in L<Paws::QConnect>
