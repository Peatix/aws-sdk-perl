...
package Paws::QConnect::ExtendedMessageTemplateData;
  use Moose;
  has Attachments => (is => 'ro', isa => 'ArrayRef[Paws::QConnect::MessageTemplateAttachment]', request_name => 'attachments', traits => ['NameInRequest']);
...
Paws::QConnect::ExtendedMessageTemplateData
...
As an example, if Att1 is expected to be a Paws::QConnect::ExtendedMessageTemplateData object:

  $service_obj->Method(Att1 => { Attachments => $value, ..., VersionNumber => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::QConnect::ExtendedMessageTemplateData object:
