...
package Paws::QConnect::DeleteAssistant;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::QConnect::DeleteAssistantResponse');
1;
...
Paws::QConnect::DeleteAssistant - Arguments for method DeleteAssistant on L<Paws::QConnect>
...
This class forms part of L<Paws>, documenting arguments for method DeleteAssistant in L<Paws::QConnect>
