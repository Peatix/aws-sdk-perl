...
package Paws::QConnect::GetRecommendations;
  use Moose;
  has AssistantId => (is => 'ro', isa => 'Str', traits => ['ParamInURI'], uri_name => 'assistantId', required => 1);
  has MaxResults => (is => 'ro', isa => 'Int', traits => ['ParamInQuery'], query_name => 'maxResults');
  has NextChunkToken => (is => 'ro', isa => 'Str', traits => ['ParamInQuery'], query_name => 'nextChunkToken');
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::QConnect::GetRecommendationsResponse');
1;
...
Paws::QConnect::GetRecommendations - Arguments for method GetRecommendations on L<Paws::QConnect>
...
=head1 SYNOPSIS
    ...
    my $GetRecommendationsResponse = $wisdom->GetRecommendations(
      ...
      NextChunkToken  => 'MyNextToken',    # OPTIONAL
    ...
    # Returns a L<Paws::QConnect::GetRecommendationsResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method GetRecommendations in L<Paws::QConnect>
