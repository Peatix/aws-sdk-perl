...
package Paws::QConnect::SearchSessions;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::QConnect::SearchSessionsResponse');
1;
...
Paws::QConnect::SearchSessions - Arguments for method SearchSessions on L<Paws::QConnect>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::QConnect::SearchSessionsResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method SearchSessions in L<Paws::QConnect>
