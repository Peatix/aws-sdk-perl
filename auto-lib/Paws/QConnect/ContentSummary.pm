...
package Paws::QConnect::ContentSummary;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::QConnect::ContentSummary object:

  $service_obj->Method(Att1 => { ContentArn => $value, ..., Title => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::QConnect::ContentSummary object:
