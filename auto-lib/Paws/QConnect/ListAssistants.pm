...
package Paws::QConnect::ListAssistants;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::QConnect::ListAssistantsResponse');
1;
...
Paws::QConnect::ListAssistants - Arguments for method ListAssistants on L<Paws::QConnect>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::QConnect::ListAssistantsResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method ListAssistants in L<Paws::QConnect>
