...
package Paws::QConnect::AIAgentData;
  use Moose;
  ...
  has Configuration => (is => 'ro', isa => 'Paws::QConnect::AIAgentConfiguration', request_name => 'configuration', traits => ['NameInRequest'], required => 1);
...
As an example, if Att1 is expected to be a Paws::QConnect::AIAgentData object:

  $service_obj->Method(Att1 => { AiAgentArn => $value, ..., VisibilityStatus => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::QConnect::AIAgentData object:
...
Specifies the origin of the AI Agent. C<SYSTEM> for a default AI Agent
created by Q in Connect or C<CUSTOMER> for an AI Agent created by
