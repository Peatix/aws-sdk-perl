...
package Paws::QConnect::CreateAIGuardrail;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'CreateAIGuardrail');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/assistants/{assistantId}/aiguardrails');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::QConnect::CreateAIGuardrailResponse');
1;
...
Paws::QConnect::CreateAIGuardrail - Arguments for method CreateAIGuardrail on L<Paws::QConnect>

=head1 DESCRIPTION

This class represents the parameters used for calling the method CreateAIGuardrail on the
L<Amazon Q Connect|Paws::QConnect> service. Use the attributes of this class
as arguments to method CreateAIGuardrail.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to CreateAIGuardrail.

=head1 SYNOPSIS

    my $wisdom = Paws->service('QConnect');
    my $CreateAIGuardrailResponse = $wisdom->CreateAIGuardrail(
    ...
    # Results:
    my $AiGuardrail = $CreateAIGuardrailResponse->AiGuardrail;

    # Returns a L<Paws::QConnect::CreateAIGuardrailResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/wisdom/CreateAIGuardrail>
...
This class forms part of L<Paws>, documenting arguments for method CreateAIGuardrail in L<Paws::QConnect>
