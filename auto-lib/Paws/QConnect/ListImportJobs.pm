...
package Paws::QConnect::ListImportJobs;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::QConnect::ListImportJobsResponse');
1;
...
Paws::QConnect::ListImportJobs - Arguments for method ListImportJobs on L<Paws::QConnect>
...
=head1 SYNOPSIS
    ...
    my $ListImportJobsResponse = $wisdom->ListImportJobs(
    ...
    # Results:
    my $ImportJobSummaries = $ListImportJobsResponse->ImportJobSummaries;
    my $NextToken          = $ListImportJobsResponse->NextToken;

    # Returns a L<Paws::QConnect::ListImportJobsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/wisdom/ListImportJobs>
...
This class forms part of L<Paws>, documenting arguments for method ListImportJobs in L<Paws::QConnect>
