...
package Paws::QConnect::GuardrailWordConfig;
  use Moose;
...
Paws::QConnect::GuardrailWordConfig
...
As an example, if Att1 is expected to be a Paws::QConnect::GuardrailWordConfig object:

  $service_obj->Method(Att1 => { Text => $value, ..., Text => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::QConnect::GuardrailWordConfig object:
