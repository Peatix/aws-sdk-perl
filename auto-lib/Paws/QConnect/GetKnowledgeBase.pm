...
package Paws::QConnect::GetKnowledgeBase;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::QConnect::GetKnowledgeBaseResponse');
1;
...
Paws::QConnect::GetKnowledgeBase - Arguments for method GetKnowledgeBase on L<Paws::QConnect>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::QConnect::GetKnowledgeBaseResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method GetKnowledgeBase in L<Paws::QConnect>
