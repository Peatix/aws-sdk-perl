...
package Paws::QConnect::DeleteQuickResponse;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::QConnect::DeleteQuickResponseResponse');
1;
...
Paws::QConnect::DeleteQuickResponse - Arguments for method DeleteQuickResponse on L<Paws::QConnect>
...
This class forms part of L<Paws>, documenting arguments for method DeleteQuickResponse in L<Paws::QConnect>
