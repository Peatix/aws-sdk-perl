...
package Paws::QConnect::GetSession;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::QConnect::GetSessionResponse');
1;
...
Paws::QConnect::GetSession - Arguments for method GetSession on L<Paws::QConnect>
...
=head1 SYNOPSIS
    ...
    my $GetSessionResponse = $wisdom->GetSession(
    ...
    # Returns a L<Paws::QConnect::GetSessionResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/wisdom/GetSession>
...
This class forms part of L<Paws>, documenting arguments for method GetSession in L<Paws::QConnect>
