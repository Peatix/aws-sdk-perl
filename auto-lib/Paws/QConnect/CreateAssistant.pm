...
package Paws::QConnect::CreateAssistant;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::QConnect::CreateAssistantResponse');
1;
...
Paws::QConnect::CreateAssistant - Arguments for method CreateAssistant on L<Paws::QConnect>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::QConnect::CreateAssistantResponse> object.
...
C<kms:CreateGrant>, C< kms:DescribeKey>, C<kms:Decrypt>, and
C<kms:GenerateDataKey*> permissions to the IAM identity using the key
to invoke Amazon Q in Connect. To use Amazon Q in Connect with chat,
the key policy must also allow C<kms:Decrypt>, C<kms:GenerateDataKey*>,
and C<kms:DescribeKey> permissions to the C<connect.amazonaws.com>
service principal.
...
This class forms part of L<Paws>, documenting arguments for method CreateAssistant in L<Paws::QConnect>
