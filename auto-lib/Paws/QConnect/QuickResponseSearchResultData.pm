...
package Paws::QConnect::QuickResponseSearchResultData;
  use Moose;
  ...
  has Contents => (is => 'ro', isa => 'Paws::QConnect::QuickResponseContents', request_name => 'contents', traits => ['NameInRequest'], required => 1);
...
Paws::QConnect::QuickResponseSearchResultData
...
As an example, if Att1 is expected to be a Paws::QConnect::QuickResponseSearchResultData object:

  $service_obj->Method(Att1 => { AttributesInterpolated => $value, ..., Tags => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::QConnect::QuickResponseSearchResultData object:
...
=head2 B<REQUIRED> Contents => L<Paws::QConnect::QuickResponseContents>
