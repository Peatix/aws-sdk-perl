...
package Paws::QConnect::DeleteKnowledgeBase;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::QConnect::DeleteKnowledgeBaseResponse');
1;
...
Paws::QConnect::DeleteKnowledgeBase - Arguments for method DeleteKnowledgeBase on L<Paws::QConnect>
...
This class forms part of L<Paws>, documenting arguments for method DeleteKnowledgeBase in L<Paws::QConnect>
