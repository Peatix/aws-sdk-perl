...
package Paws::QConnect::ListKnowledgeBases;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::QConnect::ListKnowledgeBasesResponse');
1;
...
Paws::QConnect::ListKnowledgeBases - Arguments for method ListKnowledgeBases on L<Paws::QConnect>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::QConnect::ListKnowledgeBasesResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method ListKnowledgeBases in L<Paws::QConnect>
