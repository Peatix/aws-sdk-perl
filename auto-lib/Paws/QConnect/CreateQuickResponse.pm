...
package Paws::QConnect::CreateQuickResponse;
  use Moose;
  has Channels => (is => 'ro', isa => 'ArrayRef[Str|Undef]', traits => ['NameInRequest'], request_name => 'channels');
  has ClientToken => (is => 'ro', isa => 'Str', traits => ['NameInRequest'], request_name => 'clientToken');
  has Content => (is => 'ro', isa => 'Paws::QConnect::QuickResponseDataProvider', traits => ['NameInRequest'], request_name => 'content', required => 1);
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::QConnect::CreateQuickResponseResponse');
1;
...
Paws::QConnect::CreateQuickResponse - Arguments for method CreateQuickResponse on L<Paws::QConnect>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::QConnect::CreateQuickResponseResponse> object.
...
=head2 B<REQUIRED> Content => L<Paws::QConnect::QuickResponseDataProvider>
...
This class forms part of L<Paws>, documenting arguments for method CreateQuickResponse in L<Paws::QConnect>
