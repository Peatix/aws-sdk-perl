...
package Paws::QConnect::ListQuickResponses;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::QConnect::ListQuickResponsesResponse');
1;
...
Paws::QConnect::ListQuickResponses - Arguments for method ListQuickResponses on L<Paws::QConnect>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::QConnect::ListQuickResponsesResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method ListQuickResponses in L<Paws::QConnect>
