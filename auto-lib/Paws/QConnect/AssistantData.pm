...
package Paws::QConnect::AssistantData;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::QConnect::AssistantData object:

  $service_obj->Method(Att1 => { AiAgentConfiguration => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::QConnect::AssistantData object:
