...
package Paws::QConnect::GetAssistant;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::QConnect::GetAssistantResponse');
1;
...
Paws::QConnect::GetAssistant - Arguments for method GetAssistant on L<Paws::QConnect>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::QConnect::GetAssistantResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method GetAssistant in L<Paws::QConnect>
