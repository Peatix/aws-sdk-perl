...
package Paws::QConnect::StartContentUpload;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::QConnect::StartContentUploadResponse');
1;
...
Paws::QConnect::StartContentUpload - Arguments for method StartContentUpload on L<Paws::QConnect>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::QConnect::StartContentUploadResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method StartContentUpload in L<Paws::QConnect>
