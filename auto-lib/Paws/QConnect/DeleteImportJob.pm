...
package Paws::QConnect::DeleteImportJob;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::QConnect::DeleteImportJobResponse');
1;
...
Paws::QConnect::DeleteImportJob - Arguments for method DeleteImportJob on L<Paws::QConnect>
...
This class forms part of L<Paws>, documenting arguments for method DeleteImportJob in L<Paws::QConnect>
