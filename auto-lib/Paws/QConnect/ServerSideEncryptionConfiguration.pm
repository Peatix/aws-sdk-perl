...
package Paws::QConnect::ServerSideEncryptionConfiguration;
  use Moose;
...
Paws::QConnect::ServerSideEncryptionConfiguration
...
As an example, if Att1 is expected to be a Paws::QConnect::ServerSideEncryptionConfiguration object:

  $service_obj->Method(Att1 => { KmsKeyId => $value, ..., KmsKeyId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::QConnect::ServerSideEncryptionConfiguration object:
