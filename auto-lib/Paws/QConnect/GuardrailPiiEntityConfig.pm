...
package Paws::QConnect::GuardrailPiiEntityConfig;
  use Moose;
...
Paws::QConnect::GuardrailPiiEntityConfig
...
As an example, if Att1 is expected to be a Paws::QConnect::GuardrailPiiEntityConfig object:

  $service_obj->Method(Att1 => { Action => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::QConnect::GuardrailPiiEntityConfig object:
...
example, in the phrase "I am 40 years old," Guarrails recognizes "40
years" as an age.
...
Dr., Mr., Mrs., or Miss. AI Guardrail doesn't apply this entity type to
names that are part of organizations or addresses. For example, AI
Guardrail recognizes the "John Doe Organization" as an organization,
...
AI Guardrail recognizes expiration dates such as I<01/21>, I<01/2021>,
and I<Jan 2021>.
...
123-456-789>. A SIN can be validated through a simple check-digit
...
I<485 555 3456>. The current system formats the 10-digit number with
