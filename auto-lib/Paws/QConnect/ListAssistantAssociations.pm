...
package Paws::QConnect::ListAssistantAssociations;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::QConnect::ListAssistantAssociationsResponse');
1;
...
Paws::QConnect::ListAssistantAssociations - Arguments for method ListAssistantAssociations on L<Paws::QConnect>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::QConnect::ListAssistantAssociationsResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method ListAssistantAssociations in L<Paws::QConnect>
