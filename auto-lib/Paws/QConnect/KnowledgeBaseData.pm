...
package Paws::QConnect::KnowledgeBaseData;
  use Moose;
  has Description => (is => 'ro', isa => 'Str', request_name => 'description', traits => ['NameInRequest']);
  has IngestionFailureReasons => (is => 'ro', isa => 'ArrayRef[Str|Undef]', request_name => 'ingestionFailureReasons', traits => ['NameInRequest']);
  has IngestionStatus => (is => 'ro', isa => 'Str', request_name => 'ingestionStatus', traits => ['NameInRequest']);
...
Paws::QConnect::KnowledgeBaseData
...
As an example, if Att1 is expected to be a Paws::QConnect::KnowledgeBaseData object:

  $service_obj->Method(Att1 => { Description => $value, ..., VectorIngestionConfiguration => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::QConnect::KnowledgeBaseData object:
...
=head2 IngestionFailureReasons => ArrayRef[Str|Undef]
