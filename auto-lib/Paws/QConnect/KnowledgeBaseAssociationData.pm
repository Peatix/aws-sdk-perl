...
package Paws::QConnect::KnowledgeBaseAssociationData;
  use Moose;
...
Paws::QConnect::KnowledgeBaseAssociationData
...
As an example, if Att1 is expected to be a Paws::QConnect::KnowledgeBaseAssociationData object:

  $service_obj->Method(Att1 => { KnowledgeBaseArn => $value, ..., KnowledgeBaseId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::QConnect::KnowledgeBaseAssociationData object:
