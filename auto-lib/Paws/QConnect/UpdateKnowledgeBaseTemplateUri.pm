...
package Paws::QConnect::UpdateKnowledgeBaseTemplateUri;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::QConnect::UpdateKnowledgeBaseTemplateUriResponse');
1;
...
Paws::QConnect::UpdateKnowledgeBaseTemplateUri - Arguments for method UpdateKnowledgeBaseTemplateUri on L<Paws::QConnect>
...
=head1 SYNOPSIS
   ...
   # Returns a L<Paws::QConnect::UpdateKnowledgeBaseTemplateUriResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method UpdateKnowledgeBaseTemplateUri in L<Paws::QConnect>
