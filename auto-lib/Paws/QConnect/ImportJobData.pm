...
package Paws::QConnect::ImportJobData;
  use Moose;
  has CreatedTime => (is => 'ro', isa => 'Str', request_name => 'createdTime', traits => ['NameInRequest'], required => 1);
  has ExternalSourceConfiguration => (is => 'ro', isa => 'Paws::QConnect::ExternalSourceConfiguration', request_name => 'externalSourceConfiguration', traits => ['NameInRequest']);
  ...
  has Metadata => (is => 'ro', isa => 'Paws::QConnect::ContentMetadata', request_name => 'metadata', traits => ['NameInRequest']);
...
As an example, if Att1 is expected to be a Paws::QConnect::ImportJobData object:

  $service_obj->Method(Att1 => { CreatedTime => $value, ..., UrlExpiry => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::QConnect::ImportJobData object:
