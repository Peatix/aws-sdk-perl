...
package Paws::QConnect::ImportJobSummary;
  use Moose;
...
Paws::QConnect::ImportJobSummary
...
As an example, if Att1 is expected to be a Paws::QConnect::ImportJobSummary object:

  $service_obj->Method(Att1 => { CreatedTime => $value, ..., UploadId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::QConnect::ImportJobSummary object:
