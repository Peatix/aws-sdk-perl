package Paws::DevOpsGuru;
  ...
  sub DeleteInsight {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::DevOpsGuru::DeleteInsight', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeEventSourcesConfig {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::DevOpsGuru::DescribeEventSourcesConfig', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeOrganizationHealth {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::DevOpsGuru::DescribeOrganizationHealth', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DescribeOrganizationOverview {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::DevOpsGuru::DescribeOrganizationOverview', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DescribeOrganizationResourceCollectionHealth {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::DevOpsGuru::DescribeOrganizationResourceCollectionHealth', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ListAnomalousLogGroups {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::DevOpsGuru::ListAnomalousLogGroups', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ListEvents {
    my $self = shift;
  ...
  sub ListMonitoredResources {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::DevOpsGuru::ListMonitoredResources', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ListOrganizationInsights {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::DevOpsGuru::ListOrganizationInsights', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub SearchOrganizationInsights {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::DevOpsGuru::SearchOrganizationInsights', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub UpdateEventSourcesConfig {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::DevOpsGuru::UpdateEventSourcesConfig', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribeAllOrganizationResourceCollectionHealth {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->DescribeOrganizationResourceCollectionHealth(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->NextToken) {
        $next_result = $self->DescribeOrganizationResourceCollectionHealth(@_, NextToken => $next_result->NextToken);
        push @{ $result->CloudFormation }, @{ $next_result->CloudFormation };
        push @{ $result->Account }, @{ $next_result->Account };
      ...
      while ($result->NextToken) {
        ...
        $callback->($_ => 'Account') foreach (@{ $result->Account });
        $callback->($_ => 'Service') foreach (@{ $result->Service });
        $callback->($_ => 'Tags') foreach (@{ $result->Tags });
        $result = $self->DescribeOrganizationResourceCollectionHealth(@_, NextToken => $result->NextToken);
      }
      $callback->($_ => 'CloudFormation') foreach (@{ $result->CloudFormation });
      $callback->($_ => 'Account') foreach (@{ $result->Account });
      $callback->($_ => 'Service') foreach (@{ $result->Service });
  ...
  sub GetAllResourceCollection {
    ...
    if (not defined $callback) {
      while ($next_result->NextToken) {
        ...
        push @{ $result->ResourceCollection->Tags }, @{ $next_result->ResourceCollection->Tags };
      }
      return $result;
    } else {
      while ($result->NextToken) {
        $callback->($_ => 'ResourceCollection.CloudFormation.StackNames') foreach (@{ $result->ResourceCollection->CloudFormation->StackNames });
        $callback->($_ => 'ResourceCollection.Tags') foreach (@{ $result->ResourceCollection->Tags });
  ...
  sub ListAllAnomalousLogGroups {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->ListAnomalousLogGroups(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->NextToken) {
        $next_result = $self->ListAnomalousLogGroups(@_, NextToken => $next_result->NextToken);
        push @{ $result->InsightId }, @{ $next_result->InsightId };
        push @{ $result->AnomalousLogGroups }, @{ $next_result->AnomalousLogGroups };
      }
      return $result;
    } else {
      while ($result->NextToken) {
        $callback->($_ => 'InsightId') foreach (@{ $result->InsightId });
        $callback->($_ => 'AnomalousLogGroups') foreach (@{ $result->AnomalousLogGroups });
        $result = $self->ListAnomalousLogGroups(@_, NextToken => $result->NextToken);
      }
      $callback->($_ => 'InsightId') foreach (@{ $result->InsightId });
      $callback->($_ => 'AnomalousLogGroups') foreach (@{ $result->AnomalousLogGroups });
    }
  ...
  sub ListAllMonitoredResources {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->ListMonitoredResources(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->NextToken) {
        $next_result = $self->ListMonitoredResources(@_, NextToken => $next_result->NextToken);
        push @{ $result->MonitoredResourceIdentifiers }, @{ $next_result->MonitoredResourceIdentifiers };
      }
      return $result;
    } else {
      while ($result->NextToken) {
        $callback->($_ => 'MonitoredResourceIdentifiers') foreach (@{ $result->MonitoredResourceIdentifiers });
        $result = $self->ListMonitoredResources(@_, NextToken => $result->NextToken);
      }
      $callback->($_ => 'MonitoredResourceIdentifiers') foreach (@{ $result->MonitoredResourceIdentifiers });
    }
  ...
  sub ListAllOrganizationInsights {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->ListOrganizationInsights(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->NextToken) {
        $next_result = $self->ListOrganizationInsights(@_, NextToken => $next_result->NextToken);
        push @{ $result->ProactiveInsights }, @{ $next_result->ProactiveInsights };
        push @{ $result->ReactiveInsights }, @{ $next_result->ReactiveInsights };
      }
      return $result;
      ...
      while ($result->NextToken) {
        $callback->($_ => 'ProactiveInsights') foreach (@{ $result->ProactiveInsights });
        $callback->($_ => 'ReactiveInsights') foreach (@{ $result->ReactiveInsights });
        $result = $self->ListOrganizationInsights(@_, NextToken => $result->NextToken);
      }
      $callback->($_ => 'ProactiveInsights') foreach (@{ $result->ProactiveInsights });
      $callback->($_ => 'ReactiveInsights') foreach (@{ $result->ReactiveInsights });
    }
  ...
  sub SearchAllOrganizationInsights {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->SearchOrganizationInsights(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->NextToken) {
        $next_result = $self->SearchOrganizationInsights(@_, NextToken => $next_result->NextToken);
        push @{ $result->ProactiveInsights }, @{ $next_result->ProactiveInsights };
        push @{ $result->ReactiveInsights }, @{ $next_result->ReactiveInsights };
      }
      return $result;
      ...
      while ($result->NextToken) {
        $callback->($_ => 'ProactiveInsights') foreach (@{ $result->ProactiveInsights });
        $callback->($_ => 'ReactiveInsights') foreach (@{ $result->ReactiveInsights });
        $result = $self->SearchOrganizationInsights(@_, NextToken => $result->NextToken);
      }
      $callback->($_ => 'ProactiveInsights') foreach (@{ $result->ProactiveInsights });
      $callback->($_ => 'ReactiveInsights') foreach (@{ $result->ReactiveInsights });
    }
...
anomalous behavior is detected, DevOps Guru creates an I<insight> that
...
see What is Amazon DevOps Guru
...
Each argument is described in detail in: L<Paws::DevOpsGuru::DeleteInsight>

Returns: a L<Paws::DevOpsGuru::DeleteInsightResponse> instance
...
=head2 DescribeEventSourcesConfig
...
Each argument is described in detail in: L<Paws::DevOpsGuru::DescribeEventSourcesConfig>

Returns: a L<Paws::DevOpsGuru::DescribeEventSourcesConfigResponse> instance
...
=head2 DescribeOrganizationHealth
...
Each argument is described in detail in: L<Paws::DevOpsGuru::DescribeOrganizationHealth>

Returns: a L<Paws::DevOpsGuru::DescribeOrganizationHealthResponse> instance

Returns active insights, predictive insights, and resource hours
analyzed in last hour.


=head2 DescribeOrganizationOverview
...
Each argument is described in detail in: L<Paws::DevOpsGuru::DescribeOrganizationOverview>

Returns: a L<Paws::DevOpsGuru::DescribeOrganizationOverviewResponse> instance
...
=head2 DescribeOrganizationResourceCollectionHealth

=over

=item OrganizationResourceCollectionType => Str
...
Each argument is described in detail in: L<Paws::DevOpsGuru::DescribeOrganizationResourceCollectionHealth>

Returns: a L<Paws::DevOpsGuru::DescribeOrganizationResourceCollectionHealthResponse> instance
...
collections in your account. You specify the type of Amazon Web
...
tagged using the same tag I<key>. You can specify up to 500 Amazon Web
...
same tag I<key>. You can specify up to 500 Amazon Web Services
...
=item [Filters => L<Paws::DevOpsGuru::ListAnomaliesForInsightFilters>]
...
Each argument is described in detail in: L<Paws::DevOpsGuru::ListAnomalousLogGroups>

Returns: a L<Paws::DevOpsGuru::ListAnomalousLogGroupsResponse> instance
...
(C<ONGOING>, C<CLOSED>, or C<ANY>).


=head2 ListMonitoredResources

=over

=item [Filters => L<Paws::DevOpsGuru::ListMonitoredResourcesFilters>]
...
Each argument is described in detail in: L<Paws::DevOpsGuru::ListMonitoredResources>

Returns: a L<Paws::DevOpsGuru::ListMonitoredResourcesResponse> instance
...
=head2 ListOrganizationInsights
...
Each argument is described in detail in: L<Paws::DevOpsGuru::ListOrganizationInsights>

Returns: a L<Paws::DevOpsGuru::ListOrganizationInsightsResponse> instance
...
statuses (C<ONGOING> or C<CLOSED>), one or more severities (C<LOW>,
...
=head2 SearchOrganizationInsights
...
=item [Filters => L<Paws::DevOpsGuru::SearchOrganizationInsightsFilters>]
...
Each argument is described in detail in: L<Paws::DevOpsGuru::SearchOrganizationInsights>

Returns: a L<Paws::DevOpsGuru::SearchOrganizationInsightsResponse> instance
...
=head2 UpdateEventSourcesConfig

=over

=item [EventSources => L<Paws::DevOpsGuru::EventSourcesConfig>]


=back

Each argument is described in detail in: L<Paws::DevOpsGuru::UpdateEventSourcesConfig>

Returns: a L<Paws::DevOpsGuru::UpdateEventSourcesConfigResponse> instance
...
=head2 DescribeAllOrganizationResourceCollectionHealth(sub { },OrganizationResourceCollectionType => Str, [AccountIds => ArrayRef[Str|Undef], MaxResults => Int, NextToken => Str, OrganizationalUnitIds => ArrayRef[Str|Undef]])

=head2 DescribeAllOrganizationResourceCollectionHealth(OrganizationResourceCollectionType => Str, [AccountIds => ArrayRef[Str|Undef], MaxResults => Int, NextToken => Str, OrganizationalUnitIds => ArrayRef[Str|Undef]])
...
If passed a sub as first parameter, it will call the sub for each element found in :
 ...
 - Account, passing the object as the first parameter, and the string 'Account' as the second parameter 

 - Service, passing the object as the first parameter, and the string 'Service' as the second parameter 

 - Tags, passing the object as the first parameter, and the string 'Tags' as the second parameter 

If not, it will return a a L<Paws::DevOpsGuru::DescribeOrganizationResourceCollectionHealthResponse> instance with all the C<param>s; andC<param>s; andC<param>s; andC<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
...
If not, it will return a a L<Paws::DevOpsGuru::DescribeResourceCollectionHealthResponse> instance with all the C<param>s; andC<param>s; andC<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
...
If passed a sub as first parameter, it will call the sub for each element found in :
 ...
 - ResourceCollection.Tags, passing the object as the first parameter, and the string 'ResourceCollection.Tags' as the second parameter 

If not, it will return a a L<Paws::DevOpsGuru::GetResourceCollectionResponse> instance with all the C<param>s; andC<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.


=head2 ListAllAnomaliesForInsight(sub { },InsightId => Str, [AccountId => Str, Filters => L<Paws::DevOpsGuru::ListAnomaliesForInsightFilters>, MaxResults => Int, NextToken => Str, StartTimeRange => L<Paws::DevOpsGuru::StartTimeRange>])

=head2 ListAllAnomaliesForInsight(InsightId => Str, [AccountId => Str, Filters => L<Paws::DevOpsGuru::ListAnomaliesForInsightFilters>, MaxResults => Int, NextToken => Str, StartTimeRange => L<Paws::DevOpsGuru::StartTimeRange>])
...
=head2 ListAllAnomalousLogGroups(sub { },InsightId => Str, [MaxResults => Int, NextToken => Str])

=head2 ListAllAnomalousLogGroups(InsightId => Str, [MaxResults => Int, NextToken => Str])


If passed a sub as first parameter, it will call the sub for each element found in :

 - InsightId, passing the object as the first parameter, and the string 'InsightId' as the second parameter 

 - AnomalousLogGroups, passing the object as the first parameter, and the string 'AnomalousLogGroups' as the second parameter 

If not, it will return a a L<Paws::DevOpsGuru::ListAnomalousLogGroupsResponse> instance with all the C<param>s; andC<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.


=head2 ListAllEvents(sub { },Filters => L<Paws::DevOpsGuru::ListEventsFilters>, [AccountId => Str, MaxResults => Int, NextToken => Str])

=head2 ListAllEvents(Filters => L<Paws::DevOpsGuru::ListEventsFilters>, [AccountId => Str, MaxResults => Int, NextToken => Str])
...
=head2 ListAllMonitoredResources(sub { },[Filters => L<Paws::DevOpsGuru::ListMonitoredResourcesFilters>, MaxResults => Int, NextToken => Str])

=head2 ListAllMonitoredResources([Filters => L<Paws::DevOpsGuru::ListMonitoredResourcesFilters>, MaxResults => Int, NextToken => Str])


If passed a sub as first parameter, it will call the sub for each element found in :

 - MonitoredResourceIdentifiers, passing the object as the first parameter, and the string 'MonitoredResourceIdentifiers' as the second parameter 

If not, it will return a a L<Paws::DevOpsGuru::ListMonitoredResourcesResponse> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
...
=head2 ListAllOrganizationInsights(sub { },StatusFilter => L<Paws::DevOpsGuru::ListInsightsStatusFilter>, [AccountIds => ArrayRef[Str|Undef], MaxResults => Int, NextToken => Str, OrganizationalUnitIds => ArrayRef[Str|Undef]])

=head2 ListAllOrganizationInsights(StatusFilter => L<Paws::DevOpsGuru::ListInsightsStatusFilter>, [AccountIds => ArrayRef[Str|Undef], MaxResults => Int, NextToken => Str, OrganizationalUnitIds => ArrayRef[Str|Undef]])
...
If not, it will return a a L<Paws::DevOpsGuru::ListOrganizationInsightsResponse> instance with all the C<param>s; andC<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.


=head2 ListAllRecommendations(sub { },InsightId => Str, [AccountId => Str, Locale => Str, NextToken => Str])

=head2 ListAllRecommendations(InsightId => Str, [AccountId => Str, Locale => Str, NextToken => Str])
...
=head2 SearchAllOrganizationInsights(sub { },AccountIds => ArrayRef[Str|Undef], StartTimeRange => L<Paws::DevOpsGuru::StartTimeRange>, Type => Str, [Filters => L<Paws::DevOpsGuru::SearchOrganizationInsightsFilters>, MaxResults => Int, NextToken => Str])

=head2 SearchAllOrganizationInsights(AccountIds => ArrayRef[Str|Undef], StartTimeRange => L<Paws::DevOpsGuru::StartTimeRange>, Type => Str, [Filters => L<Paws::DevOpsGuru::SearchOrganizationInsightsFilters>, MaxResults => Int, NextToken => Str])
...
If not, it will return a a L<Paws::DevOpsGuru::SearchOrganizationInsightsResponse> instance with all the C<param>s; andC<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
