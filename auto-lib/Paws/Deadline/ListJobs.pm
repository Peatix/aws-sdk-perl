...
package Paws::Deadline::ListJobs;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Deadline::ListJobsResponse');
1;
...
Paws::Deadline::ListJobs - Arguments for method ListJobs on L<Paws::Deadline>
...
=head1 SYNOPSIS
    ...
    my $ListJobsResponse = $deadline->ListJobs(
      FarmId      => 'MyFarmId',
      QueueId     => 'MyQueueId',
    ...
    # Returns a L<Paws::Deadline::ListJobsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/deadline/ListJobs>
...
This class forms part of L<Paws>, documenting arguments for method ListJobs in L<Paws::Deadline>
