...
package Paws::Deadline::AssociateMemberToQueue;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'AssociateMemberToQueue');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/2023-10-12/farms/{farmId}/queues/{queueId}/members/{principalId}');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'PUT');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Deadline::AssociateMemberToQueueResponse');
1;
...
Paws::Deadline::AssociateMemberToQueue - Arguments for method AssociateMemberToQueue on L<Paws::Deadline>

=head1 DESCRIPTION

This class represents the parameters used for calling the method AssociateMemberToQueue on the
L<AWSDeadlineCloud|Paws::Deadline> service. Use the attributes of this class
as arguments to method AssociateMemberToQueue.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to AssociateMemberToQueue.

=head1 SYNOPSIS

    my $deadline = Paws->service('Deadline');
    my $AssociateMemberToQueueResponse = $deadline->AssociateMemberToQueue(
      FarmId          => 'MyFarmId',
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/deadline/AssociateMemberToQueue>
...
This class forms part of L<Paws>, documenting arguments for method AssociateMemberToQueue in L<Paws::Deadline>
