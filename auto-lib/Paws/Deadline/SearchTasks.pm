...
package Paws::Deadline::SearchTasks;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'SearchTasks');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/2023-10-12/farms/{farmId}/search/tasks');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Deadline::SearchTasksResponse');
1;
...
Paws::Deadline::SearchTasks - Arguments for method SearchTasks on L<Paws::Deadline>

=head1 DESCRIPTION

This class represents the parameters used for calling the method SearchTasks on the
L<AWSDeadlineCloud|Paws::Deadline> service. Use the attributes of this class
as arguments to method SearchTasks.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to SearchTasks.

=head1 SYNOPSIS

    my $deadline = Paws->service('Deadline');
    my $SearchTasksResponse = $deadline->SearchTasks(
      FarmId            => 'MyFarmId',
      ItemOffset        => 1,
      QueueIds          => [ 'MyQueueId', ... ],
      FilterExpressions => {
    ...
    # Results:
    my $NextItemOffset = $SearchTasksResponse->NextItemOffset;
    my $Tasks          = $SearchTasksResponse->Tasks;
    my $TotalResults   = $SearchTasksResponse->TotalResults;

    # Returns a L<Paws::Deadline::SearchTasksResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/deadline/SearchTasks>
...
This class forms part of L<Paws>, documenting arguments for method SearchTasks in L<Paws::Deadline>
