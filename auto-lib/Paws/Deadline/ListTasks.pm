...
package Paws::Deadline::ListTasks;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/2023-10-12/farms/{farmId}/queues/{queueId}/jobs/{jobId}/steps/{stepId}/tasks');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Deadline::ListTasksResponse');
1;
...
Paws::Deadline::ListTasks - Arguments for method ListTasks on L<Paws::Deadline>
...
=head1 SYNOPSIS
    ...
    my $ListTasksResponse = $deadline->ListTasks(
      FarmId     => 'MyFarmId',
      JobId      => 'MyJobId',
      QueueId    => 'MyQueueId',
      StepId     => 'MyStepId',
    ...
    # Returns a L<Paws::Deadline::ListTasksResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/deadline/ListTasks>
...
This class forms part of L<Paws>, documenting arguments for method ListTasks in L<Paws::Deadline>
