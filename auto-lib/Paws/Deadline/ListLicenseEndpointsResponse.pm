...
package Paws::Deadline::ListLicenseEndpointsResponse;
  use Moose;
  has LicenseEndpoints => (is => 'ro', isa => 'ArrayRef[Paws::Deadline::LicenseEndpointSummary]', traits => ['NameInRequest'], request_name => 'licenseEndpoints', required => 1);
...
Paws::Deadline::ListLicenseEndpointsResponse

=head1 ATTRIBUTES


=head2 B<REQUIRED> LicenseEndpoints => ArrayRef[L<Paws::Deadline::LicenseEndpointSummary>]
