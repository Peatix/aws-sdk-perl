...
package Paws::Deadline::ListStepConsumersResponse;
  use Moose;
  has Consumers => (is => 'ro', isa => 'ArrayRef[Paws::Deadline::StepConsumer]', traits => ['NameInRequest'], request_name => 'consumers', required => 1);
...
Paws::Deadline::ListStepConsumersResponse

=head1 ATTRIBUTES


=head2 B<REQUIRED> Consumers => ArrayRef[L<Paws::Deadline::StepConsumer>]
