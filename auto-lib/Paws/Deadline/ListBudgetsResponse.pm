...
package Paws::Deadline::ListBudgetsResponse;
  use Moose;
  has Budgets => (is => 'ro', isa => 'ArrayRef[Paws::Deadline::BudgetSummary]', traits => ['NameInRequest'], request_name => 'budgets', required => 1);
...
Paws::Deadline::ListBudgetsResponse

=head1 ATTRIBUTES


=head2 B<REQUIRED> Budgets => ArrayRef[L<Paws::Deadline::BudgetSummary>]
