...
package Paws::Deadline::ListSteps;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/2023-10-12/farms/{farmId}/queues/{queueId}/jobs/{jobId}/steps');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Deadline::ListStepsResponse');
1;
...
Paws::Deadline::ListSteps - Arguments for method ListSteps on L<Paws::Deadline>
...
=head1 SYNOPSIS
    ...
    my $ListStepsResponse = $deadline->ListSteps(
      FarmId     => 'MyFarmId',
      JobId      => 'MyJobId',
      QueueId    => 'MyQueueId',
    ...
    # Results:
    my $NextToken = $ListStepsResponse->NextToken;
    my $Steps     = $ListStepsResponse->Steps;

    # Returns a L<Paws::Deadline::ListStepsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/deadline/ListSteps>
...
This class forms part of L<Paws>, documenting arguments for method ListSteps in L<Paws::Deadline>
