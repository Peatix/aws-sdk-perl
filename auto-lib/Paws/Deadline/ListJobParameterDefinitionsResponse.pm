...
package Paws::Deadline::ListJobParameterDefinitionsResponse;
  use Moose;
  has JobParameterDefinitions => (is => 'ro', isa => 'ArrayRef[Paws::Deadline::JobParameterDefinition]', traits => ['NameInRequest'], request_name => 'jobParameterDefinitions', required => 1);
...
Paws::Deadline::ListJobParameterDefinitionsResponse

=head1 ATTRIBUTES


=head2 B<REQUIRED> JobParameterDefinitions => ArrayRef[L<Paws::Deadline::JobParameterDefinition>]
