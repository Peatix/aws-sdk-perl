...
package Paws::Deadline::ListAvailableMeteredProductsResponse;
  use Moose;
  has MeteredProducts => (is => 'ro', isa => 'ArrayRef[Paws::Deadline::MeteredProductSummary]', traits => ['NameInRequest'], request_name => 'meteredProducts', required => 1);
...
Paws::Deadline::ListAvailableMeteredProductsResponse

=head1 ATTRIBUTES


=head2 B<REQUIRED> MeteredProducts => ArrayRef[L<Paws::Deadline::MeteredProductSummary>]
