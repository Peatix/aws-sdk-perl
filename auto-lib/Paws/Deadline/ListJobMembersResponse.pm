...
package Paws::Deadline::ListJobMembersResponse;
  use Moose;
  has Members => (is => 'ro', isa => 'ArrayRef[Paws::Deadline::JobMember]', traits => ['NameInRequest'], request_name => 'members', required => 1);
...
Paws::Deadline::ListJobMembersResponse

=head1 ATTRIBUTES


=head2 B<REQUIRED> Members => ArrayRef[L<Paws::Deadline::JobMember>]
