...
package Paws::Deadline::DeleteBudget;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Deadline::DeleteBudgetResponse');
1;
...
Paws::Deadline::DeleteBudget - Arguments for method DeleteBudget on L<Paws::Deadline>
...
=head1 SYNOPSIS
    ...
    my $DeleteBudgetResponse = $deadline->DeleteBudget(
      BudgetId => 'MyBudgetId',
      FarmId   => 'MyFarmId',
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/deadline/DeleteBudget>
...
This class forms part of L<Paws>, documenting arguments for method DeleteBudget in L<Paws::Deadline>
