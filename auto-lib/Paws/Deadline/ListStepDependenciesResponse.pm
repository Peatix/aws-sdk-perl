...
package Paws::Deadline::ListStepDependenciesResponse;
  use Moose;
  has Dependencies => (is => 'ro', isa => 'ArrayRef[Paws::Deadline::StepDependency]', traits => ['NameInRequest'], request_name => 'dependencies', required => 1);
...
Paws::Deadline::ListStepDependenciesResponse

=head1 ATTRIBUTES


=head2 B<REQUIRED> Dependencies => ArrayRef[L<Paws::Deadline::StepDependency>]
