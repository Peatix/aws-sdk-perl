...
package Paws::Deadline::ParameterFilterExpression;
  use Moose;
...
Paws::Deadline::ParameterFilterExpression
...
As an example, if Att1 is expected to be a Paws::Deadline::ParameterFilterExpression object:

  $service_obj->Method(Att1 => { Name => $value, ..., Value => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Deadline::ParameterFilterExpression object:
