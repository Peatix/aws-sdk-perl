...
package Paws::Deadline::ListJobsResponse;
  use Moose;
  has Jobs => (is => 'ro', isa => 'ArrayRef[Paws::Deadline::JobSummary]', traits => ['NameInRequest'], request_name => 'jobs', required => 1);
...
Paws::Deadline::ListJobsResponse

=head1 ATTRIBUTES


=head2 B<REQUIRED> Jobs => ArrayRef[L<Paws::Deadline::JobSummary>]
