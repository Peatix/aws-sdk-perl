...
package Paws::Deadline::ListQueueEnvironmentsResponse;
  use Moose;
  has Environments => (is => 'ro', isa => 'ArrayRef[Paws::Deadline::QueueEnvironmentSummary]', traits => ['NameInRequest'], request_name => 'environments', required => 1);
...
Paws::Deadline::ListQueueEnvironmentsResponse

=head1 ATTRIBUTES


=head2 B<REQUIRED> Environments => ArrayRef[L<Paws::Deadline::QueueEnvironmentSummary>]
