...
package Paws::Deadline::ListFleetsResponse;
  use Moose;
  has Fleets => (is => 'ro', isa => 'ArrayRef[Paws::Deadline::FleetSummary]', traits => ['NameInRequest'], request_name => 'fleets', required => 1);
...
Paws::Deadline::ListFleetsResponse

=head1 ATTRIBUTES


=head2 B<REQUIRED> Fleets => ArrayRef[L<Paws::Deadline::FleetSummary>]
