...
package Paws::Deadline::ListWorkersResponse;
  use Moose;
  has NextToken => (is => 'ro', isa => 'Str', traits => ['NameInRequest'], request_name => 'nextToken');
  has Workers => (is => 'ro', isa => 'ArrayRef[Paws::Deadline::WorkerSummary]', traits => ['NameInRequest'], request_name => 'workers', required => 1);
...
Paws::Deadline::ListWorkersResponse
...
=head2 B<REQUIRED> Workers => ArrayRef[L<Paws::Deadline::WorkerSummary>]
