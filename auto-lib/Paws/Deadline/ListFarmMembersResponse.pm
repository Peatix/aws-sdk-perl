...
package Paws::Deadline::ListFarmMembersResponse;
  use Moose;
  has Members => (is => 'ro', isa => 'ArrayRef[Paws::Deadline::FarmMember]', traits => ['NameInRequest'], request_name => 'members', required => 1);
...
Paws::Deadline::ListFarmMembersResponse

=head1 ATTRIBUTES


=head2 B<REQUIRED> Members => ArrayRef[L<Paws::Deadline::FarmMember>]
