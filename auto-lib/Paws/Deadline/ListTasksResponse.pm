...
package Paws::Deadline::ListTasksResponse;
  use Moose;
  has NextToken => (is => 'ro', isa => 'Str', traits => ['NameInRequest'], request_name => 'nextToken');
  has Tasks => (is => 'ro', isa => 'ArrayRef[Paws::Deadline::TaskSummary]', traits => ['NameInRequest'], request_name => 'tasks', required => 1);
...
Paws::Deadline::ListTasksResponse
...
=head2 B<REQUIRED> Tasks => ArrayRef[L<Paws::Deadline::TaskSummary>]
