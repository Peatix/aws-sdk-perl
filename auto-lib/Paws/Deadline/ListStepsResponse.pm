...
package Paws::Deadline::ListStepsResponse;
  use Moose;
  has NextToken => (is => 'ro', isa => 'Str', traits => ['NameInRequest'], request_name => 'nextToken');
  has Steps => (is => 'ro', isa => 'ArrayRef[Paws::Deadline::StepSummary]', traits => ['NameInRequest'], request_name => 'steps', required => 1);
...
Paws::Deadline::ListStepsResponse
...
=head2 B<REQUIRED> Steps => ArrayRef[L<Paws::Deadline::StepSummary>]
