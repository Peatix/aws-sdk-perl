...
package Paws::Deadline::StepDetailsError;
  use Moose;
...
Paws::Deadline::StepDetailsError
...
As an example, if Att1 is expected to be a Paws::Deadline::StepDetailsError object:

  $service_obj->Method(Att1 => { Code => $value, ..., StepId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Deadline::StepDetailsError object:
