...
package Paws::Deadline::GetQueueFleetAssociationResponse;
  use Moose;
...
Paws::Deadline::GetQueueFleetAssociationResponse
...
Valid values are: C<"ACTIVE">, C<"STOP_SCHEDULING_AND_COMPLETE_TASKS">, C<"STOP_SCHEDULING_AND_CANCEL_TASKS">, C<"STOPPED">
=head2 UpdatedAt => Str
