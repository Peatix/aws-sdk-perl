...
package Paws::SageMaker::ModelBiasAppSpecification;
  use Moose;
...
Paws::SageMaker::ModelBiasAppSpecification
...
As an example, if Att1 is expected to be a Paws::SageMaker::ModelBiasAppSpecification object:

  $service_obj->Method(Att1 => { ConfigUri => $value, ..., ImageUri => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::SageMaker::ModelBiasAppSpecification object:
