...
package Paws::SageMaker::OptimizationVpcConfig;
  use Moose;
...
Paws::SageMaker::OptimizationVpcConfig
...
As an example, if Att1 is expected to be a Paws::SageMaker::OptimizationVpcConfig object:

  $service_obj->Method(Att1 => { SecurityGroupIds => $value, ..., Subnets => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::SageMaker::OptimizationVpcConfig object:
