...
package Paws::SageMaker::ResourceLimits;
  use Moose;
  has MaxNumberOfTrainingJobs => (is => 'ro', isa => 'Int');
...
As an example, if Att1 is expected to be a Paws::SageMaker::ResourceLimits object:
  ...
  $service_obj->Method(Att1 => { MaxNumberOfTrainingJobs => $value, ..., MaxRuntimeInSeconds => $value  });
...
=head2 MaxNumberOfTrainingJobs => Int
