...
package Paws::SageMaker::StopPipelineExecution;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::SageMaker::StopPipelineExecutionResponse');
...
Paws::SageMaker::StopPipelineExecution - Arguments for method StopPipelineExecution on L<Paws::SageMaker>
...
=head1 SYNOPSIS
    ...
    my $StopPipelineExecutionResponse = $api . sagemaker->StopPipelineExecution(
    ...
    # Returns a L<Paws::SageMaker::StopPipelineExecutionResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/api.sagemaker/StopPipelineExecution>
...
This class forms part of L<Paws>, documenting arguments for method StopPipelineExecution in L<Paws::SageMaker>
