...
package Paws::SageMaker::DeleteSpace;
  use Moose;
...
Paws::SageMaker::DeleteSpace - Arguments for method DeleteSpace on L<Paws::SageMaker>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/api.sagemaker/DeleteSpace>
...
This class forms part of L<Paws>, documenting arguments for method DeleteSpace in L<Paws::SageMaker>
