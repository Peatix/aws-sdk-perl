...
package Paws::SageMaker::ListClusterSchedulerConfigs;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'ListClusterSchedulerConfigs');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::SageMaker::ListClusterSchedulerConfigsResponse');
...
Paws::SageMaker::ListClusterSchedulerConfigs - Arguments for method ListClusterSchedulerConfigs on L<Paws::SageMaker>

=head1 DESCRIPTION

This class represents the parameters used for calling the method ListClusterSchedulerConfigs on the
L<Amazon SageMaker Service|Paws::SageMaker> service. Use the attributes of this class
as arguments to method ListClusterSchedulerConfigs.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to ListClusterSchedulerConfigs.

=head1 SYNOPSIS

    my $api.sagemaker = Paws->service('SageMaker');
    my $ListClusterSchedulerConfigsResponse =
      $api . sagemaker->ListClusterSchedulerConfigs(
    ...
    # Results:
    my $ClusterSchedulerConfigSummaries =
      $ListClusterSchedulerConfigsResponse->ClusterSchedulerConfigSummaries;
    my $NextToken = $ListClusterSchedulerConfigsResponse->NextToken;

    # Returns a L<Paws::SageMaker::ListClusterSchedulerConfigsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/api.sagemaker/ListClusterSchedulerConfigs>
...
This class forms part of L<Paws>, documenting arguments for method ListClusterSchedulerConfigs in L<Paws::SageMaker>
