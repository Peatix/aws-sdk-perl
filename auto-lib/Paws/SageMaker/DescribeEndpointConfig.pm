...
=head1 SYNOPSIS
    ...
    my $ExecutionRoleArn   = $DescribeEndpointConfigOutput->ExecutionRoleArn;
    my $ExplainerConfig    = $DescribeEndpointConfigOutput->ExplainerConfig;
    ...
    my $VpcConfig = $DescribeEndpointConfigOutput->VpcConfig;
