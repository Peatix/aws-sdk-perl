...
package Paws::SageMaker::DeleteUserProfile;
  use Moose;
...
Paws::SageMaker::DeleteUserProfile - Arguments for method DeleteUserProfile on L<Paws::SageMaker>
...
This class forms part of L<Paws>, documenting arguments for method DeleteUserProfile in L<Paws::SageMaker>
