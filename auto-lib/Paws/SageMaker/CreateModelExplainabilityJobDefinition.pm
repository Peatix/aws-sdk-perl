...
package Paws::SageMaker::CreateModelExplainabilityJobDefinition;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'CreateModelExplainabilityJobDefinition');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::SageMaker::CreateModelExplainabilityJobDefinitionResponse');
...
Paws::SageMaker::CreateModelExplainabilityJobDefinition - Arguments for method CreateModelExplainabilityJobDefinition on L<Paws::SageMaker>

=head1 DESCRIPTION

This class represents the parameters used for calling the method CreateModelExplainabilityJobDefinition on the
L<Amazon SageMaker Service|Paws::SageMaker> service. Use the attributes of this class
as arguments to method CreateModelExplainabilityJobDefinition.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to CreateModelExplainabilityJobDefinition.

=head1 SYNOPSIS

    my $api.sagemaker = Paws->service('SageMaker');
    my $CreateModelExplainabilityJobDefinitionResponse =
...
# Returns a L<Paws::SageMaker::CreateModelExplainabilityJobDefinitionResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/api.sagemaker/CreateModelExplainabilityJobDefinition>
...
This class forms part of L<Paws>, documenting arguments for method CreateModelExplainabilityJobDefinition in L<Paws::SageMaker>
