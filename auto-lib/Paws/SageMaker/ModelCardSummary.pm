...
package Paws::SageMaker::ModelCardSummary;
  use Moose;
...
Paws::SageMaker::ModelCardSummary
...
As an example, if Att1 is expected to be a Paws::SageMaker::ModelCardSummary object:

  $service_obj->Method(Att1 => { CreationTime => $value, ..., ModelCardStatus => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::SageMaker::ModelCardSummary object:
