...
package Paws::SageMaker::CapacitySizeConfig;
  use Moose;
...
Paws::SageMaker::CapacitySizeConfig
...
As an example, if Att1 is expected to be a Paws::SageMaker::CapacitySizeConfig object:

  $service_obj->Method(Att1 => { Type => $value, ..., Value => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::SageMaker::CapacitySizeConfig object:
...
Specifies the amount or percentage of instances SageMaker updates at a
time.
