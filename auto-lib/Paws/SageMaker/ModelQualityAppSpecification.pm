...
package Paws::SageMaker::ModelQualityAppSpecification;
  use Moose;
...
Paws::SageMaker::ModelQualityAppSpecification
...
As an example, if Att1 is expected to be a Paws::SageMaker::ModelQualityAppSpecification object:

  $service_obj->Method(Att1 => { ContainerArguments => $value, ..., RecordPreprocessorSourceUri => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::SageMaker::ModelQualityAppSpecification object:
