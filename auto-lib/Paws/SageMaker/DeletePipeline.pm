...
package Paws::SageMaker::DeletePipeline;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::SageMaker::DeletePipelineResponse');
...
Paws::SageMaker::DeletePipeline - Arguments for method DeletePipeline on L<Paws::SageMaker>
...
This class forms part of L<Paws>, documenting arguments for method DeletePipeline in L<Paws::SageMaker>
