...
package Paws::SageMaker::CreateSpace;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::SageMaker::CreateSpaceResponse');
...
Paws::SageMaker::CreateSpace - Arguments for method CreateSpace on L<Paws::SageMaker>
...
=head1 SYNOPSIS
    ...
    my $CreateSpaceResponse = $api . sagemaker->CreateSpace(
      DomainId          => 'MyDomainId',
      SpaceName         => 'MySpaceName',
      OwnershipSettings => {
        OwnerUserProfileName => 'MyUserProfileName',    # max: 63
      ...
      SpaceSharingSettings => {
        SharingType => 'Private',    # values: Private, Shared
    ...
    # Results:
    my $SpaceArn = $CreateSpaceResponse->SpaceArn;

    # Returns a L<Paws::SageMaker::CreateSpaceResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/api.sagemaker/CreateSpace>
...
This class forms part of L<Paws>, documenting arguments for method CreateSpace in L<Paws::SageMaker>
