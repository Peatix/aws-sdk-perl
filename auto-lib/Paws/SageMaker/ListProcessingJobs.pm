...
package Paws::SageMaker::ListProcessingJobs;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'ListProcessingJobs');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::SageMaker::ListProcessingJobsResponse');
...
Paws::SageMaker::ListProcessingJobs - Arguments for method ListProcessingJobs on L<Paws::SageMaker>

=head1 DESCRIPTION

This class represents the parameters used for calling the method ListProcessingJobs on the
L<Amazon SageMaker Service|Paws::SageMaker> service. Use the attributes of this class
as arguments to method ListProcessingJobs.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to ListProcessingJobs.

=head1 SYNOPSIS

    my $api.sagemaker = Paws->service('SageMaker');
    my $ListProcessingJobsResponse = $api . sagemaker->ListProcessingJobs(
      ...
      NameContains           => 'MyString',               # OPTIONAL
    ...
    # Results:
    my $NextToken = $ListProcessingJobsResponse->NextToken;
    my $ProcessingJobSummaries =
      $ListProcessingJobsResponse->ProcessingJobSummaries;

    # Returns a L<Paws::SageMaker::ListProcessingJobsResponse> object.
...
If the result of the previous C<ListProcessingJobs> request was
...
This class forms part of L<Paws>, documenting arguments for method ListProcessingJobs in L<Paws::SageMaker>
