...
2022 update in the Support policy
...
more information, see the January 31, 2022 update in the Support policy
...
=item [Environment => L<Paws::Robomaker::Environment>]
...
=item [S3Etags => ArrayRef[Str|Undef]]
