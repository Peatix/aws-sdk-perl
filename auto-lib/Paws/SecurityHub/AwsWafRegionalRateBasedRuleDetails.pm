...
package Paws::SecurityHub::AwsWafRegionalRateBasedRuleDetails;
  use Moose;
  has MatchPredicates => (is => 'ro', isa => 'ArrayRef[Paws::SecurityHub::AwsWafRegionalRateBasedRuleMatchPredicate]');
...
Paws::SecurityHub::AwsWafRegionalRateBasedRuleDetails
...
As an example, if Att1 is expected to be a Paws::SecurityHub::AwsWafRegionalRateBasedRuleDetails object:

  $service_obj->Method(Att1 => { MatchPredicates => $value, ..., RuleId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::SecurityHub::AwsWafRegionalRateBasedRuleDetails object:
...
=head2 MatchPredicates => ArrayRef[L<Paws::SecurityHub::AwsWafRegionalRateBasedRuleMatchPredicate>]
