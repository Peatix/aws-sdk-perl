...
package Paws::SecurityHub::DisassociateMembers;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::SecurityHub::DisassociateMembersResponse');
1;
...
Paws::SecurityHub::DisassociateMembers - Arguments for method DisassociateMembers on L<Paws::SecurityHub>
...
This class forms part of L<Paws>, documenting arguments for method DisassociateMembers in L<Paws::SecurityHub>
