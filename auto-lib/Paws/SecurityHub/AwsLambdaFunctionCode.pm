...
package Paws::SecurityHub::AwsLambdaFunctionCode;
  use Moose;
...
Paws::SecurityHub::AwsLambdaFunctionCode
...
As an example, if Att1 is expected to be a Paws::SecurityHub::AwsLambdaFunctionCode object:

  $service_obj->Method(Att1 => { S3Bucket => $value, ..., ZipFile => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::SecurityHub::AwsLambdaFunctionCode object:
