...
package Paws::SecurityHub::StartConfigurationPolicyAssociationResponse;
  use Moose;
...
Paws::SecurityHub::StartConfigurationPolicyAssociationResponse
...
An explanation for a C<FAILED> value for C<AssociationStatus>.
