...
package Paws::SecurityHub::AwsEc2LaunchTemplateDataPrivateDnsNameOptionsDetails;
  use Moose;
...
Paws::SecurityHub::AwsEc2LaunchTemplateDataPrivateDnsNameOptionsDetails
...
As an example, if Att1 is expected to be a Paws::SecurityHub::AwsEc2LaunchTemplateDataPrivateDnsNameOptionsDetails object:

  $service_obj->Method(Att1 => { EnableResourceNameDnsAAAARecord => $value, ..., HostnameType => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::SecurityHub::AwsEc2LaunchTemplateDataPrivateDnsNameOptionsDetails object:
