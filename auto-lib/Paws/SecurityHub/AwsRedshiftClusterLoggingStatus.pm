...
package Paws::SecurityHub::AwsRedshiftClusterLoggingStatus;
  use Moose;
...
Paws::SecurityHub::AwsRedshiftClusterLoggingStatus
...
As an example, if Att1 is expected to be a Paws::SecurityHub::AwsRedshiftClusterLoggingStatus object:

  $service_obj->Method(Att1 => { BucketName => $value, ..., S3KeyPrefix => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::SecurityHub::AwsRedshiftClusterLoggingStatus object:
