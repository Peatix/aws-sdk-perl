...
package Paws::SecurityHub::EnableOrganizationAdminAccount;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/organization/admin/enable');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::SecurityHub::EnableOrganizationAdminAccountResponse');
1;
...
Paws::SecurityHub::EnableOrganizationAdminAccount - Arguments for method EnableOrganizationAdminAccount on L<Paws::SecurityHub>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/securityhub/EnableOrganizationAdminAccount>
...
This class forms part of L<Paws>, documenting arguments for method EnableOrganizationAdminAccount in L<Paws::SecurityHub>
