...
package Paws::SecurityHub::AwsWafRegionalRateBasedRuleMatchPredicate;
  use Moose;
...
Paws::SecurityHub::AwsWafRegionalRateBasedRuleMatchPredicate
...
As an example, if Att1 is expected to be a Paws::SecurityHub::AwsWafRegionalRateBasedRuleMatchPredicate object:

  $service_obj->Method(Att1 => { DataId => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::SecurityHub::AwsWafRegionalRateBasedRuleMatchPredicate object:
