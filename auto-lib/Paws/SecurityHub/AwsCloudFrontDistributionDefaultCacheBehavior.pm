...
package Paws::SecurityHub::AwsCloudFrontDistributionDefaultCacheBehavior;
  use Moose;
...
Paws::SecurityHub::AwsCloudFrontDistributionDefaultCacheBehavior
...
As an example, if Att1 is expected to be a Paws::SecurityHub::AwsCloudFrontDistributionDefaultCacheBehavior object:

  $service_obj->Method(Att1 => { ViewerProtocolPolicy => $value, ..., ViewerProtocolPolicy => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::SecurityHub::AwsCloudFrontDistributionDefaultCacheBehavior object:
