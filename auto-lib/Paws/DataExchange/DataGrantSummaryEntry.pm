...
package Paws::DataExchange::DataGrantSummaryEntry;
  use Moose;
...
Paws::DataExchange::DataGrantSummaryEntry
...
As an example, if Att1 is expected to be a Paws::DataExchange::DataGrantSummaryEntry object:

  $service_obj->Method(Att1 => { AcceptanceState => $value, ..., UpdatedAt => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::DataExchange::DataGrantSummaryEntry object:
