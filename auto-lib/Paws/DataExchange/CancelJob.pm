...
package Paws::DataExchange::CancelJob;
  use Moose;
...
Paws::DataExchange::CancelJob - Arguments for method CancelJob on L<Paws::DataExchange>
...
This class forms part of L<Paws>, documenting arguments for method CancelJob in L<Paws::DataExchange>
