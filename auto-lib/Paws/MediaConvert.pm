package Paws::MediaConvert;
  ...
  sub DeletePolicy {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::MediaConvert::DeletePolicy', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DeletePreset {
    my $self = shift;
  ...
  sub GetPolicy {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::MediaConvert::GetPolicy', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetPreset {
    my $self = shift;
  ...
  sub ListVersions {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::MediaConvert::ListVersions', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub Probe {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::MediaConvert::Probe', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub PutPolicy {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::MediaConvert::PutPolicy', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub SearchJobs {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::MediaConvert::SearchJobs', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub TagResource {
    my $self = shift;
  ...
  sub SearchAllJobs {
    ...
    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->SearchJobs(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->NextToken) {
        $next_result = $self->SearchJobs(@_, NextToken => $next_result->NextToken);
        push @{ $result->Jobs }, @{ $next_result->Jobs };
      }
      return $result;
    } else {
      while ($result->NextToken) {
        $callback->($_ => 'Jobs') foreach (@{ $result->Jobs });
        $result = $self->SearchJobs(@_, NextToken => $result->NextToken);
      }
      $callback->($_ => 'Jobs') foreach (@{ $result->Jobs });
    }
...
Each argument is described in detail in: L<Paws::MediaConvert::DeletePolicy>

Returns: a L<Paws::MediaConvert::DeletePolicyResponse> instance
...
Each argument is described in detail in: L<Paws::MediaConvert::GetPolicy>

Returns: a L<Paws::MediaConvert::GetPolicyResponse> instance
...
Each argument is described in detail in: L<Paws::MediaConvert::ListVersions>

Returns: a L<Paws::MediaConvert::ListVersionsResponse> instance
...
=item [InputFiles => ArrayRef[L<Paws::MediaConvert::ProbeInputFile>]]


=back

Each argument is described in detail in: L<Paws::MediaConvert::Probe>

Returns: a L<Paws::MediaConvert::ProbeResponse> instance
...
=item Policy => L<Paws::MediaConvert::Policy>


=back

Each argument is described in detail in: L<Paws::MediaConvert::PutPolicy>

Returns: a L<Paws::MediaConvert::PutPolicyResponse> instance
...
Each argument is described in detail in: L<Paws::MediaConvert::SearchJobs>

Returns: a L<Paws::MediaConvert::SearchJobsResponse> instance
...
=head2 ListAllVersions(sub { },[MaxResults => Int, NextToken => Str])

=head2 ListAllVersions([MaxResults => Int, NextToken => Str])
...
If not, it will return a a L<Paws::MediaConvert::ListVersionsResponse> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.


=head2 SearchAllJobs(sub { },[InputFile => Str, MaxResults => Int, NextToken => Str, Order => Str, Queue => Str, Status => Str])

=head2 SearchAllJobs([InputFile => Str, MaxResults => Int, NextToken => Str, Order => Str, Queue => Str, Status => Str])
...
If not, it will return a a L<Paws::MediaConvert::SearchJobsResponse> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
