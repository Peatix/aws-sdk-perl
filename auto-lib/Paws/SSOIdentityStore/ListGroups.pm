...
package Paws::SSOIdentityStore::ListGroups;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::SSOIdentityStore::ListGroupsResponse');
...
Paws::SSOIdentityStore::ListGroups - Arguments for method ListGroups on L<Paws::SSOIdentityStore>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/identitystore/ListGroups>
...
The pagination token used for the C<ListUsers> and C<ListGroups> API
...
This class forms part of L<Paws>, documenting arguments for method ListGroups in L<Paws::SSOIdentityStore>
