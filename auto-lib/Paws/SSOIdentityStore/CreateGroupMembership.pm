...
package Paws::SSOIdentityStore::CreateGroupMembership;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::SSOIdentityStore::CreateGroupMembershipResponse');
...
Paws::SSOIdentityStore::CreateGroupMembership - Arguments for method CreateGroupMembership on L<Paws::SSOIdentityStore>
...
=head1 SYNOPSIS
    ...
    my $CreateGroupMembershipResponse = $identitystore->CreateGroupMembership(
    ...
    # Results:
    my $IdentityStoreId = $CreateGroupMembershipResponse->IdentityStoreId;
    my $MembershipId    = $CreateGroupMembershipResponse->MembershipId;

    # Returns a L<Paws::SSOIdentityStore::CreateGroupMembershipResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/identitystore/CreateGroupMembership>
...
This class forms part of L<Paws>, documenting arguments for method CreateGroupMembership in L<Paws::SSOIdentityStore>
