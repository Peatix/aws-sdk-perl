package Paws::ApiGateway;
  ...
  sub CreateDomainNameAccessAssociation {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ApiGateway::CreateDomainNameAccessAssociation', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub CreateModel {
    my $self = shift;
  ...
  sub DeleteDomainNameAccessAssociation {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ApiGateway::DeleteDomainNameAccessAssociation', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub GetDomainNameAccessAssociations {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ApiGateway::GetDomainNameAccessAssociations', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetDomainNames {
    my $self = shift;
  ...
  sub RejectDomainNameAccessAssociation {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ApiGateway::RejectDomainNameAccessAssociation', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub TagResource {
    my $self = shift;
...
run on Lambda, Amazon EC2, or other publicly addressable web services
...
=item [OwnershipVerificationCertificateArn => Str]
...
=head2 CreateDomainNameAccessAssociation

=over

=item AccessAssociationSource => Str

=item AccessAssociationSourceType => Str

=item DomainNameArn => Str
...
Each argument is described in detail in: L<Paws::ApiGateway::CreateDomainNameAccessAssociation>

Returns: a L<Paws::ApiGateway::DomainNameAccessAssociation> instance
...
=head2 DeleteDomainNameAccessAssociation

=over

=item DomainNameAccessAssociationArn => Str


=back

Each argument is described in detail in: L<Paws::ApiGateway::DeleteDomainNameAccessAssociation>
...
=head2 GetDomainNameAccessAssociations
...
Each argument is described in detail in: L<Paws::ApiGateway::GetDomainNameAccessAssociations>

Returns: a L<Paws::ApiGateway::DomainNameAccessAssociations> instance
...
=head2 RejectDomainNameAccessAssociation
...
Each argument is described in detail in: L<Paws::ApiGateway::RejectDomainNameAccessAssociation>
...
=head2 GetAllBasePathMappings(sub { },DomainName => Str, [DomainNameId => Str, Limit => Int, Position => Str])

=head2 GetAllBasePathMappings(DomainName => Str, [DomainNameId => Str, Limit => Int, Position => Str])
...
=head2 GetAllDomainNames(sub { },[Limit => Int, Position => Str, ResourceOwner => Str])

=head2 GetAllDomainNames([Limit => Int, Position => Str, ResourceOwner => Str])
