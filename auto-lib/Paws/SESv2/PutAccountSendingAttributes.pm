...
package Paws::SESv2::PutAccountSendingAttributes;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/v2/email/account/sending');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'PUT');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::SESv2::PutAccountSendingAttributesResponse');
1;
...
Paws::SESv2::PutAccountSendingAttributes - Arguments for method PutAccountSendingAttributes on L<Paws::SESv2>
...
This class forms part of L<Paws>, documenting arguments for method PutAccountSendingAttributes in L<Paws::SESv2>
