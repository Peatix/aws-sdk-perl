...
package Paws::SESv2::ListConfigurationSets;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::SESv2::ListConfigurationSetsResponse');
1;
...
Paws::SESv2::ListConfigurationSets - Arguments for method ListConfigurationSets on L<Paws::SESv2>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::SESv2::ListConfigurationSetsResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method ListConfigurationSets in L<Paws::SESv2>
