...
Paws::SESv2::DeleteEmailIdentity - Arguments for method DeleteEmailIdentity on L<Paws::SESv2>
...
This class forms part of L<Paws>, documenting arguments for method DeleteEmailIdentity in L<Paws::SESv2>
