...
package Paws::SESv2::GetCustomVerificationEmailTemplate;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::SESv2::GetCustomVerificationEmailTemplateResponse');
1;
...
Paws::SESv2::GetCustomVerificationEmailTemplate - Arguments for method GetCustomVerificationEmailTemplate on L<Paws::SESv2>
...
=head1 SYNOPSIS
  ...
  # Returns a L<Paws::SESv2::GetCustomVerificationEmailTemplateResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method GetCustomVerificationEmailTemplate in L<Paws::SESv2>
