...
package Paws::SESv2::DeleteCustomVerificationEmailTemplate;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::SESv2::DeleteCustomVerificationEmailTemplateResponse');
1;
...
Paws::SESv2::DeleteCustomVerificationEmailTemplate - Arguments for method DeleteCustomVerificationEmailTemplate on L<Paws::SESv2>
...
=head1 SYNOPSIS
    ...
    my $DeleteCustomVerificationEmailTemplateResponse =
...
This class forms part of L<Paws>, documenting arguments for method DeleteCustomVerificationEmailTemplate in L<Paws::SESv2>
