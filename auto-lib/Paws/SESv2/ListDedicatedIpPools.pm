...
package Paws::SESv2::ListDedicatedIpPools;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::SESv2::ListDedicatedIpPoolsResponse');
1;
...
Paws::SESv2::ListDedicatedIpPools - Arguments for method ListDedicatedIpPools on L<Paws::SESv2>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::SESv2::ListDedicatedIpPoolsResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method ListDedicatedIpPools in L<Paws::SESv2>
