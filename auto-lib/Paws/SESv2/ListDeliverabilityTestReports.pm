...
package Paws::SESv2::ListDeliverabilityTestReports;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/v2/email/deliverability-dashboard/test-reports');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::SESv2::ListDeliverabilityTestReportsResponse');
1;
...
Paws::SESv2::ListDeliverabilityTestReports - Arguments for method ListDeliverabilityTestReports on L<Paws::SESv2>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::SESv2::ListDeliverabilityTestReportsResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method ListDeliverabilityTestReports in L<Paws::SESv2>
