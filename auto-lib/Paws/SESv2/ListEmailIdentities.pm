...
package Paws::SESv2::ListEmailIdentities;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::SESv2::ListEmailIdentitiesResponse');
1;
...
Paws::SESv2::ListEmailIdentities - Arguments for method ListEmailIdentities on L<Paws::SESv2>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::SESv2::ListEmailIdentitiesResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method ListEmailIdentities in L<Paws::SESv2>
