...
As an example, if Att1 is expected to be a Paws::SESv2::SnsDestination object:

  $service_obj->Method(Att1 => { TopicArn => $value, ..., TopicArn => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::SESv2::SnsDestination object:
...
events to. For more information about Amazon SNS topics, see the Amazon
SNS Developer Guide
