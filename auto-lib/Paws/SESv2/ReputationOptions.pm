...
package Paws::SESv2::ReputationOptions;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::SESv2::ReputationOptions object:

  $service_obj->Method(Att1 => { LastFreshStart => $value, ..., ReputationMetricsEnabled => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::SESv2::ReputationOptions object:
