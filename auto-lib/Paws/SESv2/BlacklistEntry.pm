...
package Paws::SESv2::BlacklistEntry;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::SESv2::BlacklistEntry object:

  $service_obj->Method(Att1 => { Description => $value, ..., RblName => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::SESv2::BlacklistEntry object:
