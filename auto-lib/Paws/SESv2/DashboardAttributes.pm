...
package Paws::SESv2::DashboardAttributes;
  use Moose;
...
Paws::SESv2::DashboardAttributes
...
As an example, if Att1 is expected to be a Paws::SESv2::DashboardAttributes object:

  $service_obj->Method(Att1 => { EngagementMetrics => $value, ..., EngagementMetrics => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::SESv2::DashboardAttributes object:
...
C<ENABLED> E<ndash> Amazon SES enables engagement metrics for your
account.

=item *

C<DISABLED> E<ndash> Amazon SES disables engagement metrics for your
account.
