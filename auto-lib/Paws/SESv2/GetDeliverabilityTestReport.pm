...
package Paws::SESv2::GetDeliverabilityTestReport;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/v2/email/deliverability-dashboard/test-reports/{ReportId}');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::SESv2::GetDeliverabilityTestReportResponse');
1;
...
Paws::SESv2::GetDeliverabilityTestReport - Arguments for method GetDeliverabilityTestReport on L<Paws::SESv2>
...
=head1 SYNOPSIS
    ...
    my $Tags = $GetDeliverabilityTestReportResponse->Tags;

    # Returns a L<Paws::SESv2::GetDeliverabilityTestReportResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method GetDeliverabilityTestReport in L<Paws::SESv2>
