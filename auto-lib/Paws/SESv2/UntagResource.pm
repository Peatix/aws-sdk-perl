...
package Paws::SESv2::UntagResource;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::SESv2::UntagResourceResponse');
1;
...
Paws::SESv2::UntagResource - Arguments for method UntagResource on L<Paws::SESv2>
...
C</v2/email/tags?ResourceArn=ResourceArn&TagKeys=Key1&TagKeys=Key2>
...
This class forms part of L<Paws>, documenting arguments for method UntagResource in L<Paws::SESv2>
