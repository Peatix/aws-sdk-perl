...
package Paws::SESv2::DeleteConfigurationSet;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::SESv2::DeleteConfigurationSetResponse');
1;
...
Paws::SESv2::DeleteConfigurationSet - Arguments for method DeleteConfigurationSet on L<Paws::SESv2>
...
This class forms part of L<Paws>, documenting arguments for method DeleteConfigurationSet in L<Paws::SESv2>
