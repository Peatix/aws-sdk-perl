...
package Paws::SESv2::GetDedicatedIp;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/v2/email/dedicated-ips/{IP}');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::SESv2::GetDedicatedIpResponse');
1;
...
Paws::SESv2::GetDedicatedIp - Arguments for method GetDedicatedIp on L<Paws::SESv2>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::SESv2::GetDedicatedIpResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method GetDedicatedIp in L<Paws::SESv2>
