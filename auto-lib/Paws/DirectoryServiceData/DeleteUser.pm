...
package Paws::DirectoryServiceData::DeleteUser;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/Users/DeleteUser');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::DirectoryServiceData::DeleteUserResult');
1;
...
Paws::DirectoryServiceData::DeleteUser - Arguments for method DeleteUser on L<Paws::DirectoryServiceData>
...
=head1 SYNOPSIS
    ...
    my $DeleteUserResult = $ds -data->DeleteUser(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/ds-data/DeleteUser>
...
This class forms part of L<Paws>, documenting arguments for method DeleteUser in L<Paws::DirectoryServiceData>
