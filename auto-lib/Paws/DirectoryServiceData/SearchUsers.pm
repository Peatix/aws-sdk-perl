...
package Paws::DirectoryServiceData::SearchUsers;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/Users/SearchUsers');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::DirectoryServiceData::SearchUsersResult');
1;
...
Paws::DirectoryServiceData::SearchUsers - Arguments for method SearchUsers on L<Paws::DirectoryServiceData>
...
=head1 SYNOPSIS
    ...
    my $SearchUsersResult = $ds -data->SearchUsers(
    ...
    # Results:
    my $DirectoryId = $SearchUsersResult->DirectoryId;
    my $NextToken   = $SearchUsersResult->NextToken;
    my $Realm       = $SearchUsersResult->Realm;
    my $Users       = $SearchUsersResult->Users;

    # Returns a L<Paws::DirectoryServiceData::SearchUsersResult> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/ds-data/SearchUsers>
...
This class forms part of L<Paws>, documenting arguments for method SearchUsers in L<Paws::DirectoryServiceData>
