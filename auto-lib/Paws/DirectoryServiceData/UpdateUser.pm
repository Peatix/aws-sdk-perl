...
package Paws::DirectoryServiceData::UpdateUser;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/Users/UpdateUser');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::DirectoryServiceData::UpdateUserResult');
1;
...
Paws::DirectoryServiceData::UpdateUser - Arguments for method UpdateUser on L<Paws::DirectoryServiceData>
...
=head1 SYNOPSIS
    ...
    my $UpdateUserResult = $ds -data->UpdateUser(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/ds-data/UpdateUser>
...
This class forms part of L<Paws>, documenting arguments for method UpdateUser in L<Paws::DirectoryServiceData>
