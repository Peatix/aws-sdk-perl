...
package Paws::DirectoryServiceData::DeleteGroup;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/Groups/DeleteGroup');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::DirectoryServiceData::DeleteGroupResult');
1;
...
Paws::DirectoryServiceData::DeleteGroup - Arguments for method DeleteGroup on L<Paws::DirectoryServiceData>
...
=head1 SYNOPSIS
    ...
    my $DeleteGroupResult = $ds -data->DeleteGroup(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/ds-data/DeleteGroup>
...
This class forms part of L<Paws>, documenting arguments for method DeleteGroup in L<Paws::DirectoryServiceData>
