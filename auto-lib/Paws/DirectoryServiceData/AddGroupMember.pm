...
package Paws::DirectoryServiceData::AddGroupMember;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'AddGroupMember');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/GroupMemberships/AddGroupMember');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::DirectoryServiceData::AddGroupMemberResult');
1;
...
Paws::DirectoryServiceData::AddGroupMember - Arguments for method AddGroupMember on L<Paws::DirectoryServiceData>

=head1 DESCRIPTION

This class represents the parameters used for calling the method AddGroupMember on the
L<AWS Directory Service Data|Paws::DirectoryServiceData> service. Use the attributes of this class
as arguments to method AddGroupMember.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to AddGroupMember.

=head1 SYNOPSIS

    my $ds-data = Paws->service('DirectoryServiceData');
    my $AddGroupMemberResult = $ds -data->AddGroupMember(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/ds-data/AddGroupMember>
...
The C<SAMAccountName> of the user, group, or computer to add as a group
member.
...
is required only when adding a member outside of your Managed Microsoft
AD domain to a group inside of your Managed Microsoft AD domain. This
...
This class forms part of L<Paws>, documenting arguments for method AddGroupMember in L<Paws::DirectoryServiceData>
