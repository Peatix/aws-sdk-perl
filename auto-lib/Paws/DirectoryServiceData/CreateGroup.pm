...
package Paws::DirectoryServiceData::CreateGroup;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/Groups/CreateGroup');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::DirectoryServiceData::CreateGroupResult');
1;
...
Paws::DirectoryServiceData::CreateGroup - Arguments for method CreateGroup on L<Paws::DirectoryServiceData>
...
=head1 SYNOPSIS
    ...
    my $CreateGroupResult = $ds -data->CreateGroup(
    ...
    # Results:
    my $DirectoryId    = $CreateGroupResult->DirectoryId;
    my $SAMAccountName = $CreateGroupResult->SAMAccountName;
    my $SID            = $CreateGroupResult->SID;

    # Returns a L<Paws::DirectoryServiceData::CreateGroupResult> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/ds-data/CreateGroup>
...
This class forms part of L<Paws>, documenting arguments for method CreateGroup in L<Paws::DirectoryServiceData>
