...
package Paws::Route53RecoveryControlConfig::GatingRuleUpdate;
  use Moose;
...
Paws::Route53RecoveryControlConfig::GatingRuleUpdate
...
As an example, if Att1 is expected to be a Paws::Route53RecoveryControlConfig::GatingRuleUpdate object:

  $service_obj->Method(Att1 => { Name => $value, ..., WaitPeriodMs => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Route53RecoveryControlConfig::GatingRuleUpdate object:
