...
package Paws::Route53RecoveryControlConfig::ListRoutingControls;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/controlpanel/{ControlPanelArn}/routingcontrols');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Route53RecoveryControlConfig::ListRoutingControlsResponse');
1;
...
Paws::Route53RecoveryControlConfig::ListRoutingControls - Arguments for method ListRoutingControls on L<Paws::Route53RecoveryControlConfig>
...
# Returns a L<Paws::Route53RecoveryControlConfig::ListRoutingControlsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/route53-recovery-control-config/ListRoutingControls>
...
This class forms part of L<Paws>, documenting arguments for method ListRoutingControls in L<Paws::Route53RecoveryControlConfig>
