...
C<GetLexicon> or C<ListLexicon> APIs.
...
Services Region. For more information, see Managing Lexicons
(https://docs.aws.amazon.com/polly/latest/dg/managing-lexicons.html).
...
two optional parameters (C<OutputS3KeyPrefix> and C<SnsTopicArn>). Once
the synthesis task is created, this operation will return a
C<SpeechSynthesisTask> object, which will include an identifier of this
task as well as the current status. The C<SpeechSynthesisTask> object
