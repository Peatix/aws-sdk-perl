...
package Paws::Forecast::WhatIfForecastSummary;
  use Moose;
...
Paws::Forecast::WhatIfForecastSummary
...
As an example, if Att1 is expected to be a Paws::Forecast::WhatIfForecastSummary object:

  $service_obj->Method(Att1 => { CreationTime => $value, ..., WhatIfForecastName => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Forecast::WhatIfForecastSummary object:
...
C<WhatIfForecastArn> that is listed in the summary.
