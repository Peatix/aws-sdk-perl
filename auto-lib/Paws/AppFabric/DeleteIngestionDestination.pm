...
package Paws::AppFabric::DeleteIngestionDestination;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'DeleteIngestionDestination');
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::AppFabric::DeleteIngestionDestinationResponse');
1;
...
Paws::AppFabric::DeleteIngestionDestination - Arguments for method DeleteIngestionDestination on L<Paws::AppFabric>

=head1 DESCRIPTION

This class represents the parameters used for calling the method DeleteIngestionDestination on the
L<AppFabric|Paws::AppFabric> service. Use the attributes of this class
as arguments to method DeleteIngestionDestination.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to DeleteIngestionDestination.

=head1 SYNOPSIS

    my $appfabric = Paws->service('AppFabric');
    my $DeleteIngestionDestinationResponse =
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/appfabric/DeleteIngestionDestination>
...
This class forms part of L<Paws>, documenting arguments for method DeleteIngestionDestination in L<Paws::AppFabric>
