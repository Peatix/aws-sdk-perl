...
package Paws::IVS::DeleteChannel;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/DeleteChannel');
...
Paws::IVS::DeleteChannel - Arguments for method DeleteChannel on L<Paws::IVS>
...
This class forms part of L<Paws>, documenting arguments for method DeleteChannel in L<Paws::IVS>
