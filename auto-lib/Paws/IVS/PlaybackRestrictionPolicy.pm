...
package Paws::IVS::PlaybackRestrictionPolicy;
  use Moose;
...
Paws::IVS::PlaybackRestrictionPolicy
...
As an example, if Att1 is expected to be a Paws::IVS::PlaybackRestrictionPolicy object:

  $service_obj->Method(Att1 => { AllowedCountries => $value, ..., Tags => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::IVS::PlaybackRestrictionPolicy object:
