...
package Paws::NetworkFlowMonitor::StartQueryWorkloadInsightsTopContributors;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'StartQueryWorkloadInsightsTopContributors');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/workloadInsights/{scopeId}/topContributorsQueries');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::NetworkFlowMonitor::StartQueryWorkloadInsightsTopContributorsOutput');
1;
...
Paws::NetworkFlowMonitor::StartQueryWorkloadInsightsTopContributors - Arguments for method StartQueryWorkloadInsightsTopContributors on L<Paws::NetworkFlowMonitor>

=head1 DESCRIPTION

This class represents the parameters used for calling the method StartQueryWorkloadInsightsTopContributors on the
L<Network Flow Monitor|Paws::NetworkFlowMonitor> service. Use the attributes of this class
as arguments to method StartQueryWorkloadInsightsTopContributors.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to StartQueryWorkloadInsightsTopContributors.

=head1 SYNOPSIS

    my $networkflowmonitor = Paws->service('NetworkFlowMonitor');
    my $StartQueryWorkloadInsightsTopContributorsOutput =
    ...
    # Results:
    my $QueryId = $StartQueryWorkloadInsightsTopContributorsOutput->QueryId;

# Returns a L<Paws::NetworkFlowMonitor::StartQueryWorkloadInsightsTopContributorsOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/networkflowmonitor/StartQueryWorkloadInsightsTopContributors>
...
This class forms part of L<Paws>, documenting arguments for method StartQueryWorkloadInsightsTopContributors in L<Paws::NetworkFlowMonitor>
