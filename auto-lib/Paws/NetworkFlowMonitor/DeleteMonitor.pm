...
package Paws::NetworkFlowMonitor::DeleteMonitor;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::NetworkFlowMonitor::DeleteMonitorOutput');
1;
...
Paws::NetworkFlowMonitor::DeleteMonitor - Arguments for method DeleteMonitor on L<Paws::NetworkFlowMonitor>
...
=head1 SYNOPSIS
    ...
    my $DeleteMonitorOutput = $networkflowmonitor->DeleteMonitor(
      MonitorName => 'MyResourceName',

    );

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/networkflowmonitor/DeleteMonitor>
...
This class forms part of L<Paws>, documenting arguments for method DeleteMonitor in L<Paws::NetworkFlowMonitor>
