...
package Paws::NetworkFlowMonitor::CreateScopeOutput;
  use Moose;
...
Paws::NetworkFlowMonitor::CreateScopeOutput
...
get metrics for. A scope ID is an internally-generated identifier that
