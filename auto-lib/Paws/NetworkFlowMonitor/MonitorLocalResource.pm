...
package Paws::NetworkFlowMonitor::MonitorLocalResource;
  use Moose;
...
Paws::NetworkFlowMonitor::MonitorLocalResource
...
As an example, if Att1 is expected to be a Paws::NetworkFlowMonitor::MonitorLocalResource object:

  $service_obj->Method(Att1 => { Identifier => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::NetworkFlowMonitor::MonitorLocalResource object:
...
The type of the local resource. Valid values are C<AWS::EC2::VPC>
C<AWS::AvailabilityZone> or C<AWS::EC2::Subnet>.
