...
package Paws::VoiceID::ListDomains;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::VoiceID::ListDomainsResponse');
...
Paws::VoiceID::ListDomains - Arguments for method ListDomains on L<Paws::VoiceID>
...
=head1 SYNOPSIS
    ...
    my $ListDomainsResponse = $voiceid->ListDomains(
      MaxResults => 1,                # OPTIONAL
      NextToken  => 'MyNextToken',    # OPTIONAL
    );

    # Results:
    my $DomainSummaries = $ListDomainsResponse->DomainSummaries;
    my $NextToken       = $ListDomainsResponse->NextToken;

    # Returns a L<Paws::VoiceID::ListDomainsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/voiceid/ListDomains>
...
This class forms part of L<Paws>, documenting arguments for method ListDomains in L<Paws::VoiceID>
