...
package Paws::VoiceID::DeleteDomain;
  use Moose;
...
Paws::VoiceID::DeleteDomain - Arguments for method DeleteDomain on L<Paws::VoiceID>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/voiceid/DeleteDomain>
...
This class forms part of L<Paws>, documenting arguments for method DeleteDomain in L<Paws::VoiceID>
