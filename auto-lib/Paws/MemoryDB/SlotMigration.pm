...
package Paws::MemoryDB::SlotMigration;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::MemoryDB::SlotMigration object:

  $service_obj->Method(Att1 => { ProgressPercentage => $value, ..., ProgressPercentage => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MemoryDB::SlotMigration object:
