...
package Paws::MemoryDB::SecurityGroupMembership;
  use Moose;
...
Paws::MemoryDB::SecurityGroupMembership
...
As an example, if Att1 is expected to be a Paws::MemoryDB::SecurityGroupMembership object:

  $service_obj->Method(Att1 => { SecurityGroupId => $value, ..., Status => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MemoryDB::SecurityGroupMembership object:
