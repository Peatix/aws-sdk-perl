...
package Paws::MemoryDB::ParameterNameValue;
  use Moose;
...
Paws::MemoryDB::ParameterNameValue
...
As an example, if Att1 is expected to be a Paws::MemoryDB::ParameterNameValue object:

  $service_obj->Method(Att1 => { ParameterName => $value, ..., ParameterValue => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MemoryDB::ParameterNameValue object:
