...
package Paws::MemoryDB::DeleteSnapshot;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::MemoryDB::DeleteSnapshotResponse');
...
Paws::MemoryDB::DeleteSnapshot - Arguments for method DeleteSnapshot on L<Paws::MemoryDB>
...
=head1 SYNOPSIS
    ...
    my $DeleteSnapshotResponse = $memory -db->DeleteSnapshot(
    ...
    # Returns a L<Paws::MemoryDB::DeleteSnapshotResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/memory-db/DeleteSnapshot>
...
This class forms part of L<Paws>, documenting arguments for method DeleteSnapshot in L<Paws::MemoryDB>
