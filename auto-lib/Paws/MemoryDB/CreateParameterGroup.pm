...
package Paws::MemoryDB::CreateParameterGroup;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::MemoryDB::CreateParameterGroupResponse');
...
Paws::MemoryDB::CreateParameterGroup - Arguments for method CreateParameterGroup on L<Paws::MemoryDB>
...
=head1 SYNOPSIS
    ...
    my $CreateParameterGroupResponse = $memory -db->CreateParameterGroup(
      Family             => 'MyString',
    ...
    # Results:
    my $ParameterGroup = $CreateParameterGroupResponse->ParameterGroup;

    # Returns a L<Paws::MemoryDB::CreateParameterGroupResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/memory-db/CreateParameterGroup>
...
This class forms part of L<Paws>, documenting arguments for method CreateParameterGroup in L<Paws::MemoryDB>
