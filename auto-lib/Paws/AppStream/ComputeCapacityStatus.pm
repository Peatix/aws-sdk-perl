...
package Paws::AppStream::ComputeCapacityStatus;
  use Moose;
  has ActiveUserSessions => (is => 'ro', isa => 'Int');
  has ActualUserSessions => (is => 'ro', isa => 'Int');
  has Available => (is => 'ro', isa => 'Int');
  has AvailableUserSessions => (is => 'ro', isa => 'Int');
  has Desired => (is => 'ro', isa => 'Int', required => 1);
  has DesiredUserSessions => (is => 'ro', isa => 'Int');
...
As an example, if Att1 is expected to be a Paws::AppStream::ComputeCapacityStatus object:
  ...
  $service_obj->Method(Att1 => { ActiveUserSessions => $value, ..., Running => $value  });
...
=head2 ActiveUserSessions => Int

The number of user sessions currently being used for streaming
sessions. This only applies to multi-session fleets.


=head2 ActualUserSessions => Int

The total number of session slots that are available for streaming or
...
=head2 AvailableUserSessions => Int
