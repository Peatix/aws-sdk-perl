...
package Paws::NeptuneGraph::GetExportTaskOutput;
  use Moose;
  ...
  has ExportTaskDetails => (is => 'ro', isa => 'Paws::NeptuneGraph::ExportTaskDetails', traits => ['NameInRequest'], request_name => 'exportTaskDetails');
...
Paws::NeptuneGraph::GetExportTaskOutput
...
=head2 ExportTaskDetails => L<Paws::NeptuneGraph::ExportTaskDetails>
