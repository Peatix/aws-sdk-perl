...
package Paws::NeptuneGraph::DeleteGraphOutput;
  use Moose;
...
Paws::NeptuneGraph::DeleteGraphOutput
...
If C<true>, deletion protection was enabled for the graph.
...
The ID of the snapshot from which the graph was created, if the graph
was recovered from a snapshot.
