...
Paws::EMR::DescribeCluster - Arguments for method DescribeCluster on L<Paws::EMR>
...
=head1 SYNOPSIS
    ...
    my $DescribeClusterOutput = $elasticmapreduce->DescribeCluster(
      ClusterId => 'MyClusterId',

    );

    # Results:
    my $Cluster = $DescribeClusterOutput->Cluster;

    # Returns a L<Paws::EMR::DescribeClusterOutput> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/elasticmapreduce/DescribeCluster>
