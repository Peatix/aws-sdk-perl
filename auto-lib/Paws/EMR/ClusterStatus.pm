...
package Paws::EMR::ClusterStatus;
  use Moose;
  has ErrorDetails => (is => 'ro', isa => 'ArrayRef[Paws::EMR::ErrorDetail]');
...
As an example, if Att1 is expected to be a Paws::EMR::ClusterStatus object:
  ...
  $service_obj->Method(Att1 => { ErrorDetails => $value, ..., Timeline => $value  });
...
=head2 ErrorDetails => ArrayRef[L<Paws::EMR::ErrorDetail>]
