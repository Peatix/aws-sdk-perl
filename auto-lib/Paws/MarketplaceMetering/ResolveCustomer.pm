...
=head1 SYNOPSIS
    ...
    # Results:
    my $CustomerAWSAccountId = $ResolveCustomerResult->CustomerAWSAccountId;
...
registration token is resolved to obtain a C<CustomerIdentifier> along
with the C<CustomerAWSAccountId> and C<ProductCode>.
