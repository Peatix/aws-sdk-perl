...
Metadata assigned to an allocation. Each tag is made up of a C<key> and
a C<value>.
...
One part of a key-value pair that makes up a C<tag>. A C<key> is a
label that acts like a category for the specific tag values.


=head2 B<REQUIRED> Value => Str

One part of a key-value pair that makes up a C<tag>. A C<value> acts as
a descriptor within a tag category (key). The value can be empty or
null.
