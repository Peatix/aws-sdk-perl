...
package Paws::PinpointSMSVoiceV2::SnsDestination;
  use Moose;
...
Paws::PinpointSMSVoiceV2::SnsDestination
...
As an example, if Att1 is expected to be a Paws::PinpointSMSVoiceV2::SnsDestination object:

  $service_obj->Method(Att1 => { TopicArn => $value, ..., TopicArn => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::PinpointSMSVoiceV2::SnsDestination object:
