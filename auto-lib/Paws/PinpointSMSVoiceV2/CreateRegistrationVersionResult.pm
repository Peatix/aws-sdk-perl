...
package Paws::PinpointSMSVoiceV2::CreateRegistrationVersionResult;
  use Moose;
...
Paws::PinpointSMSVoiceV2::CreateRegistrationVersionResult
...
A B<RegistrationVersionStatusHistory> object that contains timestamps
