...
package Paws::BedrockAgent::GetFlowVersionResponse;
  use Moose;
...
Paws::BedrockAgent::GetFlowVersionResponse
...
The Amazon Resource Name (ARN) of the KMS key that the version of the
flow is encrypted with.
