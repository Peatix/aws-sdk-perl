...
package Paws::BedrockAgent::CreateDataSource;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/knowledgebases/{knowledgeBaseId}/datasources/');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'PUT');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::BedrockAgent::CreateDataSourceResponse');
1;
...
Paws::BedrockAgent::CreateDataSource - Arguments for method CreateDataSource on L<Paws::BedrockAgent>
...
=head1 SYNOPSIS
    ...
    my $CreateDataSourceResponse = $bedrock -agent->CreateDataSource(
    ...
    # Returns a L<Paws::BedrockAgent::CreateDataSourceResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/bedrock-agent/CreateDataSource>
...
DELETE: Deletes all data from your data source thatE<rsquo>s converted
into vector embeddings upon deletion of a knowledge base or data source
resource. Note that the B<vector store itself is not deleted>, only the
data. This flag is ignored if an Amazon Web Services account is
deleted.

=item *

RETAIN: Retains all data from your data source thatE<rsquo>s converted
into vector embeddings upon deletion of a knowledge base or data source
resource. Note that the B<vector store itself is not deleted> if you
...
This class forms part of L<Paws>, documenting arguments for method CreateDataSource in L<Paws::BedrockAgent>
