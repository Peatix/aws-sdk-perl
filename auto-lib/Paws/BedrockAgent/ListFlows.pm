...
package Paws::BedrockAgent::ListFlows;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::BedrockAgent::ListFlowsResponse');
1;
...
Paws::BedrockAgent::ListFlows - Arguments for method ListFlows on L<Paws::BedrockAgent>
...
=head1 SYNOPSIS
    ...
    my $ListFlowsResponse = $bedrock -agent->ListFlows(
      MaxResults => 1,                # OPTIONAL
      NextToken  => 'MyNextToken',    # OPTIONAL
    );

    # Results:
    my $FlowSummaries = $ListFlowsResponse->FlowSummaries;
    my $NextToken     = $ListFlowsResponse->NextToken;

    # Returns a L<Paws::BedrockAgent::ListFlowsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/bedrock-agent/ListFlows>
...
This class forms part of L<Paws>, documenting arguments for method ListFlows in L<Paws::BedrockAgent>
