...
package Paws::BedrockAgent::UpdateFlow;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::BedrockAgent::UpdateFlowResponse');
1;
...
Paws::BedrockAgent::UpdateFlow - Arguments for method UpdateFlow on L<Paws::BedrockAgent>
...
=head1 SYNOPSIS
    ...
    my $UpdateFlowResponse = $bedrock -agent->UpdateFlow(
    ...
    # Results:
    my $Arn       = $UpdateFlowResponse->Arn;
    my $CreatedAt = $UpdateFlowResponse->CreatedAt;
    my $CustomerEncryptionKeyArn =
      $UpdateFlowResponse->CustomerEncryptionKeyArn;
    my $Definition       = $UpdateFlowResponse->Definition;
    my $Description      = $UpdateFlowResponse->Description;
    my $ExecutionRoleArn = $UpdateFlowResponse->ExecutionRoleArn;
    my $Id               = $UpdateFlowResponse->Id;
    my $Name             = $UpdateFlowResponse->Name;
    my $Status           = $UpdateFlowResponse->Status;
    my $UpdatedAt        = $UpdateFlowResponse->UpdatedAt;
    my $Version          = $UpdateFlowResponse->Version;

    # Returns a L<Paws::BedrockAgent::UpdateFlowResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/bedrock-agent/UpdateFlow>
...
This class forms part of L<Paws>, documenting arguments for method UpdateFlow in L<Paws::BedrockAgent>
