...
package Paws::BedrockAgent::CreatePromptVersionResponse;
  use Moose;
...
Paws::BedrockAgent::CreatePromptVersionResponse
...
The Amazon Resource Name (ARN) of the KMS key to encrypt the version of
the prompt.
