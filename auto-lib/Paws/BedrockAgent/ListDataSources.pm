...
package Paws::BedrockAgent::ListDataSources;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::BedrockAgent::ListDataSourcesResponse');
1;
...
Paws::BedrockAgent::ListDataSources - Arguments for method ListDataSources on L<Paws::BedrockAgent>
...
=head1 SYNOPSIS
    ...
    my $ListDataSourcesResponse = $bedrock -agent->ListDataSources(
    ...
    # Results:
    my $DataSourceSummaries = $ListDataSourcesResponse->DataSourceSummaries;
    my $NextToken           = $ListDataSourcesResponse->NextToken;

    # Returns a L<Paws::BedrockAgent::ListDataSourcesResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/bedrock-agent/ListDataSources>
...
This class forms part of L<Paws>, documenting arguments for method ListDataSources in L<Paws::BedrockAgent>
