...
package Paws::BedrockAgent::ListAgents;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::BedrockAgent::ListAgentsResponse');
1;
...
Paws::BedrockAgent::ListAgents - Arguments for method ListAgents on L<Paws::BedrockAgent>
...
=head1 SYNOPSIS
    ...
    my $ListAgentsResponse = $bedrock -agent->ListAgents(
      MaxResults => 1,                # OPTIONAL
      NextToken  => 'MyNextToken',    # OPTIONAL
    );

    # Results:
    my $AgentSummaries = $ListAgentsResponse->AgentSummaries;
    my $NextToken      = $ListAgentsResponse->NextToken;

    # Returns a L<Paws::BedrockAgent::ListAgentsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/bedrock-agent/ListAgents>
...
This class forms part of L<Paws>, documenting arguments for method ListAgents in L<Paws::BedrockAgent>
