...
package Paws::BedrockAgent::AgentVersionSummary;
  use Moose;
...
Paws::BedrockAgent::AgentVersionSummary
...
As an example, if Att1 is expected to be a Paws::BedrockAgent::AgentVersionSummary object:

  $service_obj->Method(Att1 => { AgentName => $value, ..., UpdatedAt => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::BedrockAgent::AgentVersionSummary object:

  $result = $service_obj->Method(...);
  $result->Att1->AgentName
