...
package Paws::BedrockAgent::GetDataSource;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::BedrockAgent::GetDataSourceResponse');
1;
...
Paws::BedrockAgent::GetDataSource - Arguments for method GetDataSource on L<Paws::BedrockAgent>
...
=head1 SYNOPSIS
    ...
    my $GetDataSourceResponse = $bedrock -agent->GetDataSource(
      DataSourceId    => 'MyId',
    ...
    # Returns a L<Paws::BedrockAgent::GetDataSourceResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/bedrock-agent/GetDataSource>
...
This class forms part of L<Paws>, documenting arguments for method GetDataSource in L<Paws::BedrockAgent>
