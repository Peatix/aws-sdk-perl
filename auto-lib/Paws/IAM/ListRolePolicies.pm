...
Paws::IAM::ListRolePolicies - Arguments for method ListRolePolicies on L<Paws::IAM>
...
This class forms part of L<Paws>, documenting arguments for method ListRolePolicies in L<Paws::IAM>
