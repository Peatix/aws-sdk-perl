...
Paws::IAM::DeletePolicy - Arguments for method DeletePolicy on L<Paws::IAM>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/iam/DeletePolicy>
...
This class forms part of L<Paws>, documenting arguments for method DeletePolicy in L<Paws::IAM>
