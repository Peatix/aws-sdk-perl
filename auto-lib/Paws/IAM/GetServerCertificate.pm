...
Paws::IAM::GetServerCertificate - Arguments for method GetServerCertificate on L<Paws::IAM>
...
You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to GetServerCertificate.

=head1 SYNOPSIS

    my $iam = Paws->service('IAM');
    my $GetServerCertificateResponse = $iam->GetServerCertificate(
      ServerCertificateName => 'MyserverCertificateNameType',

    );

    # Results:
    my $ServerCertificate = $GetServerCertificateResponse->ServerCertificate;

    # Returns a L<Paws::IAM::GetServerCertificateResponse> object.
