...
package Paws::IAM::DetachRolePolicy;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'DetachRolePolicy');
...
Paws::IAM::DetachRolePolicy - Arguments for method DetachRolePolicy on L<Paws::IAM>
...
This class forms part of L<Paws>, documenting arguments for method DetachRolePolicy in L<Paws::IAM>
