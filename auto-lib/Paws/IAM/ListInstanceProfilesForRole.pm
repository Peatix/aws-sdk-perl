...
This class represents the parameters used for calling the method ListInstanceProfilesForRole on the
L<AWS Identity and Access Management|Paws::IAM> service. Use the attributes of this class
as arguments to method ListInstanceProfilesForRole.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to ListInstanceProfilesForRole.

=head1 SYNOPSIS

    my $iam = Paws->service('IAM');
    my $ListInstanceProfilesForRoleResponse = $iam->ListInstanceProfilesForRole(
...
This class forms part of L<Paws>, documenting arguments for method ListInstanceProfilesForRole in L<Paws::IAM>
