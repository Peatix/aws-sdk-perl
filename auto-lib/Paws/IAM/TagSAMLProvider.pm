...
package Paws::IAM::TagSAMLProvider;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'TagSAMLProvider');
...
Paws::IAM::TagSAMLProvider - Arguments for method TagSAMLProvider on L<Paws::IAM>

=head1 DESCRIPTION

This class represents the parameters used for calling the method TagSAMLProvider on the
L<AWS Identity and Access Management|Paws::IAM> service. Use the attributes of this class
as arguments to method TagSAMLProvider.
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/iam/TagSAMLProvider>
...
This class forms part of L<Paws>, documenting arguments for method TagSAMLProvider in L<Paws::IAM>
