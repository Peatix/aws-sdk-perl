...
package Paws::IAM::ListOpenIDConnectProviderTags;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'ListOpenIDConnectProviderTags');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::IAM::ListOpenIDConnectProviderTagsResponse');
  class_has _result_key => (isa => 'Str', is => 'ro', default => 'ListOpenIDConnectProviderTagsResult');
1;
...
Paws::IAM::ListOpenIDConnectProviderTags - Arguments for method ListOpenIDConnectProviderTags on L<Paws::IAM>

=head1 DESCRIPTION

This class represents the parameters used for calling the method ListOpenIDConnectProviderTags on the
L<AWS Identity and Access Management|Paws::IAM> service. Use the attributes of this class
as arguments to method ListOpenIDConnectProviderTags.
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/iam/ListOpenIDConnectProviderTags>
...
This class forms part of L<Paws>, documenting arguments for method ListOpenIDConnectProviderTags in L<Paws::IAM>
