...
Paws::IAM::ListOpenIDConnectProviders - Arguments for method ListOpenIDConnectProviders on L<Paws::IAM>
...
You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to ListOpenIDConnectProviders.

=head1 SYNOPSIS

    my $iam = Paws->service('IAM');
    my $ListOpenIDConnectProvidersResponse = $iam->ListOpenIDConnectProviders();

    # Results:
    my $OpenIDConnectProviderList =
      $ListOpenIDConnectProvidersResponse->OpenIDConnectProviderList;

    # Returns a L<Paws::IAM::ListOpenIDConnectProvidersResponse> object.
