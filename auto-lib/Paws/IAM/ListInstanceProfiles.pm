...
Paws::IAM::ListInstanceProfiles - Arguments for method ListInstanceProfiles on L<Paws::IAM>
...
=head1 SYNOPSIS
    ...
    my $ListInstanceProfilesResponse = $iam->ListInstanceProfiles(
...
can contain any ASCII character from the ! (C<\u0021>) through the DEL
character (C<\u007F>), including most punctuation characters, digits,
