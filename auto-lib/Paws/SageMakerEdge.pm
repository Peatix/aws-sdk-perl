package Paws::SageMakerEdge;
  ...
  sub GetDeployments {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::SageMakerEdge::GetDeployments', @_);
  ...
  sub operations { qw/GetDeployments GetDeviceRegistration SendHeartbeat / }
...
Each argument is described in detail in: L<Paws::SageMakerEdge::GetDeployments>

Returns: a L<Paws::SageMakerEdge::GetDeploymentsResult> instance
...
=item [DeploymentResult => L<Paws::SageMakerEdge::DeploymentResult>]
