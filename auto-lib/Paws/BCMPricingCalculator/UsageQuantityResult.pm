...
package Paws::BCMPricingCalculator::UsageQuantityResult;
  use Moose;
...
Paws::BCMPricingCalculator::UsageQuantityResult
...
As an example, if Att1 is expected to be a Paws::BCMPricingCalculator::UsageQuantityResult object:

  $service_obj->Method(Att1 => { Amount => $value, ..., Unit => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::BCMPricingCalculator::UsageQuantityResult object:
