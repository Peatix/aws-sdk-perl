...
package Paws::BCMPricingCalculator::BillScenarioUsageModificationItem;
  use Moose;
...
Paws::BCMPricingCalculator::BillScenarioUsageModificationItem
...
As an example, if Att1 is expected to be a Paws::BCMPricingCalculator::BillScenarioUsageModificationItem object:

  $service_obj->Method(Att1 => { AvailabilityZone => $value, ..., UsageType => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::BCMPricingCalculator::BillScenarioUsageModificationItem object:
