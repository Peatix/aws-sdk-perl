...
package Paws::BCMPricingCalculator::ExpressionFilter;
  use Moose;
  has Key => (is => 'ro', isa => 'Str', request_name => 'key', traits => ['NameInRequest']);
  has MatchOptions => (is => 'ro', isa => 'ArrayRef[Str|Undef]', request_name => 'matchOptions', traits => ['NameInRequest']);
...
Paws::BCMPricingCalculator::ExpressionFilter
...
As an example, if Att1 is expected to be a Paws::BCMPricingCalculator::ExpressionFilter object:

  $service_obj->Method(Att1 => { Key => $value, ..., Values => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::BCMPricingCalculator::ExpressionFilter object:
