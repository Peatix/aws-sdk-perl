...
package Paws::BCMPricingCalculator::UsageQuantity;
  use Moose;
  has Amount => (is => 'ro', isa => 'Num', request_name => 'amount', traits => ['NameInRequest']);
  has StartHour => (is => 'ro', isa => 'Str', request_name => 'startHour', traits => ['NameInRequest']);
...
Paws::BCMPricingCalculator::UsageQuantity
...
As an example, if Att1 is expected to be a Paws::BCMPricingCalculator::UsageQuantity object:

  $service_obj->Method(Att1 => { Amount => $value, ..., Unit => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::BCMPricingCalculator::UsageQuantity object:
