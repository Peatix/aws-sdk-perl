...
package Paws::BCMPricingCalculator::BillScenarioSummary;
  use Moose;
...
Paws::BCMPricingCalculator::BillScenarioSummary
...
As an example, if Att1 is expected to be a Paws::BCMPricingCalculator::BillScenarioSummary object:

  $service_obj->Method(Att1 => { BillInterval => $value, ..., Status => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::BCMPricingCalculator::BillScenarioSummary object:
