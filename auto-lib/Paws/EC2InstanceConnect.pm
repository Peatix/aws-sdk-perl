...
This is the I< Amazon EC2 Instance Connect API Reference>. It provides
...
administrators to publish one-time use SSH public keys to EC2,
providing users a simple and secure way to connect to their instances.

To view the Amazon EC2 Instance Connect content in the I< Amazon EC2
User Guide>, see Connect to your Linux instance using EC2 Instance
Connect
