...
package Paws::ChimeSDKMediaPipelines::GetVoiceToneAnalysisTask;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/media-insights-pipelines/{identifier}/voice-tone-analysis-tasks/{voiceToneAnalysisTaskId}');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'GET');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ChimeSDKMediaPipelines::GetVoiceToneAnalysisTaskResponse');
1;
...
Paws::ChimeSDKMediaPipelines::GetVoiceToneAnalysisTask - Arguments for method GetVoiceToneAnalysisTask on L<Paws::ChimeSDKMediaPipelines>
...
=head1 SYNOPSIS
    ...
    my $GetVoiceToneAnalysisTaskResponse =
      $media -pipelines-chime->GetVoiceToneAnalysisTask(
...
# Returns a L<Paws::ChimeSDKMediaPipelines::GetVoiceToneAnalysisTaskResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/media-pipelines-chime/GetVoiceToneAnalysisTask>
...
This class forms part of L<Paws>, documenting arguments for method GetVoiceToneAnalysisTask in L<Paws::ChimeSDKMediaPipelines>
