...
package Paws::ChimeSDKMediaPipelines::CreateMediaInsightsPipelineConfiguration;
  use Moose;
  has ClientRequestToken => (is => 'ro', isa => 'Str');
  has Elements => (is => 'ro', isa => 'ArrayRef[Paws::ChimeSDKMediaPipelines::MediaInsightsPipelineConfigurationElement]', required => 1);
  has MediaInsightsPipelineConfigurationName => (is => 'ro', isa => 'Str', required => 1);
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'CreateMediaInsightsPipelineConfiguration');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/media-insights-pipeline-configurations');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ChimeSDKMediaPipelines::CreateMediaInsightsPipelineConfigurationResponse');
1;
...
Paws::ChimeSDKMediaPipelines::CreateMediaInsightsPipelineConfiguration - Arguments for method CreateMediaInsightsPipelineConfiguration on L<Paws::ChimeSDKMediaPipelines>

=head1 DESCRIPTION

This class represents the parameters used for calling the method CreateMediaInsightsPipelineConfiguration on the
L<Amazon Chime SDK Media Pipelines|Paws::ChimeSDKMediaPipelines> service. Use the attributes of this class
as arguments to method CreateMediaInsightsPipelineConfiguration.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to CreateMediaInsightsPipelineConfiguration.

=head1 SYNOPSIS

    my $media-pipelines-chime = Paws->service('ChimeSDKMediaPipelines');
    my $CreateMediaInsightsPipelineConfigurationResponse =
      $media -pipelines-chime->CreateMediaInsightsPipelineConfiguration(
      Elements => [
        {
      ...
      MediaInsightsPipelineConfigurationName =>
        'MyMediaInsightsPipelineConfigurationNameString',
...
# Returns a L<Paws::ChimeSDKMediaPipelines::CreateMediaInsightsPipelineConfigurationResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/media-pipelines-chime/CreateMediaInsightsPipelineConfiguration>
...
=head2 B<REQUIRED> MediaInsightsPipelineConfigurationName => Str
...
resources, including C<Transcribe> and C<Transcribe Call Analytics>, on
the callerE<rsquo>s behalf.
...
This class forms part of L<Paws>, documenting arguments for method CreateMediaInsightsPipelineConfiguration in L<Paws::ChimeSDKMediaPipelines>
