...
package Paws::ChimeSDKMediaPipelines::TimestampRange;
  use Moose;
...
Paws::ChimeSDKMediaPipelines::TimestampRange
...
As an example, if Att1 is expected to be a Paws::ChimeSDKMediaPipelines::TimestampRange object:

  $service_obj->Method(Att1 => { EndTimestamp => $value, ..., StartTimestamp => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ChimeSDKMediaPipelines::TimestampRange object:
