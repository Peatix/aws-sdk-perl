...
package Paws::Drs::DataReplicationInfoReplicatedDisk;
  use Moose;
  ...
  has VolumeStatus => (is => 'ro', isa => 'Str', request_name => 'volumeStatus', traits => ['NameInRequest']);
...
Paws::Drs::DataReplicationInfoReplicatedDisk
...
As an example, if Att1 is expected to be a Paws::Drs::DataReplicationInfoReplicatedDisk object:

  $service_obj->Method(Att1 => { BackloggedStorageBytes => $value, ..., VolumeStatus => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Drs::DataReplicationInfoReplicatedDisk object:
