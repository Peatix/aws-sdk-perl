...
package Paws::Drs::IdentificationHints;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::Drs::IdentificationHints object:

  $service_obj->Method(Att1 => { AwsInstanceID => $value, ..., VmWareUuid => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Drs::IdentificationHints object:
