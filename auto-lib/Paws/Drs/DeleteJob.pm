...
package Paws::Drs::DeleteJob;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/DeleteJob');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Drs::DeleteJobResponse');
1;
...
Paws::Drs::DeleteJob - Arguments for method DeleteJob on L<Paws::Drs>
...
=head1 SYNOPSIS
    ...
    my $DeleteJobResponse = $drs->DeleteJob(
      JobID => 'MyJobID',

    );

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/drs/DeleteJob>
...
This class forms part of L<Paws>, documenting arguments for method DeleteJob in L<Paws::Drs>
