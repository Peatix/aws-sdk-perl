...
package Paws::Drs::DeleteSourceServer;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Drs::DeleteSourceServerResponse');
1;
...
Paws::Drs::DeleteSourceServer - Arguments for method DeleteSourceServer on L<Paws::Drs>
...
=head1 SYNOPSIS
    ...
    my $DeleteSourceServerResponse = $drs->DeleteSourceServer(
      SourceServerID => 'MySourceServerID',

    );

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/drs/DeleteSourceServer>
...
This class forms part of L<Paws>, documenting arguments for method DeleteSourceServer in L<Paws::Drs>
