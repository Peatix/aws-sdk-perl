...
package Paws::Macie2::DisassociateFromAdministratorAccount;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Macie2::DisassociateFromAdministratorAccountResponse');
1;
...
Paws::Macie2::DisassociateFromAdministratorAccount - Arguments for method DisassociateFromAdministratorAccount on L<Paws::Macie2>
...
This class forms part of L<Paws>, documenting arguments for method DisassociateFromAdministratorAccount in L<Paws::Macie2>
