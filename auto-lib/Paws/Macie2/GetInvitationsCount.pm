...
package Paws::Macie2::GetInvitationsCount;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Macie2::GetInvitationsCountResponse');
1;
...
Paws::Macie2::GetInvitationsCount - Arguments for method GetInvitationsCount on L<Paws::Macie2>
...
=head1 SYNOPSIS
    ...
    my $GetInvitationsCountResponse = $macie2->GetInvitationsCount();

    # Results:
    my $InvitationsCount = $GetInvitationsCountResponse->InvitationsCount;

    # Returns a L<Paws::Macie2::GetInvitationsCountResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method GetInvitationsCount in L<Paws::Macie2>
