...
package Paws::Macie2::ListMembers;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Macie2::ListMembersResponse');
1;
...
Paws::Macie2::ListMembers - Arguments for method ListMembers on L<Paws::Macie2>
...
=head1 SYNOPSIS
    ...
    my $ListMembersResponse = $macie2->ListMembers(
    ...
    # Returns a L<Paws::Macie2::ListMembersResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method ListMembers in L<Paws::Macie2>
