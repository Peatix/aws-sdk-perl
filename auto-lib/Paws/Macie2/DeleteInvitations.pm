...
package Paws::Macie2::DeleteInvitations;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Macie2::DeleteInvitationsResponse');
1;
...
Paws::Macie2::DeleteInvitations - Arguments for method DeleteInvitations on L<Paws::Macie2>
...
=head1 SYNOPSIS
    ...
    my $DeleteInvitationsResponse = $macie2->DeleteInvitations(
    ...
    # Returns a L<Paws::Macie2::DeleteInvitationsResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method DeleteInvitations in L<Paws::Macie2>
