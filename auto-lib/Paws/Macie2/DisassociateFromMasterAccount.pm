...
package Paws::Macie2::DisassociateFromMasterAccount;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Macie2::DisassociateFromMasterAccountResponse');
1;
...
Paws::Macie2::DisassociateFromMasterAccount - Arguments for method DisassociateFromMasterAccount on L<Paws::Macie2>
...
This class forms part of L<Paws>, documenting arguments for method DisassociateFromMasterAccount in L<Paws::Macie2>
