...
package Paws::Macie2::DescribeOrganizationConfiguration;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Macie2::DescribeOrganizationConfigurationResponse');
1;
...
Paws::Macie2::DescribeOrganizationConfiguration - Arguments for method DescribeOrganizationConfiguration on L<Paws::Macie2>
...
=head1 SYNOPSIS
  ...
  # Returns a L<Paws::Macie2::DescribeOrganizationConfigurationResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method DescribeOrganizationConfiguration in L<Paws::Macie2>
