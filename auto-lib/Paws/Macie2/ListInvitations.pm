...
package Paws::Macie2::ListInvitations;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Macie2::ListInvitationsResponse');
1;
...
Paws::Macie2::ListInvitations - Arguments for method ListInvitations on L<Paws::Macie2>
...
=head1 SYNOPSIS
    ...
    my $ListInvitationsResponse = $macie2->ListInvitations(
    ...
    # Returns a L<Paws::Macie2::ListInvitationsResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method ListInvitations in L<Paws::Macie2>
