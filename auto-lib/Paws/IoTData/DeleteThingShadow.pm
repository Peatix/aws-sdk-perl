...
=head1 SYNOPSIS
    ...
    my $DeleteThingShadowResponse = $data -ats . iot->DeleteThingShadow(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/data-ats.iot/DeleteThingShadow>
