...
package Paws::Comprehend::DeleteResourcePolicy;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Comprehend::DeleteResourcePolicyResponse');
...
Paws::Comprehend::DeleteResourcePolicy - Arguments for method DeleteResourcePolicy on L<Paws::Comprehend>
...
=head1 SYNOPSIS
    ...
    my $DeleteResourcePolicyResponse = $comprehend->DeleteResourcePolicy(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/comprehend/DeleteResourcePolicy>
...
This class forms part of L<Paws>, documenting arguments for method DeleteResourcePolicy in L<Paws::Comprehend>
