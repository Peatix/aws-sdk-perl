...
package Paws::Comprehend::EventsDetectionJobProperties;
  use Moose;
  ...
  has TargetEventTypes => (is => 'ro', isa => 'ArrayRef[Str|Undef]');
...
Paws::Comprehend::EventsDetectionJobProperties
...
As an example, if Att1 is expected to be a Paws::Comprehend::EventsDetectionJobProperties object:

  $service_obj->Method(Att1 => { DataAccessRoleArn => $value, ..., TargetEventTypes => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Comprehend::EventsDetectionJobProperties object:
...
=head2 TargetEventTypes => ArrayRef[Str|Undef]
