...
package Paws::Comprehend::StartDominantLanguageDetectionJobResponse;
  use Moose;
...
Paws::Comprehend::StartDominantLanguageDetectionJobResponse
...
C<arn:E<lt>partitionE<gt>:comprehend:E<lt>regionE<gt>:E<lt>account-idE<gt>:dominant-language-detection-job/E<lt>job-idE<gt>>

The following is an example job ARN:

C<arn:aws:comprehend:us-west-2:111122223333:dominant-language-detection-job/1234abcd12ab34cd56ef1234567890ab>
