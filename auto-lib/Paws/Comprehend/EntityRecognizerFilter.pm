...
As an example, if Att1 is expected to be a Paws::Comprehend::EntityRecognizerFilter object:
  ...
  $service_obj->Method(Att1 => { RecognizerName => $value, ..., SubmitTimeBefore => $value  });
...
information, see the C<ListEntityRecognizers> operation./E<gt>
