...
package Paws::Comprehend::DeleteEndpoint;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Comprehend::DeleteEndpointResponse');
...
Paws::Comprehend::DeleteEndpoint - Arguments for method DeleteEndpoint on L<Paws::Comprehend>
...
=head1 SYNOPSIS
    ...
    my $DeleteEndpointResponse = $comprehend->DeleteEndpoint(
...
This class forms part of L<Paws>, documenting arguments for method DeleteEndpoint in L<Paws::Comprehend>
