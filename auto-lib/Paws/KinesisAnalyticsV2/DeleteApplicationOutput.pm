...
package Paws::KinesisAnalyticsV2::DeleteApplicationOutput;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::KinesisAnalyticsV2::DeleteApplicationOutputResponse');
...
Paws::KinesisAnalyticsV2::DeleteApplicationOutput - Arguments for method DeleteApplicationOutput on L<Paws::KinesisAnalyticsV2>
...
=head1 SYNOPSIS
    ...
    # Results:
    my $ApplicationARN = $DeleteApplicationOutputResponse->ApplicationARN;
    my $ApplicationVersionId =
      $DeleteApplicationOutputResponse->ApplicationVersionId;

# Returns a L<Paws::KinesisAnalyticsV2::DeleteApplicationOutputResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method DeleteApplicationOutput in L<Paws::KinesisAnalyticsV2>
