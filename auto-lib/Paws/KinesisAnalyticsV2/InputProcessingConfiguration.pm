...
Paws::KinesisAnalyticsV2::InputProcessingConfiguration
...
As an example, if Att1 is expected to be a Paws::KinesisAnalyticsV2::InputProcessingConfiguration object:

  $service_obj->Method(Att1 => { InputLambdaProcessor => $value, ..., InputLambdaProcessor => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::KinesisAnalyticsV2::InputProcessingConfiguration object:
