...
package Paws::KinesisAnalyticsV2::DeleteApplication;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::KinesisAnalyticsV2::DeleteApplicationResponse');
...
Paws::KinesisAnalyticsV2::DeleteApplication - Arguments for method DeleteApplication on L<Paws::KinesisAnalyticsV2>
...
Use the C<DescribeApplication> operation to get this value.
...
This class forms part of L<Paws>, documenting arguments for method DeleteApplication in L<Paws::KinesisAnalyticsV2>
