...
package Paws::KinesisAnalyticsV2::LambdaOutput;
  use Moose;
...
Paws::KinesisAnalyticsV2::LambdaOutput
...
As an example, if Att1 is expected to be a Paws::KinesisAnalyticsV2::LambdaOutput object:

  $service_obj->Method(Att1 => { ResourceARN => $value, ..., ResourceARN => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::KinesisAnalyticsV2::LambdaOutput object:
