...
package Paws::WorkSpaces::IosImportClientBrandingAttributes;
  use Moose;
  has ForgotPasswordLink => (is => 'ro', isa => 'Str');
  has LoginMessage => (is => 'ro', isa => 'Paws::WorkSpaces::LoginMessage');
  has Logo => (is => 'ro', isa => 'Str');
  has Logo2x => (is => 'ro', isa => 'Str');
  has Logo3x => (is => 'ro', isa => 'Str');
...
Paws::WorkSpaces::IosImportClientBrandingAttributes
...
As an example, if Att1 is expected to be a Paws::WorkSpaces::IosImportClientBrandingAttributes object:

  $service_obj->Method(Att1 => { ForgotPasswordLink => $value, ..., SupportLink => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::WorkSpaces::IosImportClientBrandingAttributes object:
