...
package Paws::WorkSpaces::CertificateBasedAuthProperties;
  use Moose;
...
Paws::WorkSpaces::CertificateBasedAuthProperties
...
As an example, if Att1 is expected to be a Paws::WorkSpaces::CertificateBasedAuthProperties object:

  $service_obj->Method(Att1 => { CertificateAuthorityArn => $value, ..., Status => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::WorkSpaces::CertificateBasedAuthProperties object:
