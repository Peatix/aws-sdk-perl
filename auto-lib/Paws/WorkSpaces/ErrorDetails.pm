...
package Paws::WorkSpaces::ErrorDetails;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::WorkSpaces::ErrorDetails object:

  $service_obj->Method(Att1 => { ErrorCode => $value, ..., ErrorMessage => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::WorkSpaces::ErrorDetails object:
