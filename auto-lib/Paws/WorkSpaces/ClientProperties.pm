...
package Paws::WorkSpaces::ClientProperties;
  use Moose;
  has LogUploadEnabled => (is => 'ro', isa => 'Str');
  has ReconnectEnabled => (is => 'ro', isa => 'Str');
...
Paws::WorkSpaces::ClientProperties
...
As an example, if Att1 is expected to be a Paws::WorkSpaces::ClientProperties object:

  $service_obj->Method(Att1 => { LogUploadEnabled => $value, ..., ReconnectEnabled => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::WorkSpaces::ClientProperties object:

  $result = $service_obj->Method(...);
  $result->Att1->LogUploadEnabled
