...
package Paws::WorkSpaces::NetworkAccessConfiguration;
  use Moose;
...
Paws::WorkSpaces::NetworkAccessConfiguration
...
As an example, if Att1 is expected to be a Paws::WorkSpaces::NetworkAccessConfiguration object:

  $service_obj->Method(Att1 => { EniId => $value, ..., EniPrivateIpAddress => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::WorkSpaces::NetworkAccessConfiguration object:
