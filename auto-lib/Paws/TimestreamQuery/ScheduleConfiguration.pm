...
package Paws::TimestreamQuery::ScheduleConfiguration;
  use Moose;
...
Paws::TimestreamQuery::ScheduleConfiguration
...
As an example, if Att1 is expected to be a Paws::TimestreamQuery::ScheduleConfiguration object:

  $service_obj->Method(Att1 => { ScheduleExpression => $value, ..., ScheduleExpression => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::TimestreamQuery::ScheduleConfiguration object:
