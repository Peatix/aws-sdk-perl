...
package Paws::BedrockAgentRuntime::ListSessions;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::BedrockAgentRuntime::ListSessionsResponse');
1;
...
Paws::BedrockAgentRuntime::ListSessions - Arguments for method ListSessions on L<Paws::BedrockAgentRuntime>
...
=head1 SYNOPSIS
    ...
    my $ListSessionsResponse = $bedrock -agent-runtime->ListSessions(
    ...
    my $SessionSummaries = $ListSessionsResponse->SessionSummaries;

    # Returns a L<Paws::BedrockAgentRuntime::ListSessionsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/bedrock-agent-runtime/ListSessions>
...
This class forms part of L<Paws>, documenting arguments for method ListSessions in L<Paws::BedrockAgentRuntime>
