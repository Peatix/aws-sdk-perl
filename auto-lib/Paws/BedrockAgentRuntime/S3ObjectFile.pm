...
package Paws::BedrockAgentRuntime::S3ObjectFile;
  use Moose;
...
Paws::BedrockAgentRuntime::S3ObjectFile
...
As an example, if Att1 is expected to be a Paws::BedrockAgentRuntime::S3ObjectFile object:

  $service_obj->Method(Att1 => { Uri => $value, ..., Uri => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::BedrockAgentRuntime::S3ObjectFile object:
