...
package Paws::BedrockAgentRuntime::PostProcessingModelInvocationOutput;
  use Moose;
  has Metadata => (is => 'ro', isa => 'Paws::BedrockAgentRuntime::Metadata', request_name => 'metadata', traits => ['NameInRequest']);
  has ParsedResponse => (is => 'ro', isa => 'Paws::BedrockAgentRuntime::PostProcessingParsedResponse', request_name => 'parsedResponse', traits => ['NameInRequest']);
...
Paws::BedrockAgentRuntime::PostProcessingModelInvocationOutput
...
As an example, if Att1 is expected to be a Paws::BedrockAgentRuntime::PostProcessingModelInvocationOutput object:

  $service_obj->Method(Att1 => { Metadata => $value, ..., TraceId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::BedrockAgentRuntime::PostProcessingModelInvocationOutput object:
...
=head2 ParsedResponse => L<Paws::BedrockAgentRuntime::PostProcessingParsedResponse>
