...
package Paws::BedrockAgentRuntime::RetrieveAndGenerate;
  use Moose;
  ...
  class_has _api_call => (isa => 'Str', is => 'ro', default => 'RetrieveAndGenerate');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/retrieveAndGenerate');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::BedrockAgentRuntime::RetrieveAndGenerateResponse');
1;
...
Paws::BedrockAgentRuntime::RetrieveAndGenerate - Arguments for method RetrieveAndGenerate on L<Paws::BedrockAgentRuntime>

=head1 DESCRIPTION

This class represents the parameters used for calling the method RetrieveAndGenerate on the
L<Agents for Amazon Bedrock Runtime|Paws::BedrockAgentRuntime> service. Use the attributes of this class
as arguments to method RetrieveAndGenerate.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to RetrieveAndGenerate.

=head1 SYNOPSIS

    my $bedrock-agent-runtime = Paws->service('BedrockAgentRuntime');
    my $RetrieveAndGenerateResponse =
    ...
    # Results:
    my $Citations       = $RetrieveAndGenerateResponse->Citations;
    my $GuardrailAction = $RetrieveAndGenerateResponse->GuardrailAction;
    my $Output          = $RetrieveAndGenerateResponse->Output;
    my $SessionId       = $RetrieveAndGenerateResponse->SessionId;

   # Returns a L<Paws::BedrockAgentRuntime::RetrieveAndGenerateResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/bedrock-agent-runtime/RetrieveAndGenerate>
...
This class forms part of L<Paws>, documenting arguments for method RetrieveAndGenerate in L<Paws::BedrockAgentRuntime>
