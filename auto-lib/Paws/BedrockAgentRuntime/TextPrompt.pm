...
package Paws::BedrockAgentRuntime::TextPrompt;
  use Moose;
...
Paws::BedrockAgentRuntime::TextPrompt
...
As an example, if Att1 is expected to be a Paws::BedrockAgentRuntime::TextPrompt object:

  $service_obj->Method(Att1 => { Text => $value, ..., Text => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::BedrockAgentRuntime::TextPrompt object:
