...
package Paws::BedrockAgentRuntime::FieldForReranking;
  use Moose;
...
Paws::BedrockAgentRuntime::FieldForReranking
...
As an example, if Att1 is expected to be a Paws::BedrockAgentRuntime::FieldForReranking object:

  $service_obj->Method(Att1 => { FieldName => $value, ..., FieldName => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::BedrockAgentRuntime::FieldForReranking object:
