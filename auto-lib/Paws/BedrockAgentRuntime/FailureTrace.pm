...
package Paws::BedrockAgentRuntime::FailureTrace;
  use Moose;
  has FailureCode => (is => 'ro', isa => 'Int', request_name => 'failureCode', traits => ['NameInRequest']);
...
Paws::BedrockAgentRuntime::FailureTrace
...
As an example, if Att1 is expected to be a Paws::BedrockAgentRuntime::FailureTrace object:

  $service_obj->Method(Att1 => { FailureCode => $value, ..., TraceId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::BedrockAgentRuntime::FailureTrace object:
