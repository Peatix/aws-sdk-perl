...
package Paws::BedrockAgentRuntime::ApiParameter;
  use Moose;
...
Paws::BedrockAgentRuntime::ApiParameter
...
As an example, if Att1 is expected to be a Paws::BedrockAgentRuntime::ApiParameter object:

  $service_obj->Method(Att1 => { Name => $value, ..., Value => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::BedrockAgentRuntime::ApiParameter object:
