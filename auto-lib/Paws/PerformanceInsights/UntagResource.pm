...
package Paws::PerformanceInsights::UntagResource;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::PerformanceInsights::UntagResourceResponse');
...
Paws::PerformanceInsights::UntagResource - Arguments for method UntagResource on L<Paws::PerformanceInsights>
...
=head1 SYNOPSIS
    ...
    my $UntagResourceResponse = $pi->UntagResource(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/pi/UntagResource>
...
This class forms part of L<Paws>, documenting arguments for method UntagResource in L<Paws::PerformanceInsights>
