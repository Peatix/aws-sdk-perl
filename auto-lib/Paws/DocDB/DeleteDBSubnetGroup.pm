...
package Paws::DocDB::DeleteDBSubnetGroup;
  use Moose;
...
Paws::DocDB::DeleteDBSubnetGroup - Arguments for method DeleteDBSubnetGroup on L<Paws::DocDB>
...
Must match the name of an existing C<DBSubnetGroup>. Must not be
default.
...
This class forms part of L<Paws>, documenting arguments for method DeleteDBSubnetGroup in L<Paws::DocDB>
