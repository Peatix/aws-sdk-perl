...
package Paws::DocDB::RebootDBInstance;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::DocDB::RebootDBInstanceResult');
...
Paws::DocDB::RebootDBInstance - Arguments for method RebootDBInstance on L<Paws::DocDB>
...
=head1 SYNOPSIS
    ...
    # Results:
    my $DBInstance = $RebootDBInstanceResult->DBInstance;

    # Returns a L<Paws::DocDB::RebootDBInstanceResult> object.
...
When C<true>, the reboot is conducted through a Multi-AZ failover.
...
This class forms part of L<Paws>, documenting arguments for method RebootDBInstance in L<Paws::DocDB>
