...
package Paws::DocDB::DescribeEventSubscriptions;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::DocDB::EventSubscriptionsMessage');
...
Paws::DocDB::DescribeEventSubscriptions - Arguments for method DescribeEventSubscriptions on L<Paws::DocDB>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::DocDB::EventSubscriptionsMessage> object.
...
This class forms part of L<Paws>, documenting arguments for method DescribeEventSubscriptions in L<Paws::DocDB>
