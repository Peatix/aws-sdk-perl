...
package Paws::DocDB::RemoveSourceIdentifierFromSubscription;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::DocDB::RemoveSourceIdentifierFromSubscriptionResult');
...
Paws::DocDB::RemoveSourceIdentifierFromSubscription - Arguments for method RemoveSourceIdentifierFromSubscription on L<Paws::DocDB>
...
# Returns a L<Paws::DocDB::RemoveSourceIdentifierFromSubscriptionResult> object.
...
This class forms part of L<Paws>, documenting arguments for method RemoveSourceIdentifierFromSubscription in L<Paws::DocDB>
