...
package Paws::DocDB::ModifyEventSubscription;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::DocDB::ModifyEventSubscriptionResult');
...
Paws::DocDB::ModifyEventSubscription - Arguments for method ModifyEventSubscription on L<Paws::DocDB>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::DocDB::ModifyEventSubscriptionResult> object.
...
A Boolean value; set to C<true> to activate the subscription.
...
parameter to C<db-instance>. If this value is not specified, all events
are returned.
...
This class forms part of L<Paws>, documenting arguments for method ModifyEventSubscription in L<Paws::DocDB>
