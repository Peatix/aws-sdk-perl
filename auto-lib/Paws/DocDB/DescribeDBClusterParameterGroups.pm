...
package Paws::DocDB::DescribeDBClusterParameterGroups;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::DocDB::DBClusterParameterGroupsMessage');
...
Paws::DocDB::DescribeDBClusterParameterGroups - Arguments for method DescribeDBClusterParameterGroups on L<Paws::DocDB>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::DocDB::DBClusterParameterGroupsMessage> object.
...
This class forms part of L<Paws>, documenting arguments for method DescribeDBClusterParameterGroups in L<Paws::DocDB>
