...
package Paws::DocDB::DeleteGlobalCluster;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::DocDB::DeleteGlobalClusterResult');
...
Paws::DocDB::DeleteGlobalCluster - Arguments for method DeleteGlobalCluster on L<Paws::DocDB>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::DocDB::DeleteGlobalClusterResult> object.
...
This class forms part of L<Paws>, documenting arguments for method DeleteGlobalCluster in L<Paws::DocDB>
