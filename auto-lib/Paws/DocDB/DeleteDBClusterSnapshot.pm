...
package Paws::DocDB::DeleteDBClusterSnapshot;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::DocDB::DeleteDBClusterSnapshotResult');
...
Paws::DocDB::DeleteDBClusterSnapshot - Arguments for method DeleteDBClusterSnapshot on L<Paws::DocDB>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::DocDB::DeleteDBClusterSnapshotResult> object.
...
This class forms part of L<Paws>, documenting arguments for method DeleteDBClusterSnapshot in L<Paws::DocDB>
