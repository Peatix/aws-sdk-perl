...
package Paws::Firehose::SnowflakeRetryOptions;
  use Moose;
...
Paws::Firehose::SnowflakeRetryOptions
...
As an example, if Att1 is expected to be a Paws::Firehose::SnowflakeRetryOptions object:

  $service_obj->Method(Att1 => { DurationInSeconds => $value, ..., DurationInSeconds => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Firehose::SnowflakeRetryOptions object:
