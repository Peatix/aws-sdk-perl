...
Specifies how you want Firehose to back up documents to Amazon S3. When
set to C<FailedDocumentsOnly>, Firehose writes any data that could not
be indexed to the configured Amazon S3 destination. When set to
C<AllEvents>, Firehose delivers all incoming records to Amazon S3, and
