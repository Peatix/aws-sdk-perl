...
package Paws::Firehose::HttpEndpointBufferingHints;
  use Moose;
...
Paws::Firehose::HttpEndpointBufferingHints
...
As an example, if Att1 is expected to be a Paws::Firehose::HttpEndpointBufferingHints object:

  $service_obj->Method(Att1 => { IntervalInSeconds => $value, ..., SizeInMBs => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Firehose::HttpEndpointBufferingHints object:
