...
package Paws::Firehose::SnowflakeBufferingHints;
  use Moose;
...
Paws::Firehose::SnowflakeBufferingHints
...
As an example, if Att1 is expected to be a Paws::Firehose::SnowflakeBufferingHints object:

  $service_obj->Method(Att1 => { IntervalInSeconds => $value, ..., SizeInMBs => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Firehose::SnowflakeBufferingHints object:
...
it to the destination. The default value is 128.
