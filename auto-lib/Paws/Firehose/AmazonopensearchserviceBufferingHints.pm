...
package Paws::Firehose::AmazonopensearchserviceBufferingHints;
  use Moose;
...
Paws::Firehose::AmazonopensearchserviceBufferingHints
...
As an example, if Att1 is expected to be a Paws::Firehose::AmazonopensearchserviceBufferingHints object:

  $service_obj->Method(Att1 => { IntervalInSeconds => $value, ..., SizeInMBs => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Firehose::AmazonopensearchserviceBufferingHints object:
