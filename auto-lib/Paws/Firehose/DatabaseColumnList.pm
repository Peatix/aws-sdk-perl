...
package Paws::Firehose::DatabaseColumnList;
  use Moose;
...
Paws::Firehose::DatabaseColumnList
...
As an example, if Att1 is expected to be a Paws::Firehose::DatabaseColumnList object:

  $service_obj->Method(Att1 => { Exclude => $value, ..., Include => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Firehose::DatabaseColumnList object:
