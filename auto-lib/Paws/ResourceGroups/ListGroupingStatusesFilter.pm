...
package Paws::ResourceGroups::ListGroupingStatusesFilter;
  use Moose;
...
Paws::ResourceGroups::ListGroupingStatusesFilter
...
As an example, if Att1 is expected to be a Paws::ResourceGroups::ListGroupingStatusesFilter object:

  $service_obj->Method(Att1 => { Name => $value, ..., Values => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ResourceGroups::ListGroupingStatusesFilter object:
