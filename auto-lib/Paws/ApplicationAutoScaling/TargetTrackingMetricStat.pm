...
package Paws::ApplicationAutoScaling::TargetTrackingMetricStat;
  use Moose;
  has Metric => (is => 'ro', isa => 'Paws::ApplicationAutoScaling::TargetTrackingMetric', required => 1);
...
Paws::ApplicationAutoScaling::TargetTrackingMetricStat
...
As an example, if Att1 is expected to be a Paws::ApplicationAutoScaling::TargetTrackingMetricStat object:

  $service_obj->Method(Att1 => { Metric => $value, ..., Unit => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ApplicationAutoScaling::TargetTrackingMetricStat object:
...
=head2 B<REQUIRED> Metric => L<Paws::ApplicationAutoScaling::TargetTrackingMetric>
