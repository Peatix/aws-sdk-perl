...
package Paws::ApplicationAutoScaling::ScalingActivity;
  ...
  has NotScaledReasons => (is => 'ro', isa => 'ArrayRef[Paws::ApplicationAutoScaling::NotScaledReason]');
...
=head2 NotScaledReasons => ArrayRef[L<Paws::ApplicationAutoScaling::NotScaledReason>]

Machine-readable data that describes the reason for a not scaled
activity. Only available when DescribeScalingActivities
