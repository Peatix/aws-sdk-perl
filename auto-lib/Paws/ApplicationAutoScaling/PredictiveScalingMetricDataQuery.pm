...
package Paws::ApplicationAutoScaling::PredictiveScalingMetricDataQuery;
  use Moose;
  has Expression => (is => 'ro', isa => 'Str');
  has Id => (is => 'ro', isa => 'Str', required => 1);
  has Label => (is => 'ro', isa => 'Str');
  has MetricStat => (is => 'ro', isa => 'Paws::ApplicationAutoScaling::PredictiveScalingMetricStat');
...
Paws::ApplicationAutoScaling::PredictiveScalingMetricDataQuery
...
As an example, if Att1 is expected to be a Paws::ApplicationAutoScaling::PredictiveScalingMetricDataQuery object:

  $service_obj->Method(Att1 => { Expression => $value, ..., ReturnData => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ApplicationAutoScaling::PredictiveScalingMetricDataQuery object:
...
=head2 MetricStat => L<Paws::ApplicationAutoScaling::PredictiveScalingMetricStat>
