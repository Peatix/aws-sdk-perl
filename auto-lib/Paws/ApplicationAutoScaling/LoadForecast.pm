...
package Paws::ApplicationAutoScaling::LoadForecast;
  use Moose;
  has MetricSpecification => (is => 'ro', isa => 'Paws::ApplicationAutoScaling::PredictiveScalingMetricSpecification', required => 1);
...
Paws::ApplicationAutoScaling::LoadForecast
...
As an example, if Att1 is expected to be a Paws::ApplicationAutoScaling::LoadForecast object:

  $service_obj->Method(Att1 => { MetricSpecification => $value, ..., Values => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ApplicationAutoScaling::LoadForecast object:
...
=head2 B<REQUIRED> MetricSpecification => L<Paws::ApplicationAutoScaling::PredictiveScalingMetricSpecification>
