...
package Paws::ApplicationAutoScaling::TargetTrackingMetricDataQuery;
  use Moose;
  has Expression => (is => 'ro', isa => 'Str');
  has Id => (is => 'ro', isa => 'Str', required => 1);
  has Label => (is => 'ro', isa => 'Str');
  has MetricStat => (is => 'ro', isa => 'Paws::ApplicationAutoScaling::TargetTrackingMetricStat');
...
Paws::ApplicationAutoScaling::TargetTrackingMetricDataQuery
...
As an example, if Att1 is expected to be a Paws::ApplicationAutoScaling::TargetTrackingMetricDataQuery object:

  $service_obj->Method(Att1 => { Expression => $value, ..., ReturnData => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ApplicationAutoScaling::TargetTrackingMetricDataQuery object:
...
policy for Application Auto Scaling using metric math
...
name must be unique among all C<MetricDataQuery> objects specified for
a single scaling policy. If you are performing math expressions on this
...
=head2 MetricStat => L<Paws::ApplicationAutoScaling::TargetTrackingMetricStat>

Information about the metric data to return.

Conditional: Within each C<MetricDataQuery> object, you must specify
either C<Expression> or C<MetricStat>, but not both.
