...
package Paws::SageMakerGeospatial::ExportErrorDetailsOutput;
  use Moose;
...
Paws::SageMakerGeospatial::ExportErrorDetailsOutput
...
As an example, if Att1 is expected to be a Paws::SageMakerGeospatial::ExportErrorDetailsOutput object:

  $service_obj->Method(Att1 => { Message => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::SageMakerGeospatial::ExportErrorDetailsOutput object:
