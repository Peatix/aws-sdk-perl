...
package Paws::RDS::IntegrationError;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::RDS::IntegrationError object:

  $service_obj->Method(Att1 => { ErrorCode => $value, ..., ErrorMessage => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::RDS::IntegrationError object:
