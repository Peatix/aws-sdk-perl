...
=head1 SYNOPSIS
    ...
    my $DeleteDBSnapshotResult =
      $rds->DeleteDBSnapshot( 'DBSnapshotIdentifier' => 'mydbsnapshot' );

    # Results:
    my $DBSnapshot = $DeleteDBSnapshotResult->DBSnapshot;

    # Returns a L<Paws::RDS::DeleteDBSnapshotResult> object.
