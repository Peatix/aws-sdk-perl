...
package Paws::RDS::DescribeAccountAttributes;
  use Moose;

  use MooseX::ClassAttribute;

  class_has _api_call => (isa => 'Str', is => 'ro', default => 'DescribeAccountAttributes');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::RDS::AccountAttributesMessage');
...
Paws::RDS::DescribeAccountAttributes - Arguments for method DescribeAccountAttributes on L<Paws::RDS>
...
=head1 SYNOPSIS
    ...
    my $AccountAttributesMessage = $rds->DescribeAccountAttributes();
...
This class forms part of L<Paws>, documenting arguments for method DescribeAccountAttributes in L<Paws::RDS>
