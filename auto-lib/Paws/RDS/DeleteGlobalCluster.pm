...
package Paws::RDS::DeleteGlobalCluster;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::RDS::DeleteGlobalClusterResult');
...
Paws::RDS::DeleteGlobalCluster - Arguments for method DeleteGlobalCluster on L<Paws::RDS>
...
=head1 SYNOPSIS
    ...
    my $DeleteGlobalClusterResult = $rds->DeleteGlobalCluster(
      GlobalClusterIdentifier => 'MyString',
    ...
    # Returns a L<Paws::RDS::DeleteGlobalClusterResult> object.
...
This class forms part of L<Paws>, documenting arguments for method DeleteGlobalCluster in L<Paws::RDS>
