...
package Paws::RDS::StartDBCluster;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::RDS::StartDBClusterResult');
...
Paws::RDS::StartDBCluster - Arguments for method StartDBCluster on L<Paws::RDS>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::RDS::StartDBClusterResult> object.
...
This class forms part of L<Paws>, documenting arguments for method StartDBCluster in L<Paws::RDS>
