...
Web Services set your end date to C<06/15/87 00:00 UTC>. The defaults
...
with the C<UpdateBudget> operation.
...
C<DAILY>, and didn't set a start date, Amazon Web Services set your
start date to C<01/24/18 00:00 UTC>. If you chose C<MONTHLY>, Amazon
Web Services set your start date to C<01/01/18 00:00 UTC>. The defaults
are the same for the Billing and Cost Management console and the API.
