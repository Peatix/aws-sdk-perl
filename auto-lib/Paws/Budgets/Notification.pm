...
notification is in the C<ALARM> state, you passed the set threshold for
the budget.
...
(C<ACTUAL>) or for how much that you're forecasted to spend
(C<FORECASTED>).
...
forecasted to go over your total cost threshold. For C<PERCENTAGE>
thresholds, Amazon Web Services notifies you when you go over or are
...
C<PERCENTAGE> threshold of 80%, Amazon Web Services notifies you when
