...
package Paws::TaxSettings::DestinationS3Location;
  use Moose;
...
Paws::TaxSettings::DestinationS3Location
...
As an example, if Att1 is expected to be a Paws::TaxSettings::DestinationS3Location object:

  $service_obj->Method(Att1 => { Bucket => $value, ..., Prefix => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::TaxSettings::DestinationS3Location object:
