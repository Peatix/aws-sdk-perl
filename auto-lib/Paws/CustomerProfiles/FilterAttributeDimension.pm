...
package Paws::CustomerProfiles::FilterAttributeDimension;
  use Moose;
...
Paws::CustomerProfiles::FilterAttributeDimension
...
As an example, if Att1 is expected to be a Paws::CustomerProfiles::FilterAttributeDimension object:

  $service_obj->Method(Att1 => { DimensionType => $value, ..., Values => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CustomerProfiles::FilterAttributeDimension object:
