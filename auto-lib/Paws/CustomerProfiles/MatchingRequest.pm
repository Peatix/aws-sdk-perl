...
package Paws::CustomerProfiles::MatchingRequest;
  use Moose;
...
Paws::CustomerProfiles::MatchingRequest
...
As an example, if Att1 is expected to be a Paws::CustomerProfiles::MatchingRequest object:

  $service_obj->Method(Att1 => { AutoMerging => $value, ..., JobSchedule => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CustomerProfiles::MatchingRequest object:
