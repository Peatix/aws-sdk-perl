...
package Paws::CustomerProfiles::S3ExportingLocation;
  use Moose;
...
Paws::CustomerProfiles::S3ExportingLocation
...
As an example, if Att1 is expected to be a Paws::CustomerProfiles::S3ExportingLocation object:

  $service_obj->Method(Att1 => { S3BucketName => $value, ..., S3KeyName => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CustomerProfiles::S3ExportingLocation object:
