...
package Paws::CustomerProfiles::DeleteWorkflow;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::CustomerProfiles::DeleteWorkflowResponse');
1;
...
Paws::CustomerProfiles::DeleteWorkflow - Arguments for method DeleteWorkflow on L<Paws::CustomerProfiles>
...
=head1 SYNOPSIS
    ...
    my $DeleteWorkflowResponse = $profile->DeleteWorkflow(
      DomainName => 'Myname',
      WorkflowId => 'Mystring1To255',

    );

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/profile/DeleteWorkflow>
...
This class forms part of L<Paws>, documenting arguments for method DeleteWorkflow in L<Paws::CustomerProfiles>
