...
package Paws::CustomerProfiles::DeleteEventStream;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::CustomerProfiles::DeleteEventStreamResponse');
1;
...
Paws::CustomerProfiles::DeleteEventStream - Arguments for method DeleteEventStream on L<Paws::CustomerProfiles>
...
=head1 SYNOPSIS
    ...
    my $DeleteEventStreamResponse = $profile->DeleteEventStream(
      DomainName      => 'Myname',
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/profile/DeleteEventStream>
...
This class forms part of L<Paws>, documenting arguments for method DeleteEventStream in L<Paws::CustomerProfiles>
