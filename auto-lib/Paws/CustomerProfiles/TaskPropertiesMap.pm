package Paws::CustomerProfiles::TaskPropertiesMap;
  use Moose;
...
Paws::CustomerProfiles::TaskPropertiesMap
...
As an example, if Att1 is expected to be a Paws::CustomerProfiles::TaskPropertiesMap object:

  $service_obj->Method(Att1 => { CONCAT_FORMAT => $value, ..., VALUES => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CustomerProfiles::TaskPropertiesMap object:
