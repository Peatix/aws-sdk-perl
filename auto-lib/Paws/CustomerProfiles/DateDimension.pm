...
package Paws::CustomerProfiles::DateDimension;
  use Moose;
...
Paws::CustomerProfiles::DateDimension
...
As an example, if Att1 is expected to be a Paws::CustomerProfiles::DateDimension object:

  $service_obj->Method(Att1 => { DimensionType => $value, ..., Values => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::CustomerProfiles::DateDimension object:
