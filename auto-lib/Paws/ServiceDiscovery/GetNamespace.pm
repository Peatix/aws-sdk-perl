...
package Paws::ServiceDiscovery::GetNamespace;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ServiceDiscovery::GetNamespaceResponse');
...
Paws::ServiceDiscovery::GetNamespace - Arguments for method GetNamespace on L<Paws::ServiceDiscovery>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::ServiceDiscovery::GetNamespaceResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/servicediscovery/GetNamespace>
...
This class forms part of L<Paws>, documenting arguments for method GetNamespace in L<Paws::ServiceDiscovery>
