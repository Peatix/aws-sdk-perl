...
package Paws::CloudTrail::GetImportResponse;
  use Moose;
  ...
  has ImportStatistics => (is => 'ro', isa => 'Paws::CloudTrail::ImportStatistics');
...
Paws::CloudTrail::GetImportResponse
...
=head2 ImportStatistics => L<Paws::CloudTrail::ImportStatistics>
...
C<EventsCompleted> may be lower than the actual value, because
