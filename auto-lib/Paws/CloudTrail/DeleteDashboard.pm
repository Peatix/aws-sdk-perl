...
package Paws::CloudTrail::DeleteDashboard;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::CloudTrail::DeleteDashboardResponse');
...
Paws::CloudTrail::DeleteDashboard - Arguments for method DeleteDashboard on L<Paws::CloudTrail>
...
=head1 SYNOPSIS
    ...
    my $DeleteDashboardResponse = $cloudtrail->DeleteDashboard(
      DashboardId => 'MyDashboardArn',

    );

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/cloudtrail/DeleteDashboard>
...
This class forms part of L<Paws>, documenting arguments for method DeleteDashboard in L<Paws::CloudTrail>
