...
package Paws::TimestreamInfluxDB::DbInstanceSummary;
  use Moose;
...
Paws::TimestreamInfluxDB::DbInstanceSummary
...
As an example, if Att1 is expected to be a Paws::TimestreamInfluxDB::DbInstanceSummary object:

  $service_obj->Method(Att1 => { AllocatedStorage => $value, ..., Status => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::TimestreamInfluxDB::DbInstanceSummary object:
