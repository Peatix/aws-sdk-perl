...
package Paws::FMS::ComplianceViolator;
  use Moose;
  has Metadata => (is => 'ro', isa => 'Paws::FMS::ComplianceViolatorMetadata');
...
As an example, if Att1 is expected to be a Paws::FMS::ComplianceViolator object:
  ...
  $service_obj->Method(Att1 => { Metadata => $value, ..., ViolationReason => $value  });
...
=head2 Metadata => L<Paws::FMS::ComplianceViolatorMetadata>
