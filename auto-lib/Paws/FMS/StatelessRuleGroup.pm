...
package Paws::FMS::StatelessRuleGroup;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::FMS::StatelessRuleGroup object:

  $service_obj->Method(Att1 => { Priority => $value, ..., RuleGroupName => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::FMS::StatelessRuleGroup object:
