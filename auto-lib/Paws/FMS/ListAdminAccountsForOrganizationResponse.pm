...
package Paws::FMS::ListAdminAccountsForOrganizationResponse;
  use Moose;
  has AdminAccounts => (is => 'ro', isa => 'ArrayRef[Paws::FMS::AdminAccountSummary]');
...
Paws::FMS::ListAdminAccountsForOrganizationResponse

=head1 ATTRIBUTES


=head2 AdminAccounts => ArrayRef[L<Paws::FMS::AdminAccountSummary>]
