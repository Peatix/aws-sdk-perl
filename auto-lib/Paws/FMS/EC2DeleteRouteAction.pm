...
package Paws::FMS::EC2DeleteRouteAction;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::FMS::EC2DeleteRouteAction object:

  $service_obj->Method(Att1 => { Description => $value, ..., RouteTableId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::FMS::EC2DeleteRouteAction object:
