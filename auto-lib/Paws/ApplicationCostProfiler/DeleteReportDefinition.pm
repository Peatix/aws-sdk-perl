...
package Paws::ApplicationCostProfiler::DeleteReportDefinition;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ApplicationCostProfiler::DeleteReportDefinitionResult');
1;
...
Paws::ApplicationCostProfiler::DeleteReportDefinition - Arguments for method DeleteReportDefinition on L<Paws::ApplicationCostProfiler>
...
=head1 SYNOPSIS
    ...
    my $DeleteReportDefinitionResult =
    ...
    # Results:
    my $ReportId = $DeleteReportDefinitionResult->ReportId;

# Returns a L<Paws::ApplicationCostProfiler::DeleteReportDefinitionResult> object.
...
This class forms part of L<Paws>, documenting arguments for method DeleteReportDefinition in L<Paws::ApplicationCostProfiler>
