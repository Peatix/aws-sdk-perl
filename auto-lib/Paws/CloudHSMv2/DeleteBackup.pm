...
package Paws::CloudHSMv2::DeleteBackup;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::CloudHSMv2::DeleteBackupResponse');
...
Paws::CloudHSMv2::DeleteBackup - Arguments for method DeleteBackup on L<Paws::CloudHSMv2>
...
=head1 SYNOPSIS
    ...
    my $DeleteBackupResponse = $cloudhsmv2->DeleteBackup(
      BackupId => 'MyBackupId',

    );

    # Results:
    my $Backup = $DeleteBackupResponse->Backup;

    # Returns a L<Paws::CloudHSMv2::DeleteBackupResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method DeleteBackup in L<Paws::CloudHSMv2>
