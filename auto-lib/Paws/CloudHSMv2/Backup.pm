...
As an example, if Att1 is expected to be a Paws::CloudHSMv2::Backup object:
  ...
  $service_obj->Method(Att1 => { BackupArn => $value, ..., TagList => $value  });
...
objects contain the C<BackupId>, C<BackupState>, C<ClusterId>, and
C<CreateTimestamp> parameters. Backups that were copied into a
