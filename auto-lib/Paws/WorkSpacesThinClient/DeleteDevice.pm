...
package Paws::WorkSpacesThinClient::DeleteDevice;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WorkSpacesThinClient::DeleteDeviceResponse');
1;
...
Paws::WorkSpacesThinClient::DeleteDevice - Arguments for method DeleteDevice on L<Paws::WorkSpacesThinClient>
...
=head1 SYNOPSIS
    ...
    my $DeleteDeviceResponse = $thinclient->DeleteDevice(
      Id          => 'MyDeviceId',
      ClientToken => 'MyClientToken',    # OPTIONAL
    );

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/thinclient/DeleteDevice>
...
This class forms part of L<Paws>, documenting arguments for method DeleteDevice in L<Paws::WorkSpacesThinClient>
