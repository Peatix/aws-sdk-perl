...
package Paws::WorkSpacesThinClient::EnvironmentSummary;
  use Moose;
...
Paws::WorkSpacesThinClient::EnvironmentSummary
...
As an example, if Att1 is expected to be a Paws::WorkSpacesThinClient::EnvironmentSummary object:

  $service_obj->Method(Att1 => { ActivationCode => $value, ..., UpdatedAt => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::WorkSpacesThinClient::EnvironmentSummary object:
