...
package Paws::WorkSpacesThinClient::ListDevices;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WorkSpacesThinClient::ListDevicesResponse');
1;
...
Paws::WorkSpacesThinClient::ListDevices - Arguments for method ListDevices on L<Paws::WorkSpacesThinClient>
...
=head1 SYNOPSIS
    ...
    my $ListDevicesResponse = $thinclient->ListDevices(
    ...
    # Returns a L<Paws::WorkSpacesThinClient::ListDevicesResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/thinclient/ListDevices>
...
This class forms part of L<Paws>, documenting arguments for method ListDevices in L<Paws::WorkSpacesThinClient>
