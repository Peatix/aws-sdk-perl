...
package Paws::WorkSpacesThinClient::GetEnvironment;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WorkSpacesThinClient::GetEnvironmentResponse');
1;
...
Paws::WorkSpacesThinClient::GetEnvironment - Arguments for method GetEnvironment on L<Paws::WorkSpacesThinClient>
...
=head1 SYNOPSIS
    ...
    my $GetEnvironmentResponse = $thinclient->GetEnvironment(
      Id => 'MyEnvironmentId',
    ...
    # Returns a L<Paws::WorkSpacesThinClient::GetEnvironmentResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/thinclient/GetEnvironment>
...
This class forms part of L<Paws>, documenting arguments for method GetEnvironment in L<Paws::WorkSpacesThinClient>
