...
package Paws::GuardDuty::Administrator;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::GuardDuty::Administrator object:

  $service_obj->Method(Att1 => { AccountId => $value, ..., RelationshipStatus => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::GuardDuty::Administrator object:
