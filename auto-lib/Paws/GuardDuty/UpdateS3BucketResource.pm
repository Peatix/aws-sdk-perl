...
package Paws::GuardDuty::UpdateS3BucketResource;
  use Moose;
...
Paws::GuardDuty::UpdateS3BucketResource
...
As an example, if Att1 is expected to be a Paws::GuardDuty::UpdateS3BucketResource object:

  $service_obj->Method(Att1 => { ObjectPrefixes => $value, ..., ObjectPrefixes => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::GuardDuty::UpdateS3BucketResource object:
