...
package Paws::GuardDuty::OrganizationAdditionalConfigurationResult;
  use Moose;
...
Paws::GuardDuty::OrganizationAdditionalConfigurationResult
...
As an example, if Att1 is expected to be a Paws::GuardDuty::OrganizationAdditionalConfigurationResult object:

  $service_obj->Method(Att1 => { AutoEnable => $value, ..., Name => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::GuardDuty::OrganizationAdditionalConfigurationResult object:
