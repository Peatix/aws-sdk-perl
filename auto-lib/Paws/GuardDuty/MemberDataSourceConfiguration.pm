...
Paws::GuardDuty::MemberDataSourceConfiguration
...
Use accessors for each attribute. If Att1 is expected to be an Paws::GuardDuty::MemberDataSourceConfiguration object:
