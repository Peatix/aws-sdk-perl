...
package Paws::GuardDuty::ThreatIntelligenceDetail;
  use Moose;
  has ThreatFileSha256 => (is => 'ro', isa => 'Str', request_name => 'threatFileSha256', traits => ['NameInRequest']);
...
As an example, if Att1 is expected to be a Paws::GuardDuty::ThreatIntelligenceDetail object:
  ...
  $service_obj->Method(Att1 => { ThreatFileSha256 => $value, ..., ThreatNames => $value  });
