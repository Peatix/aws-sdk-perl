...
package Paws::GuardDuty::S3ObjectDetail;
  use Moose;
  ...
  has ObjectArn => (is => 'ro', isa => 'Str', request_name => 'objectArn', traits => ['NameInRequest']);
...
As an example, if Att1 is expected to be a Paws::GuardDuty::S3ObjectDetail object:

  $service_obj->Method(Att1 => { ETag => $value, ..., VersionId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::GuardDuty::S3ObjectDetail object:
