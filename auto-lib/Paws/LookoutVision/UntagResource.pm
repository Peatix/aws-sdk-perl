...
package Paws::LookoutVision::UntagResource;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::LookoutVision::UntagResourceResponse');
1;
...
Paws::LookoutVision::UntagResource - Arguments for method UntagResource on L<Paws::LookoutVision>
...
=head1 SYNOPSIS
    ...
    my $UntagResourceResponse = $lookoutvision->UntagResource(
...
This class forms part of L<Paws>, documenting arguments for method UntagResource in L<Paws::LookoutVision>
