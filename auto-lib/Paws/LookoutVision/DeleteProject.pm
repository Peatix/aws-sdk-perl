...
package Paws::LookoutVision::DeleteProject;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::LookoutVision::DeleteProjectResponse');
1;
...
Paws::LookoutVision::DeleteProject - Arguments for method DeleteProject on L<Paws::LookoutVision>
...
=head1 SYNOPSIS
    ...
    my $DeleteProjectResponse = $lookoutvision->DeleteProject(
      ProjectName => 'MyProjectName',
      ClientToken => 'MyClientToken',    # OPTIONAL
    );

    # Results:
    my $ProjectArn = $DeleteProjectResponse->ProjectArn;

    # Returns a L<Paws::LookoutVision::DeleteProjectResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/lookoutvision/DeleteProject>
...
C<DeleteProject> completes only once. You choose the value to pass. For
example, An issue might prevent you from getting a response from
C<DeleteProject>. In this case, safely retry your call to
C<DeleteProject> by using the same C<ClientToken> parameter value.
...
considered a new call to C<DeleteProject>. An idempotency token is
active for 8 hours.
...
This class forms part of L<Paws>, documenting arguments for method DeleteProject in L<Paws::LookoutVision>
