...
from C<UpdateDatasetEntries>. In this case, safely retry your call to
C<UpdateDatasetEntries> by using the same C<ClientToken> parameter
value.
...
considered a new call to C<UpdateDatasetEntries>. An idempotency token
