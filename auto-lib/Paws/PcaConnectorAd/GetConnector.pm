...
package Paws::PcaConnectorAd::GetConnector;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::PcaConnectorAd::GetConnectorResponse');
1;
...
Paws::PcaConnectorAd::GetConnector - Arguments for method GetConnector on L<Paws::PcaConnectorAd>
...
=head1 SYNOPSIS
    ...
    my $GetConnectorResponse = $pca -connector-ad->GetConnector(
    ...
    # Returns a L<Paws::PcaConnectorAd::GetConnectorResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/pca-connector-ad/GetConnector>
...
This class forms part of L<Paws>, documenting arguments for method GetConnector in L<Paws::PcaConnectorAd>
