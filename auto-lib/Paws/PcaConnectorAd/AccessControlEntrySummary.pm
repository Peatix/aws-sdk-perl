...
package Paws::PcaConnectorAd::AccessControlEntrySummary;
  use Moose;
...
Paws::PcaConnectorAd::AccessControlEntrySummary
...
As an example, if Att1 is expected to be a Paws::PcaConnectorAd::AccessControlEntrySummary object:

  $service_obj->Method(Att1 => { AccessRights => $value, ..., UpdatedAt => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::PcaConnectorAd::AccessControlEntrySummary object:
