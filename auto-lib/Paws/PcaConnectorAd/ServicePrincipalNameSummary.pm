...
package Paws::PcaConnectorAd::ServicePrincipalNameSummary;
  use Moose;
...
Paws::PcaConnectorAd::ServicePrincipalNameSummary
...
As an example, if Att1 is expected to be a Paws::PcaConnectorAd::ServicePrincipalNameSummary object:

  $service_obj->Method(Att1 => { ConnectorArn => $value, ..., UpdatedAt => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::PcaConnectorAd::ServicePrincipalNameSummary object:
