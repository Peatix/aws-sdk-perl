...
package Paws::PcaConnectorAd::TemplateSummary;
  use Moose;
...
Paws::PcaConnectorAd::TemplateSummary
...
As an example, if Att1 is expected to be a Paws::PcaConnectorAd::TemplateSummary object:

  $service_obj->Method(Att1 => { Arn => $value, ..., UpdatedAt => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::PcaConnectorAd::TemplateSummary object:
