package Paws::IoTEventsData;
  ...
  sub BatchDeleteDetector {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::IoTEventsData::BatchDeleteDetector', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub operations { qw/BatchAcknowledgeAlarm BatchDeleteDetector BatchDisableAlarm BatchEnableAlarm BatchPutMessage BatchResetAlarm BatchSnoozeAlarm BatchUpdateDetector DescribeAlarm DescribeDetector ListAlarms ListDetectors / }
...
=head2 BatchDeleteDetector

=over

=item Detectors => ArrayRef[L<Paws::IoTEventsData::DeleteDetectorRequest>]


=back

Each argument is described in detail in: L<Paws::IoTEventsData::BatchDeleteDetector>

Returns: a L<Paws::IoTEventsData::BatchDeleteDetectorResponse> instance
...
if referenced in the ListDetectors
...
is transformed into the input you specify (C<"inputName">) and ingested
