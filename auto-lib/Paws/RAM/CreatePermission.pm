...
package Paws::RAM::CreatePermission;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/createpermission');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::RAM::CreatePermissionResponse');
1;
...
Paws::RAM::CreatePermission - Arguments for method CreatePermission on L<Paws::RAM>
...
=head1 SYNOPSIS
    ...
    my $CreatePermissionResponse = $ram->CreatePermission(
      Name           => 'MyPermissionName',
    ...
    # Results:
    my $ClientToken = $CreatePermissionResponse->ClientToken;
    my $Permission  = $CreatePermissionResponse->Permission;

    # Returns a L<Paws::RAM::CreatePermissionResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/ram/CreatePermission>
...
The format is C< I<E<lt>service-codeE<gt>>:I<E<lt>resource-typeE<gt>> >
and is not case sensitive. For example, to specify an Amazon EC2
Subnet, you can use the string C<ec2:subnet>. To see the list of valid
values for this parameter, query the ListResourceTypes operation.
...
This class forms part of L<Paws>, documenting arguments for method CreatePermission in L<Paws::RAM>
