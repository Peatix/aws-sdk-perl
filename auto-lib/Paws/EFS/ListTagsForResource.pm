...
package Paws::EFS::ListTagsForResource;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::EFS::ListTagsForResourceResponse');
1;
...
Paws::EFS::ListTagsForResource - Arguments for method ListTagsForResource on L<Paws::EFS>
...
This class forms part of L<Paws>, documenting arguments for method ListTagsForResource in L<Paws::EFS>
