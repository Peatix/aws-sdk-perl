...
package Paws::LexModelsV2::AnalyticsUtteranceFilter;
  use Moose;
...
Paws::LexModelsV2::AnalyticsUtteranceFilter
...
As an example, if Att1 is expected to be a Paws::LexModelsV2::AnalyticsUtteranceFilter object:

  $service_obj->Method(Att1 => { Name => $value, ..., Values => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::LexModelsV2::AnalyticsUtteranceFilter object:
...
utterances. The expression may be understood as C<name> C<operator>
...
C<LocaleId EQ Book> E<ndash> The locale is the string "en".

=item *

C<UtteranceText CO help> E<ndash> The text of the utterance contains
the string "help".
...
C<UtteranceState> E<ndash> C<EQ>.

=item *

C<UtteranceText> E<ndash> C<EQ>, C<CO>.
...
C<UtteranceState> E<ndash> The state of the utterance.

=item *

C<UtteranceText> E<ndash> The text in the utterance.
