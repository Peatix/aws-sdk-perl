...
package Paws::LexModelsV2::ListIntentMetricsResponse;
  use Moose;
  has BotId => (is => 'ro', isa => 'Str', traits => ['NameInRequest'], request_name => 'botId');
  has NextToken => (is => 'ro', isa => 'Str', traits => ['NameInRequest'], request_name => 'nextToken');
  has Results => (is => 'ro', isa => 'ArrayRef[Paws::LexModelsV2::AnalyticsIntentResult]', traits => ['NameInRequest'], request_name => 'results');
...
Paws::LexModelsV2::ListIntentMetricsResponse
...
=head2 Results => ArrayRef[L<Paws::LexModelsV2::AnalyticsIntentResult>]
