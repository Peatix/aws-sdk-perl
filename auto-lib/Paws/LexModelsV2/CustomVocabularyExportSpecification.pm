...
package Paws::LexModelsV2::CustomVocabularyExportSpecification;
  use Moose;
...
Paws::LexModelsV2::CustomVocabularyExportSpecification
...
As an example, if Att1 is expected to be a Paws::LexModelsV2::CustomVocabularyExportSpecification object:

  $service_obj->Method(Att1 => { BotId => $value, ..., LocaleId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::LexModelsV2::CustomVocabularyExportSpecification object:
