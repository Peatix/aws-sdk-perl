...
package Paws::LexModelsV2::ImportFilter;
  use Moose;
...
The operator to use for the filter. Specify EQ when the C<ListImports>
operation should return only resource types that equal the specified
value. Specify CO when the C<ListImports> operation should return
