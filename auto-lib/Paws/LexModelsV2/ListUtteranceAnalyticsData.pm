...
package Paws::LexModelsV2::ListUtteranceAnalyticsData;
  use Moose;
  ...
  has SortBy => (is => 'ro', isa => 'Paws::LexModelsV2::UtteranceDataSortBy', traits => ['NameInRequest'], request_name => 'sortBy');
  has StartDateTime => (is => 'ro', isa => 'Str', traits => ['NameInRequest'], request_name => 'startDateTime', required => 1);

  use MooseX::ClassAttribute;

  class_has _api_call => (isa => 'Str', is => 'ro', default => 'ListUtteranceAnalyticsData');
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/bots/{botId}/analytics/utterances');
  class_has _api_method  => (isa => 'Str', is => 'ro', default => 'POST');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::LexModelsV2::ListUtteranceAnalyticsDataResponse');
1;
...
Paws::LexModelsV2::ListUtteranceAnalyticsData - Arguments for method ListUtteranceAnalyticsData on L<Paws::LexModelsV2>

=head1 DESCRIPTION

This class represents the parameters used for calling the method ListUtteranceAnalyticsData on the
L<Amazon Lex Model Building V2|Paws::LexModelsV2> service. Use the attributes of this class
as arguments to method ListUtteranceAnalyticsData.

You shouldn't make instances of this class. Each attribute should be used as a named argument in the call to ListUtteranceAnalyticsData.

=head1 SYNOPSIS

    my $models-v2-lex = Paws->service('LexModelsV2');
    my $ListUtteranceAnalyticsDataResponse =
      $models - v2 -lex->ListUtteranceAnalyticsData(
      BotId         => 'MyId',
      ...
      SortBy     => {
        Name  => 'UtteranceTimestamp',    # values: UtteranceTimestamp
    ...
    # Results:
    my $BotId      = $ListUtteranceAnalyticsDataResponse->BotId;
    my $NextToken  = $ListUtteranceAnalyticsDataResponse->NextToken;
    my $Utterances = $ListUtteranceAnalyticsDataResponse->Utterances;

    # Returns a L<Paws::LexModelsV2::ListUtteranceAnalyticsDataResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/models-v2-lex/ListUtteranceAnalyticsData>
...
=head2 SortBy => L<Paws::LexModelsV2::UtteranceDataSortBy>
...
This class forms part of L<Paws>, documenting arguments for method ListUtteranceAnalyticsData in L<Paws::LexModelsV2>
