...
package Paws::LexModelsV2::AnalyticsIntentFilter;
  use Moose;
...
Paws::LexModelsV2::AnalyticsIntentFilter
...
As an example, if Att1 is expected to be a Paws::LexModelsV2::AnalyticsIntentFilter object:

  $service_obj->Method(Att1 => { Name => $value, ..., Values => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::LexModelsV2::AnalyticsIntentFilter object:
...
C<IntentEndState> E<ndash> C<EQ>, C<CO>.
...
C<IntentEndState> E<ndash> The final state of the intent.
