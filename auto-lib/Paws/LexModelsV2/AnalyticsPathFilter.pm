...
package Paws::LexModelsV2::AnalyticsPathFilter;
  use Moose;
...
Paws::LexModelsV2::AnalyticsPathFilter
...
As an example, if Att1 is expected to be a Paws::LexModelsV2::AnalyticsPathFilter object:

  $service_obj->Method(Att1 => { Name => $value, ..., Values => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::LexModelsV2::AnalyticsPathFilter object:
...
The category by which to filter the intent paths. The descriptions for
