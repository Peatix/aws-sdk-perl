package Paws::Macie2;
  ...
  sub BatchUpdateAutomatedDiscoveryAccounts {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Macie2::BatchUpdateAutomatedDiscoveryAccounts', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub CreateAllowList {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Macie2::CreateAllowList', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DeleteAllowList {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Macie2::DeleteAllowList', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub GetAllowList {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Macie2::GetAllowList', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetAutomatedDiscoveryConfiguration {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Macie2::GetAutomatedDiscoveryConfiguration', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub GetClassificationScope {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Macie2::GetClassificationScope', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub GetResourceProfile {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Macie2::GetResourceProfile', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetRevealConfiguration {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Macie2::GetRevealConfiguration', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetSensitiveDataOccurrences {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Macie2::GetSensitiveDataOccurrences', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetSensitiveDataOccurrencesAvailability {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Macie2::GetSensitiveDataOccurrencesAvailability', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetSensitivityInspectionTemplate {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Macie2::GetSensitivityInspectionTemplate', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ListAllowLists {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Macie2::ListAllowLists', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ListAutomatedDiscoveryAccounts {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Macie2::ListAutomatedDiscoveryAccounts', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ListClassificationScopes {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Macie2::ListClassificationScopes', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ListManagedDataIdentifiers {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Macie2::ListManagedDataIdentifiers', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ListMembers {
    my $self = shift;
  ...
  sub ListResourceProfileArtifacts {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Macie2::ListResourceProfileArtifacts', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ListResourceProfileDetections {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Macie2::ListResourceProfileDetections', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ListSensitivityInspectionTemplates {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Macie2::ListSensitivityInspectionTemplates', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub UpdateAllowList {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Macie2::UpdateAllowList', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub UpdateAutomatedDiscoveryConfiguration {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Macie2::UpdateAutomatedDiscoveryConfiguration', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub UpdateClassificationScope {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Macie2::UpdateClassificationScope', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub UpdateResourceProfile {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Macie2::UpdateResourceProfile', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub UpdateResourceProfileDetections {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Macie2::UpdateResourceProfileDetections', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub UpdateRevealConfiguration {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Macie2::UpdateRevealConfiguration', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub UpdateSensitivityInspectionTemplate {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::Macie2::UpdateSensitivityInspectionTemplate', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ListAllAllowLists {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->ListAllowLists(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->nextToken) {
        $next_result = $self->ListAllowLists(@_, nextToken => $next_result->nextToken);
        push @{ $result->allowLists }, @{ $next_result->allowLists };
      }
      return $result;
    } else {
      while ($result->nextToken) {
        $callback->($_ => 'allowLists') foreach (@{ $result->allowLists });
        $result = $self->ListAllowLists(@_, nextToken => $result->nextToken);
      }
      $callback->($_ => 'allowLists') foreach (@{ $result->allowLists });
    }
  ...
  sub ListAllAutomatedDiscoveryAccounts {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->ListAutomatedDiscoveryAccounts(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->nextToken) {
        $next_result = $self->ListAutomatedDiscoveryAccounts(@_, nextToken => $next_result->nextToken);
      ...
      while ($result->nextToken) {
        ...
        $result = $self->ListAutomatedDiscoveryAccounts(@_, nextToken => $result->nextToken);
      }
      $callback->($_ => 'items') foreach (@{ $result->items });
    }
  ...
  sub ListAllClassificationScopes {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->ListClassificationScopes(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->nextToken) {
        $next_result = $self->ListClassificationScopes(@_, nextToken => $next_result->nextToken);
        push @{ $result->classificationScopes }, @{ $next_result->classificationScopes };
      }
      return $result;
    } else {
      while ($result->nextToken) {
        $callback->($_ => 'classificationScopes') foreach (@{ $result->classificationScopes });
        $result = $self->ListClassificationScopes(@_, nextToken => $result->nextToken);
      }
      $callback->($_ => 'classificationScopes') foreach (@{ $result->classificationScopes });
    }
  ...
  sub ListAllManagedDataIdentifiers {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->ListManagedDataIdentifiers(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->nextToken) {
        $next_result = $self->ListManagedDataIdentifiers(@_, nextToken => $next_result->nextToken);
        push @{ $result->items }, @{ $next_result->items };
      }
      return $result;
    } else {
      while ($result->nextToken) {
        $callback->($_ => 'items') foreach (@{ $result->items });
        $result = $self->ListManagedDataIdentifiers(@_, nextToken => $result->nextToken);
      }
      $callback->($_ => 'items') foreach (@{ $result->items });
    }
  ...
  sub ListAllResourceProfileArtifacts {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->ListResourceProfileArtifacts(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->nextToken) {
        $next_result = $self->ListResourceProfileArtifacts(@_, nextToken => $next_result->nextToken);
      ...
      while ($result->nextToken) {
        ...
        $result = $self->ListResourceProfileArtifacts(@_, nextToken => $result->nextToken);
      }
      $callback->($_ => 'artifacts') foreach (@{ $result->artifacts });
    }
  ...
  sub ListAllResourceProfileDetections {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->ListResourceProfileDetections(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->nextToken) {
        $next_result = $self->ListResourceProfileDetections(@_, nextToken => $next_result->nextToken);
        push @{ $result->detections }, @{ $next_result->detections };
      }
      return $result;
    } else {
      while ($result->nextToken) {
        $callback->($_ => 'detections') foreach (@{ $result->detections });
        $result = $self->ListResourceProfileDetections(@_, nextToken => $result->nextToken);
      }
      $callback->($_ => 'detections') foreach (@{ $result->detections });
    }
  ...
  sub ListAllSensitivityInspectionTemplates {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->ListSensitivityInspectionTemplates(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->nextToken) {
        $next_result = $self->ListSensitivityInspectionTemplates(@_, nextToken => $next_result->nextToken);
        push @{ $result->sensitivityInspectionTemplates }, @{ $next_result->sensitivityInspectionTemplates };
      }
      return $result;
    } else {
      while ($result->nextToken) {
        $callback->($_ => 'sensitivityInspectionTemplates') foreach (@{ $result->sensitivityInspectionTemplates });
        $result = $self->ListSensitivityInspectionTemplates(@_, nextToken => $result->nextToken);
      }
      $callback->($_ => 'sensitivityInspectionTemplates') foreach (@{ $result->sensitivityInspectionTemplates });
    }
  ...
  sub operations { qw/AcceptInvitation BatchGetCustomDataIdentifiers BatchUpdateAutomatedDiscoveryAccounts CreateAllowList CreateClassificationJob CreateCustomDataIdentifier CreateFindingsFilter CreateInvitations CreateMember CreateSampleFindings DeclineInvitations DeleteAllowList DeleteCustomDataIdentifier DeleteFindingsFilter DeleteInvitations DeleteMember DescribeBuckets DescribeClassificationJob DescribeOrganizationConfiguration DisableMacie DisableOrganizationAdminAccount DisassociateFromAdministratorAccount DisassociateFromMasterAccount DisassociateMember EnableMacie EnableOrganizationAdminAccount GetAdministratorAccount GetAllowList GetAutomatedDiscoveryConfiguration GetBucketStatistics GetClassificationExportConfiguration GetClassificationScope GetCustomDataIdentifier GetFindings GetFindingsFilter GetFindingsPublicationConfiguration GetFindingStatistics GetInvitationsCount GetMacieSession GetMasterAccount GetMember GetResourceProfile GetRevealConfiguration GetSensitiveDataOccurrences GetSensitiveDataOccurrencesAvailability GetSensitivityInspectionTemplate GetUsageStatistics GetUsageTotals ListAllowLists ListAutomatedDiscoveryAccounts ListClassificationJobs ListClassificationScopes ListCustomDataIdentifiers ListFindings ListFindingsFilters ListInvitations ListManagedDataIdentifiers ListMembers ListOrganizationAdminAccounts ListResourceProfileArtifacts ListResourceProfileDetections ListSensitivityInspectionTemplates ListTagsForResource PutClassificationExportConfiguration PutFindingsPublicationConfiguration SearchResources TagResource TestCustomDataIdentifier UntagResource UpdateAllowList UpdateAutomatedDiscoveryConfiguration UpdateClassificationJob UpdateClassificationScope UpdateFindingsFilter UpdateMacieSession UpdateMemberSession UpdateOrganizationConfiguration UpdateResourceProfile UpdateResourceProfileDetections UpdateRevealConfiguration UpdateSensitivityInspectionTemplate / }
...
=head2 BatchUpdateAutomatedDiscoveryAccounts

=over

=item [Accounts => ArrayRef[L<Paws::Macie2::AutomatedDiscoveryAccountUpdate>]]


=back

Each argument is described in detail in: L<Paws::Macie2::BatchUpdateAutomatedDiscoveryAccounts>

Returns: a L<Paws::Macie2::BatchUpdateAutomatedDiscoveryAccountsResponse> instance

Changes the status of automated sensitive data discovery for one or
more accounts.


=head2 CreateAllowList

=over

=item ClientToken => Str

=item Criteria => L<Paws::Macie2::AllowListCriteria>
...
Each argument is described in detail in: L<Paws::Macie2::CreateAllowList>

Returns: a L<Paws::Macie2::CreateAllowListResponse> instance
...
=item [AllowListIds => ArrayRef[Str|Undef]]
...
=item [ManagedDataIdentifierIds => ArrayRef[Str|Undef]]

=item [ManagedDataIdentifierSelector => Str]
...
=item [SeverityLevels => ArrayRef[L<Paws::Macie2::SeverityLevel>]]
...
=head2 DeleteAllowList

=over

=item Id => Str

=item [IgnoreJobChecks => Str]


=back

Each argument is described in detail in: L<Paws::Macie2::DeleteAllowList>

Returns: a L<Paws::Macie2::DeleteAllowListResponse> instance
...
Each argument is described in detail in: L<Paws::Macie2::GetAllowList>

Returns: a L<Paws::Macie2::GetAllowListResponse> instance

Retrieves the settings and status of an allow list.


=head2 GetAutomatedDiscoveryConfiguration
...
Each argument is described in detail in: L<Paws::Macie2::GetAutomatedDiscoveryConfiguration>

Returns: a L<Paws::Macie2::GetAutomatedDiscoveryConfigurationResponse> instance
...
Each argument is described in detail in: L<Paws::Macie2::GetClassificationScope>

Returns: a L<Paws::Macie2::GetClassificationScopeResponse> instance
...
Each argument is described in detail in: L<Paws::Macie2::GetResourceProfile>

Returns: a L<Paws::Macie2::GetResourceProfileResponse> instance

Retrieves (queries) sensitive data discovery statistics and the
sensitivity score for an S3 bucket.


=head2 GetRevealConfiguration
...
Each argument is described in detail in: L<Paws::Macie2::GetRevealConfiguration>

Returns: a L<Paws::Macie2::GetRevealConfigurationResponse> instance

Retrieves the status and configuration settings for retrieving
occurrences of sensitive data reported by findings.


=head2 GetSensitiveDataOccurrences
...
Each argument is described in detail in: L<Paws::Macie2::GetSensitiveDataOccurrences>

Returns: a L<Paws::Macie2::GetSensitiveDataOccurrencesResponse> instance

Retrieves occurrences of sensitive data reported by a finding.


=head2 GetSensitiveDataOccurrencesAvailability
...
Each argument is described in detail in: L<Paws::Macie2::GetSensitiveDataOccurrencesAvailability>

Returns: a L<Paws::Macie2::GetSensitiveDataOccurrencesAvailabilityResponse> instance

Checks whether occurrences of sensitive data can be retrieved for a
finding.


=head2 GetSensitivityInspectionTemplate
...
Each argument is described in detail in: L<Paws::Macie2::GetSensitivityInspectionTemplate>

Returns: a L<Paws::Macie2::GetSensitivityInspectionTemplateResponse> instance
...
Each argument is described in detail in: L<Paws::Macie2::ListAllowLists>

Returns: a L<Paws::Macie2::ListAllowListsResponse> instance

Retrieves a subset of information about all the allow lists for an
account.


=head2 ListAutomatedDiscoveryAccounts
...
Each argument is described in detail in: L<Paws::Macie2::ListAutomatedDiscoveryAccounts>

Returns: a L<Paws::Macie2::ListAutomatedDiscoveryAccountsResponse> instance
...
=head2 ListClassificationScopes
...
Each argument is described in detail in: L<Paws::Macie2::ListClassificationScopes>

Returns: a L<Paws::Macie2::ListClassificationScopesResponse> instance
...
=head2 ListManagedDataIdentifiers
...
Each argument is described in detail in: L<Paws::Macie2::ListManagedDataIdentifiers>

Returns: a L<Paws::Macie2::ListManagedDataIdentifiersResponse> instance
...
=head2 ListResourceProfileArtifacts
...
Each argument is described in detail in: L<Paws::Macie2::ListResourceProfileArtifacts>

Returns: a L<Paws::Macie2::ListResourceProfileArtifactsResponse> instance

Retrieves information about objects that Amazon Macie selected from an
S3 bucket for automated sensitive data discovery.


=head2 ListResourceProfileDetections
...
Each argument is described in detail in: L<Paws::Macie2::ListResourceProfileDetections>

Returns: a L<Paws::Macie2::ListResourceProfileDetectionsResponse> instance

Retrieves information about the types and amount of sensitive data that
Amazon Macie found in an S3 bucket.


=head2 ListSensitivityInspectionTemplates
...
Each argument is described in detail in: L<Paws::Macie2::ListSensitivityInspectionTemplates>

Returns: a L<Paws::Macie2::ListSensitivityInspectionTemplatesResponse> instance
...
Each argument is described in detail in: L<Paws::Macie2::UpdateAllowList>

Returns: a L<Paws::Macie2::UpdateAllowListResponse> instance

Updates the settings for an allow list.


=head2 UpdateAutomatedDiscoveryConfiguration
...
Each argument is described in detail in: L<Paws::Macie2::UpdateAutomatedDiscoveryConfiguration>

Returns: a L<Paws::Macie2::UpdateAutomatedDiscoveryConfigurationResponse> instance
...
=head2 UpdateClassificationScope

=over

=item Id => Str

=item [S3 => L<Paws::Macie2::S3ClassificationScopeUpdate>]


=back

Each argument is described in detail in: L<Paws::Macie2::UpdateClassificationScope>

Returns: a L<Paws::Macie2::UpdateClassificationScopeResponse> instance
...
=head2 UpdateResourceProfile

=over

=item ResourceArn => Str

=item [SensitivityScoreOverride => Int]


=back

Each argument is described in detail in: L<Paws::Macie2::UpdateResourceProfile>

Returns: a L<Paws::Macie2::UpdateResourceProfileResponse> instance

Updates the sensitivity score for an S3 bucket.


=head2 UpdateResourceProfileDetections

=over

=item ResourceArn => Str

=item [SuppressDataIdentifiers => ArrayRef[L<Paws::Macie2::SuppressDataIdentifier>]]


=back

Each argument is described in detail in: L<Paws::Macie2::UpdateResourceProfileDetections>

Returns: a L<Paws::Macie2::UpdateResourceProfileDetectionsResponse> instance

Updates the sensitivity scoring settings for an S3 bucket.


=head2 UpdateRevealConfiguration

=over

=item Configuration => L<Paws::Macie2::RevealConfiguration>

=item [RetrievalConfiguration => L<Paws::Macie2::UpdateRetrievalConfiguration>]


=back

Each argument is described in detail in: L<Paws::Macie2::UpdateRevealConfiguration>

Returns: a L<Paws::Macie2::UpdateRevealConfigurationResponse> instance

Updates the status and configuration settings for retrieving
occurrences of sensitive data reported by findings.


=head2 UpdateSensitivityInspectionTemplate
...
=item [Excludes => L<Paws::Macie2::SensitivityInspectionTemplateExcludes>]

=item [Includes => L<Paws::Macie2::SensitivityInspectionTemplateIncludes>]


=back

Each argument is described in detail in: L<Paws::Macie2::UpdateSensitivityInspectionTemplate>

Returns: a L<Paws::Macie2::UpdateSensitivityInspectionTemplateResponse> instance
...
=head2 ListAllAllowLists(sub { },[MaxResults => Int, NextToken => Str])

=head2 ListAllAllowLists([MaxResults => Int, NextToken => Str])


If passed a sub as first parameter, it will call the sub for each element found in :

 - allowLists, passing the object as the first parameter, and the string 'allowLists' as the second parameter 

If not, it will return a a L<Paws::Macie2::ListAllowListsResponse> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.


=head2 ListAllAutomatedDiscoveryAccounts(sub { },[AccountIds => ArrayRef[Str|Undef], MaxResults => Int, NextToken => Str])

=head2 ListAllAutomatedDiscoveryAccounts([AccountIds => ArrayRef[Str|Undef], MaxResults => Int, NextToken => Str])
...
If not, it will return a a L<Paws::Macie2::ListAutomatedDiscoveryAccountsResponse> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
...
=head2 ListAllClassificationScopes(sub { },[Name => Str, NextToken => Str])

=head2 ListAllClassificationScopes([Name => Str, NextToken => Str])


If passed a sub as first parameter, it will call the sub for each element found in :

 - classificationScopes, passing the object as the first parameter, and the string 'classificationScopes' as the second parameter 

If not, it will return a a L<Paws::Macie2::ListClassificationScopesResponse> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
...
=head2 ListAllManagedDataIdentifiers(sub { },[NextToken => Str])

=head2 ListAllManagedDataIdentifiers([NextToken => Str])
...
If not, it will return a a L<Paws::Macie2::ListManagedDataIdentifiersResponse> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
...
=head2 ListAllResourceProfileArtifacts(sub { },ResourceArn => Str, [NextToken => Str])

=head2 ListAllResourceProfileArtifacts(ResourceArn => Str, [NextToken => Str])
...
If not, it will return a a L<Paws::Macie2::ListResourceProfileArtifactsResponse> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.


=head2 ListAllResourceProfileDetections(sub { },ResourceArn => Str, [MaxResults => Int, NextToken => Str])

=head2 ListAllResourceProfileDetections(ResourceArn => Str, [MaxResults => Int, NextToken => Str])


If passed a sub as first parameter, it will call the sub for each element found in :

 - detections, passing the object as the first parameter, and the string 'detections' as the second parameter 

If not, it will return a a L<Paws::Macie2::ListResourceProfileDetectionsResponse> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.


=head2 ListAllSensitivityInspectionTemplates(sub { },[MaxResults => Int, NextToken => Str])

=head2 ListAllSensitivityInspectionTemplates([MaxResults => Int, NextToken => Str])


If passed a sub as first parameter, it will call the sub for each element found in :

 - sensitivityInspectionTemplates, passing the object as the first parameter, and the string 'sensitivityInspectionTemplates' as the second parameter 

If not, it will return a a L<Paws::Macie2::ListSensitivityInspectionTemplatesResponse> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
