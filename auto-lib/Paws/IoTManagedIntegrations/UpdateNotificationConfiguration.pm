...
package Paws::IoTManagedIntegrations::UpdateNotificationConfiguration;
  use Moose;
...
Paws::IoTManagedIntegrations::UpdateNotificationConfiguration - Arguments for method UpdateNotificationConfiguration on L<Paws::IoTManagedIntegrations>
...
=head1 SYNOPSIS
    ...
    $api . iotmanagedintegrations->UpdateNotificationConfiguration(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/api.iotmanagedintegrations/UpdateNotificationConfiguration>
...
This class forms part of L<Paws>, documenting arguments for method UpdateNotificationConfiguration in L<Paws::IoTManagedIntegrations>
