...
package Paws::DeviceFarm::DeleteInstanceProfile;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::DeviceFarm::DeleteInstanceProfileResult');
...
Paws::DeviceFarm::DeleteInstanceProfile - Arguments for method DeleteInstanceProfile on L<Paws::DeviceFarm>
...
=head1 SYNOPSIS
    ...
    my $DeleteInstanceProfileResult = $devicefarm->DeleteInstanceProfile(
...
This class forms part of L<Paws>, documenting arguments for method DeleteInstanceProfile in L<Paws::DeviceFarm>
