...
package Paws::DeviceFarm::GetAccountSettings;
  use Moose;

  use MooseX::ClassAttribute;

  class_has _api_call => (isa => 'Str', is => 'ro', default => 'GetAccountSettings');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::DeviceFarm::GetAccountSettingsResult');
...
Paws::DeviceFarm::GetAccountSettings - Arguments for method GetAccountSettings on L<Paws::DeviceFarm>
...
This class forms part of L<Paws>, documenting arguments for method GetAccountSettings in L<Paws::DeviceFarm>
