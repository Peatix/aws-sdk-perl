...
=head1 SYNOPSIS
    ...
    my $GetDownloadUrlForLayerResponse = $api . ecr->GetDownloadUrlForLayer(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/api.ecr/GetDownloadUrlForLayer>
