...
package Paws::ECR::Recommendation;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::ECR::Recommendation object:

  $service_obj->Method(Att1 => { Text => $value, ..., Url => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ECR::Recommendation object:
