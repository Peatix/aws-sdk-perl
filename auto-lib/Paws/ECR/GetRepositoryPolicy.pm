...
=head1 SYNOPSIS
   ...
   # This example obtains the repository policy for the repository named ubuntu.
    my $GetRepositoryPolicyResponse =
      $api . ecr->GetRepositoryPolicy( 'RepositoryName' => 'ubuntu' );
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/api.ecr/GetRepositoryPolicy>
