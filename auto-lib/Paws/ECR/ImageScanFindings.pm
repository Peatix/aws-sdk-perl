...
package Paws::ECR::ImageScanFindings;
  use Moose;
  has EnhancedFindings => (is => 'ro', isa => 'ArrayRef[Paws::ECR::EnhancedImageScanFinding]', request_name => 'enhancedFindings', traits => ['NameInRequest']);
...
As an example, if Att1 is expected to be a Paws::ECR::ImageScanFindings object:
  ...
  $service_obj->Method(Att1 => { EnhancedFindings => $value, ..., VulnerabilitySourceUpdatedAt => $value  });
...
=head2 EnhancedFindings => ArrayRef[L<Paws::ECR::EnhancedImageScanFinding>]
