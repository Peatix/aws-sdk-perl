...
=head1 SYNOPSIS
    ...
    my $CompleteLayerUploadResponse = $api . ecr->CompleteLayerUpload(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/api.ecr/CompleteLayerUpload>
