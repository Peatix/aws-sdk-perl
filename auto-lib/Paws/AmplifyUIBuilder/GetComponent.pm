...
package Paws::AmplifyUIBuilder::GetComponent;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::AmplifyUIBuilder::GetComponentResponse');
1;
...
Paws::AmplifyUIBuilder::GetComponent - Arguments for method GetComponent on L<Paws::AmplifyUIBuilder>
...
=head1 SYNOPSIS
    ...
    my $GetComponentResponse = $amplifyuibuilder->GetComponent(
      AppId           => 'MyString',
    ...
    # Returns a L<Paws::AmplifyUIBuilder::GetComponentResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/amplifyuibuilder/GetComponent>
...
This class forms part of L<Paws>, documenting arguments for method GetComponent in L<Paws::AmplifyUIBuilder>
