...
package Paws::AmplifyUIBuilder::ListComponents;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::AmplifyUIBuilder::ListComponentsResponse');
1;
...
Paws::AmplifyUIBuilder::ListComponents - Arguments for method ListComponents on L<Paws::AmplifyUIBuilder>
...
=head1 SYNOPSIS
    ...
    my $ListComponentsResponse = $amplifyuibuilder->ListComponents(
      AppId           => 'MyString',
    ...
    # Results:
    my $Entities  = $ListComponentsResponse->Entities;
    my $NextToken = $ListComponentsResponse->NextToken;

    # Returns a L<Paws::AmplifyUIBuilder::ListComponentsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/amplifyuibuilder/ListComponents>
...
This class forms part of L<Paws>, documenting arguments for method ListComponents in L<Paws::AmplifyUIBuilder>
