...
package Paws::AmplifyUIBuilder::ThemeSummary;
  use Moose;
...
Paws::AmplifyUIBuilder::ThemeSummary
...
As an example, if Att1 is expected to be a Paws::AmplifyUIBuilder::ThemeSummary object:

  $service_obj->Method(Att1 => { AppId => $value, ..., Name => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::AmplifyUIBuilder::ThemeSummary object:
