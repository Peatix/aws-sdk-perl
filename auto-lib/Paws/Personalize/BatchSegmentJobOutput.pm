...
package Paws::Personalize::BatchSegmentJobOutput;
  use Moose;
...
Paws::Personalize::BatchSegmentJobOutput
...
As an example, if Att1 is expected to be a Paws::Personalize::BatchSegmentJobOutput object:

  $service_obj->Method(Att1 => { S3DataDestination => $value, ..., S3DataDestination => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Personalize::BatchSegmentJobOutput object:
