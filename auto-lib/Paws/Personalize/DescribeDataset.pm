...
package Paws::Personalize::DescribeDataset;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::Personalize::DescribeDatasetResponse');
...
Paws::Personalize::DescribeDataset - Arguments for method DescribeDataset on L<Paws::Personalize>
...
=head1 SYNOPSIS
    ...
    my $DescribeDatasetResponse = $personalize->DescribeDataset(
      DatasetArn => 'MyArn',
    ...
    # Returns a L<Paws::Personalize::DescribeDatasetResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method DescribeDataset in L<Paws::Personalize>
