package Paws::CodeArtifact;
  ...
  sub CreatePackageGroup {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeArtifact::CreatePackageGroup', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DeletePackage {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeArtifact::DeletePackage', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DeletePackageGroup {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeArtifact::DeletePackageGroup', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DescribePackage {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeArtifact::DescribePackage', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DescribePackageGroup {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeArtifact::DescribePackageGroup', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub GetAssociatedPackageGroup {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeArtifact::GetAssociatedPackageGroup', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ListAllowedRepositoriesForGroup {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeArtifact::ListAllowedRepositoriesForGroup', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ListAssociatedPackages {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeArtifact::ListAssociatedPackages', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ListDomains {
    my $self = shift;
  ...
  sub ListPackageGroups {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeArtifact::ListPackageGroups', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub ListPackages {
    my $self = shift;
  ...
  sub ListSubPackageGroups {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeArtifact::ListSubPackageGroups', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub PublishPackageVersion {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeArtifact::PublishPackageVersion', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub PutPackageOriginConfiguration {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeArtifact::PutPackageOriginConfiguration', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub UpdatePackageGroup {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeArtifact::UpdatePackageGroup', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub UpdatePackageGroupOriginConfiguration {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::CodeArtifact::UpdatePackageGroupOriginConfiguration', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ListAllAllowedRepositoriesForGroup {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->ListAllowedRepositoriesForGroup(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->nextToken) {
        $next_result = $self->ListAllowedRepositoriesForGroup(@_, nextToken => $next_result->nextToken);
        push @{ $result->allowedRepositories }, @{ $next_result->allowedRepositories };
      }
      return $result;
    } else {
      while ($result->nextToken) {
        $callback->($_ => 'allowedRepositories') foreach (@{ $result->allowedRepositories });
        $result = $self->ListAllowedRepositoriesForGroup(@_, nextToken => $result->nextToken);
      }
      $callback->($_ => 'allowedRepositories') foreach (@{ $result->allowedRepositories });
    }
  ...
  sub ListAllAssociatedPackages {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->ListAssociatedPackages(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->nextToken) {
        $next_result = $self->ListAssociatedPackages(@_, nextToken => $next_result->nextToken);
      ...
      while ($result->nextToken) {
        ...
        $result = $self->ListAssociatedPackages(@_, nextToken => $result->nextToken);
      }
      $callback->($_ => 'packages') foreach (@{ $result->packages });
    }
  ...
  sub ListAllPackageGroups {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->ListPackageGroups(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->nextToken) {
        $next_result = $self->ListPackageGroups(@_, nextToken => $next_result->nextToken);
        push @{ $result->packageGroups }, @{ $next_result->packageGroups };
      }
      return $result;
    } else {
      while ($result->nextToken) {
        $callback->($_ => 'packageGroups') foreach (@{ $result->packageGroups });
        $result = $self->ListPackageGroups(@_, nextToken => $result->nextToken);
      }
      $callback->($_ => 'packageGroups') foreach (@{ $result->packageGroups });
    }
  ...
  sub ListAllSubPackageGroups {
    my $self = shift;

    my $callback = shift @_ if (ref($_[0]) eq 'CODE');
    my $result = $self->ListSubPackageGroups(@_);
    my $next_result = $result;

    if (not defined $callback) {
      while ($next_result->nextToken) {
        $next_result = $self->ListSubPackageGroups(@_, nextToken => $next_result->nextToken);
        push @{ $result->packageGroups }, @{ $next_result->packageGroups };
      }
      return $result;
    } else {
      while ($result->nextToken) {
        $callback->($_ => 'packageGroups') foreach (@{ $result->packageGroups });
        $result = $self->ListSubPackageGroups(@_, nextToken => $result->nextToken);
      }
      $callback->($_ => 'packageGroups') foreach (@{ $result->packageGroups });
    }
...
packages using tools such as the B< C<npm> > CLI or the Maven CLI (B<
C<mvn> >). For a list of supported package managers, see the
...
supports npm, PyPI, Maven, NuGet, Swift, Ruby, Cargo, and generic
package formats. For more information about the supported package
formats and how to use CodeArtifact with them, see the CodeArtifact
User Guide
(https://docs.aws.amazon.com/codeartifact/latest/ug/welcome.html).
...
B<Package group>: A group of packages that match a specified
...
package namespace, and package name. You can use package groups to more
conveniently configure package origin controls for multiple packages.
Package origin controls are used to block or allow ingestion or
publishing of new package versions, which protects users from malicious
...
B<CodeArtifact supported API operations>
...
C<CreatePackageGroup>: Creates a package group.
...
C<DeletePackage>: Deletes a package and all associated package
versions.

=item *

C<DeletePackageGroup>: Deletes a package group. Does not delete
...
C<DescribePackage>: Returns a PackageDescription
...
C<DescribePackageGroup>: Returns a PackageGroup
...
C<GetAssociatedPackageGroup>: Returns the most closely associated
...
C<ListAllowedRepositoriesForGroup>: Lists the allowed repositories for
a package group that has origin configuration set to
C<ALLOW_SPECIFIC_REPOSITORIES>.

=item *

C<ListAssociatedPackages>: Returns a list of packages associated with
...
C<ListPackageGroups>: Returns a list of package groups in the requested
domain.
...
C<ListRepositories>: Returns a list of repositories owned by the Amazon
...
C<ListSubPackageGroups>: Returns a list of direct children of the
specified package group.

=item *

C<PublishPackageVersion>: Creates a new package version containing one
or more assets.
...
C<PutPackageOriginConfiguration>: Sets the package origin configuration
...
C<UpdatePackageGroup>: Updates a package group. This API cannot be used
to update a package group's origin configuration or pattern.

=item *

C<UpdatePackageGroupOriginConfiguration>: Updates the package origin
...
=head2 CreatePackageGroup

=over

=item Domain => Str

=item PackageGroup => Str

=item [ContactInfo => Str]
...
Each argument is described in detail in: L<Paws::CodeArtifact::CreatePackageGroup>

Returns: a L<Paws::CodeArtifact::CreatePackageGroupResult> instance

Creates a package group. For more information about creating package
groups, including example CLI commands, see Create a package group
...
Each argument is described in detail in: L<Paws::CodeArtifact::DeletePackage>

Returns: a L<Paws::CodeArtifact::DeletePackageResult> instance
...
Each argument is described in detail in: L<Paws::CodeArtifact::DeletePackageGroup>

Returns: a L<Paws::CodeArtifact::DeletePackageGroupResult> instance
...
Each argument is described in detail in: L<Paws::CodeArtifact::DescribePackage>

Returns: a L<Paws::CodeArtifact::DescribePackageResult> instance
...
Each argument is described in detail in: L<Paws::CodeArtifact::DescribePackageGroup>

Returns: a L<Paws::CodeArtifact::DescribePackageGroupResult> instance
...
=head2 GetAssociatedPackageGroup
...
Each argument is described in detail in: L<Paws::CodeArtifact::GetAssociatedPackageGroup>

Returns: a L<Paws::CodeArtifact::GetAssociatedPackageGroupResult> instance
...
repository in the domain. As such, C<GetAssociatedPackageGroup> can be
...
group definition syntax and matching behavior
...
about authorization tokens, see CodeArtifact authentication and tokens
...
=head2 ListAllowedRepositoriesForGroup

=over

=item Domain => Str

=item OriginRestrictionType => Str
...
Each argument is described in detail in: L<Paws::CodeArtifact::ListAllowedRepositoriesForGroup>

Returns: a L<Paws::CodeArtifact::ListAllowedRepositoriesForGroupResult> instance
...
Each argument is described in detail in: L<Paws::CodeArtifact::ListAssociatedPackages>

Returns: a L<Paws::CodeArtifact::ListAssociatedPackagesResult> instance
...
makes this call. Each returned C<DomainSummary> object contains
information about a domain.


=head2 ListPackageGroups
...
Each argument is described in detail in: L<Paws::CodeArtifact::ListPackageGroups>

Returns: a L<Paws::CodeArtifact::ListPackageGroupsResult> instance
...
parameters. Package versions of all statuses will be returned by
default when calling C<list-package-versions> with no C<--status>
parameter.
...
repository in the specified Amazon Web Services account and that
...
Each argument is described in detail in: L<Paws::CodeArtifact::ListSubPackageGroups>

Returns: a L<Paws::CodeArtifact::ListSubPackageGroupsResult> instance
...
=head2 PublishPackageVersion

=over

=item AssetContent => Str

=item AssetName => Str

=item AssetSHA256 => Str
...
=item [Unfinished => Bool]


=back

Each argument is described in detail in: L<Paws::CodeArtifact::PublishPackageVersion>

Returns: a L<Paws::CodeArtifact::PublishPackageVersionResult> instance

Creates a new package version containing one or more assets (or files).

The C<unfinished> flag can be used to keep the package version in the
C<Unfinished> state until all of its assets have been uploaded (see
...
in the I<CodeArtifact user guide>). To set the package versionE<rsquo>s
status to C<Published>, omit the C<unfinished> flag when uploading the
final asset, or set the status using UpdatePackageVersionStatus
(https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_UpdatePackageVersionsStatus.html).
Once a package versionE<rsquo>s status is set to C<Published>, it
cannot change back to C<Unfinished>.

Only generic packages can be published using this API. For more
information, see Using generic packages
(https://docs.aws.amazon.com/codeartifact/latest/ug/using-generic.html)
in the I<CodeArtifact User Guide>.
...
=head2 PutPackageOriginConfiguration
...
=item Restrictions => L<Paws::CodeArtifact::PackageOriginRestrictions>
...
Each argument is described in detail in: L<Paws::CodeArtifact::PutPackageOriginConfiguration>

Returns: a L<Paws::CodeArtifact::PutPackageOriginConfigurationResult> instance
...
C<PutPackageOriginConfiguration> can be called on a package that
...
Each argument is described in detail in: L<Paws::CodeArtifact::UpdatePackageGroup>

Returns: a L<Paws::CodeArtifact::UpdatePackageGroupResult> instance
...
origin configuration, use UpdatePackageGroupOriginConfiguration
(https://docs.aws.amazon.com/codeartifact/latest/APIReference/API_UpdatePackageGroupOriginConfiguration.html).


=head2 UpdatePackageGroupOriginConfiguration
...
=item [AddAllowedRepositories => ArrayRef[L<Paws::CodeArtifact::PackageGroupAllowedRepository>]]

=item [DomainOwner => Str]

=item [RemoveAllowedRepositories => ArrayRef[L<Paws::CodeArtifact::PackageGroupAllowedRepository>]]

=item [Restrictions => L<Paws::CodeArtifact::OriginRestrictions>]


=back

Each argument is described in detail in: L<Paws::CodeArtifact::UpdatePackageGroupOriginConfiguration>

Returns: a L<Paws::CodeArtifact::UpdatePackageGroupOriginConfigurationResult> instance
...
see Package group origin controls
(https://docs.aws.amazon.com/codeartifact/latest/ug/package-group-origin-controls.html)
in the I<CodeArtifact User Guide>.
...
C<UpdatePackageVersionsStatus>, you can update the status of package
versions to C<Archived>, C<Published>, or C<Unlisted>. To set the
status of a package version to C<Disposed>, use DisposePackageVersions
...
=head2 ListAllAllowedRepositoriesForGroup(sub { },Domain => Str, OriginRestrictionType => Str, PackageGroup => Str, [DomainOwner => Str, MaxResults => Int, NextToken => Str])

=head2 ListAllAllowedRepositoriesForGroup(Domain => Str, OriginRestrictionType => Str, PackageGroup => Str, [DomainOwner => Str, MaxResults => Int, NextToken => Str])


If passed a sub as first parameter, it will call the sub for each element found in :

 - allowedRepositories, passing the object as the first parameter, and the string 'allowedRepositories' as the second parameter 

If not, it will return a a L<Paws::CodeArtifact::ListAllowedRepositoriesForGroupResult> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.


=head2 ListAllAssociatedPackages(sub { },Domain => Str, PackageGroup => Str, [DomainOwner => Str, MaxResults => Int, NextToken => Str, Preview => Bool])

=head2 ListAllAssociatedPackages(Domain => Str, PackageGroup => Str, [DomainOwner => Str, MaxResults => Int, NextToken => Str, Preview => Bool])
...
If not, it will return a a L<Paws::CodeArtifact::ListAssociatedPackagesResult> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
...
=head2 ListAllPackageGroups(sub { },Domain => Str, [DomainOwner => Str, MaxResults => Int, NextToken => Str, Prefix => Str])

=head2 ListAllPackageGroups(Domain => Str, [DomainOwner => Str, MaxResults => Int, NextToken => Str, Prefix => Str])


If passed a sub as first parameter, it will call the sub for each element found in :

 - packageGroups, passing the object as the first parameter, and the string 'packageGroups' as the second parameter 

If not, it will return a a L<Paws::CodeArtifact::ListPackageGroupsResult> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.


=head2 ListAllPackages(sub { },Domain => Str, Repository => Str, [DomainOwner => Str, Format => Str, MaxResults => Int, Namespace => Str, NextToken => Str, PackagePrefix => Str, Publish => Str, Upstream => Str])

=head2 ListAllPackages(Domain => Str, Repository => Str, [DomainOwner => Str, Format => Str, MaxResults => Int, Namespace => Str, NextToken => Str, PackagePrefix => Str, Publish => Str, Upstream => Str])
...
=head2 ListAllPackageVersions(sub { },Domain => Str, Format => Str, Package => Str, Repository => Str, [DomainOwner => Str, MaxResults => Int, Namespace => Str, NextToken => Str, OriginType => Str, SortBy => Str, Status => Str])

=head2 ListAllPackageVersions(Domain => Str, Format => Str, Package => Str, Repository => Str, [DomainOwner => Str, MaxResults => Int, Namespace => Str, NextToken => Str, OriginType => Str, SortBy => Str, Status => Str])
...
=head2 ListAllSubPackageGroups(sub { },Domain => Str, PackageGroup => Str, [DomainOwner => Str, MaxResults => Int, NextToken => Str])

=head2 ListAllSubPackageGroups(Domain => Str, PackageGroup => Str, [DomainOwner => Str, MaxResults => Int, NextToken => Str])
...
If not, it will return a a L<Paws::CodeArtifact::ListSubPackageGroupsResult> instance with all the C<param>s;  from all the responses. Please take into account that this mode can potentially consume vasts ammounts of memory.
