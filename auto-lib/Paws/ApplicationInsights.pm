package Paws::ApplicationInsights;
  ...
  sub AddWorkload {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ApplicationInsights::AddWorkload', @_);
  ...
  sub DescribeWorkload {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ApplicationInsights::DescribeWorkload', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub ListWorkloads {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ApplicationInsights::ListWorkloads', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub RemoveWorkload {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::ApplicationInsights::RemoveWorkload', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub TagResource {
    my $self = shift;
...
=item WorkloadConfiguration => L<Paws::ApplicationInsights::WorkloadConfiguration>


=back

Each argument is described in detail in: L<Paws::ApplicationInsights::AddWorkload>

Returns: a L<Paws::ApplicationInsights::AddWorkloadResponse> instance
...
=item [AttachMissingPermission => Bool]

=item [AutoConfigEnabled => Bool]

=item [AutoCreate => Bool]

=item [CWEMonitorEnabled => Bool]

=item [GroupingType => Str]
...
Each argument is described in detail in: L<Paws::ApplicationInsights::DescribeWorkload>

Returns: a L<Paws::ApplicationInsights::DescribeWorkloadResponse> instance
...
Each argument is described in detail in: L<Paws::ApplicationInsights::ListWorkloads>

Returns: a L<Paws::ApplicationInsights::ListWorkloadsResponse> instance

Lists the workloads that are configured on a given component.


=head2 RemoveWorkload
...
Each argument is described in detail in: L<Paws::ApplicationInsights::RemoveWorkload>

Returns: a L<Paws::ApplicationInsights::RemoveWorkloadResponse> instance
...
Each argument is described in detail in: L<Paws::ApplicationInsights::UpdateProblem>

Returns: a L<Paws::ApplicationInsights::UpdateProblemResponse> instance
...
Each argument is described in detail in: L<Paws::ApplicationInsights::UpdateWorkload>

Returns: a L<Paws::ApplicationInsights::UpdateWorkloadResponse> instance
