...
package Paws::WAF::GetRule;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAF::GetRuleResponse');
...
Paws::WAF::GetRule - Arguments for method GetRule on L<Paws::WAF>
...
=head1 SYNOPSIS
    ...
    my $GetRuleResponse =
      $waf->GetRule( 'RuleId' => 'example1ds3t-46da-4fdb-b8d5-abc321j569j5' );

    # Results:
    my $Rule = $GetRuleResponse->Rule;

    # Returns a L<Paws::WAF::GetRuleResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method GetRule in L<Paws::WAF>
