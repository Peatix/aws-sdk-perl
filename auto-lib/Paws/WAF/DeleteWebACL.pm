...
package Paws::WAF::DeleteWebACL;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAF::DeleteWebACLResponse');
...
This class forms part of L<Paws>, documenting arguments for method DeleteWebACL in L<Paws::WAF>
