...
Paws::WAF::GetSqlInjectionMatchSet - Arguments for method GetSqlInjectionMatchSet on L<Paws::WAF>
...
=head1 SYNOPSIS
   ...
   # the ID example1ds3t-46da-4fdb-b8d5-abc321j569j5.
    my $GetSqlInjectionMatchSetResponse = $waf->GetSqlInjectionMatchSet(
    ...
    # Returns a L<Paws::WAF::GetSqlInjectionMatchSetResponse> object.
