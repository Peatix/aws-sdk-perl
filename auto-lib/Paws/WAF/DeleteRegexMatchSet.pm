...
package Paws::WAF::DeleteRegexMatchSet;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAF::DeleteRegexMatchSetResponse');
...
Paws::WAF::DeleteRegexMatchSet - Arguments for method DeleteRegexMatchSet on L<Paws::WAF>
...
=head1 SYNOPSIS
    ...
    my $DeleteRegexMatchSetResponse = $waf->DeleteRegexMatchSet(
    ...
    # Returns a L<Paws::WAF::DeleteRegexMatchSetResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method DeleteRegexMatchSet in L<Paws::WAF>
