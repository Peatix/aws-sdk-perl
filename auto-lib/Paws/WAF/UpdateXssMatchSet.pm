...
package Paws::WAF::UpdateXssMatchSet;
  use Moose;
  has ChangeToken => (is => 'ro', isa => 'Str', required => 1);
  has Updates => (is => 'ro', isa => 'ArrayRef[Paws::WAF::XssMatchSetUpdate]', required => 1);
  has XssMatchSetId => (is => 'ro', isa => 'Str', required => 1);

  use MooseX::ClassAttribute;

  class_has _api_call => (isa => 'Str', is => 'ro', default => 'UpdateXssMatchSet');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAF::UpdateXssMatchSetResponse');
...
Paws::WAF::UpdateXssMatchSet - Arguments for method UpdateXssMatchSet on L<Paws::WAF>
...
=head1 SYNOPSIS
    ...
    # Returns a L<Paws::WAF::UpdateXssMatchSetResponse> object.
...
=head2 B<REQUIRED> Updates => ArrayRef[L<Paws::WAF::XssMatchSetUpdate>]
...
This class forms part of L<Paws>, documenting arguments for method UpdateXssMatchSet in L<Paws::WAF>
