...
package Paws::WAF::PutLoggingConfiguration;
  use Moose;
  has LoggingConfiguration => (is => 'ro', isa => 'Paws::WAF::LoggingConfiguration', required => 1);

  use MooseX::ClassAttribute;

  class_has _api_call => (isa => 'Str', is => 'ro', default => 'PutLoggingConfiguration');
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAF::PutLoggingConfigurationResponse');
...
Paws::WAF::PutLoggingConfiguration - Arguments for method PutLoggingConfiguration on L<Paws::WAF>
...
=head1 SYNOPSIS
    ...
    my $PutLoggingConfigurationResponse = $waf->PutLoggingConfiguration(
    ...
    # Returns a L<Paws::WAF::PutLoggingConfigurationResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method PutLoggingConfiguration in L<Paws::WAF>
