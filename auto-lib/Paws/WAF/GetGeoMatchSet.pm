...
Paws::WAF::GetGeoMatchSet - Arguments for method GetGeoMatchSet on L<Paws::WAF>
...
=head1 SYNOPSIS
    ...
    my $GetGeoMatchSetResponse = $waf->GetGeoMatchSet(
    ...
    # Returns a L<Paws::WAF::GetGeoMatchSetResponse> object.
