...
package Paws::WAF::CreateRegexMatchSet;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAF::CreateRegexMatchSetResponse');
...
Paws::WAF::CreateRegexMatchSet - Arguments for method CreateRegexMatchSet on L<Paws::WAF>
...
=head1 SYNOPSIS
    ...
    my $CreateRegexMatchSetResponse = $waf->CreateRegexMatchSet(
    ...
    # Returns a L<Paws::WAF::CreateRegexMatchSetResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method CreateRegexMatchSet in L<Paws::WAF>
