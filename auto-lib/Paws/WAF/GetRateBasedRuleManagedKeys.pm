...
package Paws::WAF::GetRateBasedRuleManagedKeys;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAF::GetRateBasedRuleManagedKeysResponse');
...
Paws::WAF::GetRateBasedRuleManagedKeys - Arguments for method GetRateBasedRuleManagedKeys on L<Paws::WAF>
...
This class forms part of L<Paws>, documenting arguments for method GetRateBasedRuleManagedKeys in L<Paws::WAF>
