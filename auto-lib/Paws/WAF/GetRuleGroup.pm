...
package Paws::WAF::GetRuleGroup;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAF::GetRuleGroupResponse');
...
Paws::WAF::GetRuleGroup - Arguments for method GetRuleGroup on L<Paws::WAF>
...
=head1 SYNOPSIS
    ...
    my $GetRuleGroupResponse = $waf->GetRuleGroup(
    ...
    # Returns a L<Paws::WAF::GetRuleGroupResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method GetRuleGroup in L<Paws::WAF>
