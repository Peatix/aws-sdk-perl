...
package Paws::WAF::CreateRegexPatternSet;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAF::CreateRegexPatternSetResponse');
...
Paws::WAF::CreateRegexPatternSet - Arguments for method CreateRegexPatternSet on L<Paws::WAF>
...
=head1 SYNOPSIS
    ...
    my $CreateRegexPatternSetResponse = $waf->CreateRegexPatternSet(
...
This class forms part of L<Paws>, documenting arguments for method CreateRegexPatternSet in L<Paws::WAF>
