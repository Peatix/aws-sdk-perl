...
package Paws::WAF::ListLoggingConfigurations;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAF::ListLoggingConfigurationsResponse');
...
Paws::WAF::ListLoggingConfigurations - Arguments for method ListLoggingConfigurations on L<Paws::WAF>
...
=head1 SYNOPSIS
    ...
    my $ListLoggingConfigurationsResponse = $waf->ListLoggingConfigurations(
      Limit      => 1,                 # OPTIONAL
    ...
    # Returns a L<Paws::WAF::ListLoggingConfigurationsResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method ListLoggingConfigurations in L<Paws::WAF>
