...
package Paws::WAF::ListSubscribedRuleGroups;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAF::ListSubscribedRuleGroupsResponse');
...
Paws::WAF::ListSubscribedRuleGroups - Arguments for method ListSubscribedRuleGroups on L<Paws::WAF>
...
=head1 SYNOPSIS
    ...
    my $ListSubscribedRuleGroupsResponse = $waf->ListSubscribedRuleGroups(
      Limit      => 1,                 # OPTIONAL
    ...
    # Returns a L<Paws::WAF::ListSubscribedRuleGroupsResponse> object.
...
This class forms part of L<Paws>, documenting arguments for method ListSubscribedRuleGroups in L<Paws::WAF>
