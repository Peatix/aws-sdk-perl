...
package Paws::WAFV2::RateLimitQueryArgument;
  use Moose;
...
Paws::WAFV2::RateLimitQueryArgument
...
As an example, if Att1 is expected to be a Paws::WAFV2::RateLimitQueryArgument object:

  $service_obj->Method(Att1 => { Name => $value, ..., TextTransformations => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::WAFV2::RateLimitQueryArgument object:
