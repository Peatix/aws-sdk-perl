...
package Paws::WAFV2::RateLimitUriPath;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::WAFV2::RateLimitUriPath object:

  $service_obj->Method(Att1 => { TextTransformations => $value, ..., TextTransformations => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::WAFV2::RateLimitUriPath object:
