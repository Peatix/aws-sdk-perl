...
package Paws::WAFV2::DeleteWebACL;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAFV2::DeleteWebACLResponse');
...
Paws::WAFV2::DeleteWebACL - Arguments for method DeleteWebACL on L<Paws::WAFV2>
...
=head1 SYNOPSIS
    ...
    my $DeleteWebACLResponse = $wafv2->DeleteWebACL(
      Id        => 'MyEntityId',
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/wafv2/DeleteWebACL>
...
This class forms part of L<Paws>, documenting arguments for method DeleteWebACL in L<Paws::WAFV2>
