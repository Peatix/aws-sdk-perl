...
package Paws::WAFV2::ListAPIKeys;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAFV2::ListAPIKeysResponse');
...
Paws::WAFV2::ListAPIKeys - Arguments for method ListAPIKeys on L<Paws::WAFV2>
...
=head1 SYNOPSIS
    ...
    my $ListAPIKeysResponse = $wafv2->ListAPIKeys(
      Scope      => 'CLOUDFRONT',
      Limit      => 1,                 # OPTIONAL
    ...
    # Results:
    my $APIKeySummaries = $ListAPIKeysResponse->APIKeySummaries;
    my $ApplicationIntegrationURL =
      $ListAPIKeysResponse->ApplicationIntegrationURL;
    my $NextMarker = $ListAPIKeysResponse->NextMarker;

    # Returns a L<Paws::WAFV2::ListAPIKeysResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/wafv2/ListAPIKeys>
...
This class forms part of L<Paws>, documenting arguments for method ListAPIKeys in L<Paws::WAFV2>
