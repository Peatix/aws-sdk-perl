...
package Paws::WAFV2::DeletePermissionPolicy;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WAFV2::DeletePermissionPolicyResponse');
...
Paws::WAFV2::DeletePermissionPolicy - Arguments for method DeletePermissionPolicy on L<Paws::WAFV2>
...
=head1 SYNOPSIS
    ...
    my $DeletePermissionPolicyResponse = $wafv2->DeletePermissionPolicy(
...
This class forms part of L<Paws>, documenting arguments for method DeletePermissionPolicy in L<Paws::WAFV2>
