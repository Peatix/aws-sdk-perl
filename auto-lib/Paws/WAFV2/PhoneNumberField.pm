...
package Paws::WAFV2::PhoneNumberField;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::WAFV2::PhoneNumberField object:

  $service_obj->Method(Att1 => { Identifier => $value, ..., Identifier => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::WAFV2::PhoneNumberField object:
