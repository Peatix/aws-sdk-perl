...
package Paws::WAFV2::JA3Fingerprint;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::WAFV2::JA3Fingerprint object:

  $service_obj->Method(Att1 => { FallbackBehavior => $value, ..., FallbackBehavior => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::WAFV2::JA3Fingerprint object:
