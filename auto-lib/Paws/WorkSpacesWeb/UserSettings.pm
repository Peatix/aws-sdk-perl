...
package Paws::WorkSpacesWeb::UserSettings;
  use Moose;
...
Paws::WorkSpacesWeb::UserSettings
...
As an example, if Att1 is expected to be a Paws::WorkSpacesWeb::UserSettings object:

  $service_obj->Method(Att1 => { AdditionalEncryptionContext => $value, ..., UserSettingsArn => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::WorkSpacesWeb::UserSettings object:
