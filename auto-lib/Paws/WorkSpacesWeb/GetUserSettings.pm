...
package Paws::WorkSpacesWeb::GetUserSettings;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WorkSpacesWeb::GetUserSettingsResponse');
1;
...
Paws::WorkSpacesWeb::GetUserSettings - Arguments for method GetUserSettings on L<Paws::WorkSpacesWeb>
...
=head1 SYNOPSIS
    ...
    my $GetUserSettingsResponse = $workspaces -web->GetUserSettings(
    ...
    # Returns a L<Paws::WorkSpacesWeb::GetUserSettingsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/workspaces-web/GetUserSettings>
...
This class forms part of L<Paws>, documenting arguments for method GetUserSettings in L<Paws::WorkSpacesWeb>
