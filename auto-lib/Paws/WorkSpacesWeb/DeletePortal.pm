...
package Paws::WorkSpacesWeb::DeletePortal;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::WorkSpacesWeb::DeletePortalResponse');
1;
...
Paws::WorkSpacesWeb::DeletePortal - Arguments for method DeletePortal on L<Paws::WorkSpacesWeb>
...
=head1 SYNOPSIS
    ...
    my $DeletePortalResponse = $workspaces -web->DeletePortal(
      PortalArn => 'MyARN',

    );

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/workspaces-web/DeletePortal>
...
This class forms part of L<Paws>, documenting arguments for method DeletePortal in L<Paws::WorkSpacesWeb>
