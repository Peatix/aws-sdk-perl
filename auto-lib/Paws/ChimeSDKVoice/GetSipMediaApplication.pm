...
package Paws::ChimeSDKVoice::GetSipMediaApplication;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ChimeSDKVoice::GetSipMediaApplicationResponse');
1;
...
Paws::ChimeSDKVoice::GetSipMediaApplication - Arguments for method GetSipMediaApplication on L<Paws::ChimeSDKVoice>
...
=head1 SYNOPSIS
    ...
    my $GetSipMediaApplicationResponse = $voice -chime->GetSipMediaApplication(
    ...
    # Returns a L<Paws::ChimeSDKVoice::GetSipMediaApplicationResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/voice-chime/GetSipMediaApplication>
...
This class forms part of L<Paws>, documenting arguments for method GetSipMediaApplication in L<Paws::ChimeSDKVoice>
