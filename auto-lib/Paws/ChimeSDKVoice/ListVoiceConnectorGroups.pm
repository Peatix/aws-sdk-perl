...
package Paws::ChimeSDKVoice::ListVoiceConnectorGroups;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ChimeSDKVoice::ListVoiceConnectorGroupsResponse');
1;
...
Paws::ChimeSDKVoice::ListVoiceConnectorGroups - Arguments for method ListVoiceConnectorGroups on L<Paws::ChimeSDKVoice>
...
=head1 SYNOPSIS
    ...
    my $ListVoiceConnectorGroupsResponse =
      $voice -chime->ListVoiceConnectorGroups(
    ...
    # Returns a L<Paws::ChimeSDKVoice::ListVoiceConnectorGroupsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/voice-chime/ListVoiceConnectorGroups>
...
This class forms part of L<Paws>, documenting arguments for method ListVoiceConnectorGroups in L<Paws::ChimeSDKVoice>
