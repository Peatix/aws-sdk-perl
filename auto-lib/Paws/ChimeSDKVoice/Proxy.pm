...
package Paws::ChimeSDKVoice::Proxy;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::ChimeSDKVoice::Proxy object:

  $service_obj->Method(Att1 => { DefaultSessionExpiryMinutes => $value, ..., PhoneNumberCountries => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ChimeSDKVoice::Proxy object:
