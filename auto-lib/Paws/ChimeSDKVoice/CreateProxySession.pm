...
package Paws::ChimeSDKVoice::CreateProxySession;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ChimeSDKVoice::CreateProxySessionResponse');
1;
...
Paws::ChimeSDKVoice::CreateProxySession - Arguments for method CreateProxySession on L<Paws::ChimeSDKVoice>
...
=head1 SYNOPSIS
    ...
    my $CreateProxySessionResponse = $voice -chime->CreateProxySession(
      Capabilities => [
    ...
    # Returns a L<Paws::ChimeSDKVoice::CreateProxySessionResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/voice-chime/CreateProxySession>
...
This class forms part of L<Paws>, documenting arguments for method CreateProxySession in L<Paws::ChimeSDKVoice>
