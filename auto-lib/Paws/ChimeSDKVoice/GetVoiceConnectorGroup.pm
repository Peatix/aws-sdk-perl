...
package Paws::ChimeSDKVoice::GetVoiceConnectorGroup;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ChimeSDKVoice::GetVoiceConnectorGroupResponse');
1;
...
Paws::ChimeSDKVoice::GetVoiceConnectorGroup - Arguments for method GetVoiceConnectorGroup on L<Paws::ChimeSDKVoice>
...
=head1 SYNOPSIS
    ...
    my $GetVoiceConnectorGroupResponse = $voice -chime->GetVoiceConnectorGroup(
    ...
    # Returns a L<Paws::ChimeSDKVoice::GetVoiceConnectorGroupResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/voice-chime/GetVoiceConnectorGroup>
...
This class forms part of L<Paws>, documenting arguments for method GetVoiceConnectorGroup in L<Paws::ChimeSDKVoice>
