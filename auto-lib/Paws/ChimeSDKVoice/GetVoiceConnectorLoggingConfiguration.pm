...
package Paws::ChimeSDKVoice::GetVoiceConnectorLoggingConfiguration;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ChimeSDKVoice::GetVoiceConnectorLoggingConfigurationResponse');
1;
...
Paws::ChimeSDKVoice::GetVoiceConnectorLoggingConfiguration - Arguments for method GetVoiceConnectorLoggingConfiguration on L<Paws::ChimeSDKVoice>
...
=head1 SYNOPSIS
    ...
    my $GetVoiceConnectorLoggingConfigurationResponse =
      $voice -chime->GetVoiceConnectorLoggingConfiguration(
...
# Returns a L<Paws::ChimeSDKVoice::GetVoiceConnectorLoggingConfigurationResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/voice-chime/GetVoiceConnectorLoggingConfiguration>
...
This class forms part of L<Paws>, documenting arguments for method GetVoiceConnectorLoggingConfiguration in L<Paws::ChimeSDKVoice>
