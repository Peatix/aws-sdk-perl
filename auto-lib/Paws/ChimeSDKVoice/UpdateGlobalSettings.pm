...
package Paws::ChimeSDKVoice::UpdateGlobalSettings;
  use Moose;
...
Paws::ChimeSDKVoice::UpdateGlobalSettings - Arguments for method UpdateGlobalSettings on L<Paws::ChimeSDKVoice>
...
=head1 SYNOPSIS
    ...
    $voice -chime->UpdateGlobalSettings(
      VoiceConnector => {
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/voice-chime/UpdateGlobalSettings>
...
This class forms part of L<Paws>, documenting arguments for method UpdateGlobalSettings in L<Paws::ChimeSDKVoice>
