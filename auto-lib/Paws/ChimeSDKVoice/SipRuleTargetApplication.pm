...
package Paws::ChimeSDKVoice::SipRuleTargetApplication;
  use Moose;
...
Paws::ChimeSDKVoice::SipRuleTargetApplication
...
As an example, if Att1 is expected to be a Paws::ChimeSDKVoice::SipRuleTargetApplication object:

  $service_obj->Method(Att1 => { AwsRegion => $value, ..., SipMediaApplicationId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ChimeSDKVoice::SipRuleTargetApplication object:
