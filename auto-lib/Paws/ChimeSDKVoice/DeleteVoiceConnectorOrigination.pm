...
package Paws::ChimeSDKVoice::DeleteVoiceConnectorOrigination;
  use Moose;
...
Paws::ChimeSDKVoice::DeleteVoiceConnectorOrigination - Arguments for method DeleteVoiceConnectorOrigination on L<Paws::ChimeSDKVoice>
...
=head1 SYNOPSIS
    ...
    $voice -chime->DeleteVoiceConnectorOrigination(
      VoiceConnectorId => 'MyNonEmptyString',

    );

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/voice-chime/DeleteVoiceConnectorOrigination>
...
This class forms part of L<Paws>, documenting arguments for method DeleteVoiceConnectorOrigination in L<Paws::ChimeSDKVoice>
