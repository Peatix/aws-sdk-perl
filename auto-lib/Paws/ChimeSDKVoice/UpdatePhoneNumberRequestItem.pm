...
package Paws::ChimeSDKVoice::UpdatePhoneNumberRequestItem;
  use Moose;
...
Paws::ChimeSDKVoice::UpdatePhoneNumberRequestItem
...
As an example, if Att1 is expected to be a Paws::ChimeSDKVoice::UpdatePhoneNumberRequestItem object:

  $service_obj->Method(Att1 => { CallingName => $value, ..., ProductType => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ChimeSDKVoice::UpdatePhoneNumberRequestItem object:
