...
package Paws::ChimeSDKVoice::Participant;
  use Moose;
...
Paws::ChimeSDKVoice::Participant
...
As an example, if Att1 is expected to be a Paws::ChimeSDKVoice::Participant object:

  $service_obj->Method(Att1 => { PhoneNumber => $value, ..., ProxyPhoneNumber => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ChimeSDKVoice::Participant object:
