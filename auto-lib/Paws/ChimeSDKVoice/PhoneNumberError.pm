...
package Paws::ChimeSDKVoice::PhoneNumberError;
  use Moose;
...
Paws::ChimeSDKVoice::PhoneNumberError
...
As an example, if Att1 is expected to be a Paws::ChimeSDKVoice::PhoneNumberError object:

  $service_obj->Method(Att1 => { ErrorCode => $value, ..., PhoneNumberId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ChimeSDKVoice::PhoneNumberError object:
