...
package Paws::ChimeSDKVoice::DeleteProxySession;
  use Moose;
...
Paws::ChimeSDKVoice::DeleteProxySession - Arguments for method DeleteProxySession on L<Paws::ChimeSDKVoice>
...
=head1 SYNOPSIS
    ...
    $voice -chime->DeleteProxySession(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/voice-chime/DeleteProxySession>
...
This class forms part of L<Paws>, documenting arguments for method DeleteProxySession in L<Paws::ChimeSDKVoice>
