...
package Paws::ChimeSDKVoice::Termination;
  use Moose;
...
Paws::ChimeSDKVoice::Termination
...
As an example, if Att1 is expected to be a Paws::ChimeSDKVoice::Termination object:

  $service_obj->Method(Att1 => { CallingRegions => $value, ..., Disabled => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ChimeSDKVoice::Termination object:
