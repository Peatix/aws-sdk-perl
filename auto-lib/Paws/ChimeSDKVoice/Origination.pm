...
package Paws::ChimeSDKVoice::Origination;
  use Moose;
  has Disabled => (is => 'ro', isa => 'Bool');
  has Routes => (is => 'ro', isa => 'ArrayRef[Paws::ChimeSDKVoice::OriginationRoute]');
...
Paws::ChimeSDKVoice::Origination
...
As an example, if Att1 is expected to be a Paws::ChimeSDKVoice::Origination object:

  $service_obj->Method(Att1 => { Disabled => $value, ..., Routes => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ChimeSDKVoice::Origination object:
...
required, but you must specify this parameter or C<Routes>.


=head2 Routes => ArrayRef[L<Paws::ChimeSDKVoice::OriginationRoute>]
...
required, but you must specify this parameter or C<Disabled>.
