...
package Paws::ChimeSDKVoice::PhoneNumberCapabilities;
  use Moose;
...
Paws::ChimeSDKVoice::PhoneNumberCapabilities
...
As an example, if Att1 is expected to be a Paws::ChimeSDKVoice::PhoneNumberCapabilities object:

  $service_obj->Method(Att1 => { InboundCall => $value, ..., OutboundSMS => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ChimeSDKVoice::PhoneNumberCapabilities object:
