...
Paws::ChimeSDKVoice::SipMediaApplication
...
As an example, if Att1 is expected to be a Paws::ChimeSDKVoice::SipMediaApplication object:

  $service_obj->Method(Att1 => { AwsRegion => $value, ..., UpdatedTimestamp => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::ChimeSDKVoice::SipMediaApplication object:
...
=head2 SipMediaApplicationArn => Str
