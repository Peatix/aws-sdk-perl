...
package Paws::ChimeSDKVoice::PutVoiceConnectorProxy;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ChimeSDKVoice::PutVoiceConnectorProxyResponse');
1;
...
Paws::ChimeSDKVoice::PutVoiceConnectorProxy - Arguments for method PutVoiceConnectorProxy on L<Paws::ChimeSDKVoice>
...
=head1 SYNOPSIS
    ...
    my $PutVoiceConnectorProxyResponse = $voice -chime->PutVoiceConnectorProxy(
    ...
    # Returns a L<Paws::ChimeSDKVoice::PutVoiceConnectorProxyResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/voice-chime/PutVoiceConnectorProxy>
...
This class forms part of L<Paws>, documenting arguments for method PutVoiceConnectorProxy in L<Paws::ChimeSDKVoice>
