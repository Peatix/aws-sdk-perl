...
package Paws::ChimeSDKVoice::DisassociatePhoneNumbersFromVoiceConnectorGroup;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ChimeSDKVoice::DisassociatePhoneNumbersFromVoiceConnectorGroupResponse');
1;
...
Paws::ChimeSDKVoice::DisassociatePhoneNumbersFromVoiceConnectorGroup - Arguments for method DisassociatePhoneNumbersFromVoiceConnectorGroup on L<Paws::ChimeSDKVoice>
...
=head1 SYNOPSIS
    ...
    my $DisassociatePhoneNumbersFromVoiceConnectorGroupResponse =
      $voice -chime->DisassociatePhoneNumbersFromVoiceConnectorGroup(
...
# Returns a L<Paws::ChimeSDKVoice::DisassociatePhoneNumbersFromVoiceConnectorGroupResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/voice-chime/DisassociatePhoneNumbersFromVoiceConnectorGroup>
...
This class forms part of L<Paws>, documenting arguments for method DisassociatePhoneNumbersFromVoiceConnectorGroup in L<Paws::ChimeSDKVoice>
