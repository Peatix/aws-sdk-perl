...
package Paws::ChimeSDKVoice::UpdateSipRule;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ChimeSDKVoice::UpdateSipRuleResponse');
1;
...
Paws::ChimeSDKVoice::UpdateSipRule - Arguments for method UpdateSipRule on L<Paws::ChimeSDKVoice>
...
=head1 SYNOPSIS
    ...
    my $UpdateSipRuleResponse = $voice -chime->UpdateSipRule(
      Name               => 'MySipRuleName',
    ...
    # Returns a L<Paws::ChimeSDKVoice::UpdateSipRuleResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/voice-chime/UpdateSipRule>
...
This class forms part of L<Paws>, documenting arguments for method UpdateSipRule in L<Paws::ChimeSDKVoice>
