...
package Paws::ChimeSDKVoice::UpdateSipMediaApplicationCall;
  use Moose;
  has Arguments => (is => 'ro', isa => 'Paws::ChimeSDKVoice::SMAUpdateCallArgumentsMap', required => 1);
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ChimeSDKVoice::UpdateSipMediaApplicationCallResponse');
1;
...
Paws::ChimeSDKVoice::UpdateSipMediaApplicationCall - Arguments for method UpdateSipMediaApplicationCall on L<Paws::ChimeSDKVoice>
...
=head1 SYNOPSIS
    ...
    my $UpdateSipMediaApplicationCallResponse =
      $voice -chime->UpdateSipMediaApplicationCall(
...
# Returns a L<Paws::ChimeSDKVoice::UpdateSipMediaApplicationCallResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/voice-chime/UpdateSipMediaApplicationCall>

=head1 ATTRIBUTES


=head2 B<REQUIRED> Arguments => L<Paws::ChimeSDKVoice::SMAUpdateCallArgumentsMap>
...
This class forms part of L<Paws>, documenting arguments for method UpdateSipMediaApplicationCall in L<Paws::ChimeSDKVoice>
