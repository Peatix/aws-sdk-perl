...
package Paws::ChimeSDKVoice::DeleteVoiceConnectorStreamingConfiguration;
  use Moose;
...
Paws::ChimeSDKVoice::DeleteVoiceConnectorStreamingConfiguration - Arguments for method DeleteVoiceConnectorStreamingConfiguration on L<Paws::ChimeSDKVoice>
...
=head1 SYNOPSIS
    ...
    $voice -chime->DeleteVoiceConnectorStreamingConfiguration(
      VoiceConnectorId => 'MyNonEmptyString',

    );

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/voice-chime/DeleteVoiceConnectorStreamingConfiguration>
...
This class forms part of L<Paws>, documenting arguments for method DeleteVoiceConnectorStreamingConfiguration in L<Paws::ChimeSDKVoice>
