...
package Paws::ChimeSDKVoice::ListVoiceConnectors;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ChimeSDKVoice::ListVoiceConnectorsResponse');
1;
...
Paws::ChimeSDKVoice::ListVoiceConnectors - Arguments for method ListVoiceConnectors on L<Paws::ChimeSDKVoice>
...
=head1 SYNOPSIS
    ...
    my $ListVoiceConnectorsResponse = $voice -chime->ListVoiceConnectors(
    ...
    # Returns a L<Paws::ChimeSDKVoice::ListVoiceConnectorsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/voice-chime/ListVoiceConnectors>
...
This class forms part of L<Paws>, documenting arguments for method ListVoiceConnectors in L<Paws::ChimeSDKVoice>
