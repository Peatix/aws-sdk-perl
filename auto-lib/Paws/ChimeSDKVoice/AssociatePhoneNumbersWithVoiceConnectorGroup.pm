...
package Paws::ChimeSDKVoice::AssociatePhoneNumbersWithVoiceConnectorGroup;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ChimeSDKVoice::AssociatePhoneNumbersWithVoiceConnectorGroupResponse');
1;
...
Paws::ChimeSDKVoice::AssociatePhoneNumbersWithVoiceConnectorGroup - Arguments for method AssociatePhoneNumbersWithVoiceConnectorGroup on L<Paws::ChimeSDKVoice>
...
=head1 SYNOPSIS
    ...
    my $AssociatePhoneNumbersWithVoiceConnectorGroupResponse =
      $voice -chime->AssociatePhoneNumbersWithVoiceConnectorGroup(
...
# Returns a L<Paws::ChimeSDKVoice::AssociatePhoneNumbersWithVoiceConnectorGroupResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/voice-chime/AssociatePhoneNumbersWithVoiceConnectorGroup>
...
This class forms part of L<Paws>, documenting arguments for method AssociatePhoneNumbersWithVoiceConnectorGroup in L<Paws::ChimeSDKVoice>
