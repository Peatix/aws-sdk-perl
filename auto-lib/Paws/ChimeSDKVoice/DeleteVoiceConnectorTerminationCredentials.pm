...
package Paws::ChimeSDKVoice::DeleteVoiceConnectorTerminationCredentials;
  use Moose;
...
Paws::ChimeSDKVoice::DeleteVoiceConnectorTerminationCredentials - Arguments for method DeleteVoiceConnectorTerminationCredentials on L<Paws::ChimeSDKVoice>
...
=head1 SYNOPSIS
    ...
    $voice -chime->DeleteVoiceConnectorTerminationCredentials(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/voice-chime/DeleteVoiceConnectorTerminationCredentials>
...
This class forms part of L<Paws>, documenting arguments for method DeleteVoiceConnectorTerminationCredentials in L<Paws::ChimeSDKVoice>
