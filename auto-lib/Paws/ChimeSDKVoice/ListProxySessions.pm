...
package Paws::ChimeSDKVoice::ListProxySessions;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::ChimeSDKVoice::ListProxySessionsResponse');
1;
...
Paws::ChimeSDKVoice::ListProxySessions - Arguments for method ListProxySessions on L<Paws::ChimeSDKVoice>
...
=head1 SYNOPSIS
    ...
    my $ListProxySessionsResponse = $voice -chime->ListProxySessions(
    ...
    # Returns a L<Paws::ChimeSDKVoice::ListProxySessionsResponse> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/voice-chime/ListProxySessions>
...
This class forms part of L<Paws>, documenting arguments for method ListProxySessions in L<Paws::ChimeSDKVoice>
