...
package Paws::S3Control::GetBucketReplication;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::S3Control::GetBucketReplicationResult');
...
Paws::S3Control::GetBucketReplication - Arguments for method GetBucketReplication on L<Paws::S3Control>
...
=head1 SYNOPSIS
    ...
    my $GetBucketReplicationResult = $s3 -control->GetBucketReplication(
    ...
    my $ReplicationConfiguration =
      $GetBucketReplicationResult->ReplicationConfiguration;

    # Returns a L<Paws::S3Control::GetBucketReplicationResult> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/s3-control/GetBucketReplication>
...
This class forms part of L<Paws>, documenting arguments for method GetBucketReplication in L<Paws::S3Control>
