...
package Paws::S3Control::DeleteBucketReplication;
  use Moose;
...
Paws::S3Control::DeleteBucketReplication - Arguments for method DeleteBucketReplication on L<Paws::S3Control>
...
=head1 SYNOPSIS
    ...
    $s3 -control->DeleteBucketReplication(
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/s3-control/DeleteBucketReplication>
...
This class forms part of L<Paws>, documenting arguments for method DeleteBucketReplication in L<Paws::S3Control>
