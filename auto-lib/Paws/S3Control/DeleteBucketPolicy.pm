...
package Paws::S3Control::DeleteBucketPolicy;
  use Moose;
...
Paws::S3Control::DeleteBucketPolicy - Arguments for method DeleteBucketPolicy on L<Paws::S3Control>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/s3-control/DeleteBucketPolicy>
...
This class forms part of L<Paws>, documenting arguments for method DeleteBucketPolicy in L<Paws::S3Control>
