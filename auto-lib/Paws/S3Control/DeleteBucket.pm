...
package Paws::S3Control::DeleteBucket;
  use Moose;
...
Paws::S3Control::DeleteBucket - Arguments for method DeleteBucket on L<Paws::S3Control>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/s3-control/DeleteBucket>
...
This class forms part of L<Paws>, documenting arguments for method DeleteBucket in L<Paws::S3Control>
