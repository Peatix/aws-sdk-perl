...
As an example, if Att1 is expected to be a Paws::S3Control::Region object:

  $service_obj->Method(Att1 => { Bucket => $value, ..., BucketAccountId => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::S3Control::Region object:
