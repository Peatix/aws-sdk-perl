...
package Paws::S3Control::StorageLensDataExport;
  use Moose;
  has CloudWatchMetrics => (is => 'ro', isa => 'Paws::S3Control::CloudWatchMetrics');
  has S3BucketDestination => (is => 'ro', isa => 'Paws::S3Control::S3BucketDestination');
...
As an example, if Att1 is expected to be a Paws::S3Control::StorageLensDataExport object:
  ...
  $service_obj->Method(Att1 => { CloudWatchMetrics => $value, ..., S3BucketDestination => $value  });
...
=head2 CloudWatchMetrics => L<Paws::S3Control::CloudWatchMetrics>

A container for enabling Amazon CloudWatch publishing for S3 Storage
Lens metrics.


=head2 S3BucketDestination => L<Paws::S3Control::S3BucketDestination>
