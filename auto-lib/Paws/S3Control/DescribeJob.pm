...
package Paws::S3Control::DescribeJob;
  use Moose;
  ...
  class_has _api_uri  => (isa => 'Str', is => 'ro', default => '/v20180820/jobs/{id}');
...
Paws::S3Control::DescribeJob - Arguments for method DescribeJob on L<Paws::S3Control>
...
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/s3-control/DescribeJob>
...
This class forms part of L<Paws>, documenting arguments for method DescribeJob in L<Paws::S3Control>
