...
package Paws::S3Control::GetBucketLifecycleConfiguration;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::S3Control::GetBucketLifecycleConfigurationResult');
...
Paws::S3Control::GetBucketLifecycleConfiguration - Arguments for method GetBucketLifecycleConfiguration on L<Paws::S3Control>
...
=head1 SYNOPSIS
    ...
    my $GetBucketLifecycleConfigurationResult =
      $s3 -control->GetBucketLifecycleConfiguration(
    ...
    # Results:
    my $Rules = $GetBucketLifecycleConfigurationResult->Rules;

   # Returns a L<Paws::S3Control::GetBucketLifecycleConfigurationResult> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/s3-control/GetBucketLifecycleConfiguration>
...
This class forms part of L<Paws>, documenting arguments for method GetBucketLifecycleConfiguration in L<Paws::S3Control>
