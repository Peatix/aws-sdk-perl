...
package Paws::S3Control::GetAccessGrantResult;
  use Moose;
...
Paws::S3Control::GetAccessGrantResult
...
this Identity Center instance with the S3 Access Grants instance, the
...
The type of permission that was granted in the access grant. Can be one
