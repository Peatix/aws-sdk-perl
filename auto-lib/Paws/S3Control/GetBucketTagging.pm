...
package Paws::S3Control::GetBucketTagging;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::S3Control::GetBucketTaggingResult');
...
Paws::S3Control::GetBucketTagging - Arguments for method GetBucketTagging on L<Paws::S3Control>
...
=head1 SYNOPSIS
    ...
    my $GetBucketTaggingResult = $s3 -control->GetBucketTagging(
    ...
    # Results:
    my $TagSet = $GetBucketTaggingResult->TagSet;

    # Returns a L<Paws::S3Control::GetBucketTaggingResult> object.

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/s3-control/GetBucketTagging>
...
This class forms part of L<Paws>, documenting arguments for method GetBucketTagging in L<Paws::S3Control>
