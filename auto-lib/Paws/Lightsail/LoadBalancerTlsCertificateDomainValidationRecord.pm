...
package Paws::Lightsail::LoadBalancerTlsCertificateDomainValidationRecord;
  use Moose;
  has DnsRecordCreationState => (is => 'ro', isa => 'Paws::Lightsail::LoadBalancerTlsCertificateDnsRecordCreationState', request_name => 'dnsRecordCreationState', traits => ['NameInRequest']);
...
As an example, if Att1 is expected to be a Paws::Lightsail::LoadBalancerTlsCertificateDomainValidationRecord object:
  ...
  $service_obj->Method(Att1 => { DnsRecordCreationState => $value, ..., Value => $value  });
...
=head2 DnsRecordCreationState => L<Paws::Lightsail::LoadBalancerTlsCertificateDnsRecordCreationState>
