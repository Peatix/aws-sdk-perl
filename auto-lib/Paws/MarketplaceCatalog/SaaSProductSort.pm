...
package Paws::MarketplaceCatalog::SaaSProductSort;
  use Moose;
...
Paws::MarketplaceCatalog::SaaSProductSort
...
As an example, if Att1 is expected to be a Paws::MarketplaceCatalog::SaaSProductSort object:

  $service_obj->Method(Att1 => { SortBy => $value, ..., SortOrder => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MarketplaceCatalog::SaaSProductSort object:
