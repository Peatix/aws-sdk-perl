...
package Paws::MarketplaceCatalog::ContainerProductLastModifiedDateFilterDateRange;
  use Moose;
...
Paws::MarketplaceCatalog::ContainerProductLastModifiedDateFilterDateRange
...
As an example, if Att1 is expected to be a Paws::MarketplaceCatalog::ContainerProductLastModifiedDateFilterDateRange object:

  $service_obj->Method(Att1 => { AfterValue => $value, ..., BeforeValue => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::MarketplaceCatalog::ContainerProductLastModifiedDateFilterDateRange object:
