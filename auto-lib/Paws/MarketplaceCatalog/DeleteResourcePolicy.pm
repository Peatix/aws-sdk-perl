...
package Paws::MarketplaceCatalog::DeleteResourcePolicy;
  use Moose;
  ...
  class_has _returns => (isa => 'Str', is => 'ro', default => 'Paws::MarketplaceCatalog::DeleteResourcePolicyResponse');
1;
...
Paws::MarketplaceCatalog::DeleteResourcePolicy - Arguments for method DeleteResourcePolicy on L<Paws::MarketplaceCatalog>
...
=head1 SYNOPSIS
    ...
    my $DeleteResourcePolicyResponse =
      $catalog . marketplace->DeleteResourcePolicy(
      ResourceArn => 'MyResourceARN',

      );

Values for attributes that are native types (Int, String, Float, etc) can passed as-is (scalar values). Values for complex Types (objects) can be passed as a HashRef. The keys and values of the hashref will be used to instance the underlying object.
For the AWS API documentation, see L<https://docs.aws.amazon.com/goto/WebAPI/catalog.marketplace/DeleteResourcePolicy>
...
This class forms part of L<Paws>, documenting arguments for method DeleteResourcePolicy in L<Paws::MarketplaceCatalog>
