...
package Paws::MarketplaceCatalog::EntitySummary;
  use Moose;
  has AmiProductSummary => (is => 'ro', isa => 'Paws::MarketplaceCatalog::AmiProductSummary');
  has ContainerProductSummary => (is => 'ro', isa => 'Paws::MarketplaceCatalog::ContainerProductSummary');
  has DataProductSummary => (is => 'ro', isa => 'Paws::MarketplaceCatalog::DataProductSummary');
  has EntityArn => (is => 'ro', isa => 'Str');
  has EntityId => (is => 'ro', isa => 'Str');
  has EntityType => (is => 'ro', isa => 'Str');
  has LastModifiedDate => (is => 'ro', isa => 'Str');
  has Name => (is => 'ro', isa => 'Str');
  has OfferSummary => (is => 'ro', isa => 'Paws::MarketplaceCatalog::OfferSummary');
  has ResaleAuthorizationSummary => (is => 'ro', isa => 'Paws::MarketplaceCatalog::ResaleAuthorizationSummary');
  has SaaSProductSummary => (is => 'ro', isa => 'Paws::MarketplaceCatalog::SaaSProductSummary');
...
As an example, if Att1 is expected to be a Paws::MarketplaceCatalog::EntitySummary object:
  ...
  $service_obj->Method(Att1 => { AmiProductSummary => $value, ..., Visibility => $value  });
...
=head2 AmiProductSummary => L<Paws::MarketplaceCatalog::AmiProductSummary>

An object that contains summary information about the AMI product.


=head2 ContainerProductSummary => L<Paws::MarketplaceCatalog::ContainerProductSummary>

An object that contains summary information about the container
product.


=head2 DataProductSummary => L<Paws::MarketplaceCatalog::DataProductSummary>
...
=head2 OfferSummary => L<Paws::MarketplaceCatalog::OfferSummary>

An object that contains summary information about the offer.


=head2 ResaleAuthorizationSummary => L<Paws::MarketplaceCatalog::ResaleAuthorizationSummary>

An object that contains summary information about the Resale
Authorization.


=head2 SaaSProductSummary => L<Paws::MarketplaceCatalog::SaaSProductSummary>
