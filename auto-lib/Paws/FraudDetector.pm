package Paws::FraudDetector;
  ...
  sub CancelBatchImportJob {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::FraudDetector::CancelBatchImportJob', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub CreateBatchImportJob {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::FraudDetector::CreateBatchImportJob', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub CreateList {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::FraudDetector::CreateList', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub CreateModel {
    my $self = shift;
  ...
  sub DeleteBatchImportJob {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::FraudDetector::DeleteBatchImportJob', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub DeleteEventsByEventType {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::FraudDetector::DeleteEventsByEventType', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DeleteEventType {
    my $self = shift;
  ...
  sub DeleteList {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::FraudDetector::DeleteList', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub DeleteModel {
    my $self = shift;
  ...
  sub GetBatchImportJobs {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::FraudDetector::GetBatchImportJobs', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub GetDeleteEventsByEventTypeStatus {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::FraudDetector::GetDeleteEventsByEventTypeStatus', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetDetectors {
    my $self = shift;
  ...
  sub GetEvent {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::FraudDetector::GetEvent', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub GetEventPredictionMetadata {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::FraudDetector::GetEventPredictionMetadata', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetEventTypes {
    my $self = shift;
  ...
  sub GetListElements {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::FraudDetector::GetListElements', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetListsMetadata {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::FraudDetector::GetListsMetadata', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub GetModels {
    my $self = shift;
  ...
  sub ListEventPredictions {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::FraudDetector::ListEventPredictions', @_);
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub SendEvent {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::FraudDetector::SendEvent', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub TagResource {
    my $self = shift;
  ...
  sub UpdateEventLabel {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::FraudDetector::UpdateEventLabel', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub UpdateList {
    my $self = shift;
    my $call_object = $self->new_with_coercions('Paws::FraudDetector::UpdateList', @_);
    return $self->caller->do_call($self, $call_object);
  }
  sub UpdateModel {
    my $self = shift;
...
The Amazon Fraud Detector Query API provides HTTPS requests that use
the HTTP verb GET or POST and a Query parameter C<Action>. AWS SDK
provides libraries, sample code, tutorials, and other resources for
software developers who prefer to build applications using
language-specific APIs instead of submitting a request over HTTP or
HTTPS. These libraries provide basic functions that automatically take
care of tasks such as cryptographically signing your requests, retrying
requests, and handling error responses, so that it is easier for you to
get started. For more information about the AWS SDKs, go to Tools to
build on AWS (https://aws.amazon.com/developer/tools/) page, scroll
down to the B<SDK> section, and choose plus (+) sign to expand the
section.
...
Each argument is described in detail in: L<Paws::FraudDetector::CancelBatchImportJob>

Returns: a L<Paws::FraudDetector::CancelBatchImportJobResult> instance
...
Each argument is described in detail in: L<Paws::FraudDetector::CreateBatchImportJob>

Returns: a L<Paws::FraudDetector::CreateBatchImportJobResult> instance
...
=item [Elements => ArrayRef[Str|Undef]]
...
Each argument is described in detail in: L<Paws::FraudDetector::CreateList>

Returns: a L<Paws::FraudDetector::CreateListResult> instance
...
=item [IngestedEventsDetail => L<Paws::FraudDetector::IngestedEventsDetail>]
...
Each argument is described in detail in: L<Paws::FraudDetector::DeleteBatchImportJob>

Returns: a L<Paws::FraudDetector::DeleteBatchImportJobResult> instance
...
Detector. If C<deleteAuditHistory> is C<True>, event data is available
through search for up to 30 seconds after the delete operation is
completed.


=head2 DeleteEventsByEventType
...
Each argument is described in detail in: L<Paws::FraudDetector::DeleteEventsByEventType>

Returns: a L<Paws::FraudDetector::DeleteEventsByEventTypeResult> instance
...
Each argument is described in detail in: L<Paws::FraudDetector::DeleteList>

Returns: a L<Paws::FraudDetector::DeleteListResult> instance
...
Each argument is described in detail in: L<Paws::FraudDetector::GetBatchImportJobs>

Returns: a L<Paws::FraudDetector::GetBatchImportJobsResult> instance
...
C<maxResults>, the value must be between 1 and 50. To get the next page
results, provide the pagination token from the
C<GetBatchImportJobsResponse> as part of your request. A null
...
=head2 GetDeleteEventsByEventTypeStatus
...
Each argument is described in detail in: L<Paws::FraudDetector::GetDeleteEventsByEventTypeStatus>

Returns: a L<Paws::FraudDetector::GetDeleteEventsByEventTypeStatusResult> instance

Retrieves the status of a C<DeleteEventsByEventType> action.
...
Each argument is described in detail in: L<Paws::FraudDetector::GetEvent>

Returns: a L<Paws::FraudDetector::GetEventResult> instance
...
=head2 GetEventPredictionMetadata
...
=item PredictionTimestamp => Str


=back

Each argument is described in detail in: L<Paws::FraudDetector::GetEventPredictionMetadata>

Returns: a L<Paws::FraudDetector::GetEventPredictionMetadataResult> instance
...
Each argument is described in detail in: L<Paws::FraudDetector::GetListElements>

Returns: a L<Paws::FraudDetector::GetListElementsResult> instance

Gets all the elements in the specified list.


=head2 GetListsMetadata
...
Each argument is described in detail in: L<Paws::FraudDetector::GetListsMetadata>

Returns: a L<Paws::FraudDetector::GetListsMetadataResult> instance
...
=head2 ListEventPredictions

=over

=item [DetectorId => L<Paws::FraudDetector::FilterCondition>]

=item [DetectorVersionId => L<Paws::FraudDetector::FilterCondition>]

=item [EventId => L<Paws::FraudDetector::FilterCondition>]

=item [EventType => L<Paws::FraudDetector::FilterCondition>]

=item [MaxResults => Int]

=item [NextToken => Str]

=item [PredictionTimeRange => L<Paws::FraudDetector::PredictionTimeRange>]


=back

Each argument is described in detail in: L<Paws::FraudDetector::ListEventPredictions>

Returns: a L<Paws::FraudDetector::ListEventPredictionsResult> instance
...
For example, the following filter lists all past predictions for C<xyz>
event type - C<{ "eventType":{ "value": "xyz" }E<rdquo> }>

This is a paginated API. If you provide a null C<maxResults>, this
action will retrieve a maximum of 10 records per page. If you provide a
C<maxResults>, the value must be between 50 and 100. To get the next
page results, provide the C<nextToken> from the response as part of
your request. A null C<nextToken> fetches the records from the
beginning.
...
=item [EventIngestion => Str]

=item [EventOrchestration => L<Paws::FraudDetector::EventOrchestration>]
...
=item [AssignedLabel => Str]

=item [LabelTimestamp => Str]


=back

Each argument is described in detail in: L<Paws::FraudDetector::SendEvent>

Returns: a L<Paws::FraudDetector::SendEventResult> instance

Stores events in Amazon Fraud Detector without generating fraud
predictions for those events. For example, you can use C<SendEvent> to
...
Each argument is described in detail in: L<Paws::FraudDetector::UpdateEventLabel>

Returns: a L<Paws::FraudDetector::UpdateEventLabelResult> instance
...
Each argument is described in detail in: L<Paws::FraudDetector::UpdateList>

Returns: a L<Paws::FraudDetector::UpdateListResult> instance
...
Change the C<TRAINING_IN_PROGRESS> status to C<TRAINING_CANCELLED>.
