...
public and private registries to host your container images. You can
use the Docker CLI or your preferred client to push, pull, and manage
...
public registry. Images are specified with either an C<imageTag> or
C<imageDigest>.
...
use the C<force> option. This option deletes all images on your behalf
