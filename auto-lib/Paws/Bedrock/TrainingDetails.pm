...
package Paws::Bedrock::TrainingDetails;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::Bedrock::TrainingDetails object:

  $service_obj->Method(Att1 => { CreationTime => $value, ..., Status => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Bedrock::TrainingDetails object:
