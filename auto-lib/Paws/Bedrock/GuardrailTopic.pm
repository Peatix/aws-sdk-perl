...
package Paws::Bedrock::GuardrailTopic;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::Bedrock::GuardrailTopic object:

  $service_obj->Method(Att1 => { Definition => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Bedrock::GuardrailTopic object:
