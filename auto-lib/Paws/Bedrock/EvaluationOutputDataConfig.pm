...
package Paws::Bedrock::EvaluationOutputDataConfig;
  use Moose;
...
Paws::Bedrock::EvaluationOutputDataConfig
...
As an example, if Att1 is expected to be a Paws::Bedrock::EvaluationOutputDataConfig object:

  $service_obj->Method(Att1 => { S3Uri => $value, ..., S3Uri => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Bedrock::EvaluationOutputDataConfig object:
