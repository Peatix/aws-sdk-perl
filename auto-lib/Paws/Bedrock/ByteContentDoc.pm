...
package Paws::Bedrock::ByteContentDoc;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::Bedrock::ByteContentDoc object:

  $service_obj->Method(Att1 => { ContentType => $value, ..., Identifier => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Bedrock::ByteContentDoc object:
