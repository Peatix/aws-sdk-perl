...
As an example, if Att1 is expected to be a Paws::Bedrock::S3Config object:

  $service_obj->Method(Att1 => { BucketName => $value, ..., KeyPrefix => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Bedrock::S3Config object:
