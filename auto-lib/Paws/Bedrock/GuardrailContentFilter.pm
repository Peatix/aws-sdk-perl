...
package Paws::Bedrock::GuardrailContentFilter;
  use Moose;
...
Paws::Bedrock::GuardrailContentFilter
...
As an example, if Att1 is expected to be a Paws::Bedrock::GuardrailContentFilter object:

  $service_obj->Method(Att1 => { InputAction => $value, ..., Type => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Bedrock::GuardrailContentFilter object:
