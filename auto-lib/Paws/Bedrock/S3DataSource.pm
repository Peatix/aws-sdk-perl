...
package Paws::Bedrock::S3DataSource;
  use Moose;
...
As an example, if Att1 is expected to be a Paws::Bedrock::S3DataSource object:

  $service_obj->Method(Att1 => { S3Uri => $value, ..., S3Uri => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Bedrock::S3DataSource object:
