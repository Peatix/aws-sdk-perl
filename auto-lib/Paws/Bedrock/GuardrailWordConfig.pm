...
package Paws::Bedrock::GuardrailWordConfig;
  use Moose;
...
Paws::Bedrock::GuardrailWordConfig
...
As an example, if Att1 is expected to be a Paws::Bedrock::GuardrailWordConfig object:

  $service_obj->Method(Att1 => { InputAction => $value, ..., Text => $value  });

=head3 Results returned from an API call

Use accessors for each attribute. If Att1 is expected to be an Paws::Bedrock::GuardrailWordConfig object:
