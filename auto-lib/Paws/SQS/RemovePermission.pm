...
package Paws::SQS::RemovePermission;
  use Moose;
...
Paws::SQS::RemovePermission - Arguments for method RemovePermission on L<Paws::SQS>
...
using the C< AddPermission > action.
...
This class forms part of L<Paws>, documenting arguments for method RemovePermission in L<Paws::SQS>
