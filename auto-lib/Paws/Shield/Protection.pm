...
package Paws::Shield::Protection;
  use Moose;
  has ApplicationLayerAutomaticResponseConfiguration => (is => 'ro', isa => 'Paws::Shield::ApplicationLayerAutomaticResponseConfiguration');
...
As an example, if Att1 is expected to be a Paws::Shield::Protection object:
  ...
  $service_obj->Method(Att1 => { ApplicationLayerAutomaticResponseConfiguration => $value, ..., ResourceArn => $value  });
...
Use accessors for each attribute. If Att1 is expected to be an Paws::Shield::Protection object:
  ...
  $result->Att1->ApplicationLayerAutomaticResponseConfiguration
...
=head2 ApplicationLayerAutomaticResponseConfiguration => L<Paws::Shield::ApplicationLayerAutomaticResponseConfiguration>
